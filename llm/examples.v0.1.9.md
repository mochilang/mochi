...
> 📦 Generated with [Mochi Compiler](https://github.com/mochi-lang/mochi) `v0.1.9`
...
// --- Currying: returns multiple layers of functions ---
fun curryAdd(a: int): fun(int): fun(int): int {
  return fun(b: int): fun(int): int => {
    return fun(c: int): int => a + b + c
  }
}
...
#### 📄 Source
```mochi
// --- Basic Setup (inferred types) ---
let name = "Mochi"   // inferred as string

// Simple function (explicit return type for clarity)
fun greet(name: string): string {
  return "Hello, " + name
}
...
// --- Closure: makeAdder returns a function ---
fun makeAdder(n: int): fun(int): int {
  return fun(x) => x + n  // type of x inferred as int
}

let add10 = makeAdder(10)
print(add10(5))  // 15

// --- Currying with inferred inner types ---
fun curryAdd(a: int): fun(int): fun(int): int {
  return fun(b) => {
    return fun(c) => a + b + c
  }
...
```text
🔍 Test basic arithmetic
✅ basic arithmetic passed
🔍 Test equality and comparison
✅ equality and comparison passed
🔍 Test let bindings
✅ let bindings passed
🔍 Test function definitions and calls
✅ function definitions and calls passed
🔍 Test closures and partial application
✅ closures and partial application passed
🔍 Test if/else logic
✅ if/else logic passed
🔍 Test for loop and accumulation
✅ for loop and accumulation passed
```
</details>

...
func newNumMatrix(matrix [][]int) any {
	var rows int = len(matrix)
	if (rows == 0) {
		return NumMatrix{Sums: _cast[[][]int]([]any{})}
	}
...
func example() {
	var nm any = newNumMatrix([][]int{[]int{3, 0, 1, 4, 2}, []int{5, 6, 3, 2, 1}, []int{1, 2, 0, 1, 5}, []int{4, 1, 0, 1, 7}, []int{1, 0, 3, 0, 5}})
	_ = nm

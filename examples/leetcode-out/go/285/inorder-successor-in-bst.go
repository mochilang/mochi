...
var example []Node = []Node{Node{Val: 5, Left: 1, Right: 2}, Node{Val: 3, Left: 3, Right: 4}, Node{Val: 6, Left: -1, Right: -1}, Node{Val: 2, Left: 5, Right: -1}, Node{Val: 4, Left: -1, Right: -1}, Node{Val: 1, Left: -1, Right: -1}}
func main() {
	successor_in_middle()
	no_successor()
	left_subtree()

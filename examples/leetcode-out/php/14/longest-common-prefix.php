...
{
    if (!((mochi_longestCommonPrefix(["flower", "flow", "flight"]) == "fl"))) {
...
{
    if (!((mochi_longestCommonPrefix(["dog", "racecar", "car"]) == ""))) {
        throw new Exception('expect failed');
    }
}
...
{
    if (!((mochi_longestCommonPrefix(["single"]) == "single"))) {
        throw new Exception('expect failed');
    }
}
...
{
    if (!((mochi_longestCommonPrefix(["a", "b", "c"]) == ""))) {
        throw new Exception('expect failed');
    }
}

...
{
    if (!((mochi_reverseKGroup([1, 2, 3, 4, 5], 2) == [2, 1, 4, 3, 5]))) {
...
{
    if (!((mochi_reverseKGroup([1, 2, 3, 4, 5], 3) == [3, 2, 1, 4, 5]))) {
        throw new Exception('expect failed');
    }
}
...
{
    if (!((mochi_reverseKGroup([1, 2, 3, 4], 4) == [4, 3, 2, 1]))) {
        throw new Exception('expect failed');
    }
}
...
{
    if (!((mochi_reverseKGroup([1, 2, 3], 5) == [1, 2, 3]))) {
        throw new Exception('expect failed');
    }
}
...
{
    if (!((mochi_reverseKGroup([1, 2, 3], 1) == [1, 2, 3]))) {
        throw new Exception('expect failed');
    }
}

...
{
    if (!((mochi_romanToInt("MCMXCIV") == 1994))) {
        throw new Exception('expect failed');
    }
}
...
{
    if (!((mochi_romanToInt("IV") == 4))) {
        throw new Exception('expect failed');
    }
    if (!((mochi_romanToInt("IX") == 9))) {
        throw new Exception('expect failed');
    }
}
...
{
    if (!((mochi_romanToInt("XL") == 40))) {
        throw new Exception('expect failed');
    }
    if (!((mochi_romanToInt("XC") == 90))) {
        throw new Exception('expect failed');
    }
}

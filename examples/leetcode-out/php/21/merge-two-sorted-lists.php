...
{
    if (!((mochi_mergeTwoLists([1, 2, 4], [1, 3, 4]) == [1, 1, 2, 3, 4, 4]))) {
...
{
    if (!((mochi_mergeTwoLists([1, 5, 7], [2, 3, 4, 6, 8]) == [1, 2, 3, 4, 5, 6, 7, 8]))) {
        throw new Exception('expect failed');
    }
}
...
{
    if (!((mochi_mergeTwoLists([1, 2, 3], []) == [1, 2, 3]))) {
        throw new Exception('expect failed');
    }
}

...
{
    if (!((mochi_lengthOfLongestSubstring("abcabcbb") == 3))) {
...
{
    if (!((mochi_lengthOfLongestSubstring("bbbbb") == 1))) {
        throw new Exception('expect failed');
    }
}
...
{
    if (!((mochi_lengthOfLongestSubstring("pwwkew") == 3))) {
        throw new Exception('expect failed');
    }
}
...
{
    if (!((mochi_lengthOfLongestSubstring("") == 0))) {
        throw new Exception('expect failed');
    }
}

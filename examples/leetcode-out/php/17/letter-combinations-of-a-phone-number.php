...
{
    if (!((mochi_letterCombinations("23") == ["ad", "ae", "af", "bd", "be", "bf", "cd", "ce", "cf"]))) {
...
{
    if (!((mochi_letterCombinations("2") == ["a", "b", "c"]))) {
        throw new Exception('expect failed');
    }
}
...
{
    if (!((mochi_letterCombinations("7") == ["p", "q", "r", "s"]))) {
        throw new Exception('expect failed');
    }
}
...
{
    if (!((mochi_letterCombinations("79") == ["pw", "px", "py", "pz", "qw", "qx", "qy", "qz", "rw", "rx", "ry", "rz", "sw", "sx", "sy", "sz"]))) {
        throw new Exception('expect failed');
    }
}

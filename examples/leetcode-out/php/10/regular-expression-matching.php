...
{
    if (!((mochi_isMatch("aab", "c*a*b") == true))) {
        throw new Exception('expect failed');
    }
}
...
{
    if (!((mochi_isMatch("mississippi", "mis*is*p*.") == false))) {
        throw new Exception('expect failed');
    }
}

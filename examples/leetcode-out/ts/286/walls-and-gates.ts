...
function example(): void {
	...
	let rooms: Array<Array<number>> = [[INF, (-1), 0, INF], [INF, INF, INF, (-1)], [INF, (-1), INF, (-1)], [0, (-1), INF, INF]]
	let expected: Array<Array<number>> = [[3, (-1), 0, 1], [2, 2, 1, (-1)], [1, (-1), 2, (-1)], [0, (-1), 3, 4]]
	if (!(_equal(wallsAndGates(rooms), expected))) { throw new Error('expect failed') }
}

function all_walls(): void {
	let rooms: Array<Array<number>> = [[(-1), (-1)], [(-1), (-1)]]

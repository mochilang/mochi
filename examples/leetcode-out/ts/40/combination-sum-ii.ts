...
function combinationSum2(candidates: Array<number>, target: number) : Array<Array<number>> {
	let arr: Array<any> = (() => {
...
function example_1(): void {
	if (!(_equal(combinationSum2([10, 1, 2, 7, 6, 1, 5], 8), [[1, 1, 6], [1, 2, 5], [1, 7], [2, 6]]))) { throw new Error('expect failed') }
}

function example_2(): void {
	if (!(_equal(combinationSum2([2, 5, 2, 1, 2], 5), [[1, 2, 2], [5]]))) { throw new Error('expect failed') }
}

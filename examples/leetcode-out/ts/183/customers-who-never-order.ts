...
let customers: Array<any> = [{id: 1, name: "Joe"}, {id: 2, name: "Henry"}, {id: 3, name: "Sam"}, {id: 4, name: "Max"}]

let orders: Array<any> = [{id: 1, customerId: 3}, {id: 2, customerId: 1}]
...
function none_left(): void {
	let allOrders: Array<any> = [{id: 1, customerId: 1}, {id: 2, customerId: 2}, {id: 3, customerId: 3}, {id: 4, customerId: 4}]

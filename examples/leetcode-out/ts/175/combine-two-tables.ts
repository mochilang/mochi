...
let person: Array<any> = [{personId: 1, firstName: "Wang", lastName: "Allen"}, {personId: 2, firstName: "Alice", lastName: "Bob"}, {personId: 3, firstName: "Bob", lastName: "Brown"}]

let address: Array<any> = [{addressId: 1, personId: 2, city: "New York City", state: "New York"}, {addressId: 2, personId: 3, city: "Leetcode", state: "California"}]

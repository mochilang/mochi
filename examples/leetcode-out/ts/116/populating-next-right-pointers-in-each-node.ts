...
let exLefts: Array<number> = [1, 3, 5, ((-1)), ((-1)), ((-1)), ((-1))]

let exRights: Array<number> = [2, 4, 6, ((-1)), ((-1)), ((-1)), ((-1))]

let exValues: Array<number> = [1, 2, 3, 4, 5, 6, 7]

let exRoot: number = 0

function connect(lefts: Array<number>, rights: Array<number>, root: number) : Array<number> {
...
function levels(lefts: Array<number>, rights: Array<number>, values: Array<number>, root: number) : Array<Array<number>> {
...
function example(): void {
	...
	if (!(_equal(levels(exLefts, exRights, exValues, exRoot), [[1], [2, 3], [4, 5, 6, 7]]))) { throw new Error('expect failed') }
	if (!(_equal(ns, [((-1)), 2, ((-1)), 4, 5, 6, ((-1))]))) { throw new Error('expect failed') }
}
...
function single_node(): void {
	...
	if (!(_equal(levels(lefts, rights, values, root), [[1]]))) { throw new Error('expect failed') }
...
function empty(): void {
	...
	if (!(_equal(levels(lefts, rights, values, ((-1))), []))) { throw new Error('expect failed') }

...
function example_1(): void {
	...
	if (!(_equal(out, [3, 5]))) { throw new Error('expect failed') }
}
...
function negatives(): void {
	...
	if (!(_equal(out, [(-1), 0]))) { throw new Error('expect failed') }
}
...
function simple(): void {
	...
	if (!(_equal(out, [0, 1]))) { throw new Error('expect failed') }
}
...
function mixed_order(): void {
	...
	if (!(_equal(out, [3, 4]))) { throw new Error('expect failed') }
}

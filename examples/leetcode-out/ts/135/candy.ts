...
function example_1(): void {
	if (!((candy([1, 0, 2]) == 5))) { throw new Error('expect failed') }
}

function example_2(): void {
	if (!((candy([1, 2, 2]) == 4))) { throw new Error('expect failed') }
}

function all_equal(): void {
	if (!((candy([1, 1, 1]) == 3))) { throw new Error('expect failed') }
}

function descending(): void {
	if (!((candy([5, 4, 3, 2, 1]) == 15))) { throw new Error('expect failed') }
}

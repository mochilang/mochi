...
function example_1(): void {
	if (!(_equal(wiggleSort([1, 5, 1, 1, 6, 4]), [1, 6, 1, 5, 1, 4]))) { throw new Error('expect failed') }
}

function example_2(): void {
	if (!(_equal(wiggleSort([1, 3, 2, 2, 3, 1]), [2, 3, 1, 3, 1, 2]))) { throw new Error('expect failed') }
}
...
function already_wiggle(): void {
	if (!(_equal(wiggleSort([2, 5, 1, 6]), [2, 6, 1, 5]))) { throw new Error('expect failed') }
}

...
function reverseVowels(s: string) : string {
	let vowels: Record<string, boolean> = {"a": true, "e": true, "i": true, "o": true, "u": true, "A": true, "E": true, "I": true, "O": true, "U": true}
...
function example_2(): void {
	if (!((reverseVowels("leetcode") == "leotcede"))) { throw new Error('expect failed') }
}

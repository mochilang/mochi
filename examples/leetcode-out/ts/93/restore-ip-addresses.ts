...
function example_1(): void {
	if (!(_equal(restoreIpAddresses("25525511135"), ["255.255.11.135", "255.255.111.35"]))) { throw new Error('expect failed') }
}

function all_zeros(): void {
	if (!(_equal(restoreIpAddresses("0000"), ["0.0.0.0"]))) { throw new Error('expect failed') }
}

function example_2(): void {
	if (!(_equal(restoreIpAddresses("101023"), ["1.0.10.23", "1.0.102.3", "10.1.0.23", "10.10.2.3", "101.0.2.3"]))) { throw new Error('expect failed') }
}

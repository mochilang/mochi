...
var Servers = map[string]LanguageServer{
	...
	// OCaml conversion uses a small helper CLI that dumps the parse tree as
	// JSON instead of the language server.
	"ocaml":  {Command: "obolcaml", Args: []string{"parse", "--json"}, LangID: "ocaml"},

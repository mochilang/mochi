...
func TestTransformGolden(t *testing.T) {
	...
	rootDir := repoRoot(t)
	pattern := filepath.Join(rootDir, "archived/tests/transpiler/x/rs", "*.rs")
...
func updateReadme() {
	...
	buf.WriteString("Each `.rs` source in `archived/tests/transpiler/x/rs` has a matching `.mochi` and `.ast` file generated by the tests.\n\n")

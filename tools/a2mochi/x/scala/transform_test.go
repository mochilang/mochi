...
func TestTransform_Golden(t *testing.T) {
	...
	root := repoRoot(t)
	pattern := filepath.Join(root, "archived/tests/transpiler/x/scala", "*.scala")
...
func updateReadme() {
	...
	buf.WriteString("Each `.scala` source in `archived/tests/transpiler/x/scala` has a matching `.mochi` and `.ast` file generated by the tests.\n")
	buf.WriteString("\n## Checklist\n")

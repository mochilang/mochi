...
func UpdateReadmeForTests() {
	...
	buf.WriteString("This directory holds golden outputs for the Clojure to Mochi converter. Each `.clj` source in `archived/tests/transpiler/x/clj` has a matching `.mochi` and `.ast` file generated by the tests.\n\n")

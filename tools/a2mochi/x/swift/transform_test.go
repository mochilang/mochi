...
func TestTransformGolden(t *testing.T) {
	...
	root := repoRoot(t)
	pattern := filepath.Join(root, "archived", "tests", "archived", "transpiler", "x", "swift", "*.swift")
...
func updateReadme() {
	...
	buf.WriteString("This directory holds golden outputs for the Swift to Mochi converter. Each `.swift` source in `archived/tests/transpiler/x/swift` has a matching `.mochi` and `.ast` file generated by the tests.\n\n")

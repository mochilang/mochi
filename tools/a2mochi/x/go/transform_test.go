...
func TestTransform_Golden(t *testing.T) {
	root := repoRoot(t)
	pattern := filepath.Join(root, "archived/tests/transpiler/x/go", "*.go")
...
func updateReadme() {
	...
	buf.WriteString("This directory holds golden outputs for the Go to Mochi converter. " +
		"Each `.go` source in `archived/tests/transpiler/x/go` has a matching `.mochi` and `.ast` file generated by the tests. " +

...
func UpdateReadmeForTests() {
	...
	buf.WriteString("This directory holds golden outputs for the PHP to Mochi converter. Each `.php` source in `archived/tests/transpiler/x/php` has a matching `.mochi` and `.ast` file generated by the tests. Generated Mochi programs are executed to verify runtime behaviour matches the original VM examples.\n\n")

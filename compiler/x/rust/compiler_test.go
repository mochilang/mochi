...
func updateReadme() {
	...
	buf.WriteString("- [ ] Generate API documentation with rustdoc\n")
	buf.WriteString("- [ ] Add linter integration for idiomatic Rust\n")
	buf.WriteString("- [ ] Support cross-compilation targets\n")
	buf.WriteString("- [ ] Improve integration with existing Rust crates\n")
	buf.WriteString("- [ ] Provide FFI examples for C interoperability\n")
	buf.WriteString("- [ ] Explore WebAssembly backend options\n")
	buf.WriteString("- [ ] Introduce automated formatting checks\n")
	buf.WriteString("- [ ] Expand unit test coverage for edge cases\n")
	buf.WriteString("- [ ] Document contribution guidelines for Rust code\n")
	buf.WriteString("- [ ] Add CI caching for Rust dependencies\n")

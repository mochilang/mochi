...
func updateReadme() {
	...
	buf.WriteString("This directory contains C source code generated by the Mochi compiler. Each test from `tests/vm/valid` is compiled and executed. Successful runs have a `.out` file, failures generate a `.error` file.\n\n")

...
func (c *Compiler) Compile(prog *parser.Program) ([]byte, error) {
	...
	// Emit imports and runtime helpers at the top. Older versions prefixed
	// every file with a generated comment. That banner is removed so the
	// output more closely matches the reference implementations. We keep the
	// `annotations` future import however, as the compiler emits forward

...
## Progress (2025-07-17 10:00)
- Removed deprecated `TestLuaCompiler_ValidPrograms` in favour of the golden test.
- Regenerated VM golden outputs using the Lua backend; no `.error` files were produced.

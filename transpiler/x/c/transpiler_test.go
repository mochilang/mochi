...
func TestTranspilerGolden(t *testing.T) {
	...
	files := []string{
		...
		filepath.Join(srcDir, "map_assign.mochi"),
		filepath.Join(srcDir, "map_in_operator.mochi"),
		filepath.Join(srcDir, "map_literal_dynamic.mochi"),
		filepath.Join(srcDir, "map_membership.mochi"),
		filepath.Join(srcDir, "map_nested_assign.mochi"),

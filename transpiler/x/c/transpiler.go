...
func (p *Program) Emit() []byte {
	...
	if needStrConcat || needStrInt || needStrFloat || needStrBool || needStrListInt || needStrListStr || needSubstring || needAtoi || needInput || needNow || needUpper || needLower || needListAppendInt || needListAppendStr || needListAppendPtr || needListAppendDoublePtr || needListAppendStrPtr || needListAppendSizeT || needListAppendStrNew {

...
Generated Erlang code from programs in `tests/rosetta/x/Mochi` lives in `tests/rosetta/transpiler/erl`.
Last updated: 2025-07-25 01:41 UTC

## Rosetta Golden Test Checklist (73/284)
| Index | Name | Status | Duration | Memory |
|------:|------|:-----:|---------:|-------:|
| 1 | 100-doors-2 | ✓ | 571.223ms | 2.8 KB |
| 2 | 100-doors-3 | ✓ |  |  |
| 3 | 100-doors | ✓ |  |  |
| 4 | 100-prisoners | ✓ |  |  |
| 5 | 15-puzzle-game | ✓ |  |  |

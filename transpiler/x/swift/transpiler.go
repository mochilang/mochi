...
// DescribeExpr renders any value using Swift's String(describing:) helper.
type DescribeExpr struct{ Value Expr }

func (de *DescribeExpr) emit(w io.Writer) {

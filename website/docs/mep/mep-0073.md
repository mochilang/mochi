...
| 2. rustdoc-JSON ingest | NOT STARTED | n/a | n/a | n/a |
| 3. type-mapping table | NOT STARTED | n/a | n/a | n/a |
| 4. wrapper synthesiser | NOT STARTED | required | n/a (no cc on wasm32) | required (no_std subset only) |
| 5. extern emitter | NOT STARTED | required | required | required |

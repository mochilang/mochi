...
| #    | Scope | Status | Commit |
|------|-------|--------|--------|
| 16.0 | CI workflow `transpiler3-beam-test.yml` runs BEAM corpus on OTP 28 × Linux + macOS via `erlef/setup-beam` | IN PROGRESS | — |
| 16.1 | Add OTP 27.latest to matrix | NOT STARTED | — |

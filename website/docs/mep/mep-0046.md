...
| #    | Scope | Status | Commit |
|------|-------|--------|--------|
| 16.0 | CI workflow runs full corpus on the OTP × arch matrix (4 cells) | NOT STARTED | — |
| 16.1 | OTP 29 RC added as non-blocking nightly when available | NOT STARTED | — |
| 16.2 | Windows x86-64 (OTP 27) runs nightly best-effort | NOT STARTED | — |

...
| 15.1 | `--target=beam-rebar3-project` emits a standalone rebar3 project | DEFERRED | — |
| 15.2 | `--target=beam-mix-project` emits a standalone mix project | DEFERRED | — |
| 15.3 | `--target=beam-atomvm` emits `.avm` bundle for AtomVM | DEFERRED | — |
| 15.4 | Docker recipe `mochilang/mochi:beam-otp27` published | DEFERRED | — |

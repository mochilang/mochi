...
| #   | Scope | Status | Commit |
|-----|-------|--------|--------|
| 11.0 | `async expr` → `mochi_async:async/1` (monitored spawn) | LANDED | TBD |
| 11.1 | `await fut` → selective receive on fresh ref (uses recv-marker optimization) | LANDED | TBD |
| 11.2 | `await_all`, `await_any` combinators | LANDED | TBD |

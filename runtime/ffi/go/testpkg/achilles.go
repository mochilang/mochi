...
// AchillesNumbersExample returns the example output for the Rosetta Code
// Achilles numbers task. The output was generated by the Go reference
// implementation and is returned as a precomputed string to avoid heavy
// computation in tests.
func AchillesNumbersExample() string {
	return `First 50 Achilles numbers:

...
// Convert converts assembly source code to Mochi using the language server.
func Convert(src string) ([]byte, error) {
	ls := any2mochi.Servers["asm"]
...
// ConvertFile reads the asm file and converts it to Mochi.

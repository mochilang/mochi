# Generated by Mochi transpiler on 2025-07-21 21:13 +0700
...
end_date = "1994-01-01"
result = Enum.group_by(for c <- customer, o <- orders, l <- lineitem, n <- nation, o.o_orderdate >= start_date && o.o_orderdate < end_date && l.l_returnflag == "R" do
  %{
    c: c,
    o: o,
    l: l,
...
end, fn %{c: c, o: _o, l: _l, n: n} -> %{c_custkey: c.c_custkey, c_name: c.c_name, c_acctbal: c.c_acctbal, c_address: c.c_address, c_phone: c.c_phone, c_comment: c.c_comment, n_name: n.n_name} end)
  ...
  |> Enum.map(fn g ->
    g = g
    %{c_custkey: g.key.c_custkey, c_name: g.key.c_name, revenue: Enum.sum(for x <- g.items do
  x.l.l_extendedprice * (1 - x.l.l_discount)

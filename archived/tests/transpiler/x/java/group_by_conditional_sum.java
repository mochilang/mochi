public class Main {
    static Data1[] items = new Data1[]{new Data1("a", 10, true), new Data1("a", 5, false), new Data1("b", 20, true)};
    static class Data1 {
        String cat;
        int val;
        boolean flag;
        Data1(String cat, int val, boolean flag) {
            this.cat = cat;
            this.val = val;
            this.flag = flag;
        }
    ...
    static class Result4 {
        Object cat;
        int share;
        Result4(Object cat, int share) {
            this.cat = cat;
            this.share = share;
        }
        boolean containsKey(String k) {
            if (k.equals("cat")) return true;
            if (k.equals("share")) return true;
            return false;
        }
    }

...
var updateAlgorithmsFlag = flag.Bool("update-algorithms-php", false, "update golden files")
...
func runAlgorithmCase(t *testing.T, file string) {
	...
	outDir := filepath.Join(root, "tests", "algorithms", "x", "PHP", filepath.Dir(file))
...
func updateAlgorithms() {
	...
	outDir := filepath.Join(root, "tests", "algorithms", "x", "PHP")
	md := filepath.Join(root, "archived", "transpiler", "x", "php", "ALGORITHMS.md")
	...
	var buf bytes.Buffer
	buf.WriteString("# PHP Algorithms Transpiler Progress\n\n")
	buf.WriteString("This checklist is auto-generated.\n")
	buf.WriteString("Generated PHP code from programs in `tests/github/TheAlgorithms/Mochi` lives in `tests/algorithms/x/PHP`.\n")

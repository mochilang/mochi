...
func TestGoTranspiler_Algorithms_Golden(t *testing.T) {
	if _, err := exec.LookPath("go"); err != nil {
		t.Skip("go toolchain not installed")
	}
	root := findRepoRoot(t)
	srcDir := filepath.Join(root, "tests", "github", "TheAlgorithms", "Mochi")
	outDir := filepath.Join(root, "tests", "algorithms", "transpiler", "Go")
...
func updateAlgorithmsChecklist() {
	...
	srcDir := filepath.Join(root, "tests", "github", "TheAlgorithms", "Mochi")
	outDir := filepath.Join(root, "tests", "algorithms", "transpiler", "Go")
	readmePath := filepath.Join(root, "archived", "transpiler", "x", "go", "ALGORITHMS.md")
	...
	buf.WriteString("# Go Algorithms Transpiler Output\n\n")

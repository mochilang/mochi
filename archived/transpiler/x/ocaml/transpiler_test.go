...
func TestTranspilePrintHello(t *testing.T) {
	...
	root := repoRoot(t)
	outDir := filepath.Join(root, "archived", "tests", "archived", "transpiler", "x", "ocaml")
...
func updateReadme() {
	...
	outDir := filepath.Join(root, "archived", "tests", "archived", "transpiler", "x", "ocaml")
	readmePath := filepath.Join(root, "archived", "transpiler", "x", "ocaml", "README.md")
...
func updateTasks() {
	root := repoRoot(&testing.T{})
	taskFile := filepath.Join(root, "archived", "transpiler", "x", "ocaml", "TASKS.md")

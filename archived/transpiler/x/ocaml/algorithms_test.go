...
func TestOCamlTranspiler_Algorithms_Golden(t *testing.T) {
	...
	outDir := filepath.Join(root, "tests", "algorithms", "x", "OCaml")
	...
	for i, src := range files {
		...
		ok := t.Run(testName, func(t *testing.T) {
			codePath := filepath.Join(outDir, rel+".ml")
...
func updateAlgorithmsChecklist() {
	...
	srcDir := filepath.Join(root, "tests", "github", "TheAlgorithms", "Mochi")
	outDir := filepath.Join(root, "tests", "algorithms", "x", "OCaml")
	readmePath := filepath.Join(root, "archived", "transpiler", "x", "ocaml", "ALGORITHMS.md")
	...
	buf.WriteString("# OCaml Algorithms Transpiler Output\n\n")

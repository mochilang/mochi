...
func TestFSTranspiler_PrintHello(t *testing.T) {
	...
	wantPath := filepath.Join(root, "archived", "tests", "archived", "transpiler", "x", "fs", "print_hello.out")
	...
	goldenSrc := filepath.Join(root, "archived", "tests", "archived", "transpiler", "x", "fs", "print_hello.fs")

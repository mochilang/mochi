...
func TestFSTranspiler_VMValid_Golden(t *testing.T) {
	root := repoRoot(t)
	outDir := filepath.Join(root, "archived", "tests", "archived", "transpiler", "x", "fs")
...
func updateReadme() {
	...
	outDir := filepath.Join(root, "archived", "tests", "archived", "transpiler", "x", "fs")
	readmePath := filepath.Join(root, "archived", "transpiler", "x", "fs", "README.md")
...
func updateTasks() {
	...
	srcDir := filepath.Join(root, "tests", "vm", "valid")
	outDir := filepath.Join(root, "archived", "tests", "archived", "transpiler", "x", "fs")
	taskFile := filepath.Join(root, "archived", "transpiler", "x", "fs", "TASKS.md")

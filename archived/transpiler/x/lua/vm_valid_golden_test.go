...
func TestLuaTranspiler_VMValid_Golden(t *testing.T) {
	...
	root := findRepoRoot(t)
	outDir := filepath.Join(root, "archived", "tests", "archived", "transpiler", "x", "lua")
...
func updateReadme() {
	...
	binDir := filepath.Join(root, "archived", "tests", "archived", "transpiler", "x", "lua")
	readmePath := filepath.Join(root, "archived", "transpiler", "x", "lua", "README.md")
...
func updateTasks() {
	root := findRepoRoot(&testing.T{})
	taskFile := filepath.Join(root, "archived", "transpiler", "x", "lua", "TASKS.md")
	srcDir := filepath.Join(root, "tests", "vm", "valid")
	binDir := filepath.Join(root, "archived", "tests", "archived", "transpiler", "x", "lua")

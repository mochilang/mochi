...
func TestCPPCompiler_TPCH_Golden(t *testing.T) {
	...
	for _, q := range []string{"q1", "q2"} {
		...
		wantCode, err := os.ReadFile(filepath.Join(root, "tests", "dataset", "tpc-h", "compiler", "cpp", q+".cpp.out"))
		if err != nil {
		...
		wantOut, err := os.ReadFile(filepath.Join(root, "tests", "dataset", "tpc-h", "compiler", "cpp", q+".out"))
		if err != nil {

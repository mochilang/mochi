// Generated by Mochi 0.10.32 on 2025-07-22 10:54 +0700
#include <stdio.h>
#include <string.h>
...
int main(void) {
    ...
    for (size_t i = 0; i < 4; i++) {
        ...
        if ((person.age >= 18)) {
            adults[adults_len++] = (Adult){person.name,person.age,person.age >= 60};
        }
    }
    puts("--- Adults ---");
    for (size_t i = 0; i < adults_len; i++) {
        Adult person = adults[i];
        if ((person.is_senior)) {

...
static combos_item_list_t create_combos_item_list(int len) {
...
int main() {
  ...
  {
    int first = 1;
    if (!first && strlen("--- Cross Join of three lists ---") > 0)
      printf(" ");
    if (strlen("--- Cross Join of three lists ---") > 0)
      printf("%s", "--- Cross Join of three lists ---");
    if (strlen("--- Cross Join of three lists ---") > 0)
      first = 0;
    printf("\n");
  }

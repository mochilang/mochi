...
## Remaining Tasks
- Implement grouping and join support in the C backend
- Emit helper functions for aggregation operations (sum, avg, count)
- Add golden tests for TPC-H and JOB dataset queries

...
int main() {
  ...
  list_int ys = tmp2;
  {
    ...
    if (!first)
      printf(" ");
    printf("%s", (contains_list_int(ys, 1)) ? "true" : "false");
    first = 0;
    printf("\n");
  }
  {
    ...
    if (!first)
      printf(" ");
    printf("%s", (contains_list_int(ys, 2)) ? "true" : "false");
    first = 0;
    printf("\n");
  }
  map_string_int m = (tmp_item_t){.a = 1};
  {
    ...
    if (!first)
      printf(" ");
    printf("%s", (map_string_int_contains(m, "a")) ? "true" : "false");
    first = 0;
    printf("\n");
  }
  {
    ...
    if (!first)
      printf(" ");
    printf("%s", (map_string_int_contains(m, "b")) ? "true" : "false");
    first = 0;
    printf("\n");
  }
  {
    ...
    if (!first)
      printf(" ");
    printf("%s", (contains_string(s, "ell")) ? "true" : "false");
    first = 0;
    printf("\n");
  }
  {
    ...
    if (!first)
      printf(" ");
    printf("%s", (contains_string(s, "foo")) ? "true" : "false");
    first = 0;
    printf("\n");
  }
  free(tmp2.data);

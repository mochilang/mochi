...
main :-
    ...
    People_11 = _V10,
    dict_create(_V12, p_person, ['name'-"Alice", 'age'-17, 'status'-"minor"]),
    dict_create(_V13, p_person, ['name'-"Bob", 'age'-26, 'status'-"adult"]),
    dict_create(_V14, p_person, ['name'-"Charlie", 'age'-19, 'status'-"adult"]),
    dict_create(_V15, p_person, ['name'-"Diana", 'age'-16, 'status'-"minor"]),
    expect((People_11 == [_V12, _V13, _V14, _V15])),
    writeln("ok"),
    true.

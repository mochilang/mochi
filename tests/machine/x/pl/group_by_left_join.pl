...
main :-
    ...
    Orders = [_V3, _V4, _V5],
    findall(_V15, (member(C, Customers), findall(O, (member(O, Orders), get_item(O, 'customerid', _V6), get_item(C, 'id', _V7), (_V6 == _V7)), _V8), (_V8 = [] -> O = nil; member(O, _V8)), true, get_item(G, 'key', _V9), findall(_V11, (member(R, G), get_item(R, 'o', _V10), _V10, _V11 = R), _V12), length(_V12, _V13), dict_create(_V14, map, [name-_V9, count-_V13]), _V15 = _V14), _V16),
    Stats = _V16,

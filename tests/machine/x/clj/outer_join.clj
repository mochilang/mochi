...
(defn -main []
  ...
  (def orders [{:id 100 :customerId 1 :total 250} {:id 101 :customerId 2 :total 125} {:id 102 :customerId 1 :total 300} {:id 103 :customerId 5 :total 80}]) ;; list of map of string to int
  (def result (let [_src orders]
  (_query _src [
    {:items customers :on (fn [o c] (= (:customerId o) (:id c))) :left true :right true}

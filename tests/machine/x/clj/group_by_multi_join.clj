; Generated by Mochi compiler v0.10.26 on 2025-07-16T16:57:05Z
(ns main)
...
(defn -main []
  ...
  (def grouped (map (fn [g] {:part (:key g) :total (reduce + 0 (vec (->> (for [r (:Items g)] (:value r)))))}) (_group_by filtered (fn [x] (:part x))))) ;; list of
  (println grouped)
)

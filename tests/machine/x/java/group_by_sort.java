import java.util.*;
public class Main {
	static List<Map<Object,Object>> items = java.util.Arrays.asList(map("cat", "a", "val", 3), map("cat", "a", "val", 1), map("cat", "b", "val", 5), map("cat", "b", "val", 2));
	...
	for (var __e : _groups1.entrySet()) {
		...
		_res0.add(map("cat", g_key, "total", sum((List<Number>)(List<?>)(new java.util.function.Supplier<List<Object>>() {public List<Object> get() {

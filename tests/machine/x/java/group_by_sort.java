...
public class GroupBySort {
	static List<Map<String,Object>> items = new ArrayList<>(Arrays.asList(mapOfEntries(entry("cat", "a"), entry("val", 3)), mapOfEntries(entry("cat", "a"), entry("val", 1)), mapOfEntries(entry("cat", "b"), entry("val", 5)), mapOfEntries(entry("cat", "b"), entry("val", 2))));
	...
	for (var __e : _groups7.entrySet()) {
		...
		_res6.add(mapOfEntries(entry("cat", g_key), entry("total", (new java.util.function.Supplier<List<Object>>(){public List<Object> get(){

...
public class OrderByMap {
	static List<Map<String,Integer>> data = new ArrayList<>(Arrays.asList(mapOfEntries(entry("a", 1), entry("b", 2)), mapOfEntries(entry("a", 1), entry("b", 1)), mapOfEntries(entry("a", 0), entry("b", 5))));

...
public class DatasetWhereFilter {
	static List<Map<String,Object>> people = new ArrayList<>(Arrays.asList(mapOfEntries(entry("name", "Alice"), entry("age", 30)), mapOfEntries(entry("name", "Bob"), entry("age", 15)), mapOfEntries(entry("name", "Charlie"), entry("age", 65)), mapOfEntries(entry("name", "Diana"), entry("age", 45))));

...
- [ ] Support generics for user-defined types
- [ ] Emit comments from Mochi source code
- [ ] Implement constant inlining when possible
- [ ] Optimize query translation
- [ ] Handle tail-call optimization for recursive functions
- [ ] Improve pattern matching code generation
- [ ] Clean up temporary variable names
- [ ] Use switch statements where appropriate
- [ ] Add command-line flags for compiler options
- [ ] Document the mapping from Mochi types to Java types

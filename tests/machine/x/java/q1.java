// Generated by Mochi compiler v0.10.24 on 2025-07-13T01:53:36Z
// q1.mochi
import java.util.*;
...
public class Q1 {
    ...
    return res8;
}}).get().stream().mapToInt(n -> ((Number)n).intValue()).sum(), (new java.util.function.Supplier<List<Integer>>(){public List<Integer> get(){

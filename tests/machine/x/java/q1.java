...
class LQuantityLExtendedpriceLDiscountLTaxLReturnflagLLinestatusLShipdate {
    int l_quantity;
    ...
    String l_linestatus;
    String l_shipdate;
    LQuantityLExtendedpriceLDiscountLTaxLReturnflagLLinestatusLShipdate(int l_quantity, double l_extendedprice, double l_discount, double l_tax, String l_returnflag, String l_linestatus, String l_shipdate) {
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof LQuantityLExtendedpriceLDiscountLTaxLReturnflagLLinestatusLShipdate other)) return false;
...
class ReturnflagLinestatusSumQtySumBasePriceSumDiscPriceSumChargeAvgQtyAvgPriceAvgDiscCountOrder {
    ...
    double avg_disc;
    int count_order;
    ReturnflagLinestatusSumQtySumBasePriceSumDiscPriceSumChargeAvgQtyAvgPriceAvgDiscCountOrder(Object returnflag, Object linestatus, int sum_qty, int sum_base_price, int sum_disc_price, int sum_charge, double avg_qty, double avg_price, double avg_disc, int count_order) {
...
class ReturnflagLinestatus {
    String returnflag;
    String linestatus;
    ReturnflagLinestatus(String returnflag, String linestatus) {
        this.returnflag = returnflag;
        this.linestatus = linestatus;
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof ReturnflagLinestatus other)) return false;
...
public class Q1 {
    ...
    List<LQuantityLExtendedpriceLDiscountLTaxLReturnflagLLinestatusLShipdate> lineitem = new ArrayList<>(Arrays.asList(new LQuantityLExtendedpriceLDiscountLTaxLReturnflagLLinestatusLShipdate(17, 1000.000000, 0.050000, 0.070000, "N", "O", "1998-08-01"), new LQuantityLExtendedpriceLDiscountLTaxLReturnflagLLinestatusLShipdate(36, 2000.000000, 0.100000, 0.050000, "N", "O", "1998-09-01"), new LQuantityLExtendedpriceLDiscountLTaxLReturnflagLLinestatusLShipdate(25, 1500.000000, 0.000000, 0.080000, "R", "F", "1998-09-03")));
    ...
    Map<ReturnflagLinestatus,List<LQuantityLExtendedpriceLDiscountLTaxLReturnflagLLinestatusLShipdate>> groups1 = new LinkedHashMap<>();
    for (var row : lineitem) {
        if (!(String.valueOf(row.l_shipdate).compareTo(String.valueOf("1998-09-02")) <= 0)) continue;
        var row2 = row;
        ReturnflagLinestatus key3 = new ReturnflagLinestatus(row.l_returnflag, row.l_linestatus);
        List<LQuantityLExtendedpriceLDiscountLTaxLReturnflagLLinestatusLShipdate> bucket4 = groups1.get(key3);
        if (bucket4 == null) { bucket4 = new ArrayList<>(); groups1.put(key3, bucket4); }
        bucket4.add(row2);
    }
    for (Map.Entry<ReturnflagLinestatus,List<LQuantityLExtendedpriceLDiscountLTaxLReturnflagLLinestatusLShipdate>> __e : groups1.entrySet()) {
        ReturnflagLinestatus g_key = __e.getKey();
        Group<ReturnflagLinestatus,LQuantityLExtendedpriceLDiscountLTaxLReturnflagLLinestatusLShipdate> g = new Group<>(g_key, __e.getValue());

import java.util.*;
public class Main {
	static List<Map<Object,Object>> items = java.util.Arrays.asList(map("cat", "a", "val", 10, "flag", true), map("cat", "a", "val", 5, "flag", false), map("cat", "b", "val", 20, "flag", true));
	...
	for (var __e : _groups1.entrySet()) {
		...
		_res0.add(map("cat", g_key, "share", ((Number)sum((List<Number>)(List<?>)(new java.util.function.Supplier<List<Object>>() {public List<Object> get() {

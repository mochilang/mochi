...
// Generated by Mochi compiler v0.10.25 on 2025-07-14T03:05:49Z
...
type v struct {
	...
	Sum_qty        int     `json:"sum_qty"`
	Sum_base_price int     `json:"sum_base_price"`
	...
	result = _convSlice[v, Result](func() []Result {
		...
		for _, g := range items {
			results = append(results, Result{
				Returnflag: _getField(g.Key, "returnflag"),
				Linestatus: _getField(g.Key, "linestatus"),

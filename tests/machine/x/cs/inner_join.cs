...
public class Program {
    public static void Main() {
        ...
        Dictionary<string, int>[] orders = new Dictionary<string, int>[] { new Dictionary<string, int> { { "id", 100 }, { "customerId", 1 }, { "total", 250 } }, new Dictionary<string, int> { { "id", 101 }, { "customerId", 2 }, { "total", 125 } }, new Dictionary<string, int> { { "id", 102 }, { "customerId", 1 }, { "total", 300 } }, new Dictionary<string, int> { { "id", 103 }, { "customerId", 4 }, { "total", 80 } } };

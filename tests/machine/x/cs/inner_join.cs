...
public class Program
{
    public static void Main()
    {
        ...
        Dictionary<string, long>[] orders = new Dictionary<string, long>[] { new Dictionary<string, long> { { "id", 100L }, { "customerId", 1L }, { "total", 250L } }, new Dictionary<string, long> { { "id", 101L }, { "customerId", 2L }, { "total", 125L } }, new Dictionary<string, long> { { "id", 102L }, { "customerId", 1L }, { "total", 300L } }, new Dictionary<string, long> { { "id", 103L }, { "customerId", 4L }, { "total", 80L } } };

...
public class Program
{
    public static void Main()
    {
        ...
        var stats = _group_by(people, person => person["city"]).Select(g => new Dictionary<string, dynamic> { { "city", g["key"] }, { "count", Enumerable.Count(g) }, { "avg_age", Enumerable.Average(g.Select(p => p["age"]).Select(_tmp1 => Convert.ToDouble(_tmp1))) } }).ToList();

...
class Program
{
    static void Main()
    {
        List<People> people = new List<dynamic> { new People { name = "Alice", age = 30 }, new People { name = "Bob", age = 15 }, new People { name = "Charlie", age = 65 }, new People { name = "Diana", age = 45 } };

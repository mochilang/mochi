...
public class Program
{
    ...
    {
        Console.WriteLine(_union(new long[] { 1, 2 }, new long[] { 2, 3 }));
        Console.WriteLine(_except(new long[] { 1, 2, 3 }, new long[] { 2 }));
        Console.WriteLine(_intersect(new long[] { 1, 2, 3 }, new long[] { 2, 4 }));
        Console.WriteLine(_union_all(new long[] { 1, 2 }, new long[] { 2, 3 }).Length);
    }

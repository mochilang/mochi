...
class Program
{
    static void Main()
    {
        List<Customer> customers = new List<dynamic> { new Customer { id = 1, name = "Alice" }, new Customer { id = 2, name = "Bob" }, new Customer { id = 3, name = "Charlie" } };
        List<Order> orders = new List<dynamic> { new Order { id = 100, customerId = 1, total = 250 }, new Order { id = 101, customerId = 2, total = 125 }, new Order { id = 102, customerId = 1, total = 300 } };
        List<Result> result = new Func<List<dynamic>>(() =>
        {

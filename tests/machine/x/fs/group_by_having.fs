// Generated by Mochi compiler v0.10.26 on 2025-07-16T16:26:58Z
open System
...
let big: Anon2 list = [ for g in _group_by [ for p in people do yield p ] (fun p -> p.city) |> List.filter (fun gTmp -> let g = gTmp in List.length g.Items >= 4) do

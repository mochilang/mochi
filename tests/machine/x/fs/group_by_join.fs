// Generated by Mochi compiler v0.10.26 on 2025-07-16T16:27:00Z
open System
...
let stats: Anon3 list = [ for g in _group_by [ for o in orders do 
  for c in customers do if o.customerId = c.id then yield (o, c) ] (fun (o, c) -> c.name) do

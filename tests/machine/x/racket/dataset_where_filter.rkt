...
(define adults (for*/list ([person people] #:when (and (>= (hash-ref person 'age) 18))) (hash 'name (hash-ref person 'name) 'age (hash-ref person 'age) 'is_senior (>= (hash-ref person 'age) 60))))
(displayln "--- Adults ---")

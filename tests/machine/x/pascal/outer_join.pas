// Generated by Mochi compiler v0.10.26 on 2025-07-16T15:43:26Z
program OuterJoin;
{$mode objfpc}
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        writeln('Order', ' ', row.KeyData['order'].id, ' ', 'by', ' ', row.KeyData['customer'].name, ' ', '- $', ' ', row.KeyData['order'].total);
      end else
      begin
        writeln('Order', ' ', row.KeyData['order'].id, ' ', 'by', ' ', 'Unknown', ' ', '- $', ' ', row.KeyData['order'].total);
      end;
    end else
    begin

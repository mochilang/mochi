...
(define people (list (list (cons 'name "Alice") (cons 'city "Paris")) (list (cons 'name "Bob") (cons 'city "Hanoi")) (list (cons 'name "Charlie") (cons 'city "Paris")) (list (cons 'name "Diana") (cons 'city "Hanoi")) (list (cons 'name "Eve") (cons 'city "Paris")) (list (cons 'name "Frank") (cons 'city "Hanoi")) (list (cons 'name "George") (cons 'city "Paris"))))
(define big (let ((_tmp '()))
  (for-each (lambda (p)

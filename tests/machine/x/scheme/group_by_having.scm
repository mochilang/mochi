; Generated by Mochi compiler v0.10.26 on 2025-07-16T16:35:22Z
(define (map-get m k)
    (let ((p (assoc k m)))
        (if p (cdr p) '()))
)
...
(define big '())
(define people '())
(set! people (list (list (cons 'name "Alice") (cons 'city "Paris")) (list (cons 'name "Bob") (cons 'city "Hanoi")) (list (cons 'name "Charlie") (cons 'city "Paris")) (list (cons 'name "Diana") (cons 'city "Hanoi")) (list (cons 'name "Eve") (cons 'city "Paris")) (list (cons 'name "Frank") (cons 'city "Hanoi")) (list (cons 'name "George") (cons 'city "Paris"))))
(set! big (let ((_tmp '()))
  (for-each (lambda (p)
  ...
  (let ((_res '()))
    (for-each (lambda (g)
      (when (_ge (_count g) 4) (set! _res (append _res (list (list (cons 'city (map-get g 'key)) (cons 'num (_count g)))))))

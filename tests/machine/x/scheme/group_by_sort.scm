; Generated by Mochi compiler v0.10.26 on 2025-07-16T16:35:29Z
(define (map-get m k)
    (let ((p (assoc k m)))
        (if p (cdr p) '()))
)
...
(define grouped '())
(define items '())
(set! items (list (list (cons 'cat "a") (cons 'val 3)) (list (cons 'cat "a") (cons 'val 1)) (list (cons 'cat "b") (cons 'val 5)) (list (cons 'cat "b") (cons 'val 2))))

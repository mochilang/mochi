; Generated by Mochi compiler v0.10.26 on 2025-07-16T17:40:16Z
(define (map-get m k)
    (let ((p (assoc k m)))
        (if p (cdr p) '()))
)
...
(set! orders (list (list (cons 'id 100) (cons 'customerId 1)) (list (cons 'id 101) (cons 'customerId 1)) (list (cons 'id 102) (cons 'customerId 2))))
(set! stats (let ((_tmp '()))
  (for-each (lambda (c)
    (let ((_ms0 '()) (_m0 #f))
      (for-each (lambda (o)

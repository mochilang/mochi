...
(define orders (list (list (cons "id" 100) (cons "customerId" 1) (cons "total" 250)) (list (cons "id" 101) (cons "customerId" 2) (cons "total" 125)) (list (cons "id" 102) (cons "customerId" 1) (cons "total" 300))))

; Generated by Mochi compiler v0.10.26 on 2025-07-16T16:36:33Z
...
(begin (display (_lt "a" "b")) (newline))
(begin (display (_le "a" "a")) (newline))
(begin (display (_gt "b" "a")) (newline))
(begin (display (_ge "b" "b")) (newline))

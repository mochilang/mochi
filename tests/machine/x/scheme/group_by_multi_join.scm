; Generated by Mochi compiler v0.10.26 on 2025-07-16T15:40:00Z
(define (map-get m k)
    (let ((p (assoc k m)))
        (if p (cdr p) '()))
)
...
(define partsupp '())
(define suppliers '())
(set! nations (list (list (cons 'id 1) (cons 'name "A")) (list (cons 'id 2) (cons 'name "B"))))
(set! suppliers (list (list (cons 'id 1) (cons 'nation 1)) (list (cons 'id 2) (cons 'nation 2))))
(set! partsupp (list (list (cons 'part 100) (cons 'supplier 1) (cons 'cost 10.0) (cons 'qty 2)) (list (cons 'part 100) (cons 'supplier 2) (cons 'cost 20.0) (cons 'qty 1)) (list (cons 'part 200) (cons 'supplier 1) (cons 'cost 5.0) (cons 'qty 3))))
(set! filtered (let ((_res '()))
  (for-each (lambda (ps)
    (for-each (lambda (s)

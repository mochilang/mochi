; Generated by Mochi compiler v0.10.26 on 2025-07-16T17:40:23Z
(define (map-get m k)
    (let ((p (assoc k m)))
        (if p (cdr p) '()))
)
...
(define tmp '())
(define total '())
(set! data (list (list (cons 'tag "a") (cons 'val 1)) (list (cons 'tag "a") (cons 'val 2)) (list (cons 'tag "b") (cons 'val 3))))
(set! groups (let ((_tmp '()))
  (for-each (lambda (d)

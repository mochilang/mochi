# Generated by Mochi compiler v0.10.27 on 2025-07-17T08:18:24Z
defmodule Main do
  def main do
    IO.puts(Enum.map_join(Enum.slice([1, 2, 3], 1, 3 - 1), " ", &inspect(&1)))
    IO.puts(Enum.map_join(Enum.slice([1, 2, 3], 0, 2 - 0), " ", &inspect(&1)))

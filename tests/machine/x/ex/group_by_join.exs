# Generated by Mochi compiler v0.10.27 on 2025-07-17T08:06:16Z
defmodule Main do
  def main do
    # customers :: list(map())
      ...
      (fn ->
         ...
         rows =
           _query(
             ...
             %{select: fn o, c -> _merge_map(_merge_map(o, c), %{o: o, c: c}) end}
           )

         groups = _group_by(rows, fn %{o: o, c: c} -> c.name end)
         items = groups

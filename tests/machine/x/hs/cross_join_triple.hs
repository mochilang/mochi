...
main = do
  ...
  mapM_ (\c -> putStrLn (unwords [_showAny (fromMaybe (error "missing") (Map.lookup "n" c)), _showAny (fromMaybe (error "missing") (Map.lookup "l" c)), _showAny (fromMaybe (error "missing") (Map.lookup "b" c))])) combos

...
for _, entry in ipairs(result) do
    if entry.order then
        print(table.concat({"Customer", __to_string(entry.customerName), "has order", __to_string(entry.order.id), "- $", __to_string(entry.order.total)}, ' '));
    else
        print(table.concat({"Customer", __to_string(entry.customerName), "has no orders"}, ' '));
    end
end

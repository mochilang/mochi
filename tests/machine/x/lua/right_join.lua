...
for _, entry in ipairs(result) do
    if entry.order then
        print((table.concat({__str("Customer"), __str(entry.customerName), __str("has order"), __str(entry.order.id), __str("- $"), __str(entry.order.total)}, ' ')):gsub(' +$',''))
    else
        print((table.concat({__str("Customer"), __str(entry.customerName), __str("has no orders")}, ' ')):gsub(' +$',''))
    end
end

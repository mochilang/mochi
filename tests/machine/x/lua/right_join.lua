...
for _, entry in ipairs(result) do
    if entry.order then
        print(__str("Customer") .. " " .. __str(entry.customerName) .. " " .. __str("has order") .. " " .. __str(entry.order.id) .. " " .. __str("- $") .. " " .. __str(entry.order.total))
    else
        print(__str("Customer") .. " " .. __str(entry.customerName) .. " " .. __str("has no orders"))
    end
end

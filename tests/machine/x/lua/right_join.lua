...
for _, entry in ipairs(result) do
    if entry.order then
        __print(__str("Customer"), __str(entry.customerName), __str("has order"), __str(entry.order.id), __str("- $"), __str(entry.order.total))
    else
        __print(__str("Customer"), __str(entry.customerName), __str("has no orders"))
    end
end

...
for _, entry in ipairs(result) do
    print((table.concat({__str("Order"), __str(entry.orderId), __str("(customerId:"), __str(entry.orderCustomerId), __str(", total: $"), __str(entry.orderTotal), __str(") paired with"), __str(entry.pairedCustomerName)}, ' ')):gsub(' +$',''))
end

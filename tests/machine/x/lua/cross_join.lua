...
for _, entry in ipairs(result) do
    print(table.concat({tostring("Order"), tostring(entry.orderId), tostring("(customerId:"), tostring(entry.orderCustomerId), tostring(", total: $"), tostring(entry.orderTotal), tostring(") paired with"), tostring(entry.pairedCustomerName)}, ' '))
end

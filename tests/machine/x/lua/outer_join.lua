...
for _, row in ipairs(result) do
    if row.order then
        if row.customer then
            print(table.concat({tostring("Order"), tostring(row.order.id), tostring("by"), tostring(row.customer.name), tostring("- $"), tostring(row.order.total)}, ' '))
        else
            print(table.concat({tostring("Order"), tostring(row.order.id), tostring("by"), tostring("Unknown"), tostring("- $"), tostring(row.order.total)}, ' '))
        end
    else
        print(table.concat({tostring("Customer"), tostring(row.customer.name), tostring("has no orders")}, ' '))
    end
end

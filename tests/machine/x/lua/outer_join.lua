...
for _, row in ipairs(result) do
    if row.order then
        if row.customer then
            print(__str("Order") .. " " .. __str(row.order.id) .. " " .. __str("by") .. " " .. __str(row.customer.name) .. " " .. __str("- $") .. " " .. __str(row.order.total))
        else
            print(__str("Order") .. " " .. __str(row.order.id) .. " " .. __str("by") .. " " .. __str("Unknown") .. " " .. __str("- $") .. " " .. __str(row.order.total))
        end
    else
        print(__str("Customer") .. " " .. __str(row.customer.name) .. " " .. __str("has no orders"))
    end
end

...
xs = {1, 2, 3}
print(__str((function(_l,_v) for _,x in ipairs(_l) do if x == _v then return true end end return false end)(xs,2)))
print(__str(not ((function(_l,_v) for _,x in ipairs(_l) do if x == _v then return true end end return false end)(xs,5))))

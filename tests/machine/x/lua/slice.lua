...
__print((function(_l,_i,_j)local _o={} for k=_i+1,_j do _o[#_o+1]=_l[k] end return _o end)({1, 2, 3},1,3))
__print((function(_l,_i,_j)local _o={} for k=_i+1,_j do _o[#_o+1]=_l[k] end return _o end)({1, 2, 3},0,2))
__print(string.sub("hello", (1)+1, 4))

...
nums = {1, 2, 3};
print(__to_string((function(_l,_v) for _,x in ipairs(_l) do if x == _v then return true end end return false end)(nums,2)));
print(__to_string((function(_l,_v) for _,x in ipairs(_l) do if x == _v then return true end end return false end)(nums,4)));

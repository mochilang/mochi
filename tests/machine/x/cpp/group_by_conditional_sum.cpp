...
inline bool operator==(const Result &a, const Result &b) { return a.i == b.i; }
  ...
  auto result = ([&]() {
    ...
    for (auto i : items) {
      ...
      for (auto &__g : __groups) {
        if (__g.key == __key) {
          __g.items.push_back(Result{i});
          __found = true;
          break;
        }
      }
      if (!__found) {
        __groups.push_back(__struct3{__key, std::vector<Result>{Result{i}}});
      }
    }
          ...
          {g.key,
           __struct4{
               ...
               (([&](auto v) {
                  ...
                  std::vector<decltype((std::declval<Result>().flag
                                            ? std::declval<Result>().val
                                            : 0))>
                      __items;
                  for (auto x : g.items) {
                ...
                ([&](auto v) {
                  ...
                  std::vector<decltype(std::declval<Result>().val)> __items;
                  for (auto x : g.items) {

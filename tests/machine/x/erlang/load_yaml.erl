...
main(_) ->
    People = [#{"__name" => "Person", name => "Alice", age => 30, email => "alice@example.com"}, #{"__name" => "Person", name => "Bob", age => 15, email => "bob@example.com"}, #{"__name" => "Person", email => "charlie@example.com", name => "Charlie", age => 20}],

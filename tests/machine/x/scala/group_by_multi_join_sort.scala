// Generated by Mochi compiler v0.10.26 on 2025-07-16T17:39:47Z
object group_by_multi_join_sort {
  ...
  case class Result1(c_custkey: Int, c_name: String, revenue: Double, c_acctbal: Double, n_name: String, c_address: String, c_phone: String, c_comment: String)

...
pub fn main() void {
    result = blk0: { var _tmp1 = std.ArrayList(ResultItem).init(std.heap.page_allocator); for (orders) |o| { for (customers) |c| { if (!((o.customerId == c.id))) continue; _tmp1.append(ResultItem{
    .orderId = o.id,
    .customerName = c.name,
    .total = o.total,

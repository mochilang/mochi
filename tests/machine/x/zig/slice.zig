...
pub fn main() void {
    std.debug.print("{any}\n", .{_slice_list(i32, &[_]i32{ @as(i32, @intCast(1)), @as(i32, @intCast(2)), @as(i32, @intCast(3)) }, @as(i32, @intCast(1)), @as(i32, @intCast(3)), 1)});
    std.debug.print("{any}\n", .{_slice_list(i32, &[_]i32{ @as(i32, @intCast(1)), @as(i32, @intCast(2)), @as(i32, @intCast(3)) }, @as(i32, @intCast(0)), @as(i32, @intCast(2)), 1)});
    std.debug.print("{any}\n", .{_slice_string("hello", @as(i32, @intCast(1)), @as(i32, @intCast(4)), 1)});
}

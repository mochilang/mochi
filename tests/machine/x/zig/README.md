# Machine Generated Zig Code

The files in this directory were produced by the Zig compiler tests. Each Mochi program from `tests/vm/valid` was compiled to Zig and executed. All programs listed below successfully compiled and ran.

...
print(" ".join([_fmt("Circle area with r ="), _fmt(r), _fmt("=>"), _fmt(area)]))
print(" ".join([_fmt("Square root of 49:"), _fmt(root)]))
print(" ".join([_fmt("sin(π/4):"), _fmt(sin45)]))
print(" ".join([_fmt("log(e):"), _fmt(log_e)]))

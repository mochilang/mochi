# Generated by Mochi compiler v0.10.26 on 2025-07-16T18:29:18Z
...
print(_fmt("--- Outer Join using syntax ---"))
for row in result:
    if row.order:
        if row.customer:
            print(
        ...
        print(
            " ".join([_fmt("Customer"), _fmt(row.customer.name), _fmt("has no orders")])
        )

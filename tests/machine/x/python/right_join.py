# Generated by Mochi compiler v0.10.26 on 2025-07-16T17:32:15Z
...
print(_fmt("--- Right Join using syntax ---"))
for entry in result:
    if entry.order:
        print(
            " ".join(
        ...
        print(
            " ".join(
                [_fmt("Customer"), _fmt(entry.customerName), _fmt("has no orders")]
            )
        )

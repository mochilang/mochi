# Generated by Mochi compiler v0.10.27 on 2025-07-17T07:49:24Z
...
result = _query(
    ...
    {"select": lambda o, c: Auto1(orderId=o.id, customerName=c.name, total=o.total)},
)
print("--- Orders with customer info ---")
for entry in result:
    print(
        f"Order {_fmt(entry.orderId)} by {_fmt(entry.customerName)} - $ {_fmt(entry.total)}"
    )

...
building_customers: list[dict[str, typing.Any]] = [
    c for c in customer if c["c_mktsegment"] == segment
]
valid_orders: list[dict[str, typing.Any]] = _query(
    orders,
    [
        {
            "items": building_customers,
            "on": lambda o, c: o["o_custkey"] == c["c_custkey"],
        }
    ],
    {"select": lambda o, c: o, "where": lambda o, c: o["o_orderdate"] < cutoff},
)
valid_lineitems: list[dict[str, typing.Any]] = [

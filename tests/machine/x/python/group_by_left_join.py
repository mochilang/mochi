# Generated by Mochi compiler v0.10.26 on 2025-07-16T18:32:53Z
...
def _q0():
    ...
    _items1 = _groups
    return [Auto1(name=g.key, count=len([r for r in g if r[1]])) for g in _items1]


stats = _q0()
print(_fmt("--- Group Left Join ---"))
for s in stats:
    print(" ".join((x for x in [_fmt(s.name), _fmt("orders:"), _fmt(s.count)] if x)))

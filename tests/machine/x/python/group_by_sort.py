# Generated by Mochi compiler v0.10.26 on 2025-07-17T00:55:09Z
...
def _q0():
    ...
    _items1 = _groups
    _items1 = sorted(_items1, key=lambda g: _sort_key(-sum([x.val for x in g])))
    return [Auto1(cat=g.key, total=sum([x.val for x in g])) for g in _items1]

...
nations: list[Nation] = [Nation(id=1, name="A"), Nation(id=2, name="B")]
suppliers: list[Supplier] = [Supplier(id=1, nation=1), Supplier(id=2, nation=2)]
partsupp: list[Partsupp] = [
    Partsupp(part=100, supplier=1, cost=10, qty=2),
    Partsupp(part=100, supplier=2, cost=20, qty=1),
    Partsupp(part=200, supplier=1, cost=5, qty=3),
]

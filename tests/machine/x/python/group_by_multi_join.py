# Generated by Mochi compiler v0.10.25 on 2025-07-14T02:58:43Z
...
filtered = _query(
    ...
    {
        "select": lambda ps, s, n: Filtered(part=ps.part, value=ps.cost * ps.qty),
...
def _q0():
    ...
    _items1 = _groups
    return [
        Grouped(part=_get(g, "key"), total=_sum([r.value for r in g])) for g in _items1
    ]

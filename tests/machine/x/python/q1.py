# Generated by Mochi compiler v0.10.25 on 2025-07-13T19:26:28Z
...
def _q0():
    ...
    _groups = _group_by(
        _rows,
        lambda row: {"returnflag": row.l_returnflag, "linestatus": row.l_linestatus},
    )
    _items1 = _groups
    return [
        {
...
result: list[dict[str, object]] = _q0()

// Generated by Mochi compiler v0.10.26 on 2025-07-16T16:30:26Z
import 'dart:io';
import 'dart:convert';
...
void main() {
  ...
  for (var entry in result) {
    if (entry['order'] != null) {
      _print(['Customer', entry['customerName'], 'has order', entry['order']['id'], '- \$', entry['order']['total']].join(' '));
    }
    else {
      _print(['Customer', entry['customerName'], 'has no orders'].join(' '));
    }
  }
}

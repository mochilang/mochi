// Generated by Mochi compiler v0.10.26 on 2025-07-16T16:29:34Z
import 'dart:io';
import 'dart:convert';
...
void main() {
  ...
  for (var entry in result) {
    _print(['Order', entry['orderId'], '(customerId:', entry['orderCustomerId'], ', total: \$', entry['orderTotal'], ') paired with', entry['pairedCustomerName']].join(' '));
  }
}

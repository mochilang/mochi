; Generated by Mochi compiler v0.10.26 on 2025-07-16T12:25:50Z
          ...
          (when (_lt p np)
            ...
            (if (equal? strategy "optimal")
              ...
              (call/cc (lambda (brk2)
                (let loop2 ()
                  (when (_lt d 50)
                    (set! n (modulo (* (current-seconds) 1000000000) 100))
                    (let loop ()
...
(set! rf (* (/ (exact->inexact pardoned) (exact->inexact trials)) 100.0))

; Generated by Mochi compiler v0.10.28 on 2025-07-18T11:21:44Z
...
(define (randMove )
  (call/cc (lambda (return)
    (return (modulo (* (current-seconds) 1000000000) 4))
  ))
)
...
(call/cc (lambda (return)
  ...
  (define tmp '())
  (set! r (isValidMove m))
  (when (not (list-ref r "ok"))
    (return #f)
  )
  (set! i empty)
  (set! j (int (list-ref r "idx")))

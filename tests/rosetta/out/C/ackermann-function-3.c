...
int show(int m, int n) {
  err = "";
  int res = ackermann2((int)(m), (int)(n));
  if ((strcmp(err, "") != 0)) {
    char *tmp4 = _str(m);
  ...
  if (bit_len(res) <= 256) {
    ...
    char *tmp19 = _str(res);
    const char *s = tmp19;
    const char *pre = slice_string(s, 0, 20);
    int suf = slice_string(s, strlen(s) - 20, strlen(s));
    char *tmp20 = _str(m);
    ...
    char *tmp31 = _str(m);
    char *tmp32 = concat_string("A(", tmp31);
    char *tmp33 = concat_string(tmp32, ", ");
    char *tmp34 = _str(n);
    char *tmp35 = concat_string(tmp33, tmp34);
    char *tmp36 = concat_string(tmp35, ") = ");
    char *tmp37 = _str(strlen(s));
    char *tmp38 = concat_string(tmp36, tmp37);
    char *tmp39 = concat_string(tmp38, " digits starting/ending with: ");
    char *tmp40 = concat_string(tmp39, pre);

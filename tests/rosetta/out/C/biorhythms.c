...
int mochi_main() {
  list_string tmp38 = list_string_create(2);
  tmp38.data[0] = "1943-03-09";
  tmp38.data[1] = "1972-07-11";
  list_string tmp39 = list_string_create(2);
  tmp39.data[0] = "1809-01-12";
  tmp39.data[1] = "1863-11-19";
  list_string tmp40 = list_string_create(2);
  tmp40.data[0] = "1809-02-12";
  tmp40.data[1] = "1863-11-19";
  list_int pairs_data[] = {tmp38, tmp39, tmp40};

        ...
        for (int e = low; e < (high + 1); e++) {
          for (int f = low; f < (high + 1); f++) {
            ...
            if ((!unique) || isUnique(a, b, c, d, e, f, g)) {
              ...
              tmp2.data[0] = tmp1;
              list_int tmp3 = concat_list_int(valid, tmp2);
              valid = tmp3;
              count = count + 1;
            }
          }
...
int main() {
  ...
  char *tmp4 = _str(r1.data["count"]);
  char *tmp5 = concat_string(tmp4, " unique solutions in 1 to 7");
  printf("%s\n", tmp5);
  printf("%d\n", r1.data["list"]);
  int r2 = getCombs(3, 9, 1);
  char *tmp6 = _str(r2.data["count"]);
  char *tmp7 = concat_string(tmp6, " unique solutions in 3 to 9");
  printf("%s\n", tmp7);
  printf("%d\n", r2.data["list"]);
  int r3 = getCombs(0, 9, 0);
  char *tmp8 = _str(r3.data["count"]);
  char *tmp9 = concat_string(tmp8, " non-unique solutions in 0 to 9");
  printf("%s\n", tmp9);
  return 0;
}

...
list_int getPointsFaces(int points, list_list_int faces) {
  ...
  int fnum = 0;
  while (fnum < faces.len) {
    for (int tmp36 = 0; tmp36 < faces.data[fnum].len; tmp36++) {
      int pn = faces.data[fnum].data[tmp36];
...
const char *key(int a, int b) {
  if (a < b) {
    ...
    char *tmp40 = _str(b);
    char *tmp41 = concat_string(tmp39, tmp40);
    return tmp41;
  }
  char *tmp42 = _str(b);
  char *tmp43 = concat_string(tmp42, ",");
  char *tmp44 = _str(a);
...
list_int cmcSubdiv(int points, list_list_int faces) {
  ...
  for (int tmp46 = 0; tmp46 < facePoints.len; tmp46++) {
    point_t fp = facePoints.data[tmp46];
    newPoints = 0;
    facePointNums = 0;
    nextPoint = nextPoint + 1;
  }
  map_string_int tmp47 = map_string_int_create(0);
  map_string_int edgePointNums = tmp47;
  int idx = 0;
  ...
  list_list_int tmp48 = {0, NULL};
  list_list_int newFaces = tmp48;
  int fnum = 0;
  while (fnum < faces.len) {
    ...
    if (oldFace.len == 4) {
      ...
      list_int tmp49 = list_int_create(4);
      tmp49.data[0] = a;
      tmp49.data[1] = ab;
      tmp49.data[2] = fpnum;
      tmp49.data[3] = da;
      list_list_int tmp50 = list_list_int_create(1);
      tmp50.data[0] = tmp49;
      list_list_int tmp51 = concat_list_list_int(newFaces, tmp50);
      newFaces = tmp51;
  ...
  list_int tmp61 = list_int_create(2);
  tmp61.data[0] = newPoints;
  tmp61.data[1] = newFaces;
  return tmp61;
}
...
const char *formatFace(list_int f) {
  ...
  int i = 1;
  while (i < f.len) {
    char *tmp62 = concat_string(s, " ");
    s = tmp62 + fmt2(f.data[i]);
    i = i + 1;
  }
  char *tmp63 = concat_string(s, "]");
  s = tmp63;
  return s;
}
...
int main() {
  ...
  list_int tmp64 = list_int_create(4);
  tmp64.data[0] = 0;
  tmp64.data[1] = 1;
  tmp64.data[2] = 2;
  tmp64.data[3] = 3;
  list_int tmp65 = list_int_create(4);
  tmp65.data[0] = 3;
  tmp65.data[1] = 2;
  tmp65.data[2] = 4;
  tmp65.data[3] = 5;
  ...
  tmp69.data[2] = 2;
  tmp69.data[3] = 4;
  list_int inputFaces_data[] = {{4, tmp64}, {4, tmp65}, {4, tmp66},
                                {4, tmp67}, {4, tmp68}, {4, tmp69}};
  ...
  for (int tmp70 = 0; tmp70 < outputPoints.len; tmp70++) {
    point_t p = outputPoints.data[tmp70];
    printf("%s\n", formatPoint(&p));
  }
  printf("\n");
  for (int tmp71 = 0; tmp71 < outputFaces.len; tmp71++) {
    list_int f = outputFaces.data[tmp71];
    printf("%s\n", formatFace(f));
  }
}

...
list_int circles(Point *p1, Point *p2, double r) {
  ...
  point_t m = (Point){.x = (p1->x + p2->x) / 2.0, .y = (p1->y + p2->y) / 2.0};
  if (q == 2.0 * r) {
  ...
  double ox = d * dx / q;
  double oy = d * dy / q;
  point_t tmp6[] = {(Point){.x = m.x - oy, .y = m.y + ox},
                    (Point){.x = m.x + oy, .y = m.y - ox}, "Two circles."};
  int tmp6_len = sizeof(tmp6) / sizeof(tmp6[0]);
  return tmp6;
}

int main() {
  point_t td[] = {(Point){.x = 0.1234, .y = 0.9876},
                  (Point){.x = 0.8765, .y = 0.2345}, 2.0};
  int td_len = sizeof(td) / sizeof(td[0]);
  point_t td[] = {(Point){.x = 0.0, .y = 2.0}, (Point){.x = 0.0, .y = 0.0},
                  1.0};
  int td_len = sizeof(td) / sizeof(td[0]);
  point_t td[] = {(Point){.x = 0.1234, .y = 0.9876},
                  (Point){.x = 0.1234, .y = 0.9876}, 2.0};
  int td_len = sizeof(td) / sizeof(td[0]);
  point_t td[] = {(Point){.x = 0.1234, .y = 0.9876},
                  (Point){.x = 0.8765, .y = 0.2345}, 0.5};
  int td_len = sizeof(td) / sizeof(td[0]);
  point_t td[] = {(Point){.x = 0.1234, .y = 0.9876},
                  (Point){.x = 0.1234, .y = 0.9876}, 0.0};
  int td_len = sizeof(td) / sizeof(td[0]);

...
public class M24Game {
    ...
    static void main() {
        List<Object> digits = new ArrayList<>(Arrays.asList());
        for (int i = 0; i < 4; i++) {
        ...
        while (i < expr.size()) {
            ...
            if (String.valueOf(ch).compareTo(String.valueOf("0")) >= 0 && String.valueOf(ch).compareTo(String.valueOf("9")) <= 0) {
                ...
                int j = 0;
                while (!Objects.equals(digits.get(j), int(ch) - int("0"))) {
                    j = (int)(j + 1);

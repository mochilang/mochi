// Generated by Mochi compiler v0.10.26 on 2025-07-16T11:31:50Z
...
public class AliquotSequenceClassifications {
    ...
    static Map<String,any> classifySequence(int k) {
        int last = k;
    ...
    static void main() {
        ...
        int k = 1;
        while (k <= 10) {
            Map<String,any> res = classifySequence(k);
            System.out.println(((Number)((Number)padLeft(k, 2) + ": " + ((Number)padRight(String.valueOf(((any)res.get("aliquot"))), 15)).doubleValue()).doubleValue() + " ").doubleValue() + ((Number)joinWithCommas((List<Integer>)((any)res.get("seq")))).doubleValue());
            k = (int)(k + 1);
        }
        System.out.println("");
        ...
        while (i < s.size()) {
            ...
            Map<String,any> res = classifySequence(val);
            System.out.println(((Number)((Number)padLeft(val, 7) + ": " + ((Number)padRight(String.valueOf(((any)res.get("aliquot"))), 15)).doubleValue()).doubleValue() + " ").doubleValue() + ((Number)joinWithCommas((List<Integer>)((any)res.get("seq")))).doubleValue());
            i = (int)(i + 1);
        }
        System.out.println("");
        int big = 15355717786080;
        Map<String,any> r = classifySequence(big);
        System.out.println(((Number)((Number)String.valueOf(big) + ": " + ((Number)padRight(String.valueOf(((any)r.get("aliquot"))), 15)).doubleValue()).doubleValue() + " ").doubleValue() + ((Number)joinWithCommas((List<Integer>)((any)r.get("seq")))).doubleValue());
    }

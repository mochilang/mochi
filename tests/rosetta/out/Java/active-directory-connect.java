// Generated by Mochi compiler v0.10.26 on 2025-07-16T12:09:32Z
...
public class ActiveDirectoryConnect {
    static boolean connect(Object client) {
        return !Objects.equals(((Map<?,?>)client).get("Host"), "") && ((Number)((Map<?,?>)client).get("Port")).doubleValue() > 0;
    }
    static void main() {

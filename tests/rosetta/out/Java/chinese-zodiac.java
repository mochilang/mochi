// Generated by Mochi compiler v0.10.26 on 2025-07-16T12:11:33Z
...
public class ChineseZodiac {
    ...
    static Object cz(int yr, List<String> animal, List<String> yinYang, List<String> element, List<String> sc, List<String> bc) {
        int y = yr - 4;
        int stem = y % 10;
        int branch = y % 12;
    ...
    for (Integer yr : Arrays.asList(1935, 1938, 1968, 1972, 1976)) {
        Object r = cz(yr, animal, yinYang, element, stemChArr, branchChArr);
        System.out.println(((Number)((Number)((Number)((Number)((Number)((Number)((Number)((Number)String.valueOf(yr) + ": " + ((Number)((Map<?,?>)r).get("element")).doubleValue()).doubleValue() + " ").doubleValue() + ((Number)((Map<?,?>)r).get("animal")).doubleValue()).doubleValue() + ", ").doubleValue() + ((Number)((Map<?,?>)r).get("yinYang")).doubleValue()).doubleValue() + ", Cycle year ").doubleValue() + ((Number)String.valueOf(((Map<?,?>)r).get("cycle"))).doubleValue()).doubleValue() + " ").doubleValue() + ((Number)((Map<?,?>)r).get("stemBranch")).doubleValue());
    }
    }
}

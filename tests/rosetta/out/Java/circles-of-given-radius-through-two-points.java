// Generated by Mochi compiler v0.10.26 on 2025-07-16T12:11:36Z
...
public class CirclesOfGivenRadiusThroughTwoPoints {
    ...
    static List<Object> circles(Object p1, Object p2, double r) {
        if (Objects.equals(((Map<?,?>)p1).get("x"), ((Map<?,?>)p2).get("x")) && Objects.equals(((Map<?,?>)p1).get("y"), ((Map<?,?>)p2).get("y"))) {
            if (r == 0.000000) {
        ...
        int dx = ((Number)((Map<?,?>)p2).get("x")).doubleValue() - ((Number)((Map<?,?>)p1).get("x")).doubleValue();
        int dy = ((Number)((Map<?,?>)p2).get("y")).doubleValue() - ((Number)((Map<?,?>)p1).get("y")).doubleValue();
        double q = hypot(dx, dy);
        if (q > 2.000000 * r) {
            return Arrays.asList(p1, p2, "Points too far apart to form circles.");
        }
        Point m = new Point(((Number)(((Number)((Map<?,?>)p1).get("x")).doubleValue() + ((Number)((Map<?,?>)p2).get("x")).doubleValue())).doubleValue() / 2.000000, ((Number)(((Number)((Map<?,?>)p1).get("y")).doubleValue() + ((Number)((Map<?,?>)p2).get("y")).doubleValue())).doubleValue() / 2.000000);

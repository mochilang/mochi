...
public class M4RingsOr4SquaresPuzzle {
    ...
    static Map<String,any> getCombs(int low, int high, boolean unique) {
    ...
    Map<String,any> r1 = getCombs(1, 7, true);
    ...
    Map<String,any> r2 = getCombs(3, 9, true);
    ...
    Map<String,any> r3 = getCombs(0, 9, false);

...
public class CholeskyDecomposition1 {
    ...
    static Map<String,any> makeSym(int order, List<? extends Number> elements) {
        return new OrderEle(order, elements);
    }
    static List<List<Double>> unpackSym(Map<String,any> m) {
        Map<String,any> n = m.get("order");
        Map<String,any> ele = m.get("ele");
    ...
    static void printSym(Map<String,any> m) {
        printMat(unpackSym(m));
    }
    static void printLower(Map<String,any> m) {
        Map<String,any> n = m.get("order");
        Map<String,any> ele = m.get("ele");
        List<List<Double>> mat = Arrays.asList();
        int idx = 0;
    ...
    static Map<String,any> choleskyLower(Map<String,any> a) {
        Map<String,any> n = a.get("order");
        Map<String,any> ae = a.get("ele");
    ...
    static void demo(Map<String,any> a) {
        System.out.println("A:");
        printSym(a);
        System.out.println("L:");
        Map<String,any> l = choleskyLower(a);
        printLower(l);
    }

...
List<Point> getFacePoints(List<Point> points, List<List<int>> faces) {
  ...
  var i = 0;
  while (i.toString().compareTo(faces.length.toString()) < 0) {
    var face = faces[i];
    var fp = Point(0, 0, 0);
    var _iter0 = face;
...
List<List<int>> sortEdges(List<List<int>> edges) {
  ...
  while (tmp.length > 0) {
    ...
    List<List<int>> out = [];
    var k = 0;
    while (k.toString().compareTo(tmp.length.toString()) < 0) {
      if (k != idx) {
...
List<Edge> getEdgesFaces(List<Point> points, List<List<int>> faces) {
  List<List<int>> edges = [];
  var fnum = 0;
  while (fnum.toString().compareTo(faces.length.toString()) < 0) {
    var face = faces[fnum];
    var numP = face.length;
    var pi = 0;
    while (pi.toString().compareTo(numP.toString()) < 0) {
      var pn1 = face[pi];
      var pn2 = 0;
      if (pi.toString().compareTo((numP as num) - 1.toString()) < 0) {
        pn2 = face[(pi as num) + 1];
      }
      else {
        pn2 = face[0];
      }
      if (pn1.toString().compareTo(pn2.toString()) > 0) {
        var tmpn = pn1;
        pn1 = pn2;
        pn2 = tmpn;
      }
  ...
  var idx = 0;
  while (idx.toString().compareTo(edges.length.toString()) < 0) {
    var e1 = edges[idx];
    if (idx.toString().compareTo(edges.length - 1.toString()) < 0) {
...
List<Point> getEdgePoints(List<Point> points, List<Edge> edgesFaces, List<Point> facePoints) {
  ...
  var i = 0;
  while (i.toString().compareTo(edgesFaces.length.toString()) < 0) {
...
List<Point> getAvgFacePoints(List<Point> points, List<List<int>> faces, List<Point> facePoints) {
  ...
  List<PointEx> temp = [];
  var i = 0;
  while (i.toString().compareTo(numP.toString()) < 0) {
  ...
  List<Point> avg = [];
  var j = 0;
  while (j.toString().compareTo(numP.toString()) < 0) {
    var tp = temp[j];
...
List<int> getPointsFaces(List<Point> points, List<List<int>> faces) {
  List<int> pf = [];
  var i = 0;
  while (i.toString().compareTo(points.length.toString()) < 0) {
...
List<any> cmcSubdiv(List<Point> points, List<List<int>> faces) {
  ...
  var idx = 0;
  while (idx.toString().compareTo(edgesFaces.length.toString()) < 0) {
...
String formatFace(List<int> f) {
  ...
  var s = '[' + fmt2(f[0]);
  var i = 1;
  while (i.toString().compareTo(f.length.toString()) < 0) {
    s = s + ' ' + fmt2(f[i]);
    i = (i as num) + 1;
  }
  s = s + ']';

...
int indexOfStr(String h, String n) {
  ...
  var i = 0;
  while (i.toString().compareTo((hlen as num) - (nlen as num).toString()) <= 0) {
...
List<int> stringSearch(String h, String n) {
  ...
  var hlen = h.length;
  var nlen = n.length;
  while (start.toString().compareTo(hlen.toString()) < 0) {
...
String display(List<int> nums) {
  var s = '[';
  var i = 0;
  while (i.toString().compareTo(nums.length.toString()) < 0) {
...
void main() {
  ...
  var i = 0;
  while (i.toString().compareTo(texts.length.toString()) < 0) {
    print('text' + (i as num) + 1.toString() + ' = ' + texts[i]);
    i = (i as num) + 1;
  }
  print('');
  var j = 0;
  while (j.toString().compareTo(texts.length.toString()) < 0) {

...
void main() {
  while (row < height) {
    List<String> line = [];
    var col = 0;
    while (col.toString().compareTo(width.toString()) < 0) {
  ...
  while (i < nIter) {
    ...
    seed = (res[0] as int);
    var r = res[1];
    if (r.toString().compareTo(85.toString()) < 0) {
    ...
    if (r.toString().compareTo(92.toString()) < 0) {
      var nx = 0.2 * x - 0.26 * y;
    ...
    if (r.toString().compareTo(99.toString()) < 0) {

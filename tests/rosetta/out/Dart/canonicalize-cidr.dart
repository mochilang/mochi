...
List<String> split(String s, String sep) {
  ...
  while (i.toString().compareTo(s.length.toString()) < 0) {
    if (sep.length > 0 && (i as num) + sep.length.toString().compareTo(s.length.toString()) <= 0 && s.toString().substring(i, (i as num) + sep.length) == sep) {
...
String toBinary(int n, int bits) {
  ...
  var val = n;
  var i = 0;
  while (i.toString().compareTo(bits.toString()) < 0) {
...
int binToInt(String bits) {
  var n = 0;
  var i = 0;
  while (i.toString().compareTo(bits.length.toString()) < 0) {
...
String canonicalize(String cidr) {
  ...
  var i = 0;
  while (i.toString().compareTo(binary.length.toString()) < 0) {

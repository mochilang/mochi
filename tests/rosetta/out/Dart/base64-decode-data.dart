...
String base64Encode(String text) {
  ...
  var out = '';
  var i = 0;
  while (i.toString().compareTo(bin.length.toString()) < 0) {
...
String base64Decode(String enc) {
  ...
  var bin = '';
  var i = 0;
  while (i.toString().compareTo(enc.length.toString()) < 0) {
    var ch = enc[i];
    if (ch == '=') {
      break;
    }
  ...
  var out = '';
  i = 0;
  while ((i as num) + 8.toString().compareTo(bin.length.toString()) <= 0) {

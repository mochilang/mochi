...
void main() {
  ...
  var seed = now();
  var i = 0;
  while (i.toString().compareTo(2000.toString()) < 0) {
    seed = nextRand(seed);
  ...
  var x = 0;
  while (x.toString().compareTo(400.toString()) < 0) {
    var y = 240;
    while (y.toString().compareTo(245.toString()) < 0) {
      SetPxRgb(bm, x, y, 8405024);
      y = (y as num) + 1;
    }
    y = 260;
    while (y.toString().compareTo(265.toString()) < 0) {
      SetPxRgb(bm, x, y, 8405024);
      y = (y as num) + 1;
    }
    x = (x as num) + 1;
  ...
  var y = 0;
  while (y.toString().compareTo(300.toString()) < 0) {
    var x = 80;
    while (x.toString().compareTo(85.toString()) < 0) {
      SetPxRgb(bm, x, y, 8405024);
      x = (x as num) + 1;
    }
    x = 95;
    while (x.toString().compareTo(100.toString()) < 0) {
      SetPxRgb(bm, x, y, 8405024);
      x = (x as num) + 1;
    }
    y = (y as num) + 1;

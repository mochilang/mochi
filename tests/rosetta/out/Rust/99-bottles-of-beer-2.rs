...
" || ch == "	" {
    ...
    fn slur(p: &'static str, d: i32) -> &'static str {
        ...
        while i < p.len() as i32 - 1 {
            a = append(a, &p[i as usize..i + 1 as usize]);
            i += 1;
        }
    ...
    fn main() -> () {
        let mut i = 99;
        while i > 0 {
            println!("{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", slur(numberName(i), i), " "), pluralizeFirst(slur("bottle of", i), i)), " "), slur("beer on the wall", i)));
            println!("{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", slur(numberName(i), i), " "), pluralizeFirst(slur("bottle of", i), i)), " "), slur("beer", i)));
            println!("{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", slur("take one", i), " "), slur("down", i)), " "), slur("pass it around", i)));
            println!("{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", slur(numberName(i - 1), i), " "), pluralizeFirst(slur("bottle of", i), i - 1)), " "), slur("beer on the wall", i)));
            i -= 1;
        }
    }
    main();

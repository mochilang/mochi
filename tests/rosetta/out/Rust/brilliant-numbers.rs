...
fn main() {
    ...
    fn main() -> () {
        ...
        let mut br = sortInts(r[&"bc"]);
        br = br[0..100].to_vec();
        let mut i = 0;
        while i < br.len() as i32 {
            println!("{:?} {}", format!("{}{}", br[i as usize].to_string().padStart(4, " "), " "), false);
            if (i + 1) % 10 == 0 {
                println!("{} {}", "", true);
            }
            i += 1;
        ...
        while k <= 13 {
            ...
            println!("{:?}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", "First >= ", climit.padStart(18, " ")), " is "), ctotal.padStart(14, " ")), " in the series: "), cnext.padStart(18, " ")));
            k += 1;
        }
    }
}

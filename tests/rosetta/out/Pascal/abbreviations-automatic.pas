...
begin
  ...
  begin
    ...
    while (i < size) do
    begin
      abbrs := specialize _appendList<Variant>(abbrs, takeRunes(specialize _indexList<string>(words, i), l));
      i := i + 1;
    end;

// Generated by Mochi compiler v0.10.26 on 2025-07-16T09:52:49Z
case class Pixel(var r: Int, var g: Int, var b: Int)

object bitmap_b_zier_curves_cubic {
  val b3Seg = 30
  ...
  def bezier3(b: Map[String, any], x1: Int, y1: Int, x2: Int, y2: Int, x3: Int, y3: Int, x4: Int, y4: Int, p: Pixel) = {
    ...
    i = 0
    while (i <= b3Seg) {
      val d = (i.toDouble) / (b3Seg.toDouble)
      var a = 1 - d
      var bcoef = a * a
      var ccoef = d * d
      var a2 = a * bcoef

...
program angles_geometric_normalization_and_conversion
  ...
  recursive real function d2r(d) result(res)
    real, intent(in) :: d
    res = ((d2d(d) * 3.141592653589793) / 180)
    return
  end function d2r
  ...
  recursive real function g2r(g) result(res)
    real, intent(in) :: g
    res = ((g2g(g) * 3.141592653589793) / 200)
    return
  end function g2r
  ...
  recursive real function m2r(m) result(res)
    real, intent(in) :: m
    res = ((m2m(m) * 3.141592653589793) / 3200)
    return
  end function m2r
  recursive real function r2d(r) result(res)
    real, intent(in) :: r
    res = ((r2r(r) * 180) / 3.141592653589793)
    return
  end function r2d
  recursive real function r2g(r) result(res)
    real, intent(in) :: r
    res = ((r2r(r) * 200) / 3.141592653589793)
    return
  end function r2g

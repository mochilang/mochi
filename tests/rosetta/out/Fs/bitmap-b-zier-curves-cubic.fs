...
let line (b) (x0) (y0) (x1) (y1) (p) =
    ...
    try
        while true do
            ...
            with Continue -> ()
    with Break -> ()
let bezier3 (b) (x1) (y1) (x2) (y2) (x3) (y3) (x4) (y4) (p) =
    let mutable px: obj = [||]
    let mutable py: obj = [||]
    let mutable i: int = 0
    while i <= b3Seg do
...
printfn "%A" (fillRgb b 16773055)
printfn "%A" (bezier3 b 20 200 700 50 -300 50 380 150 pixelFromRgb 4165615)

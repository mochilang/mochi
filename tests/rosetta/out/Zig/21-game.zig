// Generated by Mochi compiler v0.10.28 on 2025-07-18T10:32:02Z
...
fn user_main() void {
    var total = 0; // i32
    var computer = (@mod(std.time.nanoTimestamp(), 2) == 0); // bool

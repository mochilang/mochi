// Generated by Mochi compiler v0.10.28 on 2025-07-18T09:59:57Z
...
fn user_main() void {
    ...
    if (@as(i32, @intCast((groups).len)) > 0) {
        var out = "Groups: ["; // []const u8
        var i = 0; // i32
        while (i < @as(i32, @intCast((groups).len))) {
            out = _concat_string(_concat_string(_concat_string(out, "\""), groups[i]), "\"");
            if (i < (@as(i32, @intCast((groups).len)) - 1)) {

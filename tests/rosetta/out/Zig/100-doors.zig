// Generated by Mochi compiler v0.10.30 on 2025-07-19T00:25:44Z
...
pub fn main() void {
    for (0..100) |_| {
        doors = blk0: {
            var _tmp0 = std.ArrayList(bool).init(std.heap.page_allocator);
            defer _tmp0.deinit();
            _tmp0.appendSlice(doors.items) catch |err| handleError(err);

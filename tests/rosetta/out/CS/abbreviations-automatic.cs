// Generated by Mochi compiler v0.10.26 on 2025-07-16T09:28:33Z
using System;
...
class Program
{
    ...
    {
        Dictionary<string, bool> m = new Dictionary<dynamic, dynamic> { };
        List<string> out = new List<string>();
        int i = 0;
        while (i < xs.Length)
        {
            var x = _indexList(xs, i);
            if (!(m.ContainsKey(x)))
            {
                m[x] = true;
                out = new List<string>(out) { x };
            }
            i = (i + 1);
        }
        return out;
    ...
    static int abbrevLen(List<string> words)
    {
        ...
        while (true)
        {
            ...
            while (i < size)
            {
                abbrs = new List<string>(abbrs) { takeRunes(_indexList(words, i), l) };
                i = (i + 1);
            }

...
main(_) ->
    ...
    N1 = 2,
    Term0 = 1,
    (fun Loop2(Term, E, Factval, N) -> case true of true -> Factval1 = (Factval * N), N2 = (N + 1), Term1 = (1 / (Factval)), E1 = (E + Term), (case (absf(Term) < 1e-15) of true -> throw(break); _ -> ok end), Loop2(Factval1, N2, Term1, E1); _ -> ok end end(Term0, E0, Factval0, N1)),

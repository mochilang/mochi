...
spaces(N) ->
    Out0 = "",
    I3 = 0,
    (fun Loop2(I, Out) -> case (I < N1) of true -> Out1 = Out ++ " ", I4 = (I + 1), Loop2(Out1, I4); _ -> ok end end(I3, Out0)),
    Out1.
...
printFmt(F, Align) ->
    ...
    I8 = 0,
    (fun Loop6(I) -> case (I < length(Lines)) of true -> Words = mochi_get(I, Lines), Line0 = "", J2 = 0, (fun Loop5(J, Line) -> case (J < length(Words)) of true -> Line1 = (Line + pad(lists:nth((J)+1, Words), lists:nth((J)+1, Width), Align)) ++ " ", J3 = (J + 1), Loop5(Line1, J3); _ -> ok end end(J2, Line0)), io:format("~p~n", [Line1]), I9 = (I + 1), Loop6(I9); _ -> ok end end(I8)),
    io:format("~p~n", [""]).

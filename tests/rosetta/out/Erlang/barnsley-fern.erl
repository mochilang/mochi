...
main(_) ->
    ...
    Grid0 = [],
    Row0 = 0,
    (fun Loop1(Grid, Row) -> case (Row < Height) of true -> Line0 = [], Col0 = 0, (fun Loop0(Line, Col) -> case (Col < 60) of true -> Line1 = Line ++ [" "], Col1 = (Col + 1), Loop0(Line1, Col1); _ -> ok end end(Line0, Col0)), Grid1 = Grid ++ [Line1], Row1 = (Row + 1), Loop1(Grid1, Row1); _ -> ok end end(Grid0, Row0)),
    Seed0 = 1,
    X0 = 0,
    Y0 = 0,
    Ix0 = ((((60) * ((X0 - XMin))) / Dx)),

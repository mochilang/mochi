...
avgLen(N) ->
    ...
    Seed0 = 1,
    T0 = 0,
    (fun Loop6(T) -> case (T < Tests) of true -> Visited0 = [], I2 = 0, (fun Loop4(Visited, I) -> case (I < N) of true -> Visited1 = Visited ++ [false], I3 = (I + 1), Loop4(Visited1, I3); _ -> ok end end(Visited0, I2)), X0 = 0, (fun Loop5(Visited, Sum, Seed, X) -> case not lists:nth((X)+1, Visited) of true -> Visited2 = lists:sublist(Visited, X) ++ [true] ++ lists:nthtail((X)+1, Visited), Sum1 = (Sum + 1), Seed1 = rem((((Seed * 1664525) + 1013904223)), 2147483647), X1 = rem(Seed, N), Loop5(Visited2, Sum1, Seed1, X1); _ -> ok end end(Visited1, Sum0, Seed0, X0)), T1 = (T + 1), Loop6(T1); _ -> ok end end(T0)),
    ((Sum1) / Tests).
...
ana(N) ->
    ...
    Sum2 = 1,
    I4 = (Nn0 - 1),
    (fun Loop7(Term, Sum, I) -> case (I >= 1) of true -> Term1 = (Term * ((I / Nn0))), Sum3 = (Sum + Term), I5 = (I - 1), Loop7(Sum3, I5, Term1); _ -> ok end end(Term0, Sum2, I4)),
    Sum3.

...
sinApprox(X) ->
    ...
    Sum0 = X,
    N0 = 1,
    (fun Loop0(Sum, N, Term) -> case (N =< 8) of true -> Denom = ((((2 * N)) * (((2 * N) + 1)))), Term1 = (((-Term * X) * X) / Denom), Sum1 = (Sum + Term), N1 = (N + 1), Loop0(Term1, Sum1, N1); _ -> ok end end(Sum0, N0, Term0)),
    Sum1.
...
parseIntStr(Str) ->
    ...
    (fun Loop1(N, I) -> case (I < length(Str)) of true -> N3 = ((N * 10) + mochi_get(string:substr(Str, (I)+1, ((I + 1))-(I)), Digits)), I4 = (I + 1), Loop1(N3, I4); _ -> ok end end(N2, I3)),

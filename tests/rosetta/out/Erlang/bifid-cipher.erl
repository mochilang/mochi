...
decrypt(Text, Emap, Dmap) ->
    ...
    Coords0 = [],
    I4 = 0,
    (fun Loop5(Coords, I) -> case (I < length(Text1)) of true -> Ch = string:substr(Text1, (I)+1, ((I + 1))-(I)), Xy = mochi_get(Ch, Emap1), Coords1 = Coords ++ [lists:nth((0)+1, Xy)], Coords2 = Coords ++ [lists:nth((1)+1, Xy)], I5 = (I + 1), Loop5(Coords2, I5); _ -> ok end end(Coords0, I4)),
    ...
    (fun Loop7(Idx, K2) -> case (Idx < length(Coords2)) of true -> K21 = K2 ++ [lists:nth((Idx)+1, Coords2)], Idx2 = (Idx + 1), Loop7(K21, Idx2); _ -> ok end end(Idx1, K20)),
    Res2 = "",
    J2 = 0,

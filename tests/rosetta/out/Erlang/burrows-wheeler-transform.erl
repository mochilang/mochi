...
bwt(S) ->
    ...
    Table0 = [],
    I4 = 0,
    (fun Loop3(Table, I) -> case (I < Le) of true -> Rot = (string:substr(S0, (I)+1, (Le)-(I)) + string:substr(S0, (0)+1, (I)-(0))), Table1 = Table ++ [Rot], I5 = (I + 1), Loop3(Table1, I5); _ -> ok end end(Table0, I4)),
    Table2 = sortStrings(Table1),
    Last0 = "",
    I6 = 0,
    (fun Loop4(Last, I) -> case (I < Le) of true -> Last1 = (Last + string:substr(lists:nth((I)+1, Table2), ((Le - 1))+1, (Le)-((Le - 1)))), I7 = (I + 1), Loop4(Last1, I7); _ -> ok end end(Last0, I6)),
    #{"err" => false, "res" => Last1}.

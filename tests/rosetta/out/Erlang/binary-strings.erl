...
fromBytes(Bs) ->
    S0 = "",
    I0 = 0,
    (fun Loop0(I, S) -> case (I < length(Bs)) of true -> S1 = (S + char(lists:nth((I)+1, Bs))), I1 = (I + 1), Loop0(S1, I1); _ -> ok end end(I0, S0)),
    S1.
...
main(_) ->
    ...
    D0 = [],
    I2 = 0,
    (fun Loop1(D, I) -> case (I < length(B0)) of true -> D1 = D ++ [lists:nth((I)+1, B0)], I3 = (I + 1), Loop1(D1, I3); _ -> ok end end(D0, I2)),
    ...
    I6 = 3,
    (fun Loop3(Rem, I) -> case (I < length(B0)) of true -> Rem2 = Rem ++ [lists:nth((I)+1, B0)], I7 = (I + 1), Loop3(Rem2, I7); _ -> ok end end(Rem1, I6)),

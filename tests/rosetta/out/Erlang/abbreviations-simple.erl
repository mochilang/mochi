...
join(Xs, Sep) ->
    Res0 = "",
    I4 = 0,
    (fun Loop2(Res, I) -> case (I < length(Xs)) of true -> (case (I > 0) of true -> Res1 = (Res + Sep); _ -> ok end), Res2 = (Res1 + lists:nth((I)+1, Xs)), I5 = (I + 1), Loop2(Res2, I5); _ -> ok end end)(Res0, I4),
    Res2.
...
parseIntStr(Str) ->
    ...
    (fun Loop3(N, I) -> case (I < length(Str)) of true -> N1 = ((N * 10) + mochi_get(string:substr(Str, (I)+1, ((I + 1))-(I)), Digits)), I8 = (I + 1), Loop3(N1, I8); _ -> ok end end)(N0, I7),
...
readTable(Table) ->
    ...
    Mins0 = [],
    I11 = 0,
    (fun Loop5(Cmds, Mins, I) -> case (I < length(Toks)) of true -> Cmd = mochi_get(I, Toks), Minlen0 = length(Cmd), I12 = (I + 1), (case ((I12 < length(Toks)) andalso isDigits(mochi_get(I12, Toks))) of true -> Num = parseIntStr(mochi_get(I12, Toks)), (case ((Num >= 1) andalso (Num < length(Cmd))) of true -> Minlen1 = Num, I13 = (I12 + 1); _ -> ok end); _ -> ok end), Cmds1 = Cmds ++ [Cmd], Mins1 = Mins ++ [Minlen1], Loop5(I13, Cmds1, Mins1); _ -> ok end end)(Cmds0, Mins0, I11),
...
main() ->
    ...
    Results = validate(Commands, Mins, Words2),
    Out10 = "user words:",
    K0 = 0,
    (fun Loop8(Out1, K) -> case (K < length(Words2)) of true -> Out11 = Out1 ++ " ", (case (K < (length(Words2) - 1)) of true -> Out12 = (Out11 + padRight(lists:nth((K)+1, Words2), length(lists:nth((K)+1, Results2)))); _ -> Out13 = (Out12 + lists:nth((K)+1, Words2)) end), K1 = (K + 1), Loop8(Out13, K1); _ -> ok end end)(Out10, K0),
    io:format("~p~n", [Out13]),
    io:format("~p~n", ["full words: " ++ join(Results2, " ")]).

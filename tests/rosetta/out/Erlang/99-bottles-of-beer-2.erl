...
join(Xs, Sep) ->
    Res0 = "",
    I2 = 0,
    (fun Loop1(Res, I) -> case (I < length(Xs)) of true -> (case (I > 0) of true -> Res1 = (Res + Sep); _ -> ok end), Res2 = (Res + lists:nth((I)+1, Xs)), I3 = (I + 1), Loop1(Res2, I3); _ -> ok end end(Res0, I2)),
    Res2.
...
slur(P, D) ->
    ...
    A0 = [],
    I4 = 1,
    (fun Loop2(A, I) -> case (I < (length(P) - 1)) of true -> A1 = A ++ [string:substr(P, (I)+1, ((I + 1))-(I))], I5 = (I + 1), Loop2(I5, A1); _ -> ok end end(A0, I4)),
    Idx0 = (length(A1) - 1),
    Seed0 = D,

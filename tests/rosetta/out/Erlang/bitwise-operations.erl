...
bit_or(A, B) ->
    ...
    Res2 = 0,
    Bit2 = 1,
    {Ua3, Ub3, Bit3} = lists:foldl(fun(I, {Bit, Ua, Ub}) -> (case ((rem(Ua, 2) == 1) orelse (rem(Ub, 2) == 1)) of true -> Res3 = (Res2 + Bit); _ -> ok end), Ua3 = ((Ua / 2)), Ub3 = ((Ub / 2)), Bit3 = (Bit * 2), {Ua3, Ub3, Bit3} end, {Bit2, Ua2, Ub2}, lists:seq(0, (16)-1)),
    Res3.
...
shr(A, B) ->
    Ua9 = toUnsigned16(A),
    I2 = 0,
    (fun Loop1(Ua, I) -> case (I < B) of true -> Ua10 = ((Ua / 2)), I3 = (I + 1), Loop1(Ua10, I3); _ -> ok end end(Ua9, I2)),
    Ua10.

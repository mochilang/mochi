#!/usr/bin/env escript
% Generated by Mochi compiler v0.10.26 on 2025-07-16T12:03:24Z
...
bigSub(A, B) ->
    ...
    Borrow0 = 0,
    I2 = 0,
    (fun Loop3(Res, I) -> case (I < (case A0 of #{items := It} -> length(It); _ -> length(A0) end)) of true -> Av2 = lists:nth((I)+1, A0), Bv2 = 0, (case (I < (case B of #{items := It} -> length(It); _ -> length(B) end)) of true -> Bv3 = lists:nth((I)+1, B); _ -> ok end), Diff0 = ((Av1 - Bv3) - Borrow0), (case (Diff0 < 0) of true -> Diff1 = (Diff0 + 10), Borrow1 = 1; _ -> Borrow2 = 0 end), Res3 = Res ++ [Diff1], I3 = (I + 1), Loop3(Res3, I3); _ -> ok end end)(Res2, I2),
    bigTrim(Res3).
...
row(N) ->
    ...
    Out0 = [],
    I6 = 0,
    (fun Loop7(Out, I) -> case (I < N3) of true -> Diff = bigSub(mochi_get((I + 1), E), mochi_get(I, E)), Out1 = Out ++ [bigToString(Diff1)], I7 = (I + 1), Loop7(Out1, I7); _ -> ok end end)(Out0, I6),
    Out1.

...
listStr(Xs) ->
    S0 = "[",
    I0 = 0,
    (fun Loop0(I, S) -> case (I < length(Xs)) of true -> S1 = (S + lists:flatten(io_lib:format("~p", [lists:nth((I)+1, Xs)]))), (case ((I + 1) < length(Xs)) of true -> S2 = S ++ " "; _ -> ok end), I1 = (I + 1), Loop0(S2, I1); _ -> ok end end(I0, S0)),
    S3 = S2 ++ "]",
    S3.

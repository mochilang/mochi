#!/usr/bin/env escript
% Generated by Mochi compiler v0.10.26 on 2025-07-16T12:03:28Z
...
totient(N) ->
    ...
    Nn0 = N1,
    I2 = 2,
    (fun Loop2(I) -> case ((I * I) =< Nn0) of true -> (case (rem(Nn0, I) == 0) of true -> (fun Loop1(Nn) -> case (rem(Nn, I) == 0) of true -> Nn1 = (Nn / I), Loop1(Nn1); _ -> ok end end)(Nn0), Tot1 = (Tot0 - (Tot0 / I)); _ -> ok end), (case (I == 2) of true -> I3 = 1; _ -> ok end), I4 = (I3 + 2), Loop2(I4); _ -> ok end end)(I2),
...
getPerfectPowers(MaxExp) ->
    Upper = pow10(MaxExp),
    I5 = 2,
    (fun Loop4(I) -> case ((I * I) < Upper) of true -> P0 = (I * I), (fun Loop3(P, Pps) -> case true of true -> P1 = (P * I), (case (P1 >= Upper) of true -> throw(break); _ -> ok end), Pps0 = maps:put(P1, true, Pps), Loop3(P1, Pps0); _ -> ok end end)(P0, Pps), I6 = (I + 1), Loop4(I6); _ -> ok end end)(I5).
...
main() ->
    ...
    I9 = 0,
    (fun Loop12() -> case (I9 < 50) of true -> Line0 = "", J2 = 0, (fun Loop11(J, Line, I) -> case (J < 10) of true -> Line1 = (Line + pad(lists:nth((I)+1, Ach2), 4)), (case (J < 9) of true -> Line2 = Line1 ++ " "; _ -> ok end), I10 = (I + 1), J3 = (J + 1), Loop11(Line2, I10, J3); _ -> ok end end)(J2, Line0, I9), io:format("~p~n", [Line2]), Loop12(); _ -> ok end end)(),
    io:format("~p~n", ["\nFirst 30 strong Achilles numbers:"]),
    Strong0 = [],
    Count0 = 0,
    Idx2 = 0,
    (fun Loop13(Idx) -> case (Count0 < 30) of true -> Tot = totient(lists:nth((Idx)+1, Ach2)), (case lists:member(Tot2, AchSet) of true -> Strong1 = (Strong0 + [lists:nth((Idx)+1, Ach2)]), Count1 = (Count0 + 1); _ -> ok end), Idx3 = (Idx + 1), Loop13(Idx3); _ -> ok end end)(Idx1),
    I11 = 0,
    (fun Loop15() -> case (I11 < 30) of true -> Line3 = "", J4 = 0, (fun Loop14(I, J, Line) -> case (J < 10) of true -> Line4 = (Line + pad(lists:nth((I)+1, Strong1), 5)), (case (J < 9) of true -> Line5 = Line4 ++ " "; _ -> ok end), I12 = (I + 1), J5 = (J + 1), Loop14(Line5, I12, J5); _ -> ok end end)(I11, J4, Line3), io:format("~p~n", [Line5]), Loop15(); _ -> ok end end)(),

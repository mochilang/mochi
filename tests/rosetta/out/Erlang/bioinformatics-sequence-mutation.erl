...
makeSeq(S, Le) ->
    Out0 = "",
    I0 = 0,
    (fun Loop1(S, Out, I) -> case (I < Le) of true -> R0 = randInt(S, 4), S0 = lists:nth((0)+1, R0), Idx = lists:nth((1)+1, R0), Out1 = (Out + string:substr(Bases, (Idx)+1, ((Idx + 1))-(Idx))), I1 = (I + 1), Loop1(S0, Out1, I1); _ -> ok end end(S, Out0, I0)),
    [S0, Out1].
...
main() ->
    ...
    I8 = 0,
    (fun Loop8(Res, Seed, Dna, I) -> case (I < Muts) of true -> Res3 = mutate(Seed, Dna, W), Seed2 = lists:nth((0)+1, Res), Dna1 = lists:nth((1)+1, Res), I9 = (I + 1), Loop8(I9, Res3, Seed2, Dna1); _ -> ok end end(Res2, Seed1, Dna0, I8)),
    io:format("~p~n", [""]),
    prettyPrint(Dna1, 50).

#!/usr/bin/env escript
% Generated by Mochi compiler v0.10.26 on 2025-07-16T09:34:12Z
...
divisors(N) ->
    ...
    J0 = (length(Divs21) - 1),
    (fun Loop1(Divs, J) -> case (J >= 0) of true -> Divs2 = Divs ++ [lists:nth((J)+1, Divs21)], J1 = (J - 1), Loop1(Divs2, J1); _ -> ok end end(Divs1, J)),
    Divs2.

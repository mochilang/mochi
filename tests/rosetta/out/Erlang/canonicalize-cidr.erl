...
toBinary(N, Bits) ->
    ...
    Val0 = N2,
    I10 = 0,
    (fun Loop4(I, B, Val) -> case (I < Bits) of true -> B1 = (lists:flatten(io_lib:format("~p", [rem(Val, 2)])) + B), Val1 = ((Val / 2)), I11 = (I + 1), Loop4(B1, Val1, I11); _ -> ok end end(I10, B0, Val0)),
    B1.

binToInt(Bits) ->
    N3 = 0,
    I12 = 0,
    (fun Loop5(I, N) -> case (I < length(Bits)) of true -> N4 = ((N * 2) + parseIntStr(string:substr(Bits, (I)+1, ((I + 1))-(I)))), I13 = (I + 1), Loop5(N4, I13); _ -> ok end end(I12, N3)),
    N4.
...
canonicalize(Cidr) ->
    ...
    CanonParts0 = [],
    I14 = 0,
    (fun Loop7(CanonParts, I) -> case (I < length(Binary1)) of true -> CanonParts1 = CanonParts ++ [lists:flatten(io_lib:format("~p", [binToInt(lists:sublist(Binary1, (I)+1, ((I + 8))-(I)))]))], I15 = (I + 8), Loop7(CanonParts1, I15); _ -> ok end end(CanonParts0, I14)),

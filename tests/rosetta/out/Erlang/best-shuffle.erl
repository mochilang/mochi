...
shuffleChars(S, Seed) ->
    ...
    (fun Loop1(Chars, Idx, Sd) -> case (Idx > 0) of true -> Sd1 = nextRand(Sd), J0 = rem(Sd, ((Idx + 1))), Tmp = lists:nth((Idx)+1, Chars), Chars2 = lists:sublist(Chars, Idx) ++ [lists:nth((J0)+1, Chars)] ++ lists:nthtail((Idx)+1, Chars), Chars3 = lists:sublist(Chars, J0) ++ [Tmp] ++ lists:nthtail((J0)+1, Chars), Idx1 = (Idx - 1), Loop1(Sd1, Chars3, Idx1); _ -> ok end end(Chars1, Idx0, Sd0)),
    Res0 = "",
    I2 = 0,

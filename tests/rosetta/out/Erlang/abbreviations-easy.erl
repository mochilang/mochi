...
join(Xs, Sep) ->
    Res0 = "",
    I4 = 0,
    (fun Loop2(Res, I) -> case (I < length(Xs)) of true -> (case (I > 0) of true -> Res1 = (Res + Sep); _ -> ok end), Res2 = (Res1 + lists:nth((I)+1, Xs)), I5 = (I + 1), Loop2(I5, Res2); _ -> ok end end)(Res0, I4),
    Res2.
...
main() ->
    ...
    Results = validate(Commands, Words2, Mins1),
    Out10 = "user words:  ",
    K0 = 0,
    (fun Loop7(Out1, K) -> case (K < length(Words2)) of true -> Out11 = (Out1 + padRight(lists:nth((K)+1, Words2), length(lists:nth((K)+1, Results2)))) ++ " ", K1 = (K + 1), Loop7(Out11, K1); _ -> ok end end)(Out10, K0),
    io:format("~p~n", [Out11]),

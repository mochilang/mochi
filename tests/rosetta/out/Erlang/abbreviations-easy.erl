#!/usr/bin/env escript
% Generated by Mochi compiler v0.10.26 on 2025-07-16T09:34:08Z
...
padRight(S, Width) ->
    Out0 = S,
    I2 = length(S),
    (fun Loop1(I, Out) -> case (I < Width) of true -> Out1 = Out ++ " ", I3 = (I + 1), Loop1(Out1, I3); _ -> ok end end(I2, Out0)),
    Out1.
...
main() ->
    ...
    Out10 = "user words:  ",
    K0 = 0,
    (fun Loop7(K, Out1) -> case (K < length(Words)) of true -> Out11 = (Out1 + padRight(lists:nth((K)+1, Words), length(lists:nth((K)+1, Results)))) ++ " ", K1 = (K + 1), Loop7(Out11, K1); _ -> ok end end(K0, Out10)),
    io:format("~p~n", [Out11]),

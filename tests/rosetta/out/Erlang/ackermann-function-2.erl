#!/usr/bin/env escript
% Generated by Mochi compiler v0.10.26 on 2025-07-16T12:03:29Z
...
ackermann2(M, N) ->
    ...
    (case (M == 1) of true -> (N + 2); _ -> ok end),
    (case (M == 2) of true -> ((2 * N) + 3); _ -> ok end),
    (case (M == 3) of true -> ((8 * pow(2, N)) - 3); _ -> ok end),
    (case (N == 0) of true -> ackermann2((M - 1), 1); _ -> ok end),

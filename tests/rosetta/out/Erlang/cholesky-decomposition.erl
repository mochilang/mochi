...
cholesky(A) ->
    ...
    L0 = [],
    I2 = 0,
    (fun Loop2(L, I) -> case (I < N) of true -> Row0 = [], J0 = 0, (fun Loop1(Row, J) -> case (J < N) of true -> Row1 = Row ++ [0], J1 = (J + 1), Loop1(Row1, J1); _ -> ok end end(Row0, J0)), L1 = L ++ [Row1], I3 = (I + 1), Loop2(L1, I3); _ -> ok end end(L0, I2)),
    I4 = 0,

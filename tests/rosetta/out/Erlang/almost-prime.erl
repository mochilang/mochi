...
kPrime(N, K) ->
    Nf0 = 0,
    I0 = 2,
    (fun Loop1(I) -> case (I =< N) of true -> (fun Loop0(N, Nf) -> case (rem(N, I) == 0) of true -> (case (Nf == K) of true -> false; _ -> ok end), Nf1 = (Nf + 1), N0 = (N / I), Loop0(N0, Nf1); _ -> ok end end(N, Nf0)), I1 = (I + 1), Loop1(I1); _ -> ok end end(I0)),
    (Nf1 == K).

...
(let [r (try
  ...
  (loop []
    (when (< x SIZE)
      (let [r (try
        (when (_equal (_indexList (_indexList b y) x) 0)
...
(throw (ex-info "return" {:value {"board" b "full" (_equal (count empty) 1)}}))
(catch clojure.lang.ExceptionInfo e
(if (= (.getMessage e) "return")
(:value (ex-data e))
(throw e)))
...
(when (< i (count row))
(let [r (try
(when (not (_equal (_indexList row i) 0))
...
(when (< i (count xs))
(let [r (try
(if (and (< (+ i 1) (count xs)) (_equal (_indexList xs i) (_indexList xs (+ i 1))))
(do
...
(when (< x SIZE)
(let [r (try
(when (not (_equal (_indexList (_indexList b y) x) (_indexList new x)))
(def moved true) ;; bool
)
(def b (assoc-in b [y x] (_indexList new x))) ;; any
(def x (+ x 1)) ;; int
:next
(catch clojure.lang.ExceptionInfo e
(cond
...
(when (< x SIZE)
(let [r (try
(when (not (_equal (_indexList (_indexList b y) x) (_indexList rev x)))
(def moved true) ;; bool
)
...
(when (< y SIZE)
(let [r (try
(when (not (_equal (_indexList (_indexList b y) x) (_indexList new y)))
(def moved true) ;; bool
)
(def b (assoc-in b [y x] (_indexList new y))) ;; any
(def y (+ y 1)) ;; int
:next
(catch clojure.lang.ExceptionInfo e
(cond
...
(when (< y SIZE)
(let [r (try
(when (not (_equal (_indexList (_indexList b y) x) (_indexList col y)))
(def moved true) ;; bool
)
(def b (assoc-in b [y x] (_indexList col y))) ;; int
(def y (+ y 1)) ;; int
...
(when (and (< (+ x 1) SIZE) (_equal (_indexList (_indexList b y) x) (_indexList (_indexList b y) (+ x 1))))
(throw (ex-info "return" {:value true}))
)
(when (and (< (+ y 1) SIZE) (_equal (_indexList (_indexList b y) x) (_indexList (_indexList b (+ y 1)) x)))
(throw (ex-info "return" {:value true}))
)
(def x (+ x 1)) ;; int
:next
...
(def moved false) ;; bool
(when (or (_equal cmd "a") (_equal cmd "A"))

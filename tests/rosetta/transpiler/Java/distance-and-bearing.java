...
arr[j] = tmp;
    ...
    static void main() {
        ...
        while (i < results.length) {
            ...
            Object dist = r[0];
            Object bear = r[1];
            String line = String.valueOf(round(((Number)(dist)).doubleValue(), 1)) + "\t" + String.valueOf(round(((Number)(bear)).doubleValue(), 0)) + "\t" + (String)(ap.icao) + "\t" + (String)(ap.country) + " " + (String)(ap.name);

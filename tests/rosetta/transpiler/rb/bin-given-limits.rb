...
def printBins(limits, bins)
  n = limits.length
  puts(_add(_add(_add("           < ", padLeft(limits[0], 3)), " = "), padLeft(bins[0], 2)))
  i = 1
  while i < n
    puts(_add(_add(_add(_add(_add(">= ", padLeft(limits[i - 1], 3)), " and < "), padLeft(limits[i], 3)), " = "), padLeft(bins[i], 2)))
    i = _add(i, 1)
  end
  puts(_add(_add(_add(">= ", padLeft(limits[n - 1], 3)), "           = "), padLeft(bins[n], 2)))
  puts("")
end
def main()
  ...
  while i < limitsList.length
    puts(_add(_add("Example ", (_add(i, 1)).to_s), "\n"))

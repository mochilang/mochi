...
(let ((start20 (now)
 ...
 (if (< i (cond ((string? preds)
 (string-length preds)
)
 ((hash-table? preds)
 (hash-table-size preds)
)
 (else (length preds)
)
)
)
 (begin (set! av (_add av (* (- (list-ref preds i)
 f)
 (- (list-ref preds i)
 f)
)
 ...
 (begin (set! av (+ av (list-ref preds i)
)
)
 (set! i (+ i 1)
)
 ...
 (begin (let ((crowdErr (* (- truth av)
 (- truth av)
)
)
)
 (begin (let ((div (averageSquareDiff av preds)
)
)
 (begin (ret14 (_list avErr crowdErr div)
)
)
)
)
 ...
 (let ((predsArray (_list (_list 48.0 47.0 51.0)
 (_list 48.0 47.0 51.0 42.0)
)
)
)
 (begin (let ((truth 49.0)
)
 (begin (let ((i 0)
)
 (begin (call/cc (lambda (break19)
 (letrec ((loop18 (lambda ()
 (if (< i (cond ((string? predsArray)
 (string-length predsArray)
)
 ((hash-table? predsArray)
 (hash-table-size predsArray)
)
 (else (length predsArray)
)
)
)
 (begin (let ((preds (list-ref predsArray i)
)
)
 (begin (let ((res (diversityTheorem truth preds)
)
)
 (begin (_display (to-str (string-append "Average-error : " (padLeft (formatFloat (cond ((string? res)
 (substring res 0 (+ 0 1)
)
)
 ((hash-table? res)
 ...
 (newline)
 (_display (to-str (string-append "Crowd-error   : " (padLeft (formatFloat (cond ((string? res)
 (substring res 1 (+ 1 1)
)
)
 ((hash-table? res)
 ...
 (newline)
 (_display (to-str (string-append "Diversity     : " (padLeft (formatFloat (cond ((string? res)
 (substring res 2 (+ 2 1)
)
)
 ((hash-table? res)

...
(define (listToString1 xs)
 ...
 (begin (set! s (string-append s (fmt1 (list-ref xs i)
)
)
)
...
(define (deconv g f)
 ...
 (begin (if (<= j i)
 (begin (set! sum (- sum (* (list-ref out (- i j)
)
 (list-ref f j)
)
)
 ...
 (set! out (append out (_list (/ sum (list-ref f 0)
)
)
)
)
...
(define (main)
 ...
 (begin (_display (to-str (listToString1 h)
)
)
 (newline)
 (_display (to-str (listToString1 (deconv g f)
)
)
)
 (newline)
 (_display (to-str (listToString1 f)
)
)
 (newline)
 (_display (to-str (listToString1 (deconv g h)
)
)
)
 (newline)

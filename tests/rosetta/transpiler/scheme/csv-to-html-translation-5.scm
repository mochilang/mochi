...
(define (split s sep)
 ...
 (begin (if (string=? (substring s i (+ i n)
)
 sep)
 (begin (set! out (append out (_list (substring s start i)
)
)
)
 (set! i (+ i n)
 ...
 (set! out (append out (_list (substring s start (cond ((string? s)
 (string-length s)
)
 ((hash-table? s)
 (hash-table-size s)

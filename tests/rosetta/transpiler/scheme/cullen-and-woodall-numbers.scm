...
(define (main)
 ...
 (if (<= i 20)
 (begin (set! cnums (append cnums (_list (cullen i)
)
)
)
 (set! i (+ i 1)
 ...
 (_display (to-str "First 20 Cullen numbers (n * 2^n + 1)
:")
)
 (newline)
 (_display (to-str (show_list cnums)
)
)
 (newline)
 (let ((wnums (_list)
 ...
 (if (<= i 20)
 (begin (set! wnums (append wnums (_list (woodall i)
)
)
)
 (set! i (+ i 1)
...
:")
 ...
 (newline)
 (_display (to-str (show_list wnums)
)
)
 (newline)
 (let ((cprimes (_list 1 141 4713 5795 6611)
)
)
...
:")
 ...
 (newline)
 (_display (to-str (show_list cprimes)
)
)
 (newline)
 (let ((wprimes (_list 2 3 6 30 75 81 115 123 249 362 384 462)
)
)
...
:")
 ...
 (newline)
 (_display (to-str (show_list wprimes)
)
)
 (newline)
)

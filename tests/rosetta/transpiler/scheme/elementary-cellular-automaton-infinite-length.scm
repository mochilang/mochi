...
(let ((start20 (now)
 ...
 (begin (if (string=? (substring cells 0 1)
 "O")
 (begin (set! l ".")
)
 (quote ()
 ...
 (if (string=? (substring cells (- (cond ((string? cells)
 (string-length cells)
)
 ((hash-table? cells)
 ...
 (set! cells (string-append (string-append l cells)
 r)
)
 (set! cells (string-append (string-append l cells)
 r)
 ...
 (begin (set! bin (_add bin (* (btoi (string=? (substring cells n (+ n 1)
)
 "O")
)
 (pow2 b)
 ...
 (begin (if (equal? (modulo (quotient ruleVal (pow2 bin)
)
 2)
 1)
 (begin (set! a "O")
 ...
 (begin (_display (to-str (string-append (string-append " Rule #" (to-str ruleVal)
)
 ":")
)
)
 ...
 (if (< x l)
 (begin (set! cells (addNoCells cells)
)
 (let ((width (+ 40 (quotient (cond ((string? cells)
 (string-length cells)
)
 ((hash-table? cells)
 (hash-table-size cells)
 ...
 (begin (let ((spaces (_repeat " " (- width (cond ((string? cells)
 (string-length cells)
)
 ((hash-table? cells)
 (hash-table-size cells)
 ...
 (begin (_display (to-str (string-append spaces cells)
)
)
 (newline)

...
(let ((start28 (now)
 ...
 (call/cc (lambda (ret1)
 (ret1 (alist->hash-table (list (cons "Data" data)
 (cons "Balance" 0)
 (cons "Link" (list (quote ()
)
 (quote ()
)
)
 ...
 (begin (ret9 (alist->hash-table (list (cons "node" (Node data)
)
 (cons "done" #f)
)
)
 ...
 (begin (ret9 (alist->hash-table (list (cons "node" node)
 (cons "done" #t)
)
)
)
 ...
 (ret9 (alist->hash-table (list (cons "node" (insertBalance node dir)
)
 (cons "done" #t)
)
)
 ...
 (begin (hash-table-set! root "Balance" 0)
 (hash-table-set! n "Balance" 0)
 (ret13 (alist->hash-table (list (cons "node" (single root dir)
)
 (cons "done" #f)
)
)
 ...
 (ret13 (alist->hash-table (list (cons "node" (double root dir)
)
 (cons "done" #f)
)
)
 ...
 (begin (ret14 (alist->hash-table (list (cons "node" (quote ()
)
)
 (cons "done" #f)
)
 ...
 (begin (ret14 (alist->hash-table (list (cons "node" (getLink node 1)
)
 (cons "done" #f)
)
)
 ...
 (begin (ret14 (alist->hash-table (list (cons "node" (getLink node 0)
)
 (cons "done" #f)
)
)
 ...
 (begin (ret14 (alist->hash-table (list (cons "node" node)
 (cons "done" #t)
)
)
)

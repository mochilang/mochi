;; Generated on 2025-08-03 17:57 +0700
(import (scheme base))
(import (scheme time))
(import (chibi string))
...
(define (floorf x) (call/cc (lambda (ret4) (let ((y (let ((v5 x)) (cond ((string? v5) (inexact->exact (floor (string->number v5)))) ((boolean? v5) (if v5 1 0)) (else (inexact->exact (floor v5))))))) (begin (ret4 (+ 0.0 y)))))))
(define (powf base exp) (call/cc (lambda (ret6) (let ((r 1.0)) (begin (let ((i 0)) (begin (call/cc (lambda (break8) (letrec ((loop7 (lambda () (if (< i exp) (begin (set! r (* r base)) (set! i (+ i 1)) (loop7)) (quote ()))))) (loop7)))) (ret6 r))))))))
(define (fmtF x width prec) (call/cc (lambda (ret9) (let ((factor (powf 10.0 prec))) (begin (let ((y (/ (floorf (_add (* x factor) 0.5)) factor))) (begin (let ((s (to-str y))) (begin (let ((dot (indexOf s "."))) (begin (if (equal? dot (- 0 1)) (begin (set! s (string-append s ".")) (let ((j 0)) (begin (call/cc (lambda (break11) (letrec ((loop10 (lambda () (if (< j prec) (begin (set! s (string-append s "0")) (set! j (+ j 1)) (loop10)) (quote ()))))) (loop10))))))) (begin (let ((decs (- (- (cond ((string? s) (string-length s)) ((hash-table? s) (hash-table-size s)) (else (length s))) dot) 1))) (begin (call/cc (lambda (break13) (letrec ((loop12 (lambda () (if (_lt decs prec) (begin (set! s (string-append s "0")) (set! decs (_add decs 1)) (loop12)) (quote ()))))) (loop12)))))))) (call/cc (lambda (break15) (letrec ((loop14 (lambda () (if (< (cond ((string? s) (string-length s)) ((hash-table? s) (hash-table-size s)) (else (length s))) width) (begin (set! s (string-append " " s)) (loop14)) (quote ()))))) (loop14)))) (ret9 s))))))))))))
(define (expf x) (call/cc (lambda (ret16) (begin (if (< x 0.0) (begin (ret16 (/ 1.0 (expf (- x))))) (quote ())) (let ((term 1.0)) (begin (let ((sum 1.0)) (begin (let ((i 1)) (begin (call/cc (lambda (break18) (letrec ((loop17 (lambda () (if (< i 20) (begin (set! term (/ (* term x) (+ 0.0 i))) (set! sum (+ sum term)) (set! i (+ i 1)) (loop17)) (quote ()))))) (loop17)))) (ret16 sum)))))))))))
(define (eulerStep f x y h) (call/cc (lambda (ret19) (ret19 (_add y (* h (f x y)))))))
(define (newCoolingRate k) (call/cc (lambda (ret20) (ret20 (lambda (dt) (call/cc (lambda (ret21) (ret21 (* (- k) dt)))))))))
(define (newTempFunc k ambient initial) (call/cc (lambda (ret22) (ret22 (lambda (t) (call/cc (lambda (ret23) (ret23 (_add ambient (* (- initial ambient) (expf (* (- k) t))))))))))))
(define (newCoolingRateDy k ambient) (call/cc (lambda (ret24) (let ((cr (newCoolingRate k))) (begin (ret24 (lambda (_x obj) (call/cc (lambda (ret25) (ret25 (cr (- obj ambient))))))))))))

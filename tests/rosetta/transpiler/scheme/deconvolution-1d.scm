...
(define (listToStringInts xs)
 ...
 (begin (set! s (string-append s (to-str (let ((v4 (list-ref xs i)
)
)
 (cond ((string? v4)
...
(define (main)
 ...
 (begin (_display (to-str (listToStringInts h)
)
)
 (newline)
 (_display (to-str (listToStringInts (deconv g f)
)
)
)
 (newline)
 (_display (to-str (listToStringInts f)
)
)
 (newline)
 (_display (to-str (listToStringInts (deconv g h)
)
)
)
 (newline)

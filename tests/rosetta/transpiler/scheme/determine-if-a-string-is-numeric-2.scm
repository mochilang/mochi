...
(define (main)
 (call/cc (lambda (ret4)
 (begin (_display (to-str "Are these strings integers?")
)
 (newline)
 (let ((v "1")
)
 ...
 (_display (to-str (string-append (string-append (string-append "  " v)
 " -> ")
 (to-str b)
)
)
 ...
 (begin (_display (to-str (string-append (string-append (string-append "  " i)
 " -> ")
 (to-str (isInt i)
)
)

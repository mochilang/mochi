...
(define (main) (call/cc (lambda (ret4) (call/cc (lambda (break6) (letrec ((loop5 (lambda (i) (if (< i 16) (begin (begin (_display (to-str (toOct i))) (newline)) (loop5 (+ i 1))) (quote ()))))) (loop5 0)))))))
(main)

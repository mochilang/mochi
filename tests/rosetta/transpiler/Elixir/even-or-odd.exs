...
defmodule Main do
  ...
  def showInt(n) do
    try do
      line = (("Testing integer " <> Main.pad(n, 3)) <> ":  ")
      line = (if rem(n, 2) == 0, do: (line <> "even "), else: (line <> " odd "))
      line = (if rem(n, 2) == 0, do: (line <> "even"), else: (line <> " odd"))
      IO.puts(line)
    catch
      {:return, val} -> val
  ...
  def showBig(s) do
    try do
      b = Main.parseBigInt(s)
      line = (("Testing big integer " <> Kernel.inspect(b)) <> ":  ")
      line = (if rem(b, (2)) == 0, do: (line <> "even"), else: (line <> "odd"))
      IO.puts(line)
    catch
      {:return, val} -> val
    end
  ...
  def main() do
    try do
      ...
      Main.showInt(1)
      Main.showInt(2)
      Main.showBig("-222222222222222222222222222222222222")
      Main.showBig("-1")
      Main.showBig("0")
      Main.showBig("1")
      Main.showBig("222222222222222222222222222222222222")

# Code generated by Mochi transpiler 2025-07-24 08:09 +0700
defmodule Main do
  defp _now() do
  ...
  def doTrials(trials, np, strategy) do
    try do
      pardoned = 0
      t = 0
      while_fun_2 = fn while_fun_2, pardoned, t ->
        if t < trials do
          try do
            drawers = []
            i = 0
            while_fun_3 = fn while_fun_3, drawers, i ->
              if i < 100 do
                drawers = (drawers ++ [i])
                i = i + 1
                while_fun_3.(while_fun_3, drawers, i)
              else
                {drawers, i}
              end
            end
            ...
            p = 0
            success = true
            while_fun_4 = fn while_fun_4, p, success ->
              if p < np do
                try do
                  found = false
                  {found} = if strategy == "optimal" do
                    prev = p
                    d = 0
                    while_fun_5 = fn while_fun_5, d, found, prev ->
                      if d < 50 do
                        try do
                        ...
                        while_fun_5.(while_fun_5, d, found, prev)
                      else
                        {d, found, prev}
                      end
                    end
                    ...
                    opened = []
                    k = 0
                    while_fun_6 = fn while_fun_6, k, opened ->
                      if k < 100 do
                        opened = (opened ++ [false])
                        k = k + 1
                        while_fun_6.(while_fun_6, k, opened)
                      else
                        {k, opened}
                      end
                    end
                    ...
                    d = 0
                    while_fun_7 = fn while_fun_7, d, found, opened ->
                      if d < 50 do
                        try do
                          n = rem(_now(), 100)
                        ...
                        while_fun_7.(while_fun_7, d, found, opened)
                      else
                        {d, found, opened}
                      end
                    end
                ...
                while_fun_4.(while_fun_4, p, success)
              else
                {p, success}
              end
            end
          ...
          while_fun_2.(while_fun_2, pardoned, t)
        else
          {pardoned, t}
        end
      end

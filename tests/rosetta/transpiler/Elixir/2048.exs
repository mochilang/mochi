# Code generated by Mochi transpiler 2025-07-23 20:13 +0700
defmodule Main do
  defp _now() do
  ...
  def spawnTile(b) do
    try do
      ...
      b = List.replace_at(b, Enum.at(cell, 1), List.replace_at(Enum.at(b, Enum.at(cell, 1)), Enum.at(cell, 0), val))
  ...
  def moveLeft(b, score) do
    try do
      moved = false
      y = 0
      while_fun_12 = fn while_fun_12, b, moved, score, y ->
        if y < @size do
          r = slideLeft(Enum.at(b, y))
          new = r["row"]
          score = score + r["gain"]
          x = 0
          while_fun_13 = fn while_fun_13, b, moved, x ->
            if x < @size do
              if Enum.at(Enum.at(b, y), x) != Enum.at(new, x) do
                moved = true
              end
              b = List.replace_at(b, y, List.replace_at(Enum.at(b, y), x, Enum.at(new, x)))
              x = x + 1
              while_fun_13.(while_fun_13, b, moved, x)
            else
              {b, moved, x}
            end
          end
          ...
          y = y + 1
          while_fun_12.(while_fun_12, b, moved, score, y)
        else
          {b, moved, score, y}
        end
      end
      {b, moved, score, y} = try do
          while_fun_12.(while_fun_12, b, moved, score, y)
        catch
          :break -> {b, moved, score, y}
        end
  ...
  def moveRight(b, score) do
    try do
      moved = false
      y = 0
      while_fun_14 = fn while_fun_14, b, moved, score, y ->
        if y < @size do
          ...
          rev = reverseRow(rev)
          x = 0
          while_fun_15 = fn while_fun_15, b, moved, x ->
            if x < @size do
              if Enum.at(Enum.at(b, y), x) != Enum.at(rev, x) do
                moved = true
              end
              b = List.replace_at(b, y, List.replace_at(Enum.at(b, y), x, Enum.at(rev, x)))
              x = x + 1
              while_fun_15.(while_fun_15, b, moved, x)
            else
              {b, moved, x}
            end
          end
          ...
          y = y + 1
          while_fun_14.(while_fun_14, b, moved, score, y)
        else
          {b, moved, score, y}
        end
      end
  ...
  def setCol(b, x, col) do
    try do
      y = 0
      while_fun_17 = fn while_fun_17, b, y ->
        if y < @size do
          b = List.replace_at(b, y, List.replace_at(Enum.at(b, y), x, Enum.at(col, y)))
          y = y + 1
          while_fun_17.(while_fun_17, b, y)
        else
          {b, y}
        end
      end
  ...
  def moveUp(b, score) do
    try do
      moved = false
      x = 0
      while_fun_18 = fn while_fun_18, b, moved, score, x ->
        if x < @size do
          col = getCol(b, x)
          r = slideLeft(col)
          new = r["row"]
          score = score + r["gain"]
          y = 0
          while_fun_19 = fn while_fun_19, b, moved, y ->
            if y < @size do
              if Enum.at(Enum.at(b, y), x) != Enum.at(new, y) do
                moved = true
              end
              b = List.replace_at(b, y, List.replace_at(Enum.at(b, y), x, Enum.at(new, y)))
              y = y + 1
              while_fun_19.(while_fun_19, b, moved, y)
            else
              {b, moved, y}
            end
          end
          ...
          x = x + 1
          while_fun_18.(while_fun_18, b, moved, score, x)
        else
          {b, moved, score, x}
        end
      end
      {b, moved, score, x} = try do
          while_fun_18.(while_fun_18, b, moved, score, x)
        catch
          :break -> {b, moved, score, x}
        end
  ...
  def moveDown(b, score) do
    try do
      moved = false
      x = 0
      while_fun_20 = fn while_fun_20, b, moved, score, x ->
        if x < @size do
          ...
          col = reverseRow(col)
          y = 0
          while_fun_21 = fn while_fun_21, b, moved, y ->
            if y < @size do
              ...
              b = List.replace_at(b, y, List.replace_at(Enum.at(b, y), x, Enum.at(col, y)))
              y = y + 1
              while_fun_21.(while_fun_21, b, moved, y)
            else
              {b, moved, y}
            end
          end
          ...
          x = x + 1
          while_fun_20.(while_fun_20, b, moved, score, x)
        else
          {b, moved, score, x}
        end
      end

...
defmodule Main do
  ...
  def takeRunes(s, n) do
    try do
      ...
      while_fun_2 = fn while_fun_2, count, idx ->
        if idx < if is_list(s), do: length(s), else: String.length(s) do
          if count == n do
    ...
    try do
      ...
      while_fun_4 = fn while_fun_4, l ->
        if true do
          ...
          if if is_list(distinct(abbrs)), do: length(distinct(abbrs)), else: String.length(distinct(abbrs)) == size do
            throw {:return, l}
          end
          l = l + 1
  ...
  def pad2(n) do
    try do
      s = to_string(n)
      if if is_list(s), do: length(s), else: String.length(s) < 2 do
        throw {:return, (" " <> s)}
      end
      throw {:return, s}
    catch

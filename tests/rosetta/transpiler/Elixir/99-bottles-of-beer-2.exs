  ...
  def main() do
    try do
      ...
      while_fun_6 = fn while_fun_6, i ->
        if i > 0 do
          IO.puts(((((slur(numberName(i), i) <> " ") <> pluralizeFirst(slur("bottle of", i), i)) <> " ") <> slur("beer on the wall", i)))
          IO.puts(((((slur(numberName(i), i) <> " ") <> pluralizeFirst(slur("bottle of", i), i)) <> " ") <> slur("beer", i)))
          IO.puts(((((slur("take one", i) <> " ") <> slur("down", i)) <> " ") <> slur("pass it around", i)))
          IO.puts(((((slur(numberName(i - 1), i) <> " ") <> pluralizeFirst(slur("bottle of", i), i - 1)) <> " ") <> slur("beer on the wall", i)))
          i = i - 1

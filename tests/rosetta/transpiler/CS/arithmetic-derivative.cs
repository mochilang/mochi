...
class Program {
    ...
    static double D(double n) {
        ...
        if ((n < 1e+19)) {
            factors_5 = primeFactors(Convert.ToInt64(n));
        } else {
            var g_6 = Convert.ToInt64((n / 100));
        ...
        if ((c_7 == 2)) {
            return Convert.ToDouble((factors_5[(int)(0)] + factors_5[(int)(1)]));
        };
        double d_8 = (((dynamic)n) / ((dynamic)Convert.ToDouble(factors_5[(int)(0)])));
        return ((((dynamic)D(d_8)) * ((dynamic)Convert.ToDouble(factors_5[(int)(0)]))) + d_8);
    }
    ...
    static void main() {
        ...
        long n_11 = -99;
        while ((n_11 < 101)) {
            vals_10 = (Enumerable.ToArray(Enumerable.Append(vals_10, Convert.ToInt64(D(Convert.ToDouble(n_11))))));
            n_11 = (n_11 + 1);
        };
        long i_12 = 0;
        while ((i_12 < vals_10.Length)) {
            ...
            long j_14 = 0;
            while ((j_14 < 10)) {
                line_13 = (line_13 + pad(vals_10[(int)((i_12 + j_14))]));
                if ((j_14 < 9)) {
                    line_13 = (line_13 + " ");
                }
                j_14 = (j_14 + 1);

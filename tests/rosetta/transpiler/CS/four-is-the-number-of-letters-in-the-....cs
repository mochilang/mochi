...
class Program {
    ...
    static string[] split(string s_14, string sep_15) {
        ...
        string cur_17 = "";
        long i_18 = 0;
        while ((i_18 < s_14.Length)) {
            if ((((sep_15.Length > 0) && ((((dynamic)(i_18)) + ((dynamic)(sep_15.Length))) <= s_14.Length)) && (s_14.Substring((int)(i_18), (int)((((dynamic)(i_18)) + ((dynamic)(sep_15.Length))) - i_18)) == sep_15))) {
    ...
    static string pad(long n_32, long width_33) {
        string s_34 = (n_32).ToString();
        while ((s_34.Length < width_33)) {
            s_34 = (" " + s_34);
        };
        return s_34;
    }
    ...
    static void main() {
        ...
        Console.WriteLine(_fmtTop(line_35));
        Console.WriteLine(_fmtTop(("Length of sentence so far: " + (totalLength()).ToString())));
        foreach (var n_39 in new long[]{1000, 10000, 100000, 1000000, 10000000}) {
            ...
            Console.WriteLine(_fmtTop((((((((dynamic)((("Word " + pad(n_39, 8)) + " is \""))) + ((dynamic)(w_41))) + "\", with ") + (l_42).ToString()) + " letters.  Length of sentence so far: ") + (totalLength()).ToString())));
        };
    }

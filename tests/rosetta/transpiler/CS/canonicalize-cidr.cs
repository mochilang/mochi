...
class Program {
    ...
    static long binToInt(string bits_23) {
        ...
        while ((i_25 < bits_23.Length)) {
            n_24 = (((dynamic)(n_24 * 2)) + ((dynamic)Convert.ToInt64(bits_23.Substring((int)(i_25), (int)((i_25 + 1) - i_25)))));
            i_25 = (i_25 + 1);
        };
        return n_24;
    }
    ...
    static string canonicalize(string cidr_29) {
        var parts_30 = cidr_29.Split("/");
        var dotted_31 = ((dynamic)parts_30)[0];
        var size_32 = Convert.ToInt64(((dynamic)parts_30)[1]);
        string[] binParts_33 = new string[]{};
        foreach (var p_34 in dotted_31.Split(".")) {
            binParts_33 = (Enumerable.ToArray(Enumerable.Append(binParts_33, toBinary(Convert.ToInt64(p_34), 8))));
        };
        string binary_35 = join(binParts_33, "");
        binary_35 = (binary_35.Substring((int)(0), (int)(size_32 - 0)) + repeat("0", (((dynamic)32) - ((dynamic)size_32))));
        string[] canonParts_36 = new string[]{};
        long i_37 = 0;
        while ((i_37 < binary_35.Length)) {
            canonParts_36 = (Enumerable.ToArray(Enumerable.Append(canonParts_36, (binToInt(binary_35.Substring((int)(i_37), (int)((i_37 + 8) - i_37)))).ToString())));
            i_37 = (i_37 + 8);
        };
        return (((dynamic)(join(canonParts_36, ".") + "/")) + ((dynamic)((dynamic)parts_30)[1]));
    }

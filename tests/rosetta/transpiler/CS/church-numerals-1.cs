// Generated by Mochi 0.10.42 on 2025-07-28 00:22 +0700
using System;
...
class Program {
    ...
    static object incr(object i_11) {
        return (object)((((dynamic)Convert.ToInt64(i_11)) + ((dynamic)1)));
    }
    ...
    static void Main() {
        {
            var __memStart = _mem();
            var __start = _now();
            Console.WriteLine(_fmtTop(("three        -> " + (toInt(three_15)).ToString())));
            Console.WriteLine(_fmtTop(("four         -> " + (toInt(four_16)).ToString())));
            Console.WriteLine(_fmtTop(("three + four -> " + (toInt(add(three_15, four_16))).ToString())));
            Console.WriteLine(_fmtTop(("three * four -> " + (toInt(mul(three_15, four_16))).ToString())));
            Console.WriteLine(_fmtTop(("three ^ four -> " + (toInt(pow(three_15, four_16))).ToString())));
            Console.WriteLine(_fmtTop(("four ^ three -> " + (toInt(pow(four_16, three_15))).ToString())));
            Console.WriteLine(_fmtTop(("5 -> five    -> " + (toInt(intToChurch(5))).ToString())));
            var __end = _now();
            var __memEnd = _mem();

...
class Program {
    ...
    static object[] calkinWilf(long n_2) {
        ...
        seq_3 = (Enumerable.ToArray(Enumerable.Append(Enumerable.ToArray(seq_3.Cast<object>()), (object)bigrat(1, 1))));
        long i_4 = 1;
        while ((i_4 < n_2)) {
            var prev_5 = ((dynamic)seq_3)[(i_4 - 1)];
            BigInteger a_6 = num(prev_5);
            BigInteger b_7 = denom(prev_5);
            ...
            t_9 = (t_9 + 1);
            t_9 = (1 / t_9);
            seq_3 = (Enumerable.ToArray(Enumerable.Append(Enumerable.ToArray(seq_3.Cast<object>()), (object)t_9)));
            i_4 = (i_4 + 1);
        };
        return seq_3;
    }
    ...
    static long[] toContinued(object r_10) {
        BigInteger a_11 = num(r_10);
        BigInteger b_12 = denom(r_10);

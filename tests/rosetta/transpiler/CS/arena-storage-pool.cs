...
class Program {
    ...
    static Dictionary<string, object> poolGet(long[] p) {
        ...
        long idx_0 = (((dynamic)p.Length) - ((dynamic)1));
        long v_1 = p[(int)(idx_0)];

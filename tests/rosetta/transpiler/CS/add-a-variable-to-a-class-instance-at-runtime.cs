...
class Program {
    ...
    static void main() {
        SomeStruct ss = new SomeStruct{runtimeFields = new Dictionary<object, object>{}};
        ...
        while (true) {
            ...
            string name = _input();
            if ((Array.IndexOf(ss.runtimeFields, name) >= 0)) {
                var value = ss.runtimeFields[name];
                Console.WriteLine(_fmtTop((("Its value is '" + value) + "'")));
                return;
            } else {

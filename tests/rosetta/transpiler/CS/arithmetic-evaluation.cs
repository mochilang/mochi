...
class Program {
    ...
    static long parseIntStr(string str) {
        ...
        while ((i_1 < str.Length)) {
            n_2 = ((((dynamic)(n_2 * 10)) + ((dynamic)Convert.ToInt64(str.Substring((int)(i_1), (int)((i_1 + 1) - i_1))))) - 48);
            i_1 = (i_1 + 1);
        };
        return n_2;
    }
    ...
    static long powInt(long _base, long exp) {
        ...
        while ((e_12 > 0)) {
            ...
            b_11 = (b_11 * b_11);
            e_12 = (((dynamic)e_12) / ((dynamic)Convert.ToInt64(2)));
        };
        return r_10;
    }
        ...
        while (true) {
            ...
            if ((p.pos < p.expr.Length)) {
                ...
                if ((op_19 == "/")) {
                    ...
                    long rhs_23 = r2_22.v;
                    p = r2_22.p;
                    v_18 = (((dynamic)v_18) / ((dynamic)Convert.ToInt64(rhs_23)));
                    continue;
                }
            }
            break;

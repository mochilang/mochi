    ...
    static void Main() {
        {
            var __memStart = _mem();
            var __start = _now();
            Console.WriteLine(string.Join(" ", new string[]{_fmtTop("5^(4^(3^2)) has"), _fmtTop(s_10.Length), _fmtTop("digits:"), _fmtTop(s_10.Substring((int)(0), (int)(20 - 0))), _fmtTop("..."), _fmtTop(s_10.Substring((int)((s_10.Length - 20)), (int)(s_10.Length - (s_10.Length - 20))))}));
            var __end = _now();
            var __memEnd = _mem();

...
class Program {
    ...
    static string pad(string s_0, long width_1) {
        string out_2 = s_0;
        while ((out_2.Length < width_1)) {
            out_2 = (" " + out_2);
        };
        return out_2;
    }

    static BigInteger mult(BigInteger n_3, long base_4) {
        BigInteger m_5 = 1;
        BigInteger x_6 = n_3;
    ...
    static MDRResult multDigitalRoot(BigInteger n_8, long base_9) {
        BigInteger m_10 = n_8;
        long mp_11 = 0;
        BigInteger b_12 = new BigInteger(base_9);
        while ((m_10 >= b_12)) {
            m_10 = mult(m_10, base_9);
            mp_11 = (mp_11 + 1);
        };
    ...
    static void main() {
        long base_13 = 10;
        long size_14 = 5;
        Console.WriteLine(_fmtTop(((((pad("Number", 20) + " ") + pad("MDR", 3)) + " ") + pad("MP", 3))));
        ...
        long i_16 = 0;
        while ((i_16 < nums_15.Length)) {
            BigInteger n_17 = nums_15[(int)(i_16)];
            MDRResult r_18 = multDigitalRoot(n_17, base_13);
            Console.WriteLine(_fmtTop(((((pad((n_17).ToString(), 20) + " ") + pad((r_18.mdr).ToString(), 3)) + " ") + pad((r_18.mp).ToString(), 3))));
            i_16 = (i_16 + 1);
        };
        ...
        while ((idx_20 < base_13)) {
            list_19 = (Enumerable.ToArray(Enumerable.Append(list_19, new object[]{})));
            idx_20 = (idx_20 + 1);
        };
        ...
        while ((cnt_21 > 0)) {
            MDRResult r_24 = multDigitalRoot(n_22, base_13);
            long mdr_25 = r_24.mdr;
            if ((list_19[(int)(mdr_25)].Length < size_14)) {
                list_19[mdr_25] = (Enumerable.ToArray(Enumerable.Append(list_19[(int)(mdr_25)], (int)(n_22))));
                cnt_21 = (cnt_21 - 1);
            }
            n_22 = (n_22 + new BigInteger(1));
        };
        Console.WriteLine(_fmtTop("MDR: First"));
        long j_26 = 0;
        while ((j_26 < base_13)) {
            Console.WriteLine(_fmtTop(((pad((j_26).ToString(), 3) + ": ") + (list_19[(int)(j_26)]).ToString())));
            j_26 = (j_26 + 1);
        };
    }

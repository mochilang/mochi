...
class Program {
    ...
    static void main() {
        double[] angles_0 = new double[]{-2, -1, 0, 1, 2, 6.2831853, 16, 57.2957795, 359, 399, 6399, 1e+06};
        Console.WriteLine(_fmtTop("degrees normalized_degs gradians mils radians"));
        foreach (var a_1 in angles_0) {
            Console.WriteLine(_fmtTop((((((((((a_1).ToString() + " ") + (d2d(a_1)).ToString()) + " ") + (d2g(a_1)).ToString()) + " ") + (d2m(a_1)).ToString()) + " ") + (d2r(a_1)).ToString())));
        };
        Console.WriteLine(_fmtTop("\ngradians normalized_grds degrees mils radians"));
        foreach (var a_2 in angles_0) {
            Console.WriteLine(_fmtTop((((((((((a_2).ToString() + " ") + (g2g(a_2)).ToString()) + " ") + (g2d(a_2)).ToString()) + " ") + (g2m(a_2)).ToString()) + " ") + (g2r(a_2)).ToString())));
        };
        Console.WriteLine(_fmtTop("\nmils normalized_mils degrees gradians radians"));
        foreach (var a_3 in angles_0) {
            Console.WriteLine(_fmtTop((((((((((a_3).ToString() + " ") + (m2m(a_3)).ToString()) + " ") + (m2d(a_3)).ToString()) + " ") + (m2g(a_3)).ToString()) + " ") + (m2r(a_3)).ToString())));
        };
        Console.WriteLine(_fmtTop("\nradians normalized_rads degrees gradians mils"));
        foreach (var a_4 in angles_0) {
            Console.WriteLine(_fmtTop((((((((((a_4).ToString() + " ") + (r2r(a_4)).ToString()) + " ") + (r2d(a_4)).ToString()) + " ") + (r2g(a_4)).ToString()) + " ") + (r2m(a_4)).ToString())));
        };
    }

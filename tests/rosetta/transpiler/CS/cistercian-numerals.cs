...
class Program {
    ...
    static long[] numbers_24 = new long[]{0, 1, 20, 300, 4000, 5555, 6789, 9999};
    static void initN() {
        long i_1 = 0;
        while ((i_1 < 15)) {
    ...
    static void horiz(long c1_4, long c2_5, long r_6) {
        long c_7 = c1_4;
        while ((c_7 <= c2_5)) {
            n_0[(int)(r_6)][c_7] = "x";
            c_7 = (c_7 + 1);
    ...
    static void verti(long r1_8, long r2_9, long c_10) {
        long r_11 = r1_8;
        while ((r_11 <= r2_9)) {
            n_0[(int)(r_11)][c_10] = "x";
            r_11 = (r_11 + 1);
    ...
    static void diagd(long c1_12, long c2_13, long r_14) {
        long c_15 = c1_12;
        while ((c_15 <= c2_13)) {
    ...
    static void diagu(long c1_16, long c2_17, long r_18) {
        long c_19 = c1_16;
        while ((c_19 <= c2_17)) {
    ...
    static void initDraw() {
        draw_20[1] = () => {horiz(6, 10, 0);};
        draw_20[2] = () => {horiz(6, 10, 4);};
        draw_20[3] = () => {diagd(6, 10, 0);};
        draw_20[4] = () => {diagu(6, 10, 4);};
        draw_20[5] = () => {(draw_20.ContainsKey(1) ? draw_20[1] : null)(); (draw_20.ContainsKey(4) ? draw_20[4] : null)();};
        draw_20[6] = () => {verti(0, 4, 10);};
        ...
        draw_20[10] = () => {horiz(0, 4, 0);};
        draw_20[20] = () => {horiz(0, 4, 4);};
        draw_20[30] = () => {diagu(0, 4, 4);};
        draw_20[40] = () => {diagd(0, 4, 0);};
        draw_20[50] = () => {(draw_20.ContainsKey(10) ? draw_20[10] : null)(); (draw_20.ContainsKey(40) ? draw_20[40] : null)();};
        draw_20[60] = () => {verti(0, 4, 0);};
        ...
        draw_20[100] = () => {horiz(6, 10, 14);};
        draw_20[200] = () => {horiz(6, 10, 10);};
        draw_20[300] = () => {diagu(6, 10, 14);};
        draw_20[400] = () => {diagd(6, 10, 10);};
        draw_20[500] = () => {(draw_20.ContainsKey(100) ? draw_20[100] : null)(); (draw_20.ContainsKey(400) ? draw_20[400] : null)();};
        draw_20[600] = () => {verti(10, 14, 10);};
        ...
        draw_20[1000] = () => {horiz(0, 4, 14);};
        draw_20[2000] = () => {horiz(0, 4, 10);};
        draw_20[3000] = () => {diagd(0, 4, 10);};
        draw_20[4000] = () => {diagu(0, 4, 14);};
        draw_20[5000] = () => {(draw_20.ContainsKey(1000) ? draw_20[1000] : null)(); (draw_20.ContainsKey(4000) ? draw_20[4000] : null)();};
        draw_20[6000] = () => {verti(10, 14, 0);};
    ...
    static void printNumeral() {
        ...
        while ((i_21 < 15)) {
            ...
            Console.WriteLine(_fmtTop(line_22));
            i_21 = (i_21 + 1);
        };
    ...
    static void Main() {
        {
            ...
            var __start = _now();
            initDraw();
            foreach (var number_25 in numbers_24) {
                initN();
                Console.WriteLine(_fmtTop(((number_25).ToString() + ":")));

...
class Program {
    ...
    static string fmt4(double x_3) {
        double y_4 = (x_3 * 10000);
        if ((y_4 >= 0)) {
            y_4 = (y_4 + 0.5);
        } else {
            y_4 = (y_4 - 0.5);
        };
        y_4 = (((dynamic)Convert.ToDouble(Convert.ToInt64(y_4))) / ((dynamic)10000));
        string s_5 = (y_4).ToString();
        var dot_6 = s_5.IndexOf(".");
        if ((dot_6 == (0 - 1))) {
            s_5 = (s_5 + ".0000");
        } else {
            long decs_7 = (((dynamic)(((dynamic)s_5.Length) - ((dynamic)dot_6))) - ((dynamic)1));
            if ((decs_7 > 4)) {
                s_5 = s_5.Substring((int)(0), (int)((((dynamic)dot_6) + ((dynamic)5)) - 0));
            } else {
                while ((decs_7 < 4)) {
                    s_5 = (s_5 + "0");
                    decs_7 = (decs_7 + 1);
    ...
    static Point divPoint(Point p_14, double d_15) {
        return mulPoint(p_14, (1 / d_15));
    }

    static Point centerPoint(Point p1_16, Point p2_17) {
        return divPoint(sumPoint(p1_16, p2_17), 2);
    }

    static Point[] getFacePoints(Point[] points_18, long[][] faces_19) {
        Point[] facePoints_20 = new Point[]{};
        long i_21 = 0;
        while ((i_21 < ((System.Collections.ICollection)(faces_19)).Count)) {
            long[] face_22 = faces_19[(int)(i_21)];
            Point fp_23 = new Point{x = 0, y = 0, z = 0};
            foreach (var idx_24 in face_22) {
                fp_23 = sumPoint(fp_23, points_18[(int)(idx_24)]);
            }
            fp_23 = divPoint(fp_23, Convert.ToDouble(((System.Collections.ICollection)(face_22)).Count));
    ...
    static long[][] sortEdges(long[][] edges_25) {
        ...
        while ((((System.Collections.ICollection)(tmp_27)).Count > 0)) {
            long[] min_28 = tmp_27[(int)(0)];
            long idx_29 = 0;
            long j_30 = 1;
            while ((j_30 < ((System.Collections.ICollection)(tmp_27)).Count)) {
            ...
            long k_33 = 0;
            while ((k_33 < ((System.Collections.ICollection)(tmp_27)).Count)) {
                if ((k_33 != idx_29)) {
    ...
    static Edge[] getEdgesFaces(Point[] points_34, long[][] faces_35) {
        ...
        long fnum_37 = 0;
        while ((fnum_37 < ((System.Collections.ICollection)(faces_35)).Count)) {
            long[] face_38 = faces_35[(int)(fnum_37)];
            var numP_39 = ((System.Collections.ICollection)(face_38)).Count;
            long pi_40 = 0;
            while ((pi_40 < numP_39)) {
        ...
        long idx_45 = 0;
        while ((idx_45 < ((System.Collections.ICollection)(edges_36)).Count)) {
            long[] e1_46 = edges_36[(int)(idx_45)];
            if ((idx_45 < (((dynamic)((System.Collections.ICollection)(edges_36)).Count) - ((dynamic)1)))) {
    ...
    static Point[] getEdgePoints(Point[] points_53, Edge[] edgesFaces_54, Point[] facePoints_55) {
        ...
        long i_57 = 0;
        while ((i_57 < ((System.Collections.ICollection)(edgesFaces_54)).Count)) {
    ...
    static Point[] getAvgFacePoints(Point[] points_63, long[][] faces_64, Point[] facePoints_65) {
        var numP_66 = ((System.Collections.ICollection)(points_63)).Count;
        PointEx[] temp_67 = new PointEx[]{};
        long i_68 = 0;
        while ((i_68 < numP_66)) {
            temp_67 = (Enumerable.ToArray(Enumerable.Append(temp_67, new PointEx{p = new Point{x = 0, y = 0, z = 0}, n = 0})));
            i_68 = (i_68 + 1);
        };
        long fnum_69 = 0;
        while ((fnum_69 < ((System.Collections.ICollection)(faces_64)).Count)) {
    ...
    static Point[] getAvgMidEdges(Point[] points_76, Edge[] edgesFaces_77) {
        var numP_78 = ((System.Collections.ICollection)(points_76)).Count;
        PointEx[] temp_79 = new PointEx[]{};
        long i_80 = 0;
        while ((i_80 < numP_78)) {
            temp_79 = (Enumerable.ToArray(Enumerable.Append(temp_79, new PointEx{p = new Point{x = 0, y = 0, z = 0}, n = 0})));
            i_80 = (i_80 + 1);
        };
    ...
    static long[] getPointsFaces(Point[] points_89, long[][] faces_90) {
        long[] pf_91 = new long[]{};
        long i_92 = 0;
        while ((i_92 < ((System.Collections.ICollection)(points_89)).Count)) {
            pf_91 = (Enumerable.ToArray(Enumerable.Append(pf_91, 0)));
            i_92 = (i_92 + 1);
        };
        long fnum_93 = 0;
        while ((fnum_93 < ((System.Collections.ICollection)(faces_90)).Count)) {
    ...
    static Point[] getNewPoints(Point[] points_95, long[] pf_96, Point[] afp_97, Point[] ame_98) {
        ...
        long i_100 = 0;
        while ((i_100 < ((System.Collections.ICollection)(points_95)).Count)) {
            var n_101 = Convert.ToDouble(pf_96[(int)(i_100)]);
            double m1_102 = (((dynamic)(((dynamic)n_101) - ((dynamic)3))) / ((dynamic)n_101));
            double m2_103 = (((dynamic)1) / ((dynamic)n_101));
            double m3_104 = (((dynamic)2) / ((dynamic)n_101));
    ...
    static string key(long a_109, long b_110) {
        if ((a_109 < b_110)) {
            return (((a_109).ToString() + ",") + (b_110).ToString());
        };
        return (((b_110).ToString() + ",") + (a_109).ToString());
    }
    ...
    static object[] cmcSubdiv(Point[] points_111, long[][] faces_112) {
        ...
        long nextPoint_121 = ((System.Collections.ICollection)(newPoints_119)).Count;
        ...
        long idx_124 = 0;
        while ((idx_124 < ((System.Collections.ICollection)(edgesFaces_114)).Count)) {
        ...
        long fnum_127 = 0;
        while ((fnum_127 < ((System.Collections.ICollection)(faces_112)).Count)) {
            long[] oldFace_128 = faces_112[(int)(fnum_127)];
            if ((((System.Collections.ICollection)(oldFace_128)).Count == 4)) {
    ...
    static string formatFace(long[] f_139) {
        if ((((System.Collections.ICollection)(f_139)).Count == 0)) {
            return "[]";
        };
        string s_140 = ("[" + fmt2(f_139[(int)(0)]));
        long i_141 = 1;
        while ((i_141 < ((System.Collections.ICollection)(f_139)).Count)) {
    ...
    static void main() {
        Point[] inputPoints_142 = new Point[]{new Point{x = -1, y = 1, z = 1}, new Point{x = -1, y = -1, z = 1}, new Point{x = 1, y = -1, z = 1}, new Point{x = 1, y = 1, z = 1}, new Point{x = 1, y = -1, z = -1}, new Point{x = 1, y = 1, z = -1}, new Point{x = -1, y = -1, z = -1}, new Point{x = -1, y = 1, z = -1}};

...
class Program {
    ...
    static long[][] sortEdges(long[][] edges_25) {
        ...
        while ((tmp_27.Length > 0)) {
            long[] min_28 = tmp_27[(int)(0)];
            long idx_29 = 0;
            long j_30 = 1;
            while ((j_30 < tmp_27.Length)) {
    ...
    static Point[] getEdgePoints(Point[] points_53, Edge[] edgesFaces_54, Point[] facePoints_55) {
        ...
        long i_57 = 0;
        while ((i_57 < edgesFaces_54.Length)) {
    ...
    static long[] getPointsFaces(Point[] points_89, long[][] faces_90) {
        long[] pf_91 = new long[]{};
        long i_92 = 0;
        while ((i_92 < points_89.Length)) {
            pf_91 = (Enumerable.ToArray(Enumerable.Append(pf_91, 0)));
            i_92 = (i_92 + 1);
        };
        long fnum_93 = 0;
        while ((fnum_93 < faces_90.Length)) {
    ...
    static object[] cmcSubdiv(Point[] points_111, long[][] faces_112) {
        ...
        long idx_124 = 0;
        while ((idx_124 < edgesFaces_114.Length)) {
        ...
        long fnum_127 = 0;
        while ((fnum_127 < faces_112.Length)) {

...
class Program {
    ...
    static BigRat br(long n_0, long d_1) {
    ...
    static string format(Dictionary<string, long>[] ts_3) {
        string s_4 = "[";
        long i_5 = 0;
        while ((Convert.ToDouble(i_5) < Convert.ToDouble(ts_3.Length))) {
    ...
    static BigRat tanEval(long coef_7, BigRat f_8) {
        if ((coef_7 == 1)) {
            return f_8;
        };
        if ((coef_7 < 0)) {
        ...
        BigRat a_11 = tanEval(ca_9, f_8);
        BigRat b_12 = tanEval(cb_10, f_8);
        return _div(_bigrat(_add(a_11, b_12)), _bigrat(_sub(_bigrat(1), _mul(a_11, b_12))));
    }

    static BigRat tans(Dictionary<string, long>[] m_13) {
        if ((m_13.Length == 1)) {
        ...
        BigRat a_16 = tans(m_13.Skip((int)(0)).Take((int)((half_15 - 0))).ToArray());
        BigRat b_17 = tans(m_13.Skip((int)(half_15)).Take((int)((m_13.Length - half_15))).ToArray());
    ...
    static void Main() {
        {
            ...
            foreach (var ts_18 in testCases_2) {
                Console.WriteLine(_fmtTop(((("tan " + format(ts_18)) + " = ") + _fmt(tans(ts_18)))));
            }
            var __end = _now();
            var __memEnd = _mem();

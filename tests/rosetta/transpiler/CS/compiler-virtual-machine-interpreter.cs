...
class Program {
    ...
    static Dictionary<string, object> parseProgram(string src_14) {
        string[] lines_15 = split(src_14, "\n");
        string[] header_16 = fields(lines_15[(int)(0)]);
        var dataSize_17 = Convert.ToInt64(header_16[(int)(1)]);
        var nStrings_18 = Convert.ToInt64(header_16[(int)(3)]);
        ...
        while ((i_20 < lines_15.Length)) {
            ...
            var addr_26 = Convert.ToInt64(parts_25[(int)(0)]);
            string op_27 = parts_25[(int)(1)];
            long arg_28 = 0;
            if ((op_27 == "push")) {
                arg_28 = Convert.ToInt64(parts_25[(int)(2)]);
            } else {
                if (((op_27 == "fetch") || (op_27 == "store"))) {
                    arg_28 = Convert.ToInt64(parts_25[(int)(2)].Substring((int)(1), (int)((((dynamic)parts_25[(int)(2)].Length) - ((dynamic)1)) - 1)));
                } else {
                    if (((op_27 == "jmp") || (op_27 == "jz"))) {
                        arg_28 = Convert.ToInt64(parts_25[(int)(3)]);
                    }
                }
            }
    ...
    static void runVM(Dictionary<string, object> prog_29) {
        ...
        long i_31 = 0;
        while ((i_31 < ((dynamic)prog_29)["dataSize"])) {
            data_30 = (Enumerable.ToArray(Enumerable.Append(data_30, 0)));
            i_31 = (i_31 + 1);
        };
        long[] stack_32 = new long[]{};
        long pc_33 = 0;
        var code_34 = ((dynamic)prog_29)["code"];
        var addrMap_35 = ((dynamic)prog_29)["addrMap"];
        var pool_36 = ((dynamic)prog_29)["strings"];
        string line_37 = "";
        while ((pc_33 < code_34.Length)) {
            ...
            if ((op_39 == "prti")) {
                line_37 = (line_37 + (stack_32[(int)((((dynamic)stack_32.Length) - ((dynamic)1)))]).ToString());
    ...
    static string[] split(string s_47, string sep_48) {
        ...
        while ((i_51 < s_47.Length)) {
            if ((((sep_48.Length > 0) && ((((dynamic)i_51) + ((dynamic)sep_48.Length)) <= s_47.Length)) && (s_47.Substring((int)(i_51), (int)((((dynamic)i_51) + ((dynamic)sep_48.Length)) - i_51)) == sep_48))) {

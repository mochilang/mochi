...
class Program {
    ...
    static string shuffleStr(string s_2) {
        ...
        string out_8 = "";
        i_4 = 0;
        while ((string.Compare(Convert.ToString(i_4), Convert.ToString(arr_3.Length)) < 0)) {
    ...
    static string[] createPolybius() {
        string shuffled_9 = shuffleStr(alphabet_1);
        string[] labels_10 = new string[]{};
        long li_11 = 0;
        while ((string.Compare(Convert.ToString(li_11), Convert.ToString(adfgvx_0.Length)) < 0)) {
        ...
        while ((i_13 < 6)) {
            ...
            Console.WriteLine(_fmtTop(line_15));
            i_13 = (i_13 + 1);
        };
        return p_12;
    }

    static string createKey(long n_17) {
        if (((n_17 < 7) || (n_17 > 12))) {
        ...
        long i_20 = 0;
        while ((i_20 < n_17)) {
            long idx_21 = (((dynamic)(_now())) % ((dynamic)(pool_18.Length)));
    ...
    static long[] orderKey(string key_22) {
        object[] pairs_23 = new object[]{};
        long i_24 = 0;
        while ((string.Compare(Convert.ToString(i_24), Convert.ToString(key_22.Length)) < 0)) {
        ...
        var n_25 = pairs_23.Length;
        long m_26 = 0;
        while ((string.Compare(Convert.ToString(m_26), Convert.ToString(n_25)) < 0)) {
            long j_27 = 0;
            while ((j_27 < (((dynamic)(n_25)) - ((dynamic)(1))))) {
        ...
        i_24 = 0;
        while ((string.Compare(Convert.ToString(i_24), Convert.ToString(n_25)) < 0)) {
    ...
    static string encrypt(string[] polybius_30, string key_31, string plainText_32) {
        string[] labels_33 = new string[]{};
        long li_34 = 0;
        while ((string.Compare(Convert.ToString(li_34), Convert.ToString(adfgvx_0.Length)) < 0)) {
            labels_33 = (Enumerable.ToArray(Enumerable.Append(labels_33, adfgvx_0.Substring((int)(li_34), (int)((li_34 + 1) - li_34)))));
            li_34 = (li_34 + 1);
        };
        string temp_35 = "";
        long i_36 = 0;
        while ((string.Compare(Convert.ToString(i_36), Convert.ToString(plainText_32.Length)) < 0)) {
            long r_37 = 0;
            while ((r_37 < 6)) {
                long c_38 = 0;
                while ((c_38 < 6)) {
                    if ((polybius_30[(int)(r_37)].Substring((int)(c_38), (int)((c_38 + 1) - c_38)) == plainText_32.Substring((int)(i_36), (int)((i_36 + 1) - i_36)))) {
                        temp_35 = ((temp_35 + labels_33.Skip((int)(r_37)).Take((int)(((r_37 + 1) - r_37))).ToArray()) + labels_33.Skip((int)(c_38)).Take((int)(((c_38 + 1) - c_38))).ToArray());
                    }
                    c_38 = (c_38 + 1);
                }
                r_37 = (r_37 + 1);
        ...
        long colLen_39 = (((dynamic)(temp_35.Length)) / ((dynamic)(key_31.Length)));
        if ((string.Compare(Convert.ToString((((dynamic)(temp_35.Length)) % ((dynamic)(key_31.Length)))), Convert.ToString(0)) > 0)) {
        ...
        while ((rIdx_41 < colLen_39)) {
            ...
            long j_43 = 0;
            while ((string.Compare(Convert.ToString(j_43), Convert.ToString(key_31.Length)) < 0)) {
        ...
        long idx_44 = 0;
        while ((string.Compare(Convert.ToString(idx_44), Convert.ToString(temp_35.Length)) < 0)) {
            long row_45 = (((dynamic)(idx_44)) / ((dynamic)(key_31.Length)));
            long col_46 = (((dynamic)(idx_44)) % ((dynamic)(key_31.Length)));
            table_40[(int)(row_45)][col_46] = temp_35.Substring((int)(idx_44), (int)((idx_44 + 1) - idx_44));
            idx_44 = (idx_44 + 1);
        };
        long[] order_47 = orderKey(key_31);
        string[] cols_48 = new string[]{};
        long ci_49 = 0;
        while ((string.Compare(Convert.ToString(ci_49), Convert.ToString(key_31.Length)) < 0)) {
            string colStr_50 = "";
            long ri_51 = 0;
        ...
        string result_52 = "";
        ci_49 = 0;
        while ((string.Compare(Convert.ToString(ci_49), Convert.ToString(cols_48.Length)) < 0)) {
            result_52 = (result_52 + cols_48[(int)(ci_49)]);
            if ((ci_49 < (((dynamic)(cols_48.Length)) - ((dynamic)(1))))) {
                result_52 = (result_52 + " ");
            }
            ci_49 = (ci_49 + 1);
        };
    ...
    static long indexOf(string s_53, string ch_54) {
        long i_55 = 0;
        while ((string.Compare(Convert.ToString(i_55), Convert.ToString(s_53.Length)) < 0)) {
    ...
    static string decrypt(string[] polybius_56, string key_57, string cipherText_58) {
        string[] colStrs_59 = new string[]{};
        long start_60 = 0;
        long i_61 = 0;
        while ((string.Compare(Convert.ToString(i_61), Convert.ToString(cipherText_58.Length)) <= 0)) {
        ...
        long maxColLen_62 = 0;
        i_61 = 0;
        while ((string.Compare(Convert.ToString(i_61), Convert.ToString(colStrs_59.Length)) < 0)) {
            if ((string.Compare(Convert.ToString(colStrs_59[(int)(i_61)].Length), Convert.ToString(maxColLen_62)) > 0)) {
        ...
        while ((string.Compare(Convert.ToString(i_61), Convert.ToString(colStrs_59.Length)) < 0)) {
            ...
            long j_66 = 0;
            while ((string.Compare(Convert.ToString(j_66), Convert.ToString(s_64.Length)) < 0)) {
                ls_65 = (Enumerable.ToArray(Enumerable.Append(ls_65, s_64.Substring((int)(j_66), (int)((j_66 + 1) - j_66)))));
                j_66 = (j_66 + 1);
            }
            if ((string.Compare(Convert.ToString(s_64.Length), Convert.ToString(maxColLen_62)) < 0)) {
                string[] pad_67 = new string[]{};
                long k_68 = 0;
                while ((k_68 < maxColLen_62)) {
                    if ((string.Compare(Convert.ToString(k_68), Convert.ToString(ls_65.Length)) < 0)) {
        ...
        while ((r_70 < maxColLen_62)) {
            ...
            long c_72 = 0;
            while ((string.Compare(Convert.ToString(c_72), Convert.ToString(key_57.Length)) < 0)) {
        ...
        long[] order_73 = orderKey(key_57);
        r_70 = 0;
        while ((r_70 < maxColLen_62)) {
            long c_74 = 0;
            while ((string.Compare(Convert.ToString(c_74), Convert.ToString(key_57.Length)) < 0)) {
        ...
        string temp_75 = "";
        r_70 = 0;
        while ((string.Compare(Convert.ToString(r_70), Convert.ToString(table_69.Length)) < 0)) {
            long j_76 = 0;
            while ((string.Compare(Convert.ToString(j_76), Convert.ToString(table_69[(int)(r_70)].Length)) < 0)) {
        ...
        string plainText_77 = "";
        long idx_78 = 0;
        while ((string.Compare(Convert.ToString(idx_78), Convert.ToString(temp_75.Length)) < 0)) {
            long rIdx_79 = indexOf(adfgvx_0, temp_75.Substring((int)(idx_78), (int)((idx_78 + 1) - idx_78)));
            long cIdx_80 = indexOf(adfgvx_0, temp_75.Substring((int)((idx_78 + 1)), (int)((idx_78 + 2) - (idx_78 + 1))));
    ...
    static void main() {
        ...
        string[] polybius_82 = createPolybius();
        string key_83 = createKey(9);
        Console.WriteLine(_fmtTop(("\nPlaintext : " + plainText_81)));
        string cipherText_84 = encrypt(polybius_82, key_83, plainText_81);
        Console.WriteLine(_fmtTop(("\nEncrypted : " + cipherText_84)));
        string plainText2_85 = decrypt(polybius_82, key_83, cipherText_84);

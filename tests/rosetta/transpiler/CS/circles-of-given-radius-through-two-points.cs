...
class Program {
    ...
    static object[] circles(Point p1_11, Point p2_12, double r_13) {
        ...
        double d_18 = sqrtApprox(((r_13 * r_13) - ((q_16 * q_16) / 4.0)));
    ...
    static void Main() {
        {
            ...
            foreach (var tc_22 in td_21) {
                ...
                Console.WriteLine(_fmtTop((((("p1:  {" + _fmt(((dynamic)(p1_23)).x)) + " ") + _fmt(((dynamic)(p1_23)).y)) + "}")));
                Console.WriteLine(_fmtTop((((("p2:  {" + _fmt(((dynamic)(p2_24)).x)) + " ") + _fmt(((dynamic)(p2_24)).y)) + "}")));
                Console.WriteLine(_fmtTop(("r:  " + _fmt(r_25))));
                ...
                if (((caseStr_29 == "Points form a diameter and describe only a single circle.") || (caseStr_29 == "Coincident points with r==0.0 describe a degenerate circle."))) {
                    Console.WriteLine(_fmtTop((((("   Center:  {" + _fmt(((dynamic)(c1_27)).x)) + " ") + _fmt(((dynamic)(c1_27)).y)) + "}")));
                } else {
                    if ((caseStr_29 == "Two circles.")) {
                        Console.WriteLine(_fmtTop((((("   Center 1:  {" + _fmt(((dynamic)(c1_27)).x)) + " ") + _fmt(((dynamic)(c1_27)).y)) + "}")));
                        Console.WriteLine(_fmtTop((((("   Center 2:  {" + _fmt(((dynamic)(c2_28)).x)) + " ") + _fmt(((dynamic)(c2_28)).y)) + "}")));
                    }
                }

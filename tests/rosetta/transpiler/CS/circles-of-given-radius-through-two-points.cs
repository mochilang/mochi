...
class Program {
    ...
    static object[] td_21 = new object[]{new object[]{new Point{x = 0.1234, y = 0.9876}, new Point{x = 0.8765, y = 0.2345}, 2}, new object[]{new Point{x = 0, y = 2}, new Point{x = 0, y = 0}, 1}, new object[]{new Point{x = 0.1234, y = 0.9876}, new Point{x = 0.1234, y = 0.9876}, 2}, new object[]{new Point{x = 0.1234, y = 0.9876}, new Point{x = 0.8765, y = 0.2345}, 0.5}, new object[]{new Point{x = 0.1234, y = 0.9876}, new Point{x = 0.1234, y = 0.9876}, 0}};
    ...
    static double hypot(double x_3, double y_4) {
        return sqrtApprox(((x_3 * x_3) + (y_4 * y_4)));
    }

    static object[] circles(Point p1_11, Point p2_12, double r_13) {
    ...
    static void Main() {
        {
            var __memStart = _mem();
            var __start = _now();
            foreach (var tc_22 in td_21) {
                var p1_23 = ((dynamic)tc_22)[0];
                var p2_24 = ((dynamic)tc_22)[1];
                var r_25 = ((dynamic)tc_22)[2];
                Console.WriteLine(_fmtTop((((("p1:  {" + (p1_23.x).ToString()) + " ") + (p1_23.y).ToString()) + "}")));
                Console.WriteLine(_fmtTop((((("p2:  {" + (p2_24.x).ToString()) + " ") + (p2_24.y).ToString()) + "}")));
                Console.WriteLine(_fmtTop(("r:  " + (r_25).ToString())));
                object[] res_26 = circles(p1_23, p2_24, r_25);
                var c1_27 = ((dynamic)res_26)[0];
                var c2_28 = ((dynamic)res_26)[1];
                var caseStr_29 = ((dynamic)res_26)[2];
                Console.WriteLine(_fmtTop((((dynamic)"   ") + ((dynamic)caseStr_29))));
                if (((caseStr_29 == "Points form a diameter and describe only a single circle.") || (caseStr_29 == "Coincident points with r==0.0 describe a degenerate circle."))) {
                    Console.WriteLine(_fmtTop((((("   Center:  {" + (c1_27.x).ToString()) + " ") + (c1_27.y).ToString()) + "}")));
                } else {
                    if ((caseStr_29 == "Two circles.")) {
                        Console.WriteLine(_fmtTop((((("   Center 1:  {" + (c1_27.x).ToString()) + " ") + (c1_27.y).ToString()) + "}")));
                        Console.WriteLine(_fmtTop((((("   Center 2:  {" + (c2_28.x).ToString()) + " ") + (c2_28.y).ToString()) + "}")));
                    }
                }

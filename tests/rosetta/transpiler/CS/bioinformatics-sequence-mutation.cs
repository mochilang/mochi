// Generated by Mochi 0.10.52 on 2025-07-31 11:08 +0700
using System;
...
class Program {
    ...
    static object[] mutate(long s_14, string dna_15, long[] w_16) {
        ...
        long i_23 = 0;
        while ((string.Compare(Convert.ToString(i_23), Convert.ToString(le_18)) < 0)) {
        ...
        string out_30 = "";
        i_23 = 0;
        while ((string.Compare(Convert.ToString(i_23), Convert.ToString(arr_22.Length)) < 0)) {
    ...
    static void prettyPrint(string dna_31, long rowLen_32) {
        ...
        long i_34 = 0;
        while ((string.Compare(Convert.ToString(i_34), Convert.ToString(le_33)) < 0)) {
            long k_35 = (i_34 + rowLen_32);
            if ((string.Compare(Convert.ToString(k_35), Convert.ToString(le_33)) > 0)) {
                k_35 = le_33;
            }
        ...
        long t_39 = 0;
        long idx_40 = 0;
        while ((string.Compare(Convert.ToString(idx_40), Convert.ToString(le_33)) < 0)) {

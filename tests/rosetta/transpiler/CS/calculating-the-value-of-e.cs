...
class Program {
    ...
    static double e_14 = 2;
    static long n_15 = 2;
    static double term_16 = 1;
    ...
    static string formatFloat(double f_5, long prec_6) {
        ...
        var n_9 = Convert.ToInt64(scaled_8);
        string digits_10 = (n_9).ToString();
        while ((digits_10.Length <= prec_6)) {
    ...
    static void Main() {
        {
            ...
            while (true) {
                ...
                n_15 = (n_15 + 1);
                term_16 = (((dynamic)1) / ((dynamic)Convert.ToDouble(factval_13)));
                e_14 = (e_14 + term_16);

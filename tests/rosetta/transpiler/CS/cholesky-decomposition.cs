...
class Program {
    ...
    static double[][] cholesky(double[][] a_3) {
        ...
        long i_6 = 0;
        while ((Convert.ToDouble(i_6) < Convert.ToDouble(n_4))) {
            double[] row_7 = new double[]{};
            long j_8 = 0;
            while ((Convert.ToDouble(j_8) < Convert.ToDouble(n_4))) {
    ...
    static void printMat(double[][] m_12) {
        long i_13 = 0;
        while ((Convert.ToDouble(i_13) < Convert.ToDouble(m_12.Length))) {
            string line_14 = "";
            long j_15 = 0;
            while ((Convert.ToDouble(j_15) < Convert.ToDouble(m_12[(int)(i_13)].Length))) {

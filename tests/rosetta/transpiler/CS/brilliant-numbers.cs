...
class Program {
    ...
    static long[] sortInts(long[] xs_7) {
        long[] res_8 = new long[]{};
        long[] tmp_9 = xs_7;
        while ((tmp_9.Length > 0)) {
            long min_10 = tmp_9[(int)(0)];
            long idx_11 = 0;
            long i_12 = 1;
            while ((i_12 < tmp_9.Length)) {
    ...
    static void main() {
        ...
        long[] br_33 = sortInts(((dynamic)r_32)["bc"]);
        br_33 = br_33.Skip((int)(0)).Take((int)((100 - 0))).ToArray();
        long i_34 = 0;
        while ((i_34 < br_33.Length)) {
            Console.WriteLine(string.Join(" ", new string[]{_fmtTop((((dynamic)(br_33[(int)(i_34)]).ToString().PadLeft(4, ' ')) + ((dynamic)" "))), _fmtTop(false)}));
            if ((((i_34 + 1) % 10) == 0)) {
        ...
        while ((k_35 <= 13)) {
            ...
            var total_38 = ((dynamic)r2_37)["bc"];
            var next_39 = ((dynamic)r2_37)["next"];
            string climit_40 = commatize(limit_36);
            string ctotal_41 = commatize((((dynamic)total_38) + ((dynamic)1)));
            string cnext_42 = commatize(next_39);

// Generated by Mochi 0.10.40 on 2025-07-25 10:55 +0700
using System;
...
class Program {
    ...
    static void main() {
        ...
        for (var i_0 = 0; i_0 < 4; i_0++) {
            digits = (digits.Append((object)randDigit()).ToArray());
        };
        string numstr = "";
        ...
        while ((i < expr.Length)) {
            ...
            if (((string.Compare(ch, "0") >= 0) && (string.Compare(ch, "9") <= 0))) {
                ...
                stack = (stack.Append((object)Convert.ToDouble((Convert.ToInt32(ch) - Convert.ToInt32("0")))).ToArray());
            } else {
                if ((stack.Length < 2)) {

// Generated by Mochi 0.10.42 on 2025-07-27 16:56 UTC
using System;
...
class Program {
    ...
    static double[][] unpackSym(Dictionary<string, object> m_5) {
        var n_6 = ((dynamic)m_5)["order"];
        var ele_7 = ((dynamic)m_5)["ele"];
        ...
        while ((r_10 < n_6)) {
            ...
            long c_12 = 0;
            while ((c_12 <= r_10)) {
                row_11 = (Enumerable.ToArray(Enumerable.Append(row_11, (double)((dynamic)ele_7)[idx_9])));
                idx_9 = (idx_9 + 1);
                c_12 = (c_12 + 1);
            }
            while ((c_12 < n_6)) {
                row_11 = (Enumerable.ToArray(Enumerable.Append(row_11, 0)));
                c_12 = (c_12 + 1);
            }
    ...
    static void printMat(double[][] m_14) {
        ...
        while ((i_15 < m_14.Length)) {
            ...
            while ((j_17 < m_14[(int)(i_15)].Length)) {
                line_16 = (line_16 + (m_14[(int)(i_15)][(int)(j_17)]).ToString());
    ...
    static void printLower(Dictionary<string, object> m_19) {
        var n_20 = ((dynamic)m_19)["order"];
        var ele_21 = ((dynamic)m_19)["ele"];
        ...
        while ((r_24 < n_20)) {
            ...
            long c_26 = 0;
            while ((c_26 <= r_24)) {
                row_25 = (Enumerable.ToArray(Enumerable.Append(row_25, (double)((dynamic)ele_21)[idx_23])));
                idx_23 = (idx_23 + 1);
                c_26 = (c_26 + 1);
            }
            while ((c_26 < n_20)) {
    ...
    static Dictionary<string, object> choleskyLower(Dictionary<string, object> a_27) {
        var n_28 = ((dynamic)a_27)["order"];
        var ae_29 = ((dynamic)a_27)["ele"];
        double[] le_30 = new double[]{};
        long idx_31 = 0;
        while ((idx_31 < ae_29.Length)) {
            le_30 = (Enumerable.ToArray(Enumerable.Append(le_30, 0)));
            idx_31 = (idx_31 + 1);
        };
        long row_32 = 1;
        long col_33 = 1;
    ...
    static void Main() {
        {
            var __memStart = _mem();
            var __start = _now();
            demo(makeSym(3, new double[]{25, 15, 18, -5, 0, 11}));
            demo(makeSym(4, new double[]{18, 22, 70, 54, 86, 174, 42, 62, 134, 106}));
            var __end = _now();
            var __memEnd = _mem();

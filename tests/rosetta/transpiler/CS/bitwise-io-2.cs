...
class Program {
    ...
    static string bytesToBits(long[] bs_38) {
        string out_39 = "[";
        long i_40 = 0;
        while ((i_40 < bs_38.Length)) {
            out_39 = (out_39 + toBinary(bs_38[(int)(i_40)], 8));
            if (((i_40 + 1) < bs_38.Length)) {
                out_39 = (out_39 + " ");
            }
            i_40 = (i_40 + 1);
        };
    ...
    static long ord(string ch_48) {
        ...
        if (((string.Compare(ch_48, "0") >= 0) && (string.Compare(ch_48, "9") <= 0))) {
            return (((dynamic)48) + ((dynamic)Convert.ToInt64(ch_48)));
        };
        if ((ch_48 == " ")) {
            return 32;
        };
    ...
    static string bytesToDec(long[] bs_59) {
        string out_60 = "";
        long i_61 = 0;
        while ((i_61 < bs_59.Length)) {
            out_60 = (out_60 + (bs_59[(int)(i_61)]).ToString());
            if (((i_61 + 1) < bs_59.Length)) {
                out_60 = (out_60 + " ");
            }
            i_61 = (i_61 + 1);
        };
    ...
    static void Example() {
        ...
        while (true) {
            ...
            var v_69 = Convert.ToInt64(((dynamic)r_68)["val"]);
            if ((v_69 != 0)) {

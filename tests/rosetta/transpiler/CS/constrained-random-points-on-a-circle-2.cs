...
class Program {
    ...
    static string[][] rows_10 = new string[][]{};
    static long r_11 = 0;
    static long u_14 = 0;
    static Dictionary<string, bool> seen_15 = new Dictionary<string, bool>{};
    static long n_16 = 0;
    static long i2_23 = 0;
    static void Main() {
        {
            ...
            Console.WriteLine(_fmtTop(((poss_4.Length).ToString() + " possible points")));
            while ((r_11 < span_3)) {
            ...
            while ((n_16 < nPts_0)) {
                ...
                string key_22 = (((row_20).ToString() + ",") + (col_21).ToString());
            ...
            Console.WriteLine(_fmtTop(((u_14).ToString() + " unique points")));
            var __end = _now();
            var __memEnd = _mem();

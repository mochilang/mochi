...
class Program {
    ...
    static Dictionary<string, object> b_43 = newBitmap(400, 300);
    ...
    static void bezier3(Dictionary<string, object> b, long x1, long y1, long x2, long y2, long x3, long y3, long x4, long y4, Pixel p) {
        long[] px_20 = new long[]{};
        long[] py_21 = new long[]{};
        long i_22 = 0;
        while ((i_22 <= b3Seg_0)) {
        ...
        var fx4_29 = Convert.ToDouble(x4);
        var fy4_30 = Convert.ToDouble(y4);
        i_22 = 0;
        while ((i_22 <= b3Seg_0)) {
            var d_31 = (((dynamic)Convert.ToDouble(i_22)) / ((dynamic)Convert.ToDouble(b3Seg_0)));
            double a_32 = (((dynamic)1) - ((dynamic)d_31));
            double bcoef_33 = (a_32 * a_32);
            var ccoef_34 = (((dynamic)d_31) * ((dynamic)d_31));
            double a2_35 = (a_32 * bcoef_33);
            double b2_36 = (((dynamic)(3 * bcoef_33)) * ((dynamic)d_31));
            double c2_37 = (((dynamic)(3 * a_32)) * ((dynamic)ccoef_34));
            var d2_38 = (((dynamic)ccoef_34) * ((dynamic)d_31));
            px_20[i_22] = Convert.ToInt64((((dynamic)(((((dynamic)a2_35) * ((dynamic)fx1_23)) + (((dynamic)b2_36) * ((dynamic)fx2_25))) + (((dynamic)c2_37) * ((dynamic)fx3_27)))) + ((dynamic)(((dynamic)d2_38) * ((dynamic)fx4_29)))));
            py_21[i_22] = Convert.ToInt64((((dynamic)(((((dynamic)a2_35) * ((dynamic)fy1_24)) + (((dynamic)b2_36) * ((dynamic)fy2_26))) + (((dynamic)c2_37) * ((dynamic)fy3_28)))) + ((dynamic)(((dynamic)d2_38) * ((dynamic)fy4_30)))));
            i_22 = (i_22 + 1);
        };
        long x0_39 = px_20[(int)(0)];
        long y0_40 = py_21[(int)(0)];
        i_22 = 1;
        while ((i_22 <= b3Seg_0)) {
            long x_41 = px_20[(int)(i_22)];
            long y_42 = py_21[(int)(i_22)];
            line(b, x0_39, y0_40, x_41, y_42, p);
            x0_39 = x_41;
            y0_40 = y_42;
            i_22 = (i_22 + 1);
        };
    ...
    static void Main() {
        {
            var __memStart = _mem();
            var __start = _now();
            fillRgb(b_43, 16773055);
            bezier3(b_43, 20, 200, 700, 50, -300, 50, 380, 150, pixelFromRgb(4165615));
            var __end = _now();
            var __memEnd = _mem();

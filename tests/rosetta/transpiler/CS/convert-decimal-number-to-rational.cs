...
class Program {
    ...
    static Dictionary<string, long> parseRational(string s_5) {
        ...
        long i_10 = 0;
        while ((i_10 < s_5.Length)) {
            string ch_11 = s_5.Substring((int)(i_10), (int)((i_10 + 1) - i_10));
            if ((ch_11 == ".")) {
                afterDot_9 = true;
            } else {
                var d_12 = (((dynamic)Convert.ToInt64(ch_11)) - ((dynamic)Convert.ToInt64("0")));
                if ((!afterDot_9)) {
                    intPart_6 = (((dynamic)(intPart_6 * 10)) + ((dynamic)d_12));
                } else {
                    fracPart_7 = (((dynamic)(fracPart_7 * 10)) + ((dynamic)d_12));
                    denom_8 = (denom_8 * 10);
                }
            }
            i_10 = (i_10 + 1);
    ...
    static void main() {
        ...
        foreach (var s_16 in inputs_15) {
            ...
            Console.WriteLine(_fmtTop(((((s_16 + " = ") + ((r_17.ContainsKey("num") ? r_17["num"] : 0)).ToString()) + "/") + ((r_17.ContainsKey("den") ? r_17["den"] : 0)).ToString())));
        };
    }

...
static g_pps: LazyLock<Mutex<HashMap<i64, bool>>> = LazyLock::new(|| Mutex::new(HashMap::new()));
fn main() {
    unsafe {
    ...
    let mut idx: i64 = 0;
    while (count < 30) {
        let tot: i64 = totient(ach[idx as usize]);

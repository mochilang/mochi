...
static mut g_house1: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_house2: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_bedrooms: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_bathrooms: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_attic: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_kitchen: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_living_rooms: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_basement: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_garage: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_garden: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_upstairs: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_groundfloor: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_basement: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_bathroom1: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_bathroom2: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_outside: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_lounge: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_dining: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_conservatory: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h1_playroom: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_bedrooms: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_bathroom: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_toilet: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_attics: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_kitchen: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_living_rooms: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_wet_room: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_garage: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_garden: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_hot_tub: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_cellars: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_wine_cellar: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_cinema: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_suite1: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_suite2: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_bedroom3: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_bedroom4: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_lounge: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_dining: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_conservatory: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
static mut g_h2_playroom: Map = Map { name: 0, weight: 0, coverage: 0.0, children: Vec::new() };
...
unsafe fn newNode(name: &str, mut weight: i64, mut coverage: f64) -> Map {
    return Map {name: name, weight: weight, coverage: coverage, children: vec![]}
}

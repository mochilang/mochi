// Generated by Mochi transpiler v0.10.41 on 2025-07-27 01:41 +0700
...
fn main() {
    ...
    for a in angles.clone() {
        println!("{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", a.to_string(), " "), d2d((a as f64)).to_string()), " "), d2g((a as f64)).to_string()), " "), d2m((a as f64)).to_string()), " "), d2r((a as f64)).to_string()));
    }
    println!("{}", "\ngradians normalized_grds degrees mils radians");
    for a in angles.clone() {
        println!("{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", a.to_string(), " "), g2g((a as f64)).to_string()), " "), g2d((a as f64)).to_string()), " "), g2m((a as f64)).to_string()), " "), g2r((a as f64)).to_string()));
    }
    println!("{}", "\nmils normalized_mils degrees gradians radians");
    for a in angles.clone() {
        println!("{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", a.to_string(), " "), m2m((a as f64)).to_string()), " "), m2d((a as f64)).to_string()), " "), m2g((a as f64)).to_string()), " "), m2r((a as f64)).to_string()));
    }
    println!("{}", "\nradians normalized_rads degrees gradians mils");
    for a in angles.clone() {
        println!("{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", a.to_string(), " "), r2r((a as f64)).to_string()), " "), r2d((a as f64)).to_string()), " "), r2g((a as f64)).to_string()), " "), r2m((a as f64)).to_string()));
    }
};
    mochi_main();
    let _end: i64 = _now();

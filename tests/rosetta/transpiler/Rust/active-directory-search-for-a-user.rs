...
fn main() {
    ...
    return directory[username.as_str()].clone()
};
    fn mochi_main() {
    ...
    let directory = HashMap::from([(String::from("username"), vec![String::from("admins"), String::from("users")]), (String::from("john"), vec![String::from("users")])]);

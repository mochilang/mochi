// Generated by Mochi transpiler v0.10.52 on 2025-08-01 21:31 +0700
...
static g_serverData: LazyLock<Mutex<HashMap<String, HashMap<String, String>>>> = LazyLock::new(|| Mutex::new(HashMap::new()));
static g_serverNames: LazyLock<Mutex<HashMap<String, Vec<String>>>> = LazyLock::new(|| Mutex::new(HashMap::new()));
fn main() {
    unsafe {
        *g_serverData.lock().unwrap() = HashMap::from([(String::from("pub"), HashMap::from([(String::from("somefile.bin"), String::from("This is a file from the FTP server.")), (String::from("readme.txt"), String::from("Hello from ftp."))]))]);
        *g_serverNames.lock().unwrap() = HashMap::from([(String::from("pub"), vec![String::from("somefile.bin"), String::from("readme.txt")])]);

...
static mut g_testCases: Vec<Vec<HashMap<&str, i64>>> = Vec::new();
fn main() {
    unsafe {
    ...
    while (i < (ts.len() as i64)) {
        ...
        s = format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", format!("{}{}", s, "{"), t["a".as_str()].to_string()), " "), t["n".as_str()].to_string()), " "), t["d".as_str()].to_string()), "}");
    ...
    if ((m.len() as i64) == 1) {
        ...
        return tanEval(t["a".as_str()], br(t["n".as_str()], t["d".as_str()]))
    }

// Generated by Mochi transpiler v0.10.37 on 2025-07-23 09:48 +0700
...
unsafe fn moveLeft(b: Vec<Vec<i64>>, score: i64) -> Map2 {
    ...
    return Map2 {board: b, score: g_score, moved: g_moved}
}
...
fn main() {
    unsafe { g_SIZE = 4; }
    unsafe { g_board = newBoard(); }
    unsafe { g_r = spawnTile(g_board); }
    unsafe { g_full = g_r.full; }
    unsafe { g_score = 0; }
    board = g_r.board;
    r = spawnTile(g_board);
    board = g_r.board;
    ...
    while true {
        println!("{}", "Move: ");
        static mut g_cmd: String = String::new();;
        static mut g_moved: bool = false;;
        if ((g_cmd == "a") || (g_cmd == "A")) {
            static mut g_m: Map2 = Default::default();;
            board = g_m.board;
            score = g_m.score;
            moved = g_m.moved;
        }
        ...
        if g_moved.is_some() {
            static mut g_r2: Map = Default::default();;
            board = g_r2.board;
            full = g_r2.full;

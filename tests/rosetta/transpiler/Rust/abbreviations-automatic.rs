// Generated by Mochi transpiler v0.10.39 on 2025-07-25 00:28 +0700
...
fn distinct(mut xs: Vec<String>) -> Vec<String> {
    ...
    while (i < (xs.len() as i64)) {
        ...
        if !m.contains_key(&x) {
            ...
            out = { let mut v = out.clone(); v.push(x); v };
        }
        i = (i + 1);
    }
    return out
...
fn abbrevLen(mut words: Vec<String>) -> i64 {
    ...
    while true {
        ...
        let mut i: i64 = 0;
        while (i < size) {
            abbrs = { let mut v = abbrs.clone(); v.push(takeRunes(words[i as usize].clone(), l)); v };
            i = (i + 1);
        }
        if ((distinct(abbrs).len() as i64) == size) {
            return l
        }
        l = (l + 1);
    }

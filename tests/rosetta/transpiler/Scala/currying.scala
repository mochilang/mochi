// Generated by Mochi v0.10.42 on 2025-07-27 22:21:51 GMT+7
...
case class Foo(var value: BigInt) {
  def Method(b: BigInt): BigInt = {
    return (value + b).asInstanceOf[BigInt]
  }
}
...
def main(args: Array[String]): Unit = {
  {
    ...
    def main(): Any = {
      ...
      var a: Foo = Foo(BigInt(2))
      val fn1: (BigInt) => Any = ((b: BigInt) => a.Method(b))
      val fn2: (Foo, BigInt) => Any = ((f: Foo, b: BigInt) => f.Method(b))
      println("2 + 2 = " + String.valueOf(a.Method(BigInt(2))))
      println("2 + 3 = " + String.valueOf(fn1(BigInt(3))))
      println("2 + 4 = " + String.valueOf(fn2(a, BigInt(4))))
      println("3 + 5 = " + String.valueOf(fn2(Foo(BigInt(3)), BigInt(5))))
    }
    main()
    val _end = _now()
    System.gc()

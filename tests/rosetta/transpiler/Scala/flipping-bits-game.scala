// Generated by Mochi v0.10.52 on 2025-08-02 11:08:09 GMT+7
...
def shuffleBoard(_b: ArrayBuffer[ArrayBuffer[BigInt]], seed: BigInt): ArrayBuffer[Any] = {
  ...
  while (k < BigInt(2).toInt * n) {
    var r: ArrayBuffer[BigInt] = randInt(s, BigInt(n.toString))
    s = r((BigInt(0).toInt).toInt)
...
def solve(board: ArrayBuffer[ArrayBuffer[BigInt]], target: ArrayBuffer[ArrayBuffer[BigInt]]): scala.collection.mutable.Map[String,ArrayBuffer[BigInt]] = {
  ...
  var i: BigInt = BigInt(0)
  while (i < n) {
    val diff: BigInt = if (board(i.toInt)(BigInt(0).toInt) != target(i.toInt)(BigInt(0).toInt)) BigInt(1) else BigInt(0)
    row = row :+ diff
    i = i + BigInt(1)
  }
  var j: BigInt = BigInt(0)
  while (j < n) {
    val diff: BigInt = if (board(BigInt(0).toInt)(j.toInt) != target(BigInt(0).toInt)(j.toInt)) BigInt(1) else BigInt(0)
...
def applySolution(b: ArrayBuffer[ArrayBuffer[BigInt]], sol: scala.collection.mutable.Map[String,ArrayBuffer[BigInt]]): ArrayBuffer[Any] = {
  ...
  while (i < (sol("row")).size) {
    if (sol("row")((i.toInt).toInt) == BigInt(1)) {
  ...
  while (j < (sol("col")).size) {
    if (sol("col")((j.toInt).toInt) == BigInt(1)) {
...
def main(): Any = {
  ...
  seed = BigInt((res((BigInt(1).toInt).toInt)).toString)
  ...
  _br15.breakable {
    while (true) {
      ...
      seed = BigInt((sres((BigInt(1).toInt).toInt)).toString)
  ...
  var moves: BigInt = BigInt((ares((BigInt(1).toInt).toInt)).toString)
  println("Solved:")
  printBoard(board)

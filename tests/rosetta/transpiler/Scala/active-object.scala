// Generated by Mochi v0.10.40 on 2025-07-25 12:56:10 GMT+7
...
object Main {
  def sinApprox(x: Double): Double = {
    ...
    var n: Int = 1
    while (n <= 12) {
      val denom: Double = ((2 * n).asInstanceOf[Int] * (2 * n + 1).asInstanceOf[Int]).toString.toDouble
  ...
  def main(args: Array[String]): Unit = {
    while (i <= 200) {
      ...
      val k2: Double = sinApprox((t2 * PI).asInstanceOf[Double])
      s = s + (k1 + k2) * 0.5 * (t2 - t1)
      t1 = t2
      k1 = k2

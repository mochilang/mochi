// Generated by Mochi v0.10.50 on 2025-07-31 01:08:09 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    def extract(f: Fps, n: BigInt): Double = {
      ...
      return f.coeffs((n).toInt)
    }
    def one(): Fps = {
      return newFps((((i: BigInt) => {if (i == BigInt(0)) {
        return 1.0.asInstanceOf[Fps]
      }; return 0.0.asInstanceOf[Fps] })).asInstanceOf[(BigInt) => Double])
    }
    ...
    def integrate(a: Fps): Fps = {
      return newFps((((n: BigInt) => {if (n == BigInt(0)) {
        return 0.0.asInstanceOf[Fps]
      }; return (extract(a, n - BigInt(1)) / n.toString.toDouble).asInstanceOf[Fps] })).asInstanceOf[(BigInt) => Double])
    }
    def sinCos(): Pair = {
      var sin: Fps = newFps(((n: BigInt) => 0.0))
      var cos: Fps = sub(one(), integrate(sin))
      sin.compute = ((n: BigInt) => {if (n == BigInt(0)) {
        return 0.0.asInstanceOf[Pair]
      }; return (extract(cos, n - BigInt(1)) / n.toString.toDouble).asInstanceOf[Pair] })
      return Pair(sin, cos)
    }

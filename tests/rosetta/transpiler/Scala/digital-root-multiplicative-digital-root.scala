// Generated by Mochi v0.10.52 on 2025-08-01 19:06:25 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    def mult(n: BigInt, base: BigInt): BigInt = {
      ...
      var x: BigInt = n
      val b: BigInt = BigInt(base.toInt)
      while (x > BigInt(0)) {
        m = m * (x % b)
        x = x / b
      }
    ...
    def multDigitalRoot(n: BigInt, base: BigInt): MDRResult = {
      ...
      return MDRResult(mp, BigInt(m.toInt))
    }
    def main(): Any = {
      ...
      while (i < (nums).size) {
        ...
        println(pad(String.valueOf(n), BigInt(20)) + " " + pad(String.valueOf(r.mdr), BigInt(3)) + " " + pad(String.valueOf(r.mp), BigInt(3)))
        i = i + BigInt(1)
      }
      println("")
      ...
      while (cnt > BigInt(0)) {
        ...
        if ((list((mdr).toInt)).size < size) {
          list((mdr).toInt) = list((mdr).toInt) :+ BigInt(n.toInt)
          cnt = cnt - BigInt(1)
        }
        n = n + BigInt(1)
      }
      ...
      while (j < base) {
        println(pad(String.valueOf(j), BigInt(3)) + ": " + String.valueOf(list((j).toInt)))
        j = j + BigInt(1)
      }
    }
    main()

// Generated by Mochi v0.10.50 on 2025-07-31 01:07:59 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    def floyd(n: BigInt): Any = {
      ...
      while (row <= n) {
        ...
        if (i < lastInRow) {
          line = line + pad(String.valueOf(i), w.asInstanceOf[BigInt]) + " "
          lastInColumn = lastInColumn + BigInt(1)
        } else {
          line = (line + pad(String.valueOf(i), w.asInstanceOf[BigInt])).toString
          println(line)
          line = ""
          row = row + BigInt(1)

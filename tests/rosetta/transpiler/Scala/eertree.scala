// Generated by Mochi v0.10.52 on 2025-08-02 00:10:39 GMT+7
  ...
  _br0.breakable {
    while (i < (s).size) {
      _ct0.breakable {
        ...
        _br1.breakable {
          while (true) {
            k = BigInt((tree((n).toInt).asInstanceOf[scala.collection.mutable.Map[String,Any]]("length")).toString)
            val b: BigInt = i - k - BigInt(1)
            if ((b >= BigInt(0) && s.slice((b).toInt, (b + BigInt(1)).toInt) == c).asInstanceOf[Boolean]) {
              _br1.break()
            }
            n = BigInt((tree((n).toInt).asInstanceOf[scala.collection.mutable.Map[String,Any]]("suffix")).toString)
          }
        }
        var edges: scala.collection.mutable.Map[String,BigInt] = (tree((n).toInt).asInstanceOf[scala.collection.mutable.Map[String,Any]]("edges")).asInstanceOf[scala.collection.mutable.Map[String,BigInt]]
        ...
        if (BigInt((tree((suffix).toInt).asInstanceOf[scala.collection.mutable.Map[String,Any]]("length")).toString) == BigInt(1)) {
        ...
        _br2.breakable {
          while (true) {
            n = BigInt((tree((n).toInt).asInstanceOf[scala.collection.mutable.Map[String,Any]]("suffix")).toString)
            val b: BigInt = i - BigInt((tree((n).toInt).asInstanceOf[scala.collection.mutable.Map[String,Any]]("length")).toString) - BigInt(1)
            if ((b >= BigInt(0) && s.slice((b).toInt, (b + BigInt(1)).toInt) == c).asInstanceOf[Boolean]) {
              _br2.break()
            }
          }
        }
        var en: scala.collection.mutable.Map[String,BigInt] = (tree((n).toInt).asInstanceOf[scala.collection.mutable.Map[String,Any]]("edges")).asInstanceOf[scala.collection.mutable.Map[String,BigInt]]
        tree((suffix).toInt).update("suffix", en(c))
        i = i + BigInt(1)
      }
    }
  }
...
def child(tree: ArrayBuffer[scala.collection.mutable.Map[String,Any]], idx: BigInt, p: String, _acc: ArrayBuffer[String]): ArrayBuffer[String] = {
  ...
  var edges: scala.collection.mutable.Map[String,BigInt] = (tree((idx).toInt).asInstanceOf[scala.collection.mutable.Map[String,Any]]("edges")).asInstanceOf[scala.collection.mutable.Map[String,BigInt]]
  for (ch <- edges.keys) {
    val nxt: BigInt = edges(ch)
...
def subPalindromes(tree: ArrayBuffer[scala.collection.mutable.Map[String,Any]]): ArrayBuffer[String] = {
  ...
  var oEdges: scala.collection.mutable.Map[String,BigInt] = (tree((ODD_ROOT).toInt).asInstanceOf[scala.collection.mutable.Map[String,Any]]("edges")).asInstanceOf[scala.collection.mutable.Map[String,BigInt]]
  for (ch <- oEdges.keys) {
    res = res :+ ch

// Generated by Mochi v0.10.55 on 2025-08-02 17:54:28 GMT+7
...
def timeStr(_sec: BigInt): String = {
  var sec: BigInt = _sec
  var wks: BigInt = sec / BigInt(604800)
  sec = sec % BigInt(604800)
  var ds: BigInt = sec / BigInt(86400)
  sec = sec % BigInt(86400)
  var hrs: BigInt = sec / BigInt(3600)
  sec = sec % BigInt(3600)
  var mins: BigInt = sec / BigInt(60)
  sec = sec % BigInt(60)
  var res: String = ""

// Generated by Mochi v0.10.42 on 2025-07-27 22:05:41 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    def add(r: Rsdv, x: Double): Rsdv = {
      ...
      val a1 = r.a + (x - r.a) / n1
      val q1: Double = r.q + (x - r.a).toString.toDouble * (x - a1).toString.toDouble
      return Rsdv(n1, a1, q1)
    }
    def sd(r: Rsdv): Double = {
      return sqrtApprox((r.q / r.n).toString.toDouble)
    }
    def main(): Any = {
      var r: Rsdv = newRsdv()

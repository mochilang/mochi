// Generated by Mochi v0.10.40 on 2025-07-26 09:47:54 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    def cartN(lists: Any): ArrayBuffer[ArrayBuffer[BigInt]] = {
      ...
      val rest: ArrayBuffer[ArrayBuffer[BigInt]] = cartN(a.slice((BigInt(1)).toInt, ((a).size).toInt))
      for (x <- a((BigInt(0)).toInt)) {
        for (p <- rest) {
          out = out :+ concat((ArrayBuffer(x)).asInstanceOf[ArrayBuffer[BigInt]], p.asInstanceOf[ArrayBuffer[BigInt]])
        }
      }
      return out
    }

// Generated by Mochi v0.10.50 on 2025-07-30 21:21:10 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    def zeller(y: BigInt, m: BigInt, d: BigInt): BigInt = {
      ...
      val K = yy % BigInt(100)
      val J = yy / BigInt(100)
      val h: Double = ((d + BigInt(13) * (mm + BigInt(1)) / BigInt(5) + K).toString.toDouble + (K / BigInt(4)).toString.toDouble + J / BigInt(4) + BigInt(5) * J) % BigInt(7).toString.toDouble
      return ((h + BigInt(6).toString.toDouble) % BigInt(7).toString.toDouble).asInstanceOf[BigInt]
    }
    ...
    def monthName(m: BigInt): String = {
      ...
      return names((m).toInt)
    }
    def main(): Any = {
      val year = BigInt(Option(scala.io.StdIn.readLine()).getOrElse("q").toInt)

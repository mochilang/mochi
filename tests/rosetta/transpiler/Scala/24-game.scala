// Generated by Mochi v0.10.39 on 2025-07-25 09:34:57 GMT+7
  ...
  _br2.breakable {
    while (i < (expr).size) {
      ...
      if (ch >= "0" && ch <= "9") {
        ...
        var j: Int = 0
        while (digits(j) != (ch.toString().toInt).asInstanceOf[Double] - ("0".toString().toInt).asInstanceOf[Double]) {
          j = j + 1
          if (j == (digits).size) {
        ...
        stack = stack :+ ((ch.toString().toInt).asInstanceOf[Double] - ("0".toString().toInt).asInstanceOf[Double]).asInstanceOf[Double]
      } else {
        if ((stack).size < 2) {
        ...
        if (ch == "+") {
          ...
          if (ch == "-") {
            stack((stack).size - 2) = a.asInstanceOf[Double] - b.asInstanceOf[Double]
          } else {
            if (ch == "*") {
              stack((stack).size - 2) = a.asInstanceOf[Double] * b.asInstanceOf[Double]
            } else {

// Generated by Mochi v0.10.39 on 2025-07-25 00:23:23 GMT+7
...
object Main {
          ...
          if ((n == 3 && last == k).asInstanceOf[Boolean]) {
            ...
            if ((n >= 4 && last == k).asInstanceOf[Boolean]) {
              ...
              if (last == seq(n - 2)) {
                ...
                if (contains((seq.slice(1, maxOf(1, (n - 2).asInstanceOf[Int]))).asInstanceOf[ArrayBuffer[Int]], last)) {
  ...
  def main() = {
    ...
    while (k <= 10) {
      ...
      println(padLeft(k, 2) + ": " + padRight((res("aliquot")).toString, 15) + " " + joinWithCommas((res("seq")).asInstanceOf[ArrayBuffer[Int]]))
    ...
    while (i < (s).size) {
      ...
      println(padLeft(`val`, 7) + ": " + padRight((res("aliquot")).toString, 15) + " " + joinWithCommas((res("seq")).asInstanceOf[ArrayBuffer[Int]]))
      i = (i + 1).asInstanceOf[Int]
    }
    println("")
    val big: Long = 15355717786080L
    val r: Map[String,Any] = classifySequence(big.asInstanceOf[Int])
    println(String.valueOf(big) + ": " + padRight((r("aliquot")).toString, 15) + " " + joinWithCommas((r("seq")).asInstanceOf[ArrayBuffer[Int]]))
  }

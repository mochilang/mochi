// Generated by Mochi v0.10.40 on 2025-07-26 09:32:47 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    def bezier2(b: Map[String,Any], x1: Int, y1: Int, x2: Int, y2: Int, x3: Int, y3: Int, p: Pixel): Any = {
      ...
      while (i <= b2Seg) {
        ...
        var c2 = c * c
        px(i) = Math.round((a2 * fx1).toString.toDouble + (b2 * fx2).toString.toDouble + c2 * fx3).toInt
        py(i) = Math.round((a2 * fy1).toString.toDouble + (b2 * fy2).toString.toDouble + c2 * fy3).toInt
        i = (i + 1).asInstanceOf[Int]
      }
      var x0: Int = px(0)
      var y0: Int = py(0)

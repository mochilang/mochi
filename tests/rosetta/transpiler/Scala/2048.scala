// Generated by Mochi v0.10.37 on 2025-07-23 12:02:56 GMT+7
...
def draw(b: ArrayBuffer[ArrayBuffer[Int]], score: Int) = {
  ...
  while (y < SIZE) {
    ...
    var x: Int = 0
    while (x < SIZE) {
      var v: Int = b(y)(x).asInstanceOf[Int]
      if (v == 0) {
...
def slideLeft(row: ArrayBuffer[Int]): Map[String,Any] = {
  ...
  var i: Int = 0
  while (i < (row).size) {
    if (row(i).asInstanceOf[Int] != 0) {
      xs = xs :+ row(i).asInstanceOf[Int]
    }
    i = (i + 1).asInstanceOf[Int]
  }
  ...
  i = 0
  while (i < (xs).size) {
    if ((i + 1 < (xs).size && xs(i).asInstanceOf[Int] == xs(i + 1).asInstanceOf[Int]).asInstanceOf[Boolean]) {
      val v: Int = xs(i).asInstanceOf[Int] * 2
      gain = (gain + v).asInstanceOf[Int]
      res = res :+ v
      i = (i + 2).asInstanceOf[Int]
    } else {
      res = res :+ xs(i).asInstanceOf[Int]
      i = (i + 1).asInstanceOf[Int]
    }
  }
  while ((res).size < SIZE) {
...
def moveLeft(b: ArrayBuffer[ArrayBuffer[Int]], _score: Int): Map[String,Any] = {
  ...
  while (y < SIZE) {
    ...
    var x: Int = 0
    while (x < SIZE) {
      if (b(y)(x).asInstanceOf[Int] != `new`.asInstanceOf[ArrayBuffer[Any]](x)) {
        moved = true
      }
      b(y)(x) = (`new`.asInstanceOf[ArrayBuffer[Any]](x)).asInstanceOf[Int]
      x = (x + 1).asInstanceOf[Int]
    }
    y = (y + 1).asInstanceOf[Int]
  }
...
def moveRight(b: ArrayBuffer[ArrayBuffer[Int]], _score: Int): Map[String,Any] = {
  ...
  while (y < SIZE) {
    ...
    var x: Int = 0
    while (x < SIZE) {
      if (b(y)(x).asInstanceOf[Int] != rev(x).asInstanceOf[Int]) {
        moved = true
      }
      b(y)(x) = rev(x).asInstanceOf[Int]
      x = (x + 1).asInstanceOf[Int]
    }
    y = (y + 1).asInstanceOf[Int]
  }
...
def getCol(b: ArrayBuffer[ArrayBuffer[Int]], x: Int): ArrayBuffer[Int] = {
  ...
  var y: Int = 0
  while (y < SIZE) {
    col = col :+ b(y)(x).asInstanceOf[Int]
    y = (y + 1).asInstanceOf[Int]
  }
  return col
}
...
def moveUp(b: ArrayBuffer[ArrayBuffer[Int]], _score: Int): Map[String,Any] = {
  ...
  while (x < SIZE) {
    ...
    var y: Int = 0
    while (y < SIZE) {
      if (b(y)(x).asInstanceOf[Int] != `new`.asInstanceOf[ArrayBuffer[Any]](y)) {
        moved = true
      }
      b(y)(x) = (`new`.asInstanceOf[ArrayBuffer[Any]](y)).asInstanceOf[Int]
      y = (y + 1).asInstanceOf[Int]
    }
    x = (x + 1).asInstanceOf[Int]
  }
...
def moveDown(b: ArrayBuffer[ArrayBuffer[Int]], _score: Int): Map[String,Any] = {
  ...
  while (x < SIZE) {
    ...
    var y: Int = 0
    while (y < SIZE) {
      if (b(y)(x).asInstanceOf[Int] != col(y).asInstanceOf[Int]) {
        moved = true
      }
      b(y)(x) = col(y).asInstanceOf[Int]
      y = (y + 1).asInstanceOf[Int]
...
def hasMoves(b: ArrayBuffer[ArrayBuffer[Int]]): Boolean = {
  ...
  while (y < SIZE) {
    ...
    while (x < SIZE) {
      ...
      if ((x + 1 < SIZE && b(y)(x).asInstanceOf[Int] == b(y)(x + 1).asInstanceOf[Int]).asInstanceOf[Boolean]) {
        return true
      }
      if ((y + 1 < SIZE && b(y)(x).asInstanceOf[Int] == b(y + 1)(x).asInstanceOf[Int]).asInstanceOf[Boolean]) {
        return true
      }
      x = (x + 1).asInstanceOf[Int]
    }
...
def has2048(b: ArrayBuffer[ArrayBuffer[Int]]): Boolean = {
  ...
  while (y < SIZE) {
    var x: Int = 0
    while (x < SIZE) {
      if (b(y)(x).asInstanceOf[Int] >= 2048) {
        return true
      }
      x = (x + 1).asInstanceOf[Int]
    }
  ...
  breakable {
    while (true) {
      ...
      if (moved) {
        ...
        full = r2("full")
        if ((full.asInstanceOf[Boolean] && (!(hasMoves(board)).asInstanceOf[Boolean]).asInstanceOf[Boolean]).asInstanceOf[Boolean]) {
          draw(board, score)
          println("Game Over")
          break
        }

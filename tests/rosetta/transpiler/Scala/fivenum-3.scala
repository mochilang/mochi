// Generated by Mochi v0.10.50 on 2025-07-31 01:03:37 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    def fivenum(a: ArrayBuffer[Double]): ArrayBuffer[Double] = {
      ...
      val n: Int = (arr).size
      val half: BigInt = n + BigInt(3) - (n + BigInt(3)) % BigInt(2)
      val n4: Double = (half / BigInt(2)).toString.toDouble / 2.0
      ...
      while (idx < (d).size) {
        ...
        val fl: BigInt = BigInt((de - 1.0).toInt)

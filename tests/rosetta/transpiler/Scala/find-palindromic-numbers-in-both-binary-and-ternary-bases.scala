// Generated by Mochi v0.10.50 on 2025-07-30 21:20:53 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    def toBase(n: BigInt, b: BigInt): String = {
      ...
      var x: BigInt = n
      while (x > BigInt(0)) {
        s = (String.valueOf(x % b) + s).toString
      ...
      def parseIntStr(str: String): BigInt = {
        ...
        if (((str).size > BigInt(0) && str.slice((BigInt(0)).toInt, (BigInt(0)).toInt + 1) == "-").asInstanceOf[Boolean]) {
          neg = true
          i = BigInt(1)
        }
        var n: BigInt = BigInt(0)
        while (i < (str).size) {
          n = (n * BigInt(10) + (str.slice((i).toInt, (i + BigInt(1)).toInt)).asInstanceOf[BigInt] - ("0").asInstanceOf[BigInt]).asInstanceOf[BigInt]
    ...
    def parseIntBase(s: String, b: BigInt): BigInt = {
      ...
      var i: BigInt = BigInt(0)
      while (i < (s).size) {
        n = (n * b).toString.toDouble + (_parseIntStr(s.slice((i).toInt, (i + BigInt(1)).toInt), BigInt(10))).toString.toDouble
        i = (i + BigInt(1)).asInstanceOf[BigInt]
      }
      return n
    }
    ...
    def reverse3(n: BigInt): BigInt = {
      ...
      var y: BigInt = n
      while (y != BigInt(0)) {
        x = (x * BigInt(3)).toString.toDouble + (y % BigInt(3)).toString.toDouble
        y = y / BigInt(3)
      }
      return x
    }
    ...
    def main(): Any = {
      ...
      _br5.breakable {
        while (true) {
          var i: BigInt = lo
          while (i < hi) {
            var n = (i * BigInt(3) + BigInt(1)) * pow3 + reverse3(i)
          ...
          if (i == pow3) {
            pow3 = (pow3 * BigInt(3)).asInstanceOf[BigInt]
          } else {
            pow2 = (pow2 * BigInt(4)).asInstanceOf[BigInt]
          }
          val _br7 = new Breaks
          _br7.breakable {
            while (true) {

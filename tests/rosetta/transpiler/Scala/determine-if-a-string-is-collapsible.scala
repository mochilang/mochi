// Generated by Mochi v0.10.52 on 2025-08-01 19:21:06 GMT+7
...
def collapse(s: String): ArrayBuffer[Any] = {
  ...
  return ArrayBuffer(res, orig, (res).size)
}
...
def main(): Any = {
  ...
  while (idx < (strings).size) {
    val s: String = strings((idx).toInt)
    val r: ArrayBuffer[Any] = collapse(s)
    val cs = r((BigInt(0)).toInt)
    val olen = r((BigInt(1)).toInt)
    val clen = r((BigInt(2)).toInt)

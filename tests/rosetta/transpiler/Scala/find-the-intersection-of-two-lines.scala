// Generated by Mochi v0.10.50 on 2025-07-30 21:21:04 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    def createLine(a: Point, b: Point): Line = {
      val slope: Double = (b.y - a.y).toString.toDouble / (b.x - a.x).toString.toDouble
      val yint = a.y - slope * a.x
      return Line(slope, yint)
    }
    def evalX(l: Line, x: Double): Double = {
      return (l.slope * x + l.yint).toString.toDouble
    }
    def intersection(l1: Line, l2: Line): Point = {
      if (l1.slope == l2.slope) {
        return Point(0.0, 0.0)
      }
      val x: Double = (l2.yint - l1.yint).toString.toDouble / (l1.slope - l2.slope).toString.toDouble

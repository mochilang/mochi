// Generated by Mochi v0.10.39 on 2025-07-25 00:17:10 GMT+7
...
object Main {
  ...
  def rstripEmpty(words: ArrayBuffer[String]): ArrayBuffer[String] = {
    ...
    return (words.slice(0, n)).asInstanceOf[ArrayBuffer[String]]
  }
  ...
  def printFmt(f: Map[String,Any], align: Int) = {
    val lines: ArrayBuffer[ArrayBuffer[String]] = (f("text")).asInstanceOf[ArrayBuffer[ArrayBuffer[String]]]
    val width: ArrayBuffer[Int] = (f("width")).asInstanceOf[ArrayBuffer[Int]]
    var i: Int = 0
    while (i < (lines).size) {

// Generated by Mochi v0.10.50 on 2025-07-31 01:08:04 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    def chance(prob: Double): Boolean = {
      val threshold: BigInt = BigInt((prob * 1000.0).toInt)
    ...
    def step(src: ArrayBuffer[ArrayBuffer[String]]): ArrayBuffer[ArrayBuffer[String]] = {
      ...
      while (r < rows) {
        ...
        var c: BigInt = BigInt(0)
        while (c < cols) {
          var cell: String = src((r).toInt)((c).toInt)
    ...
    def printBoard(b: ArrayBuffer[ArrayBuffer[String]]): Any = {
      ...
      while (r < rows) {
        ...
        var c: BigInt = BigInt(0)
        while (c < cols) {
          val cell: String = b((r).toInt)((c).toInt)
          if (cell == " ") {
            line = line + "  "
          } else {
            line = line + " " + cell

// Generated by Mochi v0.10.42 on 2025-07-28 10:36:40 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    def throwDie(nSides: BigInt, nDice: BigInt, s: BigInt, counts: ArrayBuffer[BigInt]): Any = {
      ...
      while (i <= nSides) {
        throwDie(nSides, (nDice - BigInt(1)).asInstanceOf[BigInt], (s + i).asInstanceOf[BigInt], counts)
        i = (i + BigInt(1)).asInstanceOf[BigInt]
      }
      return
    }
    def beatingProbability(nSides1: BigInt, nDice1: BigInt, nSides2: BigInt, nDice2: BigInt): Double = {
      val len1 = (nSides1 + BigInt(1)) * nDice1
      ...
      val len2 = (nSides2 + BigInt(1)) * nDice2

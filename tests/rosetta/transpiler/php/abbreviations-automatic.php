...
function takeRunes($s, $n) {
  global $fields, $distinct, $abbrevLen, $pad2, $main;
  $idx = 0;
  $count = 0;
  while ($idx < strlen($s)) {
  if ($count == $n) {
...
function distinct($xs) {
  global $fields, $takeRunes, $abbrevLen, $pad2, $main;
  $m = [];
  $out = [];
  $i = 0;
  while ($i < count($xs)) {
...
function abbrevLen($words) {
  global $fields, $takeRunes, $distinct, $pad2, $main;
  $size = count($words);
  $l = 1;
  while (true) {
  $abbrs = [];
...
function pad2($n) {
  global $fields, $takeRunes, $distinct, $abbrevLen, $main;
...
function main() {
  global $fields, $takeRunes, $distinct, $abbrevLen, $pad2;

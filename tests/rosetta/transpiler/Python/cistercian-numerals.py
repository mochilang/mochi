...
def initDraw():
    ...
    draw[5] = lambda : [draw.get(1)(), draw.get(4)()]
    draw[6] = lambda : verti(0, 4, 10)
    draw[7] = lambda : [draw.get(1)(), draw.get(6)()]
    draw[8] = lambda : [draw.get(2)(), draw.get(6)()]
    draw[9] = lambda : [draw.get(1)(), draw.get(8)()]
    draw[10] = lambda : horiz(0, 4, 0)
    draw[20] = lambda : horiz(0, 4, 4)
    draw[30] = lambda : diagu(0, 4, 4)
    draw[40] = lambda : diagd(0, 4, 0)
    draw[50] = lambda : [draw.get(10)(), draw.get(40)()]
    draw[60] = lambda : verti(0, 4, 0)
    draw[70] = lambda : [draw.get(10)(), draw.get(60)()]
    draw[80] = lambda : [draw.get(20)(), draw.get(60)()]
    draw[90] = lambda : [draw.get(10)(), draw.get(80)()]
    draw[100] = lambda : horiz(6, 10, 14)
    draw[200] = lambda : horiz(6, 10, 10)
    draw[300] = lambda : diagu(6, 10, 14)
    draw[400] = lambda : diagd(6, 10, 10)
    draw[500] = lambda : [draw.get(100)(), draw.get(400)()]
    draw[600] = lambda : verti(10, 14, 10)
    draw[700] = lambda : [draw.get(100)(), draw.get(600)()]
    draw[800] = lambda : [draw.get(200)(), draw.get(600)()]
    draw[900] = lambda : [draw.get(100)(), draw.get(800)()]
    draw[1000] = lambda : horiz(0, 4, 14)
    draw[2000] = lambda : horiz(0, 4, 10)
    draw[3000] = lambda : diagd(0, 4, 10)
    draw[4000] = lambda : diagu(0, 4, 14)
    draw[5000] = lambda : [draw.get(1000)(), draw.get(4000)()]
    draw[6000] = lambda : verti(10, 14, 0)
    draw[7000] = lambda : [draw.get(1000)(), draw.get(6000)()]
    draw[8000] = lambda : [draw.get(2000)(), draw.get(6000)()]
    draw[9000] = lambda : [draw.get(1000)(), draw.get(8000)()]
def printNumeral():
    i = 0
    while i < 15:
        line = ""

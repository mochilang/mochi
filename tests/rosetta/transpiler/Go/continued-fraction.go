...
// Generated by Mochi v0.10.41 on 2025-07-27 01:04:07 GMT+7
package main
...
func mochiMain() {
	fmt.Println(("sqrt2: " + fmt.Sprint(real(cfSqrt2(20)))))
	fmt.Println(("nap:   " + fmt.Sprint(real(cfNap(20)))))
	fmt.Println(("pi:    " + fmt.Sprint(real(cfPi(20)))))
}

...
String strReplace(String s, String old, String _new) {
  String res = "";
  int i = 0;
  while (i < s.length) {
    if (old.length > 0 && i + old.length <= s.length && _substr(s, i, i + old.length) == old) {
    res = res + _new;
    i = i + old.length;
  } else {

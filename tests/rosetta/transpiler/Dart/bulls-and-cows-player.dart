...
void main() {
  ...
  while (true) {
    ...
    if (toks.length == 2) {
    var c = int.parse(toks[0]);
    var b = int.parse(toks[1]);
    if (c.toString().compareTo(0.toString()) >= 0 && c.toString().compareTo(4.toString()) <= 0 && b.toString().compareTo(0.toString()) >= 0 && b.toString().compareTo(4.toString()) <= 0 && c + b <= 4) {
    cows = c;
    bulls = b;
    break;
  };

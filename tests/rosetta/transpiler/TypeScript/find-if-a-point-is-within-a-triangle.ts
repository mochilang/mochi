// Generated by Mochi v0.10.42 on 2025-07-28 07:51:47 GMT+7
...
function main() {
  ...
  console.log(_str(("Triangle is " + _str(tri1))));
  for (const pt of [[0.0, 0.0], [0.0, 1.0], [3.0, 1.0]]) {
    ...
    console.log(_str(((("Point " + _str(pt)) + " is within triangle? ") + _str(ok))));
  }
  console.log(_str(""));
  let tri2: number[][] = [[(1.0 / 10), (1.0 / 9)], [(100.0 / 8), (100.0 / 3)], [(100.0 / 4), (100.0 / 9)]];
  console.log(_str(("Triangle is " + _str(tri2))));

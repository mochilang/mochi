// Generated by Mochi v0.10.40 on 2025-07-25 12:35:08 GMT+7
...
}
{
  ...
  function numberName(n: number): string {
    const small: string[] = ["no", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen"];
    const tens: string[] = ["ones", "ten", "twenty", "thirty", "forty", "fifty", "sixty", "seventy", "eighty", "ninety"];
    if ((n < 0)) {
      return "";
    }
    if ((n < 20)) {
  ...
  function slur(p: string, d: number): string {
    ...
    while ((idx >= 1)) {
      ...
      if (((seed % 100) >= d)) {
        const j: number = (seed % (idx + 1));
        const tmp: string = a[idx];
        a[idx] = a[j];
        a[j] = tmp;
      }
      idx = (idx - 1);

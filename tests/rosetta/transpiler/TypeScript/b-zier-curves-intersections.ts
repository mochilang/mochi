// Generated by Mochi v0.10.38 on 2025-07-23 16:23:08 GMT+7
...
function subdivideQuadSpline(q: QuadSpline, t: number): QuadSpline[] {
  ...
  u = ({ ...u, "c1": ((s * q.c0) + (t * q.c1)) });
  v = ({ ...v, "c1": ((s * q.c1) + (t * q.c2)) });
  u = ({ ...u, "c2": ((s * u.c1) + (t * v.c1)) });
  v = ({ ...v, "c0": u.c2 });
  return [u, v];
}
function subdivideQuadCurve(q: QuadCurve, t: number): QuadCurve[] {
  ...
  let u: QuadCurve = {"x": xs[0], "y": ys[0]};
  let v: QuadCurve = {"x": xs[1], "y": ys[1]};
  return [u, v];
}
...
function testIntersect(p: QuadCurve, q: QuadCurve, tol: number): Record<string, any> {
  ...
  if (rectsOverlap(pxmin, pymin, pxmax, pymax, qxmin, qymin, qxmax, qymax)) {
    ...
    if (((xmax - xmin) <= tol)) {
      ...
      if (((ymax - ymin) <= tol)) {
        accept = true;
        inter = ({ ...inter, "x": (0.5 * (xmin + xmax)) });
        inter = ({ ...inter, "y": (0.5 * (ymin + ymax)) });
      }
    }
  }

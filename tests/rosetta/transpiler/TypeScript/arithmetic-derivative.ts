// Generated by Mochi v0.10.40 on 2025-07-25 17:22:35 GMT+7
...
}
{
  ...
  function D(n: number): number {
    ...
    if ((n < 10000000000000000000.0)) {
      ...
      const g: number = Math.trunc((n / 100.0));
    ...
    const d: number = Math.trunc(n / factors[Math.trunc(0)]);

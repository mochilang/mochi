// Generated by Mochi v0.10.42 on 2025-07-27 21:20:51 GMT+7
...
function main() {
  ...
  let cprimes: number[] = [1, 141, 4713, 5795, 6611];
  console.log("\nFirst 5 Cullen primes (in terms of n):");
  console.log(show_list(cprimes));
  let wprimes: number[] = [2, 3, 6, 30, 75, 81, 115, 123, 249, 362, 384, 462];

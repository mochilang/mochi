// Generated by Mochi v0.10.42 on 2025-07-27 20:12:04 GMT+7

function indexOfStr(h: string, n: string): number {
  let hlen: number = (Array.isArray(h) || typeof h === 'string' ? h.length : Object.keys(h ?? {}).length);
  let nlen: number = (Array.isArray(n) || typeof n === 'string' ? n.length : Object.keys(n ?? {}).length);
  if ((nlen == 0)) {
    return 0;
  }
  let i: number = 0;

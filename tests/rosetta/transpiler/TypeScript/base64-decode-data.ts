// Generated by Mochi v0.10.42 on 2025-07-27 20:11:24 GMT+7
...
function base64Encode(text: string): string {
  ...
  let pad: number = ((3 - ((Array.isArray(text) || typeof text === 'string' ? text.length : Object.keys(text ?? {}).length) % 3)) % 3);
  if ((pad == 1)) {

// Generated by Mochi v0.10.40 on 2025-07-25 17:41:10 GMT+7
...
function Insert(tree, data: number) {
  const r: Record<string, any> = insertR(tree, data);
  return r.node;
}
...
function Remove(tree, data: number) {
  const r: Record<string, any> = removeR(tree, data);
  return r.node;
}
...
function dumpNode(node, indent: number, comma: boolean) {
  const sp: string = indentStr(indent);
  if ((node == null)) {

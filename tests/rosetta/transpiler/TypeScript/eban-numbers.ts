// Generated by Mochi v0.10.41 on 2025-07-26 20:32:19 GMT+7
...
function main() {
  ...
  for (const rg of ranges) {
    ...
    if ((start == 2)) {
      console.log((("eban numbers up to and including " + String(stop)) + ":"));
    } else {
      console.log((((("eban numbers between " + String(start)) + " and ") + String(stop)) + " (inclusive):"));
    }
    if (show) {

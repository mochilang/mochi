// Generated by Mochi v0.10.41 on 2025-07-26 20:31:07 GMT+7
...
function printTable(nums: number[], perRow: number, width: number) {
  ...
  while ((i < (Array.isArray(nums) || typeof nums === 'string' ? nums.length : Object.keys(nums ?? {}).length))) {
    ...
    if ((((i + 1) % perRow) == 0)) {
      console.log((line).substring(1, (Array.isArray(line) || typeof line === 'string' ? line.length : Object.keys(line ?? {}).length)));
      line = "";
    }
    i = (i + 1);
  }
...
function main() {
  ...
  console.log("First 50 Duffinian numbers:");
  ...
  while (((Array.isArray(triplets) || typeof triplets === 'string' ? triplets.length : Object.keys(triplets ?? {}).length) < 20)) {
    if (((isDuffinian(n) && isDuffinian((n + 1))) && isDuffinian((n + 2)))) {
      triplets.push((((((("(" + String(n)) + ",") + String((n + 1))) + ",") + String((n + 2))) + ")"));
      n = (n + 3);
    }
    n = (n + 1);
  }

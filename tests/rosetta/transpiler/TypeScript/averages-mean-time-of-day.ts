// Generated by Mochi v0.10.38 on 2025-07-23 16:18:55 GMT+7
...
function meanTime(times: string[]): string {
  ...
  const si: number = total;
  const h: number = Math.trunc(si / 3600);
  const m: number = ((si % 3600) / 60);
  const s: number = (si % 60);

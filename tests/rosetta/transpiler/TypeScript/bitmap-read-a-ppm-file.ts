// Generated by Mochi v0.10.42 on 2025-07-27 20:11:51 GMT+7
...
function writeP3(b: Bitmap): string {
  ...
  let digits: number = (Array.isArray(String(max)) || typeof String(max) === 'string' ? String(max).length : Object.keys(String(max) ?? {}).length);

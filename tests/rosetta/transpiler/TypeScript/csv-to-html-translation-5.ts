// Generated by Mochi v0.10.42 on 2025-07-27 21:19:00 GMT+7

function split(s: string, sep: string): string[] {
  let out: string[] = [];
  let start: number = 0;
  let i: number = 0;
  let n: number = (Array.isArray(sep) || typeof sep === 'string' ? sep.length : Object.keys(sep ?? {}).length);
  ...
  out.push((s).substring(start, (Array.isArray(s) || typeof s === 'string' ? s.length : Object.keys(s ?? {}).length)));
  return out;
}

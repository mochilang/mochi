// Generated by Mochi v0.10.40 on 2025-07-25 12:35:10 GMT+7
...
}
{
  ...
  function abbrevLen(words: string[]): number {
    const size: number = (Array.isArray(words) || typeof words === 'string' ? words.length : Object.keys(words ?? {}).length);
    let l: number = 1;
    while (true) {
      let abbrs: string[] = [];
      let i: number = 0;

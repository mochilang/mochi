// Generated by Mochi v0.10.37 on 2025-07-23 10:24:09 GMT+7
...
function abbrevLen(words: string[]): number {
  const size = (Array.isArray(words) || typeof words === 'string' ? words.length : Object.keys(words ?? {}).length);
  let l = 1;
  while (true) {
    let abbrs: string[] = [];
    let i = 0;

// Generated by Mochi v0.10.41 on 2025-07-26 21:24:53 GMT+7
...
let nodes: Point3[] = [{"x": -1.0, "y": -1.0, "z": -1.0}, {"x": -1.0, "y": -1.0, "z": 1.0}, {"x": -1.0, "y": 1.0, "z": -1.0}, {"x": -1.0, "y": 1.0, "z": 1.0}, {"x": 1.0, "y": -1.0, "z": -1.0}, {"x": 1.0, "y": -1.0, "z": 1.0}, {"x": 1.0, "y": 1.0, "z": -1.0}, {"x": 1.0, "y": 1.0, "z": 1.0}];
...
function main() {
  ...
  while ((f < 10)) {
    ...
    let e: number = 0;
    while ((e < (Array.isArray(edges) || typeof edges === 'string' ? edges.length : Object.keys(edges ?? {}).length))) {

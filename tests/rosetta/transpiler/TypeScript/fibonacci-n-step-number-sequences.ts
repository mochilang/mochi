// Generated by Mochi v0.10.41 on 2025-07-27 11:34:41 GMT+7
...
function main() {
  let n: number = 10;
  console.log((" Fibonacci: " + show(gen([1, 1], n))));
  console.log(("Tribonacci: " + show(gen([1, 1, 2], n))));
  console.log(("Tetranacci: " + show(gen([1, 1, 2, 4], n))));
  console.log(("     Lucas: " + show(gen([2, 1], n))));
}
var _nowSeed = 0;

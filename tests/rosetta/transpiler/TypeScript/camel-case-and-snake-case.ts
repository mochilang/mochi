// Generated by Mochi v0.10.38 on 2025-07-23 19:23:42 GMT+7
...
function camelToSnake(s: string): string {
  ...
  while ((j < (Array.isArray(out) || typeof out === 'string' ? out.length : Object.keys(out ?? {}).length))) {
    const c: string = out.slice(j, (j + 1));
    if ((c == "_")) {
      if (!lastUnd) {
        res = (res + c);
      }
...
function main() {
  const samples: string[] = ["snakeCase", "snake_case", "snake-case", "snake case", "snake CASE", "snake.case", "variable_10_case", "variable10Case", "ɛrgo rE tHis", "hurry-up-joe!", "c://my-docs/happy_Flag-Day/12.doc", " spaces "];

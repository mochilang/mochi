// Generated by Mochi transpiler v0.10.56 on 2025-08-04 10:49:46 GMT+7
#include <iostream>
#include <string>
#include <any>
#include <sstream>
...
std::any addrs = res[int64_t(0)];
std::any err = res[int64_t(1)];

int main() {
    if ((!err.has_value())) {
        std::cout << ([&]{ std::ostringstream ss; any_to_stream(ss, addrs);
 return ss.str(); }());
        std::cout << std::endl;
    } else {

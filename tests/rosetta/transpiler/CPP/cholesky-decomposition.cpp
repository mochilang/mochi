// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:08:43 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
void demo(const std::vector<std::vector<double>>& a);
int main();
...
std::vector<std::vector<double>> cholesky(const std::vector<std::vector<double>>& a) {
    ...
    while ((i < n)) {
        ...
        l = ([&]{ auto __tmp = l; __tmp.push_back(row); return __tmp; }());
        i = (i + int64_t(1));
    }
    i = int64_t(0);
    while ((i < n)) {
...
int main() {
    {
        ...
        demo(std::vector<std::vector<double>>{std::vector<double>{25.0, 15.0, -5.0}, std::vector<double>{15.0, 18.0, 0.0}, std::vector<double>{-5.0, 0.0, 11.0}});
        demo(std::vector<std::vector<double>>{std::vector<double>{18.0, 22.0, 54.0, 42.0}, std::vector<double>{22.0, 70.0, 86.0, 62.0}, std::vector<double>{54.0, 86.0, 174.0, 134.0}, std::vector<double>{42.0, 62.0, 134.0, 106.0}});
    }
    return 0;
}

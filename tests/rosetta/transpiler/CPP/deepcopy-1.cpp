// Generated by Mochi transpiler v0.10.47 on 2025-07-28 11:47:34 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <map>
...
std::string cdsStr(const cds& c) {
 ...
 return ss.str(); }())) + std::string(":")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << c.m.at(k); return ss.str(); }()));
        first = false;
    }
    ms = (ms + std::string("]"));

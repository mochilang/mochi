// Generated by Mochi transpiler v0.10.47 on 2025-07-28 11:47:32 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <vector>
...
std::string fmt1(double x);
void printColumnMatrix(const std::vector<double>& xs);
...
std::string fmt1(double x) {
    double y = ((double)((double)((int64_t)(((x * 10.0) + 0.5)))) / (10.0));
...
void printColumnMatrix(const std::vector<double>& xs) {
    ...
    std::cout << ((std::string("⎡") + fmt1(xs[int64_t(0)])) + std::string("⎤"));
    std::cout << std::endl;
    int64_t i = int64_t(1);
    while ((i < (xs.size() - int64_t(1)))) {
        std::cout << ((std::string("⎢") + fmt1(xs[i])) + std::string("⎥"));
        std::cout << std::endl;
        i = (i + int64_t(1));
    }
    std::cout << ((std::string("⎣ ") + fmt1(xs[(xs.size() - int64_t(1))])) + std::string("⎦"));
    std::cout << std::endl;
}
...
int main() {
    ...
    std::cout << std::string("deconv(g, f) =");
    std::cout << std::endl;
    printColumnMatrix(deconv(g, f));
    std::cout << std::string("");
    std::cout << std::endl;
    std::cout << std::string("deconv(g, h) =");
    std::cout << std::endl;

// Generated by Mochi transpiler v0.10.40 on 2025-07-25 21:23:08 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int main() {
    {
        ...
        std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << agm(1.0, ((double)(1.0) / (sqrtApprox(2.0)))); return ss.str(); }());
        std::cout << std::endl;

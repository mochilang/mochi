// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:07:46 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int64_t b = ord(std::string("a"));
int64_t r = ord(std::string("π"));
std::string s = std::string("aπ");
...
int main() {
    {
        ...
        std::cout << ((((([&]{ std::ostringstream ss; ss << std::boolalpha << b; return ss.str(); }()) + std::string(" ")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << r; return ss.str(); }())) + std::string(" ")) + s);
        std::cout << std::endl;
        std::cout << ((((std::string("string cast to []rune: [") + ([&]{ std::ostringstream ss; ss << std::boolalpha << b; return ss.str(); }())) + std::string(" ")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << r; return ss.str(); }())) + std::string("]"));
        std::cout << std::endl;
        std::cout << (((std::string("    string range loop: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << b; return ss.str(); }())) + std::string(" ")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << r; return ss.str(); }()));
        std::cout << std::endl;

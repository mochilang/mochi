// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:07:38 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int main() {
    {
        ...
        std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << ord(std::string("a")); return ss.str(); }());
        std::cout << std::endl;
        std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << ord(std::string("π")); return ss.str(); }());
        std::cout << std::endl;
    }
    return 0;
}

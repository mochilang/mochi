// Generated by Mochi transpiler v0.10.40 on 2025-07-26 09:27:28 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
int bsearch(const std::vector<int>& arr, int x);
int bsearchRec(const std::vector<int>& arr, int x, int low, int high);
int main();
...
int main() {
    std::vector<int> nums = std::vector<int>{-31, 0, 1, 2, 2, 4, 65, 83, 99, 782};
    int x = 2;

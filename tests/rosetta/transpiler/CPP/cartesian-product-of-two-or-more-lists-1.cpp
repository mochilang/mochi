// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:06:45 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
int main() {
    {
        ...
        std::cout << std::endl;
        std::cout << llStr(cart2(std::vector<int64_t>{int64_t(1), int64_t(2)}, std::vector<int64_t>{}));
        std::cout << std::endl;
        std::cout << llStr(cart2(std::vector<int64_t>{}, std::vector<int64_t>{int64_t(1), int64_t(2)}));
        std::cout << std::endl;
    }
    return 0;
}

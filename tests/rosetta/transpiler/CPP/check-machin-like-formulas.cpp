// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:08:02 GMT+7
#include <iostream>
#include <string>
...
std::string format(const std::vector<std::map<std::string, int64_t>>& ts) {
    ...
    while ((i < ts.size())) {
        ...
        s = (((((((s + std::string("{")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << t.at(std::string("a")); return ss.str(); }())) + std::string(" ")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << t.at(std::string("n")); return ss.str(); }())) + std::string(" ")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << t.at(std::string("d")); return ss.str(); }())) + std::string("}"));
...
BigRat tans(const std::vector<std::map<std::string, int64_t>>& m) {
    if ((m.size() == int64_t(1))) {
        ...
        return tanEval(t.at(std::string("a")), br(t.at(std::string("n")), t.at(std::string("d"))));
    }

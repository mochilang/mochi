// Generated by Mochi transpiler v0.10.40 on 2025-07-26 05:37:57 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int main() {
    while (true) {
        ...
        if ((ending == target)) {
            std::cout << (((std::string("The smallest number whose square ends with ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << target; return ss.str(); }())) + std::string(" is ")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << n; return ss.str(); }()));
            std::cout << std::endl;
            break;
        }
        n = (n + 1);

// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:07:13 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int64_t catalanRec(int64_t n) {
    ...
    int64_t t1 = (int64_t(2) * n);
    int64_t t2 = (t1 - int64_t(1));
    int64_t t3 = (int64_t(2) * t2);
    int64_t t5 = (t3 * catalanRec((n - int64_t(1))));
    return (int64_t)((t5 / (n + int64_t(1))));
}
...
int main() {
    {
        ...
        for (int i = int64_t(1); i < int64_t(16); i++ ) {
            std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << catalanRec((int64_t)(i)); return ss.str(); }());
            std::cout << std::endl;
        }
    }
    return 0;

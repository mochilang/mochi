// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:06:33 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <type_traits>
...
std::string toOct(int64_t n) {
    ...
    std::string digits = std::string("01234567");
    std::string out = std::string("");
    int64_t v = n;
    while ((v > int64_t(0))) {
        int64_t d = (v % int64_t(8));

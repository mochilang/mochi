// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:06:10 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
void Foo_ValueMethod(const Foo& self, int64_t x);
void Foo_PointerMethod(const Foo& self, int64_t x);
int main();
...
int main() {
    {
        ...
        Foo_ValueMethod(myValue, int64_t(0));
        Foo_PointerMethod(myPointer, int64_t(0));
        Foo_ValueMethod(myPointer, int64_t(0));
        Foo_PointerMethod(myValue, int64_t(0));
        Foo_ValueMethod(myValue, int64_t(0));
        Foo_PointerMethod(myPointer, int64_t(0));
    }
    return 0;

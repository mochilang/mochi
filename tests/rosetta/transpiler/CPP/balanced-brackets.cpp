// Generated by Mochi transpiler v0.10.42 on 2025-07-28 10:10:14 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <type_traits>
...
int64_t prng(int64_t max);
std::string gen(int64_t n);
void testBalanced(std::string s);
int main();

// Generated by Mochi transpiler v0.10.40 on 2025-07-26 09:26:52 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
std::string toBin(int n) {
    ...
    int x = n;
    while ((x > 0)) {
        bits = (([&]{ std::ostringstream ss; ss << std::boolalpha << (x % 2); return ss.str(); }()) + bits);
        x = (int)((x / 2));
    }
    return bits;
}

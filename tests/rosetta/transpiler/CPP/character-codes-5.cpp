// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:07:54 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int main() {
    {
        ...
        std::cout << chr(int64_t(97));
        std::cout << std::endl;
        std::cout << chr(int64_t(960));
        std::cout << std::endl;
        std::cout << (chr(int64_t(97)) + chr(int64_t(960)));
        std::cout << std::endl;
    }
    return 0;
}

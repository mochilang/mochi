// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:06:06 GMT+7
#include <iostream>
#include <string>
#include <any>
#include <vector>
...
std::vector<std::any> f();
int64_t g(int64_t a, double b);
void h(std::string s, const std::vector<int64_t>& nums);
int main();

std::vector<std::any> f() {
    return std::vector<std::any>{std::any(int64_t(0)), std::any(0.0)};
}
...
int main() {
    {
        ...
        std::vector<std::any> ab = f();
        std::any a = ab[int64_t(0)];
        std::any b = ab[int64_t(1)];
        std::any cb = f()[int64_t(1)];
        int64_t d = g(std::any_cast<int64_t>(a), std::any_cast<double>(cb));
        int64_t e = g(d, std::any_cast<double>(b));
        int64_t i = g(d, 2.0);
        std::vector<int64_t> list = {};
        list = ([&]{ auto __tmp = list; __tmp.push_back(std::any_cast<int64_t>(a)); return __tmp; }());
        list = ([&]{ auto __tmp = list; __tmp.push_back(d); return __tmp; }());
        list = ([&]{ auto __tmp = list; __tmp.push_back(e); return __tmp; }());
        list = ([&]{ auto __tmp = list; __tmp.push_back(i); return __tmp; }());
        i = list.size();
    }
    return 0;
}

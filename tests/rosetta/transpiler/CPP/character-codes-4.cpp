// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:07:50 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int64_t b = int64_t(97);
int64_t r = int64_t(960);
...
int main() {
    {
        ...
        std::cout << ((chr(int64_t(97)) + std::string(" ")) + chr(int64_t(960)));
        std::cout << std::endl;
        std::cout << ((chr(b) + std::string(" ")) + chr(r));
        std::cout << std::endl;
    }
    return 0;
}

// Generated by Mochi transpiler v0.10.41 on 2025-07-27 00:53:57 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
std::string strdup(std::string s);
int main();
...
int main() {
    {
        ...
        std::string go1 = std::string("hello C");
        std::string c2 = strdup(go1);
        std::cout << c2;
        std::cout << std::endl;

// Generated by Mochi transpiler v0.10.47 on 2025-07-28 11:47:30 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <vector>
...
std::string listToString1(const std::vector<double>& xs);
...
std::vector<double> deconv(const std::vector<double>& g, const std::vector<double>& f) {
    ...
    while ((i <= (g.size() - f.size()))) {
        ...
        out = ([&]{ auto __tmp = out; __tmp.push_back(((double)(sum) / (f[int64_t(0)]))); return __tmp; }());
        i = (i + int64_t(1));
    }
    return out;
}
...
int main() {
    ...
    std::cout << listToString1(h);
    std::cout << std::endl;
    std::cout << listToString1(deconv(g, f));
    std::cout << std::endl;
    std::cout << listToString1(f);
    std::cout << std::endl;
    std::cout << listToString1(deconv(g, h));
    std::cout << std::endl;
    return 0;
}

// Generated by Mochi transpiler v0.10.38 on 2025-07-24 13:29:39 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <any>
                ...
                for (int e = low; e < (high + 1); e++ ) {
                    for (int f = low; f < (high + 1); f++ ) {
                        ...
                        if ((!unique || isUnique((int)(a), (int)(b), (int)(c), (int)(d), (int)(e), (int)(f), (int)(g)))) {
                            valid = ([&]{ auto __tmp = valid; __tmp.push_back((std::vector<int>)std::vector{a, b, c, d, e, f, g}); return __tmp; }());
                            count = (count + 1);
                        }
                    }
                }

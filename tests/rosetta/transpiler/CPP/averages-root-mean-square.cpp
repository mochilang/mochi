// Generated by Mochi transpiler v0.10.40 on 2025-07-26 05:31:08 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
double sum = 0.0;
int x = 1;
double rms = sqrtApprox(((double)(sum) / ((double)(n))));
...
int main() {
    ...
    std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << rms; return ss.str(); }());
    std::cout << std::endl;
    return 0;
}

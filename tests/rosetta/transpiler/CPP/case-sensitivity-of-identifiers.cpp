// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:07:01 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <map>
...
int main() {
    {
        ...
        std::string pkg_dog = std::string("Salt");
        std::string Dog = std::string("Pepper");
        std::string pkg_DOG = std::string("Mustard");
        std::function<std::map<std::string, bool>(std::string, std::string, std::string)> packageSees = [&](std::string d1, std::string d2, std::string d3) mutable {
            std::cout << (((((std::string("Package sees: ") + d1) + std::string(" ")) + d2) + std::string(" ")) + d3);
            std::cout << std::endl;
            return std::map<std::string, bool>{{"pkg_dog", true}, {"Dog", true}, {"pkg_DOG", true}};
        };
        auto d = packageSees(pkg_dog, Dog, pkg_DOG);
        std::cout << ((std::string("There are ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << d.size(); return ss.str(); }())) + std::string(" dogs.\n"));
        std::cout << std::endl;
        std::string dog = std::string("Benjamin");
        d = packageSees(pkg_dog, Dog, pkg_DOG);
        std::cout << (((((std::string("Main sees:   ") + dog) + std::string(" ")) + Dog) + std::string(" ")) + pkg_DOG);
        std::cout << std::endl;
        ...
        std::cout << ((std::string("There are ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << d.size(); return ss.str(); }())) + std::string(" dogs.\n"));
        std::cout << std::endl;
        std::string DOG = std::string("Bernie");
        d = packageSees(pkg_dog, Dog, pkg_DOG);
        std::cout << (((((std::string("Main sees:   ") + dog) + std::string(" ")) + Dog) + std::string(" ")) + DOG);
        std::cout << std::endl;
        d[std::string("dog")] = true;
        d[std::string("Dog")] = true;
        d[std::string("pkg_DOG")] = true;

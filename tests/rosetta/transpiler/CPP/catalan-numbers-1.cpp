// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:07:10 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int64_t catalan(int64_t n) {
    return (int64_t)((binom((int64_t(2) * n), n) / (n + int64_t(1))));
}
...
int main() {
    {
        ...
        for (int i = int64_t(0); i < int64_t(15); i++ ) {
            std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << catalan((int64_t)(i)); return ss.str(); }());
            std::cout << std::endl;
        }
    }
    return 0;

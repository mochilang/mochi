// Generated by Mochi transpiler v0.10.38 on 2025-07-23 16:23:49 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <any>
...
std::map<std::string, std::any> moveLeft(std::vector<std::vector<int>> b, int score) {
    ...
    while ((y < SIZE)) {
        ...
        int x = 0;
        while ((x < SIZE)) {
            if ((b[y][x] != std::any_cast<std::vector<int>>(_new)[x])) {
                moved = true;
            }
            b[y][x] = std::any_cast<std::vector<int>>(_new)[x];
            x = (x + 1);
        }
        y = (y + 1);
    }
...
std::map<std::string, std::any> moveUp(std::vector<std::vector<int>> b, int score) {
    ...
    while ((x < SIZE)) {
        ...
        int y = 0;
        while ((y < SIZE)) {
            if ((b[y][x] != std::any_cast<std::vector<int>>(_new)[y])) {
                moved = true;
            }
            b[y][x] = std::any_cast<std::vector<int>>(_new)[y];
            y = (y + 1);
        }
        x = (x + 1);
    }

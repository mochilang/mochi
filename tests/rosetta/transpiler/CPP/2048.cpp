// Generated by Mochi transpiler v0.10.38 on 2025-07-23 20:18:48 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <any>
...
std::map<std::string, std::any> moveLeft(std::vector<std::vector<int>> b, int score) {
    ...
    while ((y < SIZE)) {
        ...
        int x = 0;
        while ((x < SIZE)) {
            if ((b[y][x] != std::any_cast<int>(std::any_cast<std::vector<int>>(_new)[x]))) {
                moved = true;
            }
            b[y][x] = std::any_cast<int>(std::any_cast<std::vector<int>>(_new)[x]);
            x = (x + 1);
        }
        y = (y + 1);
    }
...
std::map<std::string, std::any> moveRight(std::vector<std::vector<int>> b, int score) {
    ...
    while ((y < SIZE)) {
        ...
        rev = std::any_cast<std::vector<int>>(r[std::string("row")]);
        score = (score + std::any_cast<int>(r[std::string("gain")]));
        rev = reverseRow(rev);
        int x = 0;
        while ((x < SIZE)) {
...
std::map<std::string, std::any> moveUp(std::vector<std::vector<int>> b, int score) {
    ...
    while ((x < SIZE)) {
        ...
        int y = 0;
        while ((y < SIZE)) {
            if ((b[y][x] != std::any_cast<int>(std::any_cast<std::vector<int>>(_new)[y]))) {
                moved = true;
            }
            b[y][x] = std::any_cast<int>(std::any_cast<std::vector<int>>(_new)[y]);
            y = (y + 1);
        }
        x = (x + 1);
    }
...
std::map<std::string, std::any> moveDown(std::vector<std::vector<int>> b, int score) {
    ...
    int x = 0;
    while ((x < SIZE)) {
        std::vector<int> col = reverseRow((std::vector<int>)(getCol(b, x)));
        std::map<std::string, std::any> r = slideLeft(col);
        col = std::any_cast<std::vector<int>>(r[std::string("row")]);
        score = (score + std::any_cast<int>(r[std::string("gain")]));
        col = reverseRow(col);
        int y = 0;
        while ((y < SIZE)) {
...
int main() {
    board = std::any_cast<std::vector<std::vector<int>>>(r[std::string("board")]);
    r = spawnTile(board);
    board = std::any_cast<std::vector<std::vector<int>>>(r[std::string("board")]);
    ...
    while (true) {
        ...
        if (((cmd == std::string("a")) || (cmd == std::string("A")))) {
            ...
            board = std::any_cast<std::vector<std::vector<int>>>(m[std::string("board")]);
            score = std::any_cast<int>(m[std::string("score")]);
            moved = std::any_cast<bool>(m[std::string("moved")]);
        }
        ...
        if (moved) {
            ...
            board = std::any_cast<std::vector<std::vector<int>>>(r2[std::string("board")]);

// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:07:21 GMT+7
#include <iostream>
#include <string>
#include <functional>
#include <vector>
...
int64_t fold(std::function<int64_t(int64_t, int64_t)> f, const std::vector<int64_t>& xs);
int main();

std::vector<int64_t> n = std::vector<int64_t>{int64_t(1), int64_t(2), int64_t(3), int64_t(4), int64_t(5)};
...
int main() {
    {
        ...
        std::cout << fold((std::function<int64_t(int64_t, int64_t)>)([&](int64_t a, int64_t b) { return add((int64_t)(a), (int64_t)(b)); }), n);
        std::cout << std::endl;
        std::cout << fold((std::function<int64_t(int64_t, int64_t)>)([&](int64_t a, int64_t b) { return sub((int64_t)(a), (int64_t)(b)); }), n);
        std::cout << std::endl;
        std::cout << fold((std::function<int64_t(int64_t, int64_t)>)([&](int64_t a, int64_t b) { return mul((int64_t)(a), (int64_t)(b)); }), n);
        std::cout << std::endl;
    }
    return 0;
}

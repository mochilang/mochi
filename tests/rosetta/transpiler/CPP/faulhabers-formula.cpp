// Generated by Mochi transpiler v0.10.50 on 2025-07-30 21:15:11 GMT+7
#include <iostream>
#include <string>
    ...
    while ((p < int64_t(10))) {
        ...
        while ((j <= p)) {
            ...
            if ((([&]{ std::ostringstream ss; ss << std::boolalpha << c; return ss.str(); }()) != std::string("0/1"))) {
                ...
                int64_t exp = ((p + int64_t(1)) - j);
                if ((exp > int64_t(1))) {
                    line = ((line + std::string("^")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << exp; return ss.str(); }()));
                }
            }
            j = (j + int64_t(1));
        }

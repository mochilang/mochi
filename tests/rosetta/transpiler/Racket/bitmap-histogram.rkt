...
(define (histogram g bins)
  (let/ec _return (begin
(if (<= bins 0) (let ()
(set! bins (cond [(string? (list-ref g 0)) (string-length (list-ref g 0))] [(hash? (list-ref g 0)) (hash-count (list-ref g 0))] [else (length (list-ref g 0))]))
) (void))
(define h (list))
(define i 0)
...
(let/ec _break (let loop ()
  (if (< y (cond [(string? g) (string-length g)] [(hash? g) (hash-count g)] [else (length g)])) (let ()
    (define row (list-ref g y))
    (define x 0)
    (let/ec _break (let loop ()
  (if (< x (cond [(string? row) (string-length row)] [(hash? row) (hash-count row)] [else (length row)])) (let ()
    (define p (list-ref row x))
    (define idx (int (quotient (* p (- bins 1)) 65535)))
    (set! h (list-set h idx (let ([__l (list-ref h idx)] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
...
(let/ec _break (let loop ()
  (if (<= lb ub) (let ()
    (if (< (let ([__l lSum] [__r (list-ref h lb)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) (let ([__l uSum] [__r (list-ref h ub)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))) (let ()
(set! lSum (let ([__l lSum] [__r (list-ref h lb)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
(set! lb (let ([__l lb] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
) (let ()
(set! uSum (let ([__l uSum] [__r (list-ref h ub)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
(set! ub (- ub 1))
))
    (loop)) (void))))

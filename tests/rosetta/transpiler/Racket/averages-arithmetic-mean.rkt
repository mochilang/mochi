...
(define r (mean v))
(if (hash-ref r "ok" #f) (let ()
(displayln (string-append (string-append (string-append "Mean of " (format "~a" (cond [(string? v) (string-length v)] [(hash? v) (hash-count v)] [else (length v)]))) " numbers is ") (format "~a" (hash-ref r "mean" #f))))
) (let ()

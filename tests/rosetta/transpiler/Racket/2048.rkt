;; Generated by Mochi 0.10.38 on 2025-07-24 00:44 +0700
#lang racket/base
...
(let/ec _break (let loop ()
  (if (< y SIZE) (let ()
    ...
    (let/ec _break (let loop ()
  (if (< x SIZE) (let ()
    (define v (list-ref (list-ref (hash-ref b "cells") y) x))
    (if (equal? v 0) (let ()
...
(let/ec _break (let loop ()
  (if (< y SIZE) (let ()
    ...
    (set! score (let ([__l score] [__r (hash-ref r "gain")]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (define x 0)
    (let/ec _break (let loop ()
  (if (< x SIZE) (let ()
...
(let/ec _break (let loop ()
  (if (< y SIZE) (let ()
    (set! col (append col (list (list-ref (list-ref (hash-ref b "cells") y) x))))
    (set! y (let ([__l y] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
(_return col)
))
...
(let/ec _break (let loop ()
  (if (< y SIZE) (let ()
    ...
    (let/ec _break (let loop ()
  (if (< x SIZE) (let ()
    (if (equal? (list-ref (list-ref (hash-ref b "cells") y) x) 0) (let ()
(_return #t)
) (void))
    (if (and (< (let ([__l x] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) SIZE) (equal? (list-ref (list-ref (hash-ref b "cells") y) x) (list-ref (list-ref (hash-ref b "cells") y) (let ([__l x] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))) (let ()
(_return #t)
) (void))
    (if (and (< (let ([__l y] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) SIZE) (equal? (list-ref (list-ref (hash-ref b "cells") y) x) (list-ref (list-ref (hash-ref b "cells") (let ([__l y] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))) x))) (let ()
(_return #t)
) (void))
    (set! x (let ([__l x] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
...
(let/ec _break (let loop ()
  (if (< y SIZE) (let ()
    ...
    (let/ec _break (let loop ()
  (if (< x SIZE) (let ()
    (if (>= (list-ref (list-ref (hash-ref b "cells") y) x) 2048) (let ()
(_return #t)
) (void))
    (set! x (let ([__l x] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))

...
(let/ec _break (let loop ()
  (if (<= i b2Seg) (let ()
    (define c (/ (exact->inexact i) (exact->inexact b2Seg)))
    (define a (- 1.0 c))
    (define a2 (* a a))
    (define b2 (* (* 2.0 c) a))
    (define c2 (* c c))
    (set! px (list-set px i (int (let ([__l (let ([__l (* a2 fx1)] [__r (* b2 fx2)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))] [__r (* c2 fx3)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))))
    (set! py (list-set py i (int (let ([__l (let ([__l (* a2 fy1)] [__r (* b2 fy2)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))] [__r (* c2 fy3)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))

...
(define (edgeCheck a0 a1 bs onBoundary)
  (let/ec _return (begin
(define d0 (orient a0 a1 (if bs (list-ref bs (int 0)) #f)))
(define d1 (orient a0 a1 (if bs (list-ref bs (int 1)) #f)))
(define d2 (orient a0 a1 (if bs (list-ref bs (int 2)) #f)))
(if onBoundary (let ()
...
(let/ec _break (let loop ()
  (if (< i 3) (let ()
    ...
    (if (edgeCheck (if a (list-ref a (int i)) #f) (if a (list-ref a (int j)) #f) b onBoundary) (let ()
(_return #f)
) (void))
...
(let/ec _break (let loop ()
  (if (< i 3) (let ()
    (define j (modulo (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) 3))
    (if (edgeCheck (if b (list-ref b (int i)) #f) (if b (list-ref b (int j)) #f) a onBoundary) (let ()
(_return #f)
) (void))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))

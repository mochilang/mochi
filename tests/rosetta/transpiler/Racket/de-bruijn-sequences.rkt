...
(let/ec _break (let loop ()
  (if (<= j p) (let ()
    (set! seq (append seq (list (if a (list-ref a (int j)) #f))))
    (set! j (let ([__l j] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
) (void))
) (let ()
(set! a (list-set a (int t) (if a (list-ref a (int (- t p))) #f)))
(set! seq (dbRec k n (let ([__l t] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) p a seq))
(define j (let ([__l (if a (list-ref a (int (- t p))) #f)] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
(let/ec _break (let loop ()
  (if (< j k) (let ()
...
(if (< k 10) (let ()
(set! alphabet (substring digits 0 k))
) (void))
(define a (list))
(define i 0)
(let/ec _break (let loop ()
...
(define idx 0)
(let/ec _break (let loop ()
  (if (< idx (cond [(string? seq) (string-length seq)] [(hash? seq) (hash-count seq)] [else (length seq)])) (let ()
    (set! b (string-append b (substring alphabet (if seq (list-ref seq (int idx)) #f) (+ (if seq (list-ref seq (int idx)) #f) 1))))
    (set! idx (let ([__l idx] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
(set! b (string-append b (substring b 0 (- n 1))))
(_return b)
))
)
(define (allDigits s)
...
(let/ec _break (let loop ()
  (if (< i (cond [(string? str) (string-length str)] [(hash? str) (hash-count str)] [else (length str)])) (let ()
    (set! n (let ([__l (* n 10)] [__r (int (substring str i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
(_return n)
))
...
(let/ec _break (let loop ()
  (if (< j (- le 3)) (let ()
    (define s (substring db j (let ([__l j] [__r 4]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
    (if (allDigits s) (let ()
(define n (_parse-int-str s 10))
(set! found (list-set found (int n) (let ([__l (if found (list-ref found (int n)) #f)] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
) (void))
    (set! j (let ([__l j] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
(define errs (list))
...
(let/ec _break (let loop ()
  (if (< k 10000) (let ()
    (if (equal? (if found (list-ref found (int k)) #f) 0) (let ()
(set! errs (append errs (list (string-append (string-append "    PIN number " (padLeft k 4)) " missing"))))
) (let ()
(if (> (if found (list-ref found (int k)) #f) 1) (let ()
(set! errs (append errs (list (string-append (string-append (string-append (string-append "    PIN number " (padLeft k 4)) " occurs ") (format "~a" (if found (list-ref found (int k)) #f))) " times"))))
) (void))
))
...
(displayln (substring db 0 130))
(displayln "\nThe last 130 digits of the de Bruijn sequence are:")
(displayln (substring db (- le 130) (string-length db)))
(displayln "\nValidating the de Bruijn sequence:")
(validate db)
(displayln "\nValidating the reversed de Bruijn sequence:")
(define dbr (reverse db))
(validate dbr)
(set! db (string-append (string-append (substring db 0 4443) ".") (substring db 4444 (cond [(string? db) (string-length db)] [(hash? db) (hash-count db)] [else (length db)]))))

...
(_return (if names (list-ref names (int (modulo (let ([__l z] [__r 4]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) 7))) #f))
))
)
(define (main)
  (let/ec _return (begin
...
(define d (int (let ([__l (- doy (/ (let ([__l (* 153 mp)] [__r 2]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) (int 5)))] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
...
(define line (string-append (string-append (string-append (string-append (string-append (string-append (weekdayName days) ", ") (if months (list-ref months (int (- m 1))) #f)) " ") (format "~a" d)) ", ") (format "~a" y)))
(displayln line)
))
)
(main)

...
(define nStr (padRight (format "~a" n) 2))
(define pStr (padLeft (commatize i) 19))
(displayln (string-append (string-append (string-append "n = " nStr) "  ") pStr))
(set! i (- (let ([__l i] [__r i]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) 1))
) (void))

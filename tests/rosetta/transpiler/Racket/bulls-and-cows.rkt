...
(define pat (let ([__l (let ([__l (let ([__l (list-ref digits 0)] [__r (list-ref digits 1)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))] [__r (list-ref digits 2)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))] [__r (list-ref digits 3)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))

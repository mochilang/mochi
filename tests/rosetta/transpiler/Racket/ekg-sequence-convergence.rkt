...
(let/ec _break (let loop ()
  ...
  (if (< n limit) (let ()
    ...
    (let/ec _break (let loop ()
  (if (not done) (let ()
    (if (and (not (string-contains? seq i)) (> (gcd (if seq (list-ref seq (int (- n 1))) #f) i) 1)) (let ()
...
(let/ec _break (let loop ()
  (if (< i limit) (let ()
    (if (and (equal? (if (if ekg (list-ref ekg (int 1)) #f) (list-ref (if ekg (list-ref ekg (int 1)) #f) (int i)) #f) (if (if ekg (list-ref ekg (int 2)) #f) (list-ref (if ekg (list-ref ekg (int 2)) #f) (int i)) #f)) (areSame (sublist (if ekg (list-ref ekg (int 1)) #f) 0 i) (sublist (if ekg (list-ref ekg (int 2)) #f) 0 i))) (let ()

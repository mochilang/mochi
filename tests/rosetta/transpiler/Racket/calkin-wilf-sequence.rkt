...
(set! res (list-set res (- (cond [(string? res) (string-length res)] [(hash? res) (hash-count res)] [else (length res)]) 1) (- (list-ref res (- (cond [(string? res) (string-length res)] [(hash? res) (hash-count res)] [else (length res)]) 1)) 1)))
...
(define d "1")
(for ([n cf])
(set! b (string-append (repeat d n) b))
(if (string=? d "1") (let ()
(set! d "0")
) (let ()
(set! d "1")

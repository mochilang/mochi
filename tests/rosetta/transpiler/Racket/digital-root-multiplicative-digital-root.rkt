...
(let/ec _break (let loop ()
  (if (> cnt 0) (let ()
    ...
    (if (< (cond [(string? (if list_ (if (hash? list_) (hash-ref list_ mdr #f) (list-ref list_ (int mdr))) #f)) (string-length (if list_ (if (hash? list_) (hash-ref list_ mdr #f) (list-ref list_ (int mdr))) #f))] [(hash? (if list_ (if (hash? list_) (hash-ref list_ mdr #f) (list-ref list_ (int mdr))) #f)) (hash-count (if list_ (if (hash? list_) (hash-ref list_ mdr #f) (list-ref list_ (int mdr))) #f))] [else (length (if list_ (if (hash? list_) (hash-ref list_ mdr #f) (list-ref list_ (int mdr))) #f))]) size) (let ()
(set! list_ (list-set list_ (int mdr) (append (if list_ (if (hash? list_) (hash-ref list_ mdr #f) (list-ref list_ (int mdr))) #f) (list (int n)))))
(set! cnt (- cnt 1))
) (void))
...
(let/ec _break (let loop ()
  (if (< j base) (let ()
    (displayln (string-append (string-append (pad (format "~a" j) 3) ": ") (format "~a" (if list_ (if (hash? list_) (hash-ref list_ j #f) (list-ref list_ (int j))) #f))))

...
(_return (exact->inexact (let ([__l (* (let ([__l (* h 60)] [__r m]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) 60)] [__r sec]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
))
)
(define (pad n)
  (let/ec _return (begin

...
(set! s (string-append (string-append s "^") (format "~a" i)))
    ...
    (set! coef (int (quotient (* coef i) (let ([__l (- p i)] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))))
    (define d coef)
...
(_return #f)
    ...
    (set! c (int (quotient (* c (- n i)) (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))))

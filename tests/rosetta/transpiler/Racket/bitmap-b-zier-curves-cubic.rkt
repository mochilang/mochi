...
(let/ec _break (let loop ()
  (if (<= i b3Seg) (let ()
    ...
    (define d2 (* ccoef d))
    (set! px (list-set px i (int (let ([__l (let ([__l (let ([__l (* a2 fx1)] [__r (* b2 fx2)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))] [__r (* c2 fx3)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))] [__r (* d2 fx4)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))))
    (set! py (list-set py i (int (let ([__l (let ([__l (let ([__l (* a2 fy1)] [__r (* b2 fy2)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))] [__r (* c2 fy3)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))] [__r (* d2 fy4)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
(define x0 (list-ref px 0))
(define y0 (list-ref py 0))
(set! i 1)
(let/ec _break (let loop ()
  (if (<= i b3Seg) (let ()
    (define x (list-ref px i))
    (define y (list-ref py i))
    (line b x0 y0 x y p)
    (set! x0 x)
    (set! y0 y)
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))

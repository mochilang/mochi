...
(_return k)
    ...
    (set! k (let ([__l k] [__r (list-ref inc i)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
...
(if (equal? d 1) (let ()
(set! counts (list-set counts 0 (let ([__l (list-ref counts 0)] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
) (let ()
(if (equal? d 3) (let ()
(set! counts (list-set counts 1 (let ([__l (list-ref counts 1)] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
) (let ()
(if (equal? d 7) (let ()
(set! counts (list-set counts 2 (let ([__l (list-ref counts 2)] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
) (let ()
(if (equal? d 9) (let ()
(set! counts (list-set counts 3 (let ([__l (list-ref counts 3)] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
) (void))
))
))
))
...
(let/ec _break (let loop ()
  (if (< idx 50) (let ()
    ...
    (let/ec _break (let loop ()
  (if (< j 10) (let ()
    (set! line (string-append (string-append line (padLeft (list-ref blum idx) 3)) " "))

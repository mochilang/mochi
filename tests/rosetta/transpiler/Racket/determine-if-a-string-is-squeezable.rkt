...
(let/ec _break (let loop ()
  (if (< i (cond [(string? strings) (string-length strings)] [(hash? strings) (hash-count strings)] [else (length strings)])) (let ()
    ...
    (let/ec _break (let loop ()
  (if (< j (cond [(string? (if chars (if (hash? chars) (hash-ref chars i #f) (list-ref chars (int i))) #f)) (string-length (if chars (if (hash? chars) (hash-ref chars i #f) (list-ref chars (int i))) #f))] [(hash? (if chars (if (hash? chars) (hash-ref chars i #f) (list-ref chars (int i))) #f)) (hash-count (if chars (if (hash? chars) (hash-ref chars i #f) (list-ref chars (int i))) #f))] [else (length (if chars (if (hash? chars) (hash-ref chars i #f) (list-ref chars (int i))) #f))])) (let ()

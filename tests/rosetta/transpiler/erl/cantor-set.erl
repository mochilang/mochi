...
% Generated by Mochi transpiler v0.10.42 (35a3818303) on 2025-07-27 16:49 UTC
...
{} = Fun(lists:seq(0, (5) - 1)),
    ...
    case (length(erlang:get('stack')) > 0) of
        true ->
            try
                Frame = lists:nth((length(erlang:get('stack')) - 1) + 1, erlang:get('stack')),
    ...
    case (J_3 < (Start + (2 * Seg))) of
        true ->
            ...
            Lines_2 = lists:sublist(Lines, I_2) ++ [setchar(lists:nth(I_2 + 1, erlang:get('lines')), J_3, " ")] ++ lists:nthtail(I_2 + 1, Lines),

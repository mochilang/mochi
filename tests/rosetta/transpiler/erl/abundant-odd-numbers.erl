    ...
    case ((I * I) =< N) of
        ...
        _ -> Divs_3 = Divs,
            ...
            J_2 = nil
                ...
                continue -> Fun_loop(Divs, Divs2, I, N);
    ...
    case (J_3 >= 0) of
        true ->
            try
                ...
                continue -> Fun_2_loop(Divs_3, Divs2_4, I_2, J_3, N);
    ...
    case (I_3 < length(Xs_2)) of
        true ->
            try
                ...
                continue -> Fun_4_loop(I_3, S, Xs_2);
                break -> {I_3, S, Xs_2}
            end;
        _ -> {I_3, S, Xs_2}
    end
    ...
    case (Count < CountTo) of
        ...
        _ -> Count_3 = Count,
            ...
            S_7 = nil
                ...
                continue -> Fun_6_loop(Count, CountFrom, CountTo, N_4, PrintOne, SearchFrom);

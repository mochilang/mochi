...
% Generated by Mochi transpiler v0.10.39 (68135693b7) on 2025-07-24 13:03 +0700
    ...
    case ((I * I) =< N) of
        ...
        _ -> Divs_3 = Divs,
            ...
            J_2 = nil
                ...
                continue -> Fun_loop(Divs_3, Divs2_4, I_2, N);
    ...
    case (J_3 >= 0) of
        true ->
            ...
            try
                ...
                continue -> Fun_2_loop(Divs_4, Divs2_4, I_2, J_4, N);
    ...
    case (I_3 < length(Xs_2)) of
        true ->
            ...
            try
                ...
                continue -> Fun_4_loop(I_4, S_2, Xs_2);
                break -> {I_3, S, Xs_2}
            end;
        _ -> {I_3, S, Xs_2}
    end
...
abundantOdd(SearchFrom, CountFrom, CountTo, PrintOne) ->
    ...
    case (Count < CountTo) of
        ...
        true -> Count_2 = (Count + 1),
            case ((PrintOne andalso (Count_2 < CountTo)) /= nil) of
        true -> N_5 = (N_4 + 2),
            throw(continue),
            N_6 = N_5;
        _ -> N_6 = N_4
        ...
        _ -> Count_3 = Count,
            ...
            S_7 = nil
                ...
                continue -> Fun_6_loop(Count_3, CountFrom, CountTo, N_8, PrintOne, SearchFrom);

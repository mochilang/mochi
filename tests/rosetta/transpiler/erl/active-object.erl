...
main(_) ->
    ...
    case (erlang:get('i') =< 200) of
        true ->
            T2 = mochi_safe_mul(float(erlang:get('i')), 0.01),
            K2 = sinapprox(mochi_safe_mul(T2, 3.141592653589793)),
            erlang:put('s', (erlang:get('s') + (mochi_safe_mul((erlang:get('k1') + K2), 0.5) * (T2 - erlang:get('t1'))))),
            erlang:put('t1', T2),
            erlang:put('k1', K2),
...
{} = Fun_2(),
    ...
    case (erlang:get('i2') =< 50) of
        true ->
            T2_2 = (2 + mochi_safe_mul(float(erlang:get('i2')), 0.01)),
            K2_2 = 0,
            erlang:put('s', (erlang:get('s') + mochi_safe_mul(mochi_safe_mul((erlang:get('k1') + 0), 0.5), (T2_2 - erlang:get('t1'))))),
            erlang:put('t1', T2_2),
            erlang:put('k1', 0),

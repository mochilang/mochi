...
main() ->
    ...
    case (I =< 2) of
        true ->
            ...
            Name = (fun() -> In = io:get_line(""), case In of eof -> "q"; _ -> string:trim(In) end end)(),
            io:format("~ts~n", ["       Enter value : "]),
            Value = (fun() -> In = io:get_line(""), case In of eof -> "q"; _ -> string:trim(In) end end)(),
...
{I_2, Ss_2} = Fun(I, Ss),
    ...
    case true of
        true ->
            ...
            Name_2 = (fun() -> In = io:get_line(""), case In of eof -> "q"; _ -> string:trim(In) end end)(),

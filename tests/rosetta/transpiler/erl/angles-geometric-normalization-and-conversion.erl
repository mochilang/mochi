...
{Angles} = Fun(Angles, Angles),
    ...
    case List of
        ...
        [A_2|Fun_2_loop_rest] ->
            ...
            Fun_2_loop(Fun_2_loop_rest, Angles)
    end
end,
{Angles} = Fun_2(Angles, Angles),
    ...
    case List of
        ...
        [A_3|Fun_3_loop_rest] ->
            ...
            Fun_3_loop(Fun_3_loop_rest, Angles)
    end
end,
{Angles} = Fun_3(Angles, Angles),
    ...
    case List of
        ...
        [A_4|Fun_4_loop_rest] ->
            ...
            Fun_4_loop(Fun_4_loop_rest, Angles)
    end
end,

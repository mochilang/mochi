...
d2d(D) ->
    try
        mochi_safe_fmod(D, 360)
    catch {return, Ret} -> Ret end.

g2g(G) ->
    try
        mochi_safe_fmod(G, 400)
    catch {return, Ret} -> Ret end.

m2m(M) ->
    try
        mochi_safe_fmod(M, 6400)
    catch {return, Ret} -> Ret end.

r2r(R) ->
    try
        mochi_safe_fmod(R, mochi_safe_mul(2, 3.141592653589793))
    catch {return, Ret} -> Ret end.

d2g(D_2) ->
    try
        mochi_safe_div(mochi_safe_mul(d2d(D_2), 400), 360)
    catch {return, Ret} -> Ret end.

d2m(D_3) ->
    try
        mochi_safe_div(mochi_safe_mul(d2d(D_3), 6400), 360)
    catch {return, Ret} -> Ret end.

d2r(D_4) ->
    try
        mochi_safe_div(mochi_safe_mul(d2d(D_4), 3.141592653589793), 180)
    catch {return, Ret} -> Ret end.

g2d(G_2) ->
    try
        mochi_safe_div(mochi_safe_mul(g2g(G_2), 360), 400)
    catch {return, Ret} -> Ret end.

g2m(G_3) ->
    try
        mochi_safe_div(mochi_safe_mul(g2g(G_3), 6400), 400)
    catch {return, Ret} -> Ret end.

g2r(G_4) ->
    try
        mochi_safe_div(mochi_safe_mul(g2g(G_4), 3.141592653589793), 200)
    catch {return, Ret} -> Ret end.

m2d(M_2) ->
    try
        mochi_safe_div(mochi_safe_mul(m2m(M_2), 360), 6400)
    catch {return, Ret} -> Ret end.

m2g(M_3) ->
    try
        mochi_safe_div(mochi_safe_mul(m2m(M_3), 400), 6400)
    catch {return, Ret} -> Ret end.

m2r(M_4) ->
    try
        mochi_safe_div(mochi_safe_mul(m2m(M_4), 3.141592653589793), 3200)
    catch {return, Ret} -> Ret end.

r2d(R_2) ->
    try
        mochi_safe_div(mochi_safe_mul(r2r(R_2), 180), 3.141592653589793)
    catch {return, Ret} -> Ret end.

r2g(R_3) ->
    try
        mochi_safe_div(mochi_safe_mul(r2r(R_3), 200), 3.141592653589793)
    catch {return, Ret} -> Ret end.

r2m(R_4) ->
    try
        mochi_safe_div(mochi_safe_mul(r2r(R_4), 3200), 3.141592653589793)
    catch {return, Ret} -> Ret end.

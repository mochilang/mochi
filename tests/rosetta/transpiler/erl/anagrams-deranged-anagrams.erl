...
% Generated by Mochi transpiler v0.10.39 (341a8a2ad3) on 2025-07-24 23:26 +0700
...
main() ->
    ...
    case List of
        ...
        true -> BestLen_2 = length(W),
            W1_2 = C,
            W2_2 = W,
            throw({break, BestLen_2, K, M_5, W, W1_2, W2_2, Words}),
            BestLen_3 = BestLen_2,
            W1_3 = W1_2,
            W2_3 = W2_2;
        _ -> BestLen_3 = BestLen,
...
{BestLen_3, K, M_5, W, W1_3, W2_3, Words} = Fun_7(maps:get(K, M_5), BestLen, K, M_5, W, W1, W2, Words),

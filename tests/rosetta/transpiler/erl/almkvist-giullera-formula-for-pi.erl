...
{F_3, N_9, Primes_2, X_4} = Fun_26(Primes_2, F, N_8, Primes_2, X_4),
        case (N_9 > 1) of
        true -> F_4 = maps:put(lists:flatten(io_lib:format("~p", [N_9])), (nil + 1), F_3),
            F_5 = F_4;
        _ -> F_5 = F_3
    end,
        F_5
...
{Exps_2, Fn, N_10, Primes_3} = Fun_28(maps:keys(Fn), Exps, Fn, N_10, Primes_3),
    ...
    case List of
        ...
        [K_3|K_3_rest] ->
            Exps_4 = maps:put(K_3, (nil + maps:get(K_3, Ft2, nil)), Exps_3),
...
{Exps_4, Fn, Ft2, N_10, Primes_3, T2} = Fun_29(maps:keys(Ft2), Exps_3, Fn, Ft2, N_10, Primes_3, T2),
        Exps_5 = maps:put("3", (nil - 1), Exps_4),
        Keys = [],

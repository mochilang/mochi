...
{Bs_4, C_2, I_2} = Fun_3(Bs, C_2, I),
    ...
    case List of
        ...
        _ -> Ms_3 = Ms
            ...
            Ms_4 = (((Ms_3 ++ lists:flatten(io_lib:format("~p", [K_2]))) ++ ":") ++ lists:flatten(io_lib:format("~p", [lists:nth(K_2 + 1, maps:get("m", C_2, nil))]))),
            First_2 = false,
            Fun_4_loop(K_2_rest, Bs_5, C_2, First_2, I_2, Ms_4)
    end
end,
{Bs_5, C_2, First_2, I_2, Ms_4} = Fun_4(maps:get("m", C_2, nil), Bs_5, C_2, First, I_2, Ms),
        Ms_5 = (Ms_4 ++ "]"),

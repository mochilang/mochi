...
skipws(P) ->
    ...
    case ((I < maps:size(maps:get("expr", P, nil))) andalso (string:substr(maps:get("expr", P, nil), I + 1, ((I + 1) - I)) == " ")) of
        true ->
            I_2 = (I + 1),
            Fun_loop(I_2, P);
        _ -> {I, P}
...
parsenumber(P_3) ->
    ...
    case (maps:get("pos", P_4, nil) < maps:size(maps:get("expr", P_4, nil))) of
        true ->
            try
...
parsefactor(P_7) ->
    try
        P_8 = skipws(P_7),
        case ((maps:get("pos", P_8, nil) < maps:size(maps:get("expr", P_8, nil))) andalso (string:substr(maps:get("expr", P_8, nil), maps:get("pos", P_8, nil) + 1, ((maps:get("pos", P_8, nil) + 1) - maps:get("pos", P_8, nil))) == "(")) of
        true -> P_9 = maps:put("pos", (maps:get("pos", P_8, nil) + 1), P_8),
            R = parseexpr(P_9),
            V = maps:get("v", R, nil),
            P_10 = maps:get("p", R, nil),
            P_11 = skipws(P_10),
            case ((maps:get("pos", P_11, nil) < maps:size(maps:get("expr", P_11, nil))) andalso (string:substr(maps:get("expr", P_11, nil), maps:get("pos", P_11, nil) + 1, ((maps:get("pos", P_11, nil) + 1) - maps:get("pos", P_11, nil))) == ")")) of
        ...
        case ((maps:get("pos", P_14, nil) < maps:size(maps:get("expr", P_14, nil))) andalso (string:substr(maps:get("expr", P_14, nil), maps:get("pos", P_14, nil) + 1, ((maps:get("pos", P_14, nil) + 1) - maps:get("pos", P_14, nil))) == "-")) of
...
parsepower(P_18) ->
    ...
    case true of
        true ->
            try
                P_20 = skipws(P_19),
                case ((maps:get("pos", P_20, nil) < maps:size(maps:get("expr", P_20, nil))) andalso (string:substr(maps:get("expr", P_20, nil), maps:get("pos", P_20, nil) + 1, ((maps:get("pos", P_20, nil) + 1) - maps:get("pos", P_20, nil))) == "^")) of
...
parseterm(P_24) ->
    ...
    case true of
        true ->
            try
                P_26 = skipws(P_25),
                case (maps:get("pos", P_26, nil) < maps:size(maps:get("expr", P_26, nil))) of
...
parseexpr(P_34) ->
    ...
    case true of
        true ->
            try
                P_36 = skipws(P_35),
                case (maps:get("pos", P_36, nil) < maps:size(maps:get("expr", P_36, nil))) of

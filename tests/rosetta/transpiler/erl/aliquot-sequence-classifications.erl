...
classifySequence(K) ->
    ...
    case true of
        ...
        true -> Aliquot_6 = "Aspiring",
            ...
            Idx_3 = nil;
        _ -> case contains(lists:sublist(Seq_2, 1 + 1, (maxOf(1, (N_3 - 2)) - 1)), Last_2) of
        true -> Idx = indexOf(Seq_2, Last_2),
...
main() ->
    ...
    case (K_2 =< 10) of
        true ->
            ...
            io:format("~ts~n", [((((padLeft(K_2, 2) ++ ": ") ++ padRight(maps:get("aliquot", Res), 15)) ++ " ") ++ joinWithCommas(maps:get("seq", Res)))]),
            K_3 = (K_2 + 1),
            Fun_8_loop(K_3);
        _ -> {K_2}
    end
...
{K_3} = Fun_8(K_2),
    ...
    case (I_7 < length(S_9)) of
        true ->
            ...
            io:format("~ts~n", [((((padLeft(Val, 7) ++ ": ") ++ padRight(maps:get("aliquot", Res_2), 15)) ++ " ") ++ joinWithCommas(maps:get("seq", Res_2)))]),
            I_8 = (I_7 + 1),
...
{I_8, K_3, S_9} = Fun_9(I_7, K_3, S_9),
        ...
        io:format("~ts~n", [((((lists:flatten(io_lib:format("~p", [15355717786080])) ++ ": ") ++ padRight(maps:get("aliquot", R_3), 15)) ++ " ") ++ joinWithCommas(maps:get("seq", R_3)))]),
        nil
    catch {return, Ret} -> Ret end.

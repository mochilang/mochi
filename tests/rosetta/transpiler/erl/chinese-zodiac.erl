...
cz(Yr, Animal, YinYang, Element, Sc, Bc) ->
    try
        ...
        #{"animal" => lists:nth(Branch + 1, erlang:get('animal')), "yinYang" => lists:nth((Stem rem 2) + 1, erlang:get('yinYang')), "element" => lists:nth(mochi_to_int((Stem div 2)) + 1, erlang:get('element')), "stemBranch" => Sb, "cycle" => ((Y rem 60) + 1)}

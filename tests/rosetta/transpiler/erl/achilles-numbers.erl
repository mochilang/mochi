...
getachilles(MinExp, MaxExp_2) ->
    ...
    case true of
        ...
        _ -> ok
                ...
                case (P_3 >= Lower) of
        true -> case not maps:is_key(P_3, erlang:get('pps')) of
...
main() ->
    ...
    case List of
        ...
        [K|List_rest] ->
            Ach_2 = (Ach ++ [K]),
            Fun_13_loop(List_rest, Ach_2, AchSet, MaxDigits)
    end
end,
...
{Ach_3, AchSet, I_12, MaxDigits} = Fun_15(Ach_3, AchSet, I_11, MaxDigits),
    ...
    case (Count < 30) of
        true ->
            ...
            case mochi_member(Tot_6, AchSet) of
...
{Ach_3, AchSet, Count_3, I_12, Idx_5, MaxDigits, Strong_3} = Fun_16(Ach_3, AchSet, Count, I_12, Idx_4, MaxDigits, Strong),
    ...
    case (J_5 < 10) of
        true ->
            Line_6 = (Line_5 ++ pad(lists:nth(I_13 + 1, Strong_3), 5)),
            case (J_5 < 9) of
        true -> Line_7 = (Line_6 ++ " "),
            Line_8 = Line_7;
        _ -> Line_8 = Line_6

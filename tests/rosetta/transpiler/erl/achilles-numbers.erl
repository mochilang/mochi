...
getAchilles(MinExp, MaxExp_2) ->
    ...
    case true of
        ...
        _ -> ok
                ...
                case (P_3 >= Lower) of
        true -> case not mochi_member(P_3, erlang:get('pps')) of
...
sortInts(Xs) ->
    ...
    case (I_9 < length(Tmp)) of
        true ->
            try
                case (lists:nth(I_9 + 1, Tmp) < Min) of
        true -> Min_2 = lists:nth(I_9 + 1, Tmp),
            Idx_2 = I_9,
            Idx_3 = Idx_2,
            Min_3 = Min_2;
        _ -> Idx_3 = Idx,
            Min_3 = Min
                ...
                {continue, C0, C1, C2, C3, C4, C5} -> Fun_9_loop(C0, C1, C2, C3, C4, C5);
                break -> {I_9, Idx, Min, Res, Tmp, Xs}
            end;
...
{I_10, Idx_3, Min_3, Res, Tmp, Xs} = Fun_9(I_9, Idx, Min, Res, Tmp, Xs),
    ...
    case (J < length(Tmp)) of
        true ->
            try
                case (J /= Idx_3) of
        true -> Out_2 = (Out ++ [lists:nth(J + 1, Tmp)]),
            Out_3 = Out_2;
        _ -> Out_3 = Out
    end,
                J_2 = (J + 1),
                ...
                {continue, C0, C1, C2, C3, C4, C5, C6, C7} -> Fun_10_loop(C0, C1, C2, C3, C4, C5, C6, C7);
                break -> {I_10, Idx_3, J, Min_3, Out, Res_2, Tmp, Xs}
            end;
    ...
    case (length(S) < Width) of
        true ->
            try
                ...
                {continue, C0, C1, C2} -> Fun_12_loop(C0, C1, C2);
                break -> {N_4, S, Width}
            end;
        _ -> {N_4, S, Width}
    end
...
main() ->
    ...
    case List of
        ...
        [K|Fun_13_loop_rest] ->
            Ach_2 = (Ach ++ [K]),
            Fun_13_loop(Fun_13_loop_rest, Ach_2, AchSet, MaxDigits)
    end
end,
{Ach_2, AchSet, MaxDigits} = Fun_13(maps:keys(AchSet), Ach, AchSet, MaxDigits),
    ...
    case (J_3 < 10) of
        true ->
            try
                Line_2 = (Line ++ pad(lists:nth(I_11 + 1, Ach_3), 4)),
                case (J_3 < 9) of
        true -> Line_3 = (Line_2 ++ " "),
            Line_4 = Line_3;
        _ -> Line_4 = Line_2
                ...
                {continue, C0, C1, C2, C3, C4, C5} -> Fun_14_loop(C0, C1, C2, C3, C4, C5);
                break -> {Ach_3, AchSet, I_11, J_3, Line, MaxDigits}
            end;
...
{Ach_3, AchSet, I_12, J_4, Line_4, MaxDigits} = Fun_14(Ach_3, AchSet, I_11, J_3, Line, MaxDigits),
                ...
                {continue, C0, C1, C2, C3} -> Fun_15_loop(C0, C1, C2, C3);
                break -> {Ach_3, AchSet, I_11, MaxDigits}
            end;
...
{Ach_3, AchSet, I_12, MaxDigits} = Fun_15(Ach_3, AchSet, I_11, MaxDigits),
    ...
    case (Count < 30) of
        true ->
            try
                Tot_6 = totient(lists:nth(Idx_4 + 1, Ach_3)),
                case (mochi_member(Tot_6, AchSet) /= nil) of
        true -> Strong_2 = (Strong ++ [lists:nth(Idx_4 + 1, Ach_3)]),
            Count_2 = (Count + 1),
            Count_3 = Count_2,
            Strong_3 = Strong_2;
        _ -> Count_3 = Count,
            Strong_3 = Strong
                ...
                {continue, C0, C1, C2, C3, C4, C5, C6} -> Fun_16_loop(C0, C1, C2, C3, C4, C5, C6);
                break -> {Ach_3, AchSet, Count, I_12, Idx_4, MaxDigits, Strong}
            end;
...
{Ach_3, AchSet, Count_3, I_12, Idx_5, MaxDigits, Strong_3} = Fun_16(Ach_3, AchSet, Count, I_12, Idx_4, MaxDigits, Strong),
    ...
    case (J_5 < 10) of
        true ->
            try
                Line_6 = (Line_5 ++ pad(lists:nth(0 + 1, Strong_3), 5)),
                case (J_5 < 9) of
        true -> Line_7 = (Line_6 ++ " "),
            Line_8 = Line_7;
        _ -> Line_8 = Line_6
                ...
                break -> {Ach_3, AchSet, Count_3, I_13, Idx_5, J_5, Line_5, MaxDigits, Strong_3}
            end;
...
{Ach_3, AchSet, Count_3, I_14, Idx_5, J_6, Line_8, MaxDigits, Strong_3} = Fun_17(Ach_3, AchSet, Count_3, I_13, Idx_5, J_5, Line_5, MaxDigits, Strong_3),
                ...
                {continue, C0, C1, C2, C3, C4, C5, C6} -> Fun_18_loop(C0, C1, C2, C3, C4, C5, C6);
                break -> {Ach_3, AchSet, Count_3, I_13, Idx_5, MaxDigits, Strong_3}
            end;
    ...
    case (D =< 15) of
        true ->
            try
                ...
                break -> {Ach_3, AchSet, Count_3, Counts, D, I_14, Idx_5, MaxDigits, Strong_3}
            end;

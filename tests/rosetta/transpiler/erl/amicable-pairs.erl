...
{I_5, Sums_3} = Fun_4(I_4, Sums_2),
    ...
    case (N_2 < 19999) of
        true ->
            M = (case erlang:is_map(Sums_3) of true -> maps:get(N_2, Sums_3, nil); _ -> lists:nth(N_2 + 1, Sums_3) end),
            case (((M > N_2) andalso (M < 20000)) andalso (N_2 == (case erlang:is_map(Sums_3) of true -> maps:get(M, Sums_3, nil); _ -> lists:nth(M + 1, Sums_3) end))) of

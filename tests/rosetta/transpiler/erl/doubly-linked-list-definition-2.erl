...
pushfront(L_4, V_2) ->
    try
        N_2 = newnode(L_4, V_2),
        N_3 = maps:put("next", maps:get("head", L_4, nil), N_2),
        case (mochi_to_int(maps:get("head", L_4, nil)) /= 0) of
        true -> Nodes_3 = maps:get("nodes", L_4, nil),
            H = maps:get(mochi_to_int(maps:get("head", L_4, nil)), Nodes_3, nil),
            H_2 = maps:put("prev", maps:get("id", N_3, nil), H),
            Nodes_4 = maps:put(mochi_to_int(maps:get("id", H_2, nil)), H_2, Nodes_3),
            L_5 = maps:put("nodes", Nodes_4, L_4),
            H_3 = H_2,
            L_7 = L_5,
            Nodes_5 = Nodes_4;
        _ -> L_6 = maps:put("tail", maps:get("id", N_3, nil), L_4),
            H_3 = nil,
            L_7 = L_6,
            Nodes_5 = nil
    end,
        L_8 = maps:put("head", maps:get("id", N_3, nil), L_7),
        Nodes2 = maps:get("nodes", L_8, nil),
        Nodes2_2 = maps:put(mochi_to_int(maps:get("id", N_3, nil)), N_3, Nodes2),
        L_9 = maps:put("nodes", Nodes2_2, L_8),
        N_3
    catch {return, Ret} -> Ret end.

pushback(L_10, V_3) ->
    try
        N_4 = newnode(L_10, V_3),
        N_5 = maps:put("prev", maps:get("tail", L_10, nil), N_4),
        case (mochi_to_int(maps:get("tail", L_10, nil)) /= 0) of
        true -> Nodes_6 = maps:get("nodes", L_10, nil),
            T = maps:get(mochi_to_int(maps:get("tail", L_10, nil)), Nodes_6, nil),
            T_2 = maps:put("next", maps:get("id", N_5, nil), T),
            Nodes_7 = maps:put(mochi_to_int(maps:get("id", T_2, nil)), T_2, Nodes_6),
            L_11 = maps:put("nodes", Nodes_7, L_10),
            L_13 = L_11,
            Nodes_8 = Nodes_7,
            T_3 = T_2;
        _ -> L_12 = maps:put("head", maps:get("id", N_5, nil), L_10),
            L_13 = L_12,
            Nodes_8 = nil,
            T_3 = nil
    end,
        L_14 = maps:put("tail", maps:get("id", N_5, nil), L_13),
        Nodes2_3 = maps:get("nodes", L_14, nil),
        Nodes2_4 = maps:put(mochi_to_int(maps:get("id", N_5, nil)), N_5, Nodes2_3),
        L_15 = maps:put("nodes", Nodes2_4, L_14),
        N_5
    catch {return, Ret} -> Ret end.

insertbefore(L_16, RefID, V_4) ->
    try
        case (RefID == 0) of
        true -> throw({return, pushfront(L_16, V_4)});
        _ -> ok
    end,
        Nodes_9 = maps:get("nodes", L_16, nil),
        Ref = maps:get(RefID, Nodes_9, nil),
        N_6 = newnode(L_16, V_4),
        ...
        true -> P = maps:get(mochi_to_int(maps:get("prev", Ref, nil)), Nodes_9, nil),
            ...
            Nodes_11 = Nodes_10,
            P_3 = P_2;
        _ -> L_17 = maps:put("head", maps:get("id", N_8, nil), L_16),
            L_18 = L_17,
            Nodes_11 = Nodes_9,
            P_3 = nil
    end,
        ...
        L_19 = maps:put("nodes", Nodes_13, L_18),
        N_8
    catch {return, Ret} -> Ret end.

insertafter(L_20, RefID_2, V_5) ->
    try
        case (RefID_2 == 0) of
        true -> throw({return, pushback(L_20, V_5)});
        _ -> ok
    end,
        Nodes_14 = maps:get("nodes", L_20, nil),
        Ref_3 = maps:get(RefID_2, Nodes_14, nil),
        N_9 = newnode(L_20, V_5),
        ...
        true -> Nx = maps:get(mochi_to_int(maps:get("next", Ref_3, nil)), Nodes_14, nil),
            ...
            Nodes_16 = Nodes_15,
            Nx_3 = Nx_2;
        _ -> L_21 = maps:put("tail", maps:get("id", N_11, nil), L_20),
            L_22 = L_21,
            Nodes_16 = Nodes_14,
            Nx_3 = nil
    end,
        ...
        L_23 = maps:put("nodes", Nodes_18, L_22),
        N_11
    catch {return, Ret} -> Ret end.
...
main() ->
    try
        ...
        E4 = pushback(L_24, 4),
        E1 = pushfront(L_24, 1),
        L_25 = insertbefore(L_24, mochi_to_int(maps:get("id", E4, nil)), 3),
        L_26 = insertafter(L_25, mochi_to_int(maps:get("id", E1, nil)), "two"),
        Id_2 = mochi_to_int(maps:get("head", L_26, nil)),
        Nodes_19 = maps:get("nodes", L_26, nil),
        Fun = fun Fun_loop(E1, E4, Id_2, L_26, Nodes_19) ->
    case (Id_2 /= 0) of
        true ->
            ...
            Fun_loop(E1, E4, Id_3, L_26, Nodes_19);
        _ -> {E1, E4, Id_2, L_26, Nodes_19}
    end
end,
{E1, E4, Id_3, L_26, Nodes_19} = Fun(E1, E4, Id_2, L_26, Nodes_19),
        L_26
    catch {return, Ret} -> Ret end.

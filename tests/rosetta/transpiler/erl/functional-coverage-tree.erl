...
main() ->
    try
        ...
        addchildren(erlang:get('h1_bathrooms'), [erlang:get('h1_bathroom1'), erlang:get('h1_bathroom2'), erlang:get('h1_outside')]),
        addchildren(erlang:get('h1_living_rooms'), [erlang:get('h1_lounge'), erlang:get('h1_dining'), erlang:get('h1_conservatory'), erlang:get('h1_playroom')]),
        addchildren(erlang:get('house1'), [erlang:get('h1_bedrooms'), erlang:get('h1_bathrooms'), erlang:get('h1_attic'), erlang:get('h1_kitchen'), erlang:get('h1_living_rooms'), erlang:get('h1_basement'), erlang:get('h1_garage'), erlang:get('h1_garden')]),
        addchildren(erlang:get('h2_bedrooms'), [erlang:get('h2_suite1'), erlang:get('h2_suite2'), erlang:get('h2_bedroom3'), erlang:get('h2_bedroom4')]),
        addchildren(erlang:get('h2_upstairs'), [erlang:get('h2_bedrooms'), erlang:get('h2_bathroom'), erlang:get('h2_toilet'), erlang:get('h2_attics')]),
        addchildren(erlang:get('h2_living_rooms'), [erlang:get('h2_lounge'), erlang:get('h2_dining'), erlang:get('h2_conservatory'), erlang:get('h2_playroom')]),
        addchildren(erlang:get('h2_groundfloor'), [erlang:get('h2_kitchen'), erlang:get('h2_living_rooms'), erlang:get('h2_wet_room'), erlang:get('h2_garage'), erlang:get('h2_garden'), erlang:get('h2_hot_tub')]),
        addchildren(erlang:get('h2_basement'), [erlang:get('h2_cellars'), erlang:get('h2_wine_cellar'), erlang:get('h2_cinema')]),
        addchildren(erlang:get('house2'), [erlang:get('h2_upstairs'), erlang:get('h2_groundfloor'), erlang:get('h2_basement')]),
        addchildren(Cleaning, [erlang:get('house1'), erlang:get('house2')]),
        ...
        show(Cleaning, 0),
        setcoverage(erlang:get('h2_cinema'), 1),
        ...
        setcoverage(erlang:get('h2_cinema'), 0.75),
        nil
    catch {return, Ret} -> Ret end.

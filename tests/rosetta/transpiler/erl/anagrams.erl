...
main() ->
    ...
    case List of
        ...
        _ -> Groups_3 = maps:put(K, lists:append(maps:get(K, Groups), [W]), Groups),
            ...
            case (length(maps:get(K, Groups_4)) > MaxLen) of
        true -> MaxLen_2 = length(maps:get(K, Groups_4)),
            MaxLen_3 = MaxLen_2;
        _ -> MaxLen_3 = MaxLen
    end,
...
{Groups_4, MaxLen_3, Words} = Fun_8(Words, Groups, MaxLen, Words),
    ...
    case List of
        ...
        [W_2|Fun_9_loop_rest] ->
            K_2 = sortrunes(W_2),
            case (length(maps:get(K_2, Groups_4)) == MaxLen_3) of
        true -> case not maps:is_key(K_2, Printed) of
        true -> G = sortstrings(maps:get(K_2, Groups_4)),

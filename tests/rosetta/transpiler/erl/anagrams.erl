...
main() ->
    ...
    case List of
        ...
        true -> Groups_2 = maps:put(K, [W], Groups),
            Groups_4 = Groups_2;
        _ -> Groups_3 = maps:put(K, lists:append(maps:get(K, Groups), [W]), Groups),
            Groups_4 = Groups_3
    end,
            case (maps:size(maps:get(K, Groups_4)) > MaxLen) of
        true -> MaxLen_2 = maps:size(maps:get(K, Groups_4)),
            MaxLen_3 = MaxLen_2;
        _ -> MaxLen_3 = MaxLen
    end,
            Fun_8_loop(Fun_8_loop_rest, Groups_4, MaxLen_3, Words)
    end
end,
{Groups_4, MaxLen_3, Words} = Fun_8(Words, Groups, MaxLen, Words),
    ...
    case List of
        ...
        [W_2|Fun_9_loop_rest] ->
            K_2 = sortRunes(W_2),
            case (length(lists:nth(K_2 + 1, Groups_4)) == MaxLen_3) of
        true -> case not maps:is_key(K_2, Printed) of
        true -> G = sortStrings(lists:nth(K_2 + 1, Groups_4)),
...
{G, Groups_4, I_8, K_2, Line_2, MaxLen_3, Printed, W_2, Words} = Fun_10(G, Groups_4, I_7, K_2, Line, MaxLen_3, Printed, W_2, Words),
        ...
        _ -> Fun_12 = Fun_8,
            ...
            Fun_9_loop(Fun_9_loop_rest, Groups_4, MaxLen_3, Printed_4, Words)
    end
end,

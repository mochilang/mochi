...
% Generated by Mochi transpiler v0.10.41 (fc5a0aa3f7) on 2025-07-26 19:29 +0700
...
{I_6, Le, S_3, Table_2} = Fun_4(I_5, Le, S_3, Table),
    ...
    case (I_7 < Le) of
        true ->
            Last_2 = (Last ++ string:substr(lists:nth(I_7 + 1, Table_3), (Le - 1) + 1, (Le - (Le - 1)))),
            I_8 = (I_7 + 1),
...
{I_10, Le_2, R, Table_5} = Fun_6(I_9, Le_2, R, Table_4),
    ...
    case (I_11 < Le_2) of
        true ->
            Table_6 = lists:sublist(Table_5, I_11) ++ [(string:substr(R, I_11 + 1, ((I_11 + 1) - I_11)) ++ lists:nth(I_11 + 1, Table_5))] ++ lists:nthtail(I_11 + 1, Table_5),
            I_12 = (I_11 + 1),
...
{I_12, Le_2, N_3, R, Table_7} = Fun_8(I_10, Le_2, N_2, R, Table_5),
    ...
    case (I_13 < Le_2) of
        true ->
            case (string:substr(lists:nth(I_13 + 1, Table_7), (Le_2 - 1) + 1, (Le_2 - (Le_2 - 1))) == "\x03") of
        true -> throw({return, string:substr(lists:nth(I_13 + 1, Table_7), 1 + 1, ((Le_2 - 1) - 1))});
        _ -> ok
    end,
            I_14 = (I_13 + 1),

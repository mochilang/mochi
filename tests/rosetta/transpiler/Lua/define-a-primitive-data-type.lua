...
do
  ...
  function main()
    ...
    print(("t1 + t2 = " .. tostring(Add(t1, t2).value)))
    print(("t1 - t2 = " .. tostring(Sub(t1, t2).value)))
    print(("t1 * t2 = " .. tostring(Mul(t1, t2).value)))
    print(("t1 / t2 = " .. tostring(Div(t1, t2).value)))
    print(("t1 % t2 = " .. tostring(Rem(t1, t2).value)))
    print(("t1 + 1  = " .. tostring(Inc(t1).value)))
    print(("t1 - 1  = " .. tostring(Dec(t1).value)))
  end
  main()

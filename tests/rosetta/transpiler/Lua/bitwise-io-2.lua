...
function readBitsLSB(r, width)
  ...
  function readBitsMSB(r, width)
    ...
    function ReadBits(r, width)
      if (r.order == "LSB") then
        return readBitsLSB((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(r), width)
      end
      return readBitsMSB((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(r), width)
    end;
            ...
            elseif type(v) == 'table' and (v[1] == nil) then
              ...
              function Example()
                ...
                elseif type(v) == 'table' and (v[1] == nil) then
                  ...
                  local result = ""
                  while true do
                    local r = ReadBits((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(br), 7)
                    if r.eof then
                      break
                    end

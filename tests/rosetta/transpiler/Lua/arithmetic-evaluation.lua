...
function skipWS(p)
  ...
  elseif type(v) == 'table' and (v[1] == nil) then
    ...
    end)(p.expr)) and (string.sub(p.expr, i + 1, (i + 1)) == " ")) do
      i = (i + 1)
    end
    p.pos = i
    return p
    ...
    function parseNumber(p)
      ...
      elseif type(v) == 'table' and (v[1] == nil) then
        ...
        elseif type(v) == 'string' or type(v) == 'table' then
          ...
          local ch = string.sub(p.expr, p.pos + 1, (p.pos + 1))
        ...
        local token = string.sub(p.expr, start + 1, p.pos)
      ...
      function parseFactor(p)
        ...
        elseif type(v) == 'table' and (v[1] == nil) then
          ...
          end)(p.expr)) and (string.sub(p.expr, p.pos + 1, (p.pos + 1)) == "(")) then
            p.pos = (p.pos + 1)
            local r = parseExpr(p)
            local v = r.v
            p = r.p
                ...
                while true do
                  ...
                  elseif type(v) == 'table' and (v[1] == nil) then
                    ...
                    elseif type(v) == 'string' or type(v) == 'table' then
                      ...
                      local op = string.sub(p.expr, p.pos + 1, (p.pos + 1))
                      if (op == "*") then
                        p.pos = (p.pos + 1)

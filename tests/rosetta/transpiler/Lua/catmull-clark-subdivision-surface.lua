-- Generated by Mochi v0.10.39 on 2025-07-24 22:44 GMT+7
function input()
  return io.read('*l')
end
local _nil = {}
  ...
  function fmt4(x)
            ...
            elseif type(v) == 'table' and (v[1] == nil) then
              ...
              elseif type(v) == 'table' and (v[1] == nil) then
                ...
                elseif type(v) == 'string' or type(v) == 'table' then
                  ...
                  table.insert(res, item)
                  return res
                end)(merged, {e1[0 + 1], e1[1 + 1], e1[2 + 1], (0 - 1)})
                idx = (idx + 1)
                ::__cont_1::
              end
              local edgesCenters = {}
    ...
    function formatFace(f)
      ...
      elseif type(v) == 'table' and (v[1] == nil) then
        ...
        function main()
          local inputPoints = {{x = (0 - 1), y = 1, z = 1}, {x = (0 - 1), y = (0 - 1), z = 1}, {x = 1, y = (0 - 1), z = 1}, {x = 1, y = 1, z = 1}, {x = 1, y = (0 - 1), z = (0 - 1)}, {x = 1, y = 1, z = (0 - 1)}, {x = (0 - 1), y = (0 - 1), z = (0 - 1)}, {x = (0 - 1), y = 1, z = (0 - 1)}}

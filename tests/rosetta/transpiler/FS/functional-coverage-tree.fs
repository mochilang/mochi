...
and computeCoverage (n: Map<string, obj>) =
    ...
    try
        ...
        for node in cs do
            let m = unbox<Map<string, obj>> node
...
and show (n: Map<string, obj>) (level: int) =
    ...
    with
        | Return -> __ret
let mutable house1 = newNode "house1" 40 0.0
let mutable house2 = newNode "house2" 60 0.0
let mutable h1_bedrooms = newNode "bedrooms" 1 0.25
let mutable h1_bathrooms = newNode "bathrooms" 1 0.0
let mutable h1_attic = newNode "attic" 1 0.75
let mutable h1_kitchen = newNode "kitchen" 1 0.1
let mutable h1_living_rooms = newNode "living_rooms" 1 0.0
let mutable h1_basement = newNode "basement" 1 0.0
let mutable h1_garage = newNode "garage" 1 0.0
let mutable h1_garden = newNode "garden" 1 0.8
let mutable h2_upstairs = newNode "upstairs" 1 0.0
let mutable h2_groundfloor = newNode "groundfloor" 1 0.0
let mutable h2_basement = newNode "basement" 1 0.0
let mutable h1_bathroom1 = newNode "bathroom1" 1 0.5
let mutable h1_bathroom2 = newNode "bathroom2" 1 0.0
let mutable h1_outside = newNode "outside_lavatory" 1 1.0
let mutable h1_lounge = newNode "lounge" 1 0.0
let mutable h1_dining = newNode "dining_room" 1 0.0
let mutable h1_conservatory = newNode "conservatory" 1 0.0
let mutable h1_playroom = newNode "playroom" 1 1.0
let mutable h2_bedrooms = newNode "bedrooms" 1 0.0
let mutable h2_bathroom = newNode "bathroom" 1 0.0
let mutable h2_toilet = newNode "toilet" 1 0.0
let mutable h2_attics = newNode "attics" 1 0.6
let mutable h2_kitchen = newNode "kitchen" 1 0.0
let mutable h2_living_rooms = newNode "living_rooms" 1 0.0
let mutable h2_wet_room = newNode "wet_room_&_toilet" 1 0.0
let mutable h2_garage = newNode "garage" 1 0.0
let mutable h2_garden = newNode "garden" 1 0.9
let mutable h2_hot_tub = newNode "hot_tub_suite" 1 1.0
let mutable h2_cellars = newNode "cellars" 1 1.0
let mutable h2_wine_cellar = newNode "wine_cellar" 1 1.0
let mutable h2_cinema = newNode "cinema" 1 0.75
let mutable h2_suite1 = newNode "suite_1" 1 0.0
let mutable h2_suite2 = newNode "suite_2" 1 0.0
let mutable h2_bedroom3 = newNode "bedroom_3" 1 0.0
let mutable h2_bedroom4 = newNode "bedroom_4" 1 0.0
let mutable h2_lounge = newNode "lounge" 1 0.0
let mutable h2_dining = newNode "dining_room" 1 0.0
let mutable h2_conservatory = newNode "conservatory" 1 0.0
let mutable h2_playroom = newNode "playroom" 1 0.0
let rec main () =
    let mutable __ret : unit = Unchecked.defaultof<unit>
    try
        let __bench_start = _now()
        let __mem_start = System.GC.GetTotalMemory(true)
        let mutable cleaning = newNode "cleaning" 1 0.0

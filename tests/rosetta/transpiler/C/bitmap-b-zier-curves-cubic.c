...
int bezier3(MapSS b, int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4, Pixel p);
int main(void);
...
int main(void) {
    {
        ...
        Anon1 b = newBitmap(400LL, 300LL);
        fillRgb(b, 16773055LL);
        bezier3(b, 20LL, 200LL, 700LL, 50LL, -300LL, 50LL, 380LL, 150LL, pixelFromRgb(4165615LL));

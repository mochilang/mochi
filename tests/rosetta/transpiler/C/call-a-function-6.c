// Generated by Mochi 0.10.32 on 2025-07-31 15:21 +0700
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <malloc.h>
...
int bar(int a, int b, int c) {
    puts(str_concat(str_concat(str_concat(str_concat(str_int(a), ", "), str_int(b)), ", "), str_int(c)));
}

int user_main() {
    const char* args_keys[16] = {};
    int args_vals[16] = {};
    size_t args_len = 0;
    MapSI args = { args_keys, args_vals, args_len };
    map_set_si(args_keys, args_vals, &args_len, "a", 3LL);
    map_set_si(args_keys, args_vals, &args_len, "b", 2LL);
    map_set_si(args_keys, args_vals, &args_len, "c", 1LL);
    bar(map_get_si(args_keys, args_vals, args_len, "a"), map_get_si(args_keys, args_vals, args_len, "b"), map_get_si(args_keys, args_vals, args_len, "c"));
}

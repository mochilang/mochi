// Generated by Mochi 0.10.32 on 2025-08-04 15:16 +0700
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <unistd.h>
...
void printStat(MapSI fs, const char* path);
void user_main();
int main(void);

void printStat(MapSI fs, const char* path) {
    if (contains_str(fs.keys, fs.len, path)) {
        if (map_get_si(fs.keys, fs.vals, fs.len, path)) {

...
(declare cz_branch cz_sb cz_stem cz_y main_animal main_branchChArr main_element main_stemChArr main_yinYang r)
...
(defn -main []
  (doseq [yr [1935 1938 1968 1972 1976]] (do (def r (cz yr animal yinYang element stemChArr branchChArr)) (println (str (str (str (str (str (str (str (str (str (str (str yr) ": ") (:element r)) " ") (:animal r)) ", ") (:yinYang r)) ", Cycle year ") (str (:cycle r))) " ") (:stemBranch r))))))

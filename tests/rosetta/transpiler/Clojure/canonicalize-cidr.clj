...
(defn toBinary [toBinary_n toBinary_bits]
  (try (do (def toBinary_b "") (def toBinary_val toBinary_n) (def toBinary_i 0) (while (< toBinary_i toBinary_bits) (do (def toBinary_b (str (str (mod toBinary_val 2)) toBinary_b)) (def toBinary_val (int (/ toBinary_val 2))) (def toBinary_i (+ toBinary_i 1)))) (throw (ex-info "return" {:v toBinary_b}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e)))))

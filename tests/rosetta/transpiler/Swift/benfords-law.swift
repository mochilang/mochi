// Generated by Mochi transpiler v0.10.41 on 2025-07-26 20:48:24 GMT+7
import Foundation
...
do {
    ...
    func show(_ nums: [Double], _ title: String) {
        ...
        var i: Int = 0
        while (i < 9) {
            let obs = ((counts[i] as! Double) / Double(total))
            var line: String = ((((("  " + _p((i + 1))) + "  ") + String(describing: padFloat3(Double(obs), 9))) + "  ") + String(describing: padFloat3((preds[i] as! Double), 8)))
            print(_p(line))
            i = Int((i + 1))
        }
    }

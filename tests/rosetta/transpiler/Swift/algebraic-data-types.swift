// Generated by Mochi transpiler v0.10.39 on 2025-07-24 20:09:51 GMT+7
import Foundation

func node(_ cl: String, _ le: Any, _ aa: Int, _ ri: Any) -> [String: Any] {
    return (["cl": String(cl), "le": le, "aa": Int(aa), "ri": ri] as [String: Any] as! [String: Any])
}
func treeString(_ t: Any) -> String {
    ...
    return ((((((((("T(" + String((m as! [String: Any])["cl"]!)) + ", ") + String(treeString((m as! [String: Any])["le"]!))) + ", ") + String(String(describing: (m as! [String: Any])["aa"]!))) + ", ") + String(treeString((m as! [String: Any])["ri"]!))) + ")") as! String)
}
func balance(_ t: Any) -> Any {
    ...
    let m = (t as! [String: Any])
    if (String((m as! [String: Any])["cl"]!) != "B") {
        return t
    }
    ...
    != String(describing: nil as Any?)
        ...
        if (String((leMap as! [String: Any])["cl"]!) == "R") {
            ...
            != String(describing: nil as Any?)
                ...
                if (String((leriMap as! [String: Any])["cl"]!) == "R") {
    ...
    != String(describing: nil as Any?)
        ...
        if (String((riMap as! [String: Any])["cl"]!) == "R") {
            ...
            != String(describing: nil as Any?)
                ...
                if (String((ririMap as! [String: Any])["cl"]!) == "R") {
...
func ins(_ tr: Any, _ x: Int) -> Any {
    ...
    == String(describing: nil as Any?)
        ...
        return (node("R", nil, Int(x), nil) as! [String: Any])
    }
    if (Int(x) < ((tr as! [String: Any])["aa"] as! Int)) {
        return balance((node(((tr as! [String: Any])["cl"] as! String), ins((tr as! [String: Any])["le"], Int(x)), ((tr as! [String: Any])["aa"] as! Int), (tr as! [String: Any])["ri"]) as! [String: Any]))
    }
    if (Int(x) > ((tr as! [String: Any])["aa"] as! Int)) {
        return balance((node(((tr as! [String: Any])["cl"] as! String), (tr as! [String: Any])["le"], ((tr as! [String: Any])["aa"] as! Int), ins((tr as! [String: Any])["ri"], Int(x))) as! [String: Any]))
    }
    return tr
}

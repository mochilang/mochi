// Generated by Mochi transpiler v0.10.39 on 2025-07-24 13:20:04 GMT+7
import Foundation
...
func classifySequence(_ k: Int) -> [String: Any] {
    ...
    while true {
        ...
        if (Int(last) == 0) {
            ...
            aliquot = ((("Sociable[" + String(String(describing: (Int(n) - 1)))) + "]") as! String)
        } else if (Int(last) == Int(seq[(Int(n) - 2)])) {
            aliquot = "Aspiring"
        } else if (contains((Array(seq[1..<Int(maxOf(1, ((Int(n) - 2) as! Int)))]) as! [Int]), Int(last)) as! Bool) {
            let idx = Int(indexOf((seq as! [Int]), Int(last)))
            aliquot = ((("Cyclic[" + String(String(describing: ((Int(n) - 1) - Int(idx))))) + "]") as! String)
        ...
        if (String(aliquot) != "") {
            return (["seq": (seq as! [Int]), "aliquot": String(aliquot)] as [String: Any] as! [String: Any])
        }
    }
...
func padLeft(_ n: Int, _ w: Int) -> String {
    ...
    while (Int(((String(s)).count)) < Int(w)) {
...
func padRight(_ s: String, _ w: Int) -> String {
    ...
    var w = w
    var r = String(s)
    while (Int(((String(r)).count)) < Int(w)) {
...
func joinWithCommas(_ seq: [Int]) -> String {
    ...
    while (Int(i) < Int((((seq as! [Int])).count))) {
        s = ((String(s) + String(String(describing: Int(seq[Int(i)])))) as! String)
...
func main() {
    ...
    while (Int(k) <= 10) {
        ...
        print(((((String(padLeft(Int(k), 2)) + ": ") + String(padRight(String((res as! [String: Any])["aliquot"]!), 15))) + " ") + String(joinWithCommas(((res as! [String: Any])["seq"]! as! [Int])))))
        k = ((Int(k) + 1) as! Int)
    }
    print("")
    ...
    while (Int(i) < Int((((s as! [Int])).count))) {
        ...
        print(((((String(padLeft(Int(val), 7)) + ": ") + String(padRight(String((res as! [String: Any])["aliquot"]!), 15))) + " ") + String(joinWithCommas(((res as! [String: Any])["seq"]! as! [Int])))))
        i = ((Int(i) + 1) as! Int)
    }
    print("")
    let big = 15355717786080
    let r = (classifySequence(Int(big)) as! [String: Any])
    print(((((String(String(describing: Int(big))) + ": ") + String(padRight(String((r as! [String: Any])["aliquot"]!), 15))) + " ") + String(joinWithCommas(((r as! [String: Any])["seq"]! as! [Int])))))
}
main()

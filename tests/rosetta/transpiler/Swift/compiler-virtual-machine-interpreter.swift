// Generated by Mochi transpiler v0.10.52 on 2025-08-01 22:07:11 GMT+7
import Foundation
...
func parseProgram(_ src: String) -> [String: Any?] {
    let lines: [String] = (split((src as! String), "\n") as! [String])
    ...
    while (i < Int(((lines).count))) {
        ...
        addrMap[addr] = ((Int(((code).count)) - 1) as! Int)
        i = ((i + 1) as! Int)
    }
...
func runVM(_ prog: [String: Any?]) {
    ...
    while (pc < Int(_len(code))) {
        let inst = ((code as! [Any])[pc] as! Any?)
        let op = ((inst as! [String: Any])["op"] as! Any?)
        let arg = ((inst as! [String: Any])["arg"] as! Any?)
        ...
        if (String(describing: op) == "store") {
            data[arg] = (stack[(Int(((stack).count)) - 1)] as! Int)
            stack = (Array(stack[0..<(Int(((stack).count)) - 1)]) as! [Int])
            pc = ((pc + 1) as! Int)
            continue
        }
        if (String(describing: op) == "fetch") {
            stack = (_append(stack, (data[arg] as! Int)) as! [Int])
            pc = ((pc + 1) as! Int)
            continue
        }
        if (String(describing: op) == "add") {
            stack[(Int(((stack).count)) - 2)] = (((stack[(Int(((stack).count)) - 2)] as! Int) + (stack[(Int(((stack).count)) - 1)] as! Int)) as! Int)
            stack = (Array(stack[0..<(Int(((stack).count)) - 1)]) as! [Int])
            pc = ((pc + 1) as! Int)
            continue
        }
        ...
        if (String(describing: op) == "prts") {
            let s = ((pool as! [Any])[(stack[(Int(((stack).count)) - 1)] as! Int)] as! Any?)
            stack = (Array(stack[0..<(Int(((stack).count)) - 1)]) as! [Int])
...
func split(_ s: String, _ sep: String) -> [String] {
    ...
    while (i < Int(((s).count))) {
        if (((Int(((sep).count)) > 0) && ((i + Int(((sep).count))) <= Int(((s).count)))) && (String(describing: String(Array(String(describing: (s as! String)))[(i as! Int)..<((i + Int(((sep).count))) as! Int)])) == sep)) {
            ...
            cur = ((cur + String(describing: String(Array(String(describing: (s as! String)))[(i as! Int)..<((i + 1) as! Int)]))) as! String)
            i = ((i + 1) as! Int)
        }
    }
    parts = (_append(parts, cur) as! [String])

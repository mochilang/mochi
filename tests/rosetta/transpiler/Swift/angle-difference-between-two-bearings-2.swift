// Generated by Mochi transpiler v0.10.39 on 2025-07-24 20:10:10 GMT+7
import Foundation

func angleDiff(_ b1: Double, _ b2: Double) -> Double {
    let diff = (Double(b2) - Double(b1))
    return ((Double((Double((((Double(diff) % 360.0) + 360.0) + 180.0)) % 360.0)) - 180.0) as! Double)
}

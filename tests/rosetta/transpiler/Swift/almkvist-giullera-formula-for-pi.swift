// Generated by Mochi transpiler v0.10.39 on 2025-07-25 09:15:05 GMT+7
import Foundation
...
func main() {
    ...
    while true {
        ...
        if (n < 10) {
            ...
            var pwStr = String(String(describing: -pw))!

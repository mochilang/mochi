// Generated by Mochi transpiler v0.10.39 on 2025-07-24 21:24:03 GMT+7
import Foundation
...
func bigToString(_ a: [Int]) -> String {
    ...
    var i = ((Int((((a as! [Int])).count)) - 1) as! Int)
    while (Int(i) >= 0) {
        s = ((String(describing: s) + String(describing: String(describing: Int(a[Int(i)])))) as! String)
        i = ((Int(i) - 1) as! Int)
    }
...
func `repeat`(_ ch: String, _ n: Int) -> String {
    ...
    var i = 0
    while (Int(i) < Int(n)) {
        s = ((String(describing: s) + String(describing: ch)) as! String)
        i = ((Int(i) + 1) as! Int)
    }
    return String(describing: s)
}
...
func factorialExp(_ n: Int, _ primes: [Int]) -> [String: Int] {
    ...
    for p in (primes as! [Int]) {
        ...
        m[String(describing: String(describing: p))] = Int(e)
    }
...
func factorSmall(_ x: Int, _ primes: [Int]) -> [String: Int] {
    ...
    var n = Int(x)
    for p in (primes as! [Int]) {
        if ((_num(p) * _num(p)) > (Int(n) as! Double)) {
            break
        }
        var c = 0
        ...
        if (Int(c) > 0) {
            f[String(describing: String(describing: p))] = Int(c)
        }
    }
    if (Int(n) > 1) {
        f[String(describing: String(describing: Int(n)))] = (((f[String(describing: String(describing: Int(n)))] ?? 0 as! Int) + 1) as! Int)
    }
...
func computeIP(_ n: Int, _ primes: [Int]) -> [Int] {
    ...
    for p in (keys as! [Int]) {
        var e = Int(exps[String(describing: String(describing: p))]!)
        var i = 0
        while (Int(i) < Int(e)) {
...
func formatTerm(_ ip: [Int], _ pw: Int) -> String {
    ...
    if (Int(pw) >= Int(((String(describing: s)).count))) {
        var frac = ((String(describing: `repeat`("0", ((Int(pw) - Int(((String(describing: s)).count))) as! Int))) + String(describing: s)) as! String)
        if (Int(((String(describing: frac)).count)) < 33) {
            frac = ((String(describing: frac) + String(describing: `repeat`("0", ((33 - Int(((String(describing: frac)).count))) as! Int)))) as! String)
        }
        return (("0." + String(describing: String(Array(String(describing: frac))[0..<33]))) as! String)
    }
    var intpart = String(describing: String(Array(String(describing: s))[0..<((Int(((String(describing: s)).count)) - Int(pw)) as! Int)]))
    var frac = String(describing: String(Array(String(describing: s))[((Int(((String(describing: s)).count)) - Int(pw)) as! Int)..<Int(((String(describing: s)).count))]))
    if (Int(((String(describing: frac)).count)) < 33) {
        frac = ((String(describing: frac) + String(describing: `repeat`("0", ((33 - Int(((String(describing: frac)).count))) as! Int)))) as! String)
    }
    return (((String(describing: intpart) + ".") + String(describing: String(Array(String(describing: frac))[0..<33]))) as! String)
}
...
func main() {
    ...
    while true {
        ...
        if (Int(n) < 10) {
            let termStr = String(describing: formatTerm((ip as! [Int]), Int(pw)))
            var ipStr = String(describing: bigToString((ip as! [Int])))
            while (Int(((String(describing: ipStr)).count)) < 44) {
                ipStr = ((" " + String(describing: ipStr)) as! String)
            }
            var pwStr = String(describing: String(describing: -Int(pw)))
            while (Int(((String(describing: pwStr)).count)) < 3) {
                pwStr = ((" " + String(describing: pwStr)) as! String)
            }
            var padTerm = String(describing: termStr)
            while (Int(((String(describing: padTerm)).count)) < 35) {
                padTerm = ((String(describing: padTerm) + " ") as! String)
            }
            print(((((((String(describing: String(describing: Int(n))) + "  ") + String(describing: ipStr)) + "  ") + String(describing: pwStr)) + "  ") + String(describing: padTerm)))
        }
    ...
    if (Int(((String(describing: piStr)).count)) <= Int(precision)) {
        piStr = ((String(describing: `repeat`("0", (((Int(precision) - Int(((String(describing: piStr)).count))) + 1) as! Int))) + String(describing: piStr)) as! String)
    }
    var out = (((String(describing: String(Array(String(describing: piStr))[0..<((Int(((String(describing: piStr)).count)) - Int(precision)) as! Int)])) + ".") + String(describing: String(Array(String(describing: piStr))[((Int(((String(describing: piStr)).count)) - Int(precision)) as! Int)..<Int(((String(describing: piStr)).count))]))) as! String)
    print("")
    print("Pi to 70 decimal places is:")
    print(String(describing: out))
}
_ = main()

// Generated by Mochi transpiler v0.10.38 on 2025-07-24 13:13:06 GMT+7
import Foundation
...
func canSpell(_ word: String, _ blks: [String]) -> Bool {
    ...
    let c = String(String(String(String(Array(word)[0..<1]))).lowercased())
    var i = 0
    while (Int(i) < Int((((blks as! [String])).count))) {
        let b = String(blks[Int(i)])
        if ((String(c) == String(String(String(String(Array(b)[0..<1]))).lowercased())) || (String(c) == String(String(String(String(Array(b)[1..<2]))).lowercased()))) {
            ...
            if (canSpell(String(String(Array(word)[1..<Array(word).count])), (rest as! [String])) as! Bool) {
                return true
            }
        }
        i = ((Int(i) + 1) as! Int)
...
func newSpeller(_ blocks: String) -> (String) -> Bool {
    ...
    return { (w: String) -> Bool in (canSpell((w as! String), (bl as! [String])) as! Bool) }
}
func main() {
    ...
    for word in (["A", "BARK", "BOOK", "TREAT", "COMMON", "SQUAD", "CONFUSE"] as! [String]) {
        print(((String(word) + " ") + String(String(describing: (sp((word as! String)) as! Bool)))))
    }
}
main()

// Generated by Mochi transpiler v0.10.39 on 2025-07-24 13:16:20 GMT+7
import Foundation
...
func canSpell(_ word: String, _ blks: [String]) -> Bool {
    ...
    let c = String(lower(String(String(Array(word)[0..<1]))))
    var i = 0
    while (Int(i) < Int((((blks as! [String])).count))) {
        let b = String(blks[Int(i)])
        if ((String(c) == String(lower(String(String(Array(b)[0..<1]))))) || (String(c) == String(lower(String(String(Array(b)[1..<2])))))) {
...
func newSpeller(_ blocks: String) -> Any {
    var blocks = blocks

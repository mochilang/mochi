// Generated by Mochi transpiler v0.10.40 on 2025-07-26 04:59:40 GMT+7
import Foundation
...
do {
    ...
    var x: BigInt = BigInt((pow_big((base as! BigInt), (e2 as! Int)) as! BigInt))
    var s = (String(describing: x) as! String)

// Generated by Mochi transpiler v0.10.39 on 2025-07-24 13:19:25 GMT+7
import Foundation
    ...
    if (Int(pile[Int(y)][Int(x)]) >= 4) {
        ...
        if (Int(y) > 0) {
            ...
            if (Int(pile[(Int(y) - 1)][Int(x)]) >= 4) {
                pile = (handlePile((pile as! [[Int]]), Int(x), ((Int(y) - 1) as! Int)) as! [[Int]])
            }
        }
        if (Int(x) > 0) {
            pile[Int(y)][(Int(x) - 1)] = ((Int(pile[Int(y)][(Int(x) - 1)]) + 1) as! Int)
            if (Int(pile[Int(y)][(Int(x) - 1)]) >= 4) {
                pile = (handlePile((pile as! [[Int]]), ((Int(x) - 1) as! Int), Int(y)) as! [[Int]])
            }
        }
        if (Int(y) < (Int(dim) - 1)) {
            pile[(Int(y) + 1)][Int(x)] = ((Int(pile[(Int(y) + 1)][Int(x)]) + 1) as! Int)
        ...
        pile = (handlePile((pile as! [[Int]]), Int(x), Int(y)) as! [[Int]])
    }
    return (pile as! [[Int]])
}
...
func main() {
    ...
    pile = (handlePile((pile as! [[Int]]), Int(hdim), Int(hdim)) as! [[Int]])
    drawPile((pile as! [[Int]]), 16)
}
main()

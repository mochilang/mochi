// Generated by Mochi transpiler v0.10.40 on 2025-07-26 05:21:46 GMT+7
import Foundation
...
do {
    ...
    func main() {
        ...
        while (i < Int(((vals).count))) {
            ...
            var j = 0
            while (j < 10) {
                line = String(describing: (line + String(describing: pad(Int(vals[(i + j)])))))
                if (j < 9) {

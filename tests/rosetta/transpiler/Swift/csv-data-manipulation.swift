// Generated by Mochi transpiler v0.10.52 on 2025-08-01 22:57:50 GMT+7
import Foundation
...
do {
    ...
    var rows: [[String]] = ([(([("A" as! Any), ("B" as! Any), ("C" as! Any)] as! [String]) as! Any), (([("1" as! Any), ("2" as! Any), ("3" as! Any)] as! [String]) as! Any), (([("4" as! Any), ("5" as! Any), ("6" as! Any)] as! [String]) as! Any), (([("7" as! Any), ("8" as! Any), ("9" as! Any)] as! [String]) as! Any)] as! [[String]])
    rows[0] = (_append((rows[0] as! [String]), "SUM") as! [String])
    var i: Int = 1
    while (i < Int(((rows).count))) {
        var sum: Int = 0
        for s in (rows[i] as! [String]) {
            sum = ((sum + Int(Int(String(describing: (s as! String)))!)) as! Int)
        }

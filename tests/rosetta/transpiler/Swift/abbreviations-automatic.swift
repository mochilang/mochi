// Generated by Mochi transpiler v0.10.39 on 2025-07-25 09:14:12 GMT+7
import Foundation
...
func takeRunes(_ s: String, _ n: Int) -> String {
    ...
    while (idx < Int(((s).count))) {
        if (count == n) {
            return String(describing: String(Array((s as! String))[0..<(idx as! Int)]))
        }
        idx = ((idx + 1) as! Int)
...
func abbrevLen(_ words: [String]) -> Int {
    ...
    while true {
        ...
        var i = 0
        while (i < size) {
            abbrs = ((abbrs + [String(describing: takeRunes(String(describing: words[i]), (l as! Int)))]) as! [String])
            i = ((i + 1) as! Int)
        }
...
func main() {
    ...
    while (i < Int(((lines).count))) {
        let words = (fields(String(describing: lines[i])) as! [String])
        let l = Int(abbrevLen((words as! [String])))
        print(((String(describing: pad2((l as! Int))) + "  ") + String(describing: lines[i])))
        i = ((i + 1) as! Int)
    }
}
_ = main()

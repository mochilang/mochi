// Generated by Mochi transpiler v0.10.39 on 2025-07-24 13:16:04 GMT+7
import Foundation
...
func takeRunes(_ s: String, _ n: Int) -> String {
    ...
    var idx = 0
    var count = 0
    while (Int(idx) < Int(((String(s)).count))) {
        if (Int(count) == Int(n)) {
            return String(String(Array(String(s))[0..<Int(idx)]))
        }
...
func distinct(_ xs: [String]) -> [String] {
    var xs = xs
    var m: [String: Bool] = ([] as [String: Any] as! [String: Bool])
...
func abbrevLen(_ words: [String]) -> Int {
    var words = words
    let size = Int((((words as! [String])).count))
    var l = 1
    while true {
        var abbrs: [String] = ([] as! [String])
        var i = 0
        while (Int(i) < Int(size)) {
            abbrs = (((abbrs as! [String]) + [String(takeRunes(String(words[Int(i)]), Int(l)))]) as! [String])
            i = ((Int(i) + 1) as! Int)
        }
        if (Int((((distinct((abbrs as! [String])) as! [String])).count)) == Int(size)) {
            return Int(l)
        }
        l = ((Int(l) + 1) as! Int)
    }
...
func main() {
    ...
    while (Int(i) < Int((((lines as! [String])).count))) {
        let words = (fields(String(lines[Int(i)])) as! [String])
        let l = Int(abbrevLen((words as! [String])))
        print(((String(pad2(Int(l))) + "  ") + String(lines[Int(i)])))
        i = ((Int(i) + 1) as! Int)
    }
}
main()

// Generated by Mochi transpiler v0.10.39 on 2025-07-24 15:15:11 GMT+7
import Foundation
...
func fields(_ s: String) -> [String] {
    ...
    var cur = ""
    var i = 0
    while (Int(i) < ((String(s)).count)) {
        let ch = String(Array(String(s))[Int(i)..<((Int(i) + 1) as! Int)])
        if (((String(ch) == " ") || (String(ch) == "\n")) || (String(ch) == "\t")) {
            if (((String(cur)).count) > 0) {
...
func takeRunes(_ s: String, _ n: Int) -> String {
    var s = s
    var n = n
    var idx = 0
    var count = 0
    while (Int(idx) < ((String(s)).count)) {
        if (Int(count) == Int(n)) {
            return String(Array(String(s))[0..<Int(idx)])
        }
...
func distinct(_ xs: [String]) -> [String] {
    ...
    var i = 0
    while (Int(i) < (((xs as! [String])).count)) {
        let x = String(xs[Int(i)])
        if (!(((m as! [String: Bool])[String(x)] != nil) as! Bool)) {
            m[String(x)] = true
            out = (((out as! [String]) + [String(x)]) as! [String])
        }
        i = ((Int(i) + 1) as! Int)
    }
    return (out as! [String])
}
func abbrevLen(_ words: [String]) -> Int {
    var words = words
    let size = (((words as! [String])).count)
    var l = 1
    while true {
        var abbrs: [String] = ([] as! [String])
        var i = 0
        while (Int(i) < Int(size)) {
            abbrs = (((abbrs as! [String]) + [takeRunes(String(words[Int(i)]), Int(l))]) as! [String])
            i = ((Int(i) + 1) as! Int)
        }
        if (((distinct((abbrs as! [String]))).count) == Int(size)) {
            return Int(l)
        }
        l = ((Int(l) + 1) as! Int)
    }

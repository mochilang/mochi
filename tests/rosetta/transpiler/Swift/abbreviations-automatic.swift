// Generated by Mochi transpiler v0.10.56 on 2025-08-04 09:52:48 GMT+7
import Foundation
...
do {
    ...
    func takeRunes(_ s: String, _ n: Int) -> String {
        var idx: Int = 0
        var count: Int = 0
        while (idx < Int(((s).count))) {
            if (count == n) {
                return String(describing: String(Array(String(describing: (s as! String)))[0..<Int(idx)]))
            }
            idx = Int((idx &+ 1))
            count = Int((count &+ 1))
        }
    ...
    func distinct(_ xs: [String]) -> [String] {
        ...
        while (i < Int(((xs).count))) {
            let x = (xs[i] as! String)
            if (!(m[x] != nil)) {
                m[String(String(describing: x))] = true
    ...
    func abbrevLen(_ words: [String]) -> Int {
        let size = Int(((words).count))
        var l: Int = 1
        while true {
            var abbrs: [String] = ([] as! [String])
            var i: Int = 0
            while (i < size) {
                abbrs = (_append(abbrs, String(describing: takeRunes((words[i] as! String), Int(l)))) as! [String])
                i = Int((i &+ 1))
            }
            if (Int((((distinct((abbrs as! [String])) as! [String])).count)) == size) {
                return l
            }
            l = Int((l &+ 1))
        }
    ...
    func main() {
        ...
        while (i < Int(((lines).count))) {
            let words: [String] = (fields((lines[i] as! String)) as! [String])
            let l = Int(abbrevLen((words as! [String])))
            print(_p(((String(describing: pad2(Int(l))) + "  ") + (lines[i] as! String))))
            i = Int((i &+ 1))
        }
    }
    _ = main()

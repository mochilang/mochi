// Generated by Mochi transpiler v0.10.39 on 2025-07-24 13:19:31 GMT+7
import Foundation
...
var pps: [Int: Bool] = ([] as [String: Any] as! [Int: Bool])
...
func getAchilles(_ minExp: Int, _ maxExp: Int) -> [Int: Bool] {
    ...
    let upper = Int(pow10(Int(maxExp)))
    var achilles: [Int: Bool] = ([] as [String: Any] as! [Int: Bool])
    var b = 1

// Generated by Mochi transpiler v0.10.40 on 2025-07-25 19:51:02 GMT+7
import Foundation
...
func main() {
    ...
    while (i < Int(((expr).count))) {
        ...
        if ((ch >= "0") && (ch <= "9")) {
            ...
            var j = 0
            while (((digits as! [Any])[j] as! Int) != (Int(_int(ch)) - Int(_int("0")))) {
                j = ((j + 1) as! Int)
            ...
            stack = ((stack + [Double((Int(_int(ch)) - Int(_int("0"))))]) as! [Any])
        } else {

...
do
  ...
  function main()
    ...
    local redEdge = 40
    local nir = 100
    print((((type(("NDVI=" .. tostring(ndvi(red, nir)))) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      return encode(v)
    end)(("NDVI=" .. tostring(ndvi(red, nir))))) or (("NDVI=" .. tostring(ndvi(red, nir))))))
    print((((type(("CCCI=" .. tostring(ccci(red, redEdge, nir)))) == "table")) and (
    (function(v)
    local function encode(x)
    if type(x) == "table" then
      if x.__name and x.__order then
      ...
      return encode(v)
    end)(("CCCI=" .. tostring(ccci(red, redEdge, nir))))) or (("CCCI=" .. tostring(ccci(red, redEdge, nir))))))
    print((((type(("CVI=" .. tostring(cvi(red, green, nir)))) == "table")) and (
    (function(v)
    local function encode(x)
    if type(x) == "table" then
      if x.__name and x.__order then
      ...
      return encode(v)
    end)(("CVI=" .. tostring(cvi(red, green, nir))))) or (("CVI=" .. tostring(cvi(red, green, nir))))))
  end
  main()

...
do
  ...
  function change_brightness(img, level)
    if ((level < (-255)) or (level > 255)) then
    ...
    elseif type(v) == 'table' and (v[1] == nil) then
          ...
          elseif type(v) == 'table' and (v[1] == nil) then
            ...
            elseif type(v) == 'string' then
              ...
              elseif type(v) == 'table' then
                ...
                row_res = (function(lst, item)
                local res = {table.unpack(lst or {})}
                table.insert(res, item)
                return res
              end)(row_res, clamp((img[i + 1][j + 1] + level)))
              j = (j + 1)
            end
      ...
      if type(x) == "table" then
        ...
        return encode(v)
      end)(change_brightness(sample, 30)))
      print(
      (function(v)
      local function encode(x)
      if type(x) == "table" then
        ...
        return encode(v)
      end)(change_brightness(sample, (-60))))

        ...
        elseif type(v) == 'string' then
          ...
          elseif type(v) == 'table' and (v[1] == nil) then
            ...
            elseif type(v) == 'string' then
              ...
              local pad = (k // 2)
              local output = make_matrix(rows, cols, 0)
              local i = 0
              while (i < rows) do
                local j = 0
                while (j < cols) do
                  ...
                  while (ki < k) do
                    ...
                    while (kj < k) do
                      ...
                      local jj = ((j + kj) - pad)
                      local val = 0
                      if ((((ii >= 0) and (ii < rows)) and (jj >= 0)) and (jj < cols)) then
                        val = src[ii + 1][jj + 1]
                      end
                      sum = (sum + (val * kernel[ki + 1][kj + 1]))
                      kj = (kj + 1)
                    end
                    ki = (ki + 1)
                  end
                  ...
                  elseif type(v) == 'table' and (v[1] == nil) then
                    ...
                    elseif type(v) == 'string' then
                      ...
                      elseif type(v) == 'table' then
                        ...
                        row_str = (row_str .. tostring(result[r + 1][c + 1]))
                        if ((c + 1) < (function(v)
                        if type(v) == 'table' and v.items ~= nil then
                          return #v.items
                        elseif type(v) == 'table' and (v[1] == nil) then

  ...
  function gen_gaussian_kernel(k_size, sigma)
    ...
    while (i < k_size) do
      ...
      while (j < k_size) do
        ...
        local value = ((1 / ((2 * PI) * sigma)) * expApprox(exponent))
    ...
    elseif type(v) == 'string' then
      ...
      elseif type(v) == 'table' and (v[1] == nil) then
        ...
        elseif type(v) == 'string' then
          ...
          local dst_height = ((height - k_size) + 1)
          local dst_width = ((width - k_size) + 1)
          local kernel = gen_gaussian_kernel(k_size, sigma)
          local dst = {}
          local i = 0
          while (i < dst_height) do
            ...
            while (j < dst_width) do
              ...
              table.insert(res, item)
              return res
            end)(row, math.floor(tonumber(sum) or 0))
            j = (j + 1)
          end

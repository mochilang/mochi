...
do
  ...
  function change_contrast(img, level)
    local factor = ((259 * (level + 255)) / (255 * (259 - level)))
    local result = {}
    local i = 0
    while (i < (function(v)
          ...
          elseif type(v) == 'table' and (v[1] == nil) then
            ...
            elseif type(v) == 'string' then
              ...
              elseif type(v) == 'table' then
                ...
                local c = row[j + 1]
                local contrasted = math.floor(tonumber((128 + (factor * (c - 128)))) or 0)
                local clamped = (((contrasted < 0)) and (0) or ((((contrasted > 255)) and (255) or (contrasted))))

                          ...
                          elseif type(v) == 'table' and (v[1] == nil) then
                            ...
                            elseif type(v) == 'string' then
                              ...
                              elseif type(v) == 'table' then
                                ...
                                acc = (acc + (kernel[ky + 1][kx + 1] * (1 * pixel)))
                                kx = (kx + 1)
                              end
                              ky = (ky + 1)
                            end
                            ...
                            table.insert(res, item)
                            return res
                          end)(row, math.floor(tonumber(acc) or 0))
                          x = (x + 1)
                        end
                        out = (function(lst, item)
                        local res = {table.unpack(lst or {})}
                                    ...
                                    while (y < h) do
                                      ...
                                      while (x < w) do
                                        ...
                                        while (ky < k) do
                                          local kx = 0
                                          while (kx < k) do
                                            local iy = ((y + ky) - offset)
                                            local ix = ((x + kx) - offset)
                                            local pixel = 0
                                            if ((((iy >= 0) and (iy < h)) and (ix >= 0)) and (ix < w)) then
                                              pixel = img[iy + 1][ix + 1]
                                            end
                                      ...
                                      local sorted = sort_ints(vals)
                                      row = (function(lst, item)
                                      local res = {table.unpack(lst or {})}
                                      table.insert(res, item)
                                      return res
                                    end)(row, sorted[((function(v)
                                    if type(v) == 'table' and v.items ~= nil then
                                      return #v.items
                                    elseif type(v) == 'table' and (v[1] == nil) then
                                        local c = 0
                                            ...
                                            while (x < w) do
                                              ...
                                              while (ky < 3) do
                                                ...
                                                while (kx < 3) do
                                                  ...
                                                  sx = (sx + (gx[ky + 1][kx + 1] * pixel))
                                                  sy = (sy + (gy[ky + 1][kx + 1] * pixel))
                                                  kx = (kx + 1)
                                                end
                                                ky = (ky + 1)
                                              end
                                      ...
                                      elseif type(v) == 'table' and (v[1] == nil) then
                                        ...
                                        elseif type(v) == 'string' then
                                              ...
                                              while (dy <= 1) do
                                                ...
                                                while (dx <= 1) do
                                                  if (not ((dx == 0) and (dy == 0))) then
                                                    ...
                                                    local nx = (x + dx)
                                                    local val = 0
                                                    if ((((ny >= 0) and (ny < h)) and (nx >= 0)) and (nx < w)) then
                                                      val = img[ny + 1][nx + 1]
                                                    end
                                          ...
                                          function local_binary_value(img, x, y)
                                            local center = img[y + 1][x + 1]
                                            local neighbors = get_neighbors_pixel(img, x, y)
                                            local v = 0
                                            local i = 0
                                            while (i < (function(v)
                                            if type(v) == 'table' and v.items ~= nil then
                                                      ...
                                                      elseif type(v) == 'string' then
                                                        ...
                                                        while (y < h) do
                                                          ...
                                                          while (x < w) do
                                                            ...
                                                            table.insert(res, item)
                                                            return res
                                                          end)(row, local_binary_value(img, x, y))
                                                          x = (x + 1)
                                                        end
                                                        out = (function(lst, item)
                                                        local res = {table.unpack(lst or {})}

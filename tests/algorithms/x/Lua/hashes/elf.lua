    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      function bit_not32(x)
        ...
        while (count < 32) do
          ...
          ux = math.floor(tonumber((ux // 2)) or 0)
          bit = (bit * 2)
          count = (count + 1)
        end
        return res
        ...
        elseif type(v) == 'table' and (v[1] == nil) then
          ...
          elseif type(v) == 'string' then
            ...
            elseif type(v) == 'table' then
              ...
              local c = ord(string.sub(data, (i + 1), (i + 1)))
              hash_ = ((hash_ * 16) + c)
              local x = bit_and(hash_, 4026531840)
              if (x ~= 0) then
                hash_ = bit_xor(hash_, math.floor(tonumber((x // 16777216)) or 0))
              end
          ...
          print((((type(tostring(elf_hash("lorem ipsum"))) == "table")) and (
          (function(v)
          ...
          if type(x) == "table" then
            ...
            return encode(v)
          end)(tostring(elf_hash("lorem ipsum")))) or (tostring(elf_hash("lorem ipsum")))))

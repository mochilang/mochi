...
do
  ...
  function bytes_to_hex(bs)
    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      print((((type(bytes_to_hex(_sha256("Python"))) == "table")) and (
      (function(v)
      ...
      if type(x) == "table" then
        ...
        return encode(v)
      end)(bytes_to_hex(_sha256("Python")))) or (bytes_to_hex(_sha256("Python")))))
      print((((type(bytes_to_hex(_sha256("hello world"))) == "table")) and (
      (function(v)
      local function encode(x)
      if type(x) == "table" then
        if x.__name and x.__order then
        ...
        return encode(v)
      end)(bytes_to_hex(_sha256("hello world")))) or (bytes_to_hex(_sha256("hello world")))))

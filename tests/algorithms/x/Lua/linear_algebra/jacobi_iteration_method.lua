    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      elseif type(v) == 'string' then
        ...
        while (i < n) do
          ...
          while (j < n) do
            if (i ~= j) then
              sum = (sum + absf(matrix[i + 1][j + 1]))
            end
            j = (j + 1)
          end
          if (absf(matrix[i + 1][i + 1]) <= sum) then
                      ...
                      elseif type(v) == 'table' and (v[1] == nil) then
                        ...
                        while (k < iterations) do
                          ...
                          while (i < n) do
                            ...
                            while (j < n) do
                              if (i ~= j) then
                                sum = (sum + (coefficient[i + 1][j + 1] * x[j + 1]))
                              end
                              j = (j + 1)
                            end
                            local value = ((constant[i + 1] - sum) / coefficient[i + 1][i + 1])
                            new_x = (function(lst, item)

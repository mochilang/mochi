              ...
              function scalar_mul(s, v)
                ...
                function conjugate_gradient(A, b, max_iterations, tol)
                  ...
                  elseif type(v) == 'table' and (v[1] == nil) then
                    ...
                    print((((type(tostring(x[0 + 1])) == "table")) and (
                    (function(v)
                    ...
                    if type(x) == "table" then
                      ...
                      return encode(v)
                    end)(tostring(x[0 + 1]))) or (tostring(x[0 + 1]))))
                    print((((type(tostring(x[1 + 1])) == "table")) and (
                    (function(v)
                    local function encode(x)
                    if type(x) == "table" then
                      if x.__name and x.__order then
                      ...
                      return encode(v)
                    end)(tostring(x[1 + 1]))) or (tostring(x[1 + 1]))))
                    print((((type(tostring(x[2 + 1])) == "table")) and (
                    (function(v)
                    local function encode(x)
                    if type(x) == "table" then
                      if x.__name and x.__order then
                      ...
                      return encode(v)
                    end)(tostring(x[2 + 1]))) or (tostring(x[2 + 1]))))

  ...
  elseif type(v) == 'table' and (v[1] == nil) then
    ...
    function insert_at_position(ll, position, value)
      ...
      function print_list(ll)
        ...
        while (current ~= (-1)) do
          local node = ll.nodes[current + 1]
          print((((type(tostring(node.data)) == "table")) and (
          (function(v)
          ...
          if type(x) == "table" then
            ...
            return encode(v)
          end)(tostring(node.data))) or (tostring(node.data))))
          current = node.next_index
        end
      end
      function main()
        local ll = empty_list()
        print((((type(tostring(get_head_data(ll))) == "table")) and (
        (function(v)
        local function encode(x)
        if type(x) == "table" then
          if x.__name and x.__order then
          ...
          return encode(v)
        end)(tostring(get_head_data(ll)))) or (tostring(get_head_data(ll)))))
        print((((type(tostring(get_tail_data(ll))) == "table")) and (
        (function(v)
        local function encode(x)
        if type(x) == "table" then
          if x.__name and x.__order then
          ...
          return encode(v)
        end)(tostring(get_tail_data(ll)))) or (tostring(get_tail_data(ll)))))
        print((((type(tostring(is_empty(ll))) == "table")) and (
        (function(v)
        local function encode(x)
        if type(x) == "table" then
          if x.__name and x.__order then
          ...
          return encode(v)
        end)(tostring(is_empty(ll)))) or (tostring(is_empty(ll)))))
        insert(ll, 10)
        print((((type(tostring(get_head_data(ll))) == "table")) and (
        (function(v)
        local function encode(x)
      ...
      elseif type(v) == 'table' and (v[1] == nil) then
        ...
        elseif type(v) == 'table' and (v[1] == nil) then
          ...
          return m[k] ~= nil
        end)(ll, 10)))) or (tostring((function(m, k)
        return m[k] ~= nil
      end)(ll, 10)))))
      delete_value(ll, 10)
      print((((type(tostring((function(m, k)

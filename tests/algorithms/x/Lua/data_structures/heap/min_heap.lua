            ...
            elseif type(v) == 'table' and (v[1] == nil) then
              ...
              elseif type(v) == 'string' then
                ...
                if (smallest ~= i) then
                  ...
                  heap[smallest + 1] = tmp
                  idx_map[heap[i + 1].name + 1] = i
                  idx_map[heap[smallest + 1].name + 1] = smallest
                  i = smallest
                else
                  break
                end
                          ...
                          elseif type(v) == 'table' and (v[1] == nil) then
                            ...
                            elseif type(v) == 'table' and (v[1] == nil) then
                              ...
                              elseif type(v) == 'string' then
                                ...
                                idx_map[node.name + 1] = idx
                                val_map[node.name + 1] = node.val
                                mh.heap = heap
                                mh.idx_of_element = idx_map
                                mh.heap_dict = val_map
                                sift_up(mh, idx)
                              ...
                              function is_empty(mh)
                                ...
                                elseif type(v) == 'table' and (v[1] == nil) then
                                  ...
                                  print((((type(tostring(get_value(my_min_heap, "B"))) == "table")) and (
                                  (function(v)
                                  local function encode(x)
                                  if type(x) == "table" then
                                    if x.__name and x.__order then
                                    ...
                                    return encode(v)
                                  end)(tostring(get_value(my_min_heap, "B")))) or (tostring(get_value(my_min_heap, "B")))))

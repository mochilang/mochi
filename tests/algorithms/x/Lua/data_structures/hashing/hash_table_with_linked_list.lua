...
function hash_function(ht, key)
  ...
  if (res < 0) then
    res = (tostring(res) .. tostring(ht.size_table))
  end
  return res
end
                                  ...
                                  elseif type(v) == 'string' then
                                    ...
                                    elseif type(v) == 'table' and (v[1] == nil) then
                                      ...
                                      function main()
                                        ...
                                        insert(ht, 40)
                                        insert(ht, 50)
                                        print((((type(tostring(ht.values)) == "table")) and (
                                        (function(v)
                                        ...
                                        if type(x) == "table" then
                                          ...
                                          return encode(v)
                                        end)(tostring(ht.values))) or (tostring(ht.values))))
                                        print((((type(tostring(balanced_factor(ht))) == "table")) and (
                                        (function(v)
                                        local function encode(x)
                                        if type(x) == "table" then
                                          if x.__name and x.__order then
                                          ...
                                          return encode(v)
                                        end)(tostring(balanced_factor(ht)))) or (tostring(balanced_factor(ht)))))
                                      end
                                      main()

                                              ...
                                              elseif type(v) == 'table' and (v[1] == nil) then
                                                ...
                                                elseif type(v) == 'string' then
                                                  ...
                                                  elseif type(v) == 'table' then
                                                    ...
                                                    local it = buckets[ind + 1]
                                                    if (it.state == 0) then
                                                      print((((type(("KeyError: " .. tostring(key))) == "table")) and (
                                                      (function(v)
                                                      ...
                                                      if type(x) == "table" then
                                                        ...
                                                        return encode(v)
                                                      end)(("KeyError: " .. tostring(key)))) or (("KeyError: " .. tostring(key)))))
                                                      return
                                                    end
                                                    if ((it.state == 1) and (it.key == key)) then
                                                ...
                                                function hashmap_repr(hm)
                                                  ...
                                                  elseif type(v) == 'table' and (v[1] == nil) then
                                                    ...
                                                    elseif type(v) == 'string' then
                                                      ...
                                                      elseif type(v) == 'table' then
                                                        ...
                                                        if (b.state == 1) then
                                                          ...
                                                          out = (((out .. tostring(b.key)) .. ": ") .. tostring(b.val))
                                                        end
                                                        i = (i + 1)
                                                      end
                                                      out = (out .. ")")
                                                    ...
                                                    print((((type(tostring(hashmap_get(hm, 2))) == "table")) and (
                                                    (function(v)
                                                    local function encode(x)
                                                    if type(x) == "table" then
                                                      if x.__name and x.__order then
                                                      ...
                                                      return encode(v)
                                                    end)(tostring(hashmap_get(hm, 2)))) or (tostring(hashmap_get(hm, 2)))))
                                                    hashmap_del(hm, 1)
                                                    print((((type(hashmap_repr(hm)) == "table")) and (
                                                    (function(v)
                                                    local function encode(x)
                                                    ...
                                                    print((((type(tostring(hashmap_len(hm))) == "table")) and (
                                                    (function(v)
                                                    local function encode(x)
                                                    if type(x) == "table" then
                                                      if x.__name and x.__order then
                                                      ...
                                                      return encode(v)
                                                    end)(tostring(hashmap_len(hm)))) or (tostring(hashmap_len(hm)))))

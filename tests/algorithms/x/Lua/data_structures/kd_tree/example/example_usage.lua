      ...
      elseif type(v) == 'string' then
        ...
        elseif type(v) == 'table' then
          ...
          if (nodes[i + 1].left ~= (0 - 1)) then
            nodes[i + 1] = (nodes[i + 1].left + offset)
          end
          if (nodes[i + 1].right ~= (0 - 1)) then
            nodes[i + 1] = (nodes[i + 1].right + offset)
          end
          i = (i + 1)
        end
        return nodes
                                    ...
                                    elseif type(v) == 'table' and (v[1] == nil) then
                                      ...
                                      elseif type(v) == 'string' then
                                        ...
                                        elseif type(v) == 'table' then
                                          ...
                                          print((((type(("Distance: " .. tostring(res.dist))) == "table")) and (
                                          (function(v)
                                          local function encode(x)
                                          if type(x) == "table" then
                                            if x.__name and x.__order then
                                            ...
                                            return encode(v)
                                          end)(("Distance: " .. tostring(res.dist)))) or (("Distance: " .. tostring(res.dist)))))
                                          print((((type(("Nodes visited: " .. tostring(res.visited))) == "table")) and (
                                          (function(v)
                                          local function encode(x)
                                          if type(x) == "table" then
                                            if x.__name and x.__order then
                                            ...
                                            return encode(v)
                                          end)(("Nodes visited: " .. tostring(res.visited)))) or (("Nodes visited: " .. tostring(res.visited)))))
                                        end
                                        seed = 1
                                        main()

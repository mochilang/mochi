...
do
    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      function find_primitive(modulus)
        ...
        while (r < modulus) do
          ...
          local x = 0
          local valid = true
          while ((x < (modulus - 1)) and valid) do
            local value = mod_pow(r, x, modulus)
            if (function(lst, v)
  ...
  if (primitive_root == (0 - 1)) then
    ...
    print((((type(("The key value generated by A is: " .. tostring(a_secret))) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      return encode(v)
    end)(("The key value generated by A is: " .. tostring(a_secret)))) or (("The key value generated by A is: " .. tostring(a_secret)))))
    print((((type(("The key value generated by B is: " .. tostring(b_secret))) == "table")) and (
    (function(v)
    local function encode(x)
    if type(x) == "table" then
      if x.__name and x.__order then
      ...
      return encode(v)
    end)(("The key value generated by B is: " .. tostring(b_secret)))) or (("The key value generated by B is: " .. tostring(b_secret)))))
  end

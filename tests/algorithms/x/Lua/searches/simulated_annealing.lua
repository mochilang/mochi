      ...
      elseif type(v) == 'table' and (v[1] == nil) then
        ...
        elseif type(v) == 'string' then
          ...
          function main()
            ...
            local min_state = simulated_annealing((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(prob1), test_f1, false, 100, 5, 50, (-5), 100, 0.01, 1)
            ...
            local max_state = simulated_annealing((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(prob2), test_f1, true, 100, 5, 50, (-5), 100, 0.01, 1)
            ...
            local min_state2 = simulated_annealing((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(prob3), test_f2, false, 1000, (-1000), 1000, (-1000), 100, 0.01, 1)
            ...
            local max_state2 = simulated_annealing((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(prob4), test_f2, true, 1000, (-1000), 1000, (-1000), 100, 0.01, 1)

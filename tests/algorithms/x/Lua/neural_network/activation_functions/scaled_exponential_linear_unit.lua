  ...
  elseif type(v) == 'string' then
    ...
    do
      ...
      function scaled_exponential_linear_unit(vector, alpha, lambda_)
        ...
        while (i < _len(vector)) do
          local x = vector[i + 1]
          local y = (((x > 0.0)) and ((lambda_ * x)) or (((lambda_ * alpha) * (exp(x) - 1.0))))
    ...
    if type(x) == "table" then
      ...
      elseif type(x) == "number" then
        ...
        return encode(v)
      end)(scaled_exponential_linear_unit({1.3, 3.7, 2.4}, 1.6732, 1.0507)))
      print(
      (function(v)
      local function encode(x)
      if type(x) == "table" then
        ...
        elseif type(x) == "number" then
          ...
          return encode(v)
        end)(scaled_exponential_linear_unit({1.3, 4.7, 8.2}, 1.6732, 1.0507)))

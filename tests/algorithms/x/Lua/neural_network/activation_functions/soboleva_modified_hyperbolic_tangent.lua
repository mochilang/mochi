...
do
  ...
  function soboleva_modified_hyperbolic_tangent(vector, a_value, b_value, c_value, d_value)
    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      elseif type(v) == 'string' then
        ...
        elseif type(v) == 'table' then
          ...
          local x = vector[i + 1]
          local numerator = (exp((a_value * x)) - exp(((-b_value) * x)))
          local denominator = (exp((c_value * x)) + exp(((-d_value) * x)))
    ...
    function main()
      local vector = {5.4, (-2.4), 6.3, (-5.23), 3.27, 0.56}
      local res = soboleva_modified_hyperbolic_tangent(vector, 0.2, 0.4, 0.6, 0.8)
      ;
      (function(v)

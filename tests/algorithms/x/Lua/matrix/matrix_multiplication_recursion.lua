                  ...
                  function multiply(i, j, k, a, b, result, n, m)
                    ...
                    elseif type(v) == 'table' and (v[1] == nil) then
                      ...
                      elseif type(v) == 'string' then
                        ...
                        result[i + 1][j + 1] = (result[i + 1][j + 1] + (a[i + 1][k + 1] * b[k + 1][j + 1]))
                                  ...
                                  elseif type(v) == 'string' then
                                    ...
                                    elseif type(v) == 'table' and (v[1] == nil) then
                                      ...
                                      elseif type(v) == 'string' then
                                        ...
                                        end)(b)) or (not is_square(a))) or (not is_square(b))) then
                                        ...
                                        elseif type(v) == 'table' and (v[1] == nil) then
                                          ...
                                          if type(x) == "table" then
                                            ...
                                            return encode(v)
                                          end)(matrix_multiply_recursive(matrix_1_to_4, matrix_5_to_8)))
                                          print(
                                          (function(v)
                                          local function encode(x)
                                          if type(x) == "table" then
                                            ...
                                            return encode(v)
                                          end)(matrix_multiply_recursive(matrix_count_up, matrix_unordered)))

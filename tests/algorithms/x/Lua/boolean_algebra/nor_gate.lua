  ...
  function center(s, width)
    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      function make_table_row(i, j)
        local output = nor_gate(i, j)
        return (((((("| " .. center(tostring(i), 8)) .. " | ") .. center(tostring(j), 8)) .. " | ") .. center(tostring(output), 8)) .. " |")
      end
      ...
      print(nor_gate(1, 0))
      print(nor_gate(1, 1))
      print((((type(truth_table()) == "table")) and (
      (function(v)
      ...
      if type(x) == "table" then
        ...
        return encode(v)
      end)(truth_table())) or (truth_table())))

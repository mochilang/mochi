...
do
  ...
  function find_missing_number(nums)
    local low = math.floor((function(lst)
    local m = nil
  ...
  local high = math.floor((function(lst)
  local m = nil
  for _, v in ipairs(lst) do
    if m == nil or v > m then
      m = v
...
elseif type(v) == 'table' and (v[1] == nil) then
  ...
  print((((type(find_missing_number({0, 1, 3, 4})) == "table")) and (
  (function(v)
  ...
  if type(x) == "table" then
    ...
    return encode(v)
  end)(find_missing_number({0, 1, 3, 4}))) or (find_missing_number({0, 1, 3, 4}))))

...
do
  ...
  print((((type(str_result(r1)) == "table")) and (
  (function(v)
  ...
  if type(x) == "table" then
    ...
    return encode(v)
  end)(str_result(r1))) or (str_result(r1))))
  r2 = electric_power(2, 2, 0)
  print((((type(str_result(r2)) == "table")) and (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
    ...
    return encode(v)
  end)(str_result(r2))) or (str_result(r2))))
  r3 = electric_power((-2), 3, 0)
  print((((type(str_result(r3)) == "table")) and (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
    ...
    return encode(v)
  end)(str_result(r3))) or (str_result(r3))))
  r4 = electric_power(2.2, 2.2, 0)
  print((((type(str_result(r4)) == "table")) and (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
    ...
    return encode(v)
  end)(str_result(r4))) or (str_result(r4))))
  r5 = electric_power(2, 0, 6)
  print((((type(str_result(r5)) == "table")) and (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
    ...
    return encode(v)
  end)(str_result(r5))) or (str_result(r5))))

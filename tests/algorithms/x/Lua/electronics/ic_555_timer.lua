...
do
  ...
  function astable_frequency(resistance_1, resistance_2, capacitance)
    if (((resistance_1 <= 0.0) or (resistance_2 <= 0.0)) or (capacitance <= 0.0)) then
  ...
  function astable_duty_cycle(resistance_1, resistance_2)
    if ((resistance_1 <= 0.0) or (resistance_2 <= 0.0)) then
      _panic("All values must be positive")
    end
    return (((resistance_1 + resistance_2) / (resistance_1 + (2.0 * resistance_2))) * 100.0)
  end
  print((((type(astable_frequency(45.0, 45.0, 7.0)) == "table")) and (
  (function(v)
  ...
  if type(x) == "table" then
    ...
    return encode(v)
  end)(astable_frequency(45.0, 45.0, 7.0))) or (astable_frequency(45.0, 45.0, 7.0))))
  print((((type(astable_duty_cycle(45.0, 45.0)) == "table")) and (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
    ...
    return encode(v)
  end)(astable_duty_cycle(45.0, 45.0))) or (astable_duty_cycle(45.0, 45.0))))

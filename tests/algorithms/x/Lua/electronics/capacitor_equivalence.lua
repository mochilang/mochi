    ...
    elseif type(v) == 'table' and (v[1] == nil or v[0] ~= nil) then
      ...
      function capacitor_series(capacitors)
        ...
        elseif type(v) == 'table' and (v[1] == nil or v[0] ~= nil) then
          ...
          function main()
            local parallel = capacitor_parallel({5.71389, 12.0, 3.0})
            local series = capacitor_series({5.71389, 12.0, 3.0})
            print((((type(_str(parallel)) == "table")) and (
            (function(v)
            ...
            if type(x) == "table" then
              ...
              return encode(v)
            end)(_str(parallel))) or (_str(parallel))))
            print((((type(_str(series)) == "table")) and (
            (function(v)
            local function encode(x)
            if type(x) == "table" then
              if x.__name and x.__order then
              ...
              return encode(v)
            end)(_str(series))) or (_str(series))))
          end
          main()

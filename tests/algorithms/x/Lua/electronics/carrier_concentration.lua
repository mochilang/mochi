...
do
  ...
  print((((type(((r1.name .. ", ") .. _str(r1.value))) == "table")) and (
  (function(v)
  ...
  if type(x) == "table" then
    ...
    return encode(v)
  end)(((r1.name .. ", ") .. _str(r1.value)))) or (((r1.name .. ", ") .. _str(r1.value)))))
  r2 = carrier_concentration(0.0, 1600.0, 200.0)
  print((((type(((r2.name .. ", ") .. _str(r2.value))) == "table")) and (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
    ...
    return encode(v)
  end)(((r2.name .. ", ") .. _str(r2.value)))) or (((r2.name .. ", ") .. _str(r2.value)))))
  r3 = carrier_concentration(1000.0, 0.0, 1200.0)
  print((((type(((r3.name .. ", ") .. _str(r3.value))) == "table")) and (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
    ...
    return encode(v)
  end)(((r3.name .. ", ") .. _str(r3.value)))) or (((r3.name .. ", ") .. _str(r3.value)))))

...
do
  ...
  print((((type(((r1.kind .. " ") .. _str(r1.value))) == "table")) and (
  (function(v)
  ...
  if type(x) == "table" then
    ...
    return encode(v)
  end)(((r1.kind .. " ") .. _str(r1.value)))) or (((r1.kind .. " ") .. _str(r1.value)))))
  print((((type(((r2.kind .. " ") .. _str(r2.value))) == "table")) and (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
    ...
    return encode(v)
  end)(((r2.kind .. " ") .. _str(r2.value)))) or (((r2.kind .. " ") .. _str(r2.value)))))
  print((((type(((r3.kind .. " ") .. _str(r3.value))) == "table")) and (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
    ...
    return encode(v)
  end)(((r3.kind .. " ") .. _str(r3.value)))) or (((r3.kind .. " ") .. _str(r3.value)))))

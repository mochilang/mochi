...
do
  ...
  function ind_reactance(inductance, frequency, reactance)
    ...
    if (inductance == 0.0) then
      return {__name = "GenType1", __order = {"inductance"}, inductance = (reactance / ((2.0 * PI) * frequency))}
    end
    if (frequency == 0.0) then
      return {__name = "GenType2", __order = {"frequency"}, frequency = (reactance / ((2.0 * PI) * inductance))}
    end
    return {__name = "GenType3", __order = {"reactance"}, reactance = (((2.0 * PI) * frequency) * inductance)}
  end
  ...
  if type(x) == "table" then
    ...
    return encode(v)
  end)(ind_reactance(0.0, 10000.0, 50.0)))
  print(
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    ...
    return encode(v)
  end)(ind_reactance(0.035, 0.0, 50.0)))
  print(
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    ...
    return encode(v)
  end)(ind_reactance(3.5e-05, 1000.0, 0.0)))

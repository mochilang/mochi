...
function sort_edges(edges)
  ...
  elseif type(v) == 'table' and (v[1] == nil) then
    ...
    function kruskal(g)
      ...
      elseif type(v) == 'table' and (v[1] == nil) then
        ...
        elseif type(v) == 'string' then
          ...
          elseif type(v) == 'table' then
            ...
            added = (added + 1)
            ds = union_set((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(ds), ru, rv)
          end
        end
      ...
      function main()
        local g = new_graph()
        g = add_edge((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(g), 1, 2, 1)
        g = add_edge((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(g), 2, 3, 2)
        g = add_edge((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(g), 3, 4, 1)
        g = add_edge((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(g), 3, 5, 100)
        g = add_edge((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(g), 4, 5, 5)
        local mst = kruskal((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(g))
        print_mst(mst)
      end
      main()

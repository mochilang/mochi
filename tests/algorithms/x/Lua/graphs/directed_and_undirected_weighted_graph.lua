                                              ...
                                              function g_has_cycle_util(g, node, visited, parent)
                                                ...
                                                elseif type(v) == 'table' and (v[1] == nil) then
                                                  ...
                                                  function main()
                                                    ...
                                                    print((((type(tostring(dg_in_degree(dg, 3))) == "table")) and (
                                                    (function(v)
                                                    local function encode(x)
                                                    if type(x) == "table" then
                                                      if x.__name and x.__order then
                                                      ...
                                                      return encode(v)
                                                    end)(tostring(dg_in_degree(dg, 3)))) or (tostring(dg_in_degree(dg, 3)))))
                                                    print((((type(tostring(dg_out_degree(dg, 0))) == "table")) and (
                                                    (function(v)
                                                    local function encode(x)
                                                    if type(x) == "table" then
                                                      if x.__name and x.__order then
                                                      ...
                                                      return encode(v)
                                                    end)(tostring(dg_out_degree(dg, 0)))) or (tostring(dg_out_degree(dg, 0)))))
                                                    print((((type(
                                                    (function(v)
                                                    local function encode(x)
                                                    if type(x) == "table" then
                                                    ...
                                                    print((((type(tostring(dg_has_cycle(dg))) == "table")) and (
                                                    (function(v)
                                                    local function encode(x)
                                                    if type(x) == "table" then
                                                      if x.__name and x.__order then
                                                      ...
                                                      return encode(v)
                                                    end)(tostring(dg_has_cycle(dg)))) or (tostring(dg_has_cycle(dg)))))
                                                    ...
                                                    print((((type(tostring(g_degree(ug, 1))) == "table")) and (
                                                    (function(v)
                                                    local function encode(x)
                                                    if type(x) == "table" then
                                                      if x.__name and x.__order then
                                                      ...
                                                      return encode(v)
                                                    end)(tostring(g_degree(ug, 1)))) or (tostring(g_degree(ug, 1)))))
                                                    print((((type(tostring(g_has_cycle(ug))) == "table")) and (
                                                    (function(v)
                                                    local function encode(x)
                                                    if type(x) == "table" then
                                                      if x.__name and x.__order then
                                                      ...
                                                      return encode(v)
                                                    end)(tostring(g_has_cycle(ug)))) or (tostring(g_has_cycle(ug)))))
                                                  end
                                                  main()

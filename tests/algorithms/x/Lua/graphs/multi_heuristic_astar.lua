                          ...
                          elseif type(v) == 'table' and (v[1] == nil) then
                            ...
                            elseif type(v) == 'string' then
                              ...
                              elseif type(v) == 'table' then
                                ...
                                local p = path[j + 1]
                                print((((type((((("(" .. tostring(p.x)) .. ",") .. tostring(p.y)) .. ")")) == "table")) and (
                                (function(v)
                                ...
                                if type(x) == "table" then
                                  ...
                                  return encode(v)
                                end)((((("(" .. tostring(p.x)) .. ",") .. tostring(p.y)) .. ")"))) or ((((("(" .. tostring(p.x)) .. ",") .. tostring(p.y)) .. ")"))))
                                j = (j + 1)
                              end
                              return
                            end
                              ...
                              elseif type(v) == 'string' then
                                ...
                                elseif type(v) == 'table' then
                                  ...
                                  if (valid(nb) and (in_blocks(nb) == false)) then
                                    ...
                                    local tentative = (g_function[ckey] + 1)

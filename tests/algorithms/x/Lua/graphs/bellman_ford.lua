  ...
  function list_to_string(arr)
    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      elseif type(v) == 'string' then
        ...
        elseif type(v) == 'table' then
          ...
          function check_negative_cycle(graph, distance, edge_count)
            ...
            while (j < edge_count) do
              ...
              local v = e.dst
              local w = e.weight
              if ((distance[u + 1] < INF) and ((distance[u + 1] + w) < distance[v + 1])) then
                return true
              end
              j = (j + 1)
            end
        ...
        distances = bellman_ford(edges, 4, (function(v)
        if type(v) == 'table' and v.items ~= nil then
          return #v.items
        elseif type(v) == 'table' and (v[1] == nil) then
            local c = 0
          ...
          elseif type(v) == 'string' then
            ...
            print((((type(list_to_string(distances)) == "table")) and (
            (function(v)
            ...
            if type(x) == "table" then
              ...
              return encode(v)
            end)(list_to_string(distances))) or (list_to_string(distances))))

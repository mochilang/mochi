...
do
  ...
  print((((type(solve(13, 2)) == "table")) and (
  (function(v)
  ...
  if type(x) == "table" then
    ...
    return encode(v)
  end)(solve(13, 2))) or (solve(13, 2))))
  print((((type(solve(10, 2)) == "table")) and (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
    ...
    return encode(v)
  end)(solve(10, 2))) or (solve(10, 2))))
  print((((type(solve(10, 3)) == "table")) and (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then

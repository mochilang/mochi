...
do
  ...
  if type(x) == "table" then
    ...
    return encode(v)
  end)(combination_sum({2, 3, 5}, 8))) == "table")) and (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
  ...
  if type(x) == "table" then
    ...
    return encode(v)
  end)(combination_sum({2, 3, 5}, 8)))) or (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
  ...
  if type(x) == "table" then
    ...
    return encode(v)
  end)(combination_sum({2, 3, 6, 7}, 7))) == "table")) and (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
  ...
  if type(x) == "table" then
    ...
    return encode(v)
  end)(combination_sum({2, 3, 6, 7}, 7)))) or (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then

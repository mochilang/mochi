          ...
          if vertical then
            ...
            elseif type(v) == 'table' and (v[1] == nil) then
              ...
              elseif type(v) == 'string' then
                ...
                end)(puzzle)) or (puzzle[(row + i) + 1][col + 1] ~= "")) then
                  return false
                end
              else
                if (((col + i) >= (function(v)
                ...
                elseif type(v) == 'table' and (v[1] == nil) then
                  ...
                  elseif type(v) == 'string' then
                    ...
                    end)(puzzle[0 + 1])) or (puzzle[row + 1][(col + i) + 1] ~= "")) then
                      return false
                    end
                  end
                end
                ...
                elseif type(v) == 'table' and (v[1] == nil) then
                  ...
                  elseif type(v) == 'string' then
                    ...
                    elseif type(v) == 'table' then
                      ...
                      if vertical then
                        puzzle[(row + i) + 1][col + 1] = ch
                      else
                        puzzle[row + 1][(col + i) + 1] = ch
                      end
                    end
                  end
                    ...
                    elseif type(v) == 'table' and (v[1] == nil) then
                      ...
                      elseif type(v) == 'string' then
                        ...
                        elseif type(v) == 'table' then
                          ...
                          if vertical then
                            puzzle[(row + i) + 1][col + 1] = ""
                          else
                            puzzle[row + 1][(col + i) + 1] = ""
                          end
                        end
                      end
                      function solve_crossword(puzzle, words, used)
                        for row = 0, (function(v)
                        if type(v) == 'table' and v.items ~= nil then
                          return #v.items
                        elseif type(v) == 'table' and (v[1] == nil) then
                            local c = 0
                                          ...
                                          elseif type(v) == 'table' then
                                            ...
                                            if (not used[i + 1]) then
                                              ...
                                              for _, vertical in ipairs({true, false}) do
                                                if is_valid(puzzle, word, row, col, vertical) then

    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      elseif type(v) == 'string' then
        ...
        elseif type(v) == 'table' then
          ...
          if ((neighbours[i + 1] == 1) and (colored_vertices[i + 1] == color)) then
            return false
          end
          i = (i + 1)
        end
        ...
        elseif type(v) == 'table' and (v[1] == nil) then
          ...
          elseif type(v) == 'string' then
            ...
            while (c < max_colors) do
              if valid_coloring(graph[index + 1], colored_vertices, c) then
                colored_vertices[index + 1] = c
                if util_color(graph, max_colors, colored_vertices, (index + 1)) then
                  return true
                end
                colored_vertices[index + 1] = (-1)
              end
              c = (c + 1)
            end
            return false
            ...
            elseif type(v) == 'table' and (v[1] == nil) then
              ...
              elseif type(v) == 'string' then
                ...
                elseif type(v) == 'table' then
                  ...
                  colored_vertices = (function(lst, item)
                  local res = {table.unpack(lst)}
                  table.insert(res, item)
                  return res
                end)(colored_vertices, (-1))
                i = (i + 1)
              end

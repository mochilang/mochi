...
do
  ...
  function run_tests()
    local r = capture_radii((6.957 * pow10(8)), (1.99 * pow10(30)), 25000)
    if (abs((r - (1.720959069143714 * pow10(10)))) > 1) then
      _panic("capture_radii failed")
    end
    local a = capture_area(r)
    if (abs((a - (9.304455331801812 * pow10(20)))) > 1) then

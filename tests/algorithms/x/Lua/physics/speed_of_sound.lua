...
elseif type(v) == 'boolean' then
  ...
  do
    ...
    print((((type(_str(speed_of_sound_in_a_fluid(998.0, 2.15e+09))) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      elseif type(x) == "number" then
        ...
        return encode(v)
      end)(_str(speed_of_sound_in_a_fluid(998.0, 2.15e+09)))) or (_str(speed_of_sound_in_a_fluid(998.0, 2.15e+09)))))
      print((((type(_str(speed_of_sound_in_a_fluid(13600.0, 2.85e+10))) == "table")) and (
      (function(v)
      local function encode(x)
      if type(x) == "table" then
        if x.__name and x.__order then
        ...
        elseif type(x) == "number" then
          ...
          return encode(v)
        end)(_str(speed_of_sound_in_a_fluid(13600.0, 2.85e+10)))) or (_str(speed_of_sound_in_a_fluid(13600.0, 2.85e+10)))))

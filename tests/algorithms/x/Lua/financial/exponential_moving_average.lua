      ...
      elseif type(v) == 'string' then
        ...
        elseif type(v) == 'table' then
          ...
          if (i <= window_size) then
            ...
            moving_average = ((alpha * price) + ((1 - alpha) * moving_average))
          end
          result = (function(lst, item)
          local res = {table.unpack(lst or {})}
          table.insert(res, item)
          return res
        end)(result, moving_average)
        i = (i + 1)
      end
      return result
    end
    stock_prices = {2, 5, 3, 8.2, 6, 9, 10}
    window_size = 3

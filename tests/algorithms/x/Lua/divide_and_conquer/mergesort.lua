                ...
                elseif type(v) == 'string' then
                  ...
                  elseif type(v) == 'table' and (v[1] == nil) then
                    ...
                    if type(x) == "table" then
                      ...
                      return encode(v)
                    end)(merge_sort({5, 3, 1, 4, 2}))) == "table")) and (
                    (function(v)
                    local function encode(x)
                    if type(x) == "table" then
                      if x.__name and x.__order then
                    ...
                    if type(x) == "table" then
                      ...
                      return encode(v)
                    end)(merge_sort({(-2), 3, (-10), 11, 99, 100000, 100, (-200)}))) == "table")) and (
                    (function(v)
                    local function encode(x)
                    if type(x) == "table" then
                      if x.__name and x.__order then
                    ...
                    if type(x) == "table" then
                      ...
                      return encode(v)
                    end)(merge_sort({(-2), 3, (-10), 11, 99, 100000, 100, (-200)})))) or (
                    (function(v)
                    local function encode(x)
                    if type(x) == "table" then
                      if x.__name and x.__order then
                      ...
                      return encode(v)
                    end)(merge_sort({(-2), 3, (-10), 11, 99, 100000, 100, (-200)})))))
                    print((((type(
                    (function(v)
                    local function encode(x)
                    if type(x) == "table" then

...
function trapezoidal_rule(boundary, steps)
  local h = ((boundary[1 + 1] - boundary[0 + 1]) / steps)
  local a = boundary[0 + 1]
  local b = boundary[1 + 1]
  local xs = make_points(a, b, h)
  local y = ((h / 2) * f(a))
  local i = 0
  while (i < (function(v)
  ...
  elseif type(v) == 'table' and (v[1] == nil) then
    ...
    print((((type(("y = " .. tostring(y))) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      return encode(v)
    end)(("y = " .. tostring(y)))) or (("y = " .. tostring(y)))))

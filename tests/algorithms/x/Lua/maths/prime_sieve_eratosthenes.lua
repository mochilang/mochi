        ...
        elseif type(v) == 'string' then
          ...
          elseif type(v) == 'table' and (v[1] == nil) then
            ...
            function test_prime_sieve_eratosthenes()
              if (not list_eq(prime_sieve_eratosthenes(10), {2, 3, 5, 7})) then
                _panic("test 10 failed")
              end
              if (not list_eq(prime_sieve_eratosthenes(20), {2, 3, 5, 7, 11, 13, 17, 19})) then
                _panic("test 20 failed")
              end
              if (not list_eq(prime_sieve_eratosthenes(2), {2})) then
              ...
              elseif type(v) == 'table' and (v[1] == nil) then
                ...
                elseif type(v) == 'string' then
                  ...
                  end)(prime_sieve_eratosthenes(1)) ~= 0) then
                ...
                function main()
                  ...
                  if type(x) == "table" then
                    ...
                    return encode(v)
                  end)(prime_sieve_eratosthenes(20))) == "table")) and (
                  (function(v)
                  local function encode(x)
                  if type(x) == "table" then
                    if x.__name and x.__order then
                  ...
                  if type(x) == "table" then
                    ...
                    return encode(v)
                  end)(prime_sieve_eratosthenes(20)))) or (
                  (function(v)
                  local function encode(x)
                  if type(x) == "table" then
                    if x.__name and x.__order then
                    ...
                    return encode(v)
                  end)(prime_sieve_eratosthenes(20)))))
                end
                main()

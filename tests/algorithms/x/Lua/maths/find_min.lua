          ...
          function find_min_recursive(nums, left, right)
            ...
            elseif type(v) == 'table' and (v[1] == nil) then
              ...
              function test_find_min()
                local a = {3, 2, 1}
                if (find_min_iterative(a) ~= 1) then
                ...
                elseif type(v) == 'table' and (v[1] == nil) then
                  ...
                  elseif type(v) == 'string' then
                    ...
                    local b = {(-3), (-2), (-1)}
                    if (find_min_iterative(b) ~= (-3)) then
                    ...
                    elseif type(v) == 'table' and (v[1] == nil) then
                      ...
                      elseif type(v) == 'string' then
                        ...
                        local c = {3, (-3), 0}
                        if (find_min_iterative(c) ~= (-3)) then
                        ...
                        elseif type(v) == 'table' and (v[1] == nil) then
                          ...
                          elseif type(v) == 'string' then
                            ...
                            elseif type(v) == 'table' and (v[1] == nil) then
                              ...
                              function main()
                                test_find_min()
                                local sample = {0, 1, 2, 3, 4, 5, (-3), 24, (-56)}
                                print((((type(tostring(find_min_iterative(sample))) == "table")) and (
                                (function(v)
                                ...
                                if type(x) == "table" then
                                  ...
                                  return encode(v)
                                end)(tostring(find_min_iterative(sample)))) or (tostring(find_min_iterative(sample)))))
                              end
                              main()

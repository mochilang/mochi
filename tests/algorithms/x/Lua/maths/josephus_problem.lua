...
do
  ...
  function josephus_recursive(num_people, step_size)
    if ((num_people <= 0) or (step_size <= 0)) then
    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      elseif type(v) == 'string' then
        ...
        elseif type(v) == 'table' then
          ...
          current = (((current + step_size) - 1) % (function(v)
          if type(v) == 'table' and v.items ~= nil then
            return #v.items
          elseif type(v) == 'table' and (v[1] == nil) then
              local c = 0
          ...
          print((((type(tostring(r)) == "table")) and (
          (function(v)
          ...
          if type(x) == "table" then
            ...
            return encode(v)
          end)(tostring(r))) or (tostring(r))))
          print((((type(tostring(find_winner(7, 3))) == "table")) and (
          (function(v)
          local function encode(x)
          if type(x) == "table" then
            if x.__name and x.__order then
            ...
            return encode(v)
          end)(tostring(find_winner(7, 3)))) or (tostring(find_winner(7, 3)))))
          print((((type(tostring(josephus_iterative(7, 3))) == "table")) and (
          (function(v)
          local function encode(x)
          if type(x) == "table" then
            if x.__name and x.__order then
            ...
            return encode(v)
          end)(tostring(josephus_iterative(7, 3)))) or (tostring(josephus_iterative(7, 3)))))

          ...
          elseif type(v) == 'table' and (v[1] == nil) then
            ...
            elseif type(v) == 'string' then
              ...
              elseif type(v) == 'table' then
                ...
                local n = nums[i + 1]
                if weird(n) then
                  print((((type((tostring(n) .. " is weird.")) == "table")) and (
                  (function(v)
                  ...
                  if type(x) == "table" then
                    ...
                    return encode(v)
                  end)((tostring(n) .. " is weird."))) or ((tostring(n) .. " is weird."))))
                else
                  print((((type((tostring(n) .. " is not weird.")) == "table")) and (
                  (function(v)
                  local function encode(x)
                  if type(x) == "table" then
                    if x.__name and x.__order then
                    ...
                    return encode(v)
                  end)((tostring(n) .. " is not weird."))) or ((tostring(n) .. " is not weird."))))
                end
                i = (i + 1)
              end
            end

      ...
      function calculate_entropy(text)
        ...
        elseif type(v) == 'table' and (v[1] == nil) then
          ...
          elseif type(v) == 'string' then
            ...
            print((((type((tostring(round_to_int(first_entropy)) .. ".0")) == "table")) and (
            (function(v)
            ...
            if type(x) == "table" then
              ...
              return encode(v)
            end)((tostring(round_to_int(first_entropy)) .. ".0"))) or ((tostring(round_to_int(first_entropy)) .. ".0"))))
            local total2 = 0
              ...
              elseif type(v) == 'string' then
                ...
                elseif type(v) == 'table' then
                  ...
                  elseif type(v) == 'table' and (v[1] == nil) then
                    ...
                    print((((type((tostring(round_to_int(second_entropy)) .. ".0")) == "table")) and (
                    (function(v)
                    local function encode(x)
                    if type(x) == "table" then
                      if x.__name and x.__order then
                      ...
                      return encode(v)
                    end)((tostring(round_to_int(second_entropy)) .. ".0"))) or ((tostring(round_to_int(second_entropy)) .. ".0"))))
                    local diff = (second_entropy - first_entropy)
                    print((((type((tostring(round_to_int(diff)) .. ".0")) == "table")) and (
                    (function(v)
                    local function encode(x)
                    if type(x) == "table" then
                      if x.__name and x.__order then
                      ...
                      return encode(v)
                    end)((tostring(round_to_int(diff)) .. ".0"))) or ((tostring(round_to_int(diff)) .. ".0"))))
                  end

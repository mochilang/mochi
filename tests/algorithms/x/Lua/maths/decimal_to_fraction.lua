                                    ...
                                    elseif type(v) == 'string' then
                                      ...
                                      elseif type(v) == 'table' and (v[1] == nil) then
                                        ...
                                        elseif type(v) == 'string' then
                                          ...
                                          exp = (exp_sign * math.floor(tonumber(exp_str) or 0))
                                        end
                                        if (idx ~= (function(v)
                                        if type(v) == 'table' and v.items ~= nil then
                                          return #v.items
                                          ...
                                          elseif type(v) == 'string' then
                                            ...
                                            elseif type(v) == 'table' and (v[1] == nil) then
                                              ...
                                              elseif type(v) == 'string' then
                                                ...
                                                local numerator = math.floor(tonumber(num_str) or 0)
                                                if (sign == (0 - 1)) then
                                                ...
                                                elseif type(v) == 'table' and (v[1] == nil) then
                                                  ...
                                                  function decimal_to_fraction_str(s)
                                                    return reduce((function(_t) local _c={} for k,v in pairs(_t) do _c[k]=v end return _c end)(parse_decimal(s)))
                                                  end
                                                  function decimal_to_fraction(x)
                                                    return decimal_to_fraction_str(tostring(x))
                                                  end
                                                  ...
                                                  function main()
                                                    ...
                                                    print((((type(((tostring(fr.numerator) .. "/") .. tostring(fr.denominator))) == "table")) and (
                                                    (function(v)
                                                    ...
                                                    if type(x) == "table" then
                                                      ...
                                                      return encode(v)
                                                    end)(((tostring(fr.numerator) .. "/") .. tostring(fr.denominator)))) or (((tostring(fr.numerator) .. "/") .. tostring(fr.denominator)))))
                                                  end
                                                  main()

...
do
  ...
  function integrand(x, z)
    return (powf(x, (z - 1)) * exp_series((-x)))
  end
  ...
  function gamma_recursive(num)
    ...
    if (not ((absf(frac) < 1e-06) or (absf((frac - 0.5)) < 1e-06))) then
      _panic("num must be an integer or a half-integer")
    end
    if (absf((num - 0.5)) < 1e-06) then
      return sqrt(PI)
    end
    if (absf((num - 1)) < 1e-06) then
      return 1
    end
    return ((num - 1) * gamma_recursive((num - 1)))
  end
  function main()
    print((((type(gamma_iterative(5)) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      return encode(v)
    end)(gamma_iterative(5))) or (gamma_iterative(5))))
    print((((type(gamma_recursive(5)) == "table")) and (
    (function(v)
    local function encode(x)
    if type(x) == "table" then
      if x.__name and x.__order then
      ...
      return encode(v)
    end)(gamma_recursive(5))) or (gamma_recursive(5))))
    print((((type(gamma_recursive(0.5)) == "table")) and (
    (function(v)
    local function encode(x)
    if type(x) == "table" then
      if x.__name and x.__order then
      ...
      return encode(v)
    end)(gamma_recursive(0.5))) or (gamma_recursive(0.5))))
  end

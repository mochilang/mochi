    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      elseif type(v) == 'string' then
        ...
        elseif type(v) == 'table' then
          ...
          res = (res + math.floor(tonumber(string.sub(s, (i + 1), (i + 1))) or 0))
          i = (i + 1)
        end
        return res
      end
      ...
      function main()
        test_sum_of_digits()
        print((((type(tostring(sum_of_digits(12345))) == "table")) and (
        (function(v)
        ...
        if type(x) == "table" then
          ...
          return encode(v)
        end)(tostring(sum_of_digits(12345)))) or (tostring(sum_of_digits(12345)))))
      end
      main()

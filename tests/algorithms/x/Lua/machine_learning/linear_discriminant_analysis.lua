          ...
          elseif type(v) == 'string' then
            ...
            elseif type(v) == 'table' and (v[1] == nil) then
              ...
              elseif type(v) == 'string' then
                ...
                return ((1 / (total_count - n_classes)) * sum_sq)
              end
                            ...
                            elseif type(v) == 'table' and (v[1] == nil) then
                              ...
                              elseif type(v) == 'string' then
                                ...
                                elseif type(v) == 'table' then
                                  ...
                                  local discr = (((x_items[i + 1][j + 1] * (means[k + 1] / variance)) - ((means[k + 1] * means[k + 1]) / (2 * variance))) + ln(probabilities[k + 1]))

                      ...
                      elseif type(v) == 'string' then
                        ...
                        elseif type(v) == 'table' and (v[1] == nil) then
                          ...
                          if type(x) == "table" then
                            ...
                            return encode(v)
                          end)(predict({(-1)}, coeffs))) == "table")) and (
                          (function(v)
                          local function encode(x)
                          if type(x) == "table" then
                            if x.__name and x.__order then
                          ...
                          if type(x) == "table" then
                            ...
                            return encode(v)
                          end)(predict({(-2)}, coeffs))) == "table")) and (
                          (function(v)
                          local function encode(x)
                          if type(x) == "table" then
                            if x.__name and x.__order then
                          ...
                          if type(x) == "table" then
                            ...
                            return encode(v)
                          end)(predict({6}, coeffs))) == "table")) and (
                          (function(v)
                          local function encode(x)
                          if type(x) == "table" then
                            if x.__name and x.__order then

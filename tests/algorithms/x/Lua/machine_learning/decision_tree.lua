                  ...
                  function train_tree(x, y, depth, min_leaf_size)
                    ...
                    elseif type(v) == 'table' and (v[1] == nil) then
                      ...
                      elseif type(v) == 'string' then
                        ...
                        local best_split = 0
                        local min_error = (mean_squared_error(x, mean(y)) * 2)
                        local i = 0
                        while (i < (function(v)
                        if type(v) == 'table' and v.items ~= nil then
                          return #v.items
                  ...
                  elseif type(v) == 'string' then
                    ...
                    elseif type(v) == 'table' and (v[1] == nil) then
                      ...
                      elseif type(v) == 'string' then
                        ...
                        print((((type(("Average error: " .. tostring(avg_error))) == "table")) and (
                        (function(v)
                        local function encode(x)
                        if type(x) == "table" then
                          if x.__name and x.__order then
                          ...
                          return encode(v)
                        end)(("Average error: " .. tostring(avg_error)))) or (("Average error: " .. tostring(avg_error)))))
                      end

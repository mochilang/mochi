          ...
          elseif type(v) == 'table' and (v[1] == nil) then
            ...
            elseif type(v) == 'string' then
              ...
              while (iter < iterations) do
                ...
                local i = 0
                while (i < m) do
                  local z = dot(x[i + 1], theta)
                  local h = sigmoid(z)
                  local k = 0
                  while (k < n) do
                    grad[k + 1] = (grad[k + 1] + ((h - y[i + 1]) * x[i + 1][k + 1]))
                    k = (k + 1)
                  end
                  i = (i + 1)
                end
                local k2 = 0
                while (k2 < n) do
                  theta[k2 + 1] = (theta[k2 + 1] - ((alpha * grad[k2 + 1]) / m))
                  k2 = (k2 + 1)
                end
                iter = (iter + 1)
              end
            ...
            elseif type(v) == 'table' and (v[1] == nil) then
              ...
              elseif type(v) == 'string' then
                ...
                elseif type(v) == 'table' then
                  ...
                  print((((type(theta[i + 1]) == "table")) and (
                  (function(v)

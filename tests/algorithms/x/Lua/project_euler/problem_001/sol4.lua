...
elseif type(v) == 'table' and (v[1] == nil or v[0] ~= nil) then
  ...
  elseif type(v) == 'boolean' then
    ...
    local collection = {}
    local i = 0
    while (i < _len(zmulti)) do
      local v = zmulti[i + 1]
      if (not contains(collection, v)) then
        collection = (function(lst, item)
        local res = {table.unpack(lst or {})}
        res[#res+1] = item
        return res
      end)(collection, v)
...
local total = 0
i = 0
while (i < _len(collection)) do
  total = (total + collection[i + 1])
  i = (i + 1)
end
return total
end
...
function main()
  test_solution()
  print((((type(("solution() = " .. _str(solution(1000)))) == "table")) and (
  (function(v)
  ...
  if type(x) == "table" then
    ...
    elseif type(x) == "number" then
      ...
      return encode(v)
    end)(("solution() = " .. _str(solution(1000))))) or (("solution() = " .. _str(solution(1000))))))
  end
  main()

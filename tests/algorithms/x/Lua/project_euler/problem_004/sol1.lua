    ...
    elseif type(v) == 'boolean' then
      ...
      do
        ...
        function is_palindrome(num)
          ...
          local j = (_len(s) - 1)
          while (i < j) do
            if (string.sub(s, (i + 1), (i + 1)) ~= string.sub(s, (j + 1), (j + 1))) then
              return false
            end
            i = (i + 1)
            j = (j - 1)
            ...
            if is_palindrome(number) then
              ...
              while (divisor > 99) do
                if ((number % divisor) == 0) then
                  local other = (number // divisor)
                  if (_len(_str(other)) == 3) then
                    return number
                  end
                end
                divisor = (divisor - 1)
        ...
        print((((type(("solution() = " .. _str(solution(998001)))) == "table")) and (
        (function(v)
        ...
        if type(x) == "table" then
          ...
          elseif type(x) == "number" then
            ...
            return encode(v)
          end)(("solution() = " .. _str(solution(998001))))) or (("solution() = " .. _str(solution(998001))))))

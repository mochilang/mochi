...
do
  ...
  function solution(nth)
    local count = 0
    local number = 1
    while ((count ~= nth) and (number < 3)) do
      number = (number + 1)
  ...
  function main()
    print((((type(("solution() = " .. _str(solution(10001)))) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      return encode(v)
    end)(("solution() = " .. _str(solution(10001))))) or (("solution() = " .. _str(solution(10001))))))
  end
  main()

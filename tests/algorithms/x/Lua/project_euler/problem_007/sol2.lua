  ...
  elseif type(v) == 'string' then
    ...
    elseif type(v) == 'boolean' then
      ...
      do
        ...
        return primes[(_len(primes) - 1) + 1]
      end
      ans = solution(10001)
      print((((type(("solution(10001) = " .. _str(ans))) == "table")) and (
      (function(v)
      ...
      if type(x) == "table" then
        ...
        elseif type(x) == "number" then
          ...
          return encode(v)
        end)(("solution(10001) = " .. _str(ans)))) or (("solution(10001) = " .. _str(ans)))))

...
do
  ...
  print((((type(("Total count for quantum fourier transform state is: " ..
  (function(v)
  ...
  if type(x) == "table" then
    ...
    return encode(v)
  end)(quantum_fourier_transform(3)))) == "table")) and (
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
    ...
    return encode(v)
  end)(("Total count for quantum fourier transform state is: " ..
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
    ...
    return encode(v)
  end)(quantum_fourier_transform(3))))) or (("Total count for quantum fourier transform state is: " ..
  (function(v)
  local function encode(x)
  if type(x) == "table" then
    if x.__name and x.__order then
    ...
    return encode(v)
  end)(quantum_fourier_transform(3))))))

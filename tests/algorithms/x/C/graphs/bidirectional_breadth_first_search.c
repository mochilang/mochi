...
static size_t map_get_slen(const char *keys[], const size_t lens[], size_t len, const char *key) {
    for (size_t i = 0; i < len; i++) {
        ...
        while (i < neigh_f_len) {
            ...
            if (!(contains_str(visited_f.keys, visited_f.len, npos))) {
                ...
                if (contains_str(visited_b.keys, visited_b.len, npos)) {
                    const char* *rev = reverse_list(map_get_sl(visited_b.keys, visited_b.vals, visited_b.lens, visited_b.len, npos, NULL), map_get_slen(visited_b.keys, visited_b.lens, visited_b.len, npos));
        ...
        while (j < neigh_b_len) {
            ...
            if (!(contains_str(visited_b.keys, visited_b.len, nposb))) {
                ...
                if (contains_str(visited_f.keys, visited_f.len, nposb)) {
                    ...
                    size_t path_f_len = map_get_slen(visited_f.keys, visited_f.lens, visited_f.len, nposb);

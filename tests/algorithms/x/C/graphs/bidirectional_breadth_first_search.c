...
static size_t map_get_sl_len(const char *keys[], const size_t lens[], size_t len, const char *key) {
    for (size_t i = 0; i < len; i++) {
...
const char* * bfs(const char* start, const char* goal) {
    ...
    long long head = 0LL;
    static const char* visited_keys[17] = {"start"};
    static int visited_vals[17] = {1LL};
...
const char* * bidirectional_bfs(const char* start, const char* goal) {
    ...
    static const char* visited_f_keys[17] = {"start"};
    const char* visited_f_vals_0[1] = {start};
    static void* visited_f_vals[17];
    visited_f_vals[0] = visited_f_vals_0;
    static size_t visited_f_lens[17] = {1};
    size_t visited_f_len = 1;
    MapSL visited_f = { visited_f_keys, visited_f_vals, visited_f_lens, 1, 17 };
    static const char* visited_b_keys[17] = {"goal"};
    const char* visited_b_vals_0[1] = {goal};
    static void* visited_b_vals[17];
    visited_b_vals[0] = visited_b_vals_0;
    static size_t visited_b_lens[17] = {1};
        ...
        while (i < neigh_f_len) {
            ...
            if (!(contains_str(visited_f.keys, visited_f.len, npos))) {
                ...
                if (contains_str(visited_b.keys, visited_b.len, npos)) {
                    const char* *rev = reverse_list(map_get_sl(visited_b.keys, visited_b.vals, visited_b.lens, visited_b.len, npos, NULL), map_get_sl_len(visited_b.keys, visited_b.lens, visited_b.len, npos));
        ...
        while (j < neigh_b_len) {
            ...
            if (!(contains_str(visited_b.keys, visited_b.len, nposb))) {
                ...
                if (contains_str(visited_f.keys, visited_f.len, nposb)) {
                    ...
                    size_t path_f_len = map_get_sl_len(visited_f.keys, visited_f.lens, visited_f.len, nposb);

...
int main(void) {
    {
        ...
        puts(str_float(terminal_velocity(1.0, 25.0, 0.6, 0.77)));
        puts(str_float(terminal_velocity(2.0, 100.0, 0.45, 0.23)));
        puts(str_float(terminal_velocity(5.0, 50.0, 0.2, 0.5)));

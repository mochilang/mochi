...
double data_0[2] = {2.5, 2.4};
double data_1[2] = {0.5, 0.7};
double data_2[2] = {2.2, 2.9};
double data_3[2] = {1.9, 2.2};
double data_4[2] = {3.1, 3LL};
double data_5[2] = {2.3, 2.7};
double data_6[2] = {2LL, 1.6};
double data_7[2] = {1LL, 1.1};
double data_8[2] = {1.5, 1.6};
double data_9[2] = {1.1, 0.9};
double *data_init[10] = {data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7, data_8, data_9};
double **data = data_init;
size_t data_len = 10;
size_t data_lens_init[10] = {2, 2, 2, 2, 2, 2, 2, 2, 2, 2};
size_t *data_lens = data_lens_init;
size_t data_lens_len = 10;
PCAResult result;
long long idx = 0LL;
...
double * * standardize(double * * data, size_t data_len, size_t* data_lens, size_t data_lens_len) {
    ...
    long long n_features = data_lens[(int)(0LL)];
    double *means = NULL;
    size_t means_len = 0;
    double *stds = NULL;
    size_t stds_len = 0;
    ...
    while (j < n_features) {
        ...
        long long i = 0LL;
        while (i < n_samples) {
            column = list_append_double(column, &column_len, data[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? data_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? data_lens[(int)(i)] + _mochi_idx : _mochi_idx;})]);
            i = i + 1LL;
        }
...
double * * covariance_matrix(double * * data, size_t data_len, size_t* data_lens, size_t data_lens_len) {
    ...
    while (i < n_features) {
        ...
        while (j < n_features) {
            ...
            long long k = 0LL;
            while (k < n_samples) {
                sum = sum + (data[(int)({long long _mochi_idx = k; _mochi_idx < 0 ? data_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = i; _mochi_idx < 0 ? data_lens[(int)(k)] + _mochi_idx : _mochi_idx;})] * data[(int)({long long _mochi_idx = k; _mochi_idx < 0 ? data_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? data_lens[(int)(k)] + _mochi_idx : _mochi_idx;})]);
                k = k + 1LL;
            }
...
Eigen eigen_decomposition_2x2(double * * matrix, size_t matrix_len, size_t* matrix_lens, size_t matrix_lens_len) {
    double a = matrix[(int)({long long _mochi_idx = 0LL; _mochi_idx < 0 ? matrix_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = 0LL; _mochi_idx < 0 ? matrix_lens[(int)(0LL)] + _mochi_idx : _mochi_idx;})];
    double b = matrix[(int)({long long _mochi_idx = 0LL; _mochi_idx < 0 ? matrix_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = 1LL; _mochi_idx < 0 ? matrix_lens[(int)(0LL)] + _mochi_idx : _mochi_idx;})];
    double c = matrix[(int)({long long _mochi_idx = 1LL; _mochi_idx < 0 ? matrix_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = 1LL; _mochi_idx < 0 ? matrix_lens[(int)(1LL)] + _mochi_idx : _mochi_idx;})];
    double diff = a - c;
    double discriminant = sqrt((diff * diff) + ((4LL * b) * b));
    double lambda1 = ((a + c) + discriminant) / 2LL;
    double lambda2 = ((a + c) - discriminant) / 2LL;
    double *v1 = NULL;
    size_t v1_len = 0;
    double *v2 = NULL;
    size_t v2_len = 0;
    if (b != 0LL) {
        ...
        v1 = (long long[]){1LL, 0LL};
        v1_len = 2;
        v2 = (long long[]){0LL, 1LL};
        v2_len = 2;
    }
    ...
    eigenvectors = list_append_doubleptr(eigenvectors, &eigenvectors_len, v1);
    eigenvectors_lens = list_append_szt(eigenvectors_lens, &eigenvectors_lens_len, v1_len);
    eigenvectors = list_append_doubleptr(eigenvectors, &eigenvectors_len, v2);
    eigenvectors_lens = list_append_szt(eigenvectors_lens, &eigenvectors_lens_len, v2_len);
    if (eigenvalues[(int)({long long _mochi_idx = 0LL; _mochi_idx < 0 ? eigenvalues_len + _mochi_idx : _mochi_idx;})] < eigenvalues[(int)({long long _mochi_idx = 1LL; _mochi_idx < 0 ? eigenvalues_len + _mochi_idx : _mochi_idx;})]) {
        ...
        size_t tmp_vec_len = eigenvectors_lens[(int)(0LL)];
...
double * * transpose(double * * matrix, size_t matrix_len, size_t* matrix_lens, size_t matrix_lens_len) {
    ...
    while (i < cols) {
        ...
        long long j = 0LL;
        while (j < rows) {
            row = list_append_double(row, &row_len, matrix[(int)({long long _mochi_idx = j; _mochi_idx < 0 ? matrix_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = i; _mochi_idx < 0 ? matrix_lens[(int)(j)] + _mochi_idx : _mochi_idx;})]);
            j = j + 1LL;
        }
...
double * * matrix_multiply(double * * a, size_t a_len, size_t* a_lens, size_t a_lens_len, double * * b, size_t b_len, size_t* b_lens, size_t b_lens_len) {
    ...
    long long cols_a = a_lens[(int)(0LL)];
    long long rows_b = b_len;
    long long cols_b = b_lens[(int)(0LL)];
    if (cols_a != rows_b) {
...
int main(void) {
    {
        ...
        while (idx < 5LL) {
            puts(str_list_double(result.transformed[(int)({long long _mochi_idx = idx; _mochi_idx < 0 ? result.transformed_len + _mochi_idx : _mochi_idx;})], result.transformed_lens[idx]));
            idx = idx + 1LL;
        }

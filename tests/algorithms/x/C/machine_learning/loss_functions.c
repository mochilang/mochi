...
double binary_focal_cross_entropy(double * y_true, size_t y_true_len, double * y_pred, size_t y_pred_len, double gamma, double alpha, double epsilon) {
    ...
    while (i < y_true_len) {
        double yt = y_true[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? y_true_len + _mochi_idx : _mochi_idx;})];
        double yp = clip(y_pred[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? y_pred_len + _mochi_idx : _mochi_idx;})], epsilon, 1.0 - epsilon);
        double term1 = ((alpha * user_powf(1.0 - yp, gamma)) * yt) * ln(yp);
        double term2 = (((1.0 - alpha) * user_powf(yp, gamma)) * (1.0 - yt)) * ln(1.0 - yp);
...
double categorical_cross_entropy(double * * y_true, size_t y_true_len, size_t* y_true_lens, size_t y_true_lens_len, double * * y_pred, size_t y_pred_len, size_t* y_pred_lens, size_t y_pred_lens_len, double epsilon) {
    ...
    long long i = 0LL;
    while (i < rows) {
        if (y_true_lens[i] != y_pred_lens[i]) {
            panic("Input arrays must have the same shape.");
        }
        double sum_true = 0.0;
        double sum_pred = 0.0;
        long long j = 0LL;
        while (j < y_true_lens[i]) {
            double yt = y_true[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? y_true_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? y_true_lens[i] + _mochi_idx : _mochi_idx;})];
            double yp = y_pred[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? y_pred_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? y_pred_lens[i] + _mochi_idx : _mochi_idx;})];
            if ((yt != 0.0) && (yt != 1.0)) {
        ...
        j = 0LL;
        while (j < y_true_lens[i]) {
            double yp = clip(y_pred[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? y_pred_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? y_pred_lens[i] + _mochi_idx : _mochi_idx;})], epsilon, 1.0);
            total = total - (y_true[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? y_true_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? y_true_lens[i] + _mochi_idx : _mochi_idx;})] * ln(yp));
            j = j + 1LL;
        }
        i = i + 1LL;
    }
...
double categorical_focal_cross_entropy(double * * y_true, size_t y_true_len, size_t* y_true_lens, size_t y_true_lens_len, double * * y_pred, size_t y_pred_len, size_t* y_pred_lens, size_t y_pred_lens_len, double * alpha, size_t alpha_len, double gamma, double epsilon) {
    ...
    long long rows = y_true_len;
    long long cols = y_true_lens[0LL];
    double *a = alpha;
    ...
    if (a_len == 0LL) {
        ...
        long long j = 0LL;
        while (j < cols) {
            tmp = list_append_long_long(tmp, &tmp_len, 1.0);
            j = j + 1LL;
        }
        a = tmp;
        a_len = tmp_len;
    ...
    long long i = 0LL;
    while (i < rows) {
        if ((y_true_lens[i] != cols) || (y_pred_lens[i] != cols)) {
            panic("Shape of y_true and y_pred must be the same.");
        }
        double sum_true = 0.0;
        double sum_pred = 0.0;
        ...
        while (j < cols) {
            double yp = clip(y_pred[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? y_pred_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? y_pred_lens[i] + _mochi_idx : _mochi_idx;})], epsilon, 1.0);
            row_loss = row_loss + (((a[(int)({long long _mochi_idx = j; _mochi_idx < 0 ? a_len + _mochi_idx : _mochi_idx;})] * user_powf(1.0 - yp, gamma)) * y_true[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? y_true_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? y_true_lens[i] + _mochi_idx : _mochi_idx;})]) * ln(yp));
            j = j + 1LL;
        }
...
double mean_squared_logarithmic_error(double * y_true, size_t y_true_len, double * y_pred, size_t y_pred_len) {
    ...
    long long i = 0LL;
    while (i < y_true_len) {
        double a = ln(1.0 + y_true[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? y_true_len + _mochi_idx : _mochi_idx;})]);
        double b = ln(1.0 + y_pred[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? y_pred_len + _mochi_idx : _mochi_idx;})]);
        double diff = a - b;
...
double perplexity_loss(long long * * y_true, size_t y_true_len, size_t* y_true_lens, size_t y_true_lens_len, double * * * y_pred, size_t y_pred_len, size_t* y_pred_lens, size_t y_pred_lens_len, double epsilon) {
    ...
    long long sentence_len = y_true_lens[0LL];
    if (sentence_len != y_pred_lens[0LL]) {
    ...
    while (b < batch) {
        if ((y_true_lens[b] != sentence_len) || (y_pred_lens[b] != sentence_len)) {
            panic("Sentence length of y_true and y_pred must be equal.");
        }
        double sum_log = 0.0;
        long long j = 0LL;
        while (j < sentence_len) {
            long long label = y_true[(int)({long long _mochi_idx = b; _mochi_idx < 0 ? y_true_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? y_true_lens[b] + _mochi_idx : _mochi_idx;})];
            if (label >= vocab_size) {
                panic("Label value must not be greater than vocabulary size.");
            }
            double prob = clip(y_pred[(int)({long long _mochi_idx = b; _mochi_idx < 0 ? y_pred_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? y_pred_lens[b] + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = label; _mochi_idx < 0 ? 0 + _mochi_idx : _mochi_idx;})], epsilon, 1.0);
...
double kullback_leibler_divergence(double * y_true, size_t y_true_len, double * y_pred, size_t y_pred_len) {
    ...
    long long i = 0LL;
    while (i < y_true_len) {
        total = total + (y_true[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? y_true_len + _mochi_idx : _mochi_idx;})] * ln(y_true[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? y_true_len + _mochi_idx : _mochi_idx;})] / y_pred[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? y_pred_len + _mochi_idx : _mochi_idx;})]));
        i = i + 1LL;
    }
    return total;
}
...
const char* user_main() {
    long long *y_true_bc = NULL;
    size_t y_true_bc_len = 0;
    y_true_bc = list_append_long_long(y_true_bc, &y_true_bc_len, 0.0);
    y_true_bc = list_append_long_long(y_true_bc, &y_true_bc_len, 1.0);
    y_true_bc = list_append_long_long(y_true_bc, &y_true_bc_len, 1.0);
    y_true_bc = list_append_long_long(y_true_bc, &y_true_bc_len, 0.0);
    y_true_bc = list_append_long_long(y_true_bc, &y_true_bc_len, 1.0);
    ...
    long long *y_true_hinge = NULL;
    size_t y_true_hinge_len = 0;
    y_true_hinge = list_append_long_long(y_true_hinge, &y_true_hinge_len, -(1.0));
    y_true_hinge = list_append_long_long(y_true_hinge, &y_true_hinge_len, 1.0);
    y_true_hinge = list_append_long_long(y_true_hinge, &y_true_hinge_len, 1.0);
    y_true_hinge = list_append_long_long(y_true_hinge, &y_true_hinge_len, -(1.0));
    y_true_hinge = list_append_long_long(y_true_hinge, &y_true_hinge_len, 1.0);
    ...
    int *y_true_huber = NULL;
    size_t y_true_huber_len = 0;
    y_true_huber = list_append_int(y_true_huber, &y_true_huber_len, 0.9);
    y_true_huber = list_append_int(y_true_huber, &y_true_huber_len, 10.0);
    y_true_huber = list_append_int(y_true_huber, &y_true_huber_len, 2.0);
    y_true_huber = list_append_int(y_true_huber, &y_true_huber_len, 1.0);
    y_true_huber = list_append_int(y_true_huber, &y_true_huber_len, 5.2);

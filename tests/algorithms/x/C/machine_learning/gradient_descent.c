...
DataPoint *train_data = NULL;
size_t train_data_len = 0;
DataPoint *test_data = NULL;
size_t test_data_len = 0;
double *parameter_vector = NULL;
size_t parameter_vector_len = 0;
...
int main(void) {
    {
        ...
        train_data = ({DataPoint *tmp = malloc(5 * sizeof(DataPoint)); tmp[0] = (DataPoint){.x = ({double *tmp = malloc(3 * sizeof(double)); tmp[0] = 5.0; tmp[1] = 2.0; tmp[2] = 3.0; tmp;}), .x_len = 3, .y = 15.0}; tmp[1] = (DataPoint){.x = ({double *tmp = malloc(3 * sizeof(double)); tmp[0] = 6.0; tmp[1] = 5.0; tmp[2] = 9.0; tmp;}), .x_len = 3, .y = 25.0}; tmp[2] = (DataPoint){.x = ({double *tmp = malloc(3 * sizeof(double)); tmp[0] = 11.0; tmp[1] = 12.0; tmp[2] = 13.0; tmp;}), .x_len = 3, .y = 41.0}; tmp[3] = (DataPoint){.x = ({long long *tmp = malloc(3 * sizeof(long long)); tmp[0] = 1.0; tmp[1] = 1.0; tmp[2] = 1.0; tmp;}), .x_len = 3, .y = 8.0}; tmp[4] = (DataPoint){.x = ({double *tmp = malloc(3 * sizeof(double)); tmp[0] = 11.0; tmp[1] = 12.0; tmp[2] = 13.0; tmp;}), .x_len = 3, .y = 41.0}; tmp;});
        train_data_len = 5;
        test_data = ({DataPoint *tmp = malloc(2 * sizeof(DataPoint)); tmp[0] = (DataPoint){.x = ({double *tmp = malloc(3 * sizeof(double)); tmp[0] = 515.0; tmp[1] = 22.0; tmp[2] = 13.0; tmp;}), .x_len = 3, .y = 555.0}; tmp[1] = (DataPoint){.x = ({double *tmp = malloc(3 * sizeof(double)); tmp[0] = 61.0; tmp[1] = 35.0; tmp[2] = 49.0; tmp;}), .x_len = 3, .y = 150.0}; tmp;});
        test_data_len = 2;
        parameter_vector = ({double *tmp = malloc(4 * sizeof(double)); tmp[0] = 2.0; tmp[1] = 4.0; tmp[2] = 1.0; tmp[3] = 5.0; tmp;});
        parameter_vector_len = 4;

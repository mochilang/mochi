...
DataPoint train_data_init[5] = {(DataPoint){.x = (double[]){5.0, 2.0, 3.0}, .x_len = 3, .y = 15.0}, (DataPoint){.x = (double[]){6.0, 5.0, 9.0}, .x_len = 3, .y = 25.0}, (DataPoint){.x = (double[]){11.0, 12.0, 13.0}, .x_len = 3, .y = 41.0}, (DataPoint){.x = (long long[]){1.0, 1.0, 1.0}, .x_len = 3, .y = 8.0}, (DataPoint){.x = (double[]){11.0, 12.0, 13.0}, .x_len = 3, .y = 41.0}};

...
double train_X_0[2] = {0LL, 0LL};
double train_X_1[2] = {1LL, 0LL};
double train_X_2[2] = {0LL, 1LL};
double train_X_3[2] = {0.5, 0.5};
double train_X_4[2] = {3LL, 3LL};
double train_X_5[2] = {2LL, 3LL};
double train_X_6[2] = {3LL, 2LL};
...
const char* classify(KNN knn, double * pred_point, size_t pred_point_len, long long k) {
    ...
    while (count < k) {
        ...
        distances[(int)(min_index)].dist = 1000000000000000000LL;
        count = count + 1LL;
    }

...
int main(void) {
    {
        ...
        SAN_FRANCISCO = ({double *tmp = malloc(2 * sizeof(double)); tmp[0] = 37.774856; tmp[1] = -122.424227; tmp;});
        SAN_FRANCISCO_len = 2;
        YOSEMITE = ({double *tmp = malloc(2 * sizeof(double)); tmp[0] = 37.864742; tmp[1] = -119.537521; tmp;});
        YOSEMITE_len = 2;

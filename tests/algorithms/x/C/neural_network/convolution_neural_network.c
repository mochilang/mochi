...
double * flatten(double * * * maps, size_t maps_len, size_t* maps_lens, size_t maps_lens_len);
...
double * flatten(double * * * maps, size_t maps_len, size_t* maps_lens, size_t maps_lens_len) {
    ...
    while (i < maps_len) {
        ...
        while (j < maps_lens[(int)(i)]) {
            long long k = 0LL;
            while (k < 0) {
                out = list_append_double(out, &out_len, maps[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? maps_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? maps_lens[(int)(i)] + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = k; _mochi_idx < 0 ? 0 + _mochi_idx : _mochi_idx;})]);
                k = k + 1LL;
            }
            j = j + 1LL;
        }
...
double * forward(CNN cnn, double * * data, size_t data_len, size_t* data_lens, size_t data_lens_len) {
    ...
    while (i < cnn.conv_kernels_len) {
        ...
        maps_lens_lens = list_append_szptr(maps_lens_lens, &maps_lens_lens_len, NULL);
        i = i + 1LL;
    }
    double *flat = flatten(maps, maps_len, maps_lens, maps_len);

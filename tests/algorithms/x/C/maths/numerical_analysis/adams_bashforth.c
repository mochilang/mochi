...
int main(void) {
    {
        ...
        y2 = adams_bashforth_step2(f_x, (long long[]){0.0, 0.2}, 2, (long long[]){0.0, 0.0}, 2, 0.2, 1.0);
        y2_len = adams_bashforth_step2_len;
        puts(list_to_string(y2, y2_len));
        y3 = adams_bashforth_step3(f_xy, (long long[]){0.0, 0.2, 0.4}, 3, (long long[]){0.0, 0.0, 0.04}, 3, 0.2, 1.0);
        y3_len = adams_bashforth_step3_len;
        puts(str_float(y3[(int)({long long _mochi_idx = 3LL; _mochi_idx < 0 ? y3_len + _mochi_idx : _mochi_idx;})]));
        y4 = adams_bashforth_step4(f_xy, (long long[]){0.0, 0.2, 0.4, 0.6}, 4, (long long[]){0.0, 0.0, 0.04, 0.128}, 4, 0.2, 1.0);
        ...
        y5 = adams_bashforth_step5(f_xy, (long long[]){0.0, 0.2, 0.4, 0.6, 0.8}, 5, (long long[]){0.0, 0.0214, 0.0214, 0.22211, 0.42536}, 5, 0.2, 1.0);

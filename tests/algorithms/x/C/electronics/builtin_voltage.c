...
double BOLTZMANN = 1.380649 / 99999999999999991611392.0;
double ELECTRON_VOLT = 1.602176634 / 10000000000000000000.0;
...
int main(void) {
    {
        ...
        puts(str_float(builtin_voltage(100000000000000000.0, 100000000000000000.0, 10000000000.0)));

...
void main() {
  ...
  var _benchMem0 = ProcessInfo.currentRss;
  var _benchSw = Stopwatch()..start();
  print((min_dist_top_down("intention", "execution")).toString());
  print((min_dist_top_down("intention", "")).toString());
  print((min_dist_top_down("", "")).toString());
  print((min_dist_bottom_up("intention", "execution")).toString());
  print((min_dist_bottom_up("intention", "")).toString());
  print((min_dist_bottom_up("", "")).toString());
  _benchSw.stop();

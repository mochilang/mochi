...
List<List<int>> merge(List<List<int>> left, List<List<int>> right) {
  ...
  while (i < left.length && j < right.length) {
    ...
    result = ([...result, left[i]] as List<dynamic>).map((e) => ((e as List<dynamic>).map((e) => (e is BigInt ? e.toInt() : (e as int))).toList() as List<int>)).toList();
    i = i + 1;
  } else {
    result = ([...result, right[j]] as List<dynamic>).map((e) => ((e as List<dynamic>).map((e) => (e is BigInt ? e.toInt() : (e as int))).toList() as List<int>)).toList();
    j = j + 1;
  }
  }
  while (i < left.length) {
...
List<List<int>> sortlist_2d(List<List<int>> list_2d) {
  ...
  int i = 0;
  while (i < middle) {
    left = ([...left, list_2d[i]] as List<dynamic>).map((e) => ((e as List<dynamic>).map((e) => (e is BigInt ? e.toInt() : (e as int))).toList() as List<int>)).toList();
    i = i + 1;
  }
  List<List<int>> right = <List<int>>[];
  int j = middle;
  while (j < length) {
    right = ([...right, list_2d[j]] as List<dynamic>).map((e) => ((e as List<dynamic>).map((e) => (e is BigInt ? e.toInt() : (e as int))).toList() as List<int>)).toList();
    j = j + 1;
  }
...
List<int> merge_insertion_sort(List<int> collection) {
  ...
  while (i < collection.length) {
    ...
    if (a < b) {
    two_paired_list = ([...two_paired_list, [a, b]] as List<dynamic>).map((e) => ((e as List<dynamic>).map((e) => (e is BigInt ? e.toInt() : (e as int))).toList() as List<int>)).toList();
  } else {
    two_paired_list = ([...two_paired_list, [b, a]] as List<dynamic>).map((e) => ((e as List<dynamic>).map((e) => (e is BigInt ? e.toInt() : (e as int))).toList() as List<int>)).toList();
  };
  }
    i = i + 2;
  }

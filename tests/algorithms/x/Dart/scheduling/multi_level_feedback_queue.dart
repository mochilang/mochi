...
List<int> calculate_waiting_time(List<Process> queue) {
  ...
  while (i < queue.length) {
    Process p = queue[i];
    times = (times..add(p.waiting_time));
    i = i + 1;
  }
  return times;
}
...
List<int> calculate_turnaround_time(List<Process> queue) {
  ...
  while (i < queue.length) {
    Process p = queue[i];
    times = (times..add(p.turnaround_time));
    i = i + 1;
  }
  return times;
}

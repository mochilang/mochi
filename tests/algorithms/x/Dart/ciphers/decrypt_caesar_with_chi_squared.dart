...
void main() {
  print((r1.shift).toString() + ", " + (r1.chi).toString() + ", " + r1.decoded);
  print((r2.shift).toString() + ", " + (r2.chi).toString() + ", " + r2.decoded);
  print((r3.shift).toString() + ", " + (r3.chi).toString() + ", " + r3.decoded);
}

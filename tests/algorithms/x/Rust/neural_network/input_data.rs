...
fn main() {
        let _start: i64 = _now();
    let mut dense_to_one_hot = |mut labels: Vec<i64>, mut num_classes: i64| -> Vec<Vec<i64>> {
    ...
    let mut new_dataset = |mut images: Vec<Vec<i64>>, mut labels: Vec<Vec<i64>>| -> DataSet {
    ...
    let mut next_batch = |mut ds: DataSet, mut batch_size: i64| -> BatchResult {
    ...
    let mut read_data_sets = |mut train_images: Vec<Vec<i64>>, mut train_labels_raw: Vec<i64>, mut test_images: Vec<Vec<i64>>, mut test_labels_raw: Vec<i64>, mut validation_size: i64, mut num_classes: i64| -> Datasets {

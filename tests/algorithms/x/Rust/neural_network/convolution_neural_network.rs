...
fn main() {
    ...
    return (1.0 / (1.0 + exp(-x)))
        ...
        let mut to_float = |mut x: i64| -> f64 {
    return ((x as f64) * 1.0)
};
        fn exp(mut x: f64) -> f64 {
    return x.exp()
};
        let mut convolve = |mut data: Vec<Vec<f64>>, mut kernel: Vec<Vec<f64>>, mut step: i64, mut bias: f64| -> Vec<Vec<f64>> {
    ...
    return out
        ...
        let mut average_pool = |mut map: Vec<Vec<f64>>, mut size: i64| -> Vec<Vec<f64>> {
    let mut out: Vec<Vec<f64>> = vec![];
    let mut i: i64 = 0;
    ...
    return out
        ...
        let mut flatten = |mut maps: Vec<Vec<Vec<f64>>>| -> Vec<f64> {
    ...
    return out
        ...
        let mut vec_mul_mat = |mut v: Vec<f64>, mut m: Vec<Vec<f64>>| -> Vec<f64> {
    ...
    return res
        ...
        let mut matT_vec_mul = |mut m: Vec<Vec<f64>>, mut v: Vec<f64>| -> Vec<f64> {
    let mut res: Vec<f64> = vec![];
    let mut i: i64 = 0;
    ...
    return res
        ...
        let mut vec_add = |mut a: Vec<f64>, mut b: Vec<f64>| -> Vec<f64> {
    let mut res: Vec<f64> = vec![];
    let mut i: i64 = 0;
    ...
    return res
        ...
        let mut vec_map_sig = |mut v: Vec<f64>| -> Vec<f64> {
    let mut res: Vec<f64> = vec![];
    let mut i: i64 = 0;
    while (i < (v.len() as i64)) {

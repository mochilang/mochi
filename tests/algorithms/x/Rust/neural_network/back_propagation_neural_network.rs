...
fn main() {
    ...
    return ((1.0 * (rand() as f64)) / 2147483648.0)
        ...
        let mut expApprox = |mut x: f64| -> f64 {
    let mut y: f64 = x;
    ...
    return sum
        ...
        let mut sigmoid = |mut z: f64| -> f64 {
    return (1.0 / (1.0 + expApprox(-z)))
};
        let mut sigmoid_vec = |mut v: Vec<f64>| -> Vec<f64> {
    ...
    return res
        ...
        let mut sigmoid_derivative = |mut out: Vec<f64>| -> Vec<f64> {
    let mut res: Vec<f64> = vec![];
    let mut i: i64 = 0;
    ...
    return res
        ...
        let mut random_vector = |mut n: i64| -> Vec<f64> {
    ...
    return v
        ...
        let mut random_matrix = |mut r: i64, mut c: i64| -> Vec<Vec<f64>> {
    ...
    return m
        ...
        let mut matvec = |mut mat: Vec<Vec<f64>>, mut vec: Vec<f64>| -> Vec<f64> {
    let mut res: Vec<f64> = vec![];
    let mut i: i64 = 0;
    ...
    return res
        ...
        let mut matTvec = |mut mat: Vec<Vec<f64>>, mut vec: Vec<f64>| -> Vec<f64> {
    ...
    return res
        ...
        let mut vec_sub = |mut a: Vec<f64>, mut b: Vec<f64>| -> Vec<f64> {
    let mut res: Vec<f64> = vec![];
    let mut i: i64 = 0;
    ...
    return res
        ...
        let mut vec_mul = |mut a: Vec<f64>, mut b: Vec<f64>| -> Vec<f64> {
    let mut res: Vec<f64> = vec![];
    let mut i: i64 = 0;
    while (i < (a.len() as i64)) {
        res = { let mut _v = res.clone(); _v.push((a[i as usize] * b[i as usize])); _v };
    ...
    return res
        ...
        let mut vec_scalar_mul = |mut v: Vec<f64>, mut s: f64| -> Vec<f64> {
    let mut res: Vec<f64> = vec![];
    let mut i: i64 = 0;
    while (i < (v.len() as i64)) {
    ...
    return res
        ...
        let mut outer = |mut a: Vec<f64>, mut b: Vec<f64>| -> Vec<Vec<f64>> {
    ...
    return res
        ...
        let mut mat_scalar_mul = |mut mat: Vec<Vec<f64>>, mut s: f64| -> Vec<Vec<f64>> {
    let mut res: Vec<Vec<f64>> = vec![];
    let mut i: i64 = 0;
    while (i < (mat.len() as i64)) {
        let mut row: Vec<f64> = vec![];
    ...
    return res
        ...
        let mut mat_sub = |mut a: Vec<Vec<f64>>, mut b: Vec<Vec<f64>>| -> Vec<Vec<f64>> {
    let mut res: Vec<Vec<f64>> = vec![];
    let mut i: i64 = 0;
    while (i < (a.len() as i64)) {
        let mut row: Vec<f64> = vec![];
    ...
    return res
        ...
        let mut init_layer = |mut units: i64, mut back_units: i64, mut lr: f64| -> Layer {
    return Layer {units: units, weight: random_matrix(units, back_units), bias: random_vector(units), output: vec![], xdata: vec![], learn_rate: lr}
        ...
        let mut forward = |mut layers: Vec<Layer>, mut x: Vec<f64>| -> Vec<Layer> {
    ...
    return layers
        ...
        let mut backward = |mut layers: Vec<Layer>, mut grad: Vec<f64>| -> Vec<Layer> {
    ...
    return layers
        ...
        let mut calc_loss = |mut y: Vec<f64>, mut yhat: Vec<f64>| -> f64 {
    let mut s: f64 = 0.0;
    let mut i: i64 = 0;
    ...
    return s
        ...
        let mut calc_gradient = |mut y: Vec<f64>, mut yhat: Vec<f64>| -> Vec<f64> {
    ...
    return g
        ...
        let mut train = |mut layers: Vec<Layer>, mut xdata: Vec<Vec<f64>>, mut ydata: Vec<Vec<f64>>, mut rounds: i64, mut acc: f64| -> f64 {
    let mut r: i64 = 0;
    while (r < rounds) {
        let mut i: i64 = 0;

...
fn main() {
    ...
    let mut swish = |mut vector: Vec<f64>, mut beta: f64| -> Vec<f64> {
    let mut result: Vec<f64> = vec![];
    let mut i: i64 = 0;
    while (i < (vector.len() as i64)) {
        let v: f64 = vector[i as usize];
    ...
    let mut sigmoid_linear_unit = |mut vector: Vec<f64>| -> Vec<f64> {
    ...
    let mut approx_equal_list = |mut a: Vec<f64>, mut b: Vec<f64>, mut eps: f64| -> bool {

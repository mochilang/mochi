...
fn main() {
    ...
    let mut binary_search_delete = |mut array: Vec<i64>, mut item: i64| -> Vec<i64> {
    let mut low: i64 = 0;
    ...
    let mut binary_search_insert = |mut array: Vec<i64>, mut index: i64| -> Vec<i64> {
    let mut low: i64 = 0;
    let mut high: i64 = ((array.len() as i64) - 1);
    let mut arr: Vec<i64> = array.clone();
    while (low <= high) {
    ...
    let mut change = |mut cont: NumberContainer, mut idx: i64, mut num: i64| -> NumberContainer {

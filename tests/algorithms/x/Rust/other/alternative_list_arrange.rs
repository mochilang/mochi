...
fn main() {
        let _start: i64 = _now();
    let mut from_int = |mut x: i64| -> Item {
    ...
    let mut alternative_list_arrange = |mut first: Vec<Item>, mut second: Vec<Item>| -> Vec<Item> {
    ...
    let mut list_to_string = |mut xs: Vec<Item>| -> String {

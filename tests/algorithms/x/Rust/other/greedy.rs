...
fn main() {
    ...
    fn sort_desc(mut items: Vec<Thing>, key_func: &mut impl FnMut(Thing) -> f64) -> Vec<Thing> {
    ...
    fn greedy(mut items: Vec<Thing>, mut max_cost: f64, key_func: &mut impl FnMut(Thing) -> f64) -> GreedyResult {
    ...
    let food: Vec<String> = vec![String::from("Burger").clone().clone(), String::from("Pizza").clone().clone(), String::from("Coca Cola").clone().clone(), String::from("Rice").clone().clone(), String::from("Sambhar").clone().clone(), String::from("Chicken").clone().clone(), String::from("Fries").clone().clone(), String::from("Milk").clone().clone()];

...
fn main() {
        let _start: i64 = _now();
    let mut apply_table = |mut inp: String, mut table: Vec<i64>| -> String {
    ...
    let mut xor = |mut a: String, mut b: String| -> String {
    let mut res: String = String::new();
    let mut i: i64 = 0;
    ...
    let mut int_to_binary = |mut n: i64| -> String {
    if (n == 0) {
    ...
    let mut bin_to_int = |mut s: String| -> i64 {
    ...
    let mut apply_sbox = |mut s: Vec<Vec<i64>>, mut data: String| -> String {
    ...
    let mut f = {
fn f(apply_table: &mut dyn FnMut(String, Vec<i64>) -> String, key: &str, left: &str, left_bin_str: &mut String, p4_table: &mut Vec<i64>, pad_left: &mut dyn FnMut(String, i64) -> String, right: &str, right_bin_str: &mut String, temp: &mut String, xor: &mut dyn FnMut(String, String) -> String, mut expansion: Vec<i64>, mut s0: Vec<Vec<i64>>, mut s1: Vec<Vec<i64>>, mut key: String, mut message: String) -> String {
...
|mut expansion: Vec<i64>, mut s0: Vec<Vec<i64>>, mut s1: Vec<Vec<i64>>, mut key: String, mut message: String| -> String { f(&mut apply_table, &key, &left, &mut left_bin_str, &mut p4_table, &mut pad_left, &right, &mut right_bin_str, &mut temp, &mut xor, expansion, s0, s1, key, message) }
};

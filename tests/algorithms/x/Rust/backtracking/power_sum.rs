...
fn main() {
    ...
    fn backtrack(mut target: i64, mut exp: i64, mut current: i64, mut current_sum: i64) -> i64 {
    if (current_sum == target) {
        return 1
    }
    let mut p: i64 = int_pow(current, exp);
    let mut count: i64 = 0;
    ...
    fn solve(mut target: i64, mut exp: i64) -> i64 {

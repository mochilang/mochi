...
fn main() {
        let _start: i64 = _now();
    fn centripetal(mut mass: f64, mut velocity: f64, mut radius: f64) -> f64 {
    if (mass < 0.0) {
    ...
    fn show(mut mass: f64, mut velocity: f64, mut radius: f64) {
    let f: f64 = centripetal(mass, velocity, radius);
    println!("{}", round(f, 2).to_string());
};
    show(15.5, -30.0, 10.0);
    show(10.0, 15.0, 5.0);
    show(20.0, -50.0, 15.0);

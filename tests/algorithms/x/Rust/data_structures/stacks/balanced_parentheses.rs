...
fn main() {
    unsafe {
        g_idx = 0;
                let _start: i64 = _now();
        fn pop_last(mut xs: Vec<String>) -> Vec<String> {
    ...
    return res
        ...
        fn balanced_parentheses(mut s: String) -> bool {
    let mut stack: Vec<String> = vec![];
    let pairs: HashMap<String, String> = HashMap::from([(String::from("("), String::from(")")), (String::from("["), String::from("]")), (String::from("{"), String::from("}"))]);
    let mut i: i64 = 0;
    ...
    return ((stack.len() as i64) == 0)
        ...
        let mut tests: Vec<String> = vec![String::from("([]{})").clone(), String::from("[()]{}{[()()]()}").clone(), String::from("[(])").clone(), String::from("1+2*3-4").clone(), String::new().clone()];
        while (unsafe { g_idx.clone() } < (tests.len() as i64)) {
            println!("{}", if balanced_parentheses(tests[unsafe { g_idx.clone() } as usize].clone()) { 1 } else { 0 });

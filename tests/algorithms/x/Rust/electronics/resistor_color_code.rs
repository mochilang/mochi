...
fn main() {
    ...
    let mut contains = |list: Vec<String>, value: String| -> bool {
    ...
    let mut get_significant_digits = |colors: Vec<String>| -> i64 {
    let mut digit: i64 = 0;
    ...
    let mut get_multiplier = |color: String| -> f64 {
    ...
    let mut get_tolerance = |color: String| -> f64 {
    ...
    let mut get_temperature_coeffecient = |color: String| -> i64 {
    ...
    let mut get_band_type_count = |total: i64, typ: String| -> i64 {
    if (total == 3) {
    ...
    let mut check_validity = |number_of_bands: i64, colors: Vec<String>| -> bool {
    ...
    let mut calculate_resistance = |number_of_bands: i64, color_code_list: Vec<String>| -> String {

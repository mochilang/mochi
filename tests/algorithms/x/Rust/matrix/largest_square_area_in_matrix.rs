...
fn main() {
    ...
    fn largest_square_area_in_matrix_top_down(mut rows: i64, mut cols: i64, mut mat: Vec<Vec<i64>>) -> i64 {
    ...
    fn largest_square_area_in_matrix_top_down_with_dp(mut rows: i64, mut cols: i64, mut mat: Vec<Vec<i64>>) -> i64 {
    let mut largest: Vec<i64> = vec![0];

...
fn main() {
    ...
    fn add(mut a: Vec<Vec<f64>>, mut b: Vec<Vec<f64>>) -> Vec<Vec<f64>> {
    ...
    fn scalar_multiply(mut a: Vec<Vec<f64>>, mut s: f64) -> Vec<Vec<f64>> {
    check_matrix(a.clone());
    let rows: i64 = (a.len() as i64);
    let cols: i64 = (a[0 as usize].clone().len() as i64);
    let mut result: Vec<Vec<f64>> = vec![];
    ...
    fn transpose(mut a: Vec<Vec<f64>>) -> Vec<Vec<f64>> {
    check_matrix(a.clone());
    let rows: i64 = (a.len() as i64);
    let cols: i64 = (a[0 as usize].clone().len() as i64);
    let mut result: Vec<Vec<f64>> = vec![];

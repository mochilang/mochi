...
fn main() {
    ...
    fn parse_moves(input_str: &str) -> Vec<Coord> {
    ...
    fn validate_matrix_content(mut matrix: Vec<String>, mut size: i64) {
    ...
    fn find_repeat(mut matrix_g: Vec<Vec<String>>, mut row: i64, mut column: i64, mut size: i64) -> Vec<Coord> {
    ...
    fn play(matrix_g: &mut Vec<Vec<String>>, mut pos_x: i64, mut pos_y: i64, mut size: i64) -> PlayResult {
    ...
    fn process_game(mut size: i64, mut matrix: Vec<String>, mut moves: Vec<Coord>) -> i64 {
    ...
    fn mochi_main() {
    let size: i64 = 4;
    let matrix: Vec<String> = vec![String::from("RRBG").clone().clone(), String::from("RBBG").clone().clone(), String::from("YYGG").clone().clone(), String::from("XYGG").clone().clone()];
    let moves: Vec<Coord> = parse_moves(&"0 1,1 1");

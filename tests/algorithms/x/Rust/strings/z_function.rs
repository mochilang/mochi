...
fn main() {
    ...
    let mut z_res: Vec<i64> = z_function(&(pattern + input_str));
    let mut i: i64 = 0;
    ...
    fn test_z_function() {
    let mut s1: String = String::from("abracadabra").clone();
    let mut expected1: Vec<i64> = vec![0, 0, 0, 1, 0, 1, 0, 4, 0, 0, 1];
    let mut r1: Vec<i64> = z_function(&s1);
    if !list_eq_int(r1.clone(), expected1.clone()) {
        panic!("z_function abracadabra failed");
    }
    let mut s2: String = String::from("aaaa").clone();
    let mut expected2: Vec<i64> = vec![0, 3, 2, 1];
    let mut r2: Vec<i64> = z_function(&s2);
    if !list_eq_int(r2.clone(), expected2.clone()) {
        panic!("z_function aaaa failed");
    }
    let mut s3: String = String::from("zxxzxxz").clone();
    let mut expected3: Vec<i64> = vec![0, 0, 0, 4, 0, 0, 1];
    let mut r3: Vec<i64> = z_function(&s3);
    ...
    test_z_function();
    test_find_pattern();
    let mut r1: Vec<i64> = z_function(&"abracadabra");
    let mut r2: Vec<i64> = z_function(&"aaaa");
    let mut r3: Vec<i64> = z_function(&"zxxzxxz");
    println!("{}", format!("{:?}", r1));
    println!("{}", format!("{:?}", r2));
    println!("{}", format!("{:?}", r3));

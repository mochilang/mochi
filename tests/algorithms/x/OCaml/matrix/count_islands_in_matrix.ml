...
let rec is_safe grid visited row col =
  ...
  let visited_cell = (let __l = (let __l = visited in let __i = row in if __i < 0 then [] else match List.nth_opt __l __i with Some v -> v | None -> []) in let __i = col in if __i < 0 then false else match List.nth_opt __l __i with Some v -> v | None -> false) in
  let within_bounds = ((((row >= 0) && (row < rows)) && (col >= 0)) && (col < cols)) in
  let not_visited = (visited_cell = false) in
  __ret := (Obj.magic (((within_bounds && not_visited) && ((let __l = (let __l = grid in let __i = row in if __i < 0 then [] else match List.nth_opt __l __i with Some v -> v | None -> []) in let __i = col in if __i < 0 then 0 else match List.nth_opt __l __i with Some v -> (Obj.magic v : int) | None -> 0) = 1))) : bool); raise Return
  with Return -> !__ret)
...
and count_islands grid =
  ...
  (try while (!j < cols) do
    try
  if (not ((let __l = (let __l = !visited in let __i = !i in if __i < 0 then [] else match List.nth_opt __l __i with Some v -> v | None -> []) in let __i = !j in if __i < 0 then false else match List.nth_opt __l __i with Some v -> v | None -> false)) && ((let __l = (let __l = grid in let __i = !i in if __i < 0 then [] else match List.nth_opt __l __i with Some v -> v | None -> []) in let __i = !j in if __i < 0 then 0 else match List.nth_opt __l __i with Some v -> (Obj.magic v : int) | None -> 0) = 1)) then (

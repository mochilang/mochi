...
let rec add matrices =
  ...
  let rows = List.length ((let __l = matrices in let __i = 0 in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i))) in
  let cols = List.length ((let __l = (let __l = matrices in let __i = 0 in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) in let __i = 0 in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i))) in
  let r = ref (0) in
  ...
  (try while (!m < List.length (matrices)) do
    try
  sum := (!sum +. (let __l = (let __l = (let __l = matrices in let __i = !m in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) in let __i = !r in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) in let __i = !c in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)));
  m := (!m + 1);
    with Continue -> ()
  done with Break -> ());
...
and subtract a b =
  ...
  (try while (!c < cols) do
    try
  row := (Obj.magic (List.append (!row) [(Obj.magic (((let __l = (let __l = a in let __i = !r in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) in let __i = !c in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) -. (let __l = (let __l = b in let __i = !r in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) in let __i = !c in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)))) : float)]) : float list);
  c := (!c + 1);
    with Continue -> ()
  done with Break -> ());
  result := (Obj.magic (List.append (!result) [(Obj.magic (!row) : float list)]) : float list list);
...
and scalar_multiply matrix n =
  ...
  let row = ref (([] : (float) list)) in
  let j = ref (0) in
  (try while (!j < List.length ((let __l = matrix in let __i = !i in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)))) do
    try
  row := (Obj.magic (List.append (!row) [(Obj.magic (((let __l = (let __l = matrix in let __i = !i in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) in let __i = !j in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) *. n)) : float)]) : float list);
  j := (!j + 1);
    with Continue -> ()
  done with Break -> ());
  result := (Obj.magic (List.append (!result) [(Obj.magic (!row) : float list)]) : float list list);
...
and multiply a b =
  ...
  let colsA = List.length ((let __l = a in let __i = 0 in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i))) in
  let rowsB = List.length (b) in
  let colsB = List.length ((let __l = b in let __i = 0 in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i))) in
  let result = ref (([] : (float list) list)) in
  let i = ref (0) in
...
and transpose matrix =
  ...
  (try while (!r < rows) do
    try
  row := (Obj.magic (List.append (!row) [(Obj.magic ((let __l = (let __l = matrix in let __i = !r in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) in let __i = !c in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i))) : float)]) : float list);
  r := (!r + 1);
    with Continue -> ()
  done with Break -> ());
  result := (Obj.magic (List.append (!result) [(Obj.magic (!row) : float list)]) : float list list);
...
and minor matrix row column =
  ...
  (try while (!j < List.length ((let __l = matrix in let __i = !i in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)))) do
    try
  if (!j <> column) then (
  new_row := (Obj.magic (List.append (!new_row) [(Obj.magic ((let __l = (let __l = matrix in let __i = !i in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) in let __i = !j in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i))) : float)]) : float list);
  );
  j := (!j + 1);
    with Continue -> ()
  done with Break -> ());
...
and determinant matrix =
  ...
  __ret := (Obj.magic ((let __l = (let __l = matrix in let __i = 0 in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) in let __i = 0 in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i))) : float); raise Return
  );
  let det = ref (0.0) in
  let c = ref (0) in
  (try while (!c < List.length ((let __l = matrix in let __i = 0 in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)))) do
    try
  let sub = ref (minor (matrix) (Obj.repr (0)) (Obj.repr (!c))) in
  let sign = if (((!c mod 2 + 2) mod 2) = 0) then 1.0 else (-.(1.0)) in
  det := (!det +. (((let __l = (let __l = matrix in let __i = 0 in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) in let __i = !c in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) *. determinant (!sub)) *. sign));
  c := (!c + 1);
    with Continue -> ()
  done with Break -> ());
...
and inverse matrix =
  ...
  row := (Obj.magic (List.append (!row) [(Obj.magic (((let __l = (let __l = !matrix_minor in let __i = !i in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) in let __i = !j in let __len = List.length __l in List.nth __l (if __i >= 0 then __i else __len + __i)) *. sign)) : float)]) : float list);
  j := (!j + 1);
    with Continue -> ()
  done with Break -> ());
...
and main () =
  ...
  print_endline ((((("Determinant of " ^ (__str (Obj.magic (!matrix_b) : Obj.t))) ^ " = ") ^ (Printf.sprintf "%.16g" (determinant (!matrix_b)))) ^ " \n"));

...
let rec get_data source_data =
  ...
  (try while (!i < List.length (source_data)) do
    try
  let row = ref ((let __l = source_data in let __i = !i in if __i < 0 then [] else match List.nth_opt __l __i with Some v -> v | None -> [])) in
  let j = ref (0) in
  ...
  data_lists := (List.mapi (fun __i __x -> if __i = !j then (List.append ((let __l = !data_lists in let __i = !j in if __i < 0 then [] else match List.nth_opt __l __i with Some v -> v | None -> [])) [(Obj.magic ((let __l = !row in let __i = !j in if __i < 0 then 0. else match List.nth_opt __l __i with Some v -> (Obj.magic v : float) | None -> 0.)) : float)]) else __x) (!data_lists));
  j := (!j + 1);
    with Continue -> ()
  done with Break -> ());
  i := (!i + 1);
...
and calculate_each_score data_lists weights =
  ...
  (try while (!i < List.length (data_lists)) do
    try
  let dlist = ref ((let __l = data_lists in let __i = !i in if __i < 0 then [] else match List.nth_opt __l __i with Some v -> v | None -> [])) in
...
and generate_final_scores score_lists =
  ...
  let count = List.length ((let __l = score_lists in let __i = 0 in if __i < 0 then [] else match List.nth_opt __l __i with Some v -> v | None -> [])) in
  ...
  (try while (!i < List.length (score_lists)) do
    try
  let slist = ref ((let __l = score_lists in let __i = !i in if __i < 0 then [] else match List.nth_opt __l __i with Some v -> v | None -> [])) in
  let j = ref (0) in
...
and procentual_proximity source_data weights =
  ...
  (try while (!i < List.length (!final_scores)) do
    try
  source_data := (List.mapi (fun __i __x -> if __i = !i then (List.append ((let __l = !source_data in let __i = !i in if __i < 0 then [] else match List.nth_opt __l __i with Some v -> v | None -> [])) [(Obj.magic ((let __l = !final_scores in let __i = !i in if __i < 0 then 0. else match List.nth_opt __l __i with Some v -> (Obj.magic v : float) | None -> 0.)) : float)]) else __x) (!source_data));
  i := (!i + 1);
    with Continue -> ()
  done with Break -> ());

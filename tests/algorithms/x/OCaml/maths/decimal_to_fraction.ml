...
and reduce fr =
  ...
  let g = gcd (Obj.repr ((Obj.obj (List.assoc (__str ("numerator")) (fr) : Obj.t) : int))) (Obj.repr ((Obj.obj (List.assoc (__str ("denominator")) (fr) : Obj.t) : int))) in
  __ret := (Obj.magic ([(__str ("numerator"), Obj.repr (((Obj.obj (List.assoc (__str ("numerator")) (fr) : Obj.t) : int) / g))); (__str ("denominator"), Obj.repr (((Obj.obj (List.assoc (__str ("denominator")) (fr) : Obj.t) : int) / g)))]) : (string * Obj.t) list); raise Return
  with Return -> !__ret)
...
and decimal_to_fraction x =
  ...
  __ret := (Obj.magic (decimal_to_fraction_str ((Printf.sprintf "%.16g" (x)))) : (string * Obj.t) list); raise Return
  with Return -> !__ret)
...
and assert_fraction name fr num den =
  ...
  if (((Obj.obj (List.assoc (__str ("numerator")) (fr) : Obj.t) : int) <> num) || ((Obj.obj (List.assoc (__str ("denominator")) (fr) : Obj.t) : int) <> den)) then (
  (failwith (name));
  );
    !__ret
  with Return -> !__ret)
...
and main () =
  ...
  let fr = decimal_to_fraction (Obj.repr (1.5)) in
  print_endline ((((string_of_int ((Obj.obj (List.assoc (__str ("numerator")) (fr) : Obj.t) : int))) ^ "/") ^ (string_of_int ((Obj.obj (List.assoc (__str ("denominator")) (fr) : Obj.t) : int)))));
    !__ret
  with Return -> !__ret)

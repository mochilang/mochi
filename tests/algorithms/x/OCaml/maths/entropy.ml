...
and analyze_text text =
  ...
  if (List.mem_assoc last !single) then (
  ...
  if (List.mem_assoc ch !single) then (
  ...
  if (List.mem_assoc seq !double) then (
...
and calculate_entropy text =
  ...
  if (List.mem_assoc ch (Obj.obj (List.assoc (__str ("single")) (counts) : Obj.t) : ( string * int ) list)) then (
  ...
  let seq = (ch0 ^ ch1) in
  if (List.mem_assoc seq (Obj.obj (List.assoc (__str ("double")) (counts) : Obj.t) : ( string * int ) list)) then (

...
and main () =
  ...
  print_endline (("Cube: " ^ (Printf.sprintf "%.16g" (vol_cube (Obj.repr (2.0))))));
  print_endline (("Cuboid: " ^ (Printf.sprintf "%.16g" (vol_cuboid (Obj.repr (2.0)) (Obj.repr (2.0)) (Obj.repr (2.0))))));
  print_endline (("Cone: " ^ (Printf.sprintf "%.16g" (vol_cone (Obj.repr (2.0)) (Obj.repr (2.0))))));
  print_endline (("Right Circular Cone: " ^ (Printf.sprintf "%.16g" (vol_right_circ_cone (Obj.repr (2.0)) (Obj.repr (2.0))))));
  print_endline (("Prism: " ^ (Printf.sprintf "%.16g" (vol_prism (Obj.repr (2.0)) (Obj.repr (2.0))))));
  print_endline (("Pyramid: " ^ (Printf.sprintf "%.16g" (vol_pyramid (Obj.repr (2.0)) (Obj.repr (2.0))))));
  print_endline (("Sphere: " ^ (Printf.sprintf "%.16g" (vol_sphere (Obj.repr (2.0))))));
  print_endline (("Hemisphere: " ^ (Printf.sprintf "%.16g" (vol_hemisphere (Obj.repr (2.0))))));
  print_endline (("Circular Cylinder: " ^ (Printf.sprintf "%.16g" (vol_circular_cylinder (Obj.repr (2.0)) (Obj.repr (2.0))))));
  print_endline (("Torus: " ^ (Printf.sprintf "%.16g" (vol_torus (Obj.repr (2.0)) (Obj.repr (2.0))))));
  print_endline (("Conical Frustum: " ^ (Printf.sprintf "%.16g" (vol_conical_frustum (Obj.repr (2.0)) (Obj.repr (2.0)) (Obj.repr (4.0))))));
  print_endline (("Spherical cap: " ^ (Printf.sprintf "%.16g" (vol_spherical_cap (Obj.repr (1.0)) (Obj.repr (2.0))))));
  print_endline (("Spheres intersection: " ^ (Printf.sprintf "%.16g" (vol_spheres_intersect (Obj.repr (2.0)) (Obj.repr (2.0)) (Obj.repr (1.0))))));
  print_endline (("Spheres union: " ^ (Printf.sprintf "%.16g" (vol_spheres_union (Obj.repr (2.0)) (Obj.repr (2.0)) (Obj.repr (1.0))))));
  print_endline (("Hollow Circular Cylinder: " ^ (Printf.sprintf "%.16g" (vol_hollow_circular_cylinder (Obj.repr (1.0)) (Obj.repr (2.0)) (Obj.repr (3.0))))));
  print_endline (("Icosahedron: " ^ (Printf.sprintf "%.16g" (vol_icosahedron (Obj.repr (2.5))))));
    !__ret
  with Return -> !__ret)

(* Generated by Mochi transpiler v0.10.63 on 2025-08-11 15:15 +0700 *)
...
and normalization data ndigits =
  ...
  (try while (!i < n) do
    try
  let norm = ((List.nth (data) (!i) -. x_min) /. denom) in
...
and standardization data ndigits =
  ...
  (try while (!i < n) do
    try
  let z = ((List.nth (data) (!i) -. mu) /. sigma) in
...
let () =
  ...
  let start = _now () in
  print_endline ((__str (normalization ([2.0; 7.0; 10.0; 20.0; 30.0; 50.0]) (Obj.repr (3)))));
  print_endline ((__str (normalization ([5.0; 10.0; 15.0; 20.0; 25.0]) (Obj.repr (3)))));
  print_endline ((__str (standardization ([2.0; 7.0; 10.0; 20.0; 30.0; 50.0]) (Obj.repr (3)))));
  print_endline ((__str (standardization ([5.0; 10.0; 15.0; 20.0; 25.0]) (Obj.repr (3)))));
  let finish = _now () in
  let mem_end = _mem () in

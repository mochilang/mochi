...
let () =
  ...
  print_endline ((string_of_int (Obj.magic (solution (Obj.repr (15))) : int)));
  ...
  print_endline ((string_of_int (Obj.magic (solution (Obj.repr (34))) : int)));
  print_endline ((string_of_int (Obj.magic (solution (Obj.repr (4000000))) : int)));

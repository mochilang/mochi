// Generated by Mochi v0.10.59 on 2025-08-07 11:13:14 GMT+7
...
def stringify(fs: FuzzySet): String = {
  return fs.asInstanceOf[FuzzySet].name + ": [" + String.valueOf(fs.asInstanceOf[FuzzySet].left_boundary) + ", " + String.valueOf(fs.asInstanceOf[FuzzySet].peak) + ", " + String.valueOf(fs.asInstanceOf[FuzzySet].right_boundary) + "]"
}
...
def main(args: Array[String]): Unit = {
  {
    ...
    println("Sheru membership 0.5: " + String.valueOf(membership(sheru, 0.5)))
    println("Sheru membership 0.6: " + String.valueOf(membership(sheru, 0.6)))

// Generated by Mochi v0.10.64 on 2025-08-12 14:34:52 GMT+7
...
def get_week_day(year: BigInt, month: BigInt, day: BigInt): String = {
  ...
  val day_anchor: BigInt = (if (year % BigInt(4) != BigInt(0) || (centurian == BigInt(0) && year % BigInt(400) != BigInt(0)).asInstanceOf[Boolean]) DOOMSDAY_NOT_LEAP.lift(((month - BigInt(1)).toInt).toInt).getOrElse(BigInt(0)) else DOOMSDAY_LEAP.lift(((month - BigInt(1)).toInt).toInt).getOrElse(BigInt(0)))

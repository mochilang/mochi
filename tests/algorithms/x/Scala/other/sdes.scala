// Generated by Mochi v0.10.62 on 2025-08-09 10:39:02 GMT+7
...
def apply_table(inp: String, table: ArrayBuffer[BigInt]): String = {
  ...
  while (i < BigInt((table).size)) {
    var idx: BigInt = table.lift((i.toInt).toInt).getOrElse(null) - BigInt(1)
    if (idx < BigInt(0)) {
...
def apply_sbox(s: ArrayBuffer[ArrayBuffer[BigInt]], data: String): String = {
  ...
  val `val`: BigInt = s.lift((row.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((col.toInt).toInt).getOrElse(null)

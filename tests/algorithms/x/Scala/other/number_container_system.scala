// Generated by Mochi v0.10.69 on 2025-08-19 16:43:24 GMT+7
...
def change(cont: NumberContainer, idx: BigInt, num: BigInt): NumberContainer = {
  ...
  if ((indexmap.contains(idx))) {
    var old: BigInt = indexmap.getOrElse(idx, BigInt(0)).asInstanceOf[BigInt]
    var indexes: ArrayBuffer[BigInt] = numbermap.getOrElse(old, ArrayBuffer[BigInt]()).asInstanceOf[ArrayBuffer[BigInt]]
...
def find(cont: NumberContainer, num: BigInt): BigInt = {
  var numbermap: scala.collection.mutable.Map[BigInt,ArrayBuffer[BigInt]] = cont.numbermap
  if ((numbermap.contains(num))) {
    var arr: ArrayBuffer[BigInt] = numbermap.getOrElse(num, ArrayBuffer[BigInt]()).asInstanceOf[ArrayBuffer[BigInt]]

// Generated by Mochi v0.10.59 on 2025-08-07 11:13:03 GMT+7
...
def get_mid(p1: Point, p2: Point): Point = {
  return Point((p1.asInstanceOf[Point].x + p2.asInstanceOf[Point].x) / 2, (p1.asInstanceOf[Point].y + p2.asInstanceOf[Point].y) / 2)
}
...
def main(args: Array[String]): Unit = {
  {
    ...
    val _start = _now()
    triangle(Point(-175, -125), Point(0, 175), Point(175, -125), 2)
    val _end = _now()
    System.gc()

// Generated by Mochi v0.10.66 on 2025-08-15 10:34:20 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    val _start = _now()
    println(_str(g.adj_matrix))
    println(_str(contains_edge(g, BigInt(1), BigInt(2))))
    println(_str(contains_edge(g, BigInt(2), BigInt(1))))

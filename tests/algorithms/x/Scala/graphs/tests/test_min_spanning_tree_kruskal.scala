// Generated by Mochi v0.10.63 on 2025-08-12 08:48:01 GMT+7
  ...
  while (i < BigInt((es).size)) {
    ...
    while (j < BigInt((es).size) - i - BigInt(1)) {
      if (es.lift((j.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((BigInt(2).toInt).toInt).getOrElse(BigInt(0)) > es.lift(((j + BigInt(1)).toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((BigInt(2).toInt).toInt).getOrElse(BigInt(0))) {
        val tmp: ArrayBuffer[BigInt] = es.lift((j.toInt).toInt).getOrElse(ArrayBuffer[BigInt]())
...
def kruskal(n: BigInt, edges: ArrayBuffer[ArrayBuffer[BigInt]]): ArrayBuffer[ArrayBuffer[BigInt]] = {
  ...
  _br4.breakable {
    while (e < BigInt((sorted).size)) {
      ...
      val edge: ArrayBuffer[BigInt] = sorted.lift((e.toInt).toInt).getOrElse(ArrayBuffer[BigInt]())
      e = e + BigInt(1)
      val u: BigInt = edge.lift((BigInt(0).toInt).toInt).getOrElse(BigInt(0))
      val v: BigInt = edge.lift((BigInt(1).toInt).toInt).getOrElse(BigInt(0))
      val w: BigInt = edge.lift((BigInt(2).toInt).toInt).getOrElse(BigInt(0))
...
def edges_equal(a: ArrayBuffer[ArrayBuffer[BigInt]], b: ArrayBuffer[ArrayBuffer[BigInt]]): Boolean = {
  ...
  while (i < BigInt((a).size)) {
    val e1: ArrayBuffer[BigInt] = a.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]())
    val e2: ArrayBuffer[BigInt] = b.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]())
    if (((e1.lift((BigInt(0).toInt).toInt).getOrElse(BigInt(0)) != e2.lift((BigInt(0).toInt).toInt).getOrElse(BigInt(0)) || e1.lift((BigInt(1).toInt).toInt).getOrElse(BigInt(0)) != e2.lift((BigInt(1).toInt).toInt).getOrElse(BigInt(0))).asInstanceOf[Boolean] || e1.lift((BigInt(2).toInt).toInt).getOrElse(BigInt(0)) != e2.lift((BigInt(2).toInt).toInt).getOrElse(BigInt(0))).asInstanceOf[Boolean]) {
      return false
    }
    i = i + BigInt(1)
  }

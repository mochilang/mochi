// Generated by Mochi v0.10.63 on 2025-08-12 08:43:52 GMT+7
...
def kosaraju(graph: ArrayBuffer[ArrayBuffer[BigInt]]): ArrayBuffer[ArrayBuffer[BigInt]] = {
  ...
  while (idx >= BigInt(0)) {
    val node: BigInt = stack.lift((idx.toInt).toInt).getOrElse(BigInt(0))
...
def main(): Any = {
  ...
  while (i < BigInt((comps).size)) {
    println(comps.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()))
    i = i + BigInt(1)
  }
}

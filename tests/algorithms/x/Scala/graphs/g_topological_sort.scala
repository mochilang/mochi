// Generated by Mochi v0.10.59 on 2025-08-07 11:23:09 GMT+7
...
def depth_first_search(u: BigInt, visited: ArrayBuffer[Boolean], graph: ArrayBuffer[ArrayBuffer[BigInt]], _stack: ArrayBuffer[BigInt]): ArrayBuffer[BigInt] = {
  ...
  while (i < BigInt((graph((u.toInt).toInt)).size)) {
    val v: BigInt = graph((u.toInt).toInt)((i.toInt).toInt)
...
def print_stack(stack: ArrayBuffer[BigInt], clothes: scala.collection.mutable.Map[BigInt,String]): Any = {
  ...
  while (BigInt((s).size) > BigInt(0)) {
    val idx: BigInt = s(((BigInt((s).size) - BigInt(1)).toInt).toInt)
    s = s.slice((BigInt(0)).toInt, (BigInt((s).size) - BigInt(1)).toInt)
    println(String.valueOf(order) + " " + clothes.getOrElse(idx, "").asInstanceOf[String])
...
def main(): Any = {
  val clothes: scala.collection.mutable.Map[BigInt,String] = scala.collection.mutable.Map(BigInt(0) -> ("underwear"), BigInt(1) -> ("pants"), BigInt(2) -> ("belt"), BigInt(3) -> ("suit"), BigInt(4) -> ("shoe"), BigInt(5) -> ("socks"), BigInt(6) -> ("shirt"), BigInt(7) -> ("tie"), BigInt(8) -> ("watch"))
  val graph: ArrayBuffer[ArrayBuffer[BigInt]] = ArrayBuffer(ArrayBuffer(BigInt(1), BigInt(4)), ArrayBuffer(BigInt(2), BigInt(4)), ArrayBuffer(BigInt(3)), ArrayBuffer[BigInt](), ArrayBuffer[BigInt](), ArrayBuffer(BigInt(4)), ArrayBuffer(BigInt(2), BigInt(7)), ArrayBuffer(BigInt(3)), ArrayBuffer[BigInt]())
  val stack: ArrayBuffer[BigInt] = topological_sort(graph)

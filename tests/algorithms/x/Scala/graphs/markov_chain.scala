// Generated by Mochi v0.10.66 on 2025-08-15 10:35:59 GMT+7
...
def main(): Any = {
  ...
  println(_str(result.getOrElse("a", BigInt(0)).asInstanceOf[BigInt]) + " " + _str(result.getOrElse("b", BigInt(0)).asInstanceOf[BigInt]) + " " + _str(result.getOrElse("c", BigInt(0)).asInstanceOf[BigInt]))
}

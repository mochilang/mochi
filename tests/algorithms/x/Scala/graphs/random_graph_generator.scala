// Generated by Mochi v0.10.59 on 2025-08-07 11:25:18 GMT+7
...
def main(): Any = {
  seed = BigInt(1)
  val g1: scala.collection.mutable.Map[BigInt,ArrayBuffer[BigInt]] = random_graph(BigInt(4), 0.5, false)
  println(g1)
  seed = BigInt(1)
  val g2: scala.collection.mutable.Map[BigInt,ArrayBuffer[BigInt]] = random_graph(BigInt(4), 0.5, true)
  println(g2)
}

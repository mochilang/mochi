// Generated by Mochi v0.10.62 on 2025-08-09 10:40:12 GMT+7
...
def hubble_parameter(hubble_constant: Double, radiation_density: Double, matter_density: Double, dark_energy: Double, redshift: Double): Double = {
  val parameters: ArrayBuffer[Double] = ArrayBuffer(redshift, radiation_density, matter_density, dark_energy)
  var i: BigInt = BigInt(0)
  ...
  val curvature: Double = 1.0 - (matter_density + radiation_density + dark_energy)
  val zp1: Double = redshift + 1.0
  val e2: Double = radiation_density * pow(zp1, BigInt(4)) + matter_density * pow(zp1, BigInt(3)) + curvature * pow(zp1, BigInt(2)) + dark_energy
  return hubble_constant * sqrt_approx(e2)
}

def test_hubble_parameter(): Any = {
  val h: Double = hubble_parameter(68.3, 0.0001, 0.3, 0.7, 0.0)
  if ((h < 68.2999 || h > 68.3001).asInstanceOf[Boolean]) {

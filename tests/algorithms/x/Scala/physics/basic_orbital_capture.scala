// Generated by Mochi v0.10.69 on 2025-08-22 13:15:39 GMT+7
...
def run_tests(): Any = {
  var r: Double = capture_radii(6.957 * pow10(BigInt(8)), 1.99 * pow10(BigInt(30)), 25000.0)
...
var G: Double = 6.6743e-11

var C: Double = 2.99792458e+08

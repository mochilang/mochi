// Generated by Mochi v0.10.62 on 2025-08-09 10:39:43 GMT+7
...
def centripetal(mass: Double, velocity: Double, radius: Double): Double = {
  if (mass < 0.0) {
...
def show(mass: Double, velocity: Double, radius: Double): Any = {
  val f: Double = centripetal(mass, velocity, radius)
  println(_str(round(f, BigInt(2))))
}

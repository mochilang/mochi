// Generated by Mochi v0.10.62 on 2025-08-09 10:40:50 GMT+7
...
def focal_length(distance_of_object: Double, distance_of_image: Double): Double = {
  if ((distance_of_object == 0.0 || distance_of_image == 0.0).asInstanceOf[Boolean]) {
...
def object_distance(focal_length: Double, distance_of_image: Double): Double = {
  if ((distance_of_image == 0.0 || focal_length == 0.0).asInstanceOf[Boolean]) {
    throw new RuntimeException(String.valueOf("Invalid inputs. Enter non zero values with respect to the sign convention."))
  }
...
def image_distance(focal_length: Double, distance_of_object: Double): Double = {
  if ((distance_of_object == 0.0 || focal_length == 0.0).asInstanceOf[Boolean]) {
    throw new RuntimeException(String.valueOf("Invalid inputs. Enter non zero values with respect to the sign convention."))
  }
...
def main(): Any = {
  ...
  test_image_distance()
  println(_str(focal_length(10.0, 20.0)))
  println(_str(object_distance(30.0, 20.0)))
  println(_str(image_distance(10.0, 40.0)))
}

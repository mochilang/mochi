// Generated by Mochi v0.10.69 on 2025-08-19 16:44:16 GMT+7
...
def main(): Any = {
  ...
  println(_str(_str(casimir_force(0.0000000002635, 0.0023, 0.0))))
  println(_str(_str(casimir_force(0.000000000000000002737, 0.0, 0.0023746))))
}

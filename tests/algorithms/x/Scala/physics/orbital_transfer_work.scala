// Generated by Mochi v0.10.64 on 2025-08-12 12:39:13 GMT+7
...
def floor(x: Double): Double = {
  ...
  val f: Double = i.toString.toDouble
  if (f > x) {
...
def orbital_transfer_work(mass_central: Double, mass_object: Double, r_initial: Double, r_final: Double): String = {
  ...
  if ((r_initial <= 0.0 || r_final <= 0.0).asInstanceOf[Boolean]) {
    throw new RuntimeException(String.valueOf("Orbital radii must be greater than zero."))
  }
  val work: Double = G * mass_central * mass_object / 2.0 * (1.0 / r_initial - 1.0 / r_final)
...
def main(): Any = {
  ...
  println(orbital_transfer_work(5.972 * pow10(BigInt(24)), 1000.0, 6.371 * pow10(BigInt(6)), 7.0 * pow10(BigInt(6))))
}

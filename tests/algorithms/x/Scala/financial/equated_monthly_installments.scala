// Generated by Mochi v0.10.59 on 2025-08-07 11:12:04 GMT+7
...
def equated_monthly_installments(principal: Double, rate_per_annum: Double, years_to_repay: BigInt): Double = {
  ...
  val number_of_payments: BigInt = years_to_repay * 12
...
def main(args: Array[String]): Unit = {
  {
    ...
    val _start = _now()
    println(String.valueOf(equated_monthly_installments(25000.0, 0.12, 3)))
    println(String.valueOf(equated_monthly_installments(25000.0, 0.12, 10)))
    val _end = _now()
    System.gc()

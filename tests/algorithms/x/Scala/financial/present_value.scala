// Generated by Mochi v0.10.59 on 2025-08-07 11:12:20 GMT+7
...
def present_value(discount_rate: Double, cash_flows: ArrayBuffer[Double]): Double = {
  ...
  while (i < BigInt((cash_flows).size)) {
    val cf: Double = cash_flows((i.toInt).toInt)
...
def main(args: Array[String]): Unit = {
  {
    ...
    val _start = _now()
    println(String.valueOf(present_value(0.13, ArrayBuffer(10.0, 20.7, (-293.0).toString.toDouble, 297.0))))
    println(String.valueOf(present_value(0.07, ArrayBuffer((-109129.39).toString.toDouble, 30923.23, 15098.93, 29734.0, 39.0))))
    println(String.valueOf(present_value(0.07, ArrayBuffer(109129.39, 30923.23, 15098.93, 29734.0, 39.0))))
    val _end = _now()
    System.gc()

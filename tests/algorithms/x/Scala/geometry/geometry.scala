// Generated by Mochi v0.10.59 on 2025-08-07 11:13:35 GMT+7
...
def make_polygon(): Polygon = {
  var s: ArrayBuffer[Side] = ArrayBuffer()
  return Polygon(s)
}
...
def polygon_get_side(p: Polygon, index: BigInt): Side = {
  return p.asInstanceOf[Polygon].sides((index.toInt).toInt)
}

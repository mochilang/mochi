// Generated by Mochi v0.10.59 on 2025-08-07 11:26:33 GMT+7
...
def adler32(plain_text: String): BigInt = {
  ...
  while (i < BigInt((plain_text).size)) {
    val code: BigInt = ord((plain_text.slice((i.toInt).toInt, (i.toInt).toInt + 1)).toString)
    a = (a + code) % MOD_ADLER
    b = (b + a) % MOD_ADLER
    i = i + BigInt(1)
  }
...
def main(): Any = {
  println(String.valueOf(adler32("Algorithms")))
  println(String.valueOf(adler32("go adler em all")))
}

val MOD_ADLER: BigInt = BigInt(65521)

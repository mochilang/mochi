// Generated by Mochi v0.10.63 on 2025-08-12 08:51:55 GMT+7
...
def push(m: Machine, seed: BigInt): Machine = {
  ...
  while (i < BigInt((buf).size)) {
    val value: Double = buf.lift((i.toInt).toInt).getOrElse(0.0)
...
def pull(m: Machine): PullResult = {
  ...
  var i: BigInt = BigInt(0)
  while (i < t) {
    val r: Double = par.lift((key.toInt).toInt).getOrElse(0.0)
    val value: Double = buf.lift((key.toInt).toInt).getOrElse(0.0)
  ...
  val x: BigInt = BigInt((buf.lift((((key + BigInt(2)) % size).toInt).toInt).getOrElse(0.0) * 10000000000.0).toInt)
  val y: BigInt = BigInt((buf.lift((((key + size - BigInt(2)) % size).toInt).toInt).getOrElse(0.0) * 10000000000.0).toInt)

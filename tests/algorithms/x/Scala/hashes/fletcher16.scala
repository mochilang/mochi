// Generated by Mochi v0.10.59 on 2025-08-07 11:26:57 GMT+7
...
def fletcher16(text: String): BigInt = {
  var sum1: BigInt = BigInt(0)
  var sum2: BigInt = BigInt(0)
  var i: BigInt = BigInt(0)
  while (i < BigInt((text).size)) {
    val code: BigInt = ord((text.slice((i.toInt).toInt, (i.toInt).toInt + 1)).toString)
    sum1 = (sum1 + code) % BigInt(255)
    sum2 = (sum1 + sum2) % BigInt(255)
    i = i + BigInt(1)
  }
  return sum2 * BigInt(256) + sum1
}

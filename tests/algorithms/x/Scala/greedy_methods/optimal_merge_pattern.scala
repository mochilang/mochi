// Generated by Mochi v0.10.59 on 2025-08-07 11:26:22 GMT+7
...
def index_of_min(xs: ArrayBuffer[BigInt]): BigInt = {
  ...
  while (i < BigInt((xs).size)) {
    if (xs((i.toInt).toInt) < xs((min_idx.toInt).toInt)) {
      min_idx = i
    }
    i = i + BigInt(1)
  }
...
def optimal_merge_pattern(files: ArrayBuffer[BigInt]): BigInt = {
  ...
  while (BigInt((arr).size) > BigInt(1)) {
    ...
    while (k < BigInt(2)) {
      val min_idx: BigInt = index_of_min(arr)
      temp = temp + arr((min_idx.toInt).toInt)
...
def main(args: Array[String]): Unit = {
  {
    ...
    val _start = _now()
    println(optimal_merge_pattern(ArrayBuffer(BigInt(2), BigInt(3), BigInt(4))))
    println(optimal_merge_pattern(ArrayBuffer(BigInt(5), BigInt(10), BigInt(20), BigInt(30), BigInt(30))))
    println(optimal_merge_pattern(ArrayBuffer(BigInt(8), BigInt(8), BigInt(8), BigInt(8), BigInt(8))))
    val _end = _now()
    System.gc()

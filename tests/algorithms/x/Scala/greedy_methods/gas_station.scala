// Generated by Mochi v0.10.59 on 2025-08-07 11:26:08 GMT+7
...
def get_gas_stations(gas_quantities: ArrayBuffer[BigInt], costs: ArrayBuffer[BigInt]): ArrayBuffer[GasStation] = {
  ...
  while (i < BigInt((gas_quantities).size)) {
    stations = stations :+ GasStation(gas_quantities((i.toInt).toInt), costs((i.toInt).toInt))
    i = i + BigInt(1)
  }
  return stations
}
...
def can_complete_journey(gas_stations: ArrayBuffer[GasStation]): BigInt = {
  ...
  while (i < BigInt((gas_stations).size)) {
    total_gas = total_gas + gas_stations((i.toInt).toInt)("gas_quantity")
    total_cost = total_cost + gas_stations((i.toInt).toInt)("cost")
    i = i + BigInt(1)
  }
  ...
  i = BigInt(0)
  while (i < BigInt((gas_stations).size)) {
    val station: GasStation = gas_stations((i.toInt).toInt)
...
def main(args: Array[String]): Unit = {
  {
    ...
    val _start = _now()
    println(String.valueOf(can_complete_journey(example1)))
    println(String.valueOf(can_complete_journey(example2)))
    val _end = _now()
    System.gc()

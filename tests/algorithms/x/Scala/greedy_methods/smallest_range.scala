// Generated by Mochi v0.10.63 on 2025-08-12 08:51:37 GMT+7
...
def smallest_range(nums: ArrayBuffer[ArrayBuffer[BigInt]]): ArrayBuffer[BigInt] = {
  ...
  while (i < BigInt((nums).size)) {
    val first_val: BigInt = nums.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((BigInt(0).toInt).toInt).getOrElse(BigInt(0))
  ...
  _br1.breakable {
    while (BigInt((heap).size) > BigInt(0)) {
      ...
      while (j < BigInt((heap).size)) {
        val hj: HeapItem = heap.lift((j.toInt).toInt).getOrElse(null)
        val hmin: HeapItem = heap.lift((min_idx.toInt).toInt).getOrElse(null)
        if (hj.asInstanceOf[HeapItem].value < hmin.asInstanceOf[HeapItem].value) {
          min_idx = j
        }
        j = j + BigInt(1)
      }
      val item: HeapItem = heap.lift((min_idx.toInt).toInt).getOrElse(null)
      ...
      val next_val: BigInt = nums.lift((item.asInstanceOf[HeapItem].list_idx.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift(((item.asInstanceOf[HeapItem].elem_idx + BigInt(1)).toInt).toInt).getOrElse(BigInt(0))

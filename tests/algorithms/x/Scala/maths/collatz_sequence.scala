// Generated by Mochi v0.10.66 on 2025-08-16 14:53:58 GMT+7
...
def main(): Any = {
  var n: BigInt = BigInt(11)
  var seq: ArrayBuffer[BigInt] = collatz_sequence(n)
  println(_str(_str(seq)))
  println(_str("Collatz sequence from " + _str(n) + " took " + _str(BigInt((seq).size)) + " steps."))
}

// Generated by Mochi v0.10.59 on 2025-08-07 12:49:27 GMT+7
...
def dodecahedron_surface_area(edge: BigInt): Double = {
  ...
  val term: Double = sqrtApprox(25.0 + 10.0 * sqrtApprox(5.0))
  val e: Double = edge.toString.toDouble
  return 3.0 * term * e * e
}
...
def dodecahedron_volume(edge: BigInt): Double = {
  ...
  val term: Double = (15.0 + 7.0 * sqrtApprox(5.0)) / 4.0
  val e: Double = edge.toString.toDouble
  return term * e * e * e
}
...
def main(): Any = {
  test_dodecahedron()
  println(dodecahedron_surface_area(BigInt(5)))
  println(dodecahedron_volume(BigInt(5)))
}

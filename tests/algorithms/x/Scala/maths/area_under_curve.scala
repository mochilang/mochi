// Generated by Mochi v0.10.59 on 2025-08-07 12:46:45 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    while (i <= BigInt(100000)) {
      val result: Double = trapezoidal_area((f _).asInstanceOf[(Double) => Double], -5.0, 5.0, i)
      println("with " + String.valueOf(i) + " steps: " + String.valueOf(result))
      i = i * BigInt(10)
    }
    val _end = _now()
    System.gc()

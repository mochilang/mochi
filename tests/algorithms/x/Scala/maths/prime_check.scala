// Generated by Mochi v0.10.61 on 2025-08-08 16:06:49 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    println(_str(is_prime(BigInt(27))))
    println(_str(is_prime(BigInt(87))))
    println(_str(is_prime(BigInt(563))))
    println(_str(is_prime(BigInt(2999))))
    println(_str(is_prime(BigInt(67483))))
    val _end = _now()
    System.gc()

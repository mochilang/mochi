// Generated by Mochi v0.10.59 on 2025-08-07 12:47:15 GMT+7
...
def sort_int(xs: ArrayBuffer[BigInt]): ArrayBuffer[BigInt] = {
  ...
  while (i < BigInt((arr).size)) {
    ...
    while (j < BigInt((arr).size)) {
      if (arr((j.toInt).toInt) < arr((i.toInt).toInt)) {
        val tmp: BigInt = arr((i.toInt).toInt)
...
def sort_string(xs: ArrayBuffer[String]): ArrayBuffer[String] = {
  ...
  while (i < BigInt((arr).size)) {
    ...
    while (j < BigInt((arr).size)) {
      if (arr((j.toInt).toInt) < arr((i.toInt).toInt)) {
        val tmp: String = arr((i.toInt).toInt)
        arr((i).toInt) = arr((j.toInt).toInt)
        arr((j).toInt) = tmp
      }
      j = j + BigInt(1)
...
def mode_int(lst: ArrayBuffer[BigInt]): ArrayBuffer[BigInt] = {
  ...
  while (i < BigInt((lst).size)) {
    counts = counts :+ count_int(lst, lst((i.toInt).toInt))
    i = i + BigInt(1)
  }
  var max_count: BigInt = BigInt(0)
  i = BigInt(0)
  while (i < BigInt((counts).size)) {
    if (counts((i.toInt).toInt) > max_count) {
      max_count = counts((i.toInt).toInt)
    }
    i = i + BigInt(1)
  }
  ...
  while (i < BigInt((lst).size)) {
    if (counts((i.toInt).toInt) == max_count) {
      val v: BigInt = lst((i.toInt).toInt)
...
def mode_string(lst: ArrayBuffer[String]): ArrayBuffer[String] = {
  ...
  var i: BigInt = BigInt(0)
  while (i < BigInt((lst).size)) {
    counts = counts :+ count_string(lst, lst((i.toInt).toInt))
    i = i + BigInt(1)
  }
  var max_count: BigInt = BigInt(0)
  i = BigInt(0)
  ...
  while (i < BigInt((lst).size)) {
    if (counts((i.toInt).toInt) == max_count) {
      val v: String = lst((i.toInt).toInt)
...
def main(args: Array[String]): Unit = {
  {
    ...
    val _start = _now()
    println(mode_int(ArrayBuffer(BigInt(2), BigInt(3), BigInt(4), BigInt(5), BigInt(3), BigInt(4), BigInt(2), BigInt(5), BigInt(2), BigInt(2), BigInt(4), BigInt(2), BigInt(2), BigInt(2))))
    println(mode_int(ArrayBuffer(BigInt(3), BigInt(4), BigInt(5), BigInt(3), BigInt(4), BigInt(2), BigInt(5), BigInt(2), BigInt(2), BigInt(4), BigInt(4), BigInt(2), BigInt(2), BigInt(2))))
    println(mode_int(ArrayBuffer(BigInt(3), BigInt(4), BigInt(5), BigInt(3), BigInt(4), BigInt(2), BigInt(5), BigInt(2), BigInt(2), BigInt(4), BigInt(4), BigInt(4), BigInt(2), BigInt(2), BigInt(4), BigInt(2))))
    println(mode_string(ArrayBuffer("x", "y", "y", "z")))
    println(mode_string(ArrayBuffer("x", "x", "y", "y", "z")))
    val _end = _now()
    System.gc()

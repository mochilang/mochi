// Generated by Mochi v0.10.63 on 2025-08-12 08:00:39 GMT+7
...
def dual_mul(a: Dual, b: Dual): Dual = {
  ...
  while (i < BigInt((a.asInstanceOf[Dual].duals).size)) {
    ...
    while (j < BigInt((b.asInstanceOf[Dual].duals).size)) {
      ...
      val `val`: Double = new_duals.lift((pos.toInt).toInt).getOrElse(0.0) + a.asInstanceOf[Dual].duals.lift((i.toInt).toInt).getOrElse(0.0) * b.asInstanceOf[Dual].duals.lift((j.toInt).toInt).getOrElse(0.0)
  ...
  while (k < BigInt((a.asInstanceOf[Dual].duals).size)) {
    val `val`: Double = new_duals.lift((k.toInt).toInt).getOrElse(0.0) + a.asInstanceOf[Dual].duals.lift((k.toInt).toInt).getOrElse(0.0) * b.asInstanceOf[Dual].real
    new_duals((k).toInt) = `val`
    k = k + BigInt(1)
  }
  var l: BigInt = BigInt(0)
  while (l < BigInt((b.asInstanceOf[Dual].duals).size)) {
    val `val`: Double = new_duals.lift((l.toInt).toInt).getOrElse(0.0) + b.asInstanceOf[Dual].duals.lift((l.toInt).toInt).getOrElse(0.0) * a.asInstanceOf[Dual].real
...
def main(): Any = {
  ...
  val res: Double = differentiate(f, 9.0, BigInt(2))
  println(res)
  return null
}

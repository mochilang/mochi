// Generated by Mochi v0.10.61 on 2025-08-08 16:14:23 GMT+7
...
def int_to_base(number: BigInt, base: BigInt): String = {
  if ((base < BigInt(2) || base > BigInt(36)).asInstanceOf[Boolean]) {
...
def base_to_int(num_str: String, base: BigInt): BigInt = {
  ...
  while (i < BigInt((num_str).size)) {
    val c: String = num_str.slice((i.toInt).toInt, (i.toInt).toInt + 1)
...
def sum_of_digits(num: BigInt, base: BigInt): String = {
  ...
  val num_str: String = int_to_base(num, base)
...
def harshad_numbers_in_base(limit: BigInt, base: BigInt): ArrayBuffer[String] = {
  ...
  while (i < limit) {
    val s: String = sum_of_digits(i, base)
    val divisor: BigInt = base_to_int(s, base)
...
def is_harshad_number_in_base(num: BigInt, base: BigInt): Boolean = {
  ...
  val n: String = int_to_base(num, base)
  val d: String = sum_of_digits(num, base)
  val n_val: BigInt = base_to_int(n, base)
  val d_val: BigInt = base_to_int(d, base)
  return n_val % d_val == BigInt(0)
}

def main(): Any = {
  println(int_to_base(BigInt(0), BigInt(21)))
  println(int_to_base(BigInt(23), BigInt(2)))
  println(int_to_base(BigInt(58), BigInt(5)))
  println(int_to_base(BigInt(167), BigInt(16)))
  println(sum_of_digits(BigInt(103), BigInt(12)))
  println(sum_of_digits(BigInt(1275), BigInt(4)))
  println(sum_of_digits(BigInt(6645), BigInt(2)))
  println(harshad_numbers_in_base(BigInt(15), BigInt(2)))
  println(harshad_numbers_in_base(BigInt(12), BigInt(34)))
  println(harshad_numbers_in_base(BigInt(12), BigInt(4)))
  println(is_harshad_number_in_base(BigInt(18), BigInt(10)))
  println(is_harshad_number_in_base(BigInt(21), BigInt(10)))
  println(is_harshad_number_in_base(-BigInt(21), BigInt(5)))
}

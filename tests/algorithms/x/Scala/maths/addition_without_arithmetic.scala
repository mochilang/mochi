// Generated by Mochi v0.10.59 on 2025-08-07 12:46:08 GMT+7
...
def add(a: BigInt, b: BigInt): BigInt = {
  ...
  while (second != BigInt(0)) {
    val carry: BigInt = bit_and(first, second)
    first = bit_xor(first, second)
    second = lshift1(carry)
  }
  val result: BigInt = from_unsigned(first)
  return result
}

val MAX: BigInt = BigInt("4294967296")

val HALF: BigInt = BigInt("2147483648")
...
def main(args: Array[String]): Unit = {
  {
    ...
    val _start = _now()
    println(String.valueOf(add(BigInt(3), BigInt(5))))
    println(String.valueOf(add(BigInt(13), BigInt(5))))
    println(String.valueOf(add(-BigInt(7), BigInt(2))))
    println(String.valueOf(add(BigInt(0), -BigInt(7))))
    println(String.valueOf(add(-BigInt(321), BigInt(0))))
    val _end = _now()
    System.gc()

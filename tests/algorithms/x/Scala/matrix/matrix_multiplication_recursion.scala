// Generated by Mochi v0.10.61 on 2025-08-08 19:10:12 GMT+7
...
def matrix_multiply(a: ArrayBuffer[ArrayBuffer[BigInt]], b: ArrayBuffer[ArrayBuffer[BigInt]]): ArrayBuffer[ArrayBuffer[BigInt]] = {
  ...
  while (i < rows) {
    ...
    while (j < cols) {
      ...
      while (k < inner) {
        sum = sum + a.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((k.toInt).toInt).getOrElse(null) * b.lift((k.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((j.toInt).toInt).getOrElse(null)
        k = k + BigInt(1)
      }
      row = row :+ (sum)
      j = j + BigInt(1)
...
def multiply(i: BigInt, j: BigInt, k: BigInt, a: ArrayBuffer[ArrayBuffer[BigInt]], b: ArrayBuffer[ArrayBuffer[BigInt]], result: ArrayBuffer[ArrayBuffer[BigInt]], n: BigInt, m: BigInt): Any = {
  ...
  result((i).toInt)((j).toInt) = result.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((j.toInt).toInt).getOrElse(null) + a.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((k.toInt).toInt).getOrElse(null) * b.lift((k.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((j.toInt).toInt).getOrElse(null)

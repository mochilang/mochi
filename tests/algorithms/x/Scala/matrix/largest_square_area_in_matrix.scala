// Generated by Mochi v0.10.61 on 2025-08-08 17:46:12 GMT+7
...
def update_area_of_max_square(row: BigInt, col: BigInt, rows: BigInt, cols: BigInt, mat: ArrayBuffer[ArrayBuffer[BigInt]], largest_square_area: ArrayBuffer[BigInt]): BigInt = {
  ...
  if (mat.lift((row.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((col.toInt).toInt).getOrElse(null) == BigInt(1)) {
    val sub: BigInt = BigInt(1) + ArrayBuffer(right, diagonal, down).min
    if (sub > largest_square_area.lift((BigInt(0).toInt).toInt).getOrElse(null)) {
...
def largest_square_area_in_matrix_top_down(rows: BigInt, cols: BigInt, mat: ArrayBuffer[ArrayBuffer[BigInt]]): BigInt = {
  ...
  return largest.lift((BigInt(0).toInt).toInt).getOrElse(null)
}
...
def update_area_of_max_square_with_dp(row: BigInt, col: BigInt, rows: BigInt, cols: BigInt, mat: ArrayBuffer[ArrayBuffer[BigInt]], dp_array: ArrayBuffer[ArrayBuffer[BigInt]], largest_square_area: ArrayBuffer[BigInt]): BigInt = {
  ...
  if (dp_array.lift((row.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((col.toInt).toInt).getOrElse(null) != -BigInt(1)) {
    return dp_array.lift((row.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((col.toInt).toInt).getOrElse(null)
  }
...
def largest_square_area_in_matrix_bottom_up(rows: BigInt, cols: BigInt, mat: ArrayBuffer[ArrayBuffer[BigInt]]): BigInt = {
  ...
  while (row >= BigInt(0)) {
    ...
    while (col >= BigInt(0)) {
      val right: BigInt = dp_array.lift((row.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift(((col + BigInt(1)).toInt).toInt).getOrElse(null)
      val diagonal: BigInt = dp_array.lift(((row + BigInt(1)).toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift(((col + BigInt(1)).toInt).toInt).getOrElse(null)
      val bottom: BigInt = dp_array.lift(((row + BigInt(1)).toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((col.toInt).toInt).getOrElse(null)
      if (mat.lift((row.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((col.toInt).toInt).getOrElse(null) == BigInt(1)) {
...
def largest_square_area_in_matrix_bottom_up_space_optimization(rows: BigInt, cols: BigInt, mat: ArrayBuffer[ArrayBuffer[BigInt]]): BigInt = {
  ...
  while (row >= BigInt(0)) {
    var col: BigInt = cols - BigInt(1)
    while (col >= BigInt(0)) {
      val right: BigInt = current_row.lift(((col + BigInt(1)).toInt).toInt).getOrElse(null)
      val diagonal: BigInt = next_row.lift(((col + BigInt(1)).toInt).toInt).getOrElse(null)
      val bottom: BigInt = next_row.lift((col.toInt).toInt).getOrElse(null)
      if (mat.lift((row.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((col.toInt).toInt).getOrElse(null) == BigInt(1)) {
        val value: BigInt = BigInt(1) + ArrayBuffer(right, diagonal, bottom).min
    ...
    while (t <= cols) {
      current_row = current_row :+ (BigInt(0).asInstanceOf[Any])
      t = t + BigInt(1)
    }
    row = row - BigInt(1)
  }

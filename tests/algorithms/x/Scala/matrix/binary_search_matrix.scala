// Generated by Mochi v0.10.61 on 2025-08-08 19:01:06 GMT+7
...
def binary_search(arr: ArrayBuffer[BigInt], lower_bound: BigInt, upper_bound: BigInt, value: BigInt): BigInt = {
  ...
  if (arr.lift((r.toInt).toInt).getOrElse(null) == value) {
    return r
  }
...
def mat_bin_search(value: BigInt, matrix: ArrayBuffer[ArrayBuffer[BigInt]]): ArrayBuffer[BigInt] = {
  ...
  if (matrix.lift((index.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((BigInt(0).toInt).toInt).getOrElse(null) == value) {
    return ArrayBuffer(index, BigInt(0))
  }
  while (index < BigInt((matrix).size) && matrix.lift((index.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((BigInt(0).toInt).toInt).getOrElse(null) < value) {

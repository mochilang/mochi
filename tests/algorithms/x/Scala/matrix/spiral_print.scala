// Generated by Mochi v0.10.61 on 2025-08-08 19:11:59 GMT+7
...
def spiral_traversal(matrix: ArrayBuffer[ArrayBuffer[BigInt]]): ArrayBuffer[BigInt] = {
  ...
  while (left <= right && top <= bottom) {
    var i: BigInt = left
    while (i <= right) {
      result = result :+ (matrix.lift((top.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((i.toInt).toInt).getOrElse(null))
      i = i + BigInt(1)
    }
    top = top + BigInt(1)
    i = top
    while (i <= bottom) {
      result = result :+ (matrix.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((right.toInt).toInt).getOrElse(null))
      i = i + BigInt(1)
    }
    ...
    if (top <= bottom) {
      i = right
      while (i >= left) {
        result = result :+ (matrix.lift((bottom.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((i.toInt).toInt).getOrElse(null))
        i = i - BigInt(1)
      }
    ...
    if (left <= right) {
      i = bottom
      while (i >= top) {
        result = result :+ (matrix.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((left.toInt).toInt).getOrElse(null))
        i = i - BigInt(1)
      }
      left = left + BigInt(1)
    }

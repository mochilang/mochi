// Generated by Mochi v0.10.61 on 2025-08-08 17:04:30 GMT+7
...
def spiral_traversal(matrix: ArrayBuffer[ArrayBuffer[BigInt]]): ArrayBuffer[BigInt] = {
  ...
  while (left <= right && top <= bottom) {
    var i: BigInt = left
    while (i <= right) {
      result = result :+ (matrix((top.toInt).toInt)((i.toInt).toInt))
      i = i + BigInt(1)
    }
    top = top + BigInt(1)
    i = top
    while (i <= bottom) {
      result = result :+ (matrix((i.toInt).toInt)((right.toInt).toInt))
      i = i + BigInt(1)
    }
    ...
    if (top <= bottom) {
      i = right
      while (i >= left) {
        result = result :+ (matrix((bottom.toInt).toInt)((i.toInt).toInt))
        i = i - BigInt(1)
      }
    ...
    if (left <= right) {
      i = bottom
      while (i >= top) {
        result = result :+ (matrix((i.toInt).toInt)((left.toInt).toInt))
        i = i - BigInt(1)
      }
      left = left + BigInt(1)
    }

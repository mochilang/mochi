// Generated by Mochi v0.10.61 on 2025-08-08 17:04:42 GMT+7
...
def check_matrix(mat: ArrayBuffer[ArrayBuffer[Double]]): Any = {
  if ((BigInt((mat).size) < BigInt(2) || BigInt((mat((BigInt(0).toInt).toInt)).size) < BigInt(2)).asInstanceOf[Boolean]) {
...
def add(a: ArrayBuffer[ArrayBuffer[Double]], b: ArrayBuffer[ArrayBuffer[Double]]): ArrayBuffer[ArrayBuffer[Double]] = {
  check_matrix(a)
  check_matrix(b)
  if ((BigInt((a).size) != BigInt((b).size) || BigInt((a((BigInt(0).toInt).toInt)).size) != BigInt((b((BigInt(0).toInt).toInt)).size)).asInstanceOf[Boolean]) {
...
def scalar_multiply(a: ArrayBuffer[ArrayBuffer[Double]], s: Double): ArrayBuffer[ArrayBuffer[Double]] = {
  ...
  while (i < rows) {
    ...
    var j: BigInt = BigInt(0)
    while (j < cols) {
      row = row :+ (a((i.toInt).toInt)((j.toInt).toInt) * s)
      j = j + BigInt(1)
    }
    result = result :+ (row)
    i = i + BigInt(1)
...
def multiply(a: ArrayBuffer[ArrayBuffer[Double]], b: ArrayBuffer[ArrayBuffer[Double]]): ArrayBuffer[ArrayBuffer[Double]] = {
  check_matrix(a)
  check_matrix(b)
  if (BigInt((a((BigInt(0).toInt).toInt)).size) != BigInt((b).size)) {

// Generated by Mochi v0.10.72 on 2025-08-24 22:28:40 GMT+7
...
def push(stack: Stack, item: String): Stack = {
  var new_node: Node = Node(item, stack.asInstanceOf[Stack].top)
  var new_nodes: ArrayBuffer[Node] = stack.asInstanceOf[Stack].nodes
  new_nodes = ({new_nodes += (new_node); new_nodes})
  var new_top: BigInt = BigInt((new_nodes).size) - BigInt(1)
...
def pop(stack: Stack): PopResult = {
  ...
  var node: Node = stack.asInstanceOf[Stack].nodes.lift((stack.asInstanceOf[Stack].top.toInt).toInt).getOrElse(null)
  var new_top: BigInt = node.asInstanceOf[Node].next
  var new_stack: Stack = Stack(stack.asInstanceOf[Stack].nodes, new_top)

// Generated by Mochi v0.10.72 on 2025-08-24 22:28:54 GMT+7
...
def search(tree: SuffixTree, pattern: String): Boolean = {
  var n: BigInt = BigInt((tree.asInstanceOf[SuffixTree].text).length)
...
def main(): Any = {
  ...
  var patterns: ArrayBuffer[String] = ArrayBuffer("ana", "ban", "na", "xyz", "mon")
  var i: BigInt = BigInt(0)
  while (i < BigInt((patterns).size)) {
    var pattern: String = patterns.lift((i.toInt).toInt).getOrElse("")

// Generated by Mochi v0.10.72 on 2025-08-24 22:26:17 GMT+7
...
def dequeue(q: CircularQueue): DequeueResult = {
  ...
  var value: BigInt = q.asInstanceOf[CircularQueue].data.lift((q.asInstanceOf[CircularQueue].front.toInt).toInt).getOrElse(BigInt(0))

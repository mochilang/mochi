// Generated by Mochi v0.10.72 on 2025-08-24 22:25:22 GMT+7
...
def main(): Any = {
  var test_data_odd: ArrayBuffer[BigInt] = ArrayBuffer(BigInt(3), BigInt(9), BigInt(-11), BigInt(0), BigInt(7), BigInt(5), BigInt(1), BigInt(-1))
  var test_data_even: ArrayBuffer[BigInt] = ArrayBuffer(BigInt(4), BigInt(6), BigInt(2), BigInt(0), BigInt(8), BigInt(10), BigInt(3), BigInt(-2))

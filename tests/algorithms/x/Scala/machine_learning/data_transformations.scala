// Generated by Mochi v0.10.59 on 2025-08-07 12:42:46 GMT+7
...
def mean(data: ArrayBuffer[Double]): Double = {
  ...
  while (i < n) {
    total = total + data((i.toInt).toInt)
    i = i + BigInt(1)
  }
...
def stdev(data: ArrayBuffer[Double]): Double = {
  ...
  var i: BigInt = BigInt(0)
  while (i < n) {
    val diff: Double = data((i.toInt).toInt) - m
    sum_sq = sum_sq + diff * diff
    i = i + BigInt(1)
  }
  return sqrtApprox(sum_sq / (n - BigInt(1)).toString.toDouble)
}
...
def normalization(data: ArrayBuffer[Double], ndigits: BigInt): ArrayBuffer[Double] = {
  ...
  val n: BigInt = BigInt((data).size)
  while (i < n) {
    val norm: Double = (data((i.toInt).toInt) - x_min) / denom
...
def standardization(data: ArrayBuffer[Double], ndigits: BigInt): ArrayBuffer[Double] = {
  ...
  val n: BigInt = BigInt((data).size)
  while (i < n) {
    val z: Double = (data((i.toInt).toInt) - mu) / sigma
...
def main(args: Array[String]): Unit = {
  {
    ...
    val _start = _now()
    println(String.valueOf(normalization(ArrayBuffer(2.0, 7.0, 10.0, 20.0, 30.0, 50.0), BigInt(3))))
    println(String.valueOf(normalization(ArrayBuffer(5.0, 10.0, 15.0, 20.0, 25.0), BigInt(3))))
    println(String.valueOf(standardization(ArrayBuffer(2.0, 7.0, 10.0, 20.0, 30.0, 50.0), BigInt(3))))
    println(String.valueOf(standardization(ArrayBuffer(5.0, 10.0, 15.0, 20.0, 25.0), BigInt(3))))
    val _end = _now()
    System.gc()

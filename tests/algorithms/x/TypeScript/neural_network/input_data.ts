// Generated by Mochi v0.10.69 on 2025-08-22 13:10:51 GMT+7
...
function next_batch(ds: DataSet, batch_size: number): BatchResult {
  ...
  if (((start + batch_size) > ds.num_examples)) {
    ...
    let end: bigint = (start + batch_size);

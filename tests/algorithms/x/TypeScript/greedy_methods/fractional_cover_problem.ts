// Generated by Mochi v0.10.59 on 2025-08-06 23:28:58 GMT+7
...
function fractional_cover(items: Item[], capacity: number): number {
  ...
  while (((idx < _len(sorted)) && (remaining > 0))) {
    let item: Item = sorted[(idx) < 0 ? sorted.length + (idx) : idx];
...
(() => {
  ...
  const _start = _now()
  console.log(_str(_str(fractional_cover(items1, 50))));
  console.log(_str(_str(fractional_cover(items2, 25))));
  console.log(_str(_str(fractional_cover(items3, 50))));
  console.log(_str(_str(fractional_cover(items4, 5))));
  console.log(_str(_str(fractional_cover(items4, 1))));
  console.log(_str(_str(fractional_cover(items4, 0))));
  const _end = _now()

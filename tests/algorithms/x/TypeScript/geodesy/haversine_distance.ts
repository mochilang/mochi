// Generated by Mochi v0.10.59 on 2025-08-06 22:15:24 GMT+7
...
YOSEMITE = [37.864742, -119.537521]
  console.log(_str(_str(haversine_distance(SAN_FRANCISCO[(Math.trunc(0)) < 0 ? SAN_FRANCISCO.length + (Math.trunc(0)) : Math.trunc(0)], SAN_FRANCISCO[(Math.trunc(1)) < 0 ? SAN_FRANCISCO.length + (Math.trunc(1)) : Math.trunc(1)], YOSEMITE[(Math.trunc(0)) < 0 ? YOSEMITE.length + (Math.trunc(0)) : Math.trunc(0)], YOSEMITE[(Math.trunc(1)) < 0 ? YOSEMITE.length + (Math.trunc(1)) : Math.trunc(1)]))));
  const _end = _now()

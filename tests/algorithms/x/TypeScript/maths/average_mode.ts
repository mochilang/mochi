...
function mode_int(lst: number[]): number[] {
  ...
  let i: number = 0;
  while ((i < _len(lst))) {
    counts.push(count_int(lst, lst[(i) < 0 ? lst.length + (i) : i]));
    i = (i + 1);
  }
  let max_count: number = 0;
  i = 0;
  while ((i < _len(counts))) {
    if ((counts[(i) < 0 ? counts.length + (i) : i] > max_count)) {
      max_count = counts[(i) < 0 ? counts.length + (i) : i];
    }
    i = (i + 1);
  }
  let modes: number[] = [];
  ...
  while ((i < _len(lst))) {
    if ((counts[(i) < 0 ? counts.length + (i) : i] == max_count)) {
      let v: number = lst[(i) < 0 ? lst.length + (i) : i];
...
function mode_string(lst: string[]): string[] {
  ...
  let i: number = 0;
  while ((i < _len(lst))) {
    counts.push(count_string(lst, lst[(i) < 0 ? lst.length + (i) : i]));
    i = (i + 1);
  }
  let max_count: number = 0;
  i = 0;
  ...
  while ((i < _len(lst))) {
    if ((counts[(i) < 0 ? counts.length + (i) : i] == max_count)) {
      let v: string = lst[(i) < 0 ? lst.length + (i) : i];
...
(() => {
  ...
  const _start = _now()
  console.log(_str("[" + (mode_int([2, 3, 4, 5, 3, 4, 2, 5, 2, 2, 4, 2, 2, 2])).join(' ') + "]"));
  console.log(_str("[" + (mode_int([3, 4, 5, 3, 4, 2, 5, 2, 2, 4, 4, 2, 2, 2])).join(' ') + "]"));
  console.log(_str("[" + (mode_int([3, 4, 5, 3, 4, 2, 5, 2, 2, 4, 4, 4, 2, 2, 4, 2])).join(' ') + "]"));
  console.log(_str("[" + (mode_string(["x", "y", "y", "z"])).join(' ') + "]"));
  console.log(_str("[" + (mode_string(["x", "x", "y", "y", "z"])).join(' ') + "]"));
  const _end = _now()

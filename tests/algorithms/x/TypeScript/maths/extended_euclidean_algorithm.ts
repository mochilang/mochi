// Generated by Mochi v0.10.59 on 2025-08-07 00:17:14 GMT+7
...
function extended_euclidean_algorithm(a: number, b: number): Coeffs {
  ...
  while ((remainder != 0)) {
    ...
    let temp_remainder: number = (old_remainder - (quotient * remainder));
    old_remainder = remainder;
    remainder = temp_remainder;
    let temp_a: number = (old_coeff_a - (quotient * coeff_a));
    old_coeff_a = coeff_a;
    coeff_a = temp_a;
    let temp_b: number = (old_coeff_b - (quotient * coeff_b));
    old_coeff_b = coeff_b;
    coeff_b = temp_b;
  }
  if ((a < 0)) {

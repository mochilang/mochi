// Generated by Mochi v0.10.59 on 2025-08-07 00:17:44 GMT+7
...
(() => {
  ...
  const _start = _now()
  console.log(_str(_str(maclaurin_sin(10.0, 30))));
  console.log(_str(_str(maclaurin_sin(-10.0, 30))));
  console.log(_str(_str(maclaurin_sin(10.0, 15))));
  console.log(_str(_str(maclaurin_sin(-10.0, 15))));
  console.log(_str(_str(maclaurin_cos(5.0, 30))));
  console.log(_str(_str(maclaurin_cos(-5.0, 30))));
  console.log(_str(_str(maclaurin_cos(10.0, 15))));
  console.log(_str(_str(maclaurin_cos(-10.0, 15))));
  const _end = _now()

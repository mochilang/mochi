// Generated by Mochi v0.10.59 on 2025-08-07 00:24:32 GMT+7

function triangular_number(position: number): number {
  if ((position < 0)) {
    _panic("position must be non-negative");
  }
  return Math.trunc((position * (position + 1)) / 2);
}
...
function main() {
  ...
  console.log(_str(triangular_number(10)));
}
var _nowSeed = 0;

// Generated by Mochi v0.10.59 on 2025-08-07 00:17:23 GMT+7
...
function gaussian(x: number, mu: number, sigma: number): number {
  let coeff: number = (1.0 / sqrtApprox((((2.0 * PI) * sigma) * sigma)));
  let exponent: number = (-((x - mu) * (x - mu)) / ((2.0 * sigma) * sigma));
  return (coeff * expApprox(exponent));
}
function main() {
  let result: number = gaussian(1.0, 0.0, 1.0);

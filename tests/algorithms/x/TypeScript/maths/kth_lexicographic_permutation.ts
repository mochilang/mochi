// Generated by Mochi v0.10.63 on 2025-08-12 07:59:22 GMT+7
...
function kth_permutation(k: number, n: number): number[] {
  ...
  let total: number = (factorials[(()=>{const _mochi_idx = Math.trunc((_len(factorials) - 1)); return _mochi_idx < 0 ? factorials.length + _mochi_idx : _mochi_idx;})()] * n);
  if (((k < 0) || (k >= total))) {

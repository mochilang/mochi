...
function main() {
  set_seed(10);
  console.log(_str(_str(solovay_strassen(13, 5))));
  console.log(_str(_str(solovay_strassen(9, 10))));
  console.log(_str(_str(solovay_strassen(17, 15))));
}
var _nowSeed = 0;

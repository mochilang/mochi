// Generated by Mochi v0.10.59 on 2025-08-07 00:17:01 GMT+7
...
e2 = extended_euclid(7, 5)
  ...
  console.log(_str(_str(chinese_remainder_theorem(5, 1, 7, 3))));
  console.log(_str(_str(chinese_remainder_theorem(6, 1, 4, 3))));
  console.log(_str(_str(invert_modulo(2, 5))));
  console.log(_str(_str(invert_modulo(8, 7))));
  console.log(_str(_str(chinese_remainder_theorem2(5, 1, 7, 3))));
  console.log(_str(_str(chinese_remainder_theorem2(6, 1, 4, 3))));
  const _end = _now()

// Generated by Mochi v0.10.59 on 2025-08-07 00:17:35 GMT+7
...
function josephus_iterative(num_people: number, step_size: number): number {
  ...
  return circle[(Math.trunc(0)) < 0 ? circle.length + (Math.trunc(0)) : Math.trunc(0)];
}
var _nowSeed = 0;
...
r = josephus_recursive(7, 3)
  ...
  console.log(_str(_str(find_winner(7, 3))));
  console.log(_str(_str(josephus_iterative(7, 3))));
  const _end = _now()

// Generated by Mochi v0.10.69 on 2025-08-19 16:45:36 GMT+7
...
(() => {
  ...
  const _start = _now()
  console.log(_str(terminal_velocity(1.0, 25.0, 0.6, 0.77)));
  console.log(_str(terminal_velocity(2.0, 100.0, 0.45, 0.23)));
  console.log(_str(terminal_velocity(5.0, 50.0, 0.2, 0.5)));
  const _end = _now()

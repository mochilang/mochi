// Generated by Mochi v0.10.63 on 2025-08-11 14:53:44 GMT+7

function centripetal(mass: number, velocity: number, radius: number): number {
  if ((mass < 0.0)) {
...
function show(mass: number, velocity: number, radius: number) {
  let f: number = centripetal(mass, velocity, radius);
  console.log(_str(_str(round(f, 2))));
}
var _nowSeed = 0;

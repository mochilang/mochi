// Generated by Mochi v0.10.59 on 2025-08-07 08:17:59 GMT+7
...
(() => {
  ...
  const _start = _now()
  console.log(_str(_str(get_altitude_at_pressure(100000.0))));
  console.log(_str(_str(get_altitude_at_pressure(101325.0))));
  console.log(_str(_str(get_altitude_at_pressure(80000.0))));
  const _end = _now()

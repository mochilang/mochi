// Generated by Mochi v0.10.69 on 2025-08-19 16:42:05 GMT+7

function apply_table(inp: string, table: number[]): string {
  let res: string = "";
  let i: number = 0;
  while ((i < _len(table))) {
    let idx: bigint = (table[(()=>{const _mochi_idx = i; return _mochi_idx < 0 ? table.length + _mochi_idx : _mochi_idx;})()] - 1);
    if ((idx < 0)) {
      idx = (_len(inp) - 1);
    }

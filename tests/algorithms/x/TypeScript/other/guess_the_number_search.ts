// Generated by Mochi v0.10.59 on 2025-08-07 08:17:42 GMT+7
...
function guess_the_number(lower: number, higher: number, to_guess: number): number[] {
  ...
  console.log(_str(("guess the number : " + _str(last_numbers[(Math.trunc((_len(last_numbers) - 1))) < 0 ? last_numbers.length + (Math.trunc((_len(last_numbers) - 1))) : Math.trunc((_len(last_numbers) - 1))]))));

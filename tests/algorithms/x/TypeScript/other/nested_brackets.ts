// Generated by Mochi v0.10.59 on 2025-08-07 08:17:52 GMT+7
  ...
  while ((i < _len(s))) {
    ...
    if ((_symbol in OPEN_TO_CLOSED)) {
      ...
      if ((((_symbol == ")") || (_symbol == "]")) || (_symbol == "}"))) {
        ...
        let top: string = stack[(Math.trunc((_len(stack) - 1))) < 0 ? stack.length + (Math.trunc((_len(stack) - 1))) : Math.trunc((_len(stack) - 1))];
        if ((OPEN_TO_CLOSED[(top) < 0 ? OPEN_TO_CLOSED.length + (top) : top] != _symbol)) {
          return false;
        }

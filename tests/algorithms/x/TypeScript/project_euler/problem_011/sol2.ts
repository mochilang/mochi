// Generated by Mochi v0.10.59 on 2025-08-07 08:19:17 GMT+7
...
function max_product_four(grid: number[][]): number {
  ...
  while ((i < 20)) {
    let j: number = 0;
    while ((j < 17)) {
      let temp: number = (((grid[(i) < 0 ? grid.length + (i) : i][(j) < 0 ? grid[(i) < 0 ? grid.length + (i) : i].length + (j) : j] * grid[(i) < 0 ? grid.length + (i) : i][(Math.trunc((j + 1))) < 0 ? grid[(i) < 0 ? grid.length + (i) : i].length + (Math.trunc((j + 1))) : Math.trunc((j + 1))]) * grid[(i) < 0 ? grid.length + (i) : i][(Math.trunc((j + 2))) < 0 ? grid[(i) < 0 ? grid.length + (i) : i].length + (Math.trunc((j + 2))) : Math.trunc((j + 2))]) * grid[(i) < 0 ? grid.length + (i) : i][(Math.trunc((j + 3))) < 0 ? grid[(i) < 0 ? grid.length + (i) : i].length + (Math.trunc((j + 3))) : Math.trunc((j + 3))]);
      if ((temp > maximum)) {
        maximum = temp;
      }
      j = (j + 1);
...
(() => {
  ...
  const _start = _now()
  console.log(_str(_str(max_product_four(grid))));
  const _end = _now()

// Generated by Mochi v0.10.59 on 2025-08-07 08:54:32 GMT+7
...
function solution(m: number): number {
  ...
  return (memo[(m) < 0 ? memo.length + (m) : m][(Math.trunc((m - 1))) < 0 ? memo[(m) < 0 ? memo.length + (m) : m].length + (Math.trunc((m - 1))) : Math.trunc((m - 1))] - 1);
}
var _nowSeed = 0;
...
(() => {
  ...
  console.log(_str(_str(solution(50))));
  console.log(_str(_str(solution(30))));
  console.log(_str(_str(solution(10))));
  console.log(_str(_str(solution(5))));
  console.log(_str(_str(solution(3))));
  console.log(_str(_str(solution(2))));

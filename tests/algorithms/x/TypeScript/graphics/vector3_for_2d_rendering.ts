// Generated by Mochi v0.10.59 on 2025-08-06 22:18:35 GMT+7
...
(() => {
  ...
  const _start = _now()
  console.log(_str(_str(convert_to_2d(1.0, 2.0, 3.0, 10.0, 10.0))));
  console.log(_str(_str(rotate(1.0, 2.0, 3.0, "y", 90.0))));
  const _end = _now()

// Generated by Mochi v0.10.59 on 2025-08-07 08:57:22 GMT+7
...
async function save_apod(api_key: string): ApodData {
  let apod: ApodData = get_apod_data(api_key);
  return apod;
}
...
async function main() {
  let apod: ApodData = save_apod("DEMO_KEY");
  console.log(_str(apod.title));
  let archive: ArchiveResult = get_archive_data("apollo 2011");

// Generated by Mochi v0.10.59 on 2025-08-07 08:57:18 GMT+7
...
function get_gifs(query: string): string[] {
  ...
  let gifs: Gif[] = JSON.parse(Deno.readTextFileSync("tests/github/TheAlgorithms/Mochi/web_programming/giphy.json"));
  let urls: string[] = [];
  for (const g of gifs) {
    urls.push(g.url);
  }

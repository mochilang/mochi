// Generated by Mochi v0.10.59 on 2025-08-07 08:57:10 GMT+7

export interface Quote { q: string; a: string; h: string }
async function quote_of_the_day(): Quote[] {
  return await _fetch("https://zenquotes.io/api/today");
}
async function random_quotes(): Quote[] {
  return await _fetch("https://zenquotes.io/api/random");
}
var _nowSeed = 0;
...
response = random_quotes()
  console.log(_str("[" + (response).join(' ') + "]"));
  const _end = _now()

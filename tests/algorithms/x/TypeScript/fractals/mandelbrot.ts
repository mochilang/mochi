// Generated by Mochi v0.10.59 on 2025-08-06 22:15:02 GMT+7
...
img1 = get_image(10, 10, -0.6, 0.0, 3.2, 50, true)
  console.log(_str(rgb_to_string(img1[(Math.trunc(0)) < 0 ? img1.length + (Math.trunc(0)) : Math.trunc(0)][(Math.trunc(0)) < 0 ? img1[(Math.trunc(0)) < 0 ? img1.length + (Math.trunc(0)) : Math.trunc(0)].length + (Math.trunc(0)) : Math.trunc(0)])));
img2 = get_image(10, 10, -0.6, 0.0, 3.2, 50, false)
  console.log(_str(rgb_to_string(img2[(Math.trunc(0)) < 0 ? img2.length + (Math.trunc(0)) : Math.trunc(0)][(Math.trunc(0)) < 0 ? img2[(Math.trunc(0)) < 0 ? img2.length + (Math.trunc(0)) : Math.trunc(0)].length + (Math.trunc(0)) : Math.trunc(0)])));
  const _end = _now()

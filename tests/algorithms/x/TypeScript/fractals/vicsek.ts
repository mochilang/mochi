// Generated by Mochi v0.10.59 on 2025-08-06 22:15:10 GMT+7
...
function vicsek(order: number): string[] {
  ...
  let i: number = 0;
  while ((i < size)) {
    result.push(((blank + prev[(i) < 0 ? prev.length + (i) : i]) + blank));
    i = (i + 1);
  }
  i = 0;
  while ((i < size)) {
    result.push(((prev[(i) < 0 ? prev.length + (i) : i] + prev[(i) < 0 ? prev.length + (i) : i]) + prev[(i) < 0 ? prev.length + (i) : i]));
    i = (i + 1);
  }
  i = 0;
  while ((i < size)) {
...
function print_pattern(pattern: string[]) {
  ...
  while ((i < _len(pattern))) {
    console.log(_str(pattern[(i) < 0 ? pattern.length + (i) : i]));
    i = (i + 1);
  }
}
function main() {

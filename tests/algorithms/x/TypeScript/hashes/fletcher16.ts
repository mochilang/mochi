// Generated by Mochi v0.10.61 on 2025-08-08 15:57:22 GMT+7
...
function ord(ch: string): number {
  ...
  while ((i < _len(ascii_chars))) {
    if ((ascii_chars[(()=>{const _mochi_idx = i; return _mochi_idx < 0 ? ascii_chars.length + _mochi_idx : _mochi_idx;})()] == ch)) {
      return (32 + i);
    }
    i = (i + 1);
  }
...
function fletcher16(text: string): number {
  let sum1: number = 0;
  let sum2: number = 0;
  let i: number = 0;
  while ((i < _len(text))) {

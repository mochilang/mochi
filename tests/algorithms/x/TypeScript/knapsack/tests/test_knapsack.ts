// Generated by Mochi v0.10.59 on 2025-08-07 00:03:37 GMT+7
...
function knapsack(capacity: number, weights: number[], values: number[], counter: number): number {
  ...
  let include_val = (values[(Math.trunc((counter - 1))) < 0 ? values.length + (Math.trunc((counter - 1))) : Math.trunc((counter - 1))] + knapsack(left_capacity, weights, values, (counter - 1)));

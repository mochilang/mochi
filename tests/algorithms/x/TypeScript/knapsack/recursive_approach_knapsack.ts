// Generated by Mochi v0.10.59 on 2025-08-06 23:29:19 GMT+7
...
function knapsack(weights: number[], values: number[], number_of_items: number, max_weight: number, index: number): number {
  ...
  let ans2: number = 0;
  if ((weights[(index) < 0 ? weights.length + (index) : index] <= max_weight)) {
    ans2 = (values[(index) < 0 ? values.length + (index) : index] + knapsack(weights, values, number_of_items, (max_weight - weights[(index) < 0 ? weights.length + (index) : index]), (index + 1)));
  }
  if ((ans1 > ans2)) {
    return ans1;
  }

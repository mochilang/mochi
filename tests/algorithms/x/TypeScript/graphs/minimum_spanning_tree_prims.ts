// Generated by Mochi v0.10.59 on 2025-08-07 00:02:36 GMT+7
  ...
  while ((count < n)) {
    ...
    for (const e of graph[(u) < 0 ? graph.length + (u) : u]) {
      if (((visited[(Math.trunc(e.to)) < 0 ? visited.length + (Math.trunc(e.to)) : Math.trunc(e.to)] == false) && (e.weight < dist[(Math.trunc(e.to)) < 0 ? dist.length + (Math.trunc(e.to)) : Math.trunc(e.to)]))) {
        dist[(e.to) < 0 ? dist.length + (e.to) : e.to] = e.weight;
        parent[(e.to) < 0 ? parent.length + (e.to) : e.to] = u;
      }
    }
    count = (count + 1);
  }

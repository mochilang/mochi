// Generated by Mochi v0.10.62 on 2025-08-09 10:36:16 GMT+7
...
function main() {
  console.log(_str(_str(simple_interest(18000.0, 0.06, 3.0))));
  console.log(_str(_str(simple_interest(0.5, 0.06, 3.0))));
  console.log(_str(_str(simple_interest(18000.0, 0.01, 10.0))));
  console.log(_str(_str(compound_interest(10000.0, 0.05, 3.0))));
  console.log(_str(_str(compound_interest(10000.0, 0.05, 1.0))));
  console.log(_str(_str(apr_interest(10000.0, 0.05, 3.0))));
  console.log(_str(_str(apr_interest(10000.0, 0.05, 1.0))));
}
var _nowSeed = 0;

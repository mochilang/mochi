// Generated by Mochi v0.10.59 on 2025-08-06 22:14:34 GMT+7
...
function present_value(discount_rate: number, cash_flows: number[]): number {
  ...
  while ((i < _len(cash_flows))) {
    let cf: number = cash_flows[(i) < 0 ? cash_flows.length + (i) : i];
...
(() => {
  ...
  const _start = _now()
  console.log(_str(_str(present_value(0.13, [10.0, 20.7, -293.0, 297.0]))));
  console.log(_str(_str(present_value(0.07, [-109129.39, 30923.23, 15098.93, 29734.0, 39.0]))));
  console.log(_str(_str(present_value(0.07, [109129.39, 30923.23, 15098.93, 29734.0, 39.0]))));
  const _end = _now()

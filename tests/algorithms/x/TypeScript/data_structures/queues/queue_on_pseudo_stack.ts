// Generated by Mochi v0.10.59 on 2025-08-06 21:31:35 GMT+7
...
function rotate(q: Queue, rotation: number): Queue {
  ...
  while (((i < rotation) && (_len(s) > 0))) {
    let temp: number = s[Math.trunc(0)];
    s = drop_first(s);
    s.push(temp);
    i = (i + 1);
  }
...
function _get(q: Queue): GetResult {
  ...
  let v: number = q1.stack[Math.trunc((q1.length - 1))];

// Generated by Mochi v0.10.61 on 2025-08-08 16:36:18 GMT+7
...
function push(lst: List, value: number): List {
  ...
  while ((i < _len(lst.data))) {
    res.push(lst.data[(()=>{const _mochi_idx = i; return _mochi_idx < 0 ? lst.data.length + _mochi_idx : _mochi_idx;})()]);
    i = (i + 1);
  }
  return {"data": res};
}
function middle_element(lst: List): number {
  ...
  return lst.data[(()=>{const _mochi_idx = slow; return _mochi_idx < 0 ? lst.data.length + _mochi_idx : _mochi_idx;})()];
}
function main() {

// Generated by Mochi v0.10.59 on 2025-08-06 21:31:01 GMT+7
...
function make_linked_list(elements: number[]): number {
  ...
  nodes = [];
  nodes.push({"data": elements[Math.trunc(0)], "next": NIL});
  let head: number = 0;
  let current: number = head;
  let i: number = 1;
  while ((i < _len(elements))) {
    nodes.push({"data": elements[i], "next": NIL});
    nodes[current].next = (_len(nodes) - 1);

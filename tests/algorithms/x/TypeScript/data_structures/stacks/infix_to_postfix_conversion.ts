// Generated by Mochi v0.10.61 on 2025-08-08 16:36:51 GMT+7
...
function precedence(ch: string): number {
  if ((ch in PRECEDENCES)) {
    return PRECEDENCES[(()=>{const _mochi_idx = ch; return _mochi_idx < 0 ? PRECEDENCES.length + _mochi_idx : _mochi_idx;})()];
  }
  return -1;
}
function associativity(ch: string): string {
  if ((ch in ASSOCIATIVITIES)) {
    return ASSOCIATIVITIES[(()=>{const _mochi_idx = ch; return _mochi_idx < 0 ? ASSOCIATIVITIES.length + _mochi_idx : _mochi_idx;})()];
  }
  return "";
}

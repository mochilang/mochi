// Generated by Mochi v0.10.59 on 2025-08-06 21:31:55 GMT+7
...
function push(stack: Stack, value: number): Stack {
  ...
  nodes.push(new_node);
  if ((stack.head != (0 - 1))) {
    let head_node: Node = nodes[Math.trunc(stack.head)];
    head_node.prev = idx;
...
function pop(stack: Stack): PopResult {
  ...
  if ((next_idx != (0 - 1))) {
    let next_node: Node = nodes[next_idx];
    next_node.prev = (0 - 1);
...
function top(stack: Stack): TopResult {
  ...
  let node: Node = stack.nodes[Math.trunc(stack.head)];

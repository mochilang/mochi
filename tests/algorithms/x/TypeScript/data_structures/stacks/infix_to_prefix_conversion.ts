// Generated by Mochi v0.10.59 on 2025-08-06 21:31:42 GMT+7
...
function infix_to_postfix(infix: string): string {
    ...
    if ((is_alpha(x) || is_digit(x))) {
      ...
      if ((x == "(")) {
        ...
        if ((x == ")")) {
          ...
          while ((stack[Math.trunc((_len(stack) - 1))] != "(")) {
            post.push(stack[Math.trunc((_len(stack) - 1))]);
          ...
          if ((_len(stack) == 0)) {
            ...
            while ((((_len(stack) > 0) && (stack[Math.trunc((_len(stack) - 1))] != "(")) && (PRIORITY[x] <= PRIORITY[stack[Math.trunc((_len(stack) - 1))]]))) {
              post.push(stack[Math.trunc((_len(stack) - 1))]);
              stack = stack.slice(0, (_len(stack) - 1));
            }
            stack.push(x);
  ...
  while ((_len(stack) > 0)) {
    if ((stack[Math.trunc((_len(stack) - 1))] == "(")) {

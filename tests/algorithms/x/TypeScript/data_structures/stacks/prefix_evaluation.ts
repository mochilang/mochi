// Generated by Mochi v0.10.59 on 2025-08-06 21:31:50 GMT+7
...
function to_int(token: string): number {
  ...
  let i: number = 0;
  while ((i < _len(token))) {
    res = ((res * 10) + (token).substring(i, (i + 1)).charCodeAt(0));
    i = (i + 1);
  }
  return res;
}
  ...
  while ((i >= 0)) {
    ...
    if ((token != "")) {
      if (is_operand(token)) {
        ...
        let o1: number = stack[Math.trunc((_len(stack) - 1))];
        let o2: number = stack[Math.trunc((_len(stack) - 2))];

// Generated by Mochi v0.10.59 on 2025-08-06 21:32:09 GMT+7
...
function insert(trie: Trie, word: string) {
  ...
  while ((i < _len(word))) {
    ...
    let children: Node = nodes[curr].children;
    if ((ch in children)) {

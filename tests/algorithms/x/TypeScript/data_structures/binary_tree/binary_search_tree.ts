// Generated by Mochi v0.10.59 on 2025-08-06 20:46:53 GMT+7
...
function delete(node: any[], value: number): any[] {
  if ((node == null)) {
    return null;
  }
  if ((value < node[Math.trunc(0)])) {
    node[1] = delete(node[Math.trunc(1)], value);
  } else {
    if ((value > node[Math.trunc(0)])) {
      node[2] = delete(node[Math.trunc(2)], value);
    } else {
      ...
      node[0] = min_val;
      node[2] = delete(node[Math.trunc(2)], min_val);
    }
  }
  return node;
}

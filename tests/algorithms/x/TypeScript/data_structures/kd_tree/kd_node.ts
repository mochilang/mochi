// Generated by Mochi v0.10.72 on 2025-08-24 23:29:42 GMT+7
...
right_child = nodes[(()=>{const _mochi_idx = Math.trunc(2); return _mochi_idx < 0 ? nodes.length + _mochi_idx : _mochi_idx;})()]
  console.log(_str(root.point));
  console.log(_str(root.left));
  console.log(_str(root.right));
  console.log(_str(left_child.point));
  console.log(_str(right_child.point));
  const _end = _now()

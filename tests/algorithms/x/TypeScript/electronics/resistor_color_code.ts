// Generated by Mochi v0.10.59 on 2025-08-06 21:53:11 GMT+7
...
function get_significant_digits(colors: string[]): number {
  ...
  for (const color of colors) {
    ...
    digit = ((digit * 10) + significant_figures_color_values[(color) < 0 ? significant_figures_color_values.length + (color) : color]);
  }
  return digit;
}
function get_multiplier(color: string): number {
  ...
  return multiplier_color_values[(color) < 0 ? multiplier_color_values.length + (color) : color];
}
function get_tolerance(color: string): number {
  ...
  return tolerance_color_values[(color) < 0 ? tolerance_color_values.length + (color) : color];
}
function get_temperature_coeffecient(color: string): number {
  ...
  return temperature_coeffecient_color_values[(color) < 0 ? temperature_coeffecient_color_values.length + (color) : color];
}
...
function calculate_resistance(number_of_bands: number, color_code_list: string[]): string {
  ...
  let multiplier_color: string = color_code_list[(sig_count) < 0 ? color_code_list.length + (sig_count) : sig_count];
  let multiplier: number = get_multiplier(multiplier_color);
  let tolerance: number = 20.0;
  if ((number_of_bands >= 4)) {
    let tolerance_color: string = color_code_list[(Math.trunc((sig_count + 1))) < 0 ? color_code_list.length + (Math.trunc((sig_count + 1))) : Math.trunc((sig_count + 1))];
    tolerance = get_tolerance(tolerance_color);
  }
  let temp_coeff: number = 0;
  if ((number_of_bands == 6)) {
    let temp_color: string = color_code_list[(Math.trunc((sig_count + 2))) < 0 ? color_code_list.length + (Math.trunc((sig_count + 2))) : Math.trunc((sig_count + 2))];

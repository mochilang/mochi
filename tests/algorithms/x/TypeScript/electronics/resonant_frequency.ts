// Generated by Mochi v0.10.62 on 2025-08-09 10:36:06 GMT+7
...
function resonant_frequency(inductance: number, capacitance: number): number {
  if ((inductance <= 0.0)) {
...
(() => {
  ...
  const _start = _now()
  console.log(_str(resonant_frequency(10.0, 5.0)));
  const _end = _now()

// Generated by Mochi v0.10.59 on 2025-08-06 21:51:03 GMT+7
  ...
  while ((i < dst_height)) {
    ...
    while ((j < dst_width)) {
      ...
      while ((ki < k_size)) {
        let kj: number = 0;
        while ((kj < k_size)) {
          sum = (sum + (image[(Math.trunc((i + ki))) < 0 ? image.length + (Math.trunc((i + ki))) : Math.trunc((i + ki))][(Math.trunc((j + kj))) < 0 ? image[(Math.trunc((i + ki))) < 0 ? image.length + (Math.trunc((i + ki))) : Math.trunc((i + ki))].length + (Math.trunc((j + kj))) : Math.trunc((j + kj))] * kernel[(ki) < 0 ? kernel.length + (ki) : ki][(kj) < 0 ? kernel[(ki) < 0 ? kernel.length + (ki) : ki].length + (kj) : kj]));
          kj = (kj + 1);
        }
        ki = (ki + 1);
      }

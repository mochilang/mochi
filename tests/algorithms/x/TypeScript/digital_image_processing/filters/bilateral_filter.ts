// Generated by Mochi v0.10.59 on 2025-08-06 21:32:20 GMT+7
...
function bilateral_filter(img: number[][], spatial_variance: number, intensity_variance: number, kernel_size: number): number {
  ...
  let center: number = img_s[Math.trunc(Math.trunc(kernel_size / 2))][Math.trunc(Math.trunc(kernel_size / 2))];

...
(let/ec _break (let loop ()
  (if (< i (cond [(not es) 0] [(string? es) (string-length es)] [(hash? es) (hash-count es)] [else (length es)])) (let/ec _cont
    (define j 0)
    (let/ec _break (let loop ()
  (if (< j (- (- (cond [(not es) 0] [(string? es) (string-length es)] [(hash? es) (hash-count es)] [else (length es)]) i) 1)) (let/ec _cont
...
(define temp (if es (if (hash? es) (hash-ref es j #f) (list-ref es (int j))) #f))
...
(define (find_parent parent i)
  (let/ec _return (begin
(if (not (equal? (if parent (if (hash? parent) (hash-ref parent i #f) (list-ref parent (int i))) #f) i)) (let ()
(set! parent (list-set parent (int i) (find_parent parent (if parent (if (hash? parent) (hash-ref parent i #f) (list-ref parent (int i))) #f))))
) (void))
(_return (if parent (if (hash? parent) (hash-ref parent i #f) (list-ref parent (int i))) #f))
))
)
...
(define idx 0)
(let/ec _break (let loop ()
  (if (< idx (cond [(not es) 0] [(string? es) (string-length es)] [(hash? es) (hash-count es)] [else (length es)])) (let/ec _cont
    (define e (if es (if (hash? es) (hash-ref es idx #f) (list-ref es (int idx))) #f))
    (define pa (find_parent parent (if e (if (hash? e) (hash-ref e 0 #f) (list-ref e (int 0))) #f)))
    (define pb (find_parent parent (if e (if (hash? e) (hash-ref e 1 #f) (list-ref e (int 1))) #f)))
...
(let/ec _break (let loop ()
  (if (< i (cond [(not es) 0] [(string? es) (string-length es)] [(hash? es) (hash-count es)] [else (length es)])) (let/ec _cont
    (define e (if es (if (hash? es) (hash-ref es i #f) (list-ref es (int i))) #f))
    (set! s (string-append (string-append (string-append (string-append (string-append (string-append (string-append s "(") (format "~a" (if e (if (hash? e) (hash-ref e 0 #f) (list-ref e (int 0))) #f))) ", ") (format "~a" (if e (if (hash? e) (hash-ref e 1 #f) (list-ref e (int 1))) #f))) ", ") (format "~a" (if e (if (hash? e) (hash-ref e 2 #f) (list-ref e (int 2))) #f))) ")"))
    (if (< i (- (cond [(not es) 0] [(string? es) (string-length es)] [(hash? es) (hash-count es)] [else (length es)]) 1)) (let ()

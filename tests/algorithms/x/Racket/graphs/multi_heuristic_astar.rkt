...
(define (valid p)
  (let/ec _return (begin
(if (or (< (if p (hash-ref p "x" #f) #f) 0) (> (if p (hash-ref p "x" #f) #f) (- n 1))) (let ()
(_return #f)
) (void))
(if (or (< (if p (hash-ref p "y" #f) #f) 0) (> (if p (hash-ref p "y" #f) #f) (- n 1))) (let ()
(_return #f)
) (void))
(_return #t)
))
...
(define i 0)
(let/ec _break (let loop ()
  (if (< i (cond [(not blocks) 0] [(string? blocks) (string-length blocks)] [(hash? blocks) (hash-count blocks)] [else (length blocks)])) (let/ec _cont
    (if (pos_equal (if blocks (if (hash? blocks) (hash-ref blocks i #f) (list-ref blocks (int i))) #f) p) (let ()
(_return #t)
) (void))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
...
(define i 0)
(let/ec _break (let loop ()
  (if (< i (cond [(not pq) 0] [(string? pq) (string-length pq)] [(hash? pq) (hash-count pq)] [else (length pq)])) (let/ec _cont
    (if (pos_equal (if (if pq (if (hash? pq) (hash-ref pq i #f) (list-ref pq (int i))) #f) (hash-ref (if pq (if (hash? pq) (hash-ref pq i #f) (list-ref pq (int i))) #f) "pos" #f) #f) node) (let ()
(if (< pri (if (if pq (if (hash? pq) (hash-ref pq i #f) (list-ref pq (int i))) #f) (hash-ref (if pq (if (hash? pq) (hash-ref pq i #f) (list-ref pq (int i))) #f) "pri" #f) #f)) (let ()
...
(set! updated #t)
    ...
    (loop)) (void))))
(if (not updated) (let ()
(set! pq (append pq (list (let ([h (make-hash)]) (hash-set! h "pos" node) (hash-set! h "pri" pri) h))))
) (void))
(_return pq)
))
)
...
(define first (if pq (if (hash? pq) (hash-ref pq 0 #f) (list-ref pq (int 0))) #f))
(define m (if first (hash-ref first "pri" #f) #f))
(define i 1)
(let/ec _break (let loop ()
  (if (< i (cond [(not pq) 0] [(string? pq) (string-length pq)] [(hash? pq) (hash-count pq)] [else (length pq)])) (let/ec _cont
    (define item (if pq (if (hash? pq) (hash-ref pq i #f) (list-ref pq (int i))) #f))
    (if (< (if item (hash-ref item "pri" #f) #f) m) (let ()
...
(define (pq_pop_min pq)
  (let/ec _return (begin
(define best (if pq (if (hash? pq) (hash-ref pq 0 #f) (list-ref pq (int 0))) #f))
(define idx 0)
(define i 1)
(let/ec _break (let loop ()
  (if (< i (cond [(not pq) 0] [(string? pq) (string-length pq)] [(hash? pq) (hash-count pq)] [else (length pq)])) (let/ec _cont
    (if (< (if (if pq (if (hash? pq) (hash-ref pq i #f) (list-ref pq (int i))) #f) (hash-ref (if pq (if (hash? pq) (hash-ref pq i #f) (list-ref pq (int i))) #f) "pri" #f) #f) (if best (hash-ref best "pri" #f) #f)) (let ()
(set! best (if pq (if (hash? pq) (hash-ref pq i #f) (list-ref pq (int i))) #f))
(set! idx i)
) (void))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
...
(set! new_pq (append new_pq (list (if pq (if (hash? pq) (hash-ref pq i #f) (list-ref pq (int i))) #f))))
) (void))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
...
(let/ec _break (let loop ()
  (if (< i (cond [(not pq) 0] [(string? pq) (string-length pq)] [(hash? pq) (hash-count pq)] [else (length pq)])) (let/ec _cont
    (if (not (pos_equal (if (if pq (if (hash? pq) (hash-ref pq i #f) (list-ref pq (int i))) #f) (hash-ref (if pq (if (hash? pq) (hash-ref pq i #f) (list-ref pq (int i))) #f) "pos" #f) #f) node)) (let ()
(set! new_pq (append new_pq (list (if pq (if (hash? pq) (hash-ref pq i #f) (list-ref pq (int i))) #f))))
) (void))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
...
(let/ec _break (let loop ()
  (if (not (pos_equal current start)) (let/ec _cont
...
(let/ec _break (let loop ()
  (if (>= i 0) (let/ec _cont
    (set! rev (append rev (list (if path (if (hash? path) (hash-ref path i #f) (list-ref path (int i))) #f))))
    (set! i (- i 1))
    (loop)) (void))))
(_return rev)
))
...
(define i 0)
(let/ec _break (let loop ()
  (if (< i n_heuristic) (let/ec _cont
    (set! open_list (append open_list (list (list))))
    (define pri (key_fn start i goal g_function))
    (set! open_list (list-set open_list (int i) (pq_put (if open_list (if (hash? open_list) (hash-ref open_list i #f) (list-ref open_list (int i))) #f) start pri)))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
(let/ec _break (let loop ()
  (if (< (pq_minkey (if open_list (if (hash? open_list) (hash-ref open_list 0 #f) (list-ref open_list (int 0))) #f)) INF) (let/ec _cont
    (define chosen 0)
    (set! i 1)
    (let/ec _break (let loop ()
  (if (< i n_heuristic) (let/ec _cont
    (if (<= (pq_minkey (if open_list (if (hash? open_list) (hash-ref open_list i #f) (list-ref open_list (int i))) #f)) (* W2 (pq_minkey (if open_list (if (hash? open_list) (hash-ref open_list 0 #f) (list-ref open_list (int 0))) #f)))) (let ()
(set! chosen i)
(_break)
) (void))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
...
(set! t (let ([__l t] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    ...
    (define pair (pq_pop_min (if open_list (if (hash? open_list) (hash-ref open_list chosen #f) (list-ref open_list (int chosen))) #f)))
...
(set! open_list (list-set open_list (int i) (pq_remove (if open_list (if (hash? open_list) (hash-ref open_list i #f) (list-ref open_list (int i))) #f) (if current (hash-ref current "pos" #f) #f))))
) (void))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
...
(_return void)
    ...
    (define k 0)
    (let/ec _break (let loop ()
  (if (< k (cond [(not neighs) 0] [(string? neighs) (string-length neighs)] [(hash? neighs) (hash-count neighs)] [else (length neighs)])) (let/ec _cont
    (define nb (if neighs (if (hash? neighs) (hash-ref neighs k #f) (list-ref neighs (int k))) #f))
...
(if (or (not (hash-has-key? g_function nkey)) (< tentative (if g_function (hash-ref g_function nkey 0.0) #f))) (let ()
...
(let/ec _break (let loop ()
  (if (< i n_heuristic) (let/ec _cont
    ...
    (set! open_list (list-set open_list (int i) (pq_put (if open_list (if (hash? open_list) (hash-ref open_list i #f) (list-ref open_list (int i))) #f) nb pri2)))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
) (void))
) (void))

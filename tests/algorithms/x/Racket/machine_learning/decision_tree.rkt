...
(let/ec _break (let loop ()
  (if (< i (cond [(not vals) 0] [(string? vals) (string-length vals)] [(hash? vals) (hash-count vals)] [else (length vals)])) (let/ec _cont
    (set! sum (let ([__l sum] [__r (if vals (if (hash? vals) (hash-ref vals i #f) (list-ref vals (int i))) #f)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
...
(define i 0)
(let/ec _break (let loop ()
  (if (< i (cond [(not labels) 0] [(string? labels) (string-length labels)] [(hash? labels) (hash-count labels)] [else (length labels)])) (let/ec _cont
    (define diff (- (if labels (if (hash? labels) (hash-ref labels i #f) (list-ref labels (int i))) #f) prediction))
...
(define (train_tree x y depth min_leaf_size)
  (let/ec _return (begin
(if (< (cond [(not x) 0] [(string? x) (string-length x)] [(hash? x) (hash-count x)] [else (length x)]) (* 2 min_leaf_size)) (let ()
...
(let/ec _break (let loop ()
  (if (< i (cond [(not x) 0] [(string? x) (string-length x)] [(hash? x) (hash-count x)] [else (length x)])) (let/ec _cont
    (if (< (cond [(not (slice x 0 i)) 0] [(string? (slice x 0 i)) (string-length (slice x 0 i))] [(hash? (slice x 0 i)) (hash-count (slice x 0 i))] [else (length (slice x 0 i))]) min_leaf_size) (let ()
(set! i i)
) (let ()
(if (< (cond [(not (slice x i (length x))) 0] [(string? (slice x i (length x))) (string-length (slice x i (length x)))] [(hash? (slice x i (length x))) (hash-count (slice x i (length x)))] [else (length (slice x i (length x)))]) min_leaf_size) (let ()
(set! i i)
) (let ()
...
(define boundary (if x (if (hash? x) (hash-ref x best_split #f) (list-ref x (int best_split))) #f))
...
(define v (- 1.0))
(let/ec _break (let loop ()
  (if (< v 1.0) (let/ec _cont
    (set! x (append x (list v)))
...
(let/ec _break (let loop ()
  (if (< i (cond [(not x) 0] [(string? x) (string-length x)] [(hash? x) (hash-count x)] [else (length x)])) (let/ec _cont
    (set! y (append y (list (sin (if x (if (hash? x) (hash-ref x i #f) (list-ref x (int i))) #f)))))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
...
(let/ec _break (let loop ()
  (if (< i 10) (let/ec _cont
    (set! test_cases (append test_cases (list (- (* (rand) 2.0) 1.0))))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
(define predictions (list))
(set! i 0)
(let/ec _break (let loop ()
  (if (< i (cond [(not test_cases) 0] [(string? test_cases) (string-length test_cases)] [(hash? test_cases) (hash-count test_cases)] [else (length test_cases)])) (let/ec _cont
    (set! predictions (append predictions (list (predict tree (if test_cases (if (hash? test_cases) (hash-ref test_cases i #f) (list-ref test_cases (int i))) #f)))))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
(define sum_err 0.0)
(set! i 0)
(let/ec _break (let loop ()
  (if (< i (cond [(not test_cases) 0] [(string? test_cases) (string-length test_cases)] [(hash? test_cases) (hash-count test_cases)] [else (length test_cases)])) (let/ec _cont
    (define diff (- (if predictions (if (hash? predictions) (hash-ref predictions i #f) (list-ref predictions (int i))) #f) (if test_cases (if (hash? test_cases) (hash-ref test_cases i #f) (list-ref test_cases (int i))) #f)))
...
(displayln (string-append "Test values: " (format "~a" test_cases)))
(displayln (string-append "Predictions: " (format "~a" predictions)))
(displayln (string-append "Average error: " (format "~a" avg_error)))
))
)

...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not s) 0] [(string? s) (string-length s)] [(hash? s) (hash-count s)] [else (length s)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      ...
      (define found #f)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not UPPER) 0] [(string? UPPER) (string-length UPPER)] [(hash? UPPER) (hash-count UPPER)] [else (length UPPER)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not PUNCT) 0] [(string? PUNCT) (string-length PUNCT)] [(hash? PUNCT) (hash-count PUNCT)] [else (length PUNCT)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not lower_) 0] [(string? lower_) (string-length lower_)] [(hash? lower_) (hash-count lower_)] [else (length lower_)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define (floor x)
  (let/ec _return (begin
(define i (int x))
(if (let ([__l (exact->inexact i)] [__r x]) (> (int __l) (int __r))) (let ()
(set! i (- i 1))
) (void))
...
(define k 1)
(let/ec _break (let loop ()
  (if (let ([__l k] [__r 99]) (<= (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not tokens) 0] [(string? tokens) (string-length tokens)] [(hash? tokens) (hash-count tokens)] [else (length tokens)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not docs) 0] [(string? docs) (string-length docs)] [(hash? docs) (hash-count docs)] [else (length docs)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont

...
(define (stump_predict s x)
  (let/ec _return (begin
(if (let ([__l (if x (if (hash? x) (hash-ref x (if s (hash-ref s "feature" #f) #f) #f) (safe-index x (int (if s (hash-ref s "feature" #f) #f)))) #f)] [__r (if s (hash-ref s "threshold" #f) #f)]) (< (int __l) (int __r))) (let ()
...
(define f 0)
(let/ec _break (let loop ()
  (if (let ([__l f] [__r num_features]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define i 0)
      (let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not features) 0] [(string? features) (string-length features)] [(hash? features) (hash-count features)] [else (length features)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not features) 0] [(string? features) (string-length features)] [(hash? features) (hash-count features)] [else (length features)])]) (< (int __l) (int __r))) (begin
    ...
    (loop)) (void))))
(if (let ([__l err] [__r best_error]) (< (int __l) (int __r))) (let ()
(set! best_error err)
(set! best_feature f)
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not targets) 0] [(string? targets) (string-length targets)] [(hash? targets) (hash-count targets)] [else (length targets)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(let/ec _break (let loop ()
  (if (let ([__l r] [__r rounds]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      ...
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not targets) 0] [(string? targets) (string-length targets)] [(hash? targets) (hash-count targets)] [else (length targets)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
    ...
    (loop)) (void))))
      ...
      (set! j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not preds) 0] [(string? preds) (string-length preds)] [(hash? preds) (hash-count preds)] [else (length preds)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not model) 0] [(string? model) (string-length model)] [(hash? model) (hash-count model)] [else (length model)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not features) 0] [(string? features) (string-length features)] [(hash? features) (hash-count features)] [else (length features)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      ...
      (define label (if (let ([__l s] [__r 0.5]) (>= (int __l) (int __r))) 1 0))
      (if (equal? i 0) (let ()

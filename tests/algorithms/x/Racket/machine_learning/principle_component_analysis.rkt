...
(define guess (if (let ([__l x] [__r 1.0]) (> (int __l) (int __r))) (/ x 2.0) 1.0))
(define i 0)
...
(let/ec _break (let loop ()
  ...
  (if (let ([__l i] [__r n_samples]) (< (int __l) (int __r))) (begin
    ...
    (loop)) (void))))
      ...
      (define k 0)
      (let/ec _break (let loop ()
  (if (let ([__l k] [__r n_samples]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define r 0)
(let/ec _break (let loop ()
  (if (let ([__l r] [__r n_samples]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define row (list))
      (define c 0)
      (let/ec _break (let loop ()
  (if (let ([__l c] [__r n_features]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not vec) 0] [(string? vec) (string-length vec)] [(hash? vec) (hash-count vec)] [else (length vec)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(if (let ([__l (if eigenvalues (if (hash? eigenvalues) (hash-ref eigenvalues 0 #f) (safe-index eigenvalues (int 0))) #f)] [__r (if eigenvalues (if (hash? eigenvalues) (hash-ref eigenvalues 1 #f) (safe-index eigenvalues (int 1))) #f)]) (< (int __l) (int __r))) (let ()
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r cols]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define row (list))
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r rows]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r rows_a]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define row (list))
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r cols_b]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define sum 0.0)
      (define k 0)
      (let/ec _break (let loop ()
  (if (let ([__l k] [__r cols_a]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r n_components]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(let/ec _break (let loop ()
  (if (let ([__l idx] [__r 5]) (< (int __l) (int __r))) (begin
    (let/ec _cont

...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (- size_data size_kernel)]) (<= (int __l) (int __r))) (begin
    (let/ec _cont
      (define row (list))
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (- size_data size_kernel)]) (<= (int __l) (int __r))) (begin
    (let/ec _cont
      (define sum 0.0)
      (define a 0)
      (let/ec _break (let loop ()
  (if (let ([__l a] [__r size_kernel]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define b 0)
      (let/ec _break (let loop ()
  (if (let ([__l b] [__r size_kernel]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not map) 0] [(string? map) (string-length map)] [(hash? map) (hash-count map)] [else (length map)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define row (list))
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not (if map (if (hash? map) (hash-ref map i #f) (safe-index map (int i))) #f)) 0] [(string? (if map (if (hash? map) (hash-ref map i #f) (safe-index map (int i))) #f)) (string-length (if map (if (hash? map) (hash-ref map i #f) (safe-index map (int i))) #f))] [(hash? (if map (if (hash? map) (hash-ref map i #f) (safe-index map (int i))) #f)) (hash-count (if map (if (hash? map) (hash-ref map i #f) (safe-index map (int i))) #f))] [else (length (if map (if (hash? map) (hash-ref map i #f) (safe-index map (int i))) #f))])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define sum 0.0)
      (define a 0)
      (let/ec _break (let loop ()
  (if (let ([__l a] [__r size]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define b 0)
      (let/ec _break (let loop ()
  (if (let ([__l b] [__r size]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not maps) 0] [(string? maps) (string-length maps)] [(hash? maps) (hash-count maps)] [else (length maps)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not (if maps (if (hash? maps) (hash-ref maps i #f) (safe-index maps (int i))) #f)) 0] [(string? (if maps (if (hash? maps) (hash-ref maps i #f) (safe-index maps (int i))) #f)) (string-length (if maps (if (hash? maps) (hash-ref maps i #f) (safe-index maps (int i))) #f))] [(hash? (if maps (if (hash? maps) (hash-ref maps i #f) (safe-index maps (int i))) #f)) (hash-count (if maps (if (hash? maps) (hash-ref maps i #f) (safe-index maps (int i))) #f))] [else (length (if maps (if (hash? maps) (hash-ref maps i #f) (safe-index maps (int i))) #f))])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define k 0)
      (let/ec _break (let loop ()
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not m) 0] [(string? m) (string-length m)] [(hash? m) (hash-count m)] [else (length m)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define sum 0.0)
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not (if m (if (hash? m) (hash-ref m i #f) (safe-index m (int i))) #f)) 0] [(string? (if m (if (hash? m) (hash-ref m i #f) (safe-index m (int i))) #f)) (string-length (if m (if (hash? m) (hash-ref m i #f) (safe-index m (int i))) #f))] [(hash? (if m (if (hash? m) (hash-ref m i #f) (safe-index m (int i))) #f)) (hash-count (if m (if (hash? m) (hash-ref m i #f) (safe-index m (int i))) #f))] [else (length (if m (if (hash? m) (hash-ref m i #f) (safe-index m (int i))) #f))])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r input_size]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define row (list))
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r hidden_size]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(set! i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r hidden_size]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define row (list))
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r output_size]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (set! row (append (or row (list)) (list (- (random) 0.5))))
      (set! j (let ([__l j] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    )
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not (if cnn (hash-ref cnn "conv_kernels" #f) #f)) 0] [(string? (if cnn (hash-ref cnn "conv_kernels" #f) #f)) (string-length (if cnn (hash-ref cnn "conv_kernels" #f) #f))] [(hash? (if cnn (hash-ref cnn "conv_kernels" #f) #f)) (hash-count (if cnn (hash-ref cnn "conv_kernels" #f) #f))] [else (length (if cnn (hash-ref cnn "conv_kernels" #f) #f))])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(let/ec _break (let loop ()
  (if (let ([__l e] [__r epochs]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define s 0)
      (let/ec _break (let loop ()
  (if (let ([__l s] [__r (cond [(not samples) 0] [(string? samples) (string-length samples)] [(hash? samples) (hash-count samples)] [else (length samples)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
  ...
  (if (let ([__l i] [__r (cond [(not (if cnn (hash-ref cnn "conv_kernels" #f) #f)) 0] [(string? (if cnn (hash-ref cnn "conv_kernels" #f) #f)) (string-length (if cnn (hash-ref cnn "conv_kernels" #f) #f))] [(hash? (if cnn (hash-ref cnn "conv_kernels" #f) #f)) (hash-count (if cnn (hash-ref cnn "conv_kernels" #f) #f))] [else (length (if cnn (hash-ref cnn "conv_kernels" #f) #f))])]) (< (int __l) (int __r))) (begin
    ...
    (loop)) (void))))
      ...
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not w_out) 0] [(string? w_out) (string-length w_out)] [(hash? w_out) (hash-count w_out)] [else (length w_out)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define k 0)
      (let/ec _break (let loop ()
  (if (let ([__l k] [__r (cond [(not (if w_out (if (hash? w_out) (hash-ref w_out j #f) (safe-index w_out (int j))) #f)) 0] [(string? (if w_out (if (hash? w_out) (hash-ref w_out j #f) (safe-index w_out (int j))) #f)) (string-length (if w_out (if (hash? w_out) (hash-ref w_out j #f) (safe-index w_out (int j))) #f))] [(hash? (if w_out (if (hash? w_out) (hash-ref w_out j #f) (safe-index w_out (int j))) #f)) (hash-count (if w_out (if (hash? w_out) (hash-ref w_out j #f) (safe-index w_out (int j))) #f))] [else (length (if w_out (if (hash? w_out) (hash-ref w_out j #f) (safe-index w_out (int j))) #f))])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
    ...
    (loop)) (void))))
      (set! j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not b_out) 0] [(string? b_out) (string-length b_out)] [(hash? b_out) (hash-count b_out)] [else (length b_out)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
    ...
    (loop)) (void))))
      (define i_h 0)
      (let/ec _break (let loop ()
  (if (let ([__l i_h] [__r (cond [(not w_hidden) 0] [(string? w_hidden) (string-length w_hidden)] [(hash? w_hidden) (hash-count w_hidden)] [else (length w_hidden)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define j_h 0)
      (let/ec _break (let loop ()
  (if (let ([__l j_h] [__r (cond [(not (if w_hidden (if (hash? w_hidden) (hash-ref w_hidden i_h #f) (safe-index w_hidden (int i_h))) #f)) 0] [(string? (if w_hidden (if (hash? w_hidden) (hash-ref w_hidden i_h #f) (safe-index w_hidden (int i_h))) #f)) (string-length (if w_hidden (if (hash? w_hidden) (hash-ref w_hidden i_h #f) (safe-index w_hidden (int i_h))) #f))] [(hash? (if w_hidden (if (hash? w_hidden) (hash-ref w_hidden i_h #f) (safe-index w_hidden (int i_h))) #f)) (hash-count (if w_hidden (if (hash? w_hidden) (hash-ref w_hidden i_h #f) (safe-index w_hidden (int i_h))) #f))] [else (length (if w_hidden (if (hash? w_hidden) (hash-ref w_hidden i_h #f) (safe-index w_hidden (int i_h))) #f))])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
    ...
    (loop)) (void))))
      (set! j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not b_hidden) 0] [(string? b_hidden) (string-length b_hidden)] [(hash? b_hidden) (hash-count b_hidden)] [else (length b_hidden)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont

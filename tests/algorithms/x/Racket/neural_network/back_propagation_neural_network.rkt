...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not v) 0] [(string? v) (string-length v)] [(hash? v) (hash-count v)] [else (length v)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not out) 0] [(string? out) (string-length out)] [(hash? out) (hash-count out)] [else (length out)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r r]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not a) 0] [(string? a) (string-length a)] [(hash? a) (hash-count a)] [else (length a)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      ...
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not b) 0] [(string? b) (string-length b)] [(hash? b) (hash-count b)] [else (length b)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not mat) 0] [(string? mat) (string-length mat)] [(hash? mat) (hash-count mat)] [else (length mat)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      ...
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not (if mat (if (hash? mat) (hash-ref mat i #f) (safe-index mat (int i))) #f)) 0] [(string? (if mat (if (hash? mat) (hash-ref mat i #f) (safe-index mat (int i))) #f)) (string-length (if mat (if (hash? mat) (hash-ref mat i #f) (safe-index mat (int i))) #f))] [(hash? (if mat (if (hash? mat) (hash-ref mat i #f) (safe-index mat (int i))) #f)) (hash-count (if mat (if (hash? mat) (hash-ref mat i #f) (safe-index mat (int i))) #f))] [else (length (if mat (if (hash? mat) (hash-ref mat i #f) (safe-index mat (int i))) #f))])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not layers) 0] [(string? layers) (string-length layers)] [(hash? layers) (hash-count layers)] [else (length layers)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not y) 0] [(string? y) (string-length y)] [(hash? y) (hash-count y)] [else (length y)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define r 0)
(let/ec _break (let loop ()
  (if (let ([__l r] [__r rounds]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define i 0)
      (let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not xdata) 0] [(string? xdata) (string-length xdata)] [(hash? xdata) (hash-count xdata)] [else (length xdata)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont

...
(define (polygonal_num n sides)
  (let/ec _return (begin
(if (or (< n 0) (< sides 3)) (let ()
(panic "Invalid input: num must be >= 0 and sides must be >= 3.")
) (void))
(define term1 (* (* (- sides 2) n) n))
(define term2 (* (- sides 4) n))
(_return (floor (/ (- term1 term2) 2)))
))
)
(define (main)
  (let/ec _return (begin
(define n 5)
(define sides 4)
(define result (polygonal_num n sides))

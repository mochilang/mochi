...
(let/ec _break (let loop ()
  ...
  (if (< j (- (- n i) 1)) (begin
    (let/ec _cont
      (if (> (if arr (if (hash? arr) (hash-ref arr j #f) (safe-index arr (int j))) #f) (if arr (if (hash? arr) (hash-ref arr (let ([__l j] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) #f) (safe-index arr (int (let ([__l j] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))) #f)) (let ()

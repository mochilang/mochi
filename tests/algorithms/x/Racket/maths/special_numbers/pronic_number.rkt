...
(if (not (equal? (modulo n 2) 0)) (let ()
(_return #f)
) (void))
(define root (int_sqrt n))
(_return (equal? n (* root (let ([__l root] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))))
))
)
(define (test_is_pronic)
  (let/ec _return (begin
(if (is_pronic (- 1)) (let ()
(panic "-1 should not be pronic")
) (void))
(if (not (is_pronic 0)) (let ()
(panic "0 should be pronic")
) (void))
(if (not (is_pronic 2)) (let ()
(panic "2 should be pronic")
) (void))
(if (is_pronic 5) (let ()
(panic "5 should not be pronic")
) (void))
(if (not (is_pronic 6)) (let ()
(panic "6 should be pronic")
) (void))
(if (is_pronic 8) (let ()
(panic "8 should not be pronic")
) (void))
(if (not (is_pronic 30)) (let ()
(panic "30 should be pronic")
) (void))
(if (is_pronic 32) (let ()
(panic "32 should not be pronic")
) (void))
(if (not (is_pronic 2147441940)) (let ()

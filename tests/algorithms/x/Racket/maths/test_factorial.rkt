...
(_return (* n (factorial_recursive (- n 1))))
))
)
(define (test_zero)
  (let/ec _return (begin
(if (not (equal? (factorial 0) 1)) (let ()
(panic "factorial(0) failed")
) (void))
(if (not (equal? (factorial_recursive 0) 1)) (let ()
(panic "factorial_recursive(0) failed")
) (void))
))
)
(define (test_positive_integers)
  (let/ec _return (begin
(if (not (equal? (factorial 1) 1)) (let ()
(panic "factorial(1) failed")
) (void))
(if (not (equal? (factorial_recursive 1) 1)) (let ()
(panic "factorial_recursive(1) failed")
) (void))
(if (not (equal? (factorial 5) 120)) (let ()
(panic "factorial(5) failed")
) (void))
(if (not (equal? (factorial_recursive 5) 120)) (let ()
(panic "factorial_recursive(5) failed")
) (void))
(if (not (equal? (factorial 7) 5040)) (let ()
(panic "factorial(7) failed")
) (void))
(if (not (equal? (factorial_recursive 7) 5040)) (let ()
(panic "factorial_recursive(7) failed")
) (void))
))
)
(define (test_large_number)
  (let/ec _return (begin
(if (not (equal? (factorial 10) 3628800)) (let ()
(panic "factorial(10) failed")
) (void))
(if (not (equal? (factorial_recursive 10) 3628800)) (let ()

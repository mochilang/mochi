...
(define (test_signum)
  (let/ec _return (begin
(if (not (equal? (signum 5.0) 1)) (let ()
(panic "signum(5) failed")
) (void))
(if (not (equal? (signum (- 5.0)) (- 1))) (let ()
(panic "signum(-5) failed")
) (void))
(if (not (equal? (signum 0.0) 0)) (let ()
(panic "signum(0) failed")
) (void))
(if (not (equal? (signum 10.5) 1)) (let ()
(panic "signum(10.5) failed")
) (void))
(if (not (equal? (signum (- 10.5)) (- 1))) (let ()
(panic "signum(-10.5) failed")
) (void))
(if (not (equal? (signum 1e-06) 1)) (let ()
(panic "signum(1e-6) failed")
) (void))
(if (not (equal? (signum (- 1e-06)) (- 1))) (let ()
(panic "signum(-1e-6) failed")
) (void))
(if (not (equal? (signum 123456789.0) 1)) (let ()
...
(define (main)
  (let/ec _return (begin
(test_signum)
(displayln (signum 12.0))
(displayln (signum (- 12.0)))
(displayln (signum 0.0))
))
)

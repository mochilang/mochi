...
(define int_part "")
(let/ec _break (let loop ()
  (if (< idx (cond [(not s) 0] [(string? s) (string-length s)] [(hash? s) (hash-count s)] [else (length s)])) (let/ec _cont
...
(_break)
    ...
    (loop)) (void))))
(define frac_part "")
(if (and (< idx (cond [(not s) 0] [(string? s) (string-length s)] [(hash? s) (hash-count s)] [else (length s)])) (string=? (slice s idx (let ([__l idx] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))) ".")) (let ()
(set! idx (let ([__l idx] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
(let/ec _break (let loop ()
  (if (< idx (cond [(not s) 0] [(string? s) (string-length s)] [(hash? s) (hash-count s)] [else (length s)])) (let/ec _cont
    (define c (slice s idx (let ([__l idx] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
...
(define exp 0)
(if (and (< idx (cond [(not s) 0] [(string? s) (string-length s)] [(hash? s) (hash-count s)] [else (length s)])) (or (string=? (slice s idx (let ([__l idx] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))) "e") (string=? (slice s idx (let ([__l idx] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))) "E"))) (let ()
(set! idx (let ([__l idx] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
(define exp_sign 1)
(if (and (< idx (cond [(not s) 0] [(string? s) (string-length s)] [(hash? s) (hash-count s)] [else (length s)])) (string=? (slice s idx (let ([__l idx] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))) "-")) (let ()
(set! exp_sign (- 1))
...
(if (> exp 0) (let ()
(set! numerator (* numerator (pow10 exp)))
) (let ()
(if (< exp 0) (let ()
(set! denominator (* denominator (pow10 (- exp))))
) (void))
))
...
(define (decimal_to_fraction x)
  (let/ec _return (begin
(_return (decimal_to_fraction_str (format "~a" x)))
))
)
...
(displayln (string-append (string-append (format "~a" (if fr (hash-ref fr "numerator" #f) #f)) "/") (format "~a" (if fr (hash-ref fr "denominator" #f) #f))))
))
)

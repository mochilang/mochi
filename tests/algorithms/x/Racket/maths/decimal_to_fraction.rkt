...
(if (let ([__l y] [__r 0]) (< (int __l) (int __r))) (let ()
(set! y (- y))
) (void))
(let/ec _break (let loop ()
...
(_break)
    ...
    (loop)) (void))))
(define frac_part "")
(if (and (let ([__l idx] [__r (cond [(not s) 0] [(string? s) (string-length s)] [(hash? s) (hash-count s)] [else (length s)])]) (< (int __l) (int __r))) (string=? (slice s idx (let ([__l idx] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))) ".")) (let ()
(set! idx (let ([__l idx] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
(let/ec _break (let loop ()
  (if (let ([__l idx] [__r (cond [(not s) 0] [(string? s) (string-length s)] [(hash? s) (hash-count s)] [else (length s)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont

...
(let/ec _break (let loop ()
  (if (let ([__l v] [__r 2.0]) (>= (int __l) (int __r))) (begin
    (let/ec _cont
      (set! v (/ v 2.0))
...
(define i 3)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r 9]) (<= (int __l) (int __r))) (begin
    (let/ec _cont
      (set! zpow (* (* zpow z) z))
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not alphas) 0] [(string? alphas) (string-length alphas)] [(hash? alphas) (hash-count alphas)] [else (length alphas)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define a0 0)
(let/ec _break (let loop ()
  (if (let ([__l a0] [__r (cond [(not alphas) 0] [(string? alphas) (string-length alphas)] [(hash? alphas) (hash-count alphas)] [else (length alphas)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define ch0 (slice alphas a0 (let ([__l a0] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
      (define a1 0)
      (let/ec _break (let loop ()
  (if (let ([__l a1] [__r (cond [(not alphas) 0] [(string? alphas) (string-length alphas)] [(hash? alphas) (hash-count alphas)] [else (length alphas)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont

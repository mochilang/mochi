...
(let/ec _break (let loop ()
  (if (<= start end) (begin
    (let/ec _cont
      (if (if sieve (if (hash? sieve) (hash-ref sieve start #f) (list-ref sieve (int start))) #f) (let ()
(set! prime (append prime (list start)))
(define j (* start start))
(let/ec _break (let loop ()
  (if (<= j num) (begin
    (let/ec _cont
      (if (if sieve (if (hash? sieve) (hash-ref sieve j #f) (list-ref sieve (int j))) #f) (let ()

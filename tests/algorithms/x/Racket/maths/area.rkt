...
(define (surface_area_cube side_length)
  (let/ec _return (begin
(if (let ([__l side_length] [__r 0.0]) (< (int __l) (int __r))) (let ()
...
(define (surface_area_cuboid length_ breadth height)
  (let/ec _return (begin
(if (or (or (let ([__l length_] [__r 0.0]) (< (int __l) (int __r))) (let ([__l breadth] [__r 0.0]) (< (int __l) (int __r)))) (let ([__l height] [__r 0.0]) (< (int __l) (int __r)))) (let ()
...
(define (surface_area_sphere radius)
  (let/ec _return (begin
(if (let ([__l radius] [__r 0.0]) (< (int __l) (int __r))) (let ()
...
(define (surface_area_cone radius height)
  (let/ec _return (begin
(if (or (let ([__l radius] [__r 0.0]) (< (int __l) (int __r))) (let ([__l height] [__r 0.0]) (< (int __l) (int __r)))) (let ()
...
(define (surface_area_conical_frustum radius1 radius2 height)
  (let/ec _return (begin
(if (or (or (let ([__l radius1] [__r 0.0]) (< (int __l) (int __r))) (let ([__l radius2] [__r 0.0]) (< (int __l) (int __r)))) (let ([__l height] [__r 0.0]) (< (int __l) (int __r)))) (let ()
...
(define (surface_area_torus torus_radius tube_radius)
  (let/ec _return (begin
(if (or (let ([__l torus_radius] [__r 0.0]) (< (int __l) (int __r))) (let ([__l tube_radius] [__r 0.0]) (< (int __l) (int __r)))) (let ()
(displayln "ValueError: surface_area_torus() only accepts non-negative values")
(_return 0.0)
) (void))
(if (let ([__l torus_radius] [__r tube_radius]) (< (int __l) (int __r))) (let ()
...
(define (area_rectangle length_ width)
  (let/ec _return (begin
(if (or (let ([__l length_] [__r 0.0]) (< (int __l) (int __r))) (let ([__l width] [__r 0.0]) (< (int __l) (int __r)))) (let ()
...
(define (area_triangle base height)
  (let/ec _return (begin
(if (or (let ([__l base] [__r 0.0]) (< (int __l) (int __r))) (let ([__l height] [__r 0.0]) (< (int __l) (int __r)))) (let ()
...
(define (area_triangle_three_sides side1 side2 side3)
  (let/ec _return (begin
(if (or (or (let ([__l side1] [__r 0.0]) (< (int __l) (int __r))) (let ([__l side2] [__r 0.0]) (< (int __l) (int __r)))) (let ([__l side3] [__r 0.0]) (< (int __l) (int __r)))) (let ()
(displayln "ValueError: area_triangle_three_sides() only accepts non-negative values")
(_return 0.0)
) (void))
(if (or (or (let ([__l (let ([__l side1] [__r side2]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))] [__r side3]) (< (int __l) (int __r))) (let ([__l (let ([__l side1] [__r side3]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))] [__r side2]) (< (int __l) (int __r)))) (let ([__l (let ([__l side2] [__r side3]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))] [__r side1]) (< (int __l) (int __r)))) (let ()
...
(define (area_trapezium base1 base2 height)
  (let/ec _return (begin
(if (or (or (let ([__l base1] [__r 0.0]) (< (int __l) (int __r))) (let ([__l base2] [__r 0.0]) (< (int __l) (int __r)))) (let ([__l height] [__r 0.0]) (< (int __l) (int __r)))) (let ()
...
(define (area_ellipse radius_x radius_y)
  (let/ec _return (begin
(if (or (let ([__l radius_x] [__r 0.0]) (< (int __l) (int __r))) (let ([__l radius_y] [__r 0.0]) (< (int __l) (int __r)))) (let ()
...
(define (area_rhombus diagonal1 diagonal2)
  (let/ec _return (begin
(if (or (let ([__l diagonal1] [__r 0.0]) (< (int __l) (int __r))) (let ([__l diagonal2] [__r 0.0]) (< (int __l) (int __r)))) (let ()

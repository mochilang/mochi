...
(define (surface_area_cuboid length_ breadth height)
  (let/ec _return (begin
(if (or (or (< length_ 0.0) (< breadth 0.0)) (< height 0.0)) (let ()
...
(define (surface_area_cone radius height)
  (let/ec _return (begin
(if (or (< radius 0.0) (< height 0.0)) (let ()
...
(define (surface_area_conical_frustum radius1 radius2 height)
  (let/ec _return (begin
(if (or (or (< radius1 0.0) (< radius2 0.0)) (< height 0.0)) (let ()
...
(define (surface_area_torus torus_radius tube_radius)
  (let/ec _return (begin
(if (or (< torus_radius 0.0) (< tube_radius 0.0)) (let ()
(displayln "ValueError: surface_area_torus() only accepts non-negative values")
(_return 0.0)
) (void))
(if (< torus_radius tube_radius) (let ()
...
(define (area_rectangle length_ width)
  (let/ec _return (begin
(if (or (< length_ 0.0) (< width 0.0)) (let ()
...
(define (area_triangle_three_sides side1 side2 side3)
  (let/ec _return (begin
(if (or (or (< side1 0.0) (< side2 0.0)) (< side3 0.0)) (let ()
(displayln "ValueError: area_triangle_three_sides() only accepts non-negative values")
(_return 0.0)
) (void))
(if (or (or (< (let ([__l side1] [__r side2]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) side3) (< (let ([__l side1] [__r side3]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) side2)) (< (let ([__l side2] [__r side3]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) side1)) (let ()
...
(define (area_trapezium base1 base2 height)
  (let/ec _return (begin
(if (or (or (< base1 0.0) (< base2 0.0)) (< height 0.0)) (let ()
...
(define (area_ellipse radius_x radius_y)
  (let/ec _return (begin
(if (or (< radius_x 0.0) (< radius_y 0.0)) (let ()
...
(define (area_rhombus diagonal1 diagonal2)
  (let/ec _return (begin
(if (or (< diagonal1 0.0) (< diagonal2 0.0)) (let ()
...
(displayln (string-append "Rectangle: " (format "~a" (area_rectangle 10.0 20.0))))
(displayln (string-append "Square: " (format "~a" (area_square 10.0))))
(displayln (string-append "Triangle: " (format "~a" (area_triangle 10.0 10.0))))
(displayln (string-append "Triangle Three Sides: " (format "~a" TRI_THREE_SIDES)))
(displayln (string-append "Parallelogram: " (format "~a" (area_parallelogram 10.0 20.0))))
(displayln (string-append "Rhombus: " (format "~a" (area_rhombus 10.0 20.0))))
(displayln (string-append "Trapezium: " (format "~a" (area_trapezium 10.0 20.0 30.0))))
(displayln (string-append "Circle: " (format "~a" (area_circle 20.0))))
(displayln (string-append "Ellipse: " (format "~a" (area_ellipse 10.0 20.0))))
(displayln "")
(displayln "Surface Areas of various geometric shapes:")
(displayln (string-append "Cube: " (format "~a" (surface_area_cube 20.0))))
(displayln (string-append "Cuboid: " (format "~a" (surface_area_cuboid 10.0 20.0 30.0))))
(displayln (string-append "Sphere: " (format "~a" (surface_area_sphere 20.0))))
(displayln (string-append "Hemisphere: " (format "~a" (surface_area_hemisphere 20.0))))
(displayln (string-append "Cone: " (format "~a" (surface_area_cone 10.0 20.0))))
(displayln (string-append "Conical Frustum: " (format "~a" (surface_area_conical_frustum 10.0 20.0 30.0))))
(displayln (string-append "Cylinder: " (format "~a" (surface_area_cylinder 10.0 20.0))))
(displayln (string-append "Torus: " (format "~a" (surface_area_torus 20.0 10.0))))
(displayln (string-append "Equilateral Triangle: " (format "~a" (area_reg_polygon 3 10.0))))
(displayln (string-append "Square: " (format "~a" (area_reg_polygon 4 10.0))))
(displayln (string-append "Regular Pentagon: " (format "~a" (area_reg_polygon 5 10.0))))
    (void)
  ))

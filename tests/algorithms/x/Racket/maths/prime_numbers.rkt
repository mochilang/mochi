...
(define (fast_primes max_n)
  (let/ec _return (begin
(define result (list))
(if (>= max_n 2) (let ()
(set! result (append result (list 2)))
) (void))
(define i 3)
(let/ec _break (let loop ()
  (if (<= i max_n) (begin
...
(let* ([_start_mem (current-memory-use)] [_start (current-inexact-monotonic-milliseconds)])
  (let/ec _return (begin
(displayln (to-string (slow_primes 25)))
(displayln (to-string (primes 25)))
(displayln (to-string (fast_primes 25)))
    (void)
  ))

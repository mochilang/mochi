...
(define (test_prime_factors)
  (let/ec _return (begin
(if (not (list_eq (prime_factors 0) (list))) (let ()
(panic "prime_factors(0) failed")
) (void))
(if (not (list_eq (prime_factors 100) (list 2 2 5 5))) (let ()
(panic "prime_factors(100) failed")
) (void))
(if (not (list_eq (prime_factors 2560) (list 2 2 2 2 2 2 2 2 2 5))) (let ()
(panic "prime_factors(2560) failed")
) (void))
(if (not (list_eq (prime_factors 97) (list 97))) (let ()
...
(displayln (to-string (prime_factors 2560)))
(displayln (to-string (prime_factors 97)))
))
)

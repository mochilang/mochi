...
(displayln (to-string (is_prime 27)))
(displayln (to-string (is_prime 87)))
(displayln (to-string (is_prime 563)))
(displayln (to-string (is_prime 2999)))
(displayln (to-string (is_prime 67483)))
    (void)
  ))

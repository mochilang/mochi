...
(define start_p (let ([h (make-hash)]) (hash-set! h "Healthy" 0.6) (hash-set! h "Fever" 0.4) h))
(define trans_p (let ([h (make-hash)]) (hash-set! h "Healthy" (let ([h (make-hash)]) (hash-set! h "Healthy" 0.7) (hash-set! h "Fever" 0.3) h)) (hash-set! h "Fever" (let ([h (make-hash)]) (hash-set! h "Healthy" 0.4) (hash-set! h "Fever" 0.6) h)) h))
(define emit_p (let ([h (make-hash)]) (hash-set! h "Healthy" (let ([h (make-hash)]) (hash-set! h "normal" 0.5) (hash-set! h "cold" 0.4) (hash-set! h "dizzy" 0.1) h)) (hash-set! h "Fever" (let ([h (make-hash)]) (hash-set! h "normal" 0.1) (hash-set! h "cold" 0.3) (hash-set! h "dizzy" 0.6) h)) h))

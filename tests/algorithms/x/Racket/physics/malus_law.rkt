...
(define (malus_law initial_intensity angle)
  (let/ec _return (begin
(if (let ([__l initial_intensity] [__r 0.0]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (let ()
(panic "The value of intensity cannot be negative")
) (void))
(if (or (let ([__l angle] [__r 0.0]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (let ([__l angle] [__r 360.0]) (cond [(and (number? __l) (number? __r)) (> __l __r)] [else (> (int __l) (int __r))]))) (let ()

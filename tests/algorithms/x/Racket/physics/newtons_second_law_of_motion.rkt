...
(define (newtons_second_law_of_motion mass acceleration)
  (let/ec _return (begin
(if (or (let ([__l mass] [__r 0.0]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (let ([__l acceleration] [__r 0.0]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))]))) (let ()
(_return 0.0)
) (void))
(_return (* mass acceleration))
))
)
(define mass 12.5)
(define acceleration 10.0)
(define force (newtons_second_law_of_motion mass acceleration))
(let* ([_start_mem (current-memory-use)] [_start (current-inexact-monotonic-milliseconds)])
  (let/ec _return (begin
(displayln (string-append (string-append "The force is " (to-string force)) " N"))
    (void)
  ))

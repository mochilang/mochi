...
(define (centripetal mass velocity radius)
  (let/ec _return (begin
(if (let ([__l mass] [__r 0.0]) (< (int __l) (int __r))) (let ()
...
(_return (/ (* (* mass velocity) velocity) radius))
))
)
(define (floor x)
  (let/ec _return (begin
...
(define (show mass velocity radius)
  (let/ec _return (begin
(define f (centripetal mass velocity radius))
(displayln (to-string (round f 2)))
))
)

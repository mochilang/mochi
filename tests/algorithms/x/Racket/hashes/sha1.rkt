...
(let/ec _break (let loop ()
  (if (> num 0) (let/ec _cont
    ...
    (loop)) (void))))
(let/ec _break (let loop ()
  (if (< (cond [(not s) 0] [(string? s) (string-length s)] [(hash? s) (hash-count s)] [else (length s)]) 8) (let/ec _cont
    (set! s (string-append "0" s))
    (loop)) (void))))
(if (> (cond [(not s) 0] [(string? s) (string-length s)] [(hash? s) (hash-count s)] [else (length s)]) 8) (let ()
...
(define i 0)
(let/ec _break (let loop ()
  (if (< i (cond [(not message) 0] [(string? message) (string-length message)] [(hash? message) (hash-count message)] [else (length message)])) (let/ec _cont
    (set! bytes (append bytes (list (ord (slice message i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))))))
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
(set! bytes (append bytes (list 128)))
(let/ec _break (let loop ()
  (if (not (equal? (modulo (let ([__l (cond [(not bytes) 0] [(string? bytes) (string-length bytes)] [(hash? bytes) (hash-count bytes)] [else (length bytes)])] [__r 8]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) 64) 0)) (let/ec _cont
    (set! bytes (append bytes (list 0)))
    (loop)) (void))))
...
(let/ec _break (let loop ()
  (if (< j 8) (let/ec _cont
    (set! bytes (append bytes (list (if len_bytes (if (hash? len_bytes) (hash-ref len_bytes j #f) (list-ref len_bytes (int j))) #f))))
    (set! j (let ([__l j] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
(define blocks (list))
(define pos 0)
(let/ec _break (let loop ()
  (if (< pos (cond [(not bytes) 0] [(string? bytes) (string-length bytes)] [(hash? bytes) (hash-count bytes)] [else (length bytes)])) (let/ec _cont
    (define block (list))
    (define j2 0)
    (let/ec _break (let loop ()
  (if (< j2 64) (let/ec _cont
    (set! block (append block (list (if bytes (if (hash? bytes) (hash-ref bytes (let ([__l pos] [__r j2]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) #f) (list-ref bytes (int (let ([__l pos] [__r j2]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))) #f))))
...
(define bindex 0)
(let/ec _break (let loop ()
  (if (< bindex (cond [(not blocks) 0] [(string? blocks) (string-length blocks)] [(hash? blocks) (hash-count blocks)] [else (length blocks)])) (let/ec _cont
    (define block (if blocks (if (hash? blocks) (hash-ref blocks bindex #f) (list-ref blocks (int bindex))) #f))
    (define w (list))
    (define t 0)
    (let/ec _break (let loop ()
  (if (< t 16) (let/ec _cont
    (define j3 (* t 4))
    (define word (let ([__l (* (let ([__l (* (let ([__l (* (if block (if (hash? block) (hash-ref block j3 #f) (list-ref block (int j3))) #f) 256)] [__r (if block (if (hash? block) (hash-ref block (let ([__l j3] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) #f) (list-ref block (int (let ([__l j3] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))) #f)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) 256)] [__r (if block (if (hash? block) (hash-ref block (let ([__l j3] [__r 2]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) #f) (list-ref block (int (let ([__l j3] [__r 2]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))) #f)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) 256)] [__r (if block (if (hash? block) (hash-ref block (let ([__l j3] [__r 3]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) #f) (list-ref block (int (let ([__l j3] [__r 3]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))) #f)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (set! w (append w (list word)))
    (set! t (let ([__l t] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
    (let/ec _break (let loop ()
  (if (< t 80) (let/ec _cont
    (define tmp (bit_xor (bit_xor (bit_xor (if w (if (hash? w) (hash-ref w (- t 3) #f) (list-ref w (int (- t 3)))) #f) (if w (if (hash? w) (hash-ref w (- t 8) #f) (list-ref w (int (- t 8)))) #f)) (if w (if (hash? w) (hash-ref w (- t 14) #f) (list-ref w (int (- t 14)))) #f)) (if w (if (hash? w) (hash-ref w (- t 16) #f) (list-ref w (int (- t 16)))) #f)))
    (set! w (append w (list (rotate_left tmp 1))))
    (set! t (let ([__l t] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
    (define a h0)
    (define b h1)

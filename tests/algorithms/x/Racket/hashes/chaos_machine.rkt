...
(define i 0)
(let/ec _break (let loop ()
  (if (< i (cond [(not buf) 0] [(string? buf) (string-length buf)] [(hash? buf) (hash-count buf)] [else (length buf)])) (let/ec _cont
    (define value (if buf (if (hash? buf) (hash-ref buf i #f) (list-ref buf (int i))) #f))
    (define e (/ (* 1.0 seed) value))
    (define next_value (let ([__l (if buf (if (hash? buf) (hash-ref buf (modulo (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) size) #f) (list-ref buf (int (modulo (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) size)))) #f)] [__r e]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (set! next_value (- next_value (* 1.0 (int next_value))))
    (define r (let ([__l (if par (if (hash? par) (hash-ref par i #f) (list-ref par (int i))) #f)] [__r e]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (set! r (- r (* 1.0 (int r))))
...
(let/ec _break (let loop ()
  (if (< i t) (let/ec _cont
    (define r (if par (if (hash? par) (hash-ref par key #f) (list-ref par (int key))) #f))
    (define value (if buf (if (hash? buf) (hash-ref buf key #f) (list-ref buf (int key))) #f))
    ...
    (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    (loop)) (void))))
(define x (int (* (if buf (if (hash? buf) (hash-ref buf (modulo (let ([__l key] [__r 2]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) size) #f) (list-ref buf (int (modulo (let ([__l key] [__r 2]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) size)))) #f) 10000000000.0)))
(define y (int (* (if buf (if (hash? buf) (hash-ref buf (modulo (- (let ([__l key] [__r size]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) 2) size) #f) (list-ref buf (int (modulo (- (let ([__l key] [__r size]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) 2) size)))) #f) 10000000000.0)))

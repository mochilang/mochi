...
(define (hypercube_points num_points hypercube_size num_dimensions)
  (let/ec _return (begin
(define points (list))
(define i 0)
(let/ec _break (let loop ()
  ...
  (if (< j num_dimensions) (let/ec _cont
    (define value (* hypercube_size (random)))
    (set! point (append point (list value)))
...
(define pts (hypercube_points 3 1.0 2))

...
(let/ec _break (let ([i 0])
  (let loop ()
    (when (< i (cond [(string? word) (string-length word)] [(hash? word) (hash-count word)] [else (length word)]))
(if vertical (let ()
(if (or (>= (let ([__l row] [__r i]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) (cond [(string? puzzle) (string-length puzzle)] [(hash? puzzle) (hash-count puzzle)] [else (length puzzle)])) (not (string=? (if (if puzzle (if (hash? puzzle) (hash-ref puzzle (let ([__l row] [__r i]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) #f) (list-ref puzzle (int (let ([__l row] [__r i]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))) #f) (if (hash? (if puzzle (if (hash? puzzle) (hash-ref puzzle (let ([__l row] [__r i]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) #f) (list-ref puzzle (int (let ([__l row] [__r i]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))) #f)) (hash-ref (if puzzle (if (hash? puzzle) (hash-ref puzzle (let ([__l row] [__r i]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) #f) (list-ref puzzle (int (let ([__l row] [__r i]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))) #f) col #f) (list-ref (if puzzle (if (hash? puzzle) (hash-ref puzzle (let ([__l row] [__r i]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) #f) (list-ref puzzle (int (let ([__l row] [__r i]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))) #f) (int col))) #f) ""))) (let ()
(_return #f)
) (void))
) (let ()
(if (or (>= (let ([__l col] [__r i]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) (cond [(string? (if puzzle (if (hash? puzzle) (hash-ref puzzle 0 #f) (list-ref puzzle (int 0))) #f)) (string-length (if puzzle (if (hash? puzzle) (hash-ref puzzle 0 #f) (list-ref puzzle (int 0))) #f))] [(hash? (if puzzle (if (hash? puzzle) (hash-ref puzzle 0 #f) (list-ref puzzle (int 0))) #f)) (hash-count (if puzzle (if (hash? puzzle) (hash-ref puzzle 0 #f) (list-ref puzzle (int 0))) #f))] [else (length (if puzzle (if (hash? puzzle) (hash-ref puzzle 0 #f) (list-ref puzzle (int 0))) #f))])) (not (string=? (if (if puzzle (if (hash? puzzle) (hash-ref puzzle row #f) (list-ref puzzle (int row))) #f) (if (hash? (if puzzle (if (hash? puzzle) (hash-ref puzzle row #f) (list-ref puzzle (int row))) #f)) (hash-ref (if puzzle (if (hash? puzzle) (hash-ref puzzle row #f) (list-ref puzzle (int row))) #f) (let ([__l col] [__r i]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) #f) (list-ref (if puzzle (if (hash? puzzle) (hash-ref puzzle row #f) (list-ref puzzle (int row))) #f) (int (let ([__l col] [__r i]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))) #f) ""))) (let ()
(_return #f)
) (void))
))
      (set! i (+ i 1))
...
(let/ec _break (let ([row 0])
  (let loop ()
    (when (< row (cond [(string? puzzle) (string-length puzzle)] [(hash? puzzle) (hash-count puzzle)] [else (length puzzle)]))
(let/ec _break (let ([col 0])
  (let loop ()
    (when (< col (cond [(string? (if puzzle (if (hash? puzzle) (hash-ref puzzle 0 #f) (list-ref puzzle (int 0))) #f)) (string-length (if puzzle (if (hash? puzzle) (hash-ref puzzle 0 #f) (list-ref puzzle (int 0))) #f))] [(hash? (if puzzle (if (hash? puzzle) (hash-ref puzzle 0 #f) (list-ref puzzle (int 0))) #f)) (hash-count (if puzzle (if (hash? puzzle) (hash-ref puzzle 0 #f) (list-ref puzzle (int 0))) #f))] [else (length (if puzzle (if (hash? puzzle) (hash-ref puzzle 0 #f) (list-ref puzzle (int 0))) #f))]))
...
(let/ec _break (let ([i 0])
  (let loop ()
    (when (< i (cond [(string? words) (string-length words)] [(hash? words) (hash-count words)] [else (length words)]))

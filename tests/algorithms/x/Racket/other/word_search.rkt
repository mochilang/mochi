...
(define r 0)
(let/ec _break (let loop ()
  (if (let ([__l r] [__r height]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define row (list))
      (define c 0)
      (let/ec _break (let loop ()
  (if (let ([__l c] [__r width]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define ri 0)
(let/ec _break (let loop ()
  (if (let ([__l ri] [__r (cond [(not rows) 0] [(string? rows) (string-length rows)] [(hash? rows) (hash-count rows)] [else (length rows)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define row (if rows (if (hash? rows) (hash-ref rows ri #f) (safe-index rows (int ri))) #f))
      (define ci 0)
      (let/ec _break (let loop ()
  (if (let ([__l ci] [__r (cond [(not cols) 0] [(string? cols) (string-length cols)] [(hash? cols) (hash-count cols)] [else (length cols)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      ...
      (if (or (or (or (let ([__l end_r] [__r 0]) (< (int __l) (int __r))) (let ([__l end_r] [__r (if ws (hash-ref ws "height" #f) #f)]) (>= (int __l) (int __r)))) (let ([__l end_c] [__r 0]) (< (int __l) (int __r)))) (let ([__l end_c] [__r (if ws (hash-ref ws "width" #f) #f)]) (>= (int __l) (int __r)))) (let ()
...
(_cont)
      ...
      (define ok #t)
      (let/ec _break (let loop ()
  (if (let ([__l k] [__r word_len]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not (if ws (hash-ref ws "words" #f) #f)) 0] [(string? (if ws (hash-ref ws "words" #f) #f)) (string-length (if ws (hash-ref ws "words" #f) #f))] [(hash? (if ws (hash-ref ws "words" #f) #f)) (hash-count (if ws (hash-ref ws "words" #f) #f))] [else (length (if ws (hash-ref ws "words" #f) #f))])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      ...
      (define r 0)
      (let/ec _break (let loop ()
  (if (let ([__l r] [__r (if ws (hash-ref ws "height" #f) #f)]) (< (int __l) (int __r))) (begin
    (let/ec _cont
    ...
    (loop)) (void))))
      ...
      (define c 0)
      (let/ec _break (let loop ()
  (if (let ([__l c] [__r (if ws (hash-ref ws "width" #f) #f)]) (< (int __l) (int __r))) (begin
    (let/ec _cont

...
(define ri 0)
(let/ec _break (let loop ()
  (if (let ([__l ri] [__r (cond [(not rows) 0] [(string? rows) (string-length rows)] [(hash? rows) (hash-count rows)] [else (length rows)])]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      (define row (if rows (if (hash? rows) (hash-ref rows ri #f) (safe-index rows (int ri))) #f))
      (define ci 0)
      (let/ec _break (let loop ()
  (if (let ([__l ci] [__r (cond [(not cols) 0] [(string? cols) (string-length cols)] [(hash? cols) (hash-count cols)] [else (length cols)])]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not (if ws (hash-ref ws "words" #f) #f)) 0] [(string? (if ws (hash-ref ws "words" #f) #f)) (string-length (if ws (hash-ref ws "words" #f) #f))] [(hash? (if ws (hash-ref ws "words" #f) #f)) (hash-count (if ws (hash-ref ws "words" #f) #f))] [else (length (if ws (hash-ref ws "words" #f) #f))])]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont

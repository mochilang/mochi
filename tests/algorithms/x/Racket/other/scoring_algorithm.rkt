...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not source_data) 0] [(string? source_data) (string-length source_data)] [(hash? source_data) (hash-count source_data)] [else (length source_data)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
  ...
  (if (let ([__l j] [__r (cond [(not row) 0] [(string? row) (string-length row)] [(hash? row) (hash-count row)] [else (length row)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (if (let ([__l (cond [(not data_lists) 0] [(string? data_lists) (string-length data_lists)] [(hash? data_lists) (hash-count data_lists)] [else (length data_lists)])] [__r (let ([__l j] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))]) (< (int __l) (int __r))) (let ()
(define empty (list))
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not data_lists) 0] [(string? data_lists) (string-length data_lists)] [(hash? data_lists) (hash-count data_lists)] [else (length data_lists)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      ...
      (define j 1)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not dlist) 0] [(string? dlist) (string-length dlist)] [(hash? dlist) (hash-count dlist)] [else (length dlist)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define val (if dlist (if (hash? dlist) (hash-ref dlist j #f) (safe-index dlist (int j))) #f))
      (if (let ([__l val] [__r mind]) (< (int __l) (int __r))) (let ()
(set! mind val)
) (void))
      (if (let ([__l val] [__r maxd]) (> (int __l) (int __r))) (let ()
(set! maxd val)
) (void))
      (set! j (let ([__l j] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    )
...
(set! i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not score_lists) 0] [(string? score_lists) (string-length score_lists)] [(hash? score_lists) (hash-count score_lists)] [else (length score_lists)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define slist (if score_lists (if (hash? score_lists) (hash-ref score_lists i #f) (safe-index score_lists (int i))) #f))
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not slist) 0] [(string? slist) (string-length slist)] [(hash? slist) (hash-count slist)] [else (length slist)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not final_scores) 0] [(string? final_scores) (string-length final_scores)] [(hash? final_scores) (hash-count final_scores)] [else (length final_scores)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont

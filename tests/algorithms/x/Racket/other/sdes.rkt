...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not table) 0] [(string? table) (string-length table)] [(hash? table) (hash-count table)] [else (length table)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (and (let ([__l i] [__r (cond [(not a) 0] [(string? a) (string-length a)] [(hash? a) (hash-count a)] [else (length a)])]) (< (int __l) (int __r))) (let ([__l i] [__r (cond [(not b) 0] [(string? b) (string-length b)] [(hash? b) (hash-count b)] [else (length b)])]) (< (int __l) (int __r)))) (begin
    (let/ec _cont
...
(define res s)
(let/ec _break (let loop ()
  (if (let ([__l (cond [(not res) 0] [(string? res) (string-length res)] [(hash? res) (hash-count res)] [else (length res)])] [__r width]) (< (int __l) (int __r))) (begin
    (let/ec _cont

...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r resources]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define total 0)
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not alloc) 0] [(string? alloc) (string-length alloc)] [(hash? alloc) (hash-count alloc)] [else (length alloc)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not claim) 0] [(string? claim) (string-length claim)] [(hash? claim) (hash-count claim)] [else (length claim)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not max) 0] [(string? max) (string-length max)] [(hash? max) (hash-count max)] [else (length max)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define row (list))
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not (if max (if (hash? max) (hash-ref max 0 #f) (safe-index max (int 0))) #f)) 0] [(string? (if max (if (hash? max) (hash-ref max 0 #f) (safe-index max (int 0))) #f)) (string-length (if max (if (hash? max) (hash-ref max 0 #f) (safe-index max (int 0))) #f))] [(hash? (if max (if (hash? max) (hash-ref max 0 #f) (safe-index max (int 0))) #f)) (hash-count (if max (if (hash? max) (hash-ref max 0 #f) (safe-index max (int 0))) #f))] [else (length (if max (if (hash? max) (hash-ref max 0 #f) (safe-index max (int 0))) #f))])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not alloc) 0] [(string? alloc) (string-length alloc)] [(hash? alloc) (hash-count alloc)] [else (length alloc)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      ...
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not row) 0] [(string? row) (string-length row)] [(hash? row) (hash-count row)] [else (length row)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (set! line (string-append line (to-string (if row (if (hash? row) (hash-ref row j #f) (safe-index row (int j))) #f))))
      (if (let ([__l j] [__r (- (cond [(not row) 0] [(string? row) (string-length row)] [(hash? row) (hash-count row)] [else (length row)]) 1)]) (< (int __l) (int __r))) (let ()
...
(set! i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not avail) 0] [(string? avail) (string-length avail)] [(hash? avail) (hash-count avail)] [else (length avail)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (if (let ([__l i] [__r 0]) (> (int __l) (int __r))) (let ()
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not need_list) 0] [(string? need_list) (string-length need_list)] [(hash? need_list) (hash-count need_list)] [else (length need_list)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(let/ec _break (let loop ()
  (if (let ([__l r] [__r (cond [(not avail) 0] [(string? avail) (string-length avail)] [(hash? avail) (hash-count avail)] [else (length avail)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (if (let ([__l r] [__r 0]) (> (int __l) (int __r))) (let ()
(set! avail_str (string-append avail_str " "))
) (void))

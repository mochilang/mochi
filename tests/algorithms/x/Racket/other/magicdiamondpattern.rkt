...
(let/ec _break (let loop ()
  ...
  (if (let ([__l j] [__r (- (- n i) 1)]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    ...
    (loop)) (void))))
      (define k 0)
      (let/ec _break (let loop ()
  (if (let ([__l k] [__r (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      (set! result (string-append result "* "))

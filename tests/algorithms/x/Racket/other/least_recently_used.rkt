...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not store) 0] [(string? store) (string-length store)] [(hash? store) (hash-count store)] [else (length store)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define j 0)
(let/ec _break (let loop ()
  (if (let ([__l j] [__r (- (cond [(not store) 0] [(string? store) (string-length store)] [(hash? store) (hash-count store)] [else (length store)]) 1)]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not (if cache (hash-ref cache "store" #f) #f)) 0] [(string? (if cache (hash-ref cache "store" #f) #f)) (string-length (if cache (hash-ref cache "store" #f) #f))] [(hash? (if cache (hash-ref cache "store" #f) #f)) (hash-count (if cache (hash-ref cache "store" #f) #f))] [else (length (if cache (hash-ref cache "store" #f) #f))])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not (if cache (hash-ref cache "store" #f) #f)) 0] [(string? (if cache (hash-ref cache "store" #f) #f)) (string-length (if cache (hash-ref cache "store" #f) #f))] [(hash? (if cache (hash-ref cache "store" #f) #f)) (hash-count (if cache (hash-ref cache "store" #f) #f))] [else (length (if cache (hash-ref cache "store" #f) #f))])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      ...
      (if (let ([__l i] [__r (- (cond [(not (if cache (hash-ref cache "store" #f) #f)) 0] [(string? (if cache (hash-ref cache "store" #f) #f)) (string-length (if cache (hash-ref cache "store" #f) #f))] [(hash? (if cache (hash-ref cache "store" #f) #f)) (hash-count (if cache (hash-ref cache "store" #f) #f))] [else (length (if cache (hash-ref cache "store" #f) #f))]) 1)]) (< (int __l) (int __r))) (let ()

...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not lits) 0] [(string? lits) (string-length lits)] [(hash? lits) (hash-count lits)] [else (length lits)])]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not (if c (hash-ref c "names" #f) #f)) 0] [(string? (if c (hash-ref c "names" #f) #f)) (string-length (if c (hash-ref c "names" #f) #f))] [(hash? (if c (hash-ref c "names" #f) #f)) (hash-count (if c (hash-ref c "names" #f) #f))] [else (length (if c (hash-ref c "names" #f) #f))])]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not symbols) 0] [(string? symbols) (string-length symbols)] [(hash? symbols) (hash-count symbols)] [else (length symbols)])]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not clauses) 0] [(string? clauses) (string-length clauses)] [(hash? clauses) (hash-count clauses)] [else (length clauses)])]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not (if f (hash-ref f "clauses" #f) #f)) 0] [(string? (if f (hash-ref f "clauses" #f) #f)) (string-length (if f (hash-ref f "clauses" #f) #f))] [(hash? (if f (hash-ref f "clauses" #f) #f)) (hash-count (if f (hash-ref f "clauses" #f) #f))] [else (length (if f (hash-ref f "clauses" #f) #f))])]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      ...
      (if (let ([__l i] [__r (- (cond [(not (if f (hash-ref f "clauses" #f) #f)) 0] [(string? (if f (hash-ref f "clauses" #f) #f)) (string-length (if f (hash-ref f "clauses" #f) #f))] [(hash? (if f (hash-ref f "clauses" #f) #f)) (hash-count (if f (hash-ref f "clauses" #f) #f))] [else (length (if f (hash-ref f "clauses" #f) #f))]) 1)]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (let ()
(set! line (string-append line " , "))
) (void))
      (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    )

...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not entries) 0] [(string? entries) (string-length entries)] [(hash? entries) (hash-count entries)] [else (length entries)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not entries) 0] [(string? entries) (string-length entries)] [(hash? entries) (hash-count entries)] [else (length entries)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      ...
      (if (or (let ([__l (if e (hash-ref e "freq" #f) #f)] [__r (if m (hash-ref m "freq" #f) #f)]) (< (int __l) (int __r))) (and (equal? (if e (hash-ref e "freq" #f) #f) (if m (hash-ref m "freq" #f) #f)) (let ([__l (if e (hash-ref e "order" #f) #f)] [__r (if m (hash-ref m "order" #f) #f)]) (< (int __l) (int __r))))) (let ()
(set! min_idx i)
) (void))
      (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    )
...
(define j 0)
(let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not entries) 0] [(string? entries) (string-length entries)] [(hash? entries) (hash-count entries)] [else (length entries)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(if (let ([__l (cond [(not entries) 0] [(string? entries) (string-length entries)] [(hash? entries) (hash-count entries)] [else (length entries)])] [__r (if cache (hash-ref cache "capacity" #f) #f)]) (>= (int __l) (int __r))) (let ()

...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not b) 0] [(string? b) (string-length b)] [(hash? b) (hash-count b)] [else (length b)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define k 0)
(let/ec _break (let loop ()
  (if (let ([__l k] [__r (cond [(not xs) 0] [(string? xs) (string-length xs)] [(hash? xs) (hash-count xs)] [else (length xs)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (if (equal? k i) (let ()
...
(define magic_number (if (let ([__l gon_side] [__r 5]) (< (int __l) (int __r))) 1 2))
(define i 1)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (let ([__l (floor (/ (cond [(not extended) 0] [(string? extended) (string-length extended)] [(hash? extended) (hash-count extended)] [else (length extended)]) 3))] [__r magic_number]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 3)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not numbers) 0] [(string? numbers) (string-length numbers)] [(hash? numbers) (hash-count numbers)] [else (length numbers)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (if (let ([__l (if numbers (if (hash? numbers) (hash-ref numbers i #f) (safe-index numbers (int i))) #f)] [__r min_val]) (< (int __l) (int __r))) (let ()
...
(define k 0)
(let/ec _break (let loop ()
  (if (let ([__l k] [__r (cond [(not ring) 0] [(string? ring) (string-length ring)] [(hash? ring) (hash-count ring)] [else (length ring)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define (solution gon_side)
  (let/ec _return (begin
(if (or (let ([__l gon_side] [__r 3]) (< (int __l) (int __r))) (let ([__l gon_side] [__r 5]) (> (int __l) (int __r)))) (let ()
(_return "")
) (void))

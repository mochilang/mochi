...
(define (solution ratio)
  (let/ec _return (begin
(define j 3)
(define primes 3)
(let/ec _break (let loop ()
  (if (let ([__l (/ (exact->inexact primes) (- (* 2 j) 1))] [__r ratio]) (>= (int __l) (int __r))) (begin
    (let/ec _cont
      (define i (let ([__l (let ([__l (* j j)] [__r j]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
      (define limit (* (let ([__l j] [__r 2]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) (let ([__l j] [__r 2]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
      (define step (let ([__l j] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
      (let/ec _break (let loop ()
...
(define (test_solution)
  (let/ec _return (begin
(if (not (equal? (solution 0.5) 11)) (let ()
(panic "solution 0.5 failed")
) (void))
(if (not (equal? (solution 0.2) 309)) (let ()
(panic "solution 0.2 failed")
) (void))
(if (not (equal? (solution 0.111) 11317)) (let ()
...
(define (main)
  (let/ec _return (begin
(test_solution)
(displayln (to-string (solution 0.1)))
))
)

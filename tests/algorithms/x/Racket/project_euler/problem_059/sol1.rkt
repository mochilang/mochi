...
(let/ec _break (let loop ()
  (if (or (let ([__l x] [__r 0]) (> (int __l) (int __r))) (let ([__l y] [__r 0]) (> (int __l) (int __r)))) (begin
    (let/ec _cont
...
(if (and (let ([__l code] [__r 32]) (>= (int __l) (int __r))) (let ([__l code] [__r 127]) (< (int __l) (int __r)))) (let ()
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not ascii_chars) 0] [(string? ascii_chars) (string-length ascii_chars)] [(hash? ascii_chars) (hash-count ascii_chars)] [else (length ascii_chars)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define (is_valid_ascii code)
  (let/ec _return (begin
(if (and (let ([__l code] [__r 32]) (>= (int __l) (int __r))) (let ([__l code] [__r 126]) (<= (int __l) (int __r)))) (let ()
(_return #t)
) (void))
...
(define i 97)
(define COMMON_WORDS (list "the" "be" "to" "of" "and" "in" "that" "have"))
...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not ciphertext) 0] [(string? ciphertext) (string-length ciphertext)] [(hash? ciphertext) (hash-count ciphertext)] [else (length ciphertext)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not LOWERCASE_INTS) 0] [(string? LOWERCASE_INTS) (string-length LOWERCASE_INTS)] [(hash? LOWERCASE_INTS) (hash-count LOWERCASE_INTS)] [else (length LOWERCASE_INTS)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define j 0)
      (let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not LOWERCASE_INTS) 0] [(string? LOWERCASE_INTS) (string-length LOWERCASE_INTS)] [(hash? LOWERCASE_INTS) (hash-count LOWERCASE_INTS)] [else (length LOWERCASE_INTS)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (define k 0)
      (let/ec _break (let loop ()
  (if (let ([__l k] [__r (cond [(not LOWERCASE_INTS) 0] [(string? LOWERCASE_INTS) (string-length LOWERCASE_INTS)] [(hash? LOWERCASE_INTS) (hash-count LOWERCASE_INTS)] [else (length LOWERCASE_INTS)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (- n m)]) (<= (int __l) (int __r))) (begin
    (let/ec _cont
      (define j 0)
      (define is_match #t)
      (let/ec _break (let loop ()
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not possibles) 0] [(string? possibles) (string-length possibles)] [(hash? possibles) (hash-count possibles)] [else (length possibles)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not COMMON_WORDS) 0] [(string? COMMON_WORDS) (string-length COMMON_WORDS)] [(hash? COMMON_WORDS) (hash-count COMMON_WORDS)] [else (length COMMON_WORDS)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define j 0)
(let/ec _break (let loop ()
  (if (let ([__l j] [__r (cond [(not decoded_text) 0] [(string? decoded_text) (string-length decoded_text)] [(hash? decoded_text) (hash-count decoded_text)] [else (length decoded_text)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
...
(define ciphertext (list 17 6 1 69 12 1 69 26 11 69 1 2 69 15 10 1 78 13 11 78 16 13 15 16 69 6 5 19 11))
(let* ([_start_mem (current-memory-use)] [_start (current-inexact-monotonic-milliseconds)])
  (let/ec _return (begin
(let/ec _break (let loop ()
  (if (let ([__l i] [__r 122]) (<= (int __l) (int __r))) (begin
    (let/ec _cont

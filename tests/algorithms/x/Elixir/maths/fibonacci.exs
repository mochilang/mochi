...
defmodule Main do
  ...
  def matrix_mul(a, b) do
    try do
      a00 = Enum.at(Enum.at(a, 0), 0) * Enum.at(Enum.at(b, 0), 0) + Enum.at(Enum.at(a, 0), 1) * Enum.at(Enum.at(b, 1), 0)
      a01 = Enum.at(Enum.at(a, 0), 0) * Enum.at(Enum.at(b, 0), 1) + Enum.at(Enum.at(a, 0), 1) * Enum.at(Enum.at(b, 1), 1)
      a10 = Enum.at(Enum.at(a, 1), 0) * Enum.at(Enum.at(b, 0), 0) + Enum.at(Enum.at(a, 1), 1) * Enum.at(Enum.at(b, 1), 0)
      a11 = Enum.at(Enum.at(a, 1), 0) * Enum.at(Enum.at(b, 0), 1) + Enum.at(Enum.at(a, 1), 1) * Enum.at(Enum.at(b, 1), 1)
  ...
  def fib_matrix(n) do
    try do
      ...
      throw {:return, Enum.at(Enum.at(res, 0), 0)}
    catch
      {:return, val} -> val
    end
  end

# Code generated by Mochi transpiler 2025-08-08 17:05 +0700
defmodule Main do
  defp _bench_now() do
  ...
  def main() do
    ...
    IO.puts(Kernel.inspect(rgb_to_string(Enum.at(Enum.at(Process.get(:img1), 0), 0))))
    Process.put(:img2, get_image(10, 10, -0.6, 0.0, 3.2, 50, false))
    IO.puts(Kernel.inspect(rgb_to_string(Enum.at(Enum.at(Process.get(:img2), 0), 0))))
    mem_end = _mem()

          ...
          while_fun_15 = fn while_fun_15, dist, ii ->
            if ii < n do
              ...
              while_fun_16 = fn while_fun_16, dist, jj ->
                if jj < n do
                  {dist} = if Enum.at(Enum.at(dist, ii), jj) > Enum.at(Enum.at(dist, ii), k) + Enum.at(Enum.at(dist, k), jj) do
                    dist = List.replace_at(dist, ii, List.replace_at(Enum.at(dist, ii), jj, Enum.at(Enum.at(dist, ii), k) + Enum.at(Enum.at(dist, k), jj)))
                    {dist}
                  else
                    {dist}
                  end

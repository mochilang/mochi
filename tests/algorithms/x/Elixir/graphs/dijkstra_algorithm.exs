...
defmodule Main do
  ...
  def dijkstra(graph, src) do
    try do
      ...
      count = 0
      while_fun_3 = fn while_fun_3, count, visited ->
        if count < n do
          u = -1
          min_dist = 1000000000
          i = 0
          ...
          count = count + 1
          while_fun_3.(while_fun_3, count, visited)
        else
          {count, visited}
        end
      end

...
defmodule Main do
  ...
  def multi_a_star(start, goal, n_heuristic) do
    try do
      ...
      while_fun_11 = fn while_fun_11, back_pointer, g_function, i, open_list, t, visited ->
        if pq_minkey(Enum.at(open_list, 0, [])) < Process.get(:inf) do
          {back_pointer, g_function, i, open_list, t, visited} = try do
            chosen = 0
            i = 1
            ...
            if Map.has_key?(visited, ckey) do
              throw {:continue, {back_pointer, g_function, i, open_list, t, visited}}
            end
            ...
            {back_pointer, g_function, i, open_list, t, visited}
          catch
            {:continue, {back_pointer, g_function, i, open_list, t, visited}} -> {back_pointer, g_function, i, open_list, t, visited}
          end
          while_fun_11.(while_fun_11, back_pointer, g_function, i, open_list, t, visited)
        else
          {back_pointer, g_function, i, open_list, t, visited}
        end
      end
      {back_pointer, g_function, i, open_list, t, visited} = try do
          ...
          {:break, {back_pointer, g_function, i, open_list, t, visited}} -> {back_pointer, g_function, i, open_list, t, visited}
        end

          ...
          while_fun_4 = fn while_fun_4, j1, lower ->
            if j1 < i do
              ...
              while_fun_5 = fn while_fun_5, k, total ->
                if k < i do
                  total = total + Enum.at(Enum.at(lower, i), k) * Enum.at(Enum.at(upper, k), j1)
                  k = k + 1
              ...
              if Enum.at(Enum.at(upper, j1), j1) == 0.0 do
                raise("No LU decomposition exists")
              end
              lower = List.replace_at(lower, i, List.replace_at(Enum.at(lower, i), j1, (Enum.at(Enum.at(mat, i), j1) - total) / Enum.at(Enum.at(upper, j1), j1)))
              j1 = j1 + 1
          ...
          while_fun_6 = fn while_fun_6, j2, upper ->
            if j2 < n do
              ...
              while_fun_7 = fn while_fun_7, k2, total2 ->
                if k2 < i do
                  total2 = total2 + Enum.at(Enum.at(lower, i), k2) * Enum.at(Enum.at(upper, k2), j2)
                  k2 = k2 + 1
              ...
              upper = List.replace_at(upper, i, List.replace_at(Enum.at(upper, i), j2, Enum.at(Enum.at(mat, i), j2) - total2))
              j2 = j2 + 1

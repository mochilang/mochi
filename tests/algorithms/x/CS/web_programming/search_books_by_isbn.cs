...
class Program {
    ...
    static AuthorData _fetch_AuthorData(string url) {
        var json = _fetch(url);
        return JsonSerializer.Deserialize<AuthorData>(json, new JsonSerializerOptions{PropertyNameCaseInsensitive=true, IncludeFields=true});
    }
    static BookData _fetch_BookData(string url) {
        var json = _fetch(url);
        return JsonSerializer.Deserialize<BookData>(json, new JsonSerializerOptions{PropertyNameCaseInsensitive=true, IncludeFields=true});
    }

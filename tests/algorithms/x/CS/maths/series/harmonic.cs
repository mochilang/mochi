...
class Program {
    ...
    public static bool is_harmonic_series(double[] series_0) {
        ...
        while ((i_2 < series_0.Length)) {
            double val_3 = series_0[(int)(i_2)];
            if ((val_3 == 0.0)) {
                throw new Exception("Input series cannot have 0 as an element");
            }
            rec_series_1 = (Enumerable.ToArray(Enumerable.Append<double>(rec_series_1, (1.0 / val_3))));
            i_2 = (i_2 + 1);
        };
        double common_diff_4 = (rec_series_1[(int)(1)] - rec_series_1[(int)(0)]);
        long idx_5 = 2;
        while ((idx_5 < rec_series_1.Length)) {
            if (((rec_series_1[(int)(idx_5)] - rec_series_1[(int)((idx_5 - 1))]) != common_diff_4)) {
                return false;
            }
            idx_5 = (idx_5 + 1);
        };
    ...
    public static double harmonic_mean(double[] series_6) {
        ...
        while ((i_8 < series_6.Length)) {
            total_7 = (total_7 + (1.0 / series_6[(int)(i_8)]));
            i_8 = (i_8 + 1);
        };

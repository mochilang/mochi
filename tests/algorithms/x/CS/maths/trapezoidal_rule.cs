...
class Program {
    ...
    public static double trapezoidal_rule(double[] boundary_6, double steps_7) {
        double h_8 = ((boundary_6[(int)(1 < 0 ? boundary_6.Length + (1) : 1)] - boundary_6[(int)(0 < 0 ? boundary_6.Length + (0) : 0)]) / steps_7);
        double a_9 = boundary_6[(int)(0 < 0 ? boundary_6.Length + (0) : 0)];
        double b_10 = boundary_6[(int)(1 < 0 ? boundary_6.Length + (1) : 1)];
        double[] xs_11 = Program.make_points(a_9, b_10, h_8);
        double y_12 = ((h_8 / 2.0) * Program.f(a_9));
        long i_13 = 0;
        while ((i_13 < xs_11.Length)) {
            y_12 = (y_12 + (h_8 * Program.f(xs_11[(int)(i_13 < 0 ? xs_11.Length + (i_13) : i_13)])));
            i_13 = (i_13 + 1);
        };

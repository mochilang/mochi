...
class Program {
    ...
    public static long[] fib_iterative(long n_8) {
        ...
        long i_10 = 2;
        while ((i_10 <= n_8)) {
            fib_9 = ((Func<long[]>)(() => { var _tmp = fib_9.ToList(); _tmp.Add((_idx(fib_9, (i_10 - 1)) + _idx(fib_9, (i_10 - 2)))); return _tmp.ToArray(); }))();
            i_10 = (i_10 + 1);
        };
        return fib_9;
    }
    ...
    public static long[] fib_recursive(long n_12) {
        ...
        long i_14 = 0;
        while ((i_14 <= n_12)) {
            res_13 = ((Func<long[]>)(() => { var _tmp = res_13.ToList(); _tmp.Add(Program.fib_recursive_term(i_14)); return _tmp.ToArray(); }))();
            i_14 = (i_14 + 1);
        };
        return res_13;
    }
    ...
    public static long[] fib_recursive_cached(long n_18) {
        ...
        long j_20 = 0;
        while ((j_20 <= n_18)) {
            res_19 = ((Func<long[]>)(() => { var _tmp = res_19.ToList(); _tmp.Add(Program.fib_recursive_cached_term(j_20)); return _tmp.ToArray(); }))();
            j_20 = (j_20 + 1);
        };
        return res_19;
    }
    ...
    public static long[] fib_memoization(long n_24) {
        ...
        long i_26 = 0;
        while ((i_26 <= n_24)) {
            out_25 = ((Func<long[]>)(() => { var _tmp = out_25.ToList(); _tmp.Add(Program.fib_memoization_term(i_26)); return _tmp.ToArray(); }))();
            i_26 = (i_26 + 1);
        };
        return out_25;
    }
    ...
    public static long[] fib_binet(long n_27) {
        ...
        while ((i_31 <= n_27)) {
            ...
            res_30 = ((Func<long[]>)(() => { var _tmp = res_30.ToList(); _tmp.Add(val_32); return _tmp.ToArray(); }))();
            i_31 = (i_31 + 1);
        };
        return res_30;
    }

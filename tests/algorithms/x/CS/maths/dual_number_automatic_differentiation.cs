...
class Program {
    ...
    public static Dual make_dual(double real_0, long rank_1) {
        ...
        long i_3 = 0;
        while ((i_3 < rank_1)) {
            ds_2 = ((Func<double[]>)(() => { var _tmp = ds_2.ToList(); _tmp.Add(1.0); return _tmp.ToArray(); }))();
            i_3 = (i_3 + 1);
        };
    ...
    public static Dual dual_add(Dual a_6, Dual b_7) {
        ...
        while ((i_9 < a_6.duals.Length)) {
            s_dual_8 = ((Func<double[]>)(() => { var _tmp = s_dual_8.ToList(); _tmp.Add(_idx(a_6.duals, i_9)); return _tmp.ToArray(); }))();
            i_9 = (i_9 + 1);
        };
        double[] o_dual_10 = new double[]{};
        long j_11 = 0;
        while ((j_11 < b_7.duals.Length)) {
            o_dual_10 = ((Func<double[]>)(() => { var _tmp = o_dual_10.ToList(); _tmp.Add(_idx(b_7.duals, j_11)); return _tmp.ToArray(); }))();
            j_11 = (j_11 + 1);
        };
        if ((s_dual_8.Length > o_dual_10.Length)) {
            ...
            long k_13 = 0;
            while ((k_13 < diff_12)) {
                o_dual_10 = ((Func<double[]>)(() => { var _tmp = o_dual_10.ToList(); _tmp.Add(1.0); return _tmp.ToArray(); }))();
                k_13 = (k_13 + 1);
            }
            ...
            while ((k2_15 < diff2_14)) {
                s_dual_8 = ((Func<double[]>)(() => { var _tmp = s_dual_8.ToList(); _tmp.Add(1.0); return _tmp.ToArray(); }))();
                k2_15 = (k2_15 + 1);
            }
        };
        ...
        while ((idx_17 < s_dual_8.Length)) {
            new_duals_16 = ((Func<double[]>)(() => { var _tmp = new_duals_16.ToList(); _tmp.Add((_idx(s_dual_8, idx_17) + _idx(o_dual_10, idx_17))); return _tmp.ToArray(); }))();
            idx_17 = (idx_17 + 1);
        };
    ...
    public static Dual dual_add_real(Dual a_18, double b_19) {
        ...
        while ((i_21 < a_18.duals.Length)) {
            ds_20 = ((Func<double[]>)(() => { var _tmp = ds_20.ToList(); _tmp.Add(_idx(a_18.duals, i_21)); return _tmp.ToArray(); }))();
            i_21 = (i_21 + 1);
        };
    ...
    public static Dual dual_mul(Dual a_22, Dual b_23) {
        ...
        while ((idx_26 < new_len_24)) {
            new_duals_25 = ((Func<double[]>)(() => { var _tmp = new_duals_25.ToList(); _tmp.Add(0.0); return _tmp.ToArray(); }))();
            idx_26 = (idx_26 + 1);
        };
        long i_27 = 0;
    ...
    public static Dual dual_mul_real(Dual a_35, double b_36) {
        ...
        while ((i_38 < a_35.duals.Length)) {
            ds_37 = ((Func<double[]>)(() => { var _tmp = ds_37.ToList(); _tmp.Add((_idx(a_35.duals, i_38) * b_36)); return _tmp.ToArray(); }))();
            i_38 = (i_38 + 1);
        };

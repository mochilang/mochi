...
class Program {
    ...
    public static long[] prime_sieve(long num_2) {
        ...
        long i_4 = 0;
        while ((i_4 <= num_2)) {
            sieve_3 = (Enumerable.ToArray(Enumerable.Append<bool>(sieve_3, true)));
            i_4 = (i_4 + 1);
        };
        ...
        while ((start_6 <= end_7)) {
            if (sieve_3[(int)(start_6)]) {
                prime_5 = (Enumerable.ToArray(Enumerable.Append<long>(prime_5, start_6)));
        ...
        while ((k_9 <= num_2)) {
            if (sieve_3[(int)(k_9)]) {
                prime_5 = (Enumerable.ToArray(Enumerable.Append<long>(prime_5, k_9)));
            }
            k_9 = (k_9 + 1);
        };
        return prime_5;

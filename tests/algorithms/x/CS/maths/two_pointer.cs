...
class Program {
    ...
    public static long[] two_pointer(long[] nums_0, long target_1) {
        ...
        while ((i_2 < j_3)) {
            long s_4 = (nums_0[(int)(i_2 < 0 ? nums_0.Length + (i_2) : i_2)] + nums_0[(int)(j_3 < 0 ? nums_0.Length + (j_3) : j_3)]);
            if ((s_4 == target_1)) {
    ...
    public static void test_two_pointer() {
        if ((!Enumerable.SequenceEqual<long>(Program.two_pointer(new long[]{2, 7, 11, 15}, 9), new long[]{0, 1}))) {
            throw new Exception("case1");
        };
        if ((!Enumerable.SequenceEqual<long>(Program.two_pointer(new long[]{2, 7, 11, 15}, 17), new long[]{0, 3}))) {
            throw new Exception("case2");
        };
        if ((!Enumerable.SequenceEqual<long>(Program.two_pointer(new long[]{2, 7, 11, 15}, 18), new long[]{1, 2}))) {
            throw new Exception("case3");
        };
        if ((!Enumerable.SequenceEqual<long>(Program.two_pointer(new long[]{2, 7, 11, 15}, 26), new long[]{2, 3}))) {
            throw new Exception("case4");
        };
        if ((!Enumerable.SequenceEqual<long>(Program.two_pointer(new long[]{1, 3, 3}, 6), new long[]{1, 2}))) {

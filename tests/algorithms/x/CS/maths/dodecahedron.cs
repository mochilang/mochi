...
class Program {
    ...
    public static void test_dodecahedron() {
        if ((!Program.approx_equal(Program.dodecahedron_surface_area(5), 516.14322017669008, 0.0001))) {
        ...
        if ((!Program.approx_equal(Program.dodecahedron_volume(5), 957.88987007807907, 0.0001))) {
            throw new Exception("volume 5 failed");
        };
        if ((!Program.approx_equal(Program.dodecahedron_volume(10), 7663.1189606246326, 0.0001))) {

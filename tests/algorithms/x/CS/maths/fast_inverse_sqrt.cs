...
class Program {
    ...
    public static long rshift(long num_12, long k_13) {
        ...
        long i_15 = 0;
        while ((i_15 < k_13)) {
            result_14 = ((result_14 - _mod(result_14, 2)) / 2);
            i_15 = (i_15 + 1);
        };
        return result_14;
    }
    ...
    public static long float_to_bits(double x_19) {
        ...
        long mantissa_26 = Convert.ToInt64((frac_25 * Program.pow2_float(23)));
    ...
    public static void test_fast_inverse_sqrt() {
        ...
        if ((Program.absf((Program.fast_inverse_sqrt(4.1) - 0.4932849504615651)) > 0.0001)) {

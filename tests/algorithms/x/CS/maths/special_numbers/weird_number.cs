...
class Program {
    ...
    public static long sum_list(long[] xs_10) {
        ...
        while ((i_12 < xs_10.Length)) {
            total_11 = (total_11 + xs_10[(int)(i_12)]);
            i_12 = (i_12 + 1);
        };
        return total_11;
    }
    ...
    public static bool semi_perfect(long number_14) {
        ...
        while ((idx_18 < values_15.Length)) {
            long v_19 = values_15[(int)(idx_18)];
            long s_20 = number_14;
            while ((s_20 >= v_19)) {
                if (possible_16[(int)((s_20 - v_19))]) {
                    possible_16[s_20] = true;
                }
                s_20 = (s_20 - 1);
            }
            idx_18 = (idx_18 + 1);
        };
        return possible_16[(int)(number_14)];
    }
    ...
    public static void run_tests() {
        if ((Program.factors(12) != new long[]{1, 2, 3, 4, 6})) {
            throw new Exception("factors 12 failed");
        };
        if ((Program.factors(1) != new long[]{1})) {
            throw new Exception("factors 1 failed");
        };
        if ((Program.factors(100) != new long[]{1, 2, 4, 5, 10, 20, 25, 50})) {

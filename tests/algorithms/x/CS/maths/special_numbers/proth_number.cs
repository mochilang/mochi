...
class Program {
    ...
    public static long proth(long number_3) {
        ...
        long temp_4 = (long)(_floordiv(number_3, 3));
        long pow_5 = 1;
        ...
        while ((block_10 < block_index_6)) {
            ...
            while ((i_11 < increment_9)) {
                long next_val_12 = (Program.pow2((block_10 + 1)) + _idx(proth_list_7, (proth_index_8 - 1)));
                proth_list_7 = ((Func<long[]>)(() => { var _tmp = proth_list_7.Cast<long>().ToList(); _tmp.Add(next_val_12); return _tmp.ToArray(); }))();
        ...
        return _idx(proth_list_7, (number_3 - 1));
    }

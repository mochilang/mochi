...
class Program {
    ...
    public static double sum_of_harmonic_progression(double first_term_0, double common_difference_1, long number_of_terms_2) {
        ...
        while ((i_5 < (number_of_terms_2 - 1))) {
            ...
            arithmetic_progression_3 = ((Func<double[]>)(() => { var _tmp = arithmetic_progression_3.Cast<double>().ToList(); _tmp.Add(term_4); return _tmp.ToArray(); }))();
            i_5 = (i_5 + 1);
        };
        double total_6 = 0.0;
        long j_7 = 0;
        while ((j_7 < arithmetic_progression_3.Length)) {
            total_6 = (total_6 + (1.0 / _idx(arithmetic_progression_3, j_7)));
            j_7 = (j_7 + 1);
        };
        return total_6;
    }
    ...
    public static void test_sum_of_harmonic_progression() {
        ...
        if ((Program.abs_val((result1_9 - 0.75)) > 9.9999999999999995e-08)) {
            throw new Exception("test1 failed");
        };
        double result2_10 = Program.sum_of_harmonic_progression(0.20000000000000001, 5.0, 5);
        if ((Program.abs_val((result2_10 - 0.45666666666666667)) > 9.9999999999999995e-08)) {

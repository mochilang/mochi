...
class Program {
    ...
    public static long[] prime_factors(long n_4) {
        ...
        while ((_mod(num_5, 2) == 0)) {
            pf_6 = ((Func<long[]>)(() => { var _tmp = pf_6.ToList(); _tmp.Add(2); return _tmp.ToArray(); }))();
            num_5 = _floordiv(num_5, 2);
        };
        long i_7 = 3;
        while (((i_7 * i_7) <= num_5)) {
            while ((_mod(num_5, i_7) == 0)) {
                pf_6 = ((Func<long[]>)(() => { var _tmp = pf_6.ToList(); _tmp.Add(i_7); return _tmp.ToArray(); }))();
                num_5 = _floordiv(num_5, i_7);
            }
            i_7 = (i_7 + 2);
        };
        if ((num_5 > 2)) {
            pf_6 = ((Func<long[]>)(() => { var _tmp = pf_6.ToList(); _tmp.Add(num_5); return _tmp.ToArray(); }))();
        };
        return pf_6;
    }
    ...
    public static long[] unique(long[] arr_21) {
        ...
        while ((idx_23 < arr_21.Length)) {
            ...
            if ((!Program.contains(result_22, v_24))) {
                result_22 = ((Func<long[]>)(() => { var _tmp = result_22.ToList(); _tmp.Add(v_24); return _tmp.ToArray(); }))();
            }
            idx_23 = (idx_23 + 1);
        };
        return result_22;

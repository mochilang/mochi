...
class Program {
    ...
    public static long parse_decimal(string s_0) {
        ...
        while ((i_2 < s_0.Length)) {
            ...
            value_1 = ((value_1 * 10) + Convert.ToInt64(c_3));
            i_2 = (i_2 + 1);
        };
        return value_1;
    }
    ...
    public static string zeller_day(string date_input_4) {
        ...
        long t_15 = Convert.ToInt64(((2.6 * Convert.ToDouble(month_12)) - 5.39));
        long u_16 = (c_13 / 4);
        long v_17 = (k_14 / 4);
        long x_18 = (d_8 + k_14);
    ...
    public static void test_zeller() {
        ...
        while ((i_26 < inputs_24.Length)) {
            string res_27 = Program.zeller_day(inputs_24[(int)(i_26)]);
            if ((res_27 != expected_25[(int)(i_26)])) {

...
class Program {
    ...
    public static long[] mode_int(long[] lst_24) {
        ...
        while ((i_26 < lst_24.Length)) {
            counts_25 = ((Func<long[]>)(() => { var _tmp = counts_25.ToList(); _tmp.Add(Program.count_int(lst_24, _idx(lst_24, i_26))); return _tmp.ToArray(); }))();
            i_26 = (i_26 + 1);
        };
        long max_count_27 = 0;
        i_26 = 0;
        ...
        while ((i_26 < lst_24.Length)) {
            if ((_idx(counts_25, i_26) == max_count_27)) {
                ...
                if ((!Program.contains_int(modes_28, v_29))) {
                    modes_28 = ((Func<long[]>)(() => { var _tmp = modes_28.ToList(); _tmp.Add(v_29); return _tmp.ToArray(); }))();
                }
            }
            i_26 = (i_26 + 1);
        };
    ...
    public static string[] mode_string(string[] lst_30) {
        ...
        while ((i_32 < lst_30.Length)) {
            counts_31 = ((Func<long[]>)(() => { var _tmp = counts_31.ToList(); _tmp.Add(Program.count_string(lst_30, _idx(lst_30, i_32))); return _tmp.ToArray(); }))();
            i_32 = (i_32 + 1);
        };
        long max_count_33 = 0;
        i_32 = 0;
        ...
        while ((i_32 < lst_30.Length)) {
            if ((_idx(counts_31, i_32) == max_count_33)) {
                ...
                if ((!Program.contains_string(modes_34, v_35))) {
                    modes_34 = ((Func<string[]>)(() => { var _tmp = modes_34.ToList(); _tmp.Add(v_35); return _tmp.ToArray(); }))();
                }
            }
            i_32 = (i_32 + 1);
        };

...
class Program {
    ...
    public static long[] bubble_sort(long[] nums_0) {
        ...
        while ((i_2 < nums_0.Length)) {
            arr_1 = (Enumerable.ToArray(Enumerable.Append<long>(arr_1, nums_0[(int)(i_2 < 0 ? nums_0.Length + (i_2) : i_2)])));
            i_2 = (i_2 + 1);
        };
        ...
        while ((a_4 < n_3)) {
            long b_5 = 0;
            while ((b_5 < ((n_3 - a_4) - 1))) {
                if ((arr_1[(int)(b_5 < 0 ? arr_1.Length + (b_5) : b_5)] > arr_1[(int)((b_5 + 1) < 0 ? arr_1.Length + ((b_5 + 1)) : (b_5 + 1))])) {
                    long tmp_6 = arr_1[(int)(b_5 < 0 ? arr_1.Length + (b_5) : b_5)];
                    arr_1[(int)(b_5)] = arr_1[(int)((b_5 + 1) < 0 ? arr_1.Length + ((b_5 + 1)) : (b_5 + 1))];
    ...
    public static long[] sort3(long[] xs_7) {
        ...
        while ((i_9 < xs_7.Length)) {
            arr_8 = (Enumerable.ToArray(Enumerable.Append<long>(arr_8, xs_7[(int)(i_9 < 0 ? xs_7.Length + (i_9) : i_9)])));
            i_9 = (i_9 + 1);
        };
        ...
        while ((a_11 < n_10)) {
            ...
            while ((b_12 < ((n_10 - a_11) - 1))) {
                if ((arr_8[(int)(b_12 < 0 ? arr_8.Length + (b_12) : b_12)] > arr_8[(int)((b_12 + 1) < 0 ? arr_8.Length + ((b_12 + 1)) : (b_12 + 1))])) {
                    long tmp_13 = arr_8[(int)(b_12 < 0 ? arr_8.Length + (b_12) : b_12)];
                    arr_8[(int)(b_12)] = arr_8[(int)((b_12 + 1) < 0 ? arr_8.Length + ((b_12 + 1)) : (b_12 + 1))];
        ...
        while ((i_16 < (arr_14.Length - 2))) {
            ...
            while ((j_17 < (arr_14.Length - 1))) {
                ...
                while ((k_18 < arr_14.Length)) {
                    if ((((arr_14[(int)(i_16 < 0 ? arr_14.Length + (i_16) : i_16)] + arr_14[(int)(j_17 < 0 ? arr_14.Length + (j_17) : j_17)]) + arr_14[(int)(k_18 < 0 ? arr_14.Length + (k_18) : k_18)]) == target_15)) {
                        return Program.sort3(new long[]{arr_14[(int)(i_16 < 0 ? arr_14.Length + (i_16) : i_16)], arr_14[(int)(j_17 < 0 ? arr_14.Length + (j_17) : j_17)], arr_14[(int)(k_18 < 0 ? arr_14.Length + (k_18) : k_18)]});
                    }
                    k_18 = (k_18 + 1);
                }
                j_17 = (j_17 + 1);
    ...
    public static long[] triplet_sum2(long[] arr_19, long target_20) {
        ...
        while ((i_23 < (n_22 - 2))) {
            ...
            while ((left_24 < right_25)) {
                long s_26 = ((sorted_21[(int)(i_23 < 0 ? sorted_21.Length + (i_23) : i_23)] + sorted_21[(int)(left_24 < 0 ? sorted_21.Length + (left_24) : left_24)]) + sorted_21[(int)(right_25 < 0 ? sorted_21.Length + (right_25) : right_25)]);
                if ((s_26 == target_20)) {
                    return new long[]{sorted_21[(int)(i_23 < 0 ? sorted_21.Length + (i_23) : i_23)], sorted_21[(int)(left_24 < 0 ? sorted_21.Length + (left_24) : left_24)], sorted_21[(int)(right_25 < 0 ? sorted_21.Length + (right_25) : right_25)]};
                }
                if ((s_26 < target_20)) {
                    left_24 = (left_24 + 1);
                } else {
    ...
    public static bool list_equal(long[] a_27, long[] b_28) {
        ...
        while ((i_29 < a_27.Length)) {
            if ((a_27[(int)(i_29 < 0 ? a_27.Length + (i_29) : i_29)] != b_28[(int)(i_29 < 0 ? b_28.Length + (i_29) : i_29)])) {
                return false;
            }
            i_29 = (i_29 + 1);
        };
    ...
    public static void main() {
        ...
        Console.WriteLine(Program._fmtTop(((((_fmtStr(res_34[(int)(0 < 0 ? res_34.Length + (0) : 0)]) + " ") + _fmtStr(res_34[(int)(1 < 0 ? res_34.Length + (1) : 1)])) + " ") + _fmtStr(res_34[(int)(2 < 0 ? res_34.Length + (2) : 2)]))));
    }

...
class Program {
    ...
    public static long[] kth_permutation(long k_4, long n_5) {
        ...
        long i_7 = 2;
        while ((i_7 < n_5)) {
            factorials_6 = (Enumerable.ToArray(Enumerable.Append<long>(factorials_6, (factorials_6[(int)((factorials_6.Length - 1))] * i_7))));
            i_7 = (i_7 + 1);
        };
        long total_8 = (factorials_6[(int)((factorials_6.Length - 1))] * n_5);
        ...
        long e_10 = 0;
        while ((e_10 < n_5)) {
            elements_9 = (Enumerable.ToArray(Enumerable.Append<long>(elements_9, e_10)));
            e_10 = (e_10 + 1);
        };
        long[] permutation_11 = new long[]{};
        long idx_12 = (factorials_6.Length - 1);
        while ((idx_12 >= 0)) {
            long factorial_13 = factorials_6[(int)(idx_12)];
            long number_14 = (k_4 / factorial_13);
            k_4 = _mod(k_4, factorial_13);
            permutation_11 = (Enumerable.ToArray(Enumerable.Append<long>(permutation_11, elements_9[(int)(number_14)])));
            elements_9 = Program.remove_at(elements_9, number_14);
            idx_12 = (idx_12 - 1);
        };
        permutation_11 = (Enumerable.ToArray(Enumerable.Append<long>(permutation_11, elements_9[(int)(0)])));
    ...
    public static bool list_equal(long[] a_15, long[] b_16) {
        ...
        while ((i_17 < a_15.Length)) {
            if ((a_15[(int)(i_17)] != b_16[(int)(i_17)])) {
                return false;
            }
            i_17 = (i_17 + 1);
        };
    ...
    public static string list_to_string(long[] xs_18) {
        ...
        string s_19 = ("[" + _fmtStr(xs_18[(int)(0)]));
        long i_20 = 1;
        while ((i_20 < xs_18.Length)) {
            s_19 = ((s_19 + ", ") + _fmtStr(xs_18[(int)(i_20)]));
            i_20 = (i_20 + 1);
        };
        s_19 = (s_19 + "]");
        return s_19;

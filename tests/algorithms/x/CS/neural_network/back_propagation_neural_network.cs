...
class Program {
    ...
    public static double[] sigmoid_vec(double[] v_8) {
        ...
        while ((i_10 < v_8.Length)) {
            res_9 = ((Func<double[]>)(() => { var _tmp = res_9.Cast<double>().ToList(); _tmp.Add(Program.sigmoid(_idx(v_8, i_10))); return _tmp.ToArray(); }))();
            i_10 = (i_10 + 1);
        };
        return res_9;
    }
    ...
    public static double[] sigmoid_derivative(double[] out_11) {
        ...
        while ((i_13 < out_11.Length)) {
            double val_14 = _idx(out_11, i_13);
            res_12 = ((Func<double[]>)(() => { var _tmp = res_12.Cast<double>().ToList(); _tmp.Add((val_14 * (1.0 - val_14))); return _tmp.ToArray(); }))();
            i_13 = (i_13 + 1);
        };
        return res_12;
    }
    ...
    public static double[] random_vector(long n_15) {
        ...
        long i_17 = 0;
        while ((i_17 < n_15)) {
            v_16 = ((Func<double[]>)(() => { var _tmp = v_16.Cast<double>().ToList(); _tmp.Add((Program.random() - 0.5)); return _tmp.ToArray(); }))();
            i_17 = (i_17 + 1);
        };
        return v_16;
    }
    ...
    public static double[][] random_matrix(long r_18, long c_19) {
        ...
        long i_21 = 0;
        while ((i_21 < r_18)) {
            m_20 = ((Func<double[][]>)(() => { var _tmp = m_20.Cast<double[]>().ToList(); _tmp.Add(Program.random_vector(c_19)); return _tmp.ToArray(); }))();
            i_21 = (i_21 + 1);
        };
        return m_20;
    }
    ...
    public static double[] matvec(double[][] mat_22, double[] vec_23) {
        ...
        while ((i_25 < mat_22.Length)) {
            ...
            while ((j_27 < vec_23.Length)) {
                s_26 = (s_26 + (_idx(_idx(mat_22, i_25), j_27) * _idx(vec_23, j_27)));
                j_27 = (j_27 + 1);
            }
            res_24 = ((Func<double[]>)(() => { var _tmp = res_24.Cast<double>().ToList(); _tmp.Add(s_26); return _tmp.ToArray(); }))();
            i_25 = (i_25 + 1);
        };
        return res_24;
    }
    ...
    public static double[] matTvec(double[][] mat_28, double[] vec_29) {
        long cols_30 = _idx(mat_28, 0).Length;
        ...
        while ((j_32 < cols_30)) {
            ...
            while ((i_34 < mat_28.Length)) {
                s_33 = (s_33 + (_idx(_idx(mat_28, i_34), j_32) * _idx(vec_29, i_34)));
                i_34 = (i_34 + 1);
            }
            res_31 = ((Func<double[]>)(() => { var _tmp = res_31.Cast<double>().ToList(); _tmp.Add(s_33); return _tmp.ToArray(); }))();
            j_32 = (j_32 + 1);
        };
        return res_31;
    }
    ...
    public static double[] vec_sub(double[] a_35, double[] b_36) {
        ...
        while ((i_38 < a_35.Length)) {
            res_37 = ((Func<double[]>)(() => { var _tmp = res_37.Cast<double>().ToList(); _tmp.Add((_idx(a_35, i_38) - _idx(b_36, i_38))); return _tmp.ToArray(); }))();
            i_38 = (i_38 + 1);
        };
        return res_37;
    }
    ...
    public static double[] vec_mul(double[] a_39, double[] b_40) {
        ...
        while ((i_42 < a_39.Length)) {
            res_41 = ((Func<double[]>)(() => { var _tmp = res_41.Cast<double>().ToList(); _tmp.Add((_idx(a_39, i_42) * _idx(b_40, i_42))); return _tmp.ToArray(); }))();
            i_42 = (i_42 + 1);
        };
        return res_41;
    }
    ...
    public static double[] vec_scalar_mul(double[] v_43, double s_44) {
        ...
        while ((i_46 < v_43.Length)) {
            res_45 = ((Func<double[]>)(() => { var _tmp = res_45.Cast<double>().ToList(); _tmp.Add((_idx(v_43, i_46) * s_44)); return _tmp.ToArray(); }))();
            i_46 = (i_46 + 1);
        };
        return res_45;
    }
    ...
    public static double[][] outer(double[] a_47, double[] b_48) {
        ...
        while ((i_50 < a_47.Length)) {
            ...
            while ((j_52 < b_48.Length)) {
                row_51 = ((Func<double[]>)(() => { var _tmp = row_51.Cast<double>().ToList(); _tmp.Add((_idx(a_47, i_50) * _idx(b_48, j_52))); return _tmp.ToArray(); }))();
                j_52 = (j_52 + 1);
            }
            res_49 = ((Func<double[][]>)(() => { var _tmp = res_49.Cast<double[]>().ToList(); _tmp.Add(row_51); return _tmp.ToArray(); }))();
            i_50 = (i_50 + 1);
        };
        return res_49;
    }
    ...
    public static double[][] mat_scalar_mul(double[][] mat_53, double s_54) {
        ...
        while ((i_56 < mat_53.Length)) {
            ...
            long j_58 = 0;
            while ((j_58 < _idx(mat_53, i_56).Length)) {
                row_57 = ((Func<double[]>)(() => { var _tmp = row_57.Cast<double>().ToList(); _tmp.Add((_idx(_idx(mat_53, i_56), j_58) * s_54)); return _tmp.ToArray(); }))();
                j_58 = (j_58 + 1);
            }
            res_55 = ((Func<double[][]>)(() => { var _tmp = res_55.Cast<double[]>().ToList(); _tmp.Add(row_57); return _tmp.ToArray(); }))();
            i_56 = (i_56 + 1);
        };
        return res_55;
    }
    ...
    public static double[][] mat_sub(double[][] a_59, double[][] b_60) {
        ...
        while ((i_62 < a_59.Length)) {
            ...
            long j_64 = 0;
            while ((j_64 < _idx(a_59, i_62).Length)) {
                row_63 = ((Func<double[]>)(() => { var _tmp = row_63.Cast<double>().ToList(); _tmp.Add((_idx(_idx(a_59, i_62), j_64) - _idx(_idx(b_60, i_62), j_64))); return _tmp.ToArray(); }))();
                j_64 = (j_64 + 1);
            }
            res_61 = ((Func<double[][]>)(() => { var _tmp = res_61.Cast<double[]>().ToList(); _tmp.Add(row_63); return _tmp.ToArray(); }))();
            i_62 = (i_62 + 1);
        };
        return res_61;
    }
    ...
    public static Layer[] forward(Layer[] layers_68, double[] x_69) {
        ...
        while ((i_71 < layers_68.Length)) {
            Layer layer_72 = _idx(layers_68, i_71);
    ...
    public static Layer[] backward(Layer[] layers_74, double[] grad_75) {
        ...
        while ((i_77 > 0)) {
            Layer layer_78 = _idx(layers_74, i_77);
    ...
    public static double calc_loss(double[] y_82, double[] yhat_83) {
        ...
        while ((i_85 < y_82.Length)) {
            double d_86 = (_idx(y_82, i_85) - _idx(yhat_83, i_85));
            s_84 = (s_84 + (d_86 * d_86));
            i_85 = (i_85 + 1);
        };
        return s_84;
    ...
    public static double[] calc_gradient(double[] y_87, double[] yhat_88) {
        ...
        while ((i_90 < y_87.Length)) {
            g_89 = ((Func<double[]>)(() => { var _tmp = g_89.Cast<double>().ToList(); _tmp.Add((2.0 * (_idx(yhat_88, i_90) - _idx(y_87, i_90)))); return _tmp.ToArray(); }))();
            i_90 = (i_90 + 1);
        };
        return g_89;
    }
    ...
    public static double train(Layer[] layers_91, double[][] xdata_92, double[][] ydata_93, long rounds_94, double acc_95) {
        ...
        while ((r_96 < rounds_94)) {
            ...
            while ((i_97 < xdata_92.Length)) {
                layers_91 = Program.forward(layers_91, _idx(xdata_92, i_97));
                double[] out_98 = _idx(layers_91, (layers_91.Length - 1)).output;
                double[] grad_99 = Program.calc_gradient(_idx(ydata_93, i_97), out_98);
    ...
    public static Data create_data() {
        ...
        long i_101 = 0;
        while ((i_101 < 10)) {
            x_100 = ((Func<double[][]>)(() => { var _tmp = x_100.Cast<double[]>().ToList(); _tmp.Add(Program.random_vector(10)); return _tmp.ToArray(); }))();
            i_101 = (i_101 + 1);
        };
        double[][] y_102 = new double[][]{new double[]{0.80000000000000004, 0.40000000000000002}, new double[]{0.40000000000000002, 0.29999999999999999}, new double[]{0.34000000000000002, 0.45000000000000001}, new double[]{0.67000000000000004, 0.32000000000000001}, new double[]{0.88, 0.67000000000000004}, new double[]{0.78000000000000003, 0.77000000000000002}, new double[]{0.55000000000000004, 0.66000000000000003}, new double[]{0.55000000000000004, 0.42999999999999999}, new double[]{0.54000000000000004, 0.10000000000000001}, new double[]{0.10000000000000001, 0.5}};
    ...
    public static void main() {
        ...
        layers_106 = ((Func<Layer[]>)(() => { var _tmp = layers_106.Cast<Layer>().ToList(); _tmp.Add(Program.init_layer(10, 0, 0.29999999999999999)); return _tmp.ToArray(); }))();
        layers_106 = ((Func<Layer[]>)(() => { var _tmp = layers_106.Cast<Layer>().ToList(); _tmp.Add(Program.init_layer(20, 10, 0.29999999999999999)); return _tmp.ToArray(); }))();
        layers_106 = ((Func<Layer[]>)(() => { var _tmp = layers_106.Cast<Layer>().ToList(); _tmp.Add(Program.init_layer(30, 20, 0.29999999999999999)); return _tmp.ToArray(); }))();
        layers_106 = ((Func<Layer[]>)(() => { var _tmp = layers_106.Cast<Layer>().ToList(); _tmp.Add(Program.init_layer(2, 30, 0.29999999999999999)); return _tmp.ToArray(); }))();

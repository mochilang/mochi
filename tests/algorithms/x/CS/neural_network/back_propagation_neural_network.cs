...
class Program {
    ...
    public static double[] sigmoid_vec(double[] v_8) {
        ...
        while ((i_10 < v_8.Length)) {
            res_9 = (Enumerable.ToArray(Enumerable.Append<double>(res_9, Program.sigmoid(_idx(v_8, i_10)))));
            i_10 = (i_10 + 1);
        };
        return res_9;
    }
    ...
    public static double[] vec_sub(double[] a_35, double[] b_36) {
        ...
        while ((i_38 < a_35.Length)) {
            res_37 = (Enumerable.ToArray(Enumerable.Append<double>(res_37, (_idx(a_35, i_38) - _idx(b_36, i_38)))));
            i_38 = (i_38 + 1);
        };
        return res_37;
    }
    ...
    public static double[] vec_mul(double[] a_39, double[] b_40) {
        ...
        while ((i_42 < a_39.Length)) {
            res_41 = (Enumerable.ToArray(Enumerable.Append<double>(res_41, (_idx(a_39, i_42) * _idx(b_40, i_42)))));
            i_42 = (i_42 + 1);
        };
        return res_41;
    }
    ...
    public static double[] vec_scalar_mul(double[] v_43, double s_44) {
        ...
        while ((i_46 < v_43.Length)) {
            res_45 = (Enumerable.ToArray(Enumerable.Append<double>(res_45, (_idx(v_43, i_46) * s_44))));
            i_46 = (i_46 + 1);
        };
        return res_45;
    }
    ...
    public static double[][] outer(double[] a_47, double[] b_48) {
        ...
        while ((i_50 < a_47.Length)) {
            ...
            while ((j_52 < b_48.Length)) {
                row_51 = (Enumerable.ToArray(Enumerable.Append<double>(row_51, (_idx(a_47, i_50) * _idx(b_48, j_52)))));
                j_52 = (j_52 + 1);
            }
    ...
    public static double[][] mat_scalar_mul(double[][] mat_53, double s_54) {
        ...
        while ((i_56 < mat_53.Length)) {
            ...
            while ((j_58 < _idx(mat_53, i_56).Length)) {
                row_57 = (Enumerable.ToArray(Enumerable.Append<double>(row_57, (_idx(_idx(mat_53, i_56), j_58) * s_54))));
                j_58 = (j_58 + 1);
            }
    ...
    public static double[][] mat_sub(double[][] a_59, double[][] b_60) {
        ...
        while ((i_62 < a_59.Length)) {
            ...
            while ((j_64 < _idx(a_59, i_62).Length)) {
                row_63 = (Enumerable.ToArray(Enumerable.Append<double>(row_63, (_idx(_idx(a_59, i_62), j_64) - _idx(_idx(b_60, i_62), j_64)))));
                j_64 = (j_64 + 1);
            }
    ...
    public static double[] calc_gradient(double[] y_87, double[] yhat_88) {
        ...
        while ((i_90 < y_87.Length)) {
            g_89 = (Enumerable.ToArray(Enumerable.Append<double>(g_89, (2.0 * (_idx(yhat_88, i_90) - _idx(y_87, i_90))))));
            i_90 = (i_90 + 1);
        };
        return g_89;
    }

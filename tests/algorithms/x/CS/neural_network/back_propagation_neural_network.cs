...
class Program {
    ...
    public static void main() {
        ...
        layers_106 = ((Func<Layer[]>)(() => { var _tmp = layers_106.ToList(); _tmp.Add(Program.init_layer(10, 0, 0.3)); return _tmp.ToArray(); }))();
        layers_106 = ((Func<Layer[]>)(() => { var _tmp = layers_106.ToList(); _tmp.Add(Program.init_layer(20, 10, 0.3)); return _tmp.ToArray(); }))();
        layers_106 = ((Func<Layer[]>)(() => { var _tmp = layers_106.ToList(); _tmp.Add(Program.init_layer(30, 20, 0.3)); return _tmp.ToArray(); }))();
        layers_106 = ((Func<Layer[]>)(() => { var _tmp = layers_106.ToList(); _tmp.Add(Program.init_layer(2, 30, 0.3)); return _tmp.ToArray(); }))();

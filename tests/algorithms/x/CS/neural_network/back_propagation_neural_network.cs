...
class Program {
    ...
    public static double[] sigmoid_vec(double[] v_8) {
        ...
        while ((i_10 < v_8.Length)) {
            res_9 = ((Func<double[]>)(() => { var _tmp = res_9.ToList(); _tmp.Add(Program.sigmoid(_idx(v_8, i_10))); return _tmp.ToArray(); }))();
            i_10 = (i_10 + 1);
        };
        return res_9;
    }
    ...
    public static double[] sigmoid_derivative(double[] out_11) {
        ...
        while ((i_13 < out_11.Length)) {
            ...
            res_12 = ((Func<double[]>)(() => { var _tmp = res_12.ToList(); _tmp.Add((val_14 * (1.0 - val_14))); return _tmp.ToArray(); }))();
            i_13 = (i_13 + 1);
        };
        return res_12;
    }
    ...
    public static double[] random_vector(long n_15) {
        ...
        long i_17 = 0;
        while ((i_17 < n_15)) {
            v_16 = ((Func<double[]>)(() => { var _tmp = v_16.ToList(); _tmp.Add((Program.random() - 0.5)); return _tmp.ToArray(); }))();
            i_17 = (i_17 + 1);
        };
        return v_16;
    }
    ...
    public static double[][] random_matrix(long r_18, long c_19) {
        ...
        long i_21 = 0;
        while ((i_21 < r_18)) {
            m_20 = ((Func<double[][]>)(() => { var _tmp = m_20.ToList(); _tmp.Add(Program.random_vector(c_19)); return _tmp.ToArray(); }))();
            i_21 = (i_21 + 1);
        };
        return m_20;
    }
    ...
    public static double[] matvec(double[][] mat_22, double[] vec_23) {
        ...
        while ((i_25 < mat_22.Length)) {
            ...
            res_24 = ((Func<double[]>)(() => { var _tmp = res_24.ToList(); _tmp.Add(s_26); return _tmp.ToArray(); }))();
            i_25 = (i_25 + 1);
        };
        return res_24;
    }
    ...
    public static double[] matTvec(double[][] mat_28, double[] vec_29) {
        ...
        while ((j_32 < cols_30)) {
            ...
            res_31 = ((Func<double[]>)(() => { var _tmp = res_31.ToList(); _tmp.Add(s_33); return _tmp.ToArray(); }))();
            j_32 = (j_32 + 1);
        };
        return res_31;
    }
    ...
    public static double[] vec_sub(double[] a_35, double[] b_36) {
        ...
        while ((i_38 < a_35.Length)) {
            res_37 = ((Func<double[]>)(() => { var _tmp = res_37.ToList(); _tmp.Add((_idx(a_35, i_38) - _idx(b_36, i_38))); return _tmp.ToArray(); }))();
            i_38 = (i_38 + 1);
        };
        return res_37;
    }
    ...
    public static double[] vec_mul(double[] a_39, double[] b_40) {
        ...
        while ((i_42 < a_39.Length)) {
            res_41 = ((Func<double[]>)(() => { var _tmp = res_41.ToList(); _tmp.Add((_idx(a_39, i_42) * _idx(b_40, i_42))); return _tmp.ToArray(); }))();
            i_42 = (i_42 + 1);
        };
        return res_41;
    }
    ...
    public static double[] vec_scalar_mul(double[] v_43, double s_44) {
        ...
        while ((i_46 < v_43.Length)) {
            res_45 = ((Func<double[]>)(() => { var _tmp = res_45.ToList(); _tmp.Add((_idx(v_43, i_46) * s_44)); return _tmp.ToArray(); }))();
            i_46 = (i_46 + 1);
        };
        return res_45;
    }
    ...
    public static double[][] outer(double[] a_47, double[] b_48) {
        ...
        while ((i_50 < a_47.Length)) {
            ...
            while ((j_52 < b_48.Length)) {
                row_51 = ((Func<double[]>)(() => { var _tmp = row_51.ToList(); _tmp.Add((_idx(a_47, i_50) * _idx(b_48, j_52))); return _tmp.ToArray(); }))();
                j_52 = (j_52 + 1);
            }
            res_49 = ((Func<double[][]>)(() => { var _tmp = res_49.ToList(); _tmp.Add(row_51); return _tmp.ToArray(); }))();
            i_50 = (i_50 + 1);
        };
        return res_49;
    }
    ...
    public static double[][] mat_scalar_mul(double[][] mat_53, double s_54) {
        ...
        while ((i_56 < mat_53.Length)) {
            ...
            while ((j_58 < _idx(mat_53, i_56).Length)) {
                row_57 = ((Func<double[]>)(() => { var _tmp = row_57.ToList(); _tmp.Add((_idx(_idx(mat_53, i_56), j_58) * s_54)); return _tmp.ToArray(); }))();
                j_58 = (j_58 + 1);
            }
            res_55 = ((Func<double[][]>)(() => { var _tmp = res_55.ToList(); _tmp.Add(row_57); return _tmp.ToArray(); }))();
            i_56 = (i_56 + 1);
        };
        return res_55;
    }
    ...
    public static double[][] mat_sub(double[][] a_59, double[][] b_60) {
        ...
        while ((i_62 < a_59.Length)) {
            ...
            while ((j_64 < _idx(a_59, i_62).Length)) {
                row_63 = ((Func<double[]>)(() => { var _tmp = row_63.ToList(); _tmp.Add((_idx(_idx(a_59, i_62), j_64) - _idx(_idx(b_60, i_62), j_64))); return _tmp.ToArray(); }))();
                j_64 = (j_64 + 1);
            }
            res_61 = ((Func<double[][]>)(() => { var _tmp = res_61.ToList(); _tmp.Add(row_63); return _tmp.ToArray(); }))();
            i_62 = (i_62 + 1);
        };
        return res_61;
    }
    ...
    public static double[] calc_gradient(double[] y_87, double[] yhat_88) {
        ...
        while ((i_90 < y_87.Length)) {
            g_89 = ((Func<double[]>)(() => { var _tmp = g_89.ToList(); _tmp.Add((2.0 * (_idx(yhat_88, i_90) - _idx(y_87, i_90)))); return _tmp.ToArray(); }))();
            i_90 = (i_90 + 1);
        };
        return g_89;
    }
    ...
    public static Data create_data() {
        ...
        long i_101 = 0;
        while ((i_101 < 10)) {
            x_100 = ((Func<double[][]>)(() => { var _tmp = x_100.ToList(); _tmp.Add(Program.random_vector(10)); return _tmp.ToArray(); }))();
            i_101 = (i_101 + 1);
        };
    ...
    public static void main() {
        ...
        layers_106 = ((Func<Layer[]>)(() => { var _tmp = layers_106.ToList(); _tmp.Add(Program.init_layer(10, 0, 0.29999999999999999)); return _tmp.ToArray(); }))();
        layers_106 = ((Func<Layer[]>)(() => { var _tmp = layers_106.ToList(); _tmp.Add(Program.init_layer(20, 10, 0.29999999999999999)); return _tmp.ToArray(); }))();
        layers_106 = ((Func<Layer[]>)(() => { var _tmp = layers_106.ToList(); _tmp.Add(Program.init_layer(30, 20, 0.29999999999999999)); return _tmp.ToArray(); }))();
        layers_106 = ((Func<Layer[]>)(() => { var _tmp = layers_106.ToList(); _tmp.Add(Program.init_layer(2, 30, 0.29999999999999999)); return _tmp.ToArray(); }))();

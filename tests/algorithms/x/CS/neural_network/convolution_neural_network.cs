...
class Program {
    ...
    public static double[][] convolve(double[][] data_7, double[][] kernel_8, long step_9, double bias_10) {
        ...
        while ((i_14 <= (size_data_11 - size_kernel_12))) {
            ...
            while ((j_16 <= (size_data_11 - size_kernel_12))) {
                ...
                row_15 = ((Func<double[]>)(() => { var _tmp = row_15.Cast<double>().ToList(); _tmp.Add(Program.sigmoid((sum_17 - bias_10))); return _tmp.ToArray(); }))();
                j_16 = (j_16 + step_9);
            }
            out_13 = ((Func<double[][]>)(() => { var _tmp = out_13.Cast<double[]>().ToList(); _tmp.Add(row_15); return _tmp.ToArray(); }))();
            i_14 = (i_14 + step_9);
        };
        return out_13;
    }
    ...
    public static double[][] average_pool(double[][] map_20, long size_21) {
        ...
        while ((i_23 < map_20.Length)) {
            ...
            while ((j_25 < _idx(map_20, i_23).Length)) {
                ...
                row_24 = ((Func<double[]>)(() => { var _tmp = row_24.Cast<double>().ToList(); _tmp.Add((sum_26 / Convert.ToDouble((size_21 * size_21)))); return _tmp.ToArray(); }))();
                j_25 = (j_25 + size_21);
            }
            out_22 = ((Func<double[][]>)(() => { var _tmp = out_22.Cast<double[]>().ToList(); _tmp.Add(row_24); return _tmp.ToArray(); }))();
            i_23 = (i_23 + size_21);
        };
        return out_22;
    }
        ...
        while ((i_31 < maps_29.Length)) {
            ...
            while ((j_32 < _idx(maps_29, i_31).Length)) {
                ...
                while ((k_33 < _idx(_idx(maps_29, i_31), j_32).Length)) {
                    out_30 = ((Func<double[]>)(() => { var _tmp = out_30.Cast<double>().ToList(); _tmp.Add(_idx(_idx(_idx(maps_29, i_31), j_32), k_33)); return _tmp.ToArray(); }))();
                    k_33 = (k_33 + 1);
                }
                j_32 = (j_32 + 1);
            }
    ...
    public static double[] vec_mul_mat(double[] v_34, double[][] m_35) {
        ...
        while ((j_38 < cols_36)) {
            ...
            res_37 = ((Func<double[]>)(() => { var _tmp = res_37.Cast<double>().ToList(); _tmp.Add(sum_39); return _tmp.ToArray(); }))();
            j_38 = (j_38 + 1);
        };
        return res_37;
    }
    ...
    public static double[] matT_vec_mul(double[][] m_41, double[] v_42) {
        ...
        while ((i_44 < m_41.Length)) {
            ...
            res_43 = ((Func<double[]>)(() => { var _tmp = res_43.Cast<double>().ToList(); _tmp.Add(sum_45); return _tmp.ToArray(); }))();
            i_44 = (i_44 + 1);
        };
        return res_43;
    }
    ...
    public static double[] vec_add(double[] a_47, double[] b_48) {
        ...
        while ((i_50 < a_47.Length)) {
            res_49 = ((Func<double[]>)(() => { var _tmp = res_49.Cast<double>().ToList(); _tmp.Add((_idx(a_47, i_50) + _idx(b_48, i_50))); return _tmp.ToArray(); }))();
            i_50 = (i_50 + 1);
        };
        return res_49;
    }
    ...
    public static double[] vec_sub(double[] a_51, double[] b_52) {
        ...
        while ((i_54 < a_51.Length)) {
            res_53 = ((Func<double[]>)(() => { var _tmp = res_53.Cast<double>().ToList(); _tmp.Add((_idx(a_51, i_54) - _idx(b_52, i_54))); return _tmp.ToArray(); }))();
            i_54 = (i_54 + 1);
        };
        return res_53;
    }
    ...
    public static double[] vec_mul(double[] a_55, double[] b_56) {
        ...
        while ((i_58 < a_55.Length)) {
            res_57 = ((Func<double[]>)(() => { var _tmp = res_57.Cast<double>().ToList(); _tmp.Add((_idx(a_55, i_58) * _idx(b_56, i_58))); return _tmp.ToArray(); }))();
            i_58 = (i_58 + 1);
        };
        return res_57;
    }
    ...
    public static double[] vec_map_sig(double[] v_59) {
        ...
        while ((i_61 < v_59.Length)) {
            res_60 = ((Func<double[]>)(() => { var _tmp = res_60.Cast<double>().ToList(); _tmp.Add(Program.sigmoid(_idx(v_59, i_61))); return _tmp.ToArray(); }))();
            i_61 = (i_61 + 1);
        };
        return res_60;
    }
    ...
    public static CNN new_cnn() {
        ...
        while ((i_72 < input_size_68)) {
            ...
            while ((j_74 < hidden_size_69)) {
                row_73 = ((Func<double[]>)(() => { var _tmp = row_73.Cast<double>().ToList(); _tmp.Add((Program.random() - 0.5)); return _tmp.ToArray(); }))();
                j_74 = (j_74 + 1);
            }
            w_hidden_71 = ((Func<double[][]>)(() => { var _tmp = w_hidden_71.Cast<double[]>().ToList(); _tmp.Add(row_73); return _tmp.ToArray(); }))();
            i_72 = (i_72 + 1);
        };
        ...
        while ((i_72 < hidden_size_69)) {
            ...
            while ((j_77 < output_size_70)) {
                row_76 = ((Func<double[]>)(() => { var _tmp = row_76.Cast<double>().ToList(); _tmp.Add((Program.random() - 0.5)); return _tmp.ToArray(); }))();
                j_77 = (j_77 + 1);
            }
            w_out_75 = ((Func<double[][]>)(() => { var _tmp = w_out_75.Cast<double[]>().ToList(); _tmp.Add(row_76); return _tmp.ToArray(); }))();
            i_72 = (i_72 + 1);
        };
    ...
    public static double[] forward(CNN cnn_80, double[][] data_81) {
        ...
        while ((i_83 < cnn_80.conv_kernels.Length)) {
            ...
            maps_82 = ((Func<double[][][]>)(() => { var _tmp = maps_82.Cast<double[][]>().ToList(); _tmp.Add(pooled_85); return _tmp.ToArray(); }))();
            i_83 = (i_83 + 1);
        };
        ...
        while ((e_98 < epochs_93)) {
            ...
            while ((s_99 < samples_92.Length)) {
                ...
                while ((i_103 < cnn_91.conv_kernels.Length)) {
                    ...
                    maps_102 = ((Func<double[][][]>)(() => { var _tmp = maps_102.Cast<double[][]>().ToList(); _tmp.Add(pooled_105); return _tmp.ToArray(); }))();
                    i_103 = (i_103 + 1);
                }

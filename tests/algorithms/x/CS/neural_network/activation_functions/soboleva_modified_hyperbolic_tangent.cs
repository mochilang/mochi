...
class Program {
    ...
    public static double[] soboleva_modified_hyperbolic_tangent(double[] vector_4, double a_value_5, double b_value_6, double c_value_7, double d_value_8) {
        ...
        while ((i_10 < vector_4.Length)) {
            ...
            result_9 = ((Func<double[]>)(() => { var _tmp = result_9.Cast<double>().ToList(); _tmp.Add((numerator_12 / denominator_13)); return _tmp.ToArray(); }))();
            i_10 = (i_10 + 1);
        };
        return result_9;
    }
    ...
    public static void main() {
        double[] vector_14 = new double[]{5.4000000000000004, -2.3999999999999999, 6.2999999999999998, -5.2300000000000004, 3.27, 0.56000000000000005};
        double[] res_15 = Program.soboleva_modified_hyperbolic_tangent(vector_14, 0.20000000000000001, 0.40000000000000002, 0.59999999999999998, 0.80000000000000004);

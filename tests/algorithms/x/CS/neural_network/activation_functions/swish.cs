...
class Program {
    ...
    public static double[] sigmoid(double[] vector_4) {
        ...
        while ((i_6 < vector_4.Length)) {
            ...
            result_5 = ((Func<double[]>)(() => { var _tmp = result_5.Cast<double>().ToList(); _tmp.Add(s_8); return _tmp.ToArray(); }))();
            i_6 = (i_6 + 1);
        };
        return result_5;
    }
    ...
    public static double[] swish(double[] vector_9, double beta_10) {
        ...
        while ((i_12 < vector_9.Length)) {
            ...
            result_11 = ((Func<double[]>)(() => { var _tmp = result_11.Cast<double>().ToList(); _tmp.Add((v_13 * s_14)); return _tmp.ToArray(); }))();
            i_12 = (i_12 + 1);
        };
        return result_11;
    }
    ...
    public static void test_swish() {
        ...
        double eps_25 = 0.001;
        if ((!Program.approx_equal_list(Program.sigmoid(v_24), new double[]{0.26894141999999999, 0.73105858000000001, 0.88079708000000001}, eps_25))) {
            throw new Exception("sigmoid incorrect");
        };
        if ((!Program.approx_equal_list(Program.sigmoid_linear_unit(v_24), new double[]{-0.26894141999999999, 0.73105858000000001, 1.76159416}, eps_25))) {
            throw new Exception("sigmoid_linear_unit incorrect");
        };
        if ((!Program.approx_equal_list(Program.swish(v_24, 2.0), new double[]{-0.11920292, 0.88079708000000001, 1.96402758}, eps_25))) {
            throw new Exception("swish incorrect");
        };
        if ((!Program.approx_equal_list(Program.swish(new double[]{-2.0}, 1.0), new double[]{-0.23840584000000001}, eps_25))) {

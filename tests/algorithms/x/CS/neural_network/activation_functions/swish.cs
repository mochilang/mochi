...
class Program {
    ...
    public static double[] sigmoid(double[] vector_4) {
        ...
        while ((i_6 < vector_4.Length)) {
            ...
            result_5 = ((Func<double[]>)(() => { var _tmp = result_5.ToList(); _tmp.Add(s_8); return _tmp.ToArray(); }))();
            i_6 = (i_6 + 1);
        };
        return result_5;
    }
    ...
    public static double[] swish(double[] vector_9, double beta_10) {
        ...
        while ((i_12 < vector_9.Length)) {
            ...
            result_11 = ((Func<double[]>)(() => { var _tmp = result_11.ToList(); _tmp.Add((v_13 * s_14)); return _tmp.ToArray(); }))();
            i_12 = (i_12 + 1);
        };
        return result_11;
    }

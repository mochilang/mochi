        ...
        while ((i_3 < labels_0.Length)) {
            ...
            while ((j_5 < num_classes_1)) {
                if ((j_5 == _idx(labels_0, i_3))) {
                    row_4 = ((Func<long[]>)(() => { var _tmp = row_4.ToList(); _tmp.Add(1); return _tmp.ToArray(); }))();
                } else {
                    row_4 = ((Func<long[]>)(() => { var _tmp = row_4.ToList(); _tmp.Add(0); return _tmp.ToArray(); }))();
                }
                j_5 = (j_5 + 1);
            }
            result_2 = ((Func<long[][]>)(() => { var _tmp = result_2.ToList(); _tmp.Add(row_4); return _tmp.ToArray(); }))();
            i_3 = (i_3 + 1);
        };
        return result_2;
    }

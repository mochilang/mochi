...
class Program {
    ...
    public static long partition(long m_0) {
        ...
        return memo_1[(int)(m_0)][(int)((m_0 - 1))];
    }
    ...
    static void Main() {
        {
            var __memStart = _mem();
            var __start = _now();
            Console.WriteLine(Program._fmtTop(Program.partition(5)));
            Console.WriteLine(Program._fmtTop(Program.partition(7)));
            Console.WriteLine(Program._fmtTop(Program.partition(100)));
            var __end = _now();
            var __memEnd = _mem();

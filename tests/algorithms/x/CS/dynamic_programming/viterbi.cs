...
class Program {
    ...
    static Dictionary<string, double> start_p_40 = new Dictionary<string, double>{{"Healthy", 0.59999999999999998}, {"Fever", 0.40000000000000002}};
    static Dictionary<string, Dictionary<string, double>> trans_p_41 = new Dictionary<string, Dictionary<string, double>>{{"Healthy", new Dictionary<string, double>{{"Healthy", 0.69999999999999996}, {"Fever", 0.29999999999999999}}}, {"Fever", new Dictionary<string, double>{{"Healthy", 0.40000000000000002}, {"Fever", 0.59999999999999998}}}};
    static Dictionary<string, Dictionary<string, double>> emit_p_42 = new Dictionary<string, Dictionary<string, double>>{{"Healthy", new Dictionary<string, double>{{"normal", 0.5}, {"cold", 0.40000000000000002}, {"dizzy", 0.10000000000000001}}}, {"Fever", new Dictionary<string, double>{{"normal", 0.10000000000000001}, {"cold", 0.29999999999999999}, {"dizzy", 0.59999999999999998}}}};
    ...
    public static string[] viterbi(string[] observations_2, string[] states_3, Dictionary<string, double> start_p_4, Dictionary<string, Dictionary<string, double>> trans_p_5, Dictionary<string, Dictionary<string, double>> emit_p_6) {
        ...
        string first_obs_9 = _idx(observations_2, 0);
        long i_10 = 0;
        while ((i_10 < states_3.Length)) {
            string state_11 = _idx(states_3, i_10);
        ...
        while ((t_12 < observations_2.Length)) {
            string obs_13 = _idx(observations_2, t_12);
            long j_14 = 0;
            while ((j_14 < states_3.Length)) {
                string state_15 = _idx(states_3, j_14);
                double max_prob_16 = -1.0;
                string prev_state_17 = "";
                long k_18 = 0;
                while ((k_18 < states_3.Length)) {
                    string state0_19 = _idx(states_3, k_18);
                    string obs0_20 = _idx(observations_2, (t_12 - 1));
        ...
        while ((n_24 < observations_2.Length)) {
            path_23 = ((Func<string[]>)(() => { var _tmp = path_23.ToList(); _tmp.Add(""); return _tmp.ToArray(); }))();
            n_24 = (n_24 + 1);
        };
        string last_obs_25 = _idx(observations_2, (observations_2.Length - 1));
        double max_final_26 = -1.0;
        string last_state_27 = "";
        long m_28 = 0;
        while ((m_28 < states_3.Length)) {
            string state_29 = _idx(states_3, m_28);
        ...
        while ((idx_32 > 0)) {
            string obs_33 = _idx(observations_2, idx_32);
            string prev_34 = (ptrs_8.ContainsKey(Program.key(_idx(path_23, idx_32), obs_33)) ? ptrs_8[Program.key(_idx(path_23, idx_32), obs_33)] : "");
    ...
    public static string join_words(string[] words_35) {
        ...
        while ((i_37 < words_35.Length)) {
            ...
            res_36 = (res_36 + _idx(words_35, i_37));
            i_37 = (i_37 + 1);
        };
        return res_36;
    }

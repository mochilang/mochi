...
class Program {
    ...
    public static void add_edge(AdjacencyList al_3, long from_vertex_4, long to_vertex_5, long weight_6) {
        ...
        Edge[][] g_7 = al_3.graph;
        Edge[] edges_8 = g_7[(int)(from_vertex_4 < 0 ? g_7.Length + (from_vertex_4) : from_vertex_4)];
        g_7[(int)(from_vertex_4)] = (Enumerable.ToArray(Enumerable.Append<Edge>(edges_8, new Edge{destination_vertex = to_vertex_5, weight = weight_6})));
        al_3.graph = g_7;
    }
    ...
    public static long[] push_front(long[] q_9, long v_10) {
        ...
        while ((i_12 < q_9.Length)) {
            res_11 = (Enumerable.ToArray(Enumerable.Append<long>(res_11, q_9[(int)(i_12 < 0 ? q_9.Length + (i_12) : i_12)])));
            i_12 = (i_12 + 1);
        };
        return res_11;
    }
    ...
    public static long[] pop_front(long[] q_13) {
        ...
        while ((i_15 < q_13.Length)) {
            res_14 = (Enumerable.ToArray(Enumerable.Append<long>(res_14, q_13[(int)(i_15 < 0 ? q_13.Length + (i_15) : i_15)])));
            i_15 = (i_15 + 1);
        };
        return res_14;
    }
    ...
    public static long front(long[] q_16) {
        return q_16[(int)(0 < 0 ? q_16.Length + (0) : 0)];
    }
    ...
    public static long get_shortest_path(AdjacencyList al_17, long start_vertex_18, long finish_vertex_19) {
        ...
        while ((queue_20.Length > 0)) {
            ...
            long current_distance_24 = distances_21[(int)(current_vertex_23 < 0 ? distances_21.Length + (current_vertex_23) : current_vertex_23)];
            Edge[] edges_25 = al_17.graph[(int)(current_vertex_23 < 0 ? al_17.graph.Length + (current_vertex_23) : current_vertex_23)];
            long j_26 = 0;
            while ((j_26 < edges_25.Length)) {
                Edge edge_27 = edges_25[(int)(j_26 < 0 ? edges_25.Length + (j_26) : j_26)];
                long new_distance_28 = (current_distance_24 + edge_27.weight);
                long dest_29 = edge_27.destination_vertex;
                long dest_distance_30 = distances_21[(int)(dest_29 < 0 ? distances_21.Length + (dest_29) : dest_29)];
        ...
        long result_31 = distances_21[(int)(finish_vertex_19 < 0 ? distances_21.Length + (finish_vertex_19) : finish_vertex_19)];
        if ((result_31 < 0)) {

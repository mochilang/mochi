...
class Program {
    ...
    public static long[] dfs(long start_1, Dictionary<long, bool> visited_2) {
        ...
        foreach (long v_5 in (tree_0.ContainsKey(start_1) ? tree_0[start_1] : null)) {
            if ((!(visited_2.ContainsKey(v_5)))) {
                ...
                size_3 = (size_3 + res_6[(int)(0)]);
                cuts_4 = (cuts_4 + res_6[(int)(1)]);
            }
        };
        if ((_mod(size_3, 2) == 0)) {
            cuts_4 = (cuts_4 + 1);
    ...
    public static void main() {
        ...
        while ((i_10 < edges_9.Length)) {
            long u_11 = edges_9[(int)(i_10)][(int)(0)];
            long v_12 = edges_9[(int)(i_10)][(int)(1)];
            ...
            tree_0[u_11] = (Enumerable.ToArray(Enumerable.Append<long>((tree_0.ContainsKey(u_11) ? tree_0[u_11] : null), v_12)));
            tree_0[v_12] = (Enumerable.ToArray(Enumerable.Append<long>((tree_0.ContainsKey(v_12) ? tree_0[v_12] : null), u_11)));
            i_10 = (i_10 + 1);
        };

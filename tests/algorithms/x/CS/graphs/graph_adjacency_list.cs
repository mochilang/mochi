...
class Program {
    ...
    public static Graph create_graph(string[] vertices_0, string[][] edges_1, bool directed_2) {
        ...
        foreach (string[] e_5 in edges_1) {
            string s_6 = e_5[(int)(0)];
            string d_7 = e_5[(int)(1)];
            ...
            adj_3[s_6] = (Enumerable.ToArray(Enumerable.Append<string>((adj_3.ContainsKey(s_6) ? adj_3[s_6] : null), d_7)));
            if ((!directed_2)) {
                adj_3[d_7] = (Enumerable.ToArray(Enumerable.Append<string>((adj_3.ContainsKey(d_7) ? adj_3[d_7] : null), s_6)));
            }
        };
    ...
    public static string[] remove_from_list(string[] lst_12, string value_13) {
        ...
        while ((i_15 < lst_12.Length)) {
            if ((lst_12[(int)(i_15)] != value_13)) {
                res_14 = (Enumerable.ToArray(Enumerable.Append<string>(res_14, lst_12[(int)(i_15)])));
            }
            i_15 = (i_15 + 1);
        };
        return res_14;
    ...
    public static Graph add_edge(Graph graph_20, string s_21, string d_22) {
        ...
        list_s_25 = (Enumerable.ToArray(Enumerable.Append<string>(list_s_25, d_22)));
        adj_23[s_21] = list_s_25;
        if ((!graph_20.directed)) {
            string[] list_d_26 = (adj_23.ContainsKey(d_22) ? adj_23[d_22] : null);
            list_d_26 = (Enumerable.ToArray(Enumerable.Append<string>(list_d_26, s_21)));

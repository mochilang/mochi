...
class Program {
    ...
    public static Pair[] prim_mst(Edge[][] graph_5) {
        ...
        while ((i_10 < n_6)) {
            ...
            dist_8 = (Enumerable.ToArray(Enumerable.Append<long>(dist_8, INF_0)));
            parent_9 = (Enumerable.ToArray(Enumerable.Append<long>(parent_9, -1)));
            i_10 = (i_10 + 1);
        };
        dist_8[0] = 0;
        ...
        while ((count_12 < n_6)) {
            ...
            long v_15 = 0;
            while ((v_15 < n_6)) {
                if (((visited_7[(int)(v_15)] == false) && (dist_8[(int)(v_15)] < min_val_13))) {
                    min_val_13 = dist_8[(int)(v_15)];
                    u_14 = v_15;
                }
                v_15 = (v_15 + 1);
            }
            ...
            visited_7[u_14] = true;
            if ((u_14 != 0)) {
                result_11 = (Enumerable.ToArray(Enumerable.Append<Pair>(result_11, new Pair{u = parent_9[(int)(u_14)], v = u_14})));
            }
            foreach (Edge e_16 in graph_5[(int)(u_14)]) {
                if (((visited_7[(int)(e_16.to)] == false) && (e_16.weight < dist_8[(int)(e_16.to)]))) {
                    dist_8[e_16.to] = e_16.weight;
                    parent_9[e_16.to] = u_14;
                }
            }
            count_12 = (count_12 + 1);
        };

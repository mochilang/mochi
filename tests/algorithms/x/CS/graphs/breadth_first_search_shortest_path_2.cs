...
class Program {
    ...
    public static string[] bfs_shortest_path(Dictionary<string, string[]> graph_6, string start_7, string goal_8) {
        ...
        while ((queue_10.Length > 0)) {
            string[] path_11 = queue_10[(int)(0 < 0 ? queue_10.Length + (0) : 0)];
            queue_10 = _slice<string[]>(queue_10, 1, queue_10.Length);
            string node_12 = path_11[(int)((path_11.Length - 1) < 0 ? path_11.Length + ((path_11.Length - 1)) : (path_11.Length - 1))];
            if ((!Program.contains(explored_9, node_12))) {
                ...
                while ((i_14 < neighbours_13.Length)) {
                    string neighbour_15 = neighbours_13[(int)(i_14 < 0 ? neighbours_13.Length + (i_14) : i_14)];
    ...
    public static long bfs_shortest_path_distance(Dictionary<string, string[]> graph_17, string start_18, string target_19) {
        ...
        while ((queue_20.Length > 0)) {
            string node_23 = queue_20[(int)(0 < 0 ? queue_20.Length + (0) : 0)];
            ...
            while ((i_25 < adj_24.Length)) {
                string next_26 = adj_24[(int)(i_25 < 0 ? adj_24.Length + (i_25) : i_25)];

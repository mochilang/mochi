...
class Program {
    ...
    public static void dfs(Dictionary<long, long[]> g_0, long s_1) {
        ...
        visited_2[s_1] = true;
        stack_3 = (Enumerable.ToArray(Enumerable.Append<long>(stack_3, s_1)));
        Console.WriteLine(Program._fmtTop(s_1));
        while ((stack_3.Length > 0)) {
            long u_4 = stack_3[(int)((stack_3.Length - 1))];
            bool found_5 = false;
            foreach (long v_6 in (g_0.ContainsKey(u_4) ? g_0[u_4] : null)) {
                if ((!(visited_2.ContainsKey(v_6)))) {
                    visited_2[v_6] = true;
                    stack_3 = (Enumerable.ToArray(Enumerable.Append<long>(stack_3, v_6)));
            ...
            if ((!found_5)) {
                stack_3 = stack_3.Skip((int)(0)).Take((int)(((stack_3.Length - 1) - 0))).ToArray();
            }
        };
    }
    ...
    public static void bfs(Dictionary<long, long[]> g_7, long s_8) {
        ...
        long[] q_10 = new long[]{};
        visited_9[s_8] = true;
        q_10 = (Enumerable.ToArray(Enumerable.Append<long>(q_10, s_8)));
        Console.WriteLine(Program._fmtTop(s_8));
        while ((q_10.Length > 0)) {
            long u_11 = q_10[(int)(0)];
            q_10 = q_10.Skip((int)(1)).Take((int)((q_10.Length - 1))).ToArray();
            foreach (long v_12 in (g_7.ContainsKey(u_11) ? g_7[u_11] : null)) {
                if ((!(visited_9.ContainsKey(v_12)))) {
                    visited_9[v_12] = true;
                    q_10 = (Enumerable.ToArray(Enumerable.Append<long>(q_10, v_12)));
    ...
    public static long[] sort_ints(long[] a_13) {
        ...
        while ((i_15 < arr_14.Length)) {
            ...
            while ((j_16 < ((arr_14.Length - i_15) - 1))) {
                if ((arr_14[(int)(j_16)] > arr_14[(int)((j_16 + 1))])) {
                    long tmp_17 = arr_14[(int)(j_16)];
                    arr_14[j_16] = arr_14[(int)((j_16 + 1))];
                    arr_14[(j_16 + 1)] = tmp_17;
                }
                j_16 = (j_16 + 1);
            }
            i_15 = (i_15 + 1);
    ...
    public static void dijkstra(Dictionary<long, long[][]> g_18, long s_19) {
        ...
        while ((known_22.Length < keys_23.Length)) {
            ...
            known_22 = (Enumerable.ToArray(Enumerable.Append<long>(known_22, u_25)));
            foreach (long[] e_29 in (g_18.ContainsKey(u_25) ? g_18[u_25] : null)) {
                long v_30 = e_29[(int)(0)];
                long w_31 = e_29[(int)(1)];
                if ((!(Array.IndexOf(keys_23, v_30) >= 0))) {
                    keys_23 = (Enumerable.ToArray(Enumerable.Append<long>(keys_23, v_30)));
                }
        ...
        while ((idx_35 < ordered_34.Length)) {
            long k_36 = ordered_34[(int)(idx_35)];
            if ((k_36 != s_19)) {
    ...
    public static void topo(Dictionary<long, long[]> g_37, long n_38) {
        ...
        long i_40 = 0;
        while ((i_40 <= n_38)) {
            ind_39 = (Enumerable.ToArray(Enumerable.Append<long>(ind_39, 0)));
            i_40 = (i_40 + 1);
        };
        long node_41 = 1;
        while ((node_41 <= n_38)) {
            foreach (long v_42 in (g_37.ContainsKey(node_41) ? g_37[node_41] : null)) {
                ind_39[v_42] = (ind_39[(int)(v_42)] + 1);
            }
            node_41 = (node_41 + 1);
        };
        long[] q_43 = new long[]{};
        long j_44 = 1;
        while ((j_44 <= n_38)) {
            if ((ind_39[(int)(j_44)] == 0)) {
                q_43 = (Enumerable.ToArray(Enumerable.Append<long>(q_43, j_44)));
            }
            j_44 = (j_44 + 1);
        };
        while ((q_43.Length > 0)) {
            long v_45 = q_43[(int)(0)];
            q_43 = q_43.Skip((int)(1)).Take((int)((q_43.Length - 1))).ToArray();
            Console.WriteLine(Program._fmtTop(v_45));
            foreach (long w_46 in (g_37.ContainsKey(v_45) ? g_37[v_45] : null)) {
                ind_39[w_46] = (ind_39[(int)(w_46)] - 1);
                if ((ind_39[(int)(w_46)] == 0)) {
                    q_43 = (Enumerable.ToArray(Enumerable.Append<long>(q_43, w_46)));
                }
            }
        };
    }
    ...
    public static void floyd(long[][] a_47) {
        ...
        while ((i_50 < n_48)) {
            ...
            long j_52 = 0;
            while ((j_52 < n_48)) {
                row_51 = (Enumerable.ToArray(Enumerable.Append<long>(row_51, a_47[(int)(i_50)][(int)(j_52)])));
                j_52 = (j_52 + 1);
            }
            dist_49 = (Enumerable.ToArray(Enumerable.Append<long[]>(dist_49, row_51)));
            i_50 = (i_50 + 1);
        };
        long k_53 = 0;
        while ((k_53 < n_48)) {
            ...
            while ((ii_54 < n_48)) {
                long jj_55 = 0;
                while ((jj_55 < n_48)) {
                    if ((dist_49[(int)(ii_54)][(int)(jj_55)] > (dist_49[(int)(ii_54)][(int)(k_53)] + dist_49[(int)(k_53)][(int)(jj_55)]))) {
                        dist_49[(int)(ii_54)][jj_55] = (dist_49[(int)(ii_54)][(int)(k_53)] + dist_49[(int)(k_53)][(int)(jj_55)]);
                    }
                    jj_55 = (jj_55 + 1);
                }
                ii_54 = (ii_54 + 1);
    ...
    public static long prim(Dictionary<long, long[][]> g_56, long s_57, long n_58) {
        ...
        while ((known_60.Length < n_58)) {
            ...
            known_60 = (Enumerable.ToArray(Enumerable.Append<long>(known_60, u_64)));
            total_62 = (total_62 + mini_63);
            foreach (long[] e_68 in (g_56.ContainsKey(u_64) ? g_56[u_64] : null)) {
                long v_69 = e_68[(int)(0)];
                long w_70 = e_68[(int)(1)];
                if ((!(Array.IndexOf(keys_61, v_69) >= 0))) {
                    keys_61 = (Enumerable.ToArray(Enumerable.Append<long>(keys_61, v_69)));
                }
    ...
    public static long[][] sort_edges(long[][] edges_72) {
        ...
        while ((i_74 < es_73.Length)) {
            ...
            while ((j_75 < ((es_73.Length - i_74) - 1))) {
                if ((es_73[(int)(j_75)][(int)(2)] > es_73[(int)((j_75 + 1))][(int)(2)])) {
                    long[] tmp_76 = es_73[(int)(j_75)];
                    es_73[j_75] = es_73[(int)((j_75 + 1))];
                    es_73[(j_75 + 1)] = tmp_76;
                }
                j_75 = (j_75 + 1);
            }
    ...
    public static long find_parent(long[] parent_77, long x_78) {
        long r_79 = x_78;
        while ((parent_77[(int)(r_79)] != r_79)) {
            r_79 = parent_77[(int)(r_79)];
        };
        return r_79;
    }
    ...
    public static long kruskal(long[][] edges_83, long n_84) {
        ...
        long i_87 = 0;
        while ((i_87 <= n_84)) {
            parent_86 = (Enumerable.ToArray(Enumerable.Append<long>(parent_86, i_87)));
            i_87 = (i_87 + 1);
        };
        long total_88 = 0;
        long count_89 = 0;
        ...
        while (((count_89 < (n_84 - 1)) && (idx_90 < es_85.Length))) {
            long[] e_91 = es_85[(int)(idx_90)];
            idx_90 = (idx_90 + 1);
            long u_92 = e_91[(int)(0)];
            long v_93 = e_91[(int)(1)];
            long w_94 = e_91[(int)(2)];
    ...
    public static long[] find_isolated_nodes(Dictionary<long, long[]> g_97, long[] nodes_98) {
        ...
        foreach (long node_100 in nodes_98) {
            if (((g_97.ContainsKey(node_100) ? g_97[node_100] : null).Length == 0)) {
                isolated_99 = (Enumerable.ToArray(Enumerable.Append<long>(isolated_99, node_100)));
            }
        };
        return isolated_99;
    }

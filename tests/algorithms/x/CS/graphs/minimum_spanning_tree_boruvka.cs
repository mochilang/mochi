...
class Program {
    ...
    public static UF uf_make(long n_0) {
        ...
        long i_3 = 0;
        while ((i_3 < n_0)) {
            p_1 = (Enumerable.ToArray(Enumerable.Append<long>(p_1, i_3)));
            r_2 = (Enumerable.ToArray(Enumerable.Append<long>(r_2, 0)));
            i_3 = (i_3 + 1);
        };
    ...
    public static FindRes uf_find(UF uf_4, long x_5) {
        ...
        if ((p_6[(int)(x_5)] != x_5)) {
            FindRes res_7 = Program.uf_find(new UF{parent = p_6, rank = uf_4.rank}, p_6[(int)(x_5)]);
            p_6 = res_7.uf.parent;
            p_6[x_5] = res_7.root;
    ...
    public static UF uf_union(UF uf_8, long x_9, long y_10) {
        ...
        if ((r_17[(int)(root1_13)] > r_17[(int)(root2_15)])) {
            p_16[root2_15] = root1_13;
        } else if ((r_17[(int)(root1_13)] < r_17[(int)(root2_15)])) {
            p_16[root1_13] = root2_15;
        } else {
            p_16[root2_15] = root1_13;
            r_17[root1_13] = (r_17[(int)(root1_13)] + 1);
        };
    ...
    public static Edge[] boruvka(long n_18, Edge[] edges_19) {
        ...
        while ((num_components_21 > 1)) {
            ...
            long i_24 = 0;
            while ((i_24 < n_18)) {
                cheap_23 = (Enumerable.ToArray(Enumerable.Append<long>(cheap_23, (0 - 1))));
                i_24 = (i_24 + 1);
            }
            long idx_25 = 0;
            while ((idx_25 < edges_19.Length)) {
                Edge e_26 = edges_19[(int)(idx_25)];
                ...
                if ((set1_28 != set2_30)) {
                    if (((cheap_23[(int)(set1_28)] == (0 - 1)) || (edges_19[(int)(cheap_23[(int)(set1_28)])].w > e_26.w))) {
                        cheap_23[set1_28] = idx_25;
                    }
                    if (((cheap_23[(int)(set2_30)] == (0 - 1)) || (edges_19[(int)(cheap_23[(int)(set2_30)])].w > e_26.w))) {
                        cheap_23[set2_30] = idx_25;
                    }
                }
                idx_25 = (idx_25 + 1);
            }
            long v_31 = 0;
            while ((v_31 < n_18)) {
                long idxe_32 = cheap_23[(int)(v_31)];
                if ((idxe_32 != (0 - 1))) {
                    Edge e_33 = edges_19[(int)(idxe_32)];
                    ...
                    if ((set1_35 != set2_37)) {
                        mst_22 = (Enumerable.ToArray(Enumerable.Append<Edge>(mst_22, e_33)));

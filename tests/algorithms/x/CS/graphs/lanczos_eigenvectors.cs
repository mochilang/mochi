...
class Program {
    ...
    public static double dot(double[] a_5, double[] b_6) {
        ...
        while ((i_8 < a_5.Length)) {
            s_7 = (s_7 + (a_5[(int)(i_8)] * b_6[(int)(i_8)]));
            i_8 = (i_8 + 1);
        };
        return s_7;
    }
    ...
    public static double[] vector_scale(double[] v_9, double s_10) {
        ...
        while ((i_12 < v_9.Length)) {
            res_11 = (Enumerable.ToArray(Enumerable.Append<double>(res_11, (v_9[(int)(i_12)] * s_10))));
            i_12 = (i_12 + 1);
        };
        return res_11;
    }
    ...
    public static double[][] zeros_matrix(long r_21, long c_22) {
        ...
        while ((i_24 < r_21)) {
            ...
            long j_26 = 0;
            while ((j_26 < c_22)) {
                row_25 = (Enumerable.ToArray(Enumerable.Append<double>(row_25, 0.0)));
                j_26 = (j_26 + 1);
            }
            m_23 = (Enumerable.ToArray(Enumerable.Append<double[]>(m_23, row_25)));
            i_24 = (i_24 + 1);
        };
        return m_23;
    }
    ...
    public static double[] column(double[][] m_27, long idx_28) {
        ...
        while ((i_30 < m_27.Length)) {
            col_29 = (Enumerable.ToArray(Enumerable.Append<double>(col_29, m_27[(int)(i_30)][(int)(idx_28)])));
            i_30 = (i_30 + 1);
        };
        return col_29;
    }
    ...
    public static void validate_adjacency_list(long[][] graph_31) {
        ...
        while ((i_32 < graph_31.Length)) {
            long j_33 = 0;
            while ((j_33 < graph_31[(int)(i_32)].Length)) {
                long v_34 = graph_31[(int)(i_32)][(int)(j_33)];
    ...
    public static double[] multiply_matrix_vector(long[][] graph_35, double[] vector_36) {
        ...
        while ((i_39 < n_37)) {
            double sum_40 = 0.0;
            long j_41 = 0;
            while ((j_41 < graph_35[(int)(i_39)].Length)) {
                long nb_42 = graph_35[(int)(i_39)][(int)(j_41)];
                sum_40 = (sum_40 + vector_36[(int)(nb_42)]);
                j_41 = (j_41 + 1);
            }
            result_38 = (Enumerable.ToArray(Enumerable.Append<double>(result_38, sum_40)));
            i_39 = (i_39 + 1);
        };
        return result_38;
    }
    ...
    public static LanczosResult lanczos_iteration(long[][] graph_43, long k_44) {
        ...
        long i_49 = 0;
        while ((i_49 < n_45)) {
            v_48 = (Enumerable.ToArray(Enumerable.Append<double>(v_48, Program.random())));
            i_49 = (i_49 + 1);
        };
        double ss_50 = 0.0;
        i_49 = 0;
        while ((i_49 < n_45)) {
            ss_50 = (ss_50 + (v_48[(int)(i_49)] * v_48[(int)(i_49)]));
            i_49 = (i_49 + 1);
        };
        double vnorm_51 = Program.sqrtApprox(ss_50);
        i_49 = 0;
        while ((i_49 < n_45)) {
            q_46[(int)(i_49)][0] = (v_48[(int)(i_49)] / vnorm_51);
            i_49 = (i_49 + 1);
        };
        double beta_52 = 0.0;
        long j_53 = 0;
        while ((j_53 < k_44)) {
            ...
            long p_57 = 0;
            while ((p_57 < n_45)) {
                ss2_56 = (ss2_56 + (w_54[(int)(p_57)] * w_54[(int)(p_57)]));
                p_57 = (p_57 + 1);
            }
            beta_52 = Program.sqrtApprox(ss2_56);
            t_47[(int)(j_53)][j_53] = alpha_55;
            if ((j_53 < (k_44 - 1))) {
                t_47[(int)(j_53)][(j_53 + 1)] = beta_52;
                t_47[(int)((j_53 + 1))][j_53] = beta_52;
                if ((beta_52 > 1e-10)) {
                    double[] wnorm_58 = Program.vector_scale(w_54, (1.0 / beta_52));
                    long r_59 = 0;
                    while ((r_59 < n_45)) {
                        q_46[(int)(r_59)][(j_53 + 1)] = wnorm_58[(int)(r_59)];
                        r_59 = (r_59 + 1);
                    }
                }
            }
    ...
    public static EigenResult jacobi_eigen(double[][] a_in_60, long max_iter_61) {
        ...
        while ((iter_66 < max_iter_61)) {
            long p_67 = 0;
            long q_68 = 1;
            double max_69 = Program.absf(a_63[(int)(p_67)][(int)(q_68)]);
            i_65 = 0;
            while ((i_65 < n_62)) {
                long j_70 = (i_65 + 1);
                while ((j_70 < n_62)) {
                    double val_71 = Program.absf(a_63[(int)(i_65)][(int)(j_70)]);
                    if ((val_71 > max_69)) {
                        max_69 = val_71;
                        p_67 = i_65;
                        q_68 = j_70;
            ...
            double app_72 = a_63[(int)(p_67)][(int)(p_67)];
            double aqq_73 = a_63[(int)(q_68)][(int)(q_68)];
            double apq_74 = a_63[(int)(p_67)][(int)(q_68)];
            ...
            a_63[(int)(p_67)][p_67] = (app_72 - (t_76 * apq_74));
            a_63[(int)(q_68)][q_68] = (aqq_73 + (t_76 * apq_74));
            a_63[(int)(p_67)][q_68] = 0.0;
            a_63[(int)(q_68)][p_67] = 0.0;
            long k_80 = 0;
            while ((k_80 < n_62)) {
                if (((k_80 != p_67) && (k_80 != q_68))) {
                    double akp_81 = a_63[(int)(k_80)][(int)(p_67)];
                    double akq_82 = a_63[(int)(k_80)][(int)(q_68)];
                    a_63[(int)(k_80)][p_67] = (akp_81 - (s_78 * (akq_82 + (tau_79 * akp_81))));
                    a_63[(int)(p_67)][k_80] = a_63[(int)(k_80)][(int)(p_67)];
                    a_63[(int)(k_80)][q_68] = (akq_82 + (s_78 * (akp_81 - (tau_79 * akq_82))));
                    a_63[(int)(q_68)][k_80] = a_63[(int)(k_80)][(int)(q_68)];
                }
                k_80 = (k_80 + 1);
            }
            k_80 = 0;
            while ((k_80 < n_62)) {
                double vkp_83 = v_64[(int)(k_80)][(int)(p_67)];
                double vkq_84 = v_64[(int)(k_80)][(int)(q_68)];
                v_64[(int)(k_80)][p_67] = (vkp_83 - (s_78 * (vkq_84 + (tau_79 * vkp_83))));
                v_64[(int)(k_80)][q_68] = (vkq_84 + (s_78 * (vkp_83 - (tau_79 * vkq_84))));
                k_80 = (k_80 + 1);
            }
            iter_66 = (iter_66 + 1);
        };
        ...
        i_65 = 0;
        while ((i_65 < n_62)) {
            eigenvalues_85 = (Enumerable.ToArray(Enumerable.Append<double>(eigenvalues_85, a_63[(int)(i_65)][(int)(i_65)])));
            i_65 = (i_65 + 1);
        };
    ...
    public static double[][] matmul(double[][] a_86, double[][] b_87) {
        ...
        long cols_89 = b_87[(int)(0)].Length;
        ...
        while ((i_92 < rows_88)) {
            ...
            while ((j_93 < cols_89)) {
                ...
                long k_95 = 0;
                while ((k_95 < inner_90)) {
                    s_94 = (s_94 + (a_86[(int)(i_92)][(int)(k_95)] * b_87[(int)(k_95)][(int)(j_93)]));
                    k_95 = (k_95 + 1);
                }
                m_91[(int)(i_92)][j_93] = s_94;
                j_93 = (j_93 + 1);
            }
            i_92 = (i_92 + 1);
        };
    ...
    public static EigenResult sort_eigenpairs(double[] vals_96, double[][] vecs_97) {
        ...
        while ((i_101 < n_98)) {
            long j_102 = 0;
            while ((j_102 < (n_98 - 1))) {
                if ((values_99[(int)(j_102)] < values_99[(int)((j_102 + 1))])) {
                    double tmp_103 = values_99[(int)(j_102)];
                    values_99[j_102] = values_99[(int)((j_102 + 1))];
                    values_99[(j_102 + 1)] = tmp_103;
                    long r_104 = 0;
                    while ((r_104 < vectors_100.Length)) {
                        double tv_105 = vectors_100[(int)(r_104)][(int)(j_102)];
                        vectors_100[(int)(r_104)][j_102] = vectors_100[(int)(r_104)][(int)((j_102 + 1))];
                        vectors_100[(int)(r_104)][(j_102 + 1)] = tv_105;
                        r_104 = (r_104 + 1);
                    }
                }
                j_102 = (j_102 + 1);
    ...
    public static string list_to_string(double[] arr_112) {
        ...
        while ((i_114 < arr_112.Length)) {
            s_113 = (s_113 + _fmtStr(arr_112[(int)(i_114)]));
    ...
    public static string matrix_to_string(double[][] m_115) {
        ...
        while ((i_117 < m_115.Length)) {
            s_116 = (s_116 + Program.list_to_string(m_115[(int)(i_117)]));

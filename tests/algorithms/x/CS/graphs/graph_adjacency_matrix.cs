...
class Program {
    ...
    public static Graph make_graph(long[] vertices_0, long[][] edges_1, bool directed_2) {
        ...
        while ((i_4 < vertices_0.Length)) {
            Program.add_vertex(g_3, vertices_0[(int)(i_4)]);
            i_4 = (i_4 + 1);
        };
        long j_5 = 0;
        while ((j_5 < edges_1.Length)) {
            long[] e_6 = edges_1[(int)(j_5)];
            Program.add_edge(g_3, e_6[(int)(0)], e_6[(int)(1)]);
            j_5 = (j_5 + 1);
        };
        return g_3;
    }
    ...
    public static void add_vertex(Graph g_9, long v_10) {
        ...
        while ((i_12 < matrix_11.Length)) {
            matrix_11[i_12] = (Enumerable.ToArray(Enumerable.Append<long>(matrix_11[(int)(i_12)], 0)));
            i_12 = (i_12 + 1);
        };
        long[] row_13 = new long[]{};
        long j_14 = 0;
        while ((j_14 < (matrix_11.Length + 1))) {
            row_13 = (Enumerable.ToArray(Enumerable.Append<long>(row_13, 0)));
            j_14 = (j_14 + 1);
        };
        matrix_11 = (Enumerable.ToArray(Enumerable.Append<long[]>(matrix_11, row_13)));
    ...
    public static void remove_vertex(Graph g_25, long v_26) {
        ...
        while ((i_29 < g_25.adj_matrix.Length)) {
            if ((i_29 != idx_27)) {
                long[] row_30 = g_25.adj_matrix[(int)(i_29)];
                long[] new_row_31 = new long[]{};
                long j_32 = 0;
                while ((j_32 < row_30.Length)) {
                    if ((j_32 != idx_27)) {
                        new_row_31 = (Enumerable.ToArray(Enumerable.Append<long>(new_row_31, row_30[(int)(j_32)])));
                    }
                    j_32 = (j_32 + 1);
                }
                new_matrix_28 = (Enumerable.ToArray(Enumerable.Append<long[]>(new_matrix_28, new_row_31)));
            }
            i_29 = (i_29 + 1);
        };
    ...
    public static void add_edge(Graph g_34, long u_35, long v_36) {
        ...
        matrix_39[(int)(i_37)][j_38] = 1;
        if ((!g_34.directed)) {
            matrix_39[(int)(j_38)][i_37] = 1;
        };
    ...
    public static void remove_edge(Graph g_40, long u_41, long v_42) {
        ...
        matrix_45[(int)(i_43)][j_44] = 0;
        if ((!g_40.directed)) {
            matrix_45[(int)(j_44)][i_43] = 0;
        };
    ...
    public static bool contains_edge(Graph g_46, long u_47, long v_48) {
        ...
        return (matrix_51[(int)(i_49)][(int)(j_50)] == 1);
    }

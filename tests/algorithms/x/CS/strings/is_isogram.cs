...
class Program {
    ...
    public static string to_lower_char(string c_10) {
        long code_11 = Program.ord(c_10);
        if (((code_11 >= 65) && (code_11 <= 90))) {
            return Program.chr((code_11 + 32));
        };
        return c_10;
    }

    public static bool is_alpha(string c_12) {
        long code_13 = Program.ord(c_12);
        return (((code_13 >= 65) && (code_13 <= 90)) || ((code_13 >= 97) && (code_13 <= 122)));
    }

    public static bool is_isogram(string s_14) {
        string seen_15 = "";
        long i_16 = 0;
        while ((i_16 < s_14.Length)) {
            string ch_17 = s_14.Substring((int)(i_16), 1);
            if ((!Program.is_alpha(ch_17))) {
                throw new Exception("String must only contain alphabetic characters.");
            }
            string lower_18 = Program.to_lower_char(ch_17);
            if ((Program.index_of(seen_15, lower_18) >= 0)) {
                return false;
            }
            seen_15 = (seen_15 + lower_18);
            i_16 = (i_16 + 1);
        };
        return true;
    }
    ...
    static void Main() {
        _ = __name__;
        {
            var __memStart = _mem();
            var __start = _now();
            Console.WriteLine(Program._fmtTop(_fmtStr(Program.is_isogram("Uncopyrightable"))));
            Console.WriteLine(Program._fmtTop(_fmtStr(Program.is_isogram("allowance"))));
            var __end = _now();
            var __memEnd = _mem();

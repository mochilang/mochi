...
class Program {
    ...
    public static double[][] add(double[][] a_1, double[][] b_2) {
        ...
        while ((i_6 < rows_3)) {
            ...
            long j_8 = 0;
            while ((j_8 < cols_4)) {
                row_7 = ((Func<double[]>)(() => { var _tmp = row_7.ToList(); _tmp.Add((_idx(_idx(a_1, i_6), j_8) + _idx(_idx(b_2, i_6), j_8))); return _tmp.ToArray(); }))();
                j_8 = (j_8 + 1);
            }
            result_5 = ((Func<double[][]>)(() => { var _tmp = result_5.ToList(); _tmp.Add(row_7); return _tmp.ToArray(); }))();
            i_6 = (i_6 + 1);
        };
        return result_5;
    }
    ...
    public static double[][] subtract(double[][] a_9, double[][] b_10) {
        ...
        while ((i_14 < rows_11)) {
            ...
            long j_16 = 0;
            while ((j_16 < cols_12)) {
                row_15 = ((Func<double[]>)(() => { var _tmp = row_15.ToList(); _tmp.Add((_idx(_idx(a_9, i_14), j_16) - _idx(_idx(b_10, i_14), j_16))); return _tmp.ToArray(); }))();
                j_16 = (j_16 + 1);
            }
            result_13 = ((Func<double[][]>)(() => { var _tmp = result_13.ToList(); _tmp.Add(row_15); return _tmp.ToArray(); }))();
            i_14 = (i_14 + 1);
        };
        return result_13;
    }
    ...
    public static double[][] scalar_multiply(double[][] a_17, double s_18) {
        ...
        while ((i_22 < rows_19)) {
            ...
            long j_24 = 0;
            while ((j_24 < cols_20)) {
                row_23 = ((Func<double[]>)(() => { var _tmp = row_23.ToList(); _tmp.Add((_idx(_idx(a_17, i_22), j_24) * s_18)); return _tmp.ToArray(); }))();
                j_24 = (j_24 + 1);
            }
            result_21 = ((Func<double[][]>)(() => { var _tmp = result_21.ToList(); _tmp.Add(row_23); return _tmp.ToArray(); }))();
            i_22 = (i_22 + 1);
        };
        return result_21;
    }
    ...
    public static double[][] transpose(double[][] a_40) {
        ...
        while ((j_44 < cols_42)) {
            ...
            long i_46 = 0;
            while ((i_46 < rows_41)) {
                row_45 = ((Func<double[]>)(() => { var _tmp = row_45.ToList(); _tmp.Add(_idx(_idx(a_40, i_46), j_44)); return _tmp.ToArray(); }))();
                i_46 = (i_46 + 1);
            }

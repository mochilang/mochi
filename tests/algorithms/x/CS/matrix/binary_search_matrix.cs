...
class Program {
    ...
    public static long[] mat_bin_search(long value_5, long[][] matrix_6) {
        long index_7 = 0;
        if ((matrix_6[(int)(index_7)][(int)(0)] == value_5)) {
            return new long[]{index_7, 0};
        };
        while (((index_7 < matrix_6.Length) && (matrix_6[(int)(index_7)][(int)(0)] < value_5))) {
            long r_8 = Program.binary_search(matrix_6[(int)(index_7)], 0, (matrix_6[(int)(index_7)].Length - 1), value_5);
            if ((r_8 != -1)) {

...
class Program {
    ...
    public static long[][] matrix_multiply(long[][] a_3, long[][] b_4) {
        ...
        while ((i_9 < rows_5)) {
            ...
            while ((j_11 < cols_6)) {
                ...
                row_10 = ((Func<long[]>)(() => { var _tmp = row_10.Cast<long>().ToList(); _tmp.Add(sum_12); return _tmp.ToArray(); }))();
                j_11 = (j_11 + 1);
            }
            result_8 = ((Func<long[][]>)(() => { var _tmp = result_8.Cast<long[]>().ToList(); _tmp.Add(row_10); return _tmp.ToArray(); }))();
            i_9 = (i_9 + 1);
        };
        return result_8;
    }
    ...
    public static long[][] matrix_multiply_recursive(long[][] a_22, long[][] b_23) {
        ...
        while ((i_27 < n_24)) {
            ...
            long j_29 = 0;
            while ((j_29 < m_25)) {
                row_28 = ((Func<long[]>)(() => { var _tmp = row_28.Cast<long>().ToList(); _tmp.Add(0); return _tmp.ToArray(); }))();
                j_29 = (j_29 + 1);
            }
            result_26 = ((Func<long[][]>)(() => { var _tmp = result_26.Cast<long[]>().ToList(); _tmp.Add(row_28); return _tmp.ToArray(); }))();
            i_27 = (i_27 + 1);
        };

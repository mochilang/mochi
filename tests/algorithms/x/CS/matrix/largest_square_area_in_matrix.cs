...
class Program {
    ...
    public static long largest_square_area_in_matrix_top_down_with_dp(long rows_25, long cols_26, long[][] mat_27) {
        ...
        while ((r_30 < rows_25)) {
            ...
            long c_32 = 0;
            while ((c_32 < cols_26)) {
                row_list_31 = ((Func<long[]>)(() => { var _tmp = row_list_31.ToList(); _tmp.Add(-1); return _tmp.ToArray(); }))();
                c_32 = (c_32 + 1);
            }
            dp_array_29 = ((Func<long[][]>)(() => { var _tmp = dp_array_29.ToList(); _tmp.Add(row_list_31); return _tmp.ToArray(); }))();
            r_30 = (r_30 + 1);
        };
    ...
    public static long largest_square_area_in_matrix_bottom_up(long rows_33, long cols_34, long[][] mat_35) {
        ...
        while ((r_37 <= rows_33)) {
            ...
            long c_39 = 0;
            while ((c_39 <= cols_34)) {
                row_list_38 = ((Func<long[]>)(() => { var _tmp = row_list_38.ToList(); _tmp.Add(0); return _tmp.ToArray(); }))();
                c_39 = (c_39 + 1);
            }
            dp_array_36 = ((Func<long[][]>)(() => { var _tmp = dp_array_36.ToList(); _tmp.Add(row_list_38); return _tmp.ToArray(); }))();
            r_37 = (r_37 + 1);
        };
        long largest_40 = 0;
    ...
    public static long largest_square_area_in_matrix_bottom_up_space_optimization(long rows_47, long cols_48, long[][] mat_49) {
        ...
        long i_51 = 0;
        while ((i_51 <= cols_48)) {
            current_row_50 = ((Func<long[]>)(() => { var _tmp = current_row_50.ToList(); _tmp.Add(0); return _tmp.ToArray(); }))();
            i_51 = (i_51 + 1);
        };
        long[] next_row_52 = new long[]{};
        long j_53 = 0;
        while ((j_53 <= cols_48)) {
            next_row_52 = ((Func<long[]>)(() => { var _tmp = next_row_52.ToList(); _tmp.Add(0); return _tmp.ToArray(); }))();
            j_53 = (j_53 + 1);
        };
        long largest_54 = 0;

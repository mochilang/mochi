...
class Program {
    ...
    public static long increment_score(long count_47) {
        return _floordiv((count_47 * (count_47 + 1)), 2);
    }
    ...
    public static string[][] move_y(string[][] matrix_g_54, long size_55) {
        ...
        while ((column_57 >= 0)) {
            ...
            if (all_empty_59) {
                empty_cols_56 = ((Func<long[]>)(() => { var _tmp = empty_cols_56.Cast<long>().ToList(); _tmp.Add(column_57); return _tmp.ToArray(); }))();
            }
    ...
    public static string[][] build_matrix(string[] matrix_74) {
        ...
        while ((i_76 < matrix_74.Length)) {
            ...
            while ((j_79 < row_77.Length)) {
                row_list_78 = ((Func<string[]>)(() => { var _tmp = row_list_78.Cast<string>().ToList(); _tmp.Add(_substr(row_77, j_79, (j_79 + 1))); return _tmp.ToArray(); }))();
                j_79 = (j_79 + 1);
            }

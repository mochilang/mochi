...
class Program {
    ...
    public static double[][] add(double[][][] matrices_0) {
        long rows_1 = _idx(matrices_0, 0).Length;
        long cols_2 = _idx(_idx(matrices_0, 0), 0).Length;
        long r_3 = 0;
        ...
        while ((r_3 < rows_1)) {
            ...
            while ((c_6 < cols_2)) {
                ...
                while ((m_8 < matrices_0.Length)) {
                    sum_7 = (sum_7 + _idx(_idx(_idx(matrices_0, m_8), r_3), c_6));
                    m_8 = (m_8 + 1);
                }
                row_5 = ((Func<double[]>)(() => { var _tmp = row_5.ToList(); _tmp.Add(sum_7); return _tmp.ToArray(); }))();
                c_6 = (c_6 + 1);
            }
            result_4 = ((Func<double[][]>)(() => { var _tmp = result_4.ToList(); _tmp.Add(row_5); return _tmp.ToArray(); }))();
            r_3 = (r_3 + 1);
        };
        return result_4;
    }
    ...
    public static double[][] subtract(double[][] a_9, double[][] b_10) {
        ...
        while ((r_13 < rows_11)) {
            ...
            long c_16 = 0;
            while ((c_16 < cols_12)) {
                row_15 = ((Func<double[]>)(() => { var _tmp = row_15.ToList(); _tmp.Add((_idx(_idx(a_9, r_13), c_16) - _idx(_idx(b_10, r_13), c_16))); return _tmp.ToArray(); }))();
                c_16 = (c_16 + 1);
            }
            result_14 = ((Func<double[][]>)(() => { var _tmp = result_14.ToList(); _tmp.Add(row_15); return _tmp.ToArray(); }))();
            r_13 = (r_13 + 1);
        };
        return result_14;
    }
    ...
    public static double[][] scalar_multiply(double[][] matrix_17, double n_18) {
        ...
        while ((i_20 < matrix_17.Length)) {
            ...
            long j_22 = 0;
            while ((j_22 < _idx(matrix_17, i_20).Length)) {
                row_21 = ((Func<double[]>)(() => { var _tmp = row_21.ToList(); _tmp.Add((_idx(_idx(matrix_17, i_20), j_22) * n_18)); return _tmp.ToArray(); }))();
                j_22 = (j_22 + 1);
            }
            result_19 = ((Func<double[][]>)(() => { var _tmp = result_19.ToList(); _tmp.Add(row_21); return _tmp.ToArray(); }))();
            i_20 = (i_20 + 1);
        };
        return result_19;
    }
    ...
    public static double[][] multiply(double[][] a_23, double[][] b_24) {
        ...
        long colsA_26 = _idx(a_23, 0).Length;
        long rowsB_27 = b_24.Length;
        long colsB_28 = _idx(b_24, 0).Length;
        ...
        while ((i_30 < rowsA_25)) {
            ...
            while ((j_32 < colsB_28)) {
                ...
                long k_34 = 0;
                while ((k_34 < colsA_26)) {
                    sum_33 = (sum_33 + (_idx(_idx(a_23, i_30), k_34) * _idx(_idx(b_24, k_34), j_32)));
                    k_34 = (k_34 + 1);
                }
                row_31 = ((Func<double[]>)(() => { var _tmp = row_31.ToList(); _tmp.Add(sum_33); return _tmp.ToArray(); }))();
                j_32 = (j_32 + 1);
            }
            result_29 = ((Func<double[][]>)(() => { var _tmp = result_29.ToList(); _tmp.Add(row_31); return _tmp.ToArray(); }))();
            i_30 = (i_30 + 1);
        };
        return result_29;
    }
    ...
    public static double[][] identity(long n_35) {
        ...
        while ((i_37 < n_35)) {
            ...
            while ((j_39 < n_35)) {
                if ((i_37 == j_39)) {
                    row_38 = ((Func<double[]>)(() => { var _tmp = row_38.ToList(); _tmp.Add(1.0); return _tmp.ToArray(); }))();
                } else {
                    row_38 = ((Func<double[]>)(() => { var _tmp = row_38.ToList(); _tmp.Add(0.0); return _tmp.ToArray(); }))();
                }
                j_39 = (j_39 + 1);
            }
            result_36 = ((Func<double[][]>)(() => { var _tmp = result_36.ToList(); _tmp.Add(row_38); return _tmp.ToArray(); }))();
            i_37 = (i_37 + 1);
        };
        return result_36;
    }
    ...
    public static double[][] transpose(double[][] matrix_40) {
        ...
        long cols_42 = _idx(matrix_40, 0).Length;
        ...
        while ((c_44 < cols_42)) {
            ...
            long r_46 = 0;
            while ((r_46 < rows_41)) {
                row_45 = ((Func<double[]>)(() => { var _tmp = row_45.ToList(); _tmp.Add(_idx(_idx(matrix_40, r_46), c_44)); return _tmp.ToArray(); }))();
                r_46 = (r_46 + 1);
            }
            result_43 = ((Func<double[][]>)(() => { var _tmp = result_43.ToList(); _tmp.Add(row_45); return _tmp.ToArray(); }))();
            c_44 = (c_44 + 1);
        };
        return result_43;
    }
    ...
    public static double[][] minor(double[][] matrix_47, long row_48, long column_49) {
        ...
        while ((i_51 < matrix_47.Length)) {
            if ((i_51 != row_48)) {
                ...
                long j_53 = 0;
                while ((j_53 < _idx(matrix_47, i_51).Length)) {
                    if ((j_53 != column_49)) {
                        new_row_52 = ((Func<double[]>)(() => { var _tmp = new_row_52.ToList(); _tmp.Add(_idx(_idx(matrix_47, i_51), j_53)); return _tmp.ToArray(); }))();
                    }
                    j_53 = (j_53 + 1);
                }
                result_50 = ((Func<double[][]>)(() => { var _tmp = result_50.ToList(); _tmp.Add(new_row_52); return _tmp.ToArray(); }))();
            }
            i_51 = (i_51 + 1);
        };
        return result_50;
    ...
    public static double determinant(double[][] matrix_54) {
        if ((matrix_54.Length == 1)) {
            return _idx(_idx(matrix_54, 0), 0);
        };
        double det_55 = 0.0;
        long c_56 = 0;
        while ((c_56 < _idx(matrix_54, 0).Length)) {
            double[][] sub_57 = Program.minor(matrix_54, 0, c_56);
            double sign_58 = ((_mod(c_56, 2) == 0) ? 1.0 : -1.0);
            det_55 = (det_55 + ((_idx(_idx(matrix_54, 0), c_56) * Program.determinant(sub_57)) * sign_58));
            c_56 = (c_56 + 1);
        };
        return det_55;
    }
    ...
    public static double[][] inverse(double[][] matrix_59) {
        ...
        while ((i_63 < size_61)) {
            ...
            while ((j_65 < size_61)) {
                ...
                row_64 = ((Func<double[]>)(() => { var _tmp = row_64.ToList(); _tmp.Add(Program.determinant(m_66)); return _tmp.ToArray(); }))();
                j_65 = (j_65 + 1);
            }
            matrix_minor_62 = ((Func<double[][]>)(() => { var _tmp = matrix_minor_62.ToList(); _tmp.Add(row_64); return _tmp.ToArray(); }))();
            i_63 = (i_63 + 1);
        };
        ...
        while ((i_63 < size_61)) {
            ...
            while ((j_69 < size_61)) {
                ...
                row_68 = ((Func<double[]>)(() => { var _tmp = row_68.ToList(); _tmp.Add((_idx(_idx(matrix_minor_62, i_63), j_69) * sign_70)); return _tmp.ToArray(); }))();
                j_69 = (j_69 + 1);
            }
            cofactors_67 = ((Func<double[][]>)(() => { var _tmp = cofactors_67.ToList(); _tmp.Add(row_68); return _tmp.ToArray(); }))();
            i_63 = (i_63 + 1);
        };

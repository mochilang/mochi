...
class Program {
    ...
    public static double[][] matrix_columns(Matrix m_4) {
        ...
        while ((j_6 < m_4.cols)) {
            ...
            long i_8 = 0;
            while ((i_8 < m_4.rows)) {
                col_7 = ((Func<double[]>)(() => { var _tmp = col_7.Cast<double>().ToList(); _tmp.Add(_idx(_idx(m_4.data, i_8), j_6)); return _tmp.ToArray(); }))();
                i_8 = (i_8 + 1);
            }
        ...
        while ((i_19 < m_15.rows)) {
            if ((i_19 != r_16)) {
                ...
                while ((j_21 < m_15.cols)) {
                    if ((j_21 != c_17)) {
                        row_20 = ((Func<double[]>)(() => { var _tmp = row_20.Cast<double>().ToList(); _tmp.Add(_idx(_idx(m_15.data, i_19), j_21)); return _tmp.ToArray(); }))();
                    }
                    j_21 = (j_21 + 1);
                }
    ...
    public static Matrix matrix_adjugate(Matrix m_41) {
        ...
        while ((i_44 < m_41.rows)) {
            ...
            while ((j_46 < m_41.cols)) {
                row_45 = ((Func<double[]>)(() => { var _tmp = row_45.Cast<double>().ToList(); _tmp.Add(_idx(_idx(cof_42.data, j_46), i_44)); return _tmp.ToArray(); }))();
                j_46 = (j_46 + 1);
            }
    ...
    public static Matrix matrix_add_column(Matrix m_53, double[] col_54) {
        ...
        while ((i_56 < m_53.rows)) {
            newData_55 = ((Func<double[][]>)(() => { var _tmp = newData_55.Cast<double[]>().ToList(); _tmp.Add(((Func<double[]>)(() => { var _tmp = _idx(m_53.data, i_56).Cast<double>().ToList(); _tmp.Add(_idx(col_54, i_56)); return _tmp.ToArray(); }))()); return _tmp.ToArray(); }))();
            i_56 = (i_56 + 1);
        };
    ...
    public static Matrix matrix_mul_scalar(Matrix m_57, double s_58) {
        ...
        while ((i_60 < m_57.rows)) {
            ...
            while ((j_62 < m_57.cols)) {
                row_61 = ((Func<double[]>)(() => { var _tmp = row_61.Cast<double>().ToList(); _tmp.Add((_idx(_idx(m_57.data, i_60), j_62) * s_58)); return _tmp.ToArray(); }))();
                j_62 = (j_62 + 1);
            }
    ...
    public static Matrix matrix_add(Matrix a_64, Matrix b_65) {
        ...
        while ((i_67 < a_64.rows)) {
            ...
            while ((j_69 < a_64.cols)) {
                row_68 = ((Func<double[]>)(() => { var _tmp = row_68.Cast<double>().ToList(); _tmp.Add((_idx(_idx(a_64.data, i_67), j_69) + _idx(_idx(b_65.data, i_67), j_69))); return _tmp.ToArray(); }))();
                j_69 = (j_69 + 1);
            }
    ...
    public static Matrix matrix_sub(Matrix a_70, Matrix b_71) {
        ...
        while ((i_73 < a_70.rows)) {
            ...
            while ((j_75 < a_70.cols)) {
                row_74 = ((Func<double[]>)(() => { var _tmp = row_74.Cast<double>().ToList(); _tmp.Add((_idx(_idx(a_70.data, i_73), j_75) - _idx(_idx(b_71.data, i_73), j_75))); return _tmp.ToArray(); }))();
                j_75 = (j_75 + 1);
            }
    ...
    public static Matrix matrix_mul(Matrix a_80, Matrix b_81) {
        ...
        while ((i_84 < a_80.rows)) {
            ...
            while ((j_86 < b_81.cols)) {
                row_85 = ((Func<double[]>)(() => { var _tmp = row_85.Cast<double>().ToList(); _tmp.Add(Program.matrix_dot(_idx(a_80.data, i_84), _idx(bcols_82, j_86))); return _tmp.ToArray(); }))();
                j_86 = (j_86 + 1);
            }

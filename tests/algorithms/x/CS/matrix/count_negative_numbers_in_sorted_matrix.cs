...
class Program {
    ...
    public static long find_negative_index(long[] arr_4) {
        ...
        while ((left_5 <= right_6)) {
            ...
            long num_8 = arr_4[(int)(mid_7)];
            if ((num_8 < 0)) {
                if ((mid_7 == 0)) {
                    return 0;
                }
                if ((arr_4[(int)((mid_7 - 1))] >= 0)) {
                    return mid_7;
                }
                right_6 = (mid_7 - 1);
            } else {
    ...
    public static long count_negatives_binary_search(long[][] grid_9) {
        long total_10 = 0;
        long bound_11 = grid_9[(int)(0)].Length;
        long i_12 = 0;
        while ((i_12 < grid_9.Length)) {
            long[] row_13 = grid_9[(int)(i_12)];
            long idx_14 = Program.find_negative_index(row_13.Skip((int)(0)).Take((int)((bound_11 - 0))).ToArray());
            bound_11 = idx_14;
            total_10 = (total_10 + idx_14);
            i_12 = (i_12 + 1);
        };
        return ((grid_9.Length * grid_9[(int)(0)].Length) - total_10);
    }
    ...
    public static long count_negatives_brute_force(long[][] grid_15) {
        ...
        while ((i_17 < grid_15.Length)) {
            long[] row_18 = grid_15[(int)(i_17)];
            long j_19 = 0;
            while ((j_19 < row_18.Length)) {
                if ((row_18[(int)(j_19)] < 0)) {
                    count_16 = (count_16 + 1);
                }
                j_19 = (j_19 + 1);
            }
    ...
    public static long count_negatives_brute_force_with_break(long[][] grid_20) {
        ...
        while ((i_22 < grid_20.Length)) {
            long[] row_23 = grid_20[(int)(i_22)];
            long j_24 = 0;
            while ((j_24 < row_23.Length)) {
                long number_25 = row_23[(int)(j_24)];
                if ((number_25 < 0)) {
    ...
    static void Main() {
        {
            ...
            while ((i_29 < test_grids_27.Length)) {
                results_bin_28 = (Enumerable.ToArray(Enumerable.Append<long>(results_bin_28, Program.count_negatives_binary_search(test_grids_27[(int)(i_29)]))));
                i_29 = (i_29 + 1);
            }
            ...
            i_29 = 0;
            while ((i_29 < test_grids_27.Length)) {
                results_brute_30 = (Enumerable.ToArray(Enumerable.Append<long>(results_brute_30, Program.count_negatives_brute_force(test_grids_27[(int)(i_29)]))));
                i_29 = (i_29 + 1);
            }
            ...
            i_29 = 0;
            while ((i_29 < test_grids_27.Length)) {
                results_break_31 = (Enumerable.ToArray(Enumerable.Append<long>(results_break_31, Program.count_negatives_brute_force_with_break(test_grids_27[(int)(i_29)]))));
                i_29 = (i_29 + 1);
            }

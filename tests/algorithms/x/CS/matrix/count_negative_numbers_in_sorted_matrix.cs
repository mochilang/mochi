...
class Program {
    ...
    public static long[][] generate_large_matrix() {
        ...
        while ((i_1 < 1000)) {
            ...
            long j_3 = (1000 - i_1);
            while ((j_3 > (-1000 - i_1))) {
                row_2 = ((Func<long[]>)(() => { var _tmp = row_2.Cast<long>().ToList(); _tmp.Add(j_3); return _tmp.ToArray(); }))();
                j_3 = (j_3 - 1);
            }
            result_0 = ((Func<long[][]>)(() => { var _tmp = result_0.Cast<long[]>().ToList(); _tmp.Add(row_2); return _tmp.ToArray(); }))();
            i_1 = (i_1 + 1);
        };
        return result_0;
    }
    ...
    public static long find_negative_index(long[] arr_4) {
        ...
        while ((left_5 <= right_6)) {
            long mid_7 = _floordiv((left_5 + right_6), 2);
    ...
    static void Main() {
        _ = __name__;
        {
            ...
            while ((i_29 < test_grids_27.Length)) {
                results_bin_28 = ((Func<long[]>)(() => { var _tmp = results_bin_28.Cast<long>().ToList(); _tmp.Add(Program.count_negatives_binary_search(_idx(test_grids_27, i_29))); return _tmp.ToArray(); }))();
                i_29 = (i_29 + 1);
            }
            ...
            i_29 = 0;
            while ((i_29 < test_grids_27.Length)) {
                results_brute_30 = ((Func<long[]>)(() => { var _tmp = results_brute_30.Cast<long>().ToList(); _tmp.Add(Program.count_negatives_brute_force(_idx(test_grids_27, i_29))); return _tmp.ToArray(); }))();
                i_29 = (i_29 + 1);
            }
            ...
            i_29 = 0;
            while ((i_29 < test_grids_27.Length)) {
                results_break_31 = ((Func<long[]>)(() => { var _tmp = results_break_31.Cast<long>().ToList(); _tmp.Add(Program.count_negatives_brute_force_with_break(_idx(test_grids_27, i_29))); return _tmp.ToArray(); }))();
                i_29 = (i_29 + 1);
            }

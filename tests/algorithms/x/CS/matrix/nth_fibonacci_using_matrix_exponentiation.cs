...
class Program {
    ...
    public static long[][] multiply(long[][] matrix_a_0, long[][] matrix_b_1) {
        ...
        while ((i_4 < n_2)) {
            ...
            while ((j_6 < n_2)) {
                ...
                row_5 = ((Func<long[]>)(() => { var _tmp = row_5.Cast<long>().ToList(); _tmp.Add(val_7); return _tmp.ToArray(); }))();
                j_6 = (j_6 + 1);
            }
            matrix_c_3 = ((Func<long[][]>)(() => { var _tmp = matrix_c_3.Cast<long[]>().ToList(); _tmp.Add(row_5); return _tmp.ToArray(); }))();
            i_4 = (i_4 + 1);
        };
        return matrix_c_3;
    }
    ...
    public static long[][] identity(long n_9) {
        ...
        while ((i_11 < n_9)) {
            ...
            while ((j_13 < n_9)) {
                if ((i_11 == j_13)) {
                    row_12 = ((Func<long[]>)(() => { var _tmp = row_12.Cast<long>().ToList(); _tmp.Add(1); return _tmp.ToArray(); }))();
                } else {
                    row_12 = ((Func<long[]>)(() => { var _tmp = row_12.Cast<long>().ToList(); _tmp.Add(0); return _tmp.ToArray(); }))();
                }
                j_13 = (j_13 + 1);
            }
            res_10 = ((Func<long[][]>)(() => { var _tmp = res_10.Cast<long[]>().ToList(); _tmp.Add(row_12); return _tmp.ToArray(); }))();
            i_11 = (i_11 + 1);
        };
        return res_10;
    }

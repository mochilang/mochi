...
class Program {
    ...
    public static Matrix make_matrix(long rows_0, long cols_1, double value_2) {
        ...
        while ((r_4 < rows_0)) {
            ...
            long c_6 = 0;
            while ((c_6 < cols_1)) {
                row_5 = ((Func<double[]>)(() => { var _tmp = row_5.ToList(); _tmp.Add(value_2); return _tmp.ToArray(); }))();
                c_6 = (c_6 + 1);
            }
            arr_3 = ((Func<double[][]>)(() => { var _tmp = arr_3.ToList(); _tmp.Add(row_5); return _tmp.ToArray(); }))();
            r_4 = (r_4 + 1);
        };
    ...
    public static Matrix matrix_add(Matrix a_14, Matrix b_15) {
        ...
        while ((i_17 < a_14.rows)) {
            ...
            while ((j_19 < a_14.cols)) {
                row_18 = ((Func<double[]>)(() => { var _tmp = row_18.ToList(); _tmp.Add((_idx(_idx(a_14.data, i_17), j_19) + _idx(_idx(b_15.data, i_17), j_19))); return _tmp.ToArray(); }))();
                j_19 = (j_19 + 1);
            }
            res_16 = ((Func<double[][]>)(() => { var _tmp = res_16.ToList(); _tmp.Add(row_18); return _tmp.ToArray(); }))();
            i_17 = (i_17 + 1);
        };
    ...
    public static Matrix matrix_sub(Matrix a_20, Matrix b_21) {
        ...
        while ((i_23 < a_20.rows)) {
            ...
            while ((j_25 < a_20.cols)) {
                row_24 = ((Func<double[]>)(() => { var _tmp = row_24.ToList(); _tmp.Add((_idx(_idx(a_20.data, i_23), j_25) - _idx(_idx(b_21.data, i_23), j_25))); return _tmp.ToArray(); }))();
                j_25 = (j_25 + 1);
            }
            res_22 = ((Func<double[][]>)(() => { var _tmp = res_22.ToList(); _tmp.Add(row_24); return _tmp.ToArray(); }))();
            i_23 = (i_23 + 1);
        };
    ...
    public static Matrix matrix_mul_scalar(Matrix m_26, double k_27) {
        ...
        while ((i_29 < m_26.rows)) {
            ...
            while ((j_31 < m_26.cols)) {
                row_30 = ((Func<double[]>)(() => { var _tmp = row_30.ToList(); _tmp.Add((_idx(_idx(m_26.data, i_29), j_31) * k_27)); return _tmp.ToArray(); }))();
                j_31 = (j_31 + 1);
            }
            res_28 = ((Func<double[][]>)(() => { var _tmp = res_28.ToList(); _tmp.Add(row_30); return _tmp.ToArray(); }))();
            i_29 = (i_29 + 1);
        };
    ...
    public static Matrix matrix_mul(Matrix a_32, Matrix b_33) {
        ...
        while ((i_35 < a_32.rows)) {
            ...
            while ((j_37 < b_33.cols)) {
                ...
                row_36 = ((Func<double[]>)(() => { var _tmp = row_36.ToList(); _tmp.Add(sum_38); return _tmp.ToArray(); }))();
                j_37 = (j_37 + 1);
            }
            res_34 = ((Func<double[][]>)(() => { var _tmp = res_34.ToList(); _tmp.Add(row_36); return _tmp.ToArray(); }))();
            i_35 = (i_35 + 1);
        };
    ...
    public static Matrix matrix_transpose(Matrix m_40) {
        ...
        while ((c_42 < m_40.cols)) {
            ...
            while ((r_44 < m_40.rows)) {
                row_43 = ((Func<double[]>)(() => { var _tmp = row_43.ToList(); _tmp.Add(_idx(_idx(m_40.data, r_44), c_42)); return _tmp.ToArray(); }))();
                r_44 = (r_44 + 1);
            }
            res_41 = ((Func<double[][]>)(() => { var _tmp = res_41.ToList(); _tmp.Add(row_43); return _tmp.ToArray(); }))();
            c_42 = (c_42 + 1);
        };

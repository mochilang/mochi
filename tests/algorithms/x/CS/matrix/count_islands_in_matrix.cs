...
class Program {
    ...
    public static long count_islands(long[][] grid_18) {
        ...
        while ((i_22 < rows_19)) {
            ...
            long j_24 = 0;
            while ((j_24 < cols_20)) {
                row_list_23 = ((Func<bool[]>)(() => { var _tmp = row_list_23.ToList(); _tmp.Add(false); return _tmp.ToArray(); }))();
                j_24 = (j_24 + 1);
            }
            visited_21 = ((Func<bool[][]>)(() => { var _tmp = visited_21.ToList(); _tmp.Add(row_list_23); return _tmp.ToArray(); }))();
            i_22 = (i_22 + 1);
        };
        long count_25 = 0;
        i_22 = 0;

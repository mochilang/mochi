...
class Program {
    ...
    public static long[][] make_matrix(long row_size_1) {
        ...
        while ((y_4 < size_2)) {
            ...
            long x_6 = 0;
            while ((x_6 < size_2)) {
                row_5 = ((Func<long[]>)(() => { var _tmp = row_5.Cast<long>().ToList(); _tmp.Add(((1 + x_6) + (y_4 * size_2))); return _tmp.ToArray(); }))();
                x_6 = (x_6 + 1);
            }
            mat_3 = ((Func<long[][]>)(() => { var _tmp = mat_3.Cast<long[]>().ToList(); _tmp.Add(row_5); return _tmp.ToArray(); }))();
            y_4 = (y_4 + 1);
        };
        return mat_3;
    }
    ...
    public static long[][] transpose(long[][] mat_7) {
        ...
        while ((i_10 < n_8)) {
            ...
            long j_12 = 0;
            while ((j_12 < n_8)) {
                row_11 = ((Func<long[]>)(() => { var _tmp = row_11.Cast<long>().ToList(); _tmp.Add(_idx(_idx(mat_7, j_12), i_10)); return _tmp.ToArray(); }))();
                j_12 = (j_12 + 1);
            }
            result_9 = ((Func<long[][]>)(() => { var _tmp = result_9.Cast<long[]>().ToList(); _tmp.Add(row_11); return _tmp.ToArray(); }))();
            i_10 = (i_10 + 1);
        };
        return result_9;
    }
    ...
    public static long[][] reverse_row(long[][] mat_13) {
        ...
        while ((i_15 >= 0)) {
            result_14 = ((Func<long[][]>)(() => { var _tmp = result_14.Cast<long[]>().ToList(); _tmp.Add(_idx(mat_13, i_15)); return _tmp.ToArray(); }))();
            i_15 = (i_15 - 1);
        };
        return result_14;
    }
    ...
    public static long[][] reverse_column(long[][] mat_16) {
        ...
        while ((i_18 < mat_16.Length)) {
            ...
            while ((j_20 >= 0)) {
                row_19 = ((Func<long[]>)(() => { var _tmp = row_19.Cast<long>().ToList(); _tmp.Add(_idx(_idx(mat_16, i_18), j_20)); return _tmp.ToArray(); }))();
                j_20 = (j_20 - 1);
            }
            result_17 = ((Func<long[][]>)(() => { var _tmp = result_17.Cast<long[]>().ToList(); _tmp.Add(row_19); return _tmp.ToArray(); }))();
            i_18 = (i_18 + 1);
        };
        return result_17;
    }

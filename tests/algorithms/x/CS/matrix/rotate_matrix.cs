...
class Program {
    ...
    public static long[][] transpose(long[][] mat_7) {
        ...
        while ((i_10 < n_8)) {
            ...
            long j_12 = 0;
            while ((j_12 < n_8)) {
                row_11 = (Enumerable.ToArray(Enumerable.Append<long>(row_11, mat_7[(int)(j_12)][(int)(i_10)])));
                j_12 = (j_12 + 1);
            }
    ...
    public static long[][] reverse_row(long[][] mat_13) {
        ...
        while ((i_15 >= 0)) {
            result_14 = (Enumerable.ToArray(Enumerable.Append<long[]>(result_14, mat_13[(int)(i_15)])));
            i_15 = (i_15 - 1);
        };
        return result_14;
    }
    ...
    public static long[][] reverse_column(long[][] mat_16) {
        ...
        while ((i_18 < mat_16.Length)) {
            ...
            long j_20 = (mat_16[(int)(i_18)].Length - 1);
            while ((j_20 >= 0)) {
                row_19 = (Enumerable.ToArray(Enumerable.Append<long>(row_19, mat_16[(int)(i_18)][(int)(j_20)])));
                j_20 = (j_20 - 1);
            }
    ...
    public static string row_to_string(long[] row_30) {
        ...
        while ((i_32 < row_30.Length)) {
            if ((i_32 == 0)) {
                line_31 = _fmtStr(row_30[(int)(i_32)]);
            } else {
                line_31 = ((line_31 + " ") + _fmtStr(row_30[(int)(i_32)]));
            }
            i_32 = (i_32 + 1);
        };
        return line_31;
    ...
    public static void print_matrix(long[][] mat_33) {
        ...
        while ((i_34 < mat_33.Length)) {
            Console.WriteLine(Program._fmtTop(Program.row_to_string(mat_33[(int)(i_34)])));
            i_34 = (i_34 + 1);
        };
    }

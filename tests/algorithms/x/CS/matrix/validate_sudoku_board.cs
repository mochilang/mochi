...
class Program {
    ...
    public static bool is_valid_sudoku_board(string[][] board_2) {
        ...
        i_3 = 0;
        while ((i_3 < NUM_SQUARES_0)) {
            rows_4 = ((Func<string[][]>)(() => { var _tmp = rows_4.ToList(); _tmp.Add(new string[]{}); return _tmp.ToArray(); }))();
            cols_5 = ((Func<string[][]>)(() => { var _tmp = cols_5.ToList(); _tmp.Add(new string[]{}); return _tmp.ToArray(); }))();
            boxes_6 = ((Func<string[][]>)(() => { var _tmp = boxes_6.ToList(); _tmp.Add(new string[]{}); return _tmp.ToArray(); }))();
            i_3 = (i_3 + 1);
        };
        for (var r_7 = 0; r_7 < NUM_SQUARES_0; r_7++) {
            for (var c_8 = 0; c_8 < NUM_SQUARES_0; c_8++) {
                ...
                long box_10 = ((_atoi((r_7 / 3)) * 3) + _atoi((c_8 / 3)));
                ...
                rows_4[(int)(r_7)] = ((Func<string[]>)(() => { var _tmp = _idx(rows_4, r_7).ToList(); _tmp.Add(value_9); return _tmp.ToArray(); }))();
                cols_5[(int)(c_8)] = ((Func<string[]>)(() => { var _tmp = _idx(cols_5, c_8).ToList(); _tmp.Add(value_9); return _tmp.ToArray(); }))();
                boxes_6[(int)(box_10)] = ((Func<string[]>)(() => { var _tmp = _idx(boxes_6, box_10).ToList(); _tmp.Add(value_9); return _tmp.ToArray(); }))();
            }
        };
        return true;
    }

    ...
    public static bool is_valid_sudoku_board(string[][] board_2) {
        ...
        for (var r_7 = 0; r_7 < NUM_SQUARES_0; r_7++) {
            for (var c_8 = 0; c_8 < NUM_SQUARES_0; c_8++) {
                ...
                rows_4[(int)(r_7)] = (Enumerable.ToArray(Enumerable.Append<string>(_idx(rows_4, r_7), value_9)));
                cols_5[(int)(c_8)] = (Enumerable.ToArray(Enumerable.Append<string>(_idx(cols_5, c_8), value_9)));
                boxes_6[(int)(box_10)] = (Enumerable.ToArray(Enumerable.Append<string>(_idx(boxes_6, box_10), value_9)));
            }
        };
        return true;
    }

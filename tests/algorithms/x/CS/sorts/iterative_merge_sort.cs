...
class Program {
    ...
    public static long[] merge(long[] a_0, long low_1, long mid_2, long high_3) {
        ...
        while (((left_4.Length > 0) && (right_5.Length > 0))) {
            if ((left_4[(int)(0)] <= right_5[(int)(0)])) {
                result_6 = (Enumerable.ToArray(Enumerable.Append<long>(result_6, left_4[(int)(0)])));
                left_4 = _slice<long>(left_4, 1, left_4.Length);
            } else {
                result_6 = (Enumerable.ToArray(Enumerable.Append<long>(result_6, right_5[(int)(0)])));
                right_5 = _slice<long>(right_5, 1, right_5.Length);
            }
        };
        long i_7 = 0;
        while ((i_7 < left_4.Length)) {
            result_6 = (Enumerable.ToArray(Enumerable.Append<long>(result_6, left_4[(int)(i_7)])));
            i_7 = (i_7 + 1);
        };
        i_7 = 0;
        while ((i_7 < right_5.Length)) {
            result_6 = (Enumerable.ToArray(Enumerable.Append<long>(result_6, right_5[(int)(i_7)])));
            i_7 = (i_7 + 1);
        };
        i_7 = 0;
        while ((i_7 < result_6.Length)) {
            a_0[(int)((low_1 + i_7))] = result_6[(int)(i_7)];
            i_7 = (i_7 + 1);
        };
        return a_0;
    }
    ...
    public static string list_to_string(long[] arr_17) {
        ...
        while ((i_19 < arr_17.Length)) {
            s_18 = (s_18 + _fmtStr(arr_17[(int)(i_19)]));

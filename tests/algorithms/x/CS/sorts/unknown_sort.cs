...
class Program {
    ...
    public static long list_min(long[] xs_0) {
        long i_1 = 1;
        long m_2 = _idx(xs_0, 0);
        while ((i_1 < xs_0.Length)) {
            if ((_idx(xs_0, i_1) < m_2)) {
                m_2 = _idx(xs_0, i_1);
            }
            i_1 = (i_1 + 1);
        };
    ...
    public static long list_max(long[] xs_3) {
        long i_4 = 1;
        long m_5 = _idx(xs_3, 0);
        while ((i_4 < xs_3.Length)) {
            if ((_idx(xs_3, i_4) > m_5)) {
                m_5 = _idx(xs_3, i_4);
            }
            i_4 = (i_4 + 1);
        };
    ...
    public static long[] remove_once(long[] xs_6, long value_7) {
        ...
        while ((i_10 < xs_6.Length)) {
            if (((!removed_9) && (_idx(xs_6, i_10) == value_7))) {
                removed_9 = true;
            } else {
                res_8 = (Enumerable.ToArray(Enumerable.Append<long>(res_8, _idx(xs_6, i_10))));
            }
            i_10 = (i_10 + 1);
        };
        return res_8;
    ...
    public static long[] reverse_list(long[] xs_11) {
        ...
        while ((i_13 >= 0)) {
            res_12 = (Enumerable.ToArray(Enumerable.Append<long>(res_12, _idx(xs_11, i_13))));
            i_13 = (i_13 - 1);
        };
        return res_12;
    }

...
class Program {
    ...
    public static long[] copy_list(long[] xs_0) {
        ...
        while ((k_2 < xs_0.Length)) {
            res_1 = (Enumerable.ToArray(Enumerable.Append<long>(res_1, _idx(xs_0, k_2))));
            k_2 = (k_2 + 1);
        };
        return res_1;
    }
    ...
    public static long[] insertion_sort(long[] xs_3) {
        ...
        while ((idx_5 < arr_4.Length)) {
            long value_6 = _idx(arr_4, idx_5);
            long jdx_7 = (idx_5 - 1);
            while (((jdx_7 >= 0) && (_idx(arr_4, jdx_7) > value_6))) {
                arr_4[(int)((jdx_7 + 1))] = _idx(arr_4, jdx_7);
                jdx_7 = (jdx_7 - 1);
            }
    ...
    public static long[] merge(long[] left_8, long[] right_9) {
        ...
        while (((i_11 < left_8.Length) && (j_12 < right_9.Length))) {
            if ((_idx(left_8, i_11) < _idx(right_9, j_12))) {
                result_10 = (Enumerable.ToArray(Enumerable.Append<long>(result_10, _idx(left_8, i_11))));
                i_11 = (i_11 + 1);
            } else {
                result_10 = (Enumerable.ToArray(Enumerable.Append<long>(result_10, _idx(right_9, j_12))));
                j_12 = (j_12 + 1);
            }
        };
    ...
    public static long[] tim_sort(long[] xs_13) {
        ...
        current_17 = (Enumerable.ToArray(Enumerable.Append<long>(current_17, _idx(xs_13, 0))));
        long i_18 = 1;
        while ((i_18 < n_14)) {
            if ((_idx(xs_13, i_18) < _idx(xs_13, (i_18 - 1)))) {
                runs_15 = (Enumerable.ToArray(Enumerable.Append<long[]>(runs_15, Program.copy_list(current_17))));
                current_17 = new long[]{};
                current_17 = (Enumerable.ToArray(Enumerable.Append<long>(current_17, _idx(xs_13, i_18))));
            } else {
                current_17 = (Enumerable.ToArray(Enumerable.Append<long>(current_17, _idx(xs_13, i_18))));
            }
            i_18 = (i_18 + 1);
        ...
        while ((r_19 < runs_15.Length)) {
            sorted_runs_16 = (Enumerable.ToArray(Enumerable.Append<long[]>(sorted_runs_16, Program.insertion_sort(_idx(runs_15, r_19)))));
            r_19 = (r_19 + 1);
        };
        long[] result_20 = new long[]{};
        r_19 = 0;
        while ((r_19 < sorted_runs_16.Length)) {
            result_20 = Program.merge(result_20, _idx(sorted_runs_16, r_19));
            r_19 = (r_19 + 1);
        };
        return result_20;
    }
    ...
    public static string list_to_string(long[] xs_21) {
        ...
        while ((k_23 < xs_21.Length)) {
            s_22 = (s_22 + _fmtStr(_idx(xs_21, k_23)));

...
class Program {
    ...
    public static long compare_keys(string[] a_18, string[] b_19) {
        ...
        while (((i_20 < a_18.Length) && (i_20 < b_19.Length))) {
            if ((string.Compare(_idx(a_18, i_20), _idx(b_19, i_20)) < 0)) {
                return -1;
            }
            if ((string.Compare(_idx(a_18, i_20), _idx(b_19, i_20)) > 0)) {
                return 1;
    ...
    public static string[] natural_sort(string[] arr_21) {
        ...
        while ((k_24 < arr_21.Length)) {
            res_22 = (Enumerable.ToArray(Enumerable.Append<string>(res_22, _idx(arr_21, k_24))));
            keys_23 = (Enumerable.ToArray(Enumerable.Append<string[]>(keys_23, Program.alphanum_key(_idx(arr_21, k_24)))));
            k_24 = (k_24 + 1);
        };
        long i_25 = 1;
        while ((i_25 < res_22.Length)) {
            string current_26 = _idx(res_22, i_25);
            string[] current_key_27 = _idx(keys_23, i_25);
            long j_28 = (i_25 - 1);
            while (((j_28 >= 0) && (Program.compare_keys(_idx(keys_23, j_28), current_key_27) > 0))) {
                res_22[(int)((j_28 + 1))] = _idx(res_22, j_28);
                keys_23[(int)((j_28 + 1))] = _idx(keys_23, j_28);
                j_28 = (j_28 - 1);
            }

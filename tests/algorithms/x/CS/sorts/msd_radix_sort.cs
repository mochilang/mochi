...
class Program {
    ...
    public static long max_bit_length(long[] nums_3) {
        ...
        while ((i_4 < nums_3.Length)) {
            long l_6 = Program.get_bit_length(_idx(nums_3, i_4));
            if ((l_6 > max_len_5)) {
                max_len_5 = l_6;
            }
            i_4 = (i_4 + 1);
    ...
    public static long[] _msd_radix_sort(long[] nums_11, long bit_position_12) {
        ...
        while ((i_15 < ones_14.Length)) {
            res_17 = (Enumerable.ToArray(Enumerable.Append<long>(res_17, _idx(ones_14, i_15))));
            i_15 = (i_15 + 1);
        };
        return res_17;
    }

...
class Program {
    ...
    public static long[] merge(long[] left_5, long[] right_6) {
        ...
        while (((i_8 < left_5.Length) && (j_9 < right_6.Length))) {
            if ((_idx(left_5, i_8) <= _idx(right_6, j_9))) {
                result_7 = (Enumerable.ToArray(Enumerable.Append<long>(result_7, _idx(left_5, i_8))));
                i_8 = (i_8 + 1);
            } else {
                result_7 = (Enumerable.ToArray(Enumerable.Append<long>(result_7, _idx(right_6, j_9))));
                j_9 = (j_9 + 1);
            }
        };

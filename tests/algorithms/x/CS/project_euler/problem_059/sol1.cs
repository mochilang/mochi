...
class Program {
    ...
    public static string try_key(long[] ciphertext_16, long[] key_17) {
        ...
        while ((i_19 < ciphertext_16.Length)) {
            long decodedchar_21 = Program.xor(ciphertext_16[(int)(i_19)], key_17[(int)(_mod(i_19, klen_20))]);
        ...
        while ((i_24 < LOWERCASE_INTS_13.Length)) {
            ...
            while ((j_25 < LOWERCASE_INTS_13.Length)) {
                ...
                while ((k_26 < LOWERCASE_INTS_13.Length)) {
                    long[] key_27 = new long[]{LOWERCASE_INTS_13[(int)(i_24)], LOWERCASE_INTS_13[(int)(j_25)], LOWERCASE_INTS_13[(int)(k_26)]};
                    string decoded_28 = Program.try_key(ciphertext_22, key_27);
                    if ((decoded_28 != null)) {
                        possibles_23 = (Enumerable.ToArray(Enumerable.Append<string>(possibles_23, decoded_28)));
                    }
                    k_26 = (k_26 + 1);
                }
                j_25 = (j_25 + 1);
    ...
    public static string[] filter_common_word(string[] possibles_36, string common_word_37) {
        ...
        while ((i_39 < possibles_36.Length)) {
            string p_40 = possibles_36[(int)(i_39)];
            if (Program.contains(p_40.ToLower(), common_word_37)) {
                res_38 = (Enumerable.ToArray(Enumerable.Append<string>(res_38, p_40)));
            }
            i_39 = (i_39 + 1);
        };
        return res_38;
    ...
    public static long solution(long[] ciphertext_41) {
        ...
        while ((i_43 < COMMON_WORDS_15.Length)) {
            string word_44 = COMMON_WORDS_15[(int)(i_43)];
        ...
        string decoded_text_45 = possibles_42[(int)(0)];
        long sum_46 = 0;
        long j_47 = 0;
    ...
    static void Main() {
        {
            ...
            var __start = _now();
            while ((i_14 <= 122)) {
                LOWERCASE_INTS_13 = (Enumerable.ToArray(Enumerable.Append<long>(LOWERCASE_INTS_13, i_14)));
                i_14 = (i_14 + 1);
            }
            string[] COMMON_WORDS_15 = new string[]{"the", "be", "to", "of", "and", "in", "that", "have"};
            long[] ciphertext_48 = new long[]{17, 6, 1, 69, 12, 1, 69, 26, 11, 69, 1, 2, 69, 15, 10, 1, 78, 13, 11, 78, 16, 13, 15, 16, 69, 6, 5, 19, 11};

    ...
    static void Main() {
        {
            ...
            Console.WriteLine(Program._fmtTop(_fmtStr(Program.solution(600))));
            Console.WriteLine(Program._fmtTop(_fmtStr(Program.solution(-7))));

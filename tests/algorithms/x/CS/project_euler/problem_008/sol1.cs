...
class Program {
    ...
    public static long solution(string n_1) {
        long largest_product_2 = 0;
        long i_3 = 0;
        while ((i_3 <= (n_1.Length - 13))) {
            long product_4 = 1;
            long j_5 = 0;
            while ((j_5 < 13)) {
                product_4 = (product_4 * _atoi(_substr(n_1, (i_3 + j_5), ((i_3 + j_5) + 1))));
                j_5 = (j_5 + 1);
            }
            if ((product_4 > largest_product_2)) {
                largest_product_2 = product_4;
            }
            i_3 = (i_3 + 1);
        };
        return largest_product_2;
    }
    ...
    static void Main() {
        {
            var __memStart = _mem();
            var __start = _now();
            Console.WriteLine(Program._fmtTop(("solution() = " + _fmtStr(Program.solution(N_0)))));
            var __end = _now();
            var __memEnd = _mem();

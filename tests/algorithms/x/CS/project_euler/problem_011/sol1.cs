...
class Program {
    ...
    public static long largest_product(long[][] grid_0) {
        long n_rows_1 = grid_0.Length;
        long n_cols_2 = grid_0[(int)(0)].Length;
        long largest_3 = 0;
        long i_4 = 0;
        while ((i_4 < n_rows_1)) {
            long j_5 = 0;
            while ((j_5 < n_cols_2)) {
                if ((j_5 <= (n_cols_2 - 4))) {
                    long horz_6 = (((grid_0[(int)(i_4)][(int)(j_5)] * grid_0[(int)(i_4)][(int)((j_5 + 1))]) * grid_0[(int)(i_4)][(int)((j_5 + 2))]) * grid_0[(int)(i_4)][(int)((j_5 + 3))]);
                    if ((horz_6 > largest_3)) {
                        largest_3 = horz_6;
                    }
                }
                if ((i_4 <= (n_rows_1 - 4))) {
                    long vert_7 = (((grid_0[(int)(i_4)][(int)(j_5)] * grid_0[(int)((i_4 + 1))][(int)(j_5)]) * grid_0[(int)((i_4 + 2))][(int)(j_5)]) * grid_0[(int)((i_4 + 3))][(int)(j_5)]);
                    if ((vert_7 > largest_3)) {
                        largest_3 = vert_7;
                    }
                    if ((j_5 <= (n_cols_2 - 4))) {
                        long lr_8 = (((grid_0[(int)(i_4)][(int)(j_5)] * grid_0[(int)((i_4 + 1))][(int)((j_5 + 1))]) * grid_0[(int)((i_4 + 2))][(int)((j_5 + 2))]) * grid_0[(int)((i_4 + 3))][(int)((j_5 + 3))]);
                        if ((lr_8 > largest_3)) {
                            largest_3 = lr_8;
                        }
                    }
                    if ((j_5 >= 3)) {
                        long rl_9 = (((grid_0[(int)(i_4)][(int)(j_5)] * grid_0[(int)((i_4 + 1))][(int)((j_5 - 1))]) * grid_0[(int)((i_4 + 2))][(int)((j_5 - 2))]) * grid_0[(int)((i_4 + 3))][(int)((j_5 - 3))]);
                        if ((rl_9 > largest_3)) {
                            largest_3 = rl_9;
                        }
                    }

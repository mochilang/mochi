    ...
    static void Main() {
        {
            ...
            Console.WriteLine(Program._fmtTop(_fmtStr(Program.solution(34))));
            Console.WriteLine(Program._fmtTop(_fmtStr(Program.solution(4000000))));
            var __end = _now();
            var __memEnd = _mem();

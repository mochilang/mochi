...
class Program {
    ...
    public static long solution(string[] matrix_str_17) {
        ...
        long size_21 = powers_20[(int)(n_19)];
        long[] dp_22 = new long[]{};
        long i_23 = 0;
        while ((i_23 < size_21)) {
        ...
        while ((mask_24 < size_21)) {
            ...
            if ((row_25 < n_19)) {
                long col_26 = 0;
                while ((col_26 < n_19)) {
                    if ((_mod((mask_24 / powers_20[(int)(col_26)]), 2) == 0)) {
                        long new_mask_27 = (mask_24 + powers_20[(int)(col_26)]);
                        long value_28 = (dp_22[(int)(mask_24)] + arr_18[(int)(row_25)][(int)(col_26)]);
                        if ((value_28 > dp_22[(int)(new_mask_27)])) {
                            dp_22[new_mask_27] = value_28;
                        }
                    }
                    col_26 = (col_26 + 1);
                }

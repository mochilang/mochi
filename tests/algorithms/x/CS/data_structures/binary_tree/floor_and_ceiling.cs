...
class Program {
    ...
    public static long[] inorder(Node[] nodes_0, long idx_1) {
        if ((idx_1 == -1)) {
            return new long[]{};
        };
        Node node_2 = nodes_0[(int)(idx_1)];
        long[] result_3 = Program.inorder(nodes_0, node_2.left);
        result_3 = (Enumerable.ToArray(Enumerable.Append<long>(result_3, node_2.key)));
        result_3 = (Enumerable.ToArray(Enumerable.Concat(result_3, Program.inorder(nodes_0, node_2.right))));
        return result_3;
    }

    public static long[] floor_ceiling(Node[] nodes_4, long idx_5, long key_6) {
        object floor_val_7 = null;
        object ceiling_val_8 = null;
        long current_9 = idx_5;
        while ((current_9 != -1)) {
            Node node_10 = nodes_4[(int)(current_9)];
        ...
        return new long[]{floor_val_7, ceiling_val_8}.Cast<long>().ToArray();
    }

...
class Program {
    ...
    public static double round(double x_10, long n_11) {
        double m_12 = Math.Pow(10.0, n_11);
    ...
    static void Main() {
        _ = __name__;
        {
            var __memStart = _mem();
            var __start = _now();
            Console.WriteLine(Program._fmtTop(Program.charging_inductor(5.7999999999999998, 1.5, 2.2999999999999998, 2.0)));
            Console.WriteLine(Program._fmtTop(Program.charging_inductor(8.0, 5.0, 3.0, 2.0)));
            Console.WriteLine(Program._fmtTop(Program.charging_inductor(8.0, (5.0 * Math.Pow(10.0, 2)), 3.0, 2.0)));
            var __end = _now();
            var __memEnd = _mem();

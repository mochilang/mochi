...
class Program {
    ...
    public static bool bfs(long[][] graph_0, long s_1, long t_2, long[] parent_3) {
        ...
        while ((i_5 < graph_0.Length)) {
            visited_4 = ((Func<bool[]>)(() => { var _tmp = visited_4.Cast<bool>().ToList(); _tmp.Add(false); return _tmp.ToArray(); }))();
            i_5 = (i_5 + 1);
        };
        ...
        while ((head_7 < queue_6.Length)) {
            ...
            while ((ind_9 < _idx(graph_0, u_8).Length)) {
                if (((_idx(visited_4, ind_9) == false) && (_idx(_idx(graph_0, u_8), ind_9) > 0))) {
                    queue_6 = ((Func<long[]>)(() => { var _tmp = queue_6.Cast<long>().ToList(); _tmp.Add(ind_9); return _tmp.ToArray(); }))();
    ...
    public static long[][] mincut(long[][] graph_10, long source_11, long sink_12) {
        ...
        while ((i_15 < g_13.Length)) {
            parent_14 = ((Func<long[]>)(() => { var _tmp = parent_14.Cast<long>().ToList(); _tmp.Add(-1); return _tmp.ToArray(); }))();
            i_15 = (i_15 + 1);
        };
        ...
        while ((i_15 < g_13.Length)) {
            ...
            while ((j_18 < _idx(g_13, i_15).Length)) {
                row_17 = ((Func<long[]>)(() => { var _tmp = row_17.Cast<long>().ToList(); _tmp.Add(_idx(_idx(g_13, i_15), j_18)); return _tmp.ToArray(); }))();
                j_18 = (j_18 + 1);
            }
            temp_16 = ((Func<long[][]>)(() => { var _tmp = temp_16.Cast<long[]>().ToList(); _tmp.Add(row_17); return _tmp.ToArray(); }))();
            i_15 = (i_15 + 1);
        };
        ...
        while ((i_15 < g_13.Length)) {
            ...
            while ((j_26 < _idx(g_13, 0).Length)) {
                if (((_idx(_idx(g_13, i_15), j_26) == 0) && (_idx(_idx(temp_16, i_15), j_26) > 0))) {
                    res_25 = ((Func<long[][]>)(() => { var _tmp = res_25.Cast<long[]>().ToList(); _tmp.Add(new long[]{i_15, j_26}); return _tmp.ToArray(); }))();
                }
                j_26 = (j_26 + 1);
            }
            i_15 = (i_15 + 1);

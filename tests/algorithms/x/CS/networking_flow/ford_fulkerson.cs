...
class Program {
    ...
    public static bool breadth_first_search(long[][] graph_1, long source_2, long sink_3, long[] parent_4) {
        ...
        while ((i_6 < graph_1.Length)) {
            visited_5 = ((Func<bool[]>)(() => { var _tmp = visited_5.Cast<bool>().ToList(); _tmp.Add(false); return _tmp.ToArray(); }))();
            i_6 = (i_6 + 1);
        };
        long[] queue_7 = new long[]{};
        queue_7 = ((Func<long[]>)(() => { var _tmp = queue_7.Cast<long>().ToList(); _tmp.Add(source_2); return _tmp.ToArray(); }))();
        ...
        while ((head_8 < queue_7.Length)) {
            ...
            while ((ind_11 < row_10.Length)) {
                ...
                if (((_idx(visited_5, ind_11) == false) && (capacity_12 > 0))) {
                    queue_7 = ((Func<long[]>)(() => { var _tmp = queue_7.Cast<long>().ToList(); _tmp.Add(ind_11); return _tmp.ToArray(); }))();
    ...
    public static long ford_fulkerson(long[][] graph_13, long source_14, long sink_15) {
        ...
        while ((i_17 < graph_13.Length)) {
            parent_16 = ((Func<long[]>)(() => { var _tmp = parent_16.Cast<long>().ToList(); _tmp.Add(-1); return _tmp.ToArray(); }))();
            i_17 = (i_17 + 1);
        };
        long max_flow_18 = 0;

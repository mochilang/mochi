...
class Program {
    ...
    public static long[] set_at_int(long[] xs_0, long idx_1, long value_2) {
        ...
        while ((i_3 < xs_0.Length)) {
            if ((i_3 == idx_1)) {
                ...
                res_4 = (Enumerable.ToArray(Enumerable.Append<long>(res_4, xs_0[(int)(i_3)])));
            }
            i_3 = (i_3 + 1);
        };
        return res_4;
    ...
    public static long[] sort_int(long[] xs_5) {
        ...
        while ((i_7 < res_6.Length)) {
            long key_8 = res_6[(int)(i_7)];
            long j_9 = (i_7 - 1);
            while (((j_9 >= 0) && (res_6[(int)(j_9)] > key_8))) {
                res_6 = Program.set_at_int(res_6, (j_9 + 1), res_6[(int)(j_9)]);
                j_9 = (j_9 - 1);
            }
    ...
    public static long median_of_five(long[] arr_10) {
        ...
        return sorted_11[(int)((sorted_11.Length / 2))];
    }
    ...
    public static long quick_select(long[] arr_15, long target_16) {
        ...
        while ((i_21 < arr_15.Length)) {
            if ((arr_15[(int)(i_21)] < x_17)) {
                left_18 = (Enumerable.ToArray(Enumerable.Append<long>(left_18, arr_15[(int)(i_21)])));
            } else if ((arr_15[(int)(i_21)] > x_17)) {
                right_19 = (Enumerable.ToArray(Enumerable.Append<long>(right_19, arr_15[(int)(i_21)])));
            } else if ((arr_15[(int)(i_21)] == x_17)) {
                if ((!check_20)) {
                    check_20 = true;
                } else {

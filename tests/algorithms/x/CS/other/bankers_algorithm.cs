...
class Program {
    ...
    public static long[] available_resources(long[] claim_6, long[] alloc_sum_7) {
        ...
        while ((i_9 < claim_6.Length)) {
            avail_8 = (Enumerable.ToArray(Enumerable.Append<long>(avail_8, (_idx(claim_6, i_9) - _idx(alloc_sum_7, i_9)))));
            i_9 = (i_9 + 1);
        };
        return avail_8;
    }
    ...
    public static long[][] need(long[][] max_10, long[][] alloc_11) {
        ...
        while ((i_13 < max_10.Length)) {
            ...
            while ((j_15 < _idx(max_10, 0).Length)) {
                row_14 = (Enumerable.ToArray(Enumerable.Append<long>(row_14, (_idx(_idx(max_10, i_13), j_15) - _idx(_idx(alloc_11, i_13), j_15)))));
                j_15 = (j_15 + 1);
            }

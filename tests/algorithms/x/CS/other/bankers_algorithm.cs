...
class Program {
    ...
    public static long[] processes_resource_summation(long[][] alloc_0) {
        long resources_1 = _idx(alloc_0, 0).Length;
        ...
        while ((i_3 < resources_1)) {
            ...
            while ((j_5 < alloc_0.Length)) {
                total_4 = (total_4 + _idx(_idx(alloc_0, j_5), i_3));
                j_5 = (j_5 + 1);
            }
            sums_2 = ((Func<long[]>)(() => { var _tmp = sums_2.Cast<long>().ToList(); _tmp.Add(total_4); return _tmp.ToArray(); }))();
            i_3 = (i_3 + 1);
        };
        return sums_2;
    }
    ...
    public static long[] available_resources(long[] claim_6, long[] alloc_sum_7) {
        ...
        while ((i_9 < claim_6.Length)) {
            avail_8 = ((Func<long[]>)(() => { var _tmp = avail_8.Cast<long>().ToList(); _tmp.Add((_idx(claim_6, i_9) - _idx(alloc_sum_7, i_9))); return _tmp.ToArray(); }))();
            i_9 = (i_9 + 1);
        };
        return avail_8;
    }
    ...
    public static long[][] need(long[][] max_10, long[][] alloc_11) {
        ...
        while ((i_13 < max_10.Length)) {
            ...
            long j_15 = 0;
            while ((j_15 < _idx(max_10, 0).Length)) {
                row_14 = ((Func<long[]>)(() => { var _tmp = row_14.Cast<long>().ToList(); _tmp.Add((_idx(_idx(max_10, i_13), j_15) - _idx(_idx(alloc_11, i_13), j_15))); return _tmp.ToArray(); }))();
                j_15 = (j_15 + 1);
            }
            needs_12 = ((Func<long[][]>)(() => { var _tmp = needs_12.Cast<long[]>().ToList(); _tmp.Add(row_14); return _tmp.ToArray(); }))();
            i_13 = (i_13 + 1);
        };
        return needs_12;
    }
    ...
    public static void pretty_print(long[] claim_16, long[][] alloc_17, long[][] max_18) {
        ...
        while ((i_19 < alloc_17.Length)) {
            long[] row_20 = _idx(alloc_17, i_19);
            string line_21 = (("P" + _fmtStr((i_19 + 1))) + "       ");
            long j_22 = 0;
            while ((j_22 < row_20.Length)) {
                line_21 = (line_21 + _fmtStr(_idx(row_20, j_22)));
        ...
        while ((i_19 < max_18.Length)) {
            long[] row_23 = _idx(max_18, i_19);
            string line_24 = (("P" + _fmtStr((i_19 + 1))) + "       ");
            long j_25 = 0;
            while ((j_25 < row_23.Length)) {
                line_24 = (line_24 + _fmtStr(_idx(row_23, j_25)));
        ...
        while ((i_19 < claim_16.Length)) {
            ...
            usage_26 = (usage_26 + _fmtStr(_idx(claim_16, i_19)));
            i_19 = (i_19 + 1);
        };
        ...
        while ((i_19 < avail_28.Length)) {
            ...
            avail_str_29 = (avail_str_29 + _fmtStr(_idx(avail_28, i_19)));
            i_19 = (i_19 + 1);
        };
    ...
    public static void bankers_algorithm(long[] claim_30, long[][] alloc_31, long[][] max_32) {
        ...
        while ((i_37 < need_list_33.Length)) {
            finished_36 = ((Func<bool[]>)(() => { var _tmp = finished_36.Cast<bool>().ToList(); _tmp.Add(false); return _tmp.ToArray(); }))();
            i_37 = (i_37 + 1);
        };
        ...
        while ((remaining_38 > 0)) {
            ...
            while ((p_40 < need_list_33.Length)) {
                if ((!_idx(finished_36, p_40))) {
                    bool exec_41 = true;
                    long r_42 = 0;
                    while ((r_42 < avail_35.Length)) {
                        if ((_idx(_idx(need_list_33, p_40), r_42) > _idx(avail_35, r_42))) {
                            exec_41 = false;
                            break;
                        }
                        r_42 = (r_42 + 1);
                    ...
                    if (exec_41) {
                        ...
                        r_42 = 0;
                        while ((r_42 < avail_35.Length)) {
                            avail_35[(int)(r_42)] = (_idx(avail_35, r_42) + _idx(_idx(alloc_31, p_40), r_42));
                            r_42 = (r_42 + 1);
                        }
                        string avail_str_43 = "";
                        r_42 = 0;
                        while ((r_42 < avail_35.Length)) {
                            ...
                            avail_str_43 = (avail_str_43 + _fmtStr(_idx(avail_35, r_42)));
                            r_42 = (r_42 + 1);
                        }

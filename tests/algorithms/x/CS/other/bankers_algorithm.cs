...
class Program {
    ...
    public static long[] processes_resource_summation(long[][] alloc_0) {
        ...
        while ((i_3 < resources_1)) {
            ...
            sums_2 = ((Func<long[]>)(() => { var _tmp = sums_2.ToList(); _tmp.Add(total_4); return _tmp.ToArray(); }))();
            i_3 = (i_3 + 1);
        };
        return sums_2;
    }
    ...
    public static long[] available_resources(long[] claim_6, long[] alloc_sum_7) {
        ...
        while ((i_9 < claim_6.Length)) {
            avail_8 = ((Func<long[]>)(() => { var _tmp = avail_8.ToList(); _tmp.Add((_idx(claim_6, i_9) - _idx(alloc_sum_7, i_9))); return _tmp.ToArray(); }))();
            i_9 = (i_9 + 1);
        };
        return avail_8;
    }
    ...
    public static long[][] need(long[][] max_10, long[][] alloc_11) {
        ...
        while ((i_13 < max_10.Length)) {
            ...
            while ((j_15 < _idx(max_10, 0).Length)) {
                row_14 = ((Func<long[]>)(() => { var _tmp = row_14.ToList(); _tmp.Add((_idx(_idx(max_10, i_13), j_15) - _idx(_idx(alloc_11, i_13), j_15))); return _tmp.ToArray(); }))();
                j_15 = (j_15 + 1);
            }
            needs_12 = ((Func<long[][]>)(() => { var _tmp = needs_12.ToList(); _tmp.Add(row_14); return _tmp.ToArray(); }))();
            i_13 = (i_13 + 1);
        };
        return needs_12;
    }
    ...
    public static void bankers_algorithm(long[] claim_30, long[][] alloc_31, long[][] max_32) {
        ...
        while ((i_37 < need_list_33.Length)) {
            finished_36 = ((Func<bool[]>)(() => { var _tmp = finished_36.ToList(); _tmp.Add(false); return _tmp.ToArray(); }))();
            i_37 = (i_37 + 1);
        };

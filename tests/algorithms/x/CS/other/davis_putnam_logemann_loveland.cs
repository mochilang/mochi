...
class Program {
    ...
    public static Clause new_clause(string[] lits_0) {
        ...
        while ((i_3 < lits_0.Length)) {
            string lit_4 = _idx(lits_0, i_3);
            m_1[lit_4] = (0 - 1);
            names_2 = ((Func<string[]>)(() => { var _tmp = names_2.Cast<string>().ToList(); _tmp.Add(lit_4); return _tmp.ToArray(); }))();
            i_3 = (i_3 + 1);
        };
    ...
    public static Clause assign_clause(Clause c_5, Dictionary<string, long> model_6) {
        ...
        while ((i_8 < c_5.names.Length)) {
            string lit_9 = _idx(c_5.names, i_8);
    ...
    public static EvalResult evaluate_clause(Clause c_12, Dictionary<string, long> model_13) {
        ...
        while ((i_14 < c_12.names.Length)) {
            string lit_15 = _idx(c_12.names, i_14);
        ...
        i_14 = 0;
        while ((i_14 < c_12.names.Length)) {
            string lit_17 = _idx(c_12.names, i_14);
        ...
        i_14 = 0;
        while ((i_14 < c_12.names.Length)) {
            string lit_20 = _idx(c_12.names, i_14);
    ...
    public static string[] remove_symbol(string[] symbols_22, string s_23) {
        ...
        while ((i_25 < symbols_22.Length)) {
            if ((_idx(symbols_22, i_25) != s_23)) {
                res_24 = ((Func<string[]>)(() => { var _tmp = res_24.Cast<string>().ToList(); _tmp.Add(_idx(symbols_22, i_25)); return _tmp.ToArray(); }))();
            }
            i_25 = (i_25 + 1);
        };
        return res_24;
    ...
    public static DPLLResult dpll_algorithm(Clause[] clauses_26, string[] symbols_27, Dictionary<string, long> model_28) {
        ...
        while ((i_30 < clauses_26.Length)) {
            EvalResult ev_31 = Program.evaluate_clause(_idx(clauses_26, i_30), model_28);
    ...
    public static string str_clause(Clause c_37) {
        ...
        while ((i_40 < c_37.names.Length)) {
            string lit_41 = _idx(c_37.names, i_40);
            if (first_39) {
                first_39 = false;
            } else {
                line_38 = (line_38 + " , ");
    ...
    public static string str_formula(Formula f_42) {
        ...
        while ((i_44 < f_42.clauses.Length)) {
            line_43 = (line_43 + Program.str_clause(_idx(f_42.clauses, i_44)));

...
class Program {
    ...
    public static Clause new_clause(string[] lits_0) {
        ...
        while ((i_3 < lits_0.Length)) {
            ...
            m_1[lit_4] = (0 - 1);
            names_2 = ((Func<string[]>)(() => { var _tmp = names_2.ToList(); _tmp.Add(lit_4); return _tmp.ToArray(); }))();
            i_3 = (i_3 + 1);
        };
    ...
    public static string[] remove_symbol(string[] symbols_22, string s_23) {
        ...
        while ((i_25 < symbols_22.Length)) {
            if ((_idx(symbols_22, i_25) != s_23)) {
                res_24 = ((Func<string[]>)(() => { var _tmp = res_24.ToList(); _tmp.Add(_idx(symbols_22, i_25)); return _tmp.ToArray(); }))();
            }
            i_25 = (i_25 + 1);
        };
        return res_24;

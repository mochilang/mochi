...
class Program {
    ...
    public static long get_avg(long number_1_0, long number_2_1) {
        return _floordiv((number_1_0 + number_2_1), 2);
    }
    ...
    public static long[] guess_the_number(long lower_2, long higher_3, long to_guess_4) {
        ...
        while (true) {
            ...
            last_numbers_8 = ((Func<long[]>)(() => { var _tmp = last_numbers_8.Cast<long>().ToList(); _tmp.Add(number_9); return _tmp.ToArray(); }))();
        ...
        Console.WriteLine(Program._fmtTop(("guess the number : " + _fmtStr(_idx(last_numbers_8, (last_numbers_8.Length - 1))))));

...
class Program {
    ...
    public static string[] slice_without_last(string[] xs_1) {
        ...
        while ((i_3 < (xs_1.Length - 1))) {
            res_2 = (Enumerable.ToArray(Enumerable.Append<string>(res_2, xs_1[(int)(i_3)])));
            i_3 = (i_3 + 1);
        };
        return res_2;
    }
    ...
    public static bool is_balanced(string s_4) {
        ...
        while ((i_6 < s_4.Length)) {
            ...
            if ((OPEN_TO_CLOSED_0.ContainsKey(symbol_7))) {
                stack_5 = (Enumerable.ToArray(Enumerable.Append<string>(stack_5, symbol_7)));
            } else if ((((symbol_7 == ")") || (symbol_7 == "]")) || (symbol_7 == "}"))) {
                if ((stack_5.Length == 0)) {
                    return false;
                }
                string top_8 = stack_5[(int)((stack_5.Length - 1))];

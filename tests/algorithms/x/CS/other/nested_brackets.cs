...
class Program {
    ...
    public static string[] slice_without_last(string[] xs_1) {
        ...
        while ((i_3 < (xs_1.Length - 1))) {
            res_2 = ((Func<string[]>)(() => { var _tmp = res_2.Cast<string>().ToList(); _tmp.Add(_idx(xs_1, i_3)); return _tmp.ToArray(); }))();
            i_3 = (i_3 + 1);
        };
        return res_2;
    }
    ...
    public static bool is_balanced(string s_4) {
        ...
        while ((i_6 < s_4.Length)) {
            ...
            if ((OPEN_TO_CLOSED_0.ContainsKey(symbol_7))) {
                stack_5 = ((Func<string[]>)(() => { var _tmp = stack_5.Cast<string>().ToList(); _tmp.Add(symbol_7); return _tmp.ToArray(); }))();

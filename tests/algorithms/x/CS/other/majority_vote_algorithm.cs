// Generated by Mochi 0.10.69 (commit 582ddaf78e) on 2025-08-19 09:22 +0700
    ...
    public static long[] majority_vote(long[] votes_3, long votes_needed_to_win_4) {
        ...
        while ((i_7 < votes_3.Length)) {
            ...
            if ((idx_9 != -1)) {
                ...
                candidates_5 = ((Func<long[]>)(() => { var _tmp = candidates_5.Cast<long>().ToList(); _tmp.Add(v_8); return _tmp.ToArray(); }))();
                counts_6 = ((Func<long[]>)(() => { var _tmp = counts_6.Cast<long>().ToList(); _tmp.Add(1); return _tmp.ToArray(); }))();
            } else {
                long j_10 = 0;
                ...
                while ((j_10 < candidates_5.Length)) {
                    if ((_idx(counts_6, j_10) > 0)) {
                        new_candidates_11 = ((Func<long[]>)(() => { var _tmp = new_candidates_11.Cast<long>().ToList(); _tmp.Add(_idx(candidates_5, j_10)); return _tmp.ToArray(); }))();
                        new_counts_12 = ((Func<long[]>)(() => { var _tmp = new_counts_12.Cast<long>().ToList(); _tmp.Add(_idx(counts_6, j_10)); return _tmp.ToArray(); }))();
                    }
                    j_10 = (j_10 + 1);
                }
        ...
        while ((j_14 < candidates_5.Length)) {
            final_counts_13 = ((Func<long[]>)(() => { var _tmp = final_counts_13.Cast<long>().ToList(); _tmp.Add(0); return _tmp.ToArray(); }))();
            j_14 = (j_14 + 1);
        };
        i_7 = 0;
        while ((i_7 < votes_3.Length)) {
        ...
        while ((j_14 < candidates_5.Length)) {
            if (((_idx(final_counts_13, j_14) * votes_needed_to_win_4) > votes_3.Length)) {
                result_17 = ((Func<long[]>)(() => { var _tmp = result_17.Cast<long>().ToList(); _tmp.Add(_idx(candidates_5, j_14)); return _tmp.ToArray(); }))();
            }
            j_14 = (j_14 + 1);
        };
        return result_17;

    ...
    public static long[] majority_vote(long[] votes_3, long votes_needed_to_win_4) {
            ...
            if ((idx_9 != (0 - 1))) {
                ...
                while ((j_10 < candidates_5.Length)) {
                    if ((_idx(counts_6, j_10) > 0)) {
                        new_candidates_11 = (Enumerable.ToArray(Enumerable.Append<long>(new_candidates_11, _idx(candidates_5, j_10))));
                        new_counts_12 = (Enumerable.ToArray(Enumerable.Append<long>(new_counts_12, _idx(counts_6, j_10))));
                    }
                    j_10 = (j_10 + 1);
                }
        ...
        while ((j_14 < candidates_5.Length)) {
            if (((_idx(final_counts_13, j_14) * votes_needed_to_win_4) > votes_3.Length)) {
                result_17 = (Enumerable.ToArray(Enumerable.Append<long>(result_17, _idx(candidates_5, j_14))));
            }
            j_14 = (j_14 + 1);
        };
        return result_17;

...
class Program {
    ...
    public static object[] alternative_list_arrange(object[] first_3, object[] second_4) {
        ...
        while ((i_9 < abs_len_7)) {
            if ((i_9 < len1_5)) {
                result_8 = ((Func<object[]>)(() => { var _tmp = result_8.Cast<object>().ToList(); _tmp.Add((object)((dynamic)first_3)[i_9]); return _tmp.ToArray(); }))();
            }
            if ((i_9 < len2_6)) {
                result_8 = ((Func<object[]>)(() => { var _tmp = result_8.Cast<object>().ToList(); _tmp.Add((object)((dynamic)second_4)[i_9]); return _tmp.ToArray(); }))();
            }
            i_9 = (i_9 + 1);
        };
        return result_8;

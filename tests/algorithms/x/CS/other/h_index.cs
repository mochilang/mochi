...
class Program {
    ...
    public static long[] subarray(long[] xs_0, long start_1, long end_2) {
        ...
        long k_4 = start_1;
        while ((k_4 < end_2)) {
            result_3 = ((Func<long[]>)(() => { var _tmp = result_3.Cast<long>().ToList(); _tmp.Add(_idx(xs_0, k_4)); return _tmp.ToArray(); }))();
            k_4 = (k_4 + 1);
        };
        return result_3;
    }
    ...
    public static long[] merge(long[] left_half_5, long[] right_half_6) {
        ...
        while (((i_8 < left_half_5.Length) && (j_9 < right_half_6.Length))) {
            if ((_idx(left_half_5, i_8) < _idx(right_half_6, j_9))) {
                result_7 = ((Func<long[]>)(() => { var _tmp = result_7.Cast<long>().ToList(); _tmp.Add(_idx(left_half_5, i_8)); return _tmp.ToArray(); }))();
                i_8 = (i_8 + 1);
            } else {
                result_7 = ((Func<long[]>)(() => { var _tmp = result_7.Cast<long>().ToList(); _tmp.Add(_idx(right_half_6, j_9)); return _tmp.ToArray(); }))();
                j_9 = (j_9 + 1);
            }
        };
    ...
    public static long[] merge_sort(long[] array_10) {
        ...
        long middle_11 = _floordiv(array_10.Length, 2);

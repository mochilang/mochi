...
class Program {
    ...
    public static DoubleLinkedList new_list() {
        ...
        nodes_0 = ((Func<Node[]>)(() => { var _tmp = nodes_0.ToList(); _tmp.Add(head_1); return _tmp.ToArray(); }))();
        nodes_0 = ((Func<Node[]>)(() => { var _tmp = nodes_0.ToList(); _tmp.Add(tail_2); return _tmp.ToArray(); }))();
    ...
    public static LRUCache lru_put(LRUCache c_28, long key_29, long value_30) {
        ...
        if ((!(cache_31.cache.ContainsKey(key_str_32)))) {
            ...
            nodes_38 = ((Func<Node[]>)(() => { var _tmp = nodes_38.ToList(); _tmp.Add(new_node_39); return _tmp.ToArray(); }))();

...
class Program {
    ...
    public static Entry[] remove_lfu(Entry[] entries_13) {
        ...
        while ((j_19 < entries_13.Length)) {
            if ((j_19 != min_idx_14)) {
                res_18 = ((Func<Entry[]>)(() => { var _tmp = res_18.Cast<Entry>().ToList(); _tmp.Add(_idx(entries_13, j_19)); return _tmp.ToArray(); }))();
            }
            j_19 = (j_19 + 1);
        };
        return res_18;
    ...
    public static LFUCache lfu_put(LFUCache cache_20, long key_21, long value_22) {
        ...
        entries_23 = ((Func<Entry[]>)(() => { var _tmp = entries_23.Cast<Entry>().ToList(); _tmp.Add(new_entry_28); return _tmp.ToArray(); }))();

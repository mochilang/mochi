...
class Program {
    ...
    public static WordSearch make_word_search(string[] words_8, long width_9, long height_10) {
        ...
        while ((r_12 < height_10)) {
            ...
            long c_14 = 0;
            while ((c_14 < width_9)) {
                row_13 = ((Func<string[]>)(() => { var _tmp = row_13.Cast<string>().ToList(); _tmp.Add(""); return _tmp.ToArray(); }))();
                c_14 = (c_14 + 1);
            }
            board_11 = ((Func<string[][]>)(() => { var _tmp = board_11.Cast<string[]>().ToList(); _tmp.Add(row_13); return _tmp.ToArray(); }))();
            r_12 = (r_12 + 1);
        };
    ...
    public static bool insert_dir(WordSearch ws_15, string word_16, long dr_17, long dc_18, long[] rows_19, long[] cols_20) {
        ...
        while ((ri_22 < rows_19.Length)) {
            long row_23 = _idx(rows_19, ri_22);
            long ci_24 = 0;
            while ((ci_24 < cols_20.Length)) {
                long col_25 = _idx(cols_20, ci_24);
                ...
                while ((k_28 < word_len_21)) {
                    ...
                    if ((_idx(_idx(ws_15.board, rr_30), cc_31) != "")) {
                        ok_29 = false;
                        break;
                    }
                    k_28 = (k_28 + 1);
                ...
                if (ok_29) {
                    ...
                    while ((k_28 < word_len_21)) {
                        ...
                        string[] row_list_34 = _idx(ws_15.board, rr2_32);
                        row_list_34[(int)(cc2_33)] = _substr(word_16, k_28, (k_28 + 1));
                        k_28 = (k_28 + 1);
                    }
                    return true;
                }
    ...
    public static void generate_board(WordSearch ws_35) {
        ...
        while ((i_38 < ws_35.words.Length)) {
            string word_39 = _idx(ws_35.words, i_38);
            long[] rows_40 = new long[]{};
            long r_41 = 0;
            while ((r_41 < ws_35.height)) {
                rows_40 = ((Func<long[]>)(() => { var _tmp = rows_40.Cast<long>().ToList(); _tmp.Add(r_41); return _tmp.ToArray(); }))();
                r_41 = (r_41 + 1);
            }
            long[] cols_42 = new long[]{};
            long c_43 = 0;
            while ((c_43 < ws_35.width)) {
                cols_42 = ((Func<long[]>)(() => { var _tmp = cols_42.Cast<long>().ToList(); _tmp.Add(c_43); return _tmp.ToArray(); }))();
                c_43 = (c_43 + 1);
            }
            rows_40 = Program.shuffle(rows_40);
            cols_42 = Program.shuffle(cols_42);
            long d_44 = Program.rand_range(8);
            Program.insert_dir(ws_35, word_39, _idx(dirs_r_36, d_44), _idx(dirs_c_37, d_44), rows_40, cols_42);
            i_38 = (i_38 + 1);
        };
    }
    ...
    public static string visualise(WordSearch ws_45, bool add_fake_chars_46) {
        ...
        while ((r_48 < ws_45.height)) {
            ...
            while ((c_49 < ws_45.width)) {
                string ch_50 = _idx(_idx(ws_45.board, r_48), c_49);
                if ((ch_50 == "")) {

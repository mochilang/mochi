...
class Program {
    ...
    public static WordSearch make_word_search(string[] words_8, long width_9, long height_10) {
        ...
        while ((r_12 < height_10)) {
            ...
            long c_14 = 0;
            while ((c_14 < width_9)) {
                row_13 = ((Func<string[]>)(() => { var _tmp = row_13.ToList(); _tmp.Add(""); return _tmp.ToArray(); }))();
                c_14 = (c_14 + 1);
            }
            board_11 = ((Func<string[][]>)(() => { var _tmp = board_11.ToList(); _tmp.Add(row_13); return _tmp.ToArray(); }))();
            r_12 = (r_12 + 1);
        };
    ...
    public static void generate_board(WordSearch ws_35) {
        ...
        while ((i_38 < ws_35.words.Length)) {
            ...
            while ((r_41 < ws_35.height)) {
                rows_40 = ((Func<long[]>)(() => { var _tmp = rows_40.ToList(); _tmp.Add(r_41); return _tmp.ToArray(); }))();
                r_41 = (r_41 + 1);
            }
            long[] cols_42 = new long[]{};
            long c_43 = 0;
            while ((c_43 < ws_35.width)) {
                cols_42 = ((Func<long[]>)(() => { var _tmp = cols_42.ToList(); _tmp.Add(c_43); return _tmp.ToArray(); }))();
                c_43 = (c_43 + 1);
            }

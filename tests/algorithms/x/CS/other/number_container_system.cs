...
class Program {
    ...
    public static long[] remove_at(long[] xs_0, long idx_1) {
        ...
        while ((i_3 < xs_0.Length)) {
            if ((i_3 != idx_1)) {
                res_2 = ((Func<long[]>)(() => { var _tmp = res_2.Cast<long>().ToList(); _tmp.Add(_idx(xs_0, i_3)); return _tmp.ToArray(); }))();
            }
            i_3 = (i_3 + 1);
        };
        return res_2;
    ...
    public static long[] insert_at(long[] xs_4, long idx_5, long val_6) {
        ...
        while ((i_8 < xs_4.Length)) {
            if ((i_8 == idx_5)) {
                res_7 = ((Func<long[]>)(() => { var _tmp = res_7.Cast<long>().ToList(); _tmp.Add(val_6); return _tmp.ToArray(); }))();
            }
            res_7 = ((Func<long[]>)(() => { var _tmp = res_7.Cast<long>().ToList(); _tmp.Add(_idx(xs_4, i_8)); return _tmp.ToArray(); }))();
            i_8 = (i_8 + 1);
        };
    ...
    public static long[] binary_search_delete(long[] array_9, long item_10) {
        ...
        while ((low_11 <= high_12)) {
            long mid_14 = _floordiv((low_11 + high_12), 2);
    ...
    public static long[] binary_search_insert(long[] array_15, long index_16) {
        ...
        while ((low_17 <= high_18)) {
            long mid_20 = _floordiv((low_17 + high_18), 2);

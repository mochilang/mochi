...
class Program {
    ...
    public static Thing[] build_menu(string[] names_4, double[] values_5, double[] weights_6) {
        ...
        while ((((i_8 < values_5.Length) && (i_8 < names_4.Length)) && (i_8 < weights_6.Length))) {
            menu_7 = ((Func<Thing[]>)(() => { var _tmp = menu_7.ToList(); _tmp.Add(new Thing{name = _idx(names_4, i_8), value = _idx(values_5, i_8), weight = _idx(weights_6, i_8)}); return _tmp.ToArray(); }))();
            i_8 = (i_8 + 1);
        };
        return menu_7;
    }
    ...
    public static Thing[] sort_desc(Thing[] items_9, Func<Thing, double> key_func_10) {
        ...
        while ((i_12 < items_9.Length)) {
            arr_11 = ((Func<Thing[]>)(() => { var _tmp = arr_11.ToList(); _tmp.Add(_idx(items_9, i_12)); return _tmp.ToArray(); }))();
            i_12 = (i_12 + 1);
        };
        long j_13 = 1;
        while ((j_13 < arr_11.Length)) {
            ...
            long k_16 = (j_13 - 1);
            while (((k_16 >= 0) && (string.Compare(Convert.ToString(key_func_10(_idx(arr_11, k_16))), Convert.ToString(key_val_15)) < 0))) {
    ...
    public static GreedyResult greedy(Thing[] items_17, double max_cost_18, Func<Thing, double> key_func_19) {
        ...
        while ((i_24 < items_copy_20.Length)) {
            ...
            if (((total_cost_23 + w_26) <= max_cost_18)) {
                result_21 = ((Func<Thing[]>)(() => { var _tmp = result_21.ToList(); _tmp.Add(it_25); return _tmp.ToArray(); }))();

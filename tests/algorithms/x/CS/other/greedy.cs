...
class Program {
    ...
    public static Thing[] build_menu(string[] names_4, double[] values_5, double[] weights_6) {
        ...
        while ((((i_8 < values_5.Length) && (i_8 < names_4.Length)) && (i_8 < weights_6.Length))) {
            menu_7 = (Enumerable.ToArray(Enumerable.Append<Thing>(menu_7, new Thing{name = _idx(names_4, i_8), value = _idx(values_5, i_8), weight = _idx(weights_6, i_8)})));
            i_8 = (i_8 + 1);
        };
        return menu_7;
    }
    ...
    public static Thing[] sort_desc(Thing[] items_9, Func<Thing, double> key_func_10) {
        ...
        while ((i_12 < items_9.Length)) {
            arr_11 = (Enumerable.ToArray(Enumerable.Append<Thing>(arr_11, _idx(items_9, i_12))));
            i_12 = (i_12 + 1);
        };
        long j_13 = 1;

...
class Program {
    ...
    public static string get_week_day(long year_3, long month_4, long day_5) {
        ...
        long century_6 = _floordiv(year_3, 100);
        long century_anchor_7 = _mod(((5 * _mod(century_6, 4)) + 2), 7);
        long centurian_8 = _mod(year_3, 100);
        long centurian_m_9 = _mod(centurian_8, 12);
        long dooms_day_10 = _mod((((_floordiv(centurian_8, 12) + centurian_m_9) + _floordiv(centurian_m_9, 4)) + century_anchor_7), 7);
        long day_anchor_11 = (((_mod(year_3, 4) != 0) || ((centurian_8 == 0) && (_mod(year_3, 400) != 0))) ? _idx(DOOMSDAY_NOT_LEAP_1, (month_4 - 1)) : _idx(DOOMSDAY_LEAP_0, (month_4 - 1)));

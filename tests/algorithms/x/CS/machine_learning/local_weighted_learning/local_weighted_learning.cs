...
class Program {
    ...
    public static double[][] transpose(double[][] mat_5) {
        ...
        while ((i_9 < cols_7)) {
            ...
            long j_11 = 0;
            while ((j_11 < rows_6)) {
                row_10 = (Enumerable.ToArray(Enumerable.Append<double>(row_10, mat_5[(int)(j_11)][(int)(i_9)])));
                j_11 = (j_11 + 1);
            }
    ...
    public static double[][] matMul(double[][] a_12, double[][] b_13) {
        ...
        long a_cols_15 = a_12[(int)(0)].Length;
        long b_cols_16 = b_13[(int)(0)].Length;
    ...
    public static double[][] matInv(double[][] mat_23) {
        ...
        while ((i_26 < n_24)) {
            ...
            long j_28 = 0;
            while ((j_28 < n_24)) {
                row_27 = (Enumerable.ToArray(Enumerable.Append<double>(row_27, mat_23[(int)(i_26)][(int)(j_28)])));
                j_28 = (j_28 + 1);
            }
            j_28 = 0;
            while ((j_28 < n_24)) {
        ...
        long col_29 = 0;
        while ((col_29 < n_24)) {
            double pivot_30 = aug_25[(int)(col_29)][(int)(col_29)];
            if ((pivot_30 == 0.0)) {
                throw new Exception("Matrix is singular");
            }
            long j_31 = 0;
            while ((j_31 < (2 * n_24))) {
                aug_25[(int)(col_29)][j_31] = (aug_25[(int)(col_29)][(int)(j_31)] / pivot_30);
                j_31 = (j_31 + 1);
            }
            long r_32 = 0;
            while ((r_32 < n_24)) {
                if ((r_32 != col_29)) {
                    double factor_33 = aug_25[(int)(r_32)][(int)(col_29)];
                    j_31 = 0;
                    while ((j_31 < (2 * n_24))) {
                        aug_25[(int)(r_32)][j_31] = (aug_25[(int)(r_32)][(int)(j_31)] - (factor_33 * aug_25[(int)(col_29)][(int)(j_31)]));
                        j_31 = (j_31 + 1);
                    }
                }
                r_32 = (r_32 + 1);
        ...
        while ((i_26 < n_24)) {
            ...
            long j_36 = 0;
            while ((j_36 < n_24)) {
                row_35 = (Enumerable.ToArray(Enumerable.Append<double>(row_35, aug_25[(int)(i_26)][(int)((j_36 + n_24))])));
                j_36 = (j_36 + 1);
            }
    ...
    public static double[][] weight_matrix(double[] point_37, double[][] x_train_38, double tau_39) {
        ...
        while ((j_45 < m_40)) {
            ...
            while ((k_47 < point_37.Length)) {
                double diff_48 = (point_37[(int)(k_47)] - x_train_38[(int)(j_45)][(int)(k_47)]);
                diff_sq_46 = (diff_sq_46 + (diff_48 * diff_48));
                k_47 = (k_47 + 1);
            }
            weights_41[(int)(j_45)][j_45] = Program.expApprox((-diff_sq_46 / ((2.0 * tau_39) * tau_39)));
            j_45 = (j_45 + 1);
        };
        return weights_41;
    }
    ...
    public static double[][] local_weight(double[] point_49, double[][] x_train_50, double[] y_train_51, double tau_52) {
        ...
        while ((i_59 < y_train_51.Length)) {
            y_col_58 = (Enumerable.ToArray(Enumerable.Append<double[]>(y_col_58, new double[]{y_train_51[(int)(i_59)]})));
            i_59 = (i_59 + 1);
        };
    ...
    public static double[] local_weight_regression(double[][] x_train_61, double[] y_train_62, double tau_63) {
        ...
        long i_66 = 0;
        while ((i_66 < m_64)) {
            double[][] theta_67 = Program.local_weight(x_train_61[(int)(i_66)], x_train_61, y_train_62, tau_63);
            double[] weights_vec_68 = new double[]{};
            long k_69 = 0;
            while ((k_69 < theta_67.Length)) {
                weights_vec_68 = (Enumerable.ToArray(Enumerable.Append<double>(weights_vec_68, theta_67[(int)(k_69)][(int)(0)])));
                k_69 = (k_69 + 1);
            }
            double pred_70 = 0.0;
            long j_71 = 0;
            while ((j_71 < x_train_61[(int)(i_66)].Length)) {
                pred_70 = (pred_70 + (x_train_61[(int)(i_66)][(int)(j_71)] * weights_vec_68[(int)(j_71)]));
                j_71 = (j_71 + 1);
            }

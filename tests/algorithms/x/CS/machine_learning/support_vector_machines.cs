...
class Program {
    ...
    public static double dot(double[] a_0, double[] b_1) {
        ...
        while ((i_3 < a_0.Length)) {
            s_2 = (s_2 + (a_0[(int)(i_3)] * b_1[(int)(i_3)]));
            i_3 = (i_3 + 1);
        };
        return s_2;
    }
    ...
    public static SVC fit(SVC model_7, double[][] xs_8, long[] ys_9) {
        long n_features_10 = xs_8[(int)(0)].Length;
        ...
        while ((epoch_14 < model_7.epochs)) {
            ...
            while ((j_15 < xs_8.Length)) {
                double[] x_16 = xs_8[(int)(j_15)];
                double y_17 = Convert.ToDouble(ys_9[(int)(j_15)]);
                double prod_18 = (Program.dot(w_11, x_16) + b_13);
                if (((y_17 * prod_18) < 1.0)) {
                    long k_19 = 0;
                    while ((k_19 < w_11.Length)) {
                        w_11[k_19] = (w_11[(int)(k_19)] + (model_7.lr * ((y_17 * x_16[(int)(k_19)]) - ((2.0 * model_7.lambda) * w_11[(int)(k_19)]))));
                        k_19 = (k_19 + 1);
                    }
                    ...
                    while ((k_20 < w_11.Length)) {
                        w_11[k_20] = (w_11[(int)(k_20)] - (model_7.lr * ((2.0 * model_7.lambda) * w_11[(int)(k_20)])));
                        k_20 = (k_20 + 1);
                    }
                }
                j_15 = (j_15 + 1);

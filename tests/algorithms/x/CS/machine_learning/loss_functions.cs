...
class Program {
    ...
    public static double powf(double base_9, double exp_10) {
        ...
        long i_12 = 0;
        long n_13 = Convert.ToInt64(exp_10);
        while ((i_12 < n_13)) {
    ...
    public static double exp(double x_21) {
        ...
        long n_24 = 1;
        while ((n_24 < 20)) {
            term_22 = ((term_22 * x_21) / Program.to_float(n_24));
            sum_23 = (sum_23 + term_22);
            n_24 = (n_24 + 1);
        };
        return sum_23;
    }
    ...
    public static double mean(double[] v_25) {
        ...
        while ((i_27 < v_25.Length)) {
            total_26 = (total_26 + v_25[(int)(i_27)]);
            i_27 = (i_27 + 1);
        };
    ...
    public static double binary_cross_entropy(double[] y_true_28, double[] y_pred_29, double epsilon_30) {
        ...
        while ((i_32 < y_true_28.Length)) {
            double yt_33 = y_true_28[(int)(i_32)];
            double yp_34 = Program.clip(y_pred_29[(int)(i_32)], epsilon_30, (1.0 - epsilon_30));
    ...
    public static double binary_focal_cross_entropy(double[] y_true_36, double[] y_pred_37, double gamma_38, double alpha_39, double epsilon_40) {
        ...
        while ((i_42 < y_true_36.Length)) {
            double yt_43 = y_true_36[(int)(i_42)];
            double yp_44 = Program.clip(y_pred_37[(int)(i_42)], epsilon_40, (1.0 - epsilon_40));
    ...
    public static double categorical_cross_entropy(double[][] y_true_47, double[][] y_pred_48, double epsilon_49) {
        ...
        long i_52 = 0;
        while ((i_52 < rows_50)) {
            if ((y_true_47[(int)(i_52)].Length != y_pred_48[(int)(i_52)].Length)) {
                throw new Exception("Input arrays must have the same shape.");
            }
            double sum_true_53 = 0.0;
            double sum_pred_54 = 0.0;
            long j_55 = 0;
            while ((j_55 < y_true_47[(int)(i_52)].Length)) {
                double yt_56 = y_true_47[(int)(i_52)][(int)(j_55)];
                double yp_57 = y_pred_48[(int)(i_52)][(int)(j_55)];
            ...
            j_55 = 0;
            while ((j_55 < y_true_47[(int)(i_52)].Length)) {
                double yp_58 = Program.clip(y_pred_48[(int)(i_52)][(int)(j_55)], epsilon_49, 1.0);
                total_51 = (total_51 - (y_true_47[(int)(i_52)][(int)(j_55)] * Program.ln(yp_58)));
                j_55 = (j_55 + 1);
            }
            i_52 = (i_52 + 1);
        };
    ...
    public static double categorical_focal_cross_entropy(double[][] y_true_59, double[][] y_pred_60, double[] alpha_61, double gamma_62, double epsilon_63) {
        ...
        long cols_65 = y_true_59[(int)(0)].Length;
        ...
        long i_70 = 0;
        while ((i_70 < rows_64)) {
            if (((y_true_59[(int)(i_70)].Length != cols_65) || (y_pred_60[(int)(i_70)].Length != cols_65))) {
                throw new Exception("Shape of y_true and y_pred must be the same.");
            }
            ...
            long j_73 = 0;
            while ((j_73 < cols_65)) {
                double yt_74 = y_true_59[(int)(i_70)][(int)(j_73)];
                double yp_75 = y_pred_60[(int)(i_70)][(int)(j_73)];
            ...
            j_73 = 0;
            while ((j_73 < cols_65)) {
                double yp_77 = Program.clip(y_pred_60[(int)(i_70)][(int)(j_73)], epsilon_63, 1.0);
                row_loss_76 = (row_loss_76 + (((a_66[(int)(j_73)] * Program.powf((1.0 - yp_77), gamma_62)) * y_true_59[(int)(i_70)][(int)(j_73)]) * Program.ln(yp_77)));
                j_73 = (j_73 + 1);
            }
    ...
    public static double huber_loss(double[] y_true_85, double[] y_pred_86, double delta_87) {
        ...
        while ((i_89 < y_true_85.Length)) {
            double diff_90 = (y_true_85[(int)(i_89)] - y_pred_86[(int)(i_89)]);
    ...
    public static double mean_squared_error(double[] y_true_92, double[] y_pred_93) {
        ...
        while ((i_95 < y_true_92.Length)) {
            double diff_96 = (y_true_92[(int)(i_95)] - y_pred_93[(int)(i_95)]);
    ...
    public static double mean_absolute_error(double[] y_true_97, double[] y_pred_98) {
        ...
        while ((i_100 < y_true_97.Length)) {
            total_99 = (total_99 + Program.absf((y_true_97[(int)(i_100)] - y_pred_98[(int)(i_100)])));
            i_100 = (i_100 + 1);
        };
    ...
    public static double mean_squared_logarithmic_error(double[] y_true_101, double[] y_pred_102) {
        ...
        while ((i_104 < y_true_101.Length)) {
            double a_105 = Program.ln((1.0 + y_true_101[(int)(i_104)]));
            double b_106 = Program.ln((1.0 + y_pred_102[(int)(i_104)]));
    ...
    public static double mean_absolute_percentage_error(double[] y_true_108, double[] y_pred_109, double epsilon_110) {
        ...
        while ((i_112 < y_true_108.Length)) {
            double yt_113 = y_true_108[(int)(i_112)];
            if ((yt_113 == 0.0)) {
                yt_113 = epsilon_110;
            }
            total_111 = (total_111 + Program.absf(((yt_113 - y_pred_109[(int)(i_112)]) / yt_113)));
            i_112 = (i_112 + 1);
        };
    ...
    public static double perplexity_loss(long[][] y_true_114, double[][][] y_pred_115, double epsilon_116) {
        ...
        long sentence_len_118 = y_true_114[(int)(0)].Length;
        if ((sentence_len_118 != y_pred_115[(int)(0)].Length)) {
            throw new Exception("Sentence length of y_true and y_pred must be equal.");
        };
        long vocab_size_119 = y_pred_115[(int)(0)][(int)(0)].Length;
        long b_120 = 0;
        double total_perp_121 = 0.0;
        while ((b_120 < batch_117)) {
            if (((y_true_114[(int)(b_120)].Length != sentence_len_118) || (y_pred_115[(int)(b_120)].Length != sentence_len_118))) {
                throw new Exception("Sentence length of y_true and y_pred must be equal.");
            }
            double sum_log_122 = 0.0;
            long j_123 = 0;
            while ((j_123 < sentence_len_118)) {
                long label_124 = y_true_114[(int)(b_120)][(int)(j_123)];
                if ((label_124 >= vocab_size_119)) {
                    throw new Exception("Label value must not be greater than vocabulary size.");
                }
                double prob_125 = Program.clip(y_pred_115[(int)(b_120)][(int)(j_123)][(int)(label_124)], epsilon_116, 1.0);
    ...
    public static double smooth_l1_loss(double[] y_true_128, double[] y_pred_129, double beta_130) {
        ...
        while ((i_132 < y_true_128.Length)) {
            double diff_133 = Program.absf((y_true_128[(int)(i_132)] - y_pred_129[(int)(i_132)]));
    ...
    public static double kullback_leibler_divergence(double[] y_true_134, double[] y_pred_135) {
        ...
        while ((i_137 < y_true_134.Length)) {
            total_136 = (total_136 + (y_true_134[(int)(i_137)] * Program.ln((y_true_134[(int)(i_137)] / y_pred_135[(int)(i_137)]))));
            i_137 = (i_137 + 1);
        };
        return total_136;
    }

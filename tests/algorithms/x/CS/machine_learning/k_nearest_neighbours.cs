...
class Program {
    ...
    public static KNN make_knn(double[][] train_data_3, long[] train_target_4, string[] class_labels_5) {
        ...
        while ((i_7 < train_data_3.Length)) {
            PointLabel pl_8 = new PointLabel{point = train_data_3[(int)(i_7)], label = train_target_4[(int)(i_7)]};
    ...
    public static double euclidean_distance(double[] a_9, double[] b_10) {
        ...
        while ((i_12 < a_9.Length)) {
            double diff_13 = (a_9[(int)(i_12)] - b_10[(int)(i_12)]);
    ...
    public static string classify(KNN knn_14, double[] pred_point_15, long k_16) {
        ...
        while ((i_18 < knn_14.data.Length)) {
            double d_19 = Program.euclidean_distance(knn_14.data[(int)(i_18)].point, pred_point_15);
            distances_17 = (Enumerable.ToArray(Enumerable.Append<DistLabel>(distances_17, new DistLabel{dist = d_19, label = knn_14.data[(int)(i_18)].label})));
            i_18 = (i_18 + 1);
        };
        ...
        while ((count_21 < k_16)) {
            ...
            while ((j_23 < distances_17.Length)) {
                if ((distances_17[(int)(j_23)].dist < distances_17[(int)(min_index_22)].dist)) {
                    min_index_22 = j_23;
                }
                j_23 = (j_23 + 1);
            }
            votes_20 = (Enumerable.ToArray(Enumerable.Append<long>(votes_20, distances_17[(int)(min_index_22)].label)));
            distances_17[(int)(min_index_22)].dist = 1;
            e18;
            count_21 = (count_21 + 1);
        };
        ...
        while ((v_26 < votes_20.Length)) {
            long lbl_27 = votes_20[(int)(v_26)];
            tally_24[lbl_27] = (tally_24[(int)(lbl_27)] + 1);
            v_26 = (v_26 + 1);
        };
        long max_idx_28 = 0;
        long m_29 = 1;
        while ((m_29 < tally_24.Length)) {
            if ((tally_24[(int)(m_29)] > tally_24[(int)(max_idx_28)])) {
                max_idx_28 = m_29;
            }
            m_29 = (m_29 + 1);
        };
        return knn_14.labels[(int)(max_idx_28)];
    }

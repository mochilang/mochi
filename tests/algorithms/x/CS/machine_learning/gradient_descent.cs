...
class Program {
    ...
    public static double hypothesis_value(double[] input_1, double[] params_2) {
        double value_3 = params_2[(int)(0)];
        long i_4 = 0;
        while ((i_4 < input_1.Length)) {
            value_3 = (value_3 + (input_1[(int)(i_4)] * params_2[(int)((i_4 + 1))]));
            i_4 = (i_4 + 1);
        };
        return value_3;
    }
    ...
    public static double summation_of_cost_derivative(long index_7, double[] params_8, DataPoint[] data_9) {
        ...
        while ((i_11 < data_9.Length)) {
            DataPoint dp_12 = data_9[(int)(i_11)];
            double e_13 = Program.calc_error(dp_12, params_8);
            if ((index_7 == -1)) {
                sum_10 = (sum_10 + e_13);
            } else {
                sum_10 = (sum_10 + (e_13 * dp_12.x[(int)(index_7)]));
            }
            i_11 = (i_11 + 1);
        };
        return sum_10;
    ...
    public static bool allclose(double[] a_17, double[] b_18, double atol_19, double rtol_20) {
        ...
        while ((i_21 < a_17.Length)) {
            double diff_22 = Program.absf((a_17[(int)(i_21)] - b_18[(int)(i_21)]));
            double limit_23 = (atol_19 + (rtol_20 * Program.absf(b_18[(int)(i_21)])));
            if ((diff_22 > limit_23)) {
                return false;
            }
            i_21 = (i_21 + 1);
    ...
    public static double[] run_gradient_descent(DataPoint[] train_data_24, double[] initial_params_25) {
        double learning_rate_26 = 0.009;
        double absolute_error_limit_27 = 2e-06;
        ...
        while (true) {
            ...
            while ((i_32 < params_30.Length)) {
                ...
                temp_31 = (Enumerable.ToArray(Enumerable.Append<double>(temp_31, (params_30[(int)(i_32)] - (learning_rate_26 * deriv_33)))));
                i_32 = (i_32 + 1);
            }
    ...
    public static void test_gradient_descent(DataPoint[] test_data_34, double[] params_35) {
        ...
        while ((i_36 < test_data_34.Length)) {
            DataPoint dp_37 = test_data_34[(int)(i_36)];

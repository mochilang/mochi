...
class Program {
    ...
    public static double dot(double[] x_0, double[] y_1) {
        ...
        while ((i_3 < x_0.Length)) {
            sum_2 = (sum_2 + (x_0[(int)(i_3)] * y_1[(int)(i_3)]));
            i_3 = (i_3 + 1);
        };
        return sum_2;
    }
    ...
    public static double[] run_steep_gradient_descent(double[][] data_x_4, double[] data_y_5, long len_data_6, double alpha_7, double[] theta_8) {
        ...
        while ((i_11 < len_data_6)) {
            double prediction_12 = Program.dot(theta_8, data_x_4[(int)(i_11)]);
            double error_13 = (prediction_12 - data_y_5[(int)(i_11)]);
            long k_14 = 0;
            while ((k_14 < theta_8.Length)) {
                gradients_9[k_14] = (gradients_9[(int)(k_14)] + (error_13 * data_x_4[(int)(i_11)][(int)(k_14)]));
                k_14 = (k_14 + 1);
            }
            i_11 = (i_11 + 1);
        };
        ...
        while ((g_16 < theta_8.Length)) {
            t_15 = (Enumerable.ToArray(Enumerable.Append<double>(t_15, (theta_8[(int)(g_16)] - ((alpha_7 / len_data_6) * gradients_9[(int)(g_16)])))));
            g_16 = (g_16 + 1);
        };
        return t_15;
    }
    ...
    public static double sum_of_square_error(double[][] data_x_17, double[] data_y_18, long len_data_19, double[] theta_20) {
        ...
        while ((i_22 < len_data_19)) {
            double prediction_23 = Program.dot(theta_20, data_x_17[(int)(i_22)]);
            double diff_24 = (prediction_23 - data_y_18[(int)(i_22)]);
    ...
    public static double[] run_linear_regression(double[][] data_x_25, double[] data_y_26) {
        ...
        long no_features_29 = data_x_25[(int)(0)].Length;
    ...
    public static double mean_absolute_error(double[] predicted_y_36, double[] original_y_37) {
        ...
        while ((i_39 < predicted_y_36.Length)) {
            double diff_40 = Program.absf((predicted_y_36[(int)(i_39)] - original_y_37[(int)(i_39)]));
    ...
    static void Main() {
        {
            ...
            while ((i_44 < theta_43.Length)) {
                Console.WriteLine(Program._fmtTop(_fmtStr(theta_43[(int)(i_44)])));
                i_44 = (i_44 + 1);
            }

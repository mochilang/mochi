...
class Program {
    ...
    public static Point[] get_neighbours(Point p_0, long x_limit_1, long y_limit_2) {
        ...
        foreach (Point d_5 in deltas_3) {
            ...
            if (((((0 <= nx_6) && (nx_6 < x_limit_1)) && (0 <= ny_7)) && (ny_7 < y_limit_2))) {
                neighbours_4 = ((Func<Point[]>)(() => { var _tmp = neighbours_4.ToList(); _tmp.Add(new Point{x = nx_6, y = ny_7}); return _tmp.ToArray(); }))();
            }
        };
        return neighbours_4;
    }
    ...
    public static Point[] astar(long x_limit_14, long y_limit_15, Point start_16, Point goal_17) {
        ...
        open_18 = ((Func<Node[]>)(() => { var _tmp = open_18.ToList(); _tmp.Add(new Node{pos = start_16, parent = new Point{x = (0 - 1), y = (0 - 1)}, g = 0, h = 0, f = 0}); return _tmp.ToArray(); }))();
        ...
        while ((open_18.Length > 0)) {
            ...
            while ((j_24 < open_18.Length)) {
                if ((j_24 != min_index_21)) {
                    new_open_23 = ((Func<Node[]>)(() => { var _tmp = new_open_23.ToList(); _tmp.Add(_idx(open_18, j_24)); return _tmp.ToArray(); }))();
                }
                j_24 = (j_24 + 1);
            }
            open_18 = new_open_23;
            closed_19 = ((Func<Node[]>)(() => { var _tmp = closed_19.ToList(); _tmp.Add(current_20); return _tmp.ToArray(); }))();
            ...
            foreach (Point np_26 in neighbours_25) {
                ...
                open_18 = ((Func<Node[]>)(() => { var _tmp = open_18.ToList(); _tmp.Add(new Node{pos = np_26, parent = current_20.pos, g = g_27, h = h_30, f = f_31}); return _tmp.ToArray(); }))();
            }
        };
        Point[] path_34 = new Point[]{};
        path_34 = ((Func<Point[]>)(() => { var _tmp = path_34.ToList(); _tmp.Add(current_20.pos); return _tmp.ToArray(); }))();
        ...
        while ((k_36 >= 0)) {
            rev_35 = ((Func<Point[]>)(() => { var _tmp = rev_35.ToList(); _tmp.Add(_idx(path_34, k_36)); return _tmp.ToArray(); }))();
            k_36 = (k_36 - 1);
        };
        return rev_35;
    }
    ...
    public static long[][] create_world(long x_limit_37, long y_limit_38) {
        ...
        while ((i_40 < x_limit_37)) {
            ...
            while ((j_42 < y_limit_38)) {
                row_41 = ((Func<long[]>)(() => { var _tmp = row_41.ToList(); _tmp.Add(0); return _tmp.ToArray(); }))();
                j_42 = (j_42 + 1);
            }
            world_39 = ((Func<long[][]>)(() => { var _tmp = world_39.ToList(); _tmp.Add(row_41); return _tmp.ToArray(); }))();
            i_40 = (i_40 + 1);
        };
        return world_39;
    }

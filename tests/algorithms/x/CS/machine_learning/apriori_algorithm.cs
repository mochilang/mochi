// Generated by Mochi 0.10.66 (commit 3822e1fcc8) on 2025-08-14 22:33 +0700
...
class Program {
    ...
    public static string[][] slice_list(string[][] xs_16, long start_17) {
        ...
        while ((i_19 < xs_16.Length)) {
            res_18 = ((Func<string[][]>)(() => { var _tmp = res_18.ToList(); _tmp.Add(_idx(xs_16, i_19)); return _tmp.ToArray(); }))();
            i_19 = (i_19 + 1);
        };
        return res_18;
    }
    ...
    public static string[][][] combinations_lists(string[][] xs_20, long k_21) {
        ...
        if ((k_21 == 0)) {
            result_22 = ((Func<string[][][]>)(() => { var _tmp = result_22.ToList(); _tmp.Add(new string[][]{}); return _tmp.ToArray(); }))();
            return result_22;
        };
        long i_23 = 0;
        while ((i_23 < xs_20.Length)) {
            ...
            foreach (string[][] combo_27 in tail_combos_26) {
                ...
                new_combo_28 = ((Func<string[][]>)(() => { var _tmp = new_combo_28.ToList(); _tmp.Add(head_24); return _tmp.ToArray(); }))();
                foreach (string[] c_29 in combo_27) {
                    new_combo_28 = ((Func<string[][]>)(() => { var _tmp = new_combo_28.ToList(); _tmp.Add(c_29); return _tmp.ToArray(); }))();
                }
                result_22 = ((Func<string[][][]>)(() => { var _tmp = result_22.ToList(); _tmp.Add(new_combo_28); return _tmp.ToArray(); }))();
            }
            i_23 = (i_23 + 1);
        };
        return result_22;
                ...
                foreach (string[] item_38 in candidate_34) {
                    foreach (string s_39 in item_38) {
                        if ((!Program.contains_string(merged_37, s_39))) {
                            merged_37 = ((Func<string[]>)(() => { var _tmp = merged_37.ToList(); _tmp.Add(s_39); return _tmp.ToArray(); }))();
                        }
                    }
                }
                pruned_33 = ((Func<string[][]>)(() => { var _tmp = pruned_33.ToList(); _tmp.Add(merged_37); return _tmp.ToArray(); }))();
            }
        };
        return pruned_33;
    }
    ...
    public static string[] sort_strings(string[] xs_40) {
        ...
        foreach (string s_42 in xs_40) {
            res_41 = ((Func<string[]>)(() => { var _tmp = res_41.ToList(); _tmp.Add(s_42); return _tmp.ToArray(); }))();
        };
        long i_43 = 0;
    ...
    public static Itemset[] apriori(string[][] data_49, long min_support_50) {
        ...
        foreach (string[] transaction_52 in data_49) {
            ...
            foreach (string v_54 in transaction_52) {
                t_53 = ((Func<string[]>)(() => { var _tmp = t_53.ToList(); _tmp.Add(v_54); return _tmp.ToArray(); }))();
            }
            itemset_51 = ((Func<string[][]>)(() => { var _tmp = itemset_51.ToList(); _tmp.Add(t_53); return _tmp.ToArray(); }))();
        };
        ...
        while ((itemset_51.Length > 0)) {
            ...
            while ((idx_58 < itemset_51.Length)) {
                counts_57 = ((Func<long[]>)(() => { var _tmp = counts_57.ToList(); _tmp.Add(0); return _tmp.ToArray(); }))();
                idx_58 = (idx_58 + 1);
            }
            ...
            while ((k_63 < itemset_51.Length)) {
                if ((_idx(counts_57, k_63) >= min_support_50)) {
                    new_itemset_62 = ((Func<string[][]>)(() => { var _tmp = new_itemset_62.ToList(); _tmp.Add(_idx(itemset_51, k_63)); return _tmp.ToArray(); }))();
                }
                k_63 = (k_63 + 1);
            }
            ...
            while ((m_64 < itemset_51.Length)) {
                ...
                frequent_55 = ((Func<Itemset[]>)(() => { var _tmp = frequent_55.ToList(); _tmp.Add(new Itemset{items = sorted_item_65, support = _idx(counts_57, m_64)}); return _tmp.ToArray(); }))();
                m_64 = (m_64 + 1);
            }

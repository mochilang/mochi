...
class Program {
    ...
    public static double[][] standardize(double[][] data_6) {
        ...
        long n_features_8 = data_6[(int)(0)].Length;
        ...
        while ((j_11 < n_features_8)) {
            ...
            while ((i_13 < n_samples_7)) {
                column_12 = (Enumerable.ToArray(Enumerable.Append<double>(column_12, data_6[(int)(i_13)][(int)(j_11)])));
                i_13 = (i_13 + 1);
            }
            ...
            while ((k_16 < n_samples_7)) {
                double diff_17 = (column_12[(int)(k_16)] - m_14);
        ...
        while ((r_19 < n_samples_7)) {
            ...
            while ((c_21 < n_features_8)) {
                row_20 = (Enumerable.ToArray(Enumerable.Append<double>(row_20, ((data_6[(int)(r_19)][(int)(c_21)] - means_9[(int)(c_21)]) / stds_10[(int)(c_21)]))));
                c_21 = (c_21 + 1);
            }
    ...
    public static double[][] covariance_matrix(double[][] data_22) {
        ...
        long n_features_24 = data_22[(int)(0)].Length;
        ...
        while ((i_26 < n_features_24)) {
            ...
            while ((j_28 < n_features_24)) {
                ...
                while ((k_30 < n_samples_23)) {
                    sum_29 = (sum_29 + (data_22[(int)(k_30)][(int)(i_26)] * data_22[(int)(k_30)][(int)(j_28)]));
                    k_30 = (k_30 + 1);
                }
    ...
    public static double[] normalize(double[] vec_31) {
        ...
        while ((i_33 < vec_31.Length)) {
            sum_32 = (sum_32 + (vec_31[(int)(i_33)] * vec_31[(int)(i_33)]));
            i_33 = (i_33 + 1);
        };
        ...
        while ((j_36 < vec_31.Length)) {
            res_35 = (Enumerable.ToArray(Enumerable.Append<double>(res_35, (vec_31[(int)(j_36)] / n_34))));
            j_36 = (j_36 + 1);
        };
        return res_35;
    }
    ...
    public static Eigen eigen_decomposition_2x2(double[][] matrix_37) {
        double a_38 = matrix_37[(int)(0)][(int)(0)];
        double b_39 = matrix_37[(int)(0)][(int)(1)];
        double c_40 = matrix_37[(int)(1)][(int)(1)];
        ...
        if ((eigenvalues_47[(int)(0)] < eigenvalues_47[(int)(1)])) {
            double tmp_val_49 = eigenvalues_47[(int)(0)];
            eigenvalues_47[0] = eigenvalues_47[(int)(1)];
            eigenvalues_47[1] = tmp_val_49;
            double[] tmp_vec_50 = eigenvectors_48[(int)(0)];
            eigenvectors_48[0] = eigenvectors_48[(int)(1)];
            eigenvectors_48[1] = tmp_vec_50;
        };
    ...
    public static double[][] transpose(double[][] matrix_51) {
        ...
        long cols_53 = matrix_51[(int)(0)].Length;
        ...
        while ((i_55 < cols_53)) {
            ...
            long j_57 = 0;
            while ((j_57 < rows_52)) {
                row_56 = (Enumerable.ToArray(Enumerable.Append<double>(row_56, matrix_51[(int)(j_57)][(int)(i_55)])));
                j_57 = (j_57 + 1);
            }
    ...
    public static double[][] matrix_multiply(double[][] a_58, double[][] b_59) {
        ...
        long cols_a_61 = a_58[(int)(0)].Length;
        long rows_b_62 = b_59.Length;
        long cols_b_63 = b_59[(int)(0)].Length;
        ...
        while ((i_65 < rows_a_60)) {
            ...
            while ((j_67 < cols_b_63)) {
                ...
                while ((k_69 < cols_a_61)) {
                    sum_68 = (sum_68 + (a_58[(int)(i_65)][(int)(k_69)] * b_59[(int)(k_69)][(int)(j_67)]));
                    k_69 = (k_69 + 1);
                }
    ...
    public static PCAResult apply_pca(double[][] data_70, long n_components_71) {
        ...
        double total_79 = (eigenvalues_75[(int)(0)] + eigenvalues_75[(int)(1)]);
        double[] ratios_80 = new double[]{};
        long i_81 = 0;
        while ((i_81 < n_components_71)) {
            ratios_80 = (Enumerable.ToArray(Enumerable.Append<double>(ratios_80, (eigenvalues_75[(int)(i_81)] / total_79))));
            i_81 = (i_81 + 1);
        };
    ...
    static void Main() {
        {
            ...
            long idx_84 = 0;
            while ((idx_84 < 5)) {
                Console.WriteLine(Program._fmtTop(result_83.transformed[(int)(idx_84)]));
                idx_84 = (idx_84 + 1);
            }

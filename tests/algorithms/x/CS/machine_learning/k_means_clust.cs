...
class Program {
    ...
    static long k_50 = 3;
    static double[][] initial_centroids_51 = new double[][]{data_49[(int)(0)], data_49[(int)(2)], data_49[(int)(5)]};
    ...
    public static long[] assign_clusters(double[][] data_5, double[][] centroids_6) {
        ...
        for (var i_8 = 0; i_8 < data_5.Length; i_8++) {
            long best_idx_9 = 0;
            double best_10 = Program.distance_sq(data_5[(int)(i_8)], centroids_6[(int)(0)]);
            for (var j_11 = 1; j_11 < centroids_6.Length; j_11++) {
                double dist_12 = Program.distance_sq(data_5[(int)(i_8)], centroids_6[(int)(j_11)]);
                if ((dist_12 < best_10)) {
                    best_10 = dist_12;
                    best_idx_9 = j_11;
                }
    ...
    public static double[][] revise_centroids(double[][] data_13, long k_14, long[] assignment_15) {
        long dim_16 = data_13[(int)(0)].Length;
        ...
        for (var i_22 = 0; i_22 < data_13.Length; i_22++) {
            long c_23 = assignment_15[(int)(i_22)];
            counts_18[c_23] = (counts_18[(int)(c_23)] + 1);
            for (var j_24 = 0; j_24 < dim_16; j_24++) {
                sums_17[(int)(c_23)][j_24] = (sums_17[(int)(c_23)][(int)(j_24)] + data_13[(int)(i_22)][(int)(j_24)]);
            }
        };
        double[][] centroids_25 = new double[][]{};
        for (var i_26 = 0; i_26 < k_14; i_26++) {
            double[] row_27 = new double[]{};
            if ((counts_18[(int)(i_26)] > 0)) {
                for (var j_28 = 0; j_28 < dim_16; j_28++) {
                    row_27 = (Enumerable.ToArray(Enumerable.Append<double>(row_27, (sums_17[(int)(i_26)][(int)(j_28)] / Convert.ToDouble(counts_18[(int)(i_26)])))));
                }
            } else {
    ...
    public static double compute_heterogeneity(double[][] data_30, double[][] centroids_31, long[] assignment_32) {
        ...
        for (var i_34 = 0; i_34 < data_30.Length; i_34++) {
            long c_35 = assignment_32[(int)(i_34)];
            total_33 = (total_33 + Program.distance_sq(data_30[(int)(i_34)], centroids_31[(int)(c_35)]));
        };
        return total_33;
    }
    ...
    public static bool lists_equal(long[] a_36, long[] b_37) {
        ...
        for (var i_38 = 0; i_38 < a_36.Length; i_38++) {
            if ((a_36[(int)(i_38)] != b_37[(int)(i_38)])) {
                return false;
            }
        };
        return true;

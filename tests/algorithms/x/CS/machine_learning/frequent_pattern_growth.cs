    ...
    public static string[] sort_items(string[] items_16, object header_table_17) {
        ...
        while ((i_19 < arr_18.Length)) {
            ...
            while ((j_20 < arr_18.Length)) {
                if ((string.Compare(Convert.ToString(((dynamic)((dynamic)header_table_17)[_idx(arr_18, i_19)])["count"]), Convert.ToString(((dynamic)((dynamic)header_table_17)[_idx(arr_18, j_20)])["count"])) < 0)) {
    ...
    public static string[][] mine_tree(object in_tree_48, object header_table_49, long min_sup_50, string[] pre_fix_51, string[][] freq_item_list_52) {
        ...
        while ((i_57 < sorted_items_56.Length)) {
            ...
            while ((j_58 < sorted_items_56.Length)) {
                if ((string.Compare(Convert.ToString(((dynamic)((dynamic)header_table_49)[((dynamic)sorted_items_56)[i_57]])["count"]), Convert.ToString(((dynamic)((dynamic)header_table_49)[((dynamic)sorted_items_56)[j_58]])["count"])) > 0)) {

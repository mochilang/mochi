...
class Program {
    ...
    public static double euclidean(double[] a_3, double[] b_4) {
        ...
        while ((i_6 < a_3.Length)) {
            double diff_7 = (a_3[(int)(i_6)] - b_4[(int)(i_6)]);
    ...
    public static Neighbor[] similarity_search(double[][] dataset_9, double[][] value_array_10) {
        long dim_11 = dataset_9[(int)(0)].Length;
        if ((dim_11 != value_array_10[(int)(0)].Length)) {
            return new Neighbor[]{};
        };
        Neighbor[] result_12 = new Neighbor[]{};
        long i_13 = 0;
        while ((i_13 < value_array_10.Length)) {
            double[] value_14 = value_array_10[(int)(i_13)];
            double dist_15 = Program.euclidean(value_14, dataset_9[(int)(0)]);
            double[] vec_16 = dataset_9[(int)(0)];
            long j_17 = 1;
            while ((j_17 < dataset_9.Length)) {
                double d_18 = Program.euclidean(value_14, dataset_9[(int)(j_17)]);
                if ((d_18 < dist_15)) {
                    dist_15 = d_18;
                    vec_16 = dataset_9[(int)(j_17)];
                }
                j_17 = (j_17 + 1);
            }
    ...
    public static double cosine_similarity(double[] a_20, double[] b_21) {
        ...
        while ((i_25 < a_20.Length)) {
            dot_22 = (dot_22 + (a_20[(int)(i_25)] * b_21[(int)(i_25)]));
            norm_a_23 = (norm_a_23 + (a_20[(int)(i_25)] * a_20[(int)(i_25)]));
            norm_b_24 = (norm_b_24 + (b_21[(int)(i_25)] * b_21[(int)(i_25)]));
            i_25 = (i_25 + 1);
        };
    ...
    static void Main() {
        {
            ...
            while ((k_29 < neighbors_28.Length)) {
                Neighbor n_30 = neighbors_28[(int)(k_29)];

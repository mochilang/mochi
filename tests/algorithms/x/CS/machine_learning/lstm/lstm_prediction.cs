...
class Program {
    ...
    public static LSTMState forward(double[] seq_7, LSTMWeights w_8) {
        ...
        while ((t_15 < seq_7.Length)) {
            double x_16 = seq_7[(int)(t_15)];
            double h_prev_17 = h_arr_14[(int)(t_15)];
            double c_prev_18 = c_arr_13[(int)(t_15)];
    ...
    public static LSTMWeights backward(double[] seq_25, double target_26, LSTMWeights w_27, LSTMState s_28, double lr_29) {
        ...
        double h_last_45 = s_28.h[(int)(T_44)];
        ...
        long t_50 = (T_44 - 1);
        while ((t_50 >= 0)) {
            double i_t_51 = s_28.i[(int)(t_50)];
            double f_t_52 = s_28.f[(int)(t_50)];
            double o_t_53 = s_28.o[(int)(t_50)];
            double g_t_54 = s_28.g[(int)(t_50)];
            double c_t_55 = s_28.c[(int)((t_50 + 1))];
            double c_prev_56 = s_28.c[(int)(t_50)];
            double h_prev_57 = s_28.h[(int)(t_50)];
    ...
    public static Samples make_samples(double[] data_68, long look_back_69) {
        ...
        while (((i_72 + look_back_69) < data_68.Length)) {
            double[] seq_73 = data_68.Skip((int)(i_72)).Take((int)(((i_72 + look_back_69) - i_72))).ToArray();
            X_70 = (Enumerable.ToArray(Enumerable.Append<double[]>(X_70, seq_73)));
            Y_71 = (Enumerable.ToArray(Enumerable.Append<double>(Y_71, data_68[(int)((i_72 + look_back_69))])));
            i_72 = (i_72 + 1);
        };
    ...
    public static LSTMWeights train(double[] data_74, long look_back_75, long epochs_76, double lr_77) {
        ...
        while ((ep_80 < epochs_76)) {
            ...
            while ((j_81 < samples_78.x.Length)) {
                double[] seq_82 = samples_78.x[(int)(j_81)];
                double target_83 = samples_78.y[(int)(j_81)];
    ...
    public static double predict(double[] seq_85, LSTMWeights w_86) {
        ...
        double h_last_88 = state_87.h[(int)((state_87.h.Length - 1))];

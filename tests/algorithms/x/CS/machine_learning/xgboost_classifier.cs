...
class Program {
    ...
    public static double stump_predict(Stump s_3, double[] x_4) {
        if ((x_4[(int)(s_3.feature)] < s_3.threshold)) {
            return s_3.left;
        };
        return s_3.right;
    }
    ...
    public static Stump train_stump(double[][] features_5, double[] residuals_6) {
        ...
        double best_error_9 = 1e+09;
        double best_left_10 = 0.0;
        double best_right_11 = 0.0;
        long num_features_12 = features_5[(int)(0)].Length;
        long f_13 = 0;
        while ((f_13 < num_features_12)) {
            long i_14 = 0;
            while ((i_14 < features_5.Length)) {
                double threshold_15 = features_5[(int)(i_14)][(int)(f_13)];
                double[] left_16 = new double[]{};
                double[] right_17 = new double[]{};
                long j_18 = 0;
                while ((j_18 < features_5.Length)) {
                    if ((features_5[(int)(j_18)][(int)(f_13)] < threshold_15)) {
                        left_16 = (Enumerable.ToArray(Enumerable.Concat(left_16, new double[]{residuals_6[(int)(j_18)]})));
                    } else {
                        right_17 = (Enumerable.ToArray(Enumerable.Concat(right_17, new double[]{residuals_6[(int)(j_18)]})));
                    }
                    j_18 = (j_18 + 1);
                }
                if (((left_16.Length != 0) && (right_17.Length != 0))) {
                    ...
                    j_18 = 0;
                    while ((j_18 < features_5.Length)) {
                        double pred_22 = ((features_5[(int)(j_18)][(int)(f_13)] < threshold_15) ? left_mean_19 : right_mean_20);
                        double diff_23 = (residuals_6[(int)(j_18)] - pred_22);
    ...
    public static Stump[] boost(double[][] features_24, long[] targets_25, long rounds_26) {
        ...
        while ((r_30 < rounds_26)) {
            ...
            while ((j_32 < targets_25.Length)) {
                residuals_31 = (Enumerable.ToArray(Enumerable.Concat(residuals_31, new double[]{(targets_25[(int)(j_32)] - preds_28[(int)(j_32)])})));
                j_32 = (j_32 + 1);
            }
            ...
            while ((j_32 < preds_28.Length)) {
                preds_28[j_32] = (preds_28[(int)(j_32)] + Program.stump_predict(stump_33, features_24[(int)(j_32)]));
                j_32 = (j_32 + 1);
            }
            r_30 = (r_30 + 1);
        };
    ...
    public static double predict(Stump[] model_34, double[] x_35) {
        ...
        while ((i_37 < model_34.Length)) {
            Stump s_38 = model_34[(int)(i_37)];
            if ((x_35[(int)(s_38.feature)] < s_38.threshold)) {
    ...
    public static void main() {
        ...
        while ((i_43 < features_39.Length)) {
            double s_44 = Program.predict(model_41, features_39[(int)(i_43)]);

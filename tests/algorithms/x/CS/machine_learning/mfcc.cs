...
class Program {
    ...
    public static double[] normalize(double[] audio_25) {
        ...
        while ((i_27 < audio_25.Length)) {
            double v_28 = Program.absf(audio_25[(int)(i_27)]);
            if ((v_28 > max_val_26)) {
                max_val_26 = v_28;
            }
            i_27 = (i_27 + 1);
        ...
        i_27 = 0;
        while ((i_27 < audio_25.Length)) {
            res_29 = (Enumerable.ToArray(Enumerable.Append<double>(res_29, (audio_25[(int)(i_27)] / max_val_26))));
            i_27 = (i_27 + 1);
        };
        return res_29;
    }
    ...
    public static double[] dft(double[] frame_30, long bins_31) {
        ...
        while ((k_34 < bins_31)) {
            ...
            while ((n_37 < N_32)) {
                ...
                real_35 = (real_35 + (frame_30[(int)(n_37)] * Program.cosApprox(angle_38)));
                imag_36 = (imag_36 + (frame_30[(int)(n_37)] * Program.sinApprox(angle_38)));
                n_37 = (n_37 + 1);
            }
    ...
    public static double[] dot(double[][] mat_47, double[] vec_48) {
        ...
        while ((i_50 < mat_47.Length)) {
            ...
            while ((j_52 < vec_48.Length)) {
                sum_51 = (sum_51 + (mat_47[(int)(i_50)][(int)(j_52)] * vec_48[(int)(j_52)]));
                j_52 = (j_52 + 1);
            }
    ...
    public static double[] mfcc(double[] audio_60, long bins_61, long dct_num_62) {
        ...
        while ((i_68 < energies_66.Length)) {
            logfb_67 = (Enumerable.ToArray(Enumerable.Append<double>(logfb_67, (10.0 * Program.log10((energies_66[(int)(i_68)] + 1e-10))))));
            i_68 = (i_68 + 1);
        };

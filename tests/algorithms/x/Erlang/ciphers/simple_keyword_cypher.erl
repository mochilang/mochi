...
create_cipher_map(Key_2) ->
    ...
    case (I_7 < length(Cleaned)) of
        true ->
            Cipher_2 = lists:append(Cipher, [string:substr(Cleaned, I_7 + 1, 1)]),
            I_8 = (I_7 + 1),
...
{Alphabet, Char_2, Cipher_2, Cleaned, I_8, J, Key_2, Offset_2} = Fun_5(Alphabet, Char, Cipher_2, Cleaned, I_8, J, Key_2, Offset),
            Cipher_3 = lists:append(Cipher_2, [Char_2]),
            J_2 = (J + 1),
...
index_in_list(Lst, Ch_6) ->
    ...
    case (I_9 < length(Lst)) of
        true ->
            case ((case erlang:is_map(Lst) of true -> maps:get(I_9, Lst, nil); _ -> lists:nth(I_9 + 1, Lst) end) == Ch_6) of
...
encipher(Message, Cipher_4) ->
    ...
    case (I_11 < length(Msg)) of
        true ->
            Ch_7 = string:substr(Msg, I_11 + 1, 1),
            Idx_2 = index_in_string(Alphabet_2, Ch_7),
            case (Idx_2 >= 0) of
        true -> Res_9 = (Res_8 ++ (case erlang:is_map(Cipher_4) of true -> maps:get(Idx_2, Cipher_4, nil); _ -> lists:nth(Idx_2 + 1, Cipher_4) end)),
            Res_11 = Res_9;
        _ -> Res_10 = (Res_8 ++ Ch_7),
            Res_11 = Res_10
    end,

...
index_of(Xs, Target) ->
    ...
    case (I_3 < length(Xs)) of
        true ->
            case ((case erlang:is_map(Xs) of true -> maps:get(I_3, Xs, nil); _ -> lists:nth(I_3 + 1, Xs) end) == Target) of
...
encrypt(Message) ->
    ...
    case (I_5 < length(Msg)) of
        ...
        _ -> Res_5 = Res_3
            ...
            Res_6 = (Res_5 ++ (case erlang:is_map(erlang:get('CODES')) of true -> maps:get(Idx, erlang:get('CODES'), nil); _ -> lists:nth(Idx + 1, erlang:get('CODES')) end)),
            Res_7 = Res_6;
        _ -> Res_7 = Res_3
    end,
            I_6 = (I_5 + 1),
...
split_spaces(S_2) ->
    ...
    case (I_7 < length(S_2)) of
        ...
        true -> Res_9 = lists:append(Res_8, [Current]),
            Current_2 = "",
            Current_3 = Current_2,
            Res_10 = Res_9;
        _ -> Current_3 = Current,
...
{Current_5, I_8, Res_11, S_2} = Fun_4(Current, I_7, Res_8, S_2),
        case (Current_5 /= "") of
        true -> Res_12 = lists:append(Res_11, [Current_5]),
            Res_13 = Res_12;
        _ -> Res_13 = Res_11
    end,
        Res_13
...
decrypt(Message_2) ->
    ...
    case List of
        ...
        [Code|Code_rest] ->
            ...
            case (Idx_2 >= 0) of
        true -> Res_15 = (Res_14 ++ (case erlang:is_map(erlang:get('CHARS')) of true -> maps:get(Idx_2, erlang:get('CHARS'), nil); _ -> lists:nth(Idx_2 + 1, erlang:get('CHARS')) end)),
            Res_16 = Res_15;
        _ -> Res_16 = Res_14
    end,

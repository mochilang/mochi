...
get_blocks_from_text(Message, Block_size) ->
    ...
    case (Block_start < length(Message)) of
        true ->
            Block_int = 0,
            I_3 = Block_start,
            Fun_3 = fun Fun_3_loop(Block_int, Block_ints, Block_size, Block_start, I_3, Message) ->
    case ((I_3 < (Block_start + Block_size)) andalso (I_3 < length(Message))) of
        true ->
...
{Block_int_2, Block_ints, Block_size, Block_start, I_4, Message} = Fun_3(Block_int, Block_ints, Block_size, Block_start, I_3, Message),
            Block_ints_2 = lists:append(Block_ints, [Block_int_2]),
...
get_text_from_blocks(Block_ints_3, Message_length, Block_size_2) ->
    ...
    case (I_5 >= 0) of
        true ->
            case ((length(Message_2) + I_5) < Message_length) of
        true -> Ascii_number = (Block div pow_int(256, I_5)),
            Block_2 = (Block rem pow_int(256, I_5)),
...
encrypt_message(Message_4, N, E_3, Block_size_3) ->
    ...
    case List of
        ...
        [Block_4|Block_4_rest] ->
            Encrypted_2 = lists:append(Encrypted, [mod_pow(Block_4, E_3, N)]),
...
decrypt_message(Blocks_2, Message_length_2, N_2, D, Block_size_4) ->
    ...
    case List of
        ...
        [Block_5|Block_5_rest] ->
            Decrypted_blocks_2 = lists:append(Decrypted_blocks, [mod_pow(Block_5, D, N_2)]),
...
main() ->
    try
        ...
        Decrypted = decrypt_message(Encrypted_3, length("hello world"), 3233, 2753, 1),

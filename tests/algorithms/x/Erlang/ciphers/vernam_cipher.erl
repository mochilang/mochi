...
vernam_encrypt(Plaintext, Key) ->
    ...
    case (I_3 < length(Plaintext)) of
        true ->
            P = (ord(string:substr(Plaintext, I_3 + 1, ((I_3 + 1) - I_3))) - 65),
            K = (ord(string:substr(Key, (I_3 rem length(Key)) + 1, (((I_3 rem length(Key)) + 1) - (I_3 rem length(Key))))) - 65),
            Ct = (P + K),
...
vernam_decrypt(Ciphertext_3, Key_2) ->
    ...
    case (I_5 < length(Ciphertext_3)) of
        true ->
            ...
            K_2 = ord(string:substr(Key_2, (I_5 rem length(Key_2)) + 1, (((I_5 rem length(Key_2)) + 1) - (I_5 rem length(Key_2))))),
            Val = (C - K_2),

...
jacobi_symbol(Random_a, Number) ->
    ...
    case (mochi_mod(Random_a_2, 2) == 0) of
        true ->
            Random_a_3 = (Random_a_2 div 2),
            R = mochi_mod(Number, 8),
            case ((R == 3) orelse (R == 5)) of
        true -> T_2 = -T,
            T_3 = T_2;
        _ -> T_3 = T
    end,
...
{Number, Random_a_3, T_3} = Fun(Number, Random_a_2, T),
            ...
            Random_a_4 = Number,
            Number_2 = Temp,
            case ((mochi_mod(Random_a_4, 4) == 3) andalso (mochi_mod(Number_2, 4) == 3)) of
        true -> T_4 = -T_3,
            T_5 = T_4;
        _ -> T_5 = T_3
    end,
...
solovay_strassen(Number_3, Iterations) ->
    ...
    case (I < Iterations) of
        true ->
            ...
            Y = pow_mod(A_2, ((Number_3 - 1) div 2), Number_3),

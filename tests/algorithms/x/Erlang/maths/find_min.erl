...
find_min_iterative(Nums) ->
    try
        ...
        true -> erlang:error("find_min_iterative() arg is an empty sequence");
        _ -> ok
    end,
...
find_min_recursive(Nums_2, Left, Right) ->
    try
        ...
        case (N == 0) of
        true -> erlang:error("find_min_recursive() arg is an empty sequence");
        _ -> ok
    end,

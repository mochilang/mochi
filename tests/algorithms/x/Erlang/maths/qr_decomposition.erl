...
print_matrix(Mat_5) ->
    ...
    case (J_11 < erlang:length((case erlang:is_map(Mat_5) of true -> maps:get(I_23, Mat_5, nil); _ -> case I_23 < 0 of true -> mochi_nth(erlang:length(Mat_5) + I_23 + 1, Mat_5); _ -> mochi_nth(I_23 + 1, Mat_5) end end))) of
        true ->
            ...
            case ((J_11 + 1) < erlang:length((case erlang:is_map(Mat_5) of true -> maps:get(I_23, Mat_5, nil); _ -> case I_23 < 0 of true -> mochi_nth(erlang:length(Mat_5) + I_23 + 1, Mat_5); _ -> mochi_nth(I_23 + 1, Mat_5) end end))) of
        true -> Line_3 = (Line_2 ++ " "),
            Line_4 = Line_3;
        _ -> Line_4 = Line_2
    end,

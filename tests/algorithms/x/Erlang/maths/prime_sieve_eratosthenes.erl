...
{I_2, Num, Primes_2} = Fun(I, Num, Primes),
    ...
    case ((P * P) =< Num) of
        true ->
            case (case erlang:is_map(Primes_2) of true -> maps:get(P, Primes_2, nil); _ -> case P < 0 of true -> mochi_nth(erlang:length(Primes_2) + P + 1, Primes_2); _ -> mochi_nth(P + 1, Primes_2) end end) of
        true -> J = (P * P),
...
{I_2, Num, P_2, Primes_4} = Fun_4(I_2, Num, P, Primes_2),
    ...
    case (K =< Num) of
        true ->
            case (case erlang:is_map(Primes_4) of true -> maps:get(K, Primes_4, nil); _ -> case K < 0 of true -> mochi_nth(erlang:length(Primes_4) + K + 1, Primes_4); _ -> mochi_nth(K + 1, Primes_4) end end) of

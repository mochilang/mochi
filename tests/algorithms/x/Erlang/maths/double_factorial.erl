...
double_factorial_recursive(N) ->
    try
        case (N < 0) of
        true -> erlang:error("double_factorial_recursive() not defined for negative values");
        _ -> ok
    end,
        case (N =< 1) of
        true -> throw({return, 1});
...
double_factorial_iterative(N_2) ->
    try
        case (N_2 < 0) of
        true -> erlang:error("double_factorial_iterative() not defined for negative values");
        _ -> ok
    end,
        Result = 1,
        I = N_2,
...
test_double_factorial() ->
    try
        ...
        true -> erlang:error("0!! recursive failed");
        _ -> ok
    end,
        case (double_factorial_iterative(0) /= 1) of
        true -> erlang:error("0!! iterative failed");
        _ -> ok
    end,
        case (double_factorial_recursive(1) /= 1) of
        true -> erlang:error("1!! recursive failed");
        _ -> ok
    end,
        case (double_factorial_iterative(1) /= 1) of
        true -> erlang:error("1!! iterative failed");
        _ -> ok
    end,
        case (double_factorial_recursive(5) /= 15) of
        true -> erlang:error("5!! recursive failed");
        _ -> ok
    end,
        case (double_factorial_iterative(5) /= 15) of
        true -> erlang:error("5!! iterative failed");
        _ -> ok
    end,
        case (double_factorial_recursive(6) /= 48) of
        true -> erlang:error("6!! recursive failed");
        _ -> ok
    end,
        case (double_factorial_iterative(6) /= 48) of
        true -> erlang:error("6!! iterative failed");
        _ -> ok
    end,
        N_3 = 0,
    ...
    case (N_3 =< 10) of
        ...
        true -> erlang:error("double factorial mismatch");
        _ -> ok
    end,
            N_4 = (N_3 + 1),
            Fun_2_loop(N_4);

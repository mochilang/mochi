...
int_to_base(Number, Base) ->
    try
        ...
        true -> erlang:error("'base' must be between 2 and 36 inclusive");
        _ -> ok
    end,
        case (Number < 0) of
        true -> erlang:error("number must be a positive integer");
        _ -> ok
    end,
...
harshad_numbers_in_base(Limit, Base_4) ->
    ...
    case (I_7 < Limit) of
        true ->
            ...
            case (mochi_mod(I_7, Divisor) == 0) of

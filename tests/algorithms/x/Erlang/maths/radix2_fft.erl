...
{A_6, A0_2, A1_2, I_8, Invert, N_2} = Fun_4(A_6, A0, A1, I_7, Invert, N_2),
    ...
    case (I_9 < (N_2 div 2)) of
        ...
        _ -> Even_3 = Even,
            ...
            Y_3 = lists:sublist(Y_2, (I_9 + (N_2 div 2))) ++ [Odd_3] ++ lists:nthtail((I_9 + (N_2 div 2)) + 1, Y_2),
            W_2 = c_mul(W, Wn),
            I_10 = (I_9 + 1),
...
round_to(X_4, Ndigits) ->
    try
        M = pow10(Ndigits),
        mochi_safe_div(floor((mochi_safe_mul(X_4, M) + 0.5)), M)
    catch {return, Ret} -> Ret end.
...
list_to_string(L) ->
    ...
    case (I_16 < erlang:length(L)) of
        true ->
            ...
            case ((I_16 + 1) < erlang:length(L)) of
        true -> S_5 = (S_4 ++ ", "),
            S_6 = S_5;
        _ -> S_6 = S_4
    end,

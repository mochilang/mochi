...
slow_primes(Max_n) ->
    ...
    case (J < I) of
        true ->
            try
                case (mochi_mod(I, J) == 0) of
        true -> Is_prime_2 = false,
            throw({break, I, Is_prime_2, J, Max_n, Result}),
            Is_prime_3 = Is_prime_2;
        _ -> Is_prime_3 = Is_prime
    end,
                J_2 = (J + 1),
...
fast_primes(Max_n_3) ->
    ...
    case ((J_5 * J_5) =< I_5) of
        true ->
            try
                case (mochi_mod(I_5, J_5) == 0) of
        true -> Is_prime_8 = false,
            throw({break, I_5, Is_prime_8, J_5, Max_n_3, Result_9}),
            Is_prime_9 = Is_prime_8;
        _ -> Is_prime_9 = Is_prime_7
    end,
                J_6 = (J_5 + 2),

...
make_graph(Vertices, Edges, Directed) ->
    ...
    case (I < erlang:length(Vertices)) of
        true ->
            add_vertex(G, (case erlang:is_map(Vertices) of true -> maps:get(I, Vertices, nil); _ -> case I < 0 of true -> lists:nth(erlang:length(Vertices) + I + 1, Vertices); _ -> lists:nth(I + 1, Vertices) end end)),
            I_2 = (I + 1),
...
{Directed, Edges, G, I_2, Vertices} = Fun(Directed, Edges, G, I, Vertices),
    ...
    case (J < erlang:length(Edges)) of
        true ->
            E = (case erlang:is_map(Edges) of true -> maps:get(J, Edges, nil); _ -> case J < 0 of true -> lists:nth(erlang:length(Edges) + J + 1, Edges); _ -> lists:nth(J + 1, Edges) end end),
            add_edge(G, (case erlang:is_map(E) of true -> maps:get(0, E, nil); _ -> case 0 < 0 of true -> lists:nth(erlang:length(E) + 0 + 1, E); _ -> lists:nth(0 + 1, E) end end), (case erlang:is_map(E) of true -> maps:get(1, E, nil); _ -> case 1 < 0 of true -> lists:nth(erlang:length(E) + 1 + 1, E); _ -> lists:nth(1 + 1, E) end end)),
            J_2 = (J + 1),
...
add_vertex(G_3, V_2) ->
    try
        ...
        true -> erlang:error("vertex already exists");
        _ -> ok
    end,
    ...
    case (I_3 < erlang:length(Matrix)) of
        true ->
            Matrix_2 = lists:sublist(Matrix, I_3) ++ [lists:append((case (case erlang:is_map(Matrix) of true -> maps:get(I_3, Matrix, nil); _ -> case I_3 < 0 of true -> lists:nth(erlang:length(Matrix) + I_3 + 1, Matrix); _ -> lists:nth(I_3 + 1, Matrix) end end) of nil -> []; _ -> (case erlang:is_map(Matrix) of true -> maps:get(I_3, Matrix, nil); _ -> case I_3 < 0 of true -> lists:nth(erlang:length(Matrix) + I_3 + 1, Matrix); _ -> lists:nth(I_3 + 1, Matrix) end end) end), [0])] ++ lists:nthtail(I_3 + 1, Matrix),
            I_4 = (I_3 + 1),
...
remove_vertex(G_6, V_3) ->
    try
        ...
        true -> erlang:error("vertex does not exist");
        _ -> ok
    end,
    ...
    case (I_5 < erlang:length(maps:get("adj_matrix", G_6, nil))) of
        true ->
            case (I_5 /= Idx_2) of
        true -> Row_3 = (case erlang:is_map(maps:get("adj_matrix", G_6, nil)) of true -> maps:get(I_5, maps:get("adj_matrix", G_6, nil), nil); _ -> case I_5 < 0 of true -> lists:nth(erlang:length(maps:get("adj_matrix", G_6, nil)) + I_5 + 1, maps:get("adj_matrix", G_6, nil)); _ -> lists:nth(I_5 + 1, maps:get("adj_matrix", G_6, nil)) end end),
            New_row = [],
            J_5 = 0,
    ...
    case (J_5 < erlang:length(Row_3)) of
        true ->
            case (J_5 /= Idx_2) of
        true -> New_row_2 = lists:append((case New_row of nil -> []; _ -> New_row end), [(case erlang:is_map(Row_3) of true -> maps:get(J_5, Row_3, nil); _ -> case J_5 < 0 of true -> lists:nth(erlang:length(Row_3) + J_5 + 1, Row_3); _ -> lists:nth(J_5 + 1, Row_3) end end)]),
            New_row_3 = New_row_2;
        _ -> New_row_3 = New_row
    end,
            J_6 = (J_5 + 1),
...
add_edge(G_9, U, V_4) ->
    try
        ...
        true -> erlang:error("missing vertex");
        _ -> ok
    end,
...
contains_edge(G_13, U_3, V_6) ->
    try
        ...
        ((case erlang:is_map((case erlang:is_map(Matrix_12) of true -> maps:get(I_9, Matrix_12, nil); _ -> case I_9 < 0 of true -> lists:nth(erlang:length(Matrix_12) + I_9 + 1, Matrix_12); _ -> lists:nth(I_9 + 1, Matrix_12) end end)) of true -> maps:get(J_10, (case erlang:is_map(Matrix_12) of true -> maps:get(I_9, Matrix_12, nil); _ -> case I_9 < 0 of true -> lists:nth(erlang:length(Matrix_12) + I_9 + 1, Matrix_12); _ -> lists:nth(I_9 + 1, Matrix_12) end end), nil); _ -> case J_10 < 0 of true -> lists:nth(erlang:length((case erlang:is_map(Matrix_12) of true -> maps:get(I_9, Matrix_12, nil); _ -> case I_9 < 0 of true -> lists:nth(erlang:length(Matrix_12) + I_9 + 1, Matrix_12); _ -> lists:nth(I_9 + 1, Matrix_12) end end)) + J_10 + 1, (case erlang:is_map(Matrix_12) of true -> maps:get(I_9, Matrix_12, nil); _ -> case I_9 < 0 of true -> lists:nth(erlang:length(Matrix_12) + I_9 + 1, Matrix_12); _ -> lists:nth(I_9 + 1, Matrix_12) end end)); _ -> lists:nth(J_10 + 1, (case erlang:is_map(Matrix_12) of true -> maps:get(I_9, Matrix_12, nil); _ -> case I_9 < 0 of true -> lists:nth(erlang:length(Matrix_12) + I_9 + 1, Matrix_12); _ -> lists:nth(I_9 + 1, Matrix_12) end end)) end end) == 1)
    catch {return, Ret} -> Ret end.

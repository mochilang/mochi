...
key_fn(Start, I_4, Goal_5, G_func) ->
    try
        ...
        (G + mochi_safe_mul(1, heuristic(I_4, Start, Goal_5)))
    catch {return, Ret} -> Ret end.
...
in_blocks(P_7) ->
    ...
    case (I_5 < erlang:length(erlang:get('blocks'))) of
        true ->
            case pos_equal((case erlang:is_map(erlang:get('blocks')) of true -> maps:get(I_5, erlang:get('blocks'), nil); _ -> case I_5 < 0 of true -> lists:nth(erlang:length(erlang:get('blocks')) + I_5 + 1, erlang:get('blocks')); _ -> lists:nth(I_5 + 1, erlang:get('blocks')) end end), P_7) of
...
pq_put(Pq, Node, Pri) ->
    ...
    case (I_7 < erlang:length(Pq)) of
        true ->
            case pos_equal(maps:get("pos", (case erlang:is_map(Pq) of true -> maps:get(I_7, Pq, nil); _ -> case I_7 < 0 of true -> lists:nth(erlang:length(Pq) + I_7 + 1, Pq); _ -> lists:nth(I_7 + 1, Pq) end end), nil), Node) of
        true -> case (Pri < maps:get("pri", (case erlang:is_map(Pq) of true -> maps:get(I_7, Pq, nil); _ -> case I_7 < 0 of true -> lists:nth(erlang:length(Pq) + I_7 + 1, Pq); _ -> lists:nth(I_7 + 1, Pq) end end), nil)) of
...
pq_minkey(Pq_7) ->
    try
        ...
        true -> throw({return, 1.0e+09});
        _ -> ok
    end,
        First = (case erlang:is_map(Pq_7) of true -> maps:get(0, Pq_7, nil); _ -> case 0 < 0 of true -> lists:nth(erlang:length(Pq_7) + 0 + 1, Pq_7); _ -> lists:nth(0 + 1, Pq_7) end end),
        M = maps:get("pri", First, nil),
        I_9 = 1,
        Fun_4 = fun Fun_4_loop(First, I_9, M, Pq_7) ->
    case (I_9 < erlang:length(Pq_7)) of
        true ->
            Item = (case erlang:is_map(Pq_7) of true -> maps:get(I_9, Pq_7, nil); _ -> case I_9 < 0 of true -> lists:nth(erlang:length(Pq_7) + I_9 + 1, Pq_7); _ -> lists:nth(I_9 + 1, Pq_7) end end),
...
pq_pop_min(Pq_8) ->
    try
        Best = (case erlang:is_map(Pq_8) of true -> maps:get(0, Pq_8, nil); _ -> case 0 < 0 of true -> lists:nth(erlang:length(Pq_8) + 0 + 1, Pq_8); _ -> lists:nth(0 + 1, Pq_8) end end),
        Idx = 0,
        I_11 = 1,
        Fun_5 = fun Fun_5_loop(Best, I_11, Idx, Pq_8) ->
    case (I_11 < erlang:length(Pq_8)) of
        true ->
            case (maps:get("pri", (case erlang:is_map(Pq_8) of true -> maps:get(I_11, Pq_8, nil); _ -> case I_11 < 0 of true -> lists:nth(erlang:length(Pq_8) + I_11 + 1, Pq_8); _ -> lists:nth(I_11 + 1, Pq_8) end end), nil) < maps:get("pri", Best, nil)) of
        true -> Best_2 = (case erlang:is_map(Pq_8) of true -> maps:get(I_11, Pq_8, nil); _ -> case I_11 < 0 of true -> lists:nth(erlang:length(Pq_8) + I_11 + 1, Pq_8); _ -> lists:nth(I_11 + 1, Pq_8) end end),
            Idx_2 = I_11,
            Best_3 = Best_2,
            Idx_3 = Idx_2;
        _ -> Best_3 = Best,
...
{Best_3, I_12, Idx_3, Pq_8} = Fun_5(Best, I_11, Idx, Pq_8),
    ...
    case (I_13 < erlang:length(Pq_8)) of
        true ->
            case (I_13 /= Idx_3) of
        true -> New_pq_2 = lists:append((case New_pq of nil -> []; _ -> New_pq end), [(case erlang:is_map(Pq_8) of true -> maps:get(I_13, Pq_8, nil); _ -> case I_13 < 0 of true -> lists:nth(erlang:length(Pq_8) + I_13 + 1, Pq_8); _ -> lists:nth(I_13 + 1, Pq_8) end end)]),
            New_pq_3 = New_pq_2;
        _ -> New_pq_3 = New_pq
    end,
            I_14 = (I_13 + 1),
...
pq_remove(Pq_9, Node_2) ->
    ...
    case (I_15 < erlang:length(Pq_9)) of
        true ->
            case mochi_not(pos_equal(maps:get("pos", (case erlang:is_map(Pq_9) of true -> maps:get(I_15, Pq_9, nil); _ -> case I_15 < 0 of true -> lists:nth(erlang:length(Pq_9) + I_15 + 1, Pq_9); _ -> lists:nth(I_15 + 1, Pq_9) end end), nil), Node_2)) of
        true -> New_pq_5 = lists:append((case New_pq_4 of nil -> []; _ -> New_pq_4 end), [(case erlang:is_map(Pq_9) of true -> maps:get(I_15, Pq_9, nil); _ -> case I_15 < 0 of true -> lists:nth(erlang:length(Pq_9) + I_15 + 1, Pq_9); _ -> lists:nth(I_15 + 1, Pq_9) end end)]),
            New_pq_6 = New_pq_5;
        _ -> New_pq_6 = New_pq_4
    end,
            I_16 = (I_15 + 1),
...
{Back_pointer, Current_2, Goal_6, Key_2, Path_3, Start_2} = Fun_8(Back_pointer, Current, Goal_6, Key, Path_2, Start_2),
    ...
    case (I_17 >= 0) of
        true ->
            Rev_2 = lists:append((case Rev of nil -> []; _ -> Rev end), [(case erlang:is_map(Path_3) of true -> maps:get(I_17, Path_3, nil); _ -> case I_17 < 0 of true -> lists:nth(erlang:length(Path_3) + I_17 + 1, Path_3); _ -> lists:nth(I_17 + 1, Path_3) end end)]),
            I_18 = (I_17 - 1),
...
multi_a_star(Start_3, Goal_7, N_heuristic) ->
    try
        ...
        Visited = #{},
        Open_list = [],
        G_function_2 = maps:put(pos_key(Start_3), 0, G_function),
        G_function_3 = maps:put(pos_key(Goal_7), 1.0e+09, G_function_2),
    ...
    case (I_19 < erlang:get('n_heuristic')) of
        true ->
            ...
            Open_list_3 = lists:sublist(Open_list_2, I_19) ++ [pq_put((case erlang:is_map(Open_list_2) of true -> maps:get(I_19, Open_list_2, nil); _ -> case I_19 < 0 of true -> lists:nth(erlang:length(Open_list_2) + I_19 + 1, Open_list_2); _ -> lists:nth(I_19 + 1, Open_list_2) end end), Start_3, Pri_2)] ++ lists:nthtail(I_19 + 1, Open_list_2),
            I_20 = (I_19 + 1),
...
{Back_pointer_4, G_function_3, Goal_7, I_20, N_heuristic, Open_list_3, Start_3, Visited_2} = Fun_10(Back_pointer_4, G_function_3, Goal_7, I_19, N_heuristic, Open_list, Start_3, Visited_2),
    ...
    case (pq_minkey((case erlang:is_map(Open_list_3) of true -> maps:get(0, Open_list_3, nil); _ -> case 0 < 0 of true -> lists:nth(erlang:length(Open_list_3) + 0 + 1, Open_list_3); _ -> lists:nth(0 + 1, Open_list_3) end end)) < 1.0e+09) of
        true ->
            try
                Chosen = 0,
                I_21 = 1,
    ...
    case (I_21 < erlang:get('n_heuristic')) of
        true ->
            try
                case (pq_minkey((case erlang:is_map(Open_list_3) of true -> maps:get(I_21, Open_list_3, nil); _ -> case I_21 < 0 of true -> lists:nth(erlang:length(Open_list_3) + I_21 + 1, Open_list_3); _ -> lists:nth(I_21 + 1, Open_list_3) end end)) =< mochi_safe_mul(1, pq_minkey((case erlang:is_map(Open_list_3) of true -> maps:get(0, Open_list_3, nil); _ -> case 0 < 0 of true -> lists:nth(erlang:length(Open_list_3) + 0 + 1, Open_list_3); _ -> lists:nth(0 + 1, Open_list_3) end end)))) of
        true -> Chosen_2 = I_21,
...
{Back_pointer_4, Chosen_3, G_function_3, Goal_7, I_22, N_heuristic, Open_list_3, Start_3, Visited_2} = Fun_11(Back_pointer_4, Chosen, G_function_3, Goal_7, I_21, N_heuristic, Open_list_3, Start_3, Visited_2),
        ...
        _ -> ok
                ...
                Pair = pq_pop_min((case erlang:is_map(Open_list_3) of true -> maps:get(Chosen_3, Open_list_3, nil); _ -> case Chosen_3 < 0 of true -> lists:nth(erlang:length(Open_list_3) + Chosen_3 + 1, Open_list_3); _ -> lists:nth(Chosen_3 + 1, Open_list_3) end end)),
    ...
    case (I_23 < erlang:get('n_heuristic')) of
        ...
        true -> Open_list_5 = lists:sublist(Open_list_4, I_23) ++ [pq_remove((case erlang:is_map(Open_list_4) of true -> maps:get(I_23, Open_list_4, nil); _ -> case I_23 < 0 of true -> lists:nth(erlang:length(Open_list_4) + I_23 + 1, Open_list_4); _ -> lists:nth(I_23 + 1, Open_list_4) end end), maps:get("pos", Current_3, nil))] ++ lists:nthtail(I_23 + 1, Open_list_4),
...
{Back_pointer_4, Chosen_3, Current_3, G_function_3, Goal_7, I_24, N_heuristic, Open_list_6, Pair, Start_3, Visited_2} = Fun_12(Back_pointer_4, Chosen_3, Current_3, G_function_3, Goal_7, I_23, N_heuristic, Open_list_4, Pair, Start_3, Visited_2),
    ...
    case (J < erlang:length(Path_4)) of
        true ->
            P_9 = (case erlang:is_map(Path_4) of true -> maps:get(J, Path_4, nil); _ -> case J < 0 of true -> lists:nth(erlang:length(Path_4) + J + 1, Path_4); _ -> lists:nth(J + 1, Path_4) end end),
...
{Back_pointer_4, Chosen_3, Ckey, Current_3, G_function_3, Goal_7, I_24, J_2, N_heuristic, Open_list_6, Pair, Path_4, Start_3, Visited_3} = Fun_13(Back_pointer_4, Chosen_3, Ckey, Current_3, G_function_3, Goal_7, I_24, J, N_heuristic, Open_list_6, Pair, Path_4, Start_3, Visited_3),
    ...
    case (K < erlang:length(Neighs)) of
        true ->
            Nb = (case erlang:is_map(Neighs) of true -> maps:get(K, Neighs, nil); _ -> case K < 0 of true -> lists:nth(erlang:length(Neighs) + K + 1, Neighs); _ -> lists:nth(K + 1, Neighs) end end),
            case (valid(Nb) andalso (in_blocks(Nb) == false)) of
        true -> Nkey = pos_key(Nb),
            Tentative = (maps:get(Ckey, G_function_3, nil) + 1),
    ...
    case (I_25 < erlang:get('n_heuristic')) of
        true ->
            Pri2 = (Tentative + mochi_safe_mul(1, heuristic(I_25, Nb, Goal_7))),
            Open_list_7 = lists:sublist(Open_list_6, I_25) ++ [pq_put((case erlang:is_map(Open_list_6) of true -> maps:get(I_25, Open_list_6, nil); _ -> case I_25 < 0 of true -> lists:nth(erlang:length(Open_list_6) + I_25 + 1, Open_list_6); _ -> lists:nth(I_25 + 1, Open_list_6) end end), Nb, Pri2)] ++ lists:nthtail(I_25 + 1, Open_list_6),
            I_26 = (I_25 + 1),

...
rand_float() ->
    try
        mochi_safe_div(float(mochi_mod(mochi_now(), 1000000)), 1.0e+06)
    catch {return, Ret} -> Ret end.
...
distance(City1, City2) ->
    try
        Dx = float(((case erlang:is_map(City1) of true -> maps:get(0, City1, nil); _ -> case 0 < 0 of true -> lists:nth(erlang:length(City1) + 0 + 1, City1); _ -> lists:nth(0 + 1, City1) end end) - (case erlang:is_map(City2) of true -> maps:get(0, City2, nil); _ -> case 0 < 0 of true -> lists:nth(erlang:length(City2) + 0 + 1, City2); _ -> lists:nth(0 + 1, City2) end end))),
        Dy = float(((case erlang:is_map(City1) of true -> maps:get(1, City1, nil); _ -> case 1 < 0 of true -> lists:nth(erlang:length(City1) + 1 + 1, City1); _ -> lists:nth(1 + 1, City1) end end) - (case erlang:is_map(City2) of true -> maps:get(1, City2, nil); _ -> case 1 < 0 of true -> lists:nth(erlang:length(City2) + 1 + 1, City2); _ -> lists:nth(1 + 1, City2) end end))),
...
choose_weighted(Options, Weights) ->
    ...
    case (I_5 < erlang:length(Weights)) of
        true ->
            Total_2 = (Total + (case erlang:is_map(Weights) of true -> maps:get(I_5, Weights, nil); _ -> case I_5 < 0 of true -> lists:nth(erlang:length(Weights) + I_5 + 1, Weights); _ -> lists:nth(I_5 + 1, Weights) end end)),
            I_6 = (I_5 + 1),
...
{I_6, Options, Total_2, Weights} = Fun_3(I_5, Options, Total, Weights),
    ...
    case (I_7 < erlang:length(Weights)) of
        true ->
            Accum_2 = (Accum + (case erlang:is_map(Weights) of true -> maps:get(I_7, Weights, nil); _ -> case I_7 < 0 of true -> lists:nth(erlang:length(Weights) + I_7 + 1, Weights); _ -> lists:nth(I_7 + 1, Weights) end end)),
            case (R =< Accum_2) of
        true -> throw({return, (case erlang:is_map(Options) of true -> maps:get(I_7, Options, nil); _ -> case I_7 < 0 of true -> lists:nth(erlang:length(Options) + I_7 + 1, Options); _ -> lists:nth(I_7 + 1, Options) end end)});
        _ -> ok
    end,
            I_8 = (I_7 + 1),
...
{Accum_2, I_8, Options, R, Total_2, Weights} = Fun_4(Accum, I_7, Options, R, Total_2, Weights),
        (case erlang:is_map(Options) of true -> maps:get((erlang:length(Options) - 1), Options, nil); _ -> case (erlang:length(Options) - 1) < 0 of true -> lists:nth(erlang:length(Options) + (erlang:length(Options) - 1) + 1, Options); _ -> lists:nth((erlang:length(Options) - 1) + 1, Options) end end)
    catch {return, Ret} -> Ret end.
...
city_select(Pheromone, Current, Unvisited, Alpha, Beta, Cities) ->
    ...
    case (I_9 < erlang:length(Unvisited)) of
        true ->
            City = (case erlang:is_map(Unvisited) of true -> maps:get(I_9, Unvisited, nil); _ -> case I_9 < 0 of true -> lists:nth(erlang:length(Unvisited) + I_9 + 1, Unvisited); _ -> lists:nth(I_9 + 1, Unvisited) end end),
            Dist = distance(maps:get(City, Cities, nil), maps:get(Current, Cities, nil)),
            Trail = (case erlang:is_map((case erlang:is_map(Pheromone) of true -> maps:get(City, Pheromone, nil); _ -> case City < 0 of true -> lists:nth(erlang:length(Pheromone) + City + 1, Pheromone); _ -> lists:nth(City + 1, Pheromone) end end)) of true -> maps:get(Current, (case erlang:is_map(Pheromone) of true -> maps:get(City, Pheromone, nil); _ -> case City < 0 of true -> lists:nth(erlang:length(Pheromone) + City + 1, Pheromone); _ -> lists:nth(City + 1, Pheromone) end end), nil); _ -> case Current < 0 of true -> lists:nth(erlang:length((case erlang:is_map(Pheromone) of true -> maps:get(City, Pheromone, nil); _ -> case City < 0 of true -> lists:nth(erlang:length(Pheromone) + City + 1, Pheromone); _ -> lists:nth(City + 1, Pheromone) end end)) + Current + 1, (case erlang:is_map(Pheromone) of true -> maps:get(City, Pheromone, nil); _ -> case City < 0 of true -> lists:nth(erlang:length(Pheromone) + City + 1, Pheromone); _ -> lists:nth(City + 1, Pheromone) end end)); _ -> lists:nth(Current + 1, (case erlang:is_map(Pheromone) of true -> maps:get(City, Pheromone, nil); _ -> case City < 0 of true -> lists:nth(erlang:length(Pheromone) + City + 1, Pheromone); _ -> lists:nth(City + 1, Pheromone) end end)) end end),
            Prob = mochi_safe_mul(pow_float(Trail, Alpha), pow_float(mochi_safe_div(1, Dist), Beta)),
...
pheromone_update(Pheromone_2, Cities_2, Evaporation, Ants_route, Q) ->
    ...
    case (J < N) of
        true ->
            Pheromone_3 = lists:sublist(Pheromone_2, I_11) ++ [lists:sublist(lists:nth(I_11 + 1, Pheromone_2), J) ++ [mochi_safe_mul((case erlang:is_map((case erlang:is_map(Pheromone_2) of true -> maps:get(I_11, Pheromone_2, nil); _ -> case I_11 < 0 of true -> lists:nth(erlang:length(Pheromone_2) + I_11 + 1, Pheromone_2); _ -> lists:nth(I_11 + 1, Pheromone_2) end end)) of true -> maps:get(J, (case erlang:is_map(Pheromone_2) of true -> maps:get(I_11, Pheromone_2, nil); _ -> case I_11 < 0 of true -> lists:nth(erlang:length(Pheromone_2) + I_11 + 1, Pheromone_2); _ -> lists:nth(I_11 + 1, Pheromone_2) end end), nil); _ -> case J < 0 of true -> lists:nth(erlang:length((case erlang:is_map(Pheromone_2) of true -> maps:get(I_11, Pheromone_2, nil); _ -> case I_11 < 0 of true -> lists:nth(erlang:length(Pheromone_2) + I_11 + 1, Pheromone_2); _ -> lists:nth(I_11 + 1, Pheromone_2) end end)) + J + 1, (case erlang:is_map(Pheromone_2) of true -> maps:get(I_11, Pheromone_2, nil); _ -> case I_11 < 0 of true -> lists:nth(erlang:length(Pheromone_2) + I_11 + 1, Pheromone_2); _ -> lists:nth(I_11 + 1, Pheromone_2) end end)); _ -> lists:nth(J + 1, (case erlang:is_map(Pheromone_2) of true -> maps:get(I_11, Pheromone_2, nil); _ -> case I_11 < 0 of true -> lists:nth(erlang:length(Pheromone_2) + I_11 + 1, Pheromone_2); _ -> lists:nth(I_11 + 1, Pheromone_2) end end)) end end), Evaporation)] ++ lists:nthtail(J + 1, lists:nth(I_11 + 1, Pheromone_2))] ++ lists:nthtail(I_11 + 1, Pheromone_2),
            J_2 = (J + 1),
...
{Ants_route, Cities_2, Evaporation, I_12, N, Pheromone_3, Q} = Fun_7(Ants_route, Cities_2, Evaporation, I_11, N, Pheromone_2, Q),
    ...
    case (A < erlang:length(Ants_route)) of
        true ->
            Route = (case erlang:is_map(Ants_route) of true -> maps:get(A, Ants_route, nil); _ -> case A < 0 of true -> lists:nth(erlang:length(Ants_route) + A + 1, Ants_route); _ -> lists:nth(A + 1, Ants_route) end end),
            Total_3 = 0,
            R_2 = 0,
    ...
    case (R_2 < (erlang:length(Route) - 1)) of
        true ->
            Total_4 = (Total_3 + distance(maps:get((case erlang:is_map(Route) of true -> maps:get(R_2, Route, nil); _ -> case R_2 < 0 of true -> lists:nth(erlang:length(Route) + R_2 + 1, Route); _ -> lists:nth(R_2 + 1, Route) end end), Cities_2, nil), maps:get((case erlang:is_map(Route) of true -> maps:get((R_2 + 1), Route, nil); _ -> case (R_2 + 1) < 0 of true -> lists:nth(erlang:length(Route) + (R_2 + 1) + 1, Route); _ -> lists:nth((R_2 + 1) + 1, Route) end end), Cities_2, nil))),
            R_3 = (R_2 + 1),
...
{A, Ants_route, Cities_2, Evaporation, I_12, N, Pheromone_3, Q, R_3, Route, Total_4} = Fun_8(A, Ants_route, Cities_2, Evaporation, I_12, N, Pheromone_3, Q, R_2, Route, Total_3),
    ...
    case (R_4 < (erlang:length(Route) - 1)) of
        true ->
            U = (case erlang:is_map(Route) of true -> maps:get(R_4, Route, nil); _ -> case R_4 < 0 of true -> lists:nth(erlang:length(Route) + R_4 + 1, Route); _ -> lists:nth(R_4 + 1, Route) end end),
            V = (case erlang:is_map(Route) of true -> maps:get((R_4 + 1), Route, nil); _ -> case (R_4 + 1) < 0 of true -> lists:nth(erlang:length(Route) + (R_4 + 1) + 1, Route); _ -> lists:nth((R_4 + 1) + 1, Route) end end),
            Pheromone_4 = lists:sublist(Pheromone_3, U) ++ [lists:sublist(lists:nth(U + 1, Pheromone_3), V) ++ [((case erlang:is_map((case erlang:is_map(Pheromone_3) of true -> maps:get(U, Pheromone_3, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Pheromone_3) + U + 1, Pheromone_3); _ -> lists:nth(U + 1, Pheromone_3) end end)) of true -> maps:get(V, (case erlang:is_map(Pheromone_3) of true -> maps:get(U, Pheromone_3, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Pheromone_3) + U + 1, Pheromone_3); _ -> lists:nth(U + 1, Pheromone_3) end end), nil); _ -> case V < 0 of true -> lists:nth(erlang:length((case erlang:is_map(Pheromone_3) of true -> maps:get(U, Pheromone_3, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Pheromone_3) + U + 1, Pheromone_3); _ -> lists:nth(U + 1, Pheromone_3) end end)) + V + 1, (case erlang:is_map(Pheromone_3) of true -> maps:get(U, Pheromone_3, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Pheromone_3) + U + 1, Pheromone_3); _ -> lists:nth(U + 1, Pheromone_3) end end)); _ -> lists:nth(V + 1, (case erlang:is_map(Pheromone_3) of true -> maps:get(U, Pheromone_3, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Pheromone_3) + U + 1, Pheromone_3); _ -> lists:nth(U + 1, Pheromone_3) end end)) end end) + Delta)] ++ lists:nthtail(V + 1, lists:nth(U + 1, Pheromone_3))] ++ lists:nthtail(U + 1, Pheromone_3),
            Pheromone_5 = lists:sublist(Pheromone_4, V) ++ [lists:sublist(lists:nth(V + 1, Pheromone_4), U) ++ [(case erlang:is_map((case erlang:is_map(Pheromone_4) of true -> maps:get(U, Pheromone_4, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Pheromone_4) + U + 1, Pheromone_4); _ -> lists:nth(U + 1, Pheromone_4) end end)) of true -> maps:get(V, (case erlang:is_map(Pheromone_4) of true -> maps:get(U, Pheromone_4, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Pheromone_4) + U + 1, Pheromone_4); _ -> lists:nth(U + 1, Pheromone_4) end end), nil); _ -> case V < 0 of true -> lists:nth(erlang:length((case erlang:is_map(Pheromone_4) of true -> maps:get(U, Pheromone_4, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Pheromone_4) + U + 1, Pheromone_4); _ -> lists:nth(U + 1, Pheromone_4) end end)) + V + 1, (case erlang:is_map(Pheromone_4) of true -> maps:get(U, Pheromone_4, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Pheromone_4) + U + 1, Pheromone_4); _ -> lists:nth(U + 1, Pheromone_4) end end)); _ -> lists:nth(V + 1, (case erlang:is_map(Pheromone_4) of true -> maps:get(U, Pheromone_4, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Pheromone_4) + U + 1, Pheromone_4); _ -> lists:nth(U + 1, Pheromone_4) end end)) end end)] ++ lists:nthtail(U + 1, lists:nth(V + 1, Pheromone_4))] ++ lists:nthtail(V + 1, Pheromone_4),
            R_5 = (R_4 + 1),
...
remove_value(Lst, Val) ->
    ...
    case (I_13 < erlang:length(Lst)) of
        true ->
            case ((case erlang:is_map(Lst) of true -> maps:get(I_13, Lst, nil); _ -> case I_13 < 0 of true -> lists:nth(erlang:length(Lst) + I_13 + 1, Lst); _ -> lists:nth(I_13 + 1, Lst) end end) /= Val) of
        true -> Res_2 = lists:append((case Res of nil -> []; _ -> Res end), [(case erlang:is_map(Lst) of true -> maps:get(I_13, Lst, nil); _ -> case I_13 < 0 of true -> lists:nth(erlang:length(Lst) + I_13 + 1, Lst); _ -> lists:nth(I_13 + 1, Lst) end end)]),
            Res_3 = Res_2;
        _ -> Res_3 = Res
    end,
            I_14 = (I_13 + 1),
...
ant_colony(Cities_3, Ants_num, Iterations, Evaporation_2, Alpha_2, Beta_2, Q_2) ->
    ...
    case (J_3 < N_2) of
        true ->
            Row_2 = lists:append((case Row of nil -> []; _ -> Row end), [1]),
            J_4 = (J_3 + 1),
...
{Alpha_2, Ants_num, Ants_route_3, Best_distance, Best_path, Beta_2, Cities_3, Evaporation_2, I_16, Iter, Iterations, K_2, N_2, Pheromone_7, Q_2} = Fun_16(Alpha_2, Ants_num, Ants_route_2, Best_distance, Best_path, Beta_2, Cities_3, Evaporation_2, I_16, Iter, Iterations, K, N_2, Pheromone_7, Q_2),
    ...
    case (A_3 < erlang:length(Ants_route_3)) of
        true ->
            Route_5 = (case erlang:is_map(Ants_route_3) of true -> maps:get(A_3, Ants_route_3, nil); _ -> case A_3 < 0 of true -> lists:nth(erlang:length(Ants_route_3) + A_3 + 1, Ants_route_3); _ -> lists:nth(A_3 + 1, Ants_route_3) end end),
            Dist_2 = 0,
            R_6 = 0,
    ...
    case (R_6 < (erlang:length(Route_5) - 1)) of
        true ->
            Dist_3 = (Dist_2 + distance(maps:get((case erlang:is_map(Route_5) of true -> maps:get(R_6, Route_5, nil); _ -> case R_6 < 0 of true -> lists:nth(erlang:length(Route_5) + R_6 + 1, Route_5); _ -> lists:nth(R_6 + 1, Route_5) end end), Cities_3, nil), maps:get((case erlang:is_map(Route_5) of true -> maps:get((R_6 + 1), Route_5, nil); _ -> case (R_6 + 1) < 0 of true -> lists:nth(erlang:length(Route_5) + (R_6 + 1) + 1, Route_5); _ -> lists:nth((R_6 + 1) + 1, Route_5) end end), Cities_3, nil))),
            R_7 = (R_6 + 1),
...
main(_) ->
    ...
    ant_colony(erlang:get('cities'), 10, 20, 0.7, 1, 5, 10),

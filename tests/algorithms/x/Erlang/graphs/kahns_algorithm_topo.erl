...
{Graph, I_2, Indegree_2} = Fun(Graph, I, Indegree),
    ...
    case (J < erlang:length(Edges)) of
        true ->
            V = (case erlang:is_map(Edges) of true -> maps:get(J, Edges, nil); _ -> case J < 0 of true -> lists:nth(erlang:length(Edges) + J + 1, Edges); _ -> lists:nth(J + 1, Edges) end end),
...
{Graph, I_2, Indegree_3} = Fun_2(maps:values(Graph), Graph, I_2, Indegree_2),
    ...
    case (I_3 < erlang:length(Indegree_3)) of
        true ->
            case ((case erlang:is_map(Indegree_3) of true -> maps:get(I_3, Indegree_3, nil); _ -> case I_3 < 0 of true -> lists:nth(erlang:length(Indegree_3) + I_3 + 1, Indegree_3); _ -> lists:nth(I_3 + 1, Indegree_3) end end) == 0) of
...
{Graph, I_4, Indegree_3, Queue_3} = Fun_4(Graph, I_3, Indegree_3, Queue),
    ...
    case (Head < erlang:length(Queue_3)) of
        true ->
            V_2 = (case erlang:is_map(Queue_3) of true -> maps:get(Head, Queue_3, nil); _ -> case Head < 0 of true -> lists:nth(erlang:length(Queue_3) + Head + 1, Queue_3); _ -> lists:nth(Head + 1, Queue_3) end end),
            Head_2 = (Head + 1),
    ...
    case (K < erlang:length(Neighbors)) of
        true ->
            Nb = (case erlang:is_map(Neighbors) of true -> maps:get(K, Neighbors, nil); _ -> case K < 0 of true -> lists:nth(erlang:length(Neighbors) + K + 1, Neighbors); _ -> lists:nth(K + 1, Neighbors) end end),
            Indegree_4 = lists:sublist(Indegree_3, Nb) ++ [((case erlang:is_map(Indegree_3) of true -> maps:get(Nb, Indegree_3, nil); _ -> case Nb < 0 of true -> lists:nth(erlang:length(Indegree_3) + Nb + 1, Indegree_3); _ -> lists:nth(Nb + 1, Indegree_3) end end) - 1)] ++ lists:nthtail(Nb + 1, Indegree_3),
            case ((case erlang:is_map(Indegree_4) of true -> maps:get(Nb, Indegree_4, nil); _ -> case Nb < 0 of true -> lists:nth(erlang:length(Indegree_4) + Nb + 1, Indegree_4); _ -> lists:nth(Nb + 1, Indegree_4) end end) == 0) of

...
dfs_skip(Graph, Visited, Skip, At) ->
    ...
    case List of
        ...
        _ -> ok
            ...
            case ((case erlang:is_map(Visited_2) of true -> maps:get(To, Visited_2, nil); _ -> case To < 0 of true -> mochi_nth(erlang:length(Visited_2) + To + 1, Visited_2); _ -> mochi_nth(To + 1, Visited_2) end end) == false) of

...
in_list(Arr, X) ->
    ...
    case (I < erlang:length(Arr)) of
        true ->
            case ((case erlang:is_map(Arr) of true -> maps:get(I, Arr, nil); _ -> case I < 0 of true -> lists:nth(erlang:length(Arr) + I + 1, Arr); _ -> lists:nth(I + 1, Arr) end end) == X) of
...
{Dist_2, Graph_2, I_4, Keys, Known, Mini_3, N, Parent_2, S, U_4} = Fun_2(Dist_2, Graph_2, I_3, Keys, Known, Mini, N, Parent_2, S, U_2),
    ...
    case List of
        ...
        [E|E_rest] ->
            V_2 = (case erlang:is_map(E) of true -> maps:get(0, E, nil); _ -> case 0 < 0 of true -> lists:nth(erlang:length(E) + 0 + 1, E); _ -> lists:nth(0 + 1, E) end end),
            W_2 = (case erlang:is_map(E) of true -> maps:get(1, E, nil); _ -> case 1 < 0 of true -> lists:nth(erlang:length(E) + 1 + 1, E); _ -> lists:nth(1 + 1, E) end end),
...
{Dist_4, Graph_2, Keys_3, Known_2, N, Parent_4, S} = Fun_4(Dist_2, Graph_2, Keys, Known, N, Parent_2, S),
    ...
    case (J < erlang:length(Keys_3)) of
        true ->
            V_3 = (case erlang:is_map(Keys_3) of true -> maps:get(J, Keys_3, nil); _ -> case J < 0 of true -> lists:nth(erlang:length(Keys_3) + J + 1, Keys_3); _ -> lists:nth(J + 1, Keys_3) end end),
            case (V_3 /= S) of
        true -> Edges_2 = lists:append((case Edges of nil -> []; _ -> Edges end), [[(V_3 + 1), ((case erlang:is_map(Parent_4) of true -> maps:get(V_3, Parent_4, nil); _ -> case V_3 < 0 of true -> lists:nth(erlang:length(Parent_4) + V_3 + 1, Parent_4); _ -> lists:nth(V_3 + 1, Parent_4) end end) + 1)]]),
            Edges_3 = Edges_2;
        _ -> Edges_3 = Edges
    end,
            J_2 = (J + 1),
...
sort_heap(H, Dist_5) ->
    ...
    case (J_3 < ((erlang:length(A_2) - I_5) - 1)) of
        true ->
            Dj = (case maps:is_key((case erlang:is_map(A_2) of true -> maps:get(J_3, A_2, nil); _ -> case J_3 < 0 of true -> lists:nth(erlang:length(A_2) + J_3 + 1, A_2); _ -> lists:nth(J_3 + 1, A_2) end end), Dist_5) of
    true -> maps:get((case erlang:is_map(A_2) of true -> maps:get(J_3, A_2, nil); _ -> case J_3 < 0 of true -> lists:nth(erlang:length(A_2) + J_3 + 1, A_2); _ -> lists:nth(J_3 + 1, A_2) end end), Dist_5, nil);
    _ -> 1000000000
end),
            Dj1 = (case maps:is_key((case erlang:is_map(A_2) of true -> maps:get((J_3 + 1), A_2, nil); _ -> case (J_3 + 1) < 0 of true -> lists:nth(erlang:length(A_2) + (J_3 + 1) + 1, A_2); _ -> lists:nth((J_3 + 1) + 1, A_2) end end), Dist_5) of
    true -> maps:get((case erlang:is_map(A_2) of true -> maps:get((J_3 + 1), A_2, nil); _ -> case (J_3 + 1) < 0 of true -> lists:nth(erlang:length(A_2) + (J_3 + 1) + 1, A_2); _ -> lists:nth((J_3 + 1) + 1, A_2) end end), Dist_5, nil);
    _ -> 1000000000
end),
            case (Dj > Dj1) of
        true -> T = (case erlang:is_map(A_2) of true -> maps:get(J_3, A_2, nil); _ -> case J_3 < 0 of true -> lists:nth(erlang:length(A_2) + J_3 + 1, A_2); _ -> lists:nth(J_3 + 1, A_2) end end),
            A_3 = lists:sublist(A_2, J_3) ++ [(case erlang:is_map(A_2) of true -> maps:get((J_3 + 1), A_2, nil); _ -> case (J_3 + 1) < 0 of true -> lists:nth(erlang:length(A_2) + (J_3 + 1) + 1, A_2); _ -> lists:nth((J_3 + 1) + 1, A_2) end end)] ++ lists:nthtail(J_3 + 1, A_2),
...
{Dist_7, Graph_3, H_3, I_8, N_2, Parent_6, S_2} = Fun_8(Dist_7, Graph_3, H_2, I_7, N_2, Parent_6, S_2),
    ...
    case (erlang:length(H_4) > 0) of
        true ->
            U_5 = (case erlang:is_map(H_4) of true -> maps:get(0, H_4, nil); _ -> case 0 < 0 of true -> lists:nth(erlang:length(H_4) + 0 + 1, H_4); _ -> lists:nth(0 + 1, H_4) end end),
    ...
    case List of
        ...
        [E_2|E_2_rest] ->
            V_4 = (case erlang:is_map(E_2) of true -> maps:get(0, E_2, nil); _ -> case 0 < 0 of true -> lists:nth(erlang:length(E_2) + 0 + 1, E_2); _ -> lists:nth(0 + 1, E_2) end end),
...
{Dist_9, Graph_3, H_6, I_8, Known_4, N_2, Parent_8, S_2} = Fun_10(Dist_7, Graph_3, H_4, I_8, Known_3, N_2, Parent_6, S_2),
    ...
    case (J_5 < N_2) of
        true ->
            case (J_5 /= S_2) of
        true -> Edges_5 = lists:append((case Edges_4 of nil -> []; _ -> Edges_4 end), [[(J_5 + 1), ((case erlang:is_map(Parent_8) of true -> maps:get(J_5, Parent_8, nil); _ -> case J_5 < 0 of true -> lists:nth(erlang:length(Parent_8) + J_5 + 1, Parent_8); _ -> lists:nth(J_5 + 1, Parent_8) end end) + 1)]]),
            Edges_6 = Edges_5;
        _ -> Edges_6 = Edges_4
    end,
            J_6 = (J_5 + 1),
...
print_edges(Edges_7) ->
    ...
    case (I_9 < erlang:length(Edges_7)) of
        true ->
            E_3 = (case erlang:is_map(Edges_7) of true -> maps:get(I_9, Edges_7, nil); _ -> case I_9 < 0 of true -> lists:nth(erlang:length(Edges_7) + I_9 + 1, Edges_7); _ -> lists:nth(I_9 + 1, Edges_7) end end),
            io:format("~ts~n", [mochi_repr((((("(" ++ mochi_str((case erlang:is_map(E_3) of true -> maps:get(0, E_3, nil); _ -> case 0 < 0 of true -> lists:nth(erlang:length(E_3) + 0 + 1, E_3); _ -> lists:nth(0 + 1, E_3) end end))) ++ ", ") ++ mochi_str((case erlang:is_map(E_3) of true -> maps:get(1, E_3, nil); _ -> case 1 < 0 of true -> lists:nth(erlang:length(E_3) + 1 + 1, E_3); _ -> lists:nth(1 + 1, E_3) end end))) ++ ")"))]),
            I_10 = (I_9 + 1),

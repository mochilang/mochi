...
dfs_recursive(G_8, Start_vertex, Visited, Order) ->
    ...
    case (I_7 < maps:size(Neighbors)) of
        true ->
            ...
            case mochi_not((case erlang:is_map(Visited_2) of true -> maps:get(Nb, Visited_2, nil); _ -> case Nb < 0 of true -> mochi_nth(erlang:length(Visited_2) + Nb + 1, Visited_2); _ -> mochi_nth(Nb + 1, Visited_2) end end)) of
...
{G_9, I_11, N, Visited_4} = Fun_6(G_9, I_10, N, Visited_3),
    ...
    case (I_12 < N) of
        true ->
            case mochi_not((case erlang:is_map(Visited_4) of true -> maps:get(I_12, Visited_4, nil); _ -> case I_12 < 0 of true -> mochi_nth(erlang:length(Visited_4) + I_12 + 1, Visited_4); _ -> mochi_nth(I_12 + 1, Visited_4) end end)) of

...
{Graph_2, Graph_size, Visited_4} = Fun_2(lists:seq(0, (Graph_size) - 1), Graph_2, Graph_size, Visited_3),
    ...
    case List of
        ...
        [I|I_rest] ->
            case mochi_not((case erlang:is_map(Visited_4) of true -> maps:get(I, Visited_4, nil); _ -> case I < 0 of true -> mochi_nth(erlang:length(Visited_4) + I + 1, Visited_4); _ -> mochi_nth(I + 1, Visited_4) end end)) of

...
main(_) ->
    ...
    case (I < erlang:length(erlang:get('heap'))) of
        true ->
            case (maps:get("cost", (case erlang:is_map(erlang:get('heap')) of true -> maps:get(I, erlang:get('heap'), nil); _ -> case I < 0 of true -> lists:nth(erlang:length(erlang:get('heap')) + I + 1, erlang:get('heap')); _ -> lists:nth(I + 1, erlang:get('heap')) end end), nil) < maps:get("cost", (case erlang:is_map(erlang:get('heap')) of true -> maps:get(Best_idx, erlang:get('heap'), nil); _ -> case Best_idx < 0 of true -> lists:nth(erlang:length(erlang:get('heap')) + Best_idx + 1, erlang:get('heap')); _ -> lists:nth(Best_idx + 1, erlang:get('heap')) end end), nil)) of
        true -> Best_idx_2 = I,
...
{Best_idx_3, I_2} = Fun(Best_idx, I),
                Best = (case erlang:is_map(erlang:get('heap')) of true -> maps:get(Best_idx_3, erlang:get('heap'), nil); _ -> case Best_idx_3 < 0 of true -> lists:nth(erlang:length(erlang:get('heap')) + Best_idx_3 + 1, erlang:get('heap')); _ -> lists:nth(Best_idx_3 + 1, erlang:get('heap')) end end),
                New_heap = [],
                J = 0,
    ...
    case (J < erlang:length(erlang:get('heap'))) of
        ...
        true -> New_heap_2 = lists:append((case New_heap of nil -> []; _ -> New_heap end), [(case erlang:is_map(erlang:get('heap')) of true -> maps:get(J, erlang:get('heap'), nil); _ -> case J < 0 of true -> lists:nth(erlang:length(erlang:get('heap')) + J + 1, erlang:get('heap')); _ -> lists:nth(J + 1, erlang:get('heap')) end end)]),
...
{} = Fun_4(),
    ...
    case (I2 < erlang:length(erlang:get('heap2'))) of
        true ->
            case (maps:get("cost", (case erlang:is_map(erlang:get('heap2')) of true -> maps:get(I2, erlang:get('heap2'), nil); _ -> case I2 < 0 of true -> lists:nth(erlang:length(erlang:get('heap2')) + I2 + 1, erlang:get('heap2')); _ -> lists:nth(I2 + 1, erlang:get('heap2')) end end), nil) < maps:get("cost", (case erlang:is_map(erlang:get('heap2')) of true -> maps:get(Best2_idx, erlang:get('heap2'), nil); _ -> case Best2_idx < 0 of true -> lists:nth(erlang:length(erlang:get('heap2')) + Best2_idx + 1, erlang:get('heap2')); _ -> lists:nth(Best2_idx + 1, erlang:get('heap2')) end end), nil)) of
        true -> Best2_idx_2 = I2,
...
{Best2_idx_3, I2_2} = Fun_5(Best2_idx, I2),
                Best2 = (case erlang:is_map(erlang:get('heap2')) of true -> maps:get(Best2_idx_3, erlang:get('heap2'), nil); _ -> case Best2_idx_3 < 0 of true -> lists:nth(erlang:length(erlang:get('heap2')) + Best2_idx_3 + 1, erlang:get('heap2')); _ -> lists:nth(Best2_idx_3 + 1, erlang:get('heap2')) end end),
                New_heap2 = [],
                J2 = 0,
    ...
    case (J2 < erlang:length(erlang:get('heap2'))) of
        ...
        true -> New_heap2_2 = lists:append((case New_heap2 of nil -> []; _ -> New_heap2 end), [(case erlang:is_map(erlang:get('heap2')) of true -> maps:get(J2, erlang:get('heap2'), nil); _ -> case J2 < 0 of true -> lists:nth(erlang:length(erlang:get('heap2')) + J2 + 1, erlang:get('heap2')); _ -> lists:nth(J2 + 1, erlang:get('heap2')) end end)]),
...
{} = Fun_8(),
    ...
    case (I3 < erlang:length(erlang:get('heap3'))) of
        true ->
            case (maps:get("cost", (case erlang:is_map(erlang:get('heap3')) of true -> maps:get(I3, erlang:get('heap3'), nil); _ -> case I3 < 0 of true -> lists:nth(erlang:length(erlang:get('heap3')) + I3 + 1, erlang:get('heap3')); _ -> lists:nth(I3 + 1, erlang:get('heap3')) end end), nil) < maps:get("cost", (case erlang:is_map(erlang:get('heap3')) of true -> maps:get(Best3_idx, erlang:get('heap3'), nil); _ -> case Best3_idx < 0 of true -> lists:nth(erlang:length(erlang:get('heap3')) + Best3_idx + 1, erlang:get('heap3')); _ -> lists:nth(Best3_idx + 1, erlang:get('heap3')) end end), nil)) of
        true -> Best3_idx_2 = I3,
...
{Best3_idx_3, I3_2} = Fun_9(Best3_idx, I3),
                Best3 = (case erlang:is_map(erlang:get('heap3')) of true -> maps:get(Best3_idx_3, erlang:get('heap3'), nil); _ -> case Best3_idx_3 < 0 of true -> lists:nth(erlang:length(erlang:get('heap3')) + Best3_idx_3 + 1, erlang:get('heap3')); _ -> lists:nth(Best3_idx_3 + 1, erlang:get('heap3')) end end),
                New_heap3 = [],
                J3 = 0,
    ...
    case (J3 < erlang:length(erlang:get('heap3'))) of
        ...
        true -> New_heap3_2 = lists:append((case New_heap3 of nil -> []; _ -> New_heap3 end), [(case erlang:is_map(erlang:get('heap3')) of true -> maps:get(J3, erlang:get('heap3'), nil); _ -> case J3 < 0 of true -> lists:nth(erlang:length(erlang:get('heap3')) + J3 + 1, erlang:get('heap3')); _ -> lists:nth(J3 + 1, erlang:get('heap3')) end end)]),

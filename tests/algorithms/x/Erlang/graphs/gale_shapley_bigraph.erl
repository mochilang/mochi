...
remove_item(Xs_2, X_2) ->
    ...
    case (I_3 < erlang:length(Xs_2)) of
        true ->
            case (mochi_not(Removed) andalso ((case erlang:is_map(Xs_2) of true -> maps:get(I_3, Xs_2, nil); _ -> case I_3 < 0 of true -> lists:nth(erlang:length(Xs_2) + I_3 + 1, Xs_2); _ -> lists:nth(I_3 + 1, Xs_2) end end) == X_2)) of
        true -> Removed_2 = true,
            Removed_3 = Removed_2,
            Res_3 = Res;
        _ -> Res_2 = lists:append((case Res of nil -> []; _ -> Res end), [(case erlang:is_map(Xs_2) of true -> maps:get(I_3, Xs_2, nil); _ -> case I_3 < 0 of true -> lists:nth(erlang:length(Xs_2) + I_3 + 1, Xs_2); _ -> lists:nth(I_3 + 1, Xs_2) end end)]),
            Removed_3 = Removed,
            Res_3 = Res_2
    end,
            I_4 = (I_3 + 1),
...
stable_matching(Donor_pref, Recipient_pref) ->
    try
        ...
        true -> erlang:error("unequal groups");
        _ -> ok
    end,
...
{Donor_pref, Donor_record_2, I_12, N, Num_donations_2, Rec_record_2, Recipient_pref, Unmatched_2} = Fun_6(Donor_pref, Donor_record_2, I_11, N, Num_donations, Rec_record_2, Recipient_pref, Unmatched_2),
    ...
    case (erlang:length(Unmatched_2) > 0) of
        true ->
            Donor = (case erlang:is_map(Unmatched_2) of true -> maps:get(0, Unmatched_2, nil); _ -> case 0 < 0 of true -> lists:nth(erlang:length(Unmatched_2) + 0 + 1, Unmatched_2); _ -> lists:nth(0 + 1, Unmatched_2) end end),
            Donor_preference = (case erlang:is_map(Donor_pref) of true -> maps:get(Donor, Donor_pref, nil); _ -> case Donor < 0 of true -> lists:nth(erlang:length(Donor_pref) + Donor + 1, Donor_pref); _ -> lists:nth(Donor + 1, Donor_pref) end end),
            Recipient = (case erlang:is_map(Donor_preference) of true -> maps:get((case erlang:is_map(Num_donations_2) of true -> maps:get(Donor, Num_donations_2, nil); _ -> case Donor < 0 of true -> lists:nth(erlang:length(Num_donations_2) + Donor + 1, Num_donations_2); _ -> lists:nth(Donor + 1, Num_donations_2) end end), Donor_preference, nil); _ -> case (case erlang:is_map(Num_donations_2) of true -> maps:get(Donor, Num_donations_2, nil); _ -> case Donor < 0 of true -> lists:nth(erlang:length(Num_donations_2) + Donor + 1, Num_donations_2); _ -> lists:nth(Donor + 1, Num_donations_2) end end) < 0 of true -> lists:nth(erlang:length(Donor_preference) + (case erlang:is_map(Num_donations_2) of true -> maps:get(Donor, Num_donations_2, nil); _ -> case Donor < 0 of true -> lists:nth(erlang:length(Num_donations_2) + Donor + 1, Num_donations_2); _ -> lists:nth(Donor + 1, Num_donations_2) end end) + 1, Donor_preference); _ -> lists:nth((case erlang:is_map(Num_donations_2) of true -> maps:get(Donor, Num_donations_2, nil); _ -> case Donor < 0 of true -> lists:nth(erlang:length(Num_donations_2) + Donor + 1, Num_donations_2); _ -> lists:nth(Donor + 1, Num_donations_2) end end) + 1, Donor_preference) end end),
            Num_donations_3 = lists:sublist(Num_donations_2, Donor) ++ [((case erlang:is_map(Num_donations_2) of true -> maps:get(Donor, Num_donations_2, nil); _ -> case Donor < 0 of true -> lists:nth(erlang:length(Num_donations_2) + Donor + 1, Num_donations_2); _ -> lists:nth(Donor + 1, Num_donations_2) end end) + 1)] ++ lists:nthtail(Donor + 1, Num_donations_2),
            Rec_preference = (case erlang:is_map(Recipient_pref) of true -> maps:get(Recipient, Recipient_pref, nil); _ -> case Recipient < 0 of true -> lists:nth(erlang:length(Recipient_pref) + Recipient + 1, Recipient_pref); _ -> lists:nth(Recipient + 1, Recipient_pref) end end),
            Prev_donor = (case erlang:is_map(Rec_record_2) of true -> maps:get(Recipient, Rec_record_2, nil); _ -> case Recipient < 0 of true -> lists:nth(erlang:length(Rec_record_2) + Recipient + 1, Rec_record_2); _ -> lists:nth(Recipient + 1, Rec_record_2) end end),

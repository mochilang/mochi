...
pairs_to_string(Edges) ->
    ...
    case (I < erlang:length(Edges)) of
        true ->
            E = (case erlang:is_map(Edges) of true -> maps:get(I, Edges, nil); _ -> case I < 0 of true -> lists:nth(erlang:length(Edges) + I + 1, Edges); _ -> lists:nth(I + 1, Edges) end end),
...
{Dist_2, Graph, I_4, N, Parent_2, Visited_2} = Fun_2(Dist, Graph, I_3, N, Parent, Visited),
    ...
    case (V < N) of
        true ->
            case (((case erlang:is_map(Visited_2) of true -> maps:get(V, Visited_2, nil); _ -> case V < 0 of true -> lists:nth(erlang:length(Visited_2) + V + 1, Visited_2); _ -> lists:nth(V + 1, Visited_2) end end) == false) andalso ((case erlang:is_map(Dist_3) of true -> maps:get(V, Dist_3, nil); _ -> case V < 0 of true -> lists:nth(erlang:length(Dist_3) + V + 1, Dist_3); _ -> lists:nth(V + 1, Dist_3) end end) < Min_val)) of
        true -> Min_val_2 = (case erlang:is_map(Dist_3) of true -> maps:get(V, Dist_3, nil); _ -> case V < 0 of true -> lists:nth(erlang:length(Dist_3) + V + 1, Dist_3); _ -> lists:nth(V + 1, Dist_3) end end),
            U_2 = V,
            Min_val_3 = Min_val_2,
            U_3 = U_2;
        _ -> Min_val_3 = Min_val,
...
{Count, Dist_3, Graph, I_4, Min_val_3, N, Parent_2, Result, U_3, V_2, Visited_2} = Fun_3(Count, Dist_3, Graph, I_4, Min_val, N, Parent_2, Result, U, V, Visited_2),
        ...
        _ -> ok
                ...
                case (U_3 /= 0) of
        true -> Result_2 = lists:append((case Result of nil -> []; _ -> Result end), [#{"u" => (case erlang:is_map(Parent_2) of true -> maps:get(U_3, Parent_2, nil); _ -> case U_3 < 0 of true -> lists:nth(erlang:length(Parent_2) + U_3 + 1, Parent_2); _ -> lists:nth(U_3 + 1, Parent_2) end end), "v" => U_3}]),
            Result_3 = Result_2;
        _ -> Result_3 = Result
    end,
    ...
    case List of
        ...
        [E_2|E_2_rest] ->
            case (((case erlang:is_map(Visited_3) of true -> maps:get(maps:get("to", E_2, nil), Visited_3, nil); _ -> case maps:get("to", E_2, nil) < 0 of true -> lists:nth(erlang:length(Visited_3) + maps:get("to", E_2, nil) + 1, Visited_3); _ -> lists:nth(maps:get("to", E_2, nil) + 1, Visited_3) end end) == false) andalso (maps:get("weight", E_2, nil) < (case erlang:is_map(Dist_3) of true -> maps:get(maps:get("to", E_2, nil), Dist_3, nil); _ -> case maps:get("to", E_2, nil) < 0 of true -> lists:nth(erlang:length(Dist_3) + maps:get("to", E_2, nil) + 1, Dist_3); _ -> lists:nth(maps:get("to", E_2, nil) + 1, Dist_3) end end))) of
...
{Count, Dist_5, Graph, I_4, Min_val_3, N, Parent_4, Result_3, U_3, V_2, Visited_3} = Fun_4((case erlang:is_map(Graph) of true -> maps:get(U_3, Graph, nil); _ -> case U_3 < 0 of true -> lists:nth(erlang:length(Graph) + U_3 + 1, Graph); _ -> lists:nth(U_3 + 1, Graph) end end), Count, Dist_3, Graph, I_4, Min_val_3, N, Parent_2, Result_3, U_3, V_2, Visited_3),
                Count_2 = (Count + 1),

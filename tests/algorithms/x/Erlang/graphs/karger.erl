...
contains(List, Value) ->
    ...
    case (I < erlang:length(List)) of
        true ->
            case ((case erlang:is_map(List) of true -> maps:get(I, List, nil); _ -> case I < 0 of true -> lists:nth(erlang:length(List) + I + 1, List); _ -> lists:nth(I + 1, List) end end) == Value) of
...
remove_all(List_2, Value_2) ->
    ...
    case (I_3 < erlang:length(List_2)) of
        true ->
            case ((case erlang:is_map(List_2) of true -> maps:get(I_3, List_2, nil); _ -> case I_3 < 0 of true -> lists:nth(erlang:length(List_2) + I_3 + 1, List_2); _ -> lists:nth(I_3 + 1, List_2) end end) /= Value_2) of
        true -> Res_2 = lists:append((case Res of nil -> []; _ -> Res end), [(case erlang:is_map(List_2) of true -> maps:get(I_3, List_2, nil); _ -> case I_3 < 0 of true -> lists:nth(erlang:length(List_2) + I_3 + 1, List_2); _ -> lists:nth(I_3 + 1, List_2) end end)]),
            Res_3 = Res_2;
        _ -> Res_3 = Res
    end,
            I_4 = (I_3 + 1),
...
{Contracted_2, Graph} = Fun_3(maps:keys(Graph), Contracted, Graph),
    ...
    case (I_5 < erlang:length(Neigh)) of
        true ->
            Lst_2 = lists:append((case Lst of nil -> []; _ -> Lst end), [(case erlang:is_map(Neigh) of true -> maps:get(I_5, Neigh, nil); _ -> case I_5 < 0 of true -> lists:nth(erlang:length(Neigh) + I_5 + 1, Neigh); _ -> lists:nth(I_5 + 1, Neigh) end end)]),
            I_6 = (I_5 + 1),
...
{Contracted_2, Graph, Graph_copy_2} = Fun_4(maps:keys(Graph), Contracted_2, Graph, Graph_copy),
    ...
    case (erlang:length(Nodes) > 2) of
        true ->
            U = (case erlang:is_map(Nodes) of true -> maps:get(rand_int(erlang:length(Nodes)), Nodes, nil); _ -> case rand_int(erlang:length(Nodes)) < 0 of true -> lists:nth(erlang:length(Nodes) + rand_int(erlang:length(Nodes)) + 1, Nodes); _ -> lists:nth(rand_int(erlang:length(Nodes)) + 1, Nodes) end end),
            U_neighbors = maps:get(U, Graph_copy_2, nil),
            V = (case erlang:is_map(U_neighbors) of true -> maps:get(rand_int(erlang:length(U_neighbors)), U_neighbors, nil); _ -> case rand_int(erlang:length(U_neighbors)) < 0 of true -> lists:nth(erlang:length(U_neighbors) + rand_int(erlang:length(U_neighbors)) + 1, U_neighbors); _ -> lists:nth(rand_int(erlang:length(U_neighbors)) + 1, U_neighbors) end end),
            Uv = (U ++ V),
            Uv_neighbors = [],
            I_7 = 0,
    ...
    case (I_7 < erlang:length(maps:get(U, Graph_copy_2, nil))) of
        true ->
            N_2 = (case erlang:is_map(maps:get(U, Graph_copy_2, nil)) of true -> maps:get(I_7, maps:get(U, Graph_copy_2, nil), nil); _ -> case I_7 < 0 of true -> lists:nth(erlang:length(maps:get(U, Graph_copy_2, nil)) + I_7 + 1, maps:get(U, Graph_copy_2, nil)); _ -> lists:nth(I_7 + 1, maps:get(U, Graph_copy_2, nil)) end end),
...
{Contracted_2, Graph, Graph_copy_2, I_8, Nodes, U, U_neighbors, Uv, Uv_neighbors_3, V} = Fun_6(Contracted_2, Graph, Graph_copy_2, I_7, Nodes, U, U_neighbors, Uv, Uv_neighbors, V),
    ...
    case (I_9 < erlang:length(maps:get(V, Graph_copy_2, nil))) of
        true ->
            N_3 = (case erlang:is_map(maps:get(V, Graph_copy_2, nil)) of true -> maps:get(I_9, maps:get(V, Graph_copy_2, nil), nil); _ -> case I_9 < 0 of true -> lists:nth(erlang:length(maps:get(V, Graph_copy_2, nil)) + I_9 + 1, maps:get(V, Graph_copy_2, nil)); _ -> lists:nth(I_9 + 1, maps:get(V, Graph_copy_2, nil)) end end),
...
{Contracted_2, Graph, Graph_copy_2, I_10, Nodes, U, U_neighbors, Uv, Uv_neighbors_5, V} = Fun_7(Contracted_2, Graph, Graph_copy_2, I_9, Nodes, U, U_neighbors, Uv, Uv_neighbors_3, V),
    ...
    case (K < erlang:length(Uv_neighbors_5)) of
        true ->
            Nb = (case erlang:is_map(Uv_neighbors_5) of true -> maps:get(K, Uv_neighbors_5, nil); _ -> case K < 0 of true -> lists:nth(erlang:length(Uv_neighbors_5) + K + 1, Uv_neighbors_5); _ -> lists:nth(K + 1, Uv_neighbors_5) end end),
...
{Contracted_2, Graph, Graph_copy_6, I_10, K_2, Nodes, U, U_neighbors, Uv, Uv_neighbors_5, V} = Fun_8(Contracted_2, Graph, Graph_copy_3, I_10, K, Nodes, U, U_neighbors, Uv, Uv_neighbors_5, V),
    ...
    case (I_11 < erlang:length(maps:get(U, Contracted_2, nil))) of
        true ->
            Group_2 = lists:append((case Group of nil -> []; _ -> Group end), [(case erlang:is_map(maps:get(U, Contracted_2, nil)) of true -> maps:get(I_11, maps:get(U, Contracted_2, nil), nil); _ -> case I_11 < 0 of true -> lists:nth(erlang:length(maps:get(U, Contracted_2, nil)) + I_11 + 1, maps:get(U, Contracted_2, nil)); _ -> lists:nth(I_11 + 1, maps:get(U, Contracted_2, nil)) end end)]),
            I_12 = (I_11 + 1),
...
{Contracted_2, Graph, Graph_copy_6, Group_2, I_12, K_2, Nodes, U, U_neighbors, Uv, Uv_neighbors_5, V} = Fun_9(Contracted_2, Graph, Graph_copy_6, Group, I_11, K_2, Nodes, U, U_neighbors, Uv, Uv_neighbors_5, V),
    ...
    case (I_13 < erlang:length(maps:get(V, Contracted_2, nil))) of
        true ->
            Val = (case erlang:is_map(maps:get(V, Contracted_2, nil)) of true -> maps:get(I_13, maps:get(V, Contracted_2, nil), nil); _ -> case I_13 < 0 of true -> lists:nth(erlang:length(maps:get(V, Contracted_2, nil)) + I_13 + 1, maps:get(V, Contracted_2, nil)); _ -> lists:nth(I_13 + 1, maps:get(V, Contracted_2, nil)) end end),
...
{Contracted_3, Graph, Graph_copy_6, Nodes_4} = Fun_11(Contracted_2, Graph, Graph_copy_2, Nodes),
    ...
    case (J < erlang:length(Nodes_4)) of
        true ->
            N_4 = (case erlang:is_map(Nodes_4) of true -> maps:get(J, Nodes_4, nil); _ -> case J < 0 of true -> lists:nth(erlang:length(Nodes_4) + J + 1, Nodes_4); _ -> lists:nth(J + 1, Nodes_4) end end),
...
{Contracted_3, Graph, Graph_copy_6, Groups_2, J_2, Nodes_4} = Fun_12(Contracted_3, Graph, Graph_copy_6, Groups, J, Nodes_4),
        GroupA = (case erlang:is_map(Groups_2) of true -> maps:get(0, Groups_2, nil); _ -> case 0 < 0 of true -> lists:nth(erlang:length(Groups_2) + 0 + 1, Groups_2); _ -> lists:nth(0 + 1, Groups_2) end end),
        GroupB = (case erlang:is_map(Groups_2) of true -> maps:get(1, Groups_2, nil); _ -> case 1 < 0 of true -> lists:nth(erlang:length(Groups_2) + 1 + 1, Groups_2); _ -> lists:nth(1 + 1, Groups_2) end end),
        Cut = [],
        J_3 = 0,
    ...
    case (J_3 < erlang:length(GroupA)) of
        true ->
            Node_3 = (case erlang:is_map(GroupA) of true -> maps:get(J_3, GroupA, nil); _ -> case J_3 < 0 of true -> lists:nth(erlang:length(GroupA) + J_3 + 1, GroupA); _ -> lists:nth(J_3 + 1, GroupA) end end),
    ...
    case (L < erlang:length(Neigh_2)) of
        true ->
            Nb_2 = (case erlang:is_map(Neigh_2) of true -> maps:get(L, Neigh_2, nil); _ -> case L < 0 of true -> lists:nth(erlang:length(Neigh_2) + L + 1, Neigh_2); _ -> lists:nth(L + 1, Neigh_2) end end),
...
cut_to_string(Cut_4) ->
    ...
    case (I_15 < erlang:length(Cut_4)) of
        true ->
            P = (case erlang:is_map(Cut_4) of true -> maps:get(I_15, Cut_4, nil); _ -> case I_15 < 0 of true -> lists:nth(erlang:length(Cut_4) + I_15 + 1, Cut_4); _ -> lists:nth(I_15 + 1, Cut_4) end end),

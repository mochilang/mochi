...
dfs(U, Graph, Visited_edge, Path) ->
    ...
    case (I_3 < erlang:length(Neighbors)) of
        true ->
            V = (case erlang:is_map(Neighbors) of true -> maps:get(I_3, Neighbors, nil); _ -> case I_3 < 0 of true -> lists:nth(erlang:length(Neighbors) + I_3 + 1, Neighbors); _ -> lists:nth(I_3 + 1, Neighbors) end end),
            case ((case erlang:is_map((case erlang:is_map(Visited_edge) of true -> maps:get(U, Visited_edge, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Visited_edge) + U + 1, Visited_edge); _ -> lists:nth(U + 1, Visited_edge) end end)) of true -> maps:get(V, (case erlang:is_map(Visited_edge) of true -> maps:get(U, Visited_edge, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Visited_edge) + U + 1, Visited_edge); _ -> lists:nth(U + 1, Visited_edge) end end), nil); _ -> case V < 0 of true -> lists:nth(erlang:length((case erlang:is_map(Visited_edge) of true -> maps:get(U, Visited_edge, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Visited_edge) + U + 1, Visited_edge); _ -> lists:nth(U + 1, Visited_edge) end end)) + V + 1, (case erlang:is_map(Visited_edge) of true -> maps:get(U, Visited_edge, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Visited_edge) + U + 1, Visited_edge); _ -> lists:nth(U + 1, Visited_edge) end end)); _ -> lists:nth(V + 1, (case erlang:is_map(Visited_edge) of true -> maps:get(U, Visited_edge, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Visited_edge) + U + 1, Visited_edge); _ -> lists:nth(U + 1, Visited_edge) end end)) end end) == false) of

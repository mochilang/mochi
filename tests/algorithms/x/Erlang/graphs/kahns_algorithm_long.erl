...
{Graph, I_2, Indegree_2, J_2, Long_dist_2, N} = Fun_2(Graph, I_2, Indegree_2, J, Long_dist, N),
    ...
    case List of
        ...
        [V|V_rest] ->
            Indegree_3 = lists:sublist(Indegree_2, V) ++ [((case erlang:is_map(Indegree_2) of true -> maps:get(V, Indegree_2, nil); _ -> case V < 0 of true -> lists:nth(erlang:length(Indegree_2) + V + 1, Indegree_2); _ -> lists:nth(V + 1, Indegree_2) end end) + 1)] ++ lists:nthtail(V + 1, Indegree_2),
            Fun_3_loop(V_rest, Graph, I_2, Indegree_3, J_2, Long_dist_2, N, U);
        _ -> {Graph, I_2, Indegree_2, J_2, Long_dist_2, N, U}
    end
end,
{Graph, I_2, Indegree_3, J_2, Long_dist_2, N, U} = Fun_3((case erlang:is_map(Graph) of true -> maps:get(U, Graph, nil); _ -> case U < 0 of true -> lists:nth(erlang:length(Graph) + U + 1, Graph); _ -> lists:nth(U + 1, Graph) end end), Graph, I_2, Indegree_2, J_2, Long_dist_2, N, U),
            U_2 = (U + 1),
...
{Graph, I_2, Indegree_3, J_2, Long_dist_2, N, U_2} = Fun_4(Graph, I_2, Indegree_2, J_2, Long_dist_2, N, U),
    ...
    case (K < N) of
        true ->
            case ((case erlang:is_map(Indegree_3) of true -> maps:get(K, Indegree_3, nil); _ -> case K < 0 of true -> lists:nth(erlang:length(Indegree_3) + K + 1, Indegree_3); _ -> lists:nth(K + 1, Indegree_3) end end) == 0) of
...
{Graph, Head, I_2, Indegree_3, J_2, K_2, Long_dist_2, N, Queue_3, U_2} = Fun_5(Graph, Head, I_2, Indegree_3, J_2, K, Long_dist_2, N, Queue, U_2),
    ...
    case (Head < erlang:length(Queue_3)) of
        true ->
            Vertex = (case erlang:is_map(Queue_3) of true -> maps:get(Head, Queue_3, nil); _ -> case Head < 0 of true -> lists:nth(erlang:length(Queue_3) + Head + 1, Queue_3); _ -> lists:nth(Head + 1, Queue_3) end end),
            Head_2 = (Head + 1),
    ...
    case List of
        ...
        [X|X_rest] ->
            Indegree_4 = lists:sublist(Indegree_3, X) ++ [((case erlang:is_map(Indegree_3) of true -> maps:get(X, Indegree_3, nil); _ -> case X < 0 of true -> lists:nth(erlang:length(Indegree_3) + X + 1, Indegree_3); _ -> lists:nth(X + 1, Indegree_3) end end) - 1)] ++ lists:nthtail(X + 1, Indegree_3),
            New_dist = ((case erlang:is_map(Long_dist_2) of true -> maps:get(Vertex, Long_dist_2, nil); _ -> case Vertex < 0 of true -> lists:nth(erlang:length(Long_dist_2) + Vertex + 1, Long_dist_2); _ -> lists:nth(Vertex + 1, Long_dist_2) end end) + 1),
            case (New_dist > (case erlang:is_map(Long_dist_2) of true -> maps:get(X, Long_dist_2, nil); _ -> case X < 0 of true -> lists:nth(erlang:length(Long_dist_2) + X + 1, Long_dist_2); _ -> lists:nth(X + 1, Long_dist_2) end end)) of
        ...
        _ -> Long_dist_4 = Long_dist_2
            ...
            case ((case erlang:is_map(Indegree_4) of true -> maps:get(X, Indegree_4, nil); _ -> case X < 0 of true -> lists:nth(erlang:length(Indegree_4) + X + 1, Indegree_4); _ -> lists:nth(X + 1, Indegree_4) end end) == 0) of
...
{Graph, Head_2, I_2, Indegree_4, J_2, K_2, Long_dist_4, N, Queue_5, U_2, Vertex} = Fun_6((case erlang:is_map(Graph) of true -> maps:get(Vertex, Graph, nil); _ -> case Vertex < 0 of true -> lists:nth(erlang:length(Graph) + Vertex + 1, Graph); _ -> lists:nth(Vertex + 1, Graph) end end), Graph, Head_2, I_2, Indegree_3, J_2, K_2, Long_dist_2, N, Queue_3, U_2, Vertex),
...
{Graph, Head_2, I_2, Indegree_4, J_2, K_2, Long_dist_4, N, Queue_5, U_2} = Fun_7(Graph, Head, I_2, Indegree_3, J_2, K_2, Long_dist_2, N, Queue_3, U_2),
        Max_len = (case erlang:is_map(Long_dist_4) of true -> maps:get(0, Long_dist_4, nil); _ -> case 0 < 0 of true -> lists:nth(erlang:length(Long_dist_4) + 0 + 1, Long_dist_4); _ -> lists:nth(0 + 1, Long_dist_4) end end),
        M = 1,
        Fun_8 = fun Fun_8_loop(Graph, Head_2, I_2, Indegree_4, J_2, K_2, Long_dist_4, M, Max_len, N, Queue_5, U_2) ->
    case (M < N) of
        true ->
            case ((case erlang:is_map(Long_dist_4) of true -> maps:get(M, Long_dist_4, nil); _ -> case M < 0 of true -> lists:nth(erlang:length(Long_dist_4) + M + 1, Long_dist_4); _ -> lists:nth(M + 1, Long_dist_4) end end) > Max_len) of
        true -> Max_len_2 = (case erlang:is_map(Long_dist_4) of true -> maps:get(M, Long_dist_4, nil); _ -> case M < 0 of true -> lists:nth(erlang:length(Long_dist_4) + M + 1, Long_dist_4); _ -> lists:nth(M + 1, Long_dist_4) end end),
            Max_len_3 = Max_len_2;
        _ -> Max_len_3 = Max_len
    end,
            M_2 = (M + 1),

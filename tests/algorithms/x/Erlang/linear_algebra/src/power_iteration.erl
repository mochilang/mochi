...
main(_) ->
    ...
    erlang:put('input_matrix', [[41, 4, 20], [4, 26, 30], [20, 30, 50]]),
    erlang:put('vector', [41, 4, 20]),
    erlang:put('result', power_iteration(erlang:get('input_matrix'), erlang:get('vector'), 1.0e-12, 100)),

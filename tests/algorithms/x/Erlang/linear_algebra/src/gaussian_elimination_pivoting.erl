...
solve_linear_system(Matrix) ->
    try
        ...
        true -> erlang:error("Matrix is not square"),
            throw({return, []});
        _ -> ok
    end,
        Column_num = 0,
...
{Ab_6, Column_num_2, Matrix, Num_cols, Num_rows} = Fun_7(Ab, Column_num, Matrix, Num_cols, Num_rows),
    ...
    case (T < Num_rows) of
        true ->
            X_lst_2 = lists:append((case X_lst of nil -> []; _ -> X_lst end), [0]),
            T_2 = (T + 1),
...
main(_) ->
    ...
    erlang:put('example_matrix', [[5, -5, -3, 4, -11], [1, -4, 6, -4, -10], [-2, -5, 4, -5, -12], [-3, -3, 5, -5, 8]]),

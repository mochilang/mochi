...
sin_taylor(Angle) ->
    try
        X_3 = modf(Angle, mochi_safe_mul(2, 3.141592653589793)),
        case (X_3 > 3.141592653589793) of
        true -> X_4 = (X_3 - mochi_safe_mul(2, 3.141592653589793)),
            X_5 = X_4;
        _ -> X_5 = X_3
    end,
        Term = X_5,
...
cos_taylor(Angle_2) ->
    try
        X_6 = modf(Angle_2, mochi_safe_mul(2, 3.141592653589793)),
        case (X_6 > 3.141592653589793) of
        true -> X_7 = (X_6 - mochi_safe_mul(2, 3.141592653589793)),
            X_8 = X_7;
        _ -> X_8 = X_6
    end,
        Term_3 = 1,
...
reflection(Angle_5) ->
    try
        ...
        [[(mochi_safe_mul(2, C_3) - 1), mochi_safe_mul(2, Cs_2)], [mochi_safe_mul(2, Cs_2), (mochi_safe_mul(2, S_12) - 1)]]
    catch {return, Ret} -> Ret end.
...
main(_) ->
    ...
    io:format("~ts~n", [mochi_repr(("    scaling(5) = " ++ matrix_to_string(scaling(5))))]),
    io:format("~ts~n", [mochi_repr(("  rotation(45) = " ++ matrix_to_string(rotation(45))))]),
    io:format("~ts~n", [mochi_repr(("projection(45) = " ++ matrix_to_string(projection(45))))]),
    io:format("~ts~n", [mochi_repr(("reflection(45) = " ++ matrix_to_string(reflection(45))))]),

...
arcsin_taylor(X_2) ->
    ...
    case (N < 10) of
        true ->
            Num = mochi_safe_mul(mochi_safe_mul(mochi_safe_mul(mochi_safe_mul((mochi_safe_mul(2, float(N)) - 1), (mochi_safe_mul(2, float(N)) - 1)), X_2), X_2), Term),
            Den = mochi_safe_mul(mochi_safe_mul(2, float(N)), (mochi_safe_mul(2, float(N)) + 1)),
...
acos_taylor(X_3) ->
    try
        (mochi_safe_div(3.141592653589793, 2) - arcsin_taylor(X_3))
    catch {return, Ret} -> Ret end.
...
vector_angle(A_6, B_6, Deg) ->
    try
        ...
        case Deg of
        true -> Ang_2 = mochi_safe_div(mochi_safe_mul(Ang, 180), 3.141592653589793),
            Ang_3 = Ang_2;
        _ -> Ang_3 = Ang
    end,
        Ang_3
...
zero_vector(D) ->
    ...
    case (I_19 < D) of
        true ->
            Res_10 = lists:append((case Res_9 of nil -> []; _ -> Res_9 end), [0]),
            I_20 = (I_19 + 1),
...
unit_basis_vector(D_2, Pos_2) ->
    ...
    case (I_21 < D_2) of
        true ->
            case (I_21 == Pos_2) of
        true -> Res_12 = lists:append((case Res_11 of nil -> []; _ -> Res_11 end), [1]),
            Res_14 = Res_12;
        _ -> Res_13 = lists:append((case Res_11 of nil -> []; _ -> Res_11 end), [0]),
            Res_14 = Res_13
    end,
            I_22 = (I_21 + 1),
...
square_zero_matrix(N_4) ->
    ...
    case (J_14 < N_4) of
        true ->
            Row_12 = lists:append((case Row_11 of nil -> []; _ -> Row_11 end), [0]),
            J_15 = (J_14 + 1),
...
main() ->
    try
        ...
        M_9 = #{"data" => [[1, 2], [3, 4]], "width" => 2, "height" => 2},

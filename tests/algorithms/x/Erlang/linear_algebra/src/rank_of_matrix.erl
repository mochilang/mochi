...
rank_of_matrix(Matrix) ->
    ...
    case (Row < Rank) of
        true ->
            try
                case ((case erlang:is_map((case erlang:is_map(Matrix) of true -> maps:get(Row, Matrix, nil); _ -> case Row < 0 of true -> mochi_nth(erlang:length(Matrix) + Row + 1, Matrix); _ -> mochi_nth(Row + 1, Matrix) end end)) of true -> maps:get(Row, (case erlang:is_map(Matrix) of true -> maps:get(Row, Matrix, nil); _ -> case Row < 0 of true -> mochi_nth(erlang:length(Matrix) + Row + 1, Matrix); _ -> mochi_nth(Row + 1, Matrix) end end), nil); _ -> case Row < 0 of true -> mochi_nth(erlang:length((case erlang:is_map(Matrix) of true -> maps:get(Row, Matrix, nil); _ -> case Row < 0 of true -> mochi_nth(erlang:length(Matrix) + Row + 1, Matrix); _ -> mochi_nth(Row + 1, Matrix) end end)) + Row + 1, (case erlang:is_map(Matrix) of true -> maps:get(Row, Matrix, nil); _ -> case Row < 0 of true -> mochi_nth(erlang:length(Matrix) + Row + 1, Matrix); _ -> mochi_nth(Row + 1, Matrix) end end)); _ -> mochi_nth(Row + 1, (case erlang:is_map(Matrix) of true -> maps:get(Row, Matrix, nil); _ -> case Row < 0 of true -> mochi_nth(erlang:length(Matrix) + Row + 1, Matrix); _ -> mochi_nth(Row + 1, Matrix) end end)) end end) /= 0) of
        true -> Col = (Row + 1),
...
{Col_2, Columns, Matrix_2, Rank, Row, Rows} = Fun_2(Col, Columns, Matrix, Rank, Row, Rows),
    ...
    case (I_3 < Rows) of
        true ->
            try
                case ((case erlang:is_map((case erlang:is_map(Matrix) of true -> maps:get(I_3, Matrix, nil); _ -> case I_3 < 0 of true -> mochi_nth(erlang:length(Matrix) + I_3 + 1, Matrix); _ -> mochi_nth(I_3 + 1, Matrix) end end)) of true -> maps:get(Row, (case erlang:is_map(Matrix) of true -> maps:get(I_3, Matrix, nil); _ -> case I_3 < 0 of true -> mochi_nth(erlang:length(Matrix) + I_3 + 1, Matrix); _ -> mochi_nth(I_3 + 1, Matrix) end end), nil); _ -> case Row < 0 of true -> mochi_nth(erlang:length((case erlang:is_map(Matrix) of true -> maps:get(I_3, Matrix, nil); _ -> case I_3 < 0 of true -> mochi_nth(erlang:length(Matrix) + I_3 + 1, Matrix); _ -> mochi_nth(I_3 + 1, Matrix) end end)) + Row + 1, (case erlang:is_map(Matrix) of true -> maps:get(I_3, Matrix, nil); _ -> case I_3 < 0 of true -> mochi_nth(erlang:length(Matrix) + I_3 + 1, Matrix); _ -> mochi_nth(I_3 + 1, Matrix) end end)); _ -> mochi_nth(Row + 1, (case erlang:is_map(Matrix) of true -> maps:get(I_3, Matrix, nil); _ -> case I_3 < 0 of true -> mochi_nth(erlang:length(Matrix) + I_3 + 1, Matrix); _ -> mochi_nth(I_3 + 1, Matrix) end end)) end end) /= 0) of

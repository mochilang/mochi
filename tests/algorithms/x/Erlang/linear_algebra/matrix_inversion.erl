...
{Aug, I, J_2, Matrix, N, Row_2} = Fun(Aug, I, J, Matrix, N, Row),
    ...
    case (K < N) of
        true ->
            case (I == K) of
        true -> Row_3 = lists:append((case Row_2 of nil -> []; _ -> Row_2 end), [1]),
            Row_5 = Row_3;
        _ -> Row_4 = lists:append((case Row_2 of nil -> []; _ -> Row_2 end), [0]),
            Row_5 = Row_4
    end,
            K_2 = (K + 1),
...
{Aug_2, I_2, Matrix, N} = Fun_3(Aug, I, Matrix, N),
    ...
    case (R < N) of
        true ->
            try
                case ((case erlang:is_map((case erlang:is_map(Aug_2) of true -> maps:get(R, Aug_2, nil); _ -> case R < 0 of true -> mochi_nth(erlang:length(Aug_2) + R + 1, Aug_2); _ -> mochi_nth(R + 1, Aug_2) end end)) of true -> maps:get(Col, (case erlang:is_map(Aug_2) of true -> maps:get(R, Aug_2, nil); _ -> case R < 0 of true -> mochi_nth(erlang:length(Aug_2) + R + 1, Aug_2); _ -> mochi_nth(R + 1, Aug_2) end end), nil); _ -> case Col < 0 of true -> mochi_nth(erlang:length((case erlang:is_map(Aug_2) of true -> maps:get(R, Aug_2, nil); _ -> case R < 0 of true -> mochi_nth(erlang:length(Aug_2) + R + 1, Aug_2); _ -> mochi_nth(R + 1, Aug_2) end end)) + Col + 1, (case erlang:is_map(Aug_2) of true -> maps:get(R, Aug_2, nil); _ -> case R < 0 of true -> mochi_nth(erlang:length(Aug_2) + R + 1, Aug_2); _ -> mochi_nth(R + 1, Aug_2) end end)); _ -> mochi_nth(Col + 1, (case erlang:is_map(Aug_2) of true -> maps:get(R, Aug_2, nil); _ -> case R < 0 of true -> mochi_nth(erlang:length(Aug_2) + R + 1, Aug_2); _ -> mochi_nth(R + 1, Aug_2) end end)) end end) /= 0) of
        true -> Pivot_row_2 = R,
...
{Aug_2, Col, I_2, Matrix, N, Pivot_row_3, R_2} = Fun_4(Aug_2, Col, I_2, Matrix, N, Pivot_row, R),
                case ((case erlang:is_map((case erlang:is_map(Aug_2) of true -> maps:get(Pivot_row_3, Aug_2, nil); _ -> case Pivot_row_3 < 0 of true -> mochi_nth(erlang:length(Aug_2) + Pivot_row_3 + 1, Aug_2); _ -> mochi_nth(Pivot_row_3 + 1, Aug_2) end end)) of true -> maps:get(Col, (case erlang:is_map(Aug_2) of true -> maps:get(Pivot_row_3, Aug_2, nil); _ -> case Pivot_row_3 < 0 of true -> mochi_nth(erlang:length(Aug_2) + Pivot_row_3 + 1, Aug_2); _ -> mochi_nth(Pivot_row_3 + 1, Aug_2) end end), nil); _ -> case Col < 0 of true -> mochi_nth(erlang:length((case erlang:is_map(Aug_2) of true -> maps:get(Pivot_row_3, Aug_2, nil); _ -> case Pivot_row_3 < 0 of true -> mochi_nth(erlang:length(Aug_2) + Pivot_row_3 + 1, Aug_2); _ -> mochi_nth(Pivot_row_3 + 1, Aug_2) end end)) + Col + 1, (case erlang:is_map(Aug_2) of true -> maps:get(Pivot_row_3, Aug_2, nil); _ -> case Pivot_row_3 < 0 of true -> mochi_nth(erlang:length(Aug_2) + Pivot_row_3 + 1, Aug_2); _ -> mochi_nth(Pivot_row_3 + 1, Aug_2) end end)); _ -> mochi_nth(Col + 1, (case erlang:is_map(Aug_2) of true -> maps:get(Pivot_row_3, Aug_2, nil); _ -> case Pivot_row_3 < 0 of true -> mochi_nth(erlang:length(Aug_2) + Pivot_row_3 + 1, Aug_2); _ -> mochi_nth(Pivot_row_3 + 1, Aug_2) end end)) end end) == 0) of
        true -> erlang:error("Matrix is not invertible");
        _ -> ok
    end,

...
retroactive_resolution(Coefficients, Vector) ->
    ...
    case (I < Rows) of
        true ->
            Inner = [],
            Inner_2 = lists:append((case Inner of nil -> []; _ -> Inner end), [0]),
...
main(_) ->
    ...
    io:format("~ts~n", [mochi_repr(gaussian_elimination([[1, -4, -2], [5, 2, -2], [1, -1, 0]], [[-2], [-3], [4]]))]),
    io:format("~ts~n", [mochi_repr(gaussian_elimination([[1, 2], [5, 2]], [[5], [5]]))]),

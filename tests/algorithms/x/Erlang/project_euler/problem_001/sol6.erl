...
solution(N) ->
    try
        A = 3,
        Result = 0,
        Fun = fun Fun_loop(A, N, Result) ->
    case (A < N) of
        true ->
            Result_5 = (case ((mochi_mod(A, 3) == 0) orelse (mochi_mod(A, 5) == 0)) of
        true -> Result_2 = (Result + A),
            Result_2;
        _ -> Result_4 = (case (mochi_mod(A, 15) == 0) of
        ...
        _ -> Result
            ...
            A_2 = (A + 1),
            Fun_loop(A_2, N, Result_5);
        _ -> {A, N, Result}
    end
end,
{A_2, N, Result_5} = Fun(A, N, Result),
        Result_5

...
solution(N) ->
    try
        ...
        J = 2,
        Total = 0,
        Fun = fun Fun_loop(I, J, N, Total) ->
    case (J =< N) of
        true ->
            Total_3 = (case (mochi_mod(J, 2) == 0) of
        true -> Total_2 = (Total + J),
            Total_2;
        _ -> Total
    end),
            Next = (I + J),
            I_2 = J,
            J_2 = Next,
            Fun_loop(I_2, J_2, N, Total_3);
        _ -> {I, J, N, Total}
    end
end,
{I_2, J_2, N, Total_3} = Fun(I, J, N, Total),
        Total_3
...
main(_) ->
    ...
    erlang:put('result', solution(4000000)),

...
{A, B, Dp_2, I_4, M, N_2} = Fun_3(A, B, Dp, I_3, M, N_2),
    ...
    case (J_3 =< M) of
        true ->
            case (case erlang:is_map((case erlang:is_map(Dp_3) of true -> maps:get(I_5, Dp_3, nil); _ -> case I_5 < 0 of true -> lists:nth(erlang:length(Dp_3) + I_5 + 1, Dp_3); _ -> lists:nth(I_5 + 1, Dp_3) end end)) of true -> maps:get(J_3, (case erlang:is_map(Dp_3) of true -> maps:get(I_5, Dp_3, nil); _ -> case I_5 < 0 of true -> lists:nth(erlang:length(Dp_3) + I_5 + 1, Dp_3); _ -> lists:nth(I_5 + 1, Dp_3) end end), nil); _ -> case J_3 < 0 of true -> lists:nth(erlang:length((case erlang:is_map(Dp_3) of true -> maps:get(I_5, Dp_3, nil); _ -> case I_5 < 0 of true -> lists:nth(erlang:length(Dp_3) + I_5 + 1, Dp_3); _ -> lists:nth(I_5 + 1, Dp_3) end end)) + J_3 + 1, (case erlang:is_map(Dp_3) of true -> maps:get(I_5, Dp_3, nil); _ -> case I_5 < 0 of true -> lists:nth(erlang:length(Dp_3) + I_5 + 1, Dp_3); _ -> lists:nth(I_5 + 1, Dp_3) end end)); _ -> lists:nth(J_3 + 1, (case erlang:is_map(Dp_3) of true -> maps:get(I_5, Dp_3, nil); _ -> case I_5 < 0 of true -> lists:nth(erlang:length(Dp_3) + I_5 + 1, Dp_3); _ -> lists:nth(I_5 + 1, Dp_3) end end)) end end) of
...
{A, B, Dp_8, I_6, M, N_2} = Fun_5(A, B, Dp_3, I_5, M, N_2),
        (case erlang:is_map((case erlang:is_map(Dp_8) of true -> maps:get(N_2, Dp_8, nil); _ -> case N_2 < 0 of true -> lists:nth(erlang:length(Dp_8) + N_2 + 1, Dp_8); _ -> lists:nth(N_2 + 1, Dp_8) end end)) of true -> maps:get(M, (case erlang:is_map(Dp_8) of true -> maps:get(N_2, Dp_8, nil); _ -> case N_2 < 0 of true -> lists:nth(erlang:length(Dp_8) + N_2 + 1, Dp_8); _ -> lists:nth(N_2 + 1, Dp_8) end end), nil); _ -> case M < 0 of true -> lists:nth(erlang:length((case erlang:is_map(Dp_8) of true -> maps:get(N_2, Dp_8, nil); _ -> case N_2 < 0 of true -> lists:nth(erlang:length(Dp_8) + N_2 + 1, Dp_8); _ -> lists:nth(N_2 + 1, Dp_8) end end)) + M + 1, (case erlang:is_map(Dp_8) of true -> maps:get(N_2, Dp_8, nil); _ -> case N_2 < 0 of true -> lists:nth(erlang:length(Dp_8) + N_2 + 1, Dp_8); _ -> lists:nth(N_2 + 1, Dp_8) end end)); _ -> lists:nth(M + 1, (case erlang:is_map(Dp_8) of true -> maps:get(N_2, Dp_8, nil); _ -> case N_2 < 0 of true -> lists:nth(erlang:length(Dp_8) + N_2 + 1, Dp_8); _ -> lists:nth(N_2 + 1, Dp_8) end end)) end end)
    catch {return, Ret} -> Ret end.

...
main(_) ->
    ...
    io:format("~ts~n", [mochi_str(normalization([2, 7, 10, 20, 30, 50], 3))]),
    io:format("~ts~n", [mochi_str(normalization([5, 10, 15, 20, 25], 3))]),
    io:format("~ts~n", [mochi_str(standardization([2, 7, 10, 20, 30, 50], 3))]),
    io:format("~ts~n", [mochi_str(standardization([5, 10, 15, 20, 25], 3))]),

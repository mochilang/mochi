...
{Candidate_2, Candidates, Is_subsequence_3, Itemset_3, Length, Pruned} = Fun_11(Candidate_2, Candidate_2, Candidates, Is_subsequence, Itemset_3, Length, Pruned),
        ...
        true -> Pruned_2 = lists:append((case Pruned of nil -> []; _ -> Pruned end), [Candidate_2]),
            Pruned_3 = Pruned_2;
        _ -> Pruned_3 = Pruned
    end,
...
sort_strings(Xs_4) ->
    try
        Res_3 = [],
        Fun_12 = fun Fun_12_loop(List, Res_3, Xs_4) ->
    case List of
        [] -> {Res_3, Xs_4};
        [S_2|S_2_rest] ->
            Res_4 = lists:append((case Res_3 of nil -> []; _ -> Res_3 end), [S_2]),
            Fun_12_loop(S_2_rest, Res_4, Xs_4);
        _ -> {Res_3, Xs_4}
    end
end,
{Res_4, Xs_4} = Fun_12(Xs_4, Res_3, Xs_4),
        I_7 = 0,
        Fun_14 = fun Fun_14_loop(I_7, Res_4, Xs_4) ->
    case (I_7 < erlang:length(Res_4)) of
        true ->
            J = (I_7 + 1),
            Fun_13 = fun Fun_13_loop(I_7, J, Res_4, Xs_4) ->
    case (J < erlang:length(Res_4)) of
        ...
        _ -> Res_7 = Res_4,
            ...
            J_2 = (J + 1),
            Fun_13_loop(I_7, J_2, Res_7, Xs_4);
        _ -> {I_7, J, Res_4, Xs_4}
    end
end,
{I_7, J_2, Res_7, Xs_4} = Fun_13(I_7, J, Res_4, Xs_4),
            I_8 = (I_7 + 1),
            Fun_14_loop(I_8, Res_7, Xs_4);
        _ -> {I_7, Res_4, Xs_4}
    end
end,
{I_8, Res_7, Xs_4} = Fun_14(I_7, Res_4, Xs_4),
        Res_7
    catch {return, RetCatch} -> RetCatch end.
...
itemset_to_string(Xs_5) ->
    try
        S_3 = "[",
        I_9 = 0,
        Fun_15 = fun Fun_15_loop(I_9, S_3, Xs_5) ->
    case (I_9 < erlang:length(Xs_5)) of
        ...
        _ -> S_5 = S_3
            ...
            S_6 = (((S_5 ++ "'") ++ (case erlang:is_map(Xs_5) of true -> maps:get(I_9, Xs_5, nil); _ -> case I_9 < 0 of true -> mochi_nth(erlang:length(Xs_5) + I_9 + 1, Xs_5); _ -> mochi_nth(I_9 + 1, Xs_5) end end)) ++ "'"),
            I_10 = (I_9 + 1),
            Fun_15_loop(I_10, S_6, Xs_5);
        _ -> {I_9, S_3, Xs_5}
    end
end,
{I_10, S_6, Xs_5} = Fun_15(I_9, S_3, Xs_5),
        S_7 = (S_6 ++ "]"),
        S_7
    catch {return, RetCatch} -> RetCatch end.
...
apriori(Data, Min_support) ->
    try
        Itemset_4 = [],
        Fun_16 = fun Fun_16_loop(List, Data, Itemset_4, Min_support) ->
    case List of
        [] -> {Data, Itemset_4, Min_support};
        [Transaction_2|Transaction_2_rest] ->
            T = [],
            Fun_17 = fun Fun_17_loop(List, Data, Itemset_4, Min_support, T, Transaction_2) ->
    case List of
        [] -> {Data, Itemset_4, Min_support, T, Transaction_2};
        [V_2|V_2_rest] ->
            T_2 = lists:append((case T of nil -> []; _ -> T end), [V_2]),
            Fun_17_loop(V_2_rest, Data, Itemset_4, Min_support, T_2, Transaction_2);
        _ -> {Data, Itemset_4, Min_support, T, Transaction_2}
    end
end,
{Data, Itemset_4, Min_support, T_2, Transaction_2} = Fun_17(Transaction_2, Data, Itemset_4, Min_support, T, Transaction_2),
            Itemset_5 = lists:append((case Itemset_4 of nil -> []; _ -> Itemset_4 end), [T_2]),
            Fun_16_loop(Transaction_2_rest, Data, Itemset_5, Min_support);
        _ -> {Data, Itemset_4, Min_support}
    end
end,
{Data, Itemset_5, Min_support} = Fun_16(Data, Data, Itemset_4, Min_support),
        Frequent = [],
        Length_2 = 1,
        Fun_23 = fun Fun_23_loop(Data, Frequent, Itemset_5, Length_2, Min_support) ->
    case (erlang:length(Itemset_5) > 0) of
        true ->
            Counts = [],
            Idx = 0,
            Fun_18 = fun Fun_18_loop(Counts, Data, Frequent, Idx, Itemset_5, Length_2, Min_support) ->
    case (Idx < erlang:length(Itemset_5)) of
        true ->
            Counts_2 = lists:append((case Counts of nil -> []; _ -> Counts end), [0]),
            Idx_2 = (Idx + 1),
            Fun_18_loop(Counts_2, Data, Frequent, Idx_2, Itemset_5, Length_2, Min_support);
        _ -> {Counts, Data, Frequent, Idx, Itemset_5, Length_2, Min_support}
    end
end,
{Counts_2, Data, Frequent, Idx_2, Itemset_5, Length_2, Min_support} = Fun_18(Counts, Data, Frequent, Idx, Itemset_5, Length_2, Min_support),
            Fun_19 = fun Fun_19_loop(List, Counts_2, Data, Frequent, Idx_2, Itemset_5, Length_2, Min_support) ->
    case List of
        [] -> {Counts_2, Data, Frequent, Idx_2, Itemset_5, Length_2, Min_support};
        [Transaction_3|Transaction_3_rest] ->
            J_3 = 0,
            Fun_20 = fun Fun_20_loop(Counts_2, Data, Frequent, Idx_2, Itemset_5, J_3, Length_2, Min_support, Transaction_3) ->
    case (J_3 < erlang:length(Itemset_5)) of
        ...
        _ -> Counts_4 = Counts_2
            ...
            J_4 = (J_3 + 1),
            Fun_20_loop(Counts_4, Data, Frequent, Idx_2, Itemset_5, J_4, Length_2, Min_support, Transaction_3);
        _ -> {Counts_2, Data, Frequent, Idx_2, Itemset_5, J_3, Length_2, Min_support, Transaction_3}
    end
end,
{Counts_4, Data, Frequent, Idx_2, Itemset_5, J_4, Length_2, Min_support, Transaction_3} = Fun_20(Counts_2, Data, Frequent, Idx_2, Itemset_5, J_3, Length_2, Min_support, Transaction_3),
            Fun_19_loop(Transaction_3_rest, Counts_4, Data, Frequent, Idx_2, Itemset_5, Length_2, Min_support);
        _ -> {Counts_2, Data, Frequent, Idx_2, Itemset_5, Length_2, Min_support}
    end
end,
{Counts_4, Data, Frequent, Idx_2, Itemset_5, Length_2, Min_support} = Fun_19(Data, Counts_2, Data, Frequent, Idx_2, Itemset_5, Length_2, Min_support),
            New_itemset = [],
            K_2 = 0,
            Fun_21 = fun Fun_21_loop(Counts_4, Data, Frequent, Idx_2, Itemset_5, K_2, Length_2, Min_support, New_itemset) ->
    case (K_2 < erlang:length(Itemset_5)) of
        ...
        _ -> New_itemset_3 = New_itemset
            ...
            K_3 = (K_2 + 1),
            Fun_21_loop(Counts_4, Data, Frequent, Idx_2, Itemset_5, K_3, Length_2, Min_support, New_itemset_3);
        _ -> {Counts_4, Data, Frequent, Idx_2, Itemset_5, K_2, Length_2, Min_support, New_itemset}
    end
end,
{Counts_4, Data, Frequent, Idx_2, Itemset_5, K_3, Length_2, Min_support, New_itemset_3} = Fun_21(Counts_4, Data, Frequent, Idx_2, Itemset_5, K_2, Length_2, Min_support, New_itemset),
            Itemset_6 = New_itemset_3,
            M = 0,
            Fun_22 = fun Fun_22_loop(Counts_4, Data, Frequent, Idx_2, Itemset_6, K_3, Length_2, M, Min_support, New_itemset_3) ->
    case (M < erlang:length(Itemset_6)) of
        true ->
            ...
            M_2 = (M + 1),
            Fun_22_loop(Counts_4, Data, Frequent_2, Idx_2, Itemset_6, K_3, Length_2, M_2, Min_support, New_itemset_3);
        _ -> {Counts_4, Data, Frequent, Idx_2, Itemset_6, K_3, Length_2, M, Min_support, New_itemset_3}
    end
end,
{Counts_4, Data, Frequent_2, Idx_2, Itemset_6, K_3, Length_2, M_2, Min_support, New_itemset_3} = Fun_22(Counts_4, Data, Frequent, Idx_2, Itemset_6, K_3, Length_2, M, Min_support, New_itemset_3),
            Length_3 = (Length_2 + 1),
            Combos = combinations_lists(Itemset_6, Length_3),
            Itemset_7 = prune(Itemset_6, Combos, Length_3),
            Fun_23_loop(Data, Frequent_2, Itemset_7, Length_3, Min_support);
        _ -> {Data, Frequent, Itemset_5, Length_2, Min_support}
    end
end,
{Data, Frequent_2, Itemset_7, Length_3, Min_support} = Fun_23(Data, Frequent, Itemset_5, Length_2, Min_support),
        Frequent_2
    catch {return, RetCatch} -> RetCatch end.
...
{} = Fun_24(erlang:get('frequent_itemsets')),

...
{Best_error, Best_feature, Best_left, Best_right, Best_threshold, F, Features, I_3, J_2, Left_3, Num_features, Residuals, Right_3, Threshold} = Fun_2(Best_error, Best_feature, Best_left, Best_right, Best_threshold, F, Features, I_3, J, Left, Num_features, Residuals, Right, Threshold),
            case ((erlang:length(Left_3) /= 0) andalso (erlang:length(Right_3) /= 0)) of
...
predict(Model_3, X_2) ->
    ...
    case (I_7 < erlang:length(Model_3)) of
        true ->
            ...
            case ((case erlang:is_map(X_2) of true -> maps:get(maps:get("feature", S_2, nil), X_2, nil); _ -> case maps:get("feature", S_2, nil) < 0 of true -> mochi_nth(erlang:length(X_2) + maps:get("feature", S_2, nil) + 1, X_2); _ -> mochi_nth(maps:get("feature", S_2, nil) + 1, X_2) end end) < maps:get("threshold", S_2, nil)) of

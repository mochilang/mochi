...
main(_) ->
    ...
    erlang:put('train_data', [#{"x" => [5, 2, 3], "y" => 15}, #{"x" => [6, 5, 9], "y" => 25}, #{"x" => [11, 12, 13], "y" => 41}, #{"x" => [1, 1, 1], "y" => 8}, #{"x" => [11, 12, 13], "y" => 41}]),
    erlang:put('test_data', [#{"x" => [515, 22, 13], "y" => 555}, #{"x" => [61, 35, 49], "y" => 150}]),
    erlang:put('parameter_vector', [2, 4, 1, 5]),

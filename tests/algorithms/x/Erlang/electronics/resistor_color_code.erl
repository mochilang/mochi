...
get_significant_digits(Colors) ->
    ...
    case List of
        ...
        true -> erlang:error((Color ++ " is not a valid color for significant figure bands"));
        _ -> ok
    end,
            Digit_2 = ((Digit * 10) + (case erlang:is_map(erlang:get('significant_figures_color_values')) of true -> maps:get(Color, erlang:get('significant_figures_color_values'), nil); _ -> case Color < 0 of true -> lists:nth(erlang:length(erlang:get('significant_figures_color_values')) + Color + 1, erlang:get('significant_figures_color_values')); _ -> lists:nth(Color + 1, erlang:get('significant_figures_color_values')) end end)),
...
get_multiplier(Color_2) ->
    try
        ...
        true -> erlang:error((Color_2 ++ " is not a valid color for multiplier band"));
        _ -> ok
    end,
...
get_tolerance(Color_3) ->
    try
        ...
        true -> erlang:error((Color_3 ++ " is not a valid color for tolerance band"));
        _ -> ok
    end,
...
get_temperature_coeffecient(Color_4) ->
    try
        ...
        true -> erlang:error((Color_4 ++ " is not a valid color for temperature coeffecient band"));
        _ -> ok
    end,
...
get_band_type_count(Total, Typ) ->
    try
        ...
        _ -> ok
            ...
            erlang:error((Typ ++ " is not valid for a 3 band resistor"));
        _ -> case (Total == 4) of
        true -> case (Typ == "significant") of
        true -> throw({return, 2});
        _ -> ok
        ...
        _ -> ok
            ...
            erlang:error((Typ ++ " is not valid for a 4 band resistor"));
        _ -> case (Total == 5) of
        true -> case (Typ == "significant") of
        true -> throw({return, 3});
        _ -> ok
        ...
        _ -> ok
            ...
            erlang:error((Typ ++ " is not valid for a 5 band resistor"));
        _ -> case (Total == 6) of
        true -> case (Typ == "significant") of
        true -> throw({return, 3});
        _ -> ok
        ...
        _ -> ok
            ...
            erlang:error((Typ ++ " is not valid for a 6 band resistor"));
        _ -> erlang:error((mochi_str(Total) ++ " is not a valid number of bands"))
    end
    end
    end
    end,
...
check_validity(Number_of_bands, Colors_2) ->
    try
        ...
        true -> erlang:error("Invalid number of bands. Resistor bands must be 3 to 6");
        _ -> ok
    end,
        case (Number_of_bands /= erlang:length(Colors_2)) of
        true -> erlang:error((((("Expecting " ++ mochi_str(Number_of_bands)) ++ " colors, provided ") ++ mochi_str(erlang:length(Colors_2))) ++ " colors"));
        _ -> ok
    end,
    ...
    case List of
        ...
        true -> erlang:error((Color_5 ++ " is not a valid color"));
        _ -> ok
    end,
...
calculate_resistance(Number_of_bands_2, Color_code_list) ->
    try
        ...
        Multiplier_color = (case erlang:is_map(Color_code_list) of true -> maps:get(Sig_count, Color_code_list, nil); _ -> case Sig_count < 0 of true -> lists:nth(erlang:length(Color_code_list) + Sig_count + 1, Color_code_list); _ -> lists:nth(Sig_count + 1, Color_code_list) end end),
        Multiplier = get_multiplier(Multiplier_color),
        Tolerance = 20,
        case (Number_of_bands_2 >= 4) of
        true -> Tolerance_color = (case erlang:is_map(Color_code_list) of true -> maps:get((Sig_count + 1), Color_code_list, nil); _ -> case (Sig_count + 1) < 0 of true -> lists:nth(erlang:length(Color_code_list) + (Sig_count + 1) + 1, Color_code_list); _ -> lists:nth((Sig_count + 1) + 1, Color_code_list) end end),
        ...
        true -> Temp_color = (case erlang:is_map(Color_code_list) of true -> maps:get((Sig_count + 2), Color_code_list, nil); _ -> case (Sig_count + 2) < 0 of true -> lists:nth(erlang:length(Color_code_list) + (Sig_count + 2) + 1, Color_code_list); _ -> lists:nth((Sig_count + 2) + 1, Color_code_list) end end),
...
main(_) ->
    ...
    erlang:put('multiplier_color_values', #{"Black" => 1, "Brown" => 10, "Red" => 100, "Orange" => 1000, "Yellow" => 10000, "Green" => 100000, "Blue" => 1.0e+06, "Violet" => 1.0e+07, "Grey" => 1.0e+08, "White" => 1.0e+09, "Gold" => 0.1, "Silver" => 0.01}),
    erlang:put('tolerance_color_values', #{"Brown" => 1, "Red" => 2, "Orange" => 0.05, "Yellow" => 0.02, "Green" => 0.5, "Blue" => 0.25, "Violet" => 0.1, "Grey" => 0.01, "Gold" => 5, "Silver" => 10}),

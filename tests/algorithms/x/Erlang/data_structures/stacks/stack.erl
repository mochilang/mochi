...
% Generated by Mochi transpiler v0.10.71 (308042e8c5)
...
main() ->
    try
        ...
        S_res = push(S_11, 0),
        S_tmp = element(2, S_res),
        S_12 = S_tmp,
        S_res_2 = push(S_12, 1),
        S_tmp_2 = element(2, S_res_2),
        S_13 = S_tmp_2,
        S_res_3 = push(S_13, 2),
        S_tmp_3 = element(2, S_res_3),
        S_14 = S_tmp_3,
        io:format("~ts~n", [mochi_str(peek(S_14))]),
        io:format("~ts~n", [mochi_str(size(S_14))]),
        io:format("~ts~n", [mochi_str(is_full(S_14))]),
        S_res_4 = push(S_14, 3),
        S_tmp_4 = element(2, S_res_4),
        S_15 = S_tmp_4,
        S_res_5 = push(S_15, 4),
        S_tmp_5 = element(2, S_res_5),
        S_16 = S_tmp_5,

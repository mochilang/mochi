...
lamberts_ellipsoidal_distance(Lat1, Lon1, Lat2, Lon2) ->
    try
        ...
        X_4 = mochi_safe_mul((Lambda2 - Lambda1), cos_approx(mochi_safe_div((Phi1 + Phi2), 2))),
        Y = (Phi2 - Phi1),
        mochi_safe_mul(6.378137e+06, sqrt_approx((mochi_safe_mul(X_4, X_4) + mochi_safe_mul(Y, Y))))
    catch {return, Ret} -> Ret end.
...
main(_) ->
    ...
    erlang:put('EQUATORIAL_RADIUS', 6.378137e+06),

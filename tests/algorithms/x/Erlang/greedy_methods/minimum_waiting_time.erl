...
minimum_waiting_time(Queries) ->
    ...
    case (I_3 < N) of
        true ->
            Total_2 = (Total + ((case erlang:is_map(Sorted) of true -> maps:get(I_3, Sorted, nil); _ -> case I_3 < 0 of true -> lists:nth(erlang:length(Sorted) + I_3 + 1, Sorted); _ -> lists:nth(I_3 + 1, Sorted) end end) * ((N - I_3) - 1))),
            I_4 = (I_3 + 1),

...
calc_profit(Profit, Weight, Max_weight) ->
    try
        ...
        true -> erlang:error("The length of profit and weight must be same.");
        _ -> ok
    end,
        case (Max_weight =< 0) of
        true -> erlang:error("max_weight must greater than zero.");
        _ -> ok
    end,
        I = 0,
    ...
    case (I < erlang:length(Profit)) of
        ...
        true -> erlang:error("Profit can not be negative.");
        _ -> ok
    end,
        ...
        true -> erlang:error("Weight can not be negative.");
        _ -> ok
    end,
            I_2 = (I + 1),

...
function is_prime(is_prime_n: integer): boolean; forward;
function twin_prime(twin_prime_number: integer): integer; forward;
procedure test_twin_prime(); forward;
procedure main(); forward;
function is_prime(is_prime_n: integer): boolean;
var
  is_prime_i: integer;
begin
...
function twin_prime(twin_prime_number: integer): integer;
begin

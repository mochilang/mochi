...
(defn excel_title_to_column [excel_title_to_column_title]
  (binding [excel_title_to_column_ch nil excel_title_to_column_found nil excel_title_to_column_i nil excel_title_to_column_idx nil excel_title_to_column_result nil excel_title_to_column_value nil] (try (do (set! excel_title_to_column_result 0) (set! excel_title_to_column_i 0) (while (< excel_title_to_column_i (count excel_title_to_column_title)) (do (set! excel_title_to_column_ch (subs excel_title_to_column_title excel_title_to_column_i (min (+ excel_title_to_column_i 1) (count excel_title_to_column_title)))) (set! excel_title_to_column_value 0) (set! excel_title_to_column_idx 0) (set! excel_title_to_column_found false) (loop [while_flag_1 true] (when (and while_flag_1 (< excel_title_to_column_idx (count main_letters))) (cond (= (subvec main_letters excel_title_to_column_idx (+ excel_title_to_column_idx 1)) excel_title_to_column_ch) (do (set! excel_title_to_column_value (+ excel_title_to_column_idx 1)) (set! excel_title_to_column_found true) (recur false)) :else (do (set! excel_title_to_column_idx (+ excel_title_to_column_idx 1)) (recur while_flag_1))))) (when (not excel_title_to_column_found) (throw (Exception. "title must contain only uppercase A-Z"))) (set! excel_title_to_column_result (+ (* excel_title_to_column_result 26) excel_title_to_column_value)) (set! excel_title_to_column_i (+ excel_title_to_column_i 1)))) (throw (ex-info "return" {:v excel_title_to_column_result}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))

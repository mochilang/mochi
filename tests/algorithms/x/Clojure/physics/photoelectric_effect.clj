...
(def ^:dynamic main_PLANCK_CONSTANT_JS (/ 6.6261 (pow10 34)))

(def ^:dynamic main_PLANCK_CONSTANT_EVS (/ 4.1357 (pow10 15)))
...
(defn -main []
  (let [rt (Runtime/getRuntime)
    ...
    start (System/nanoTime)]
      (println (str (maximum_kinetic_energy 1000000.0 2.0 false)))
      (println (str (maximum_kinetic_energy 1000000.0 2.0 true)))
      (println (str (maximum_kinetic_energy 10000000000000000.0 2.0 true)))
      (System/gc)

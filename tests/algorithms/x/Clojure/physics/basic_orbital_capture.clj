...
(def ^:dynamic main_G 0.000000000066743)
...
(defn main []
  (binding [main_r nil] (do (run_tests) (set! main_r (capture_radii (* 6.957 (pow10 8)) (* 1.99 (pow10 30)) 25000.0)) (println (str main_r)) (println (str (capture_area main_r))))))

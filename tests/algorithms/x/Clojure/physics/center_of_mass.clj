...
(defn coord_to_string [coord_to_string_c]
  (try (throw (ex-info "return" {:v (str (str (str (str (str (str "Coord3D(x=" (str (:x coord_to_string_c))) ", y=") (str (:y coord_to_string_c))) ", z=") (str (:z coord_to_string_c))) ")")})) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e)))))

(def ^:dynamic main_r1 (center_of_mass [{:mass 4.0 :x 1.5 :y 4.0 :z 3.4} {:mass 8.1 :x 5.0 :y 6.8 :z 7.0} {:mass 12.0 :x 9.4 :y 10.1 :z 11.6}]))

(def ^:dynamic main_r2 (center_of_mass [{:mass 4.0 :x 1.0 :y 2.0 :z 3.0} {:mass 8.0 :x 5.0 :y 6.0 :z 7.0} {:mass 12.0 :x 9.0 :y 10.0 :z 11.0}]))

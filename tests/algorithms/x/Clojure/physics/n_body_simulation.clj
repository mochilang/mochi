...
(defn update_velocity [update_velocity_body_p update_velocity_force_x update_velocity_force_y update_velocity_delta_time]
  (binding [update_velocity_body nil] (try (do (set! update_velocity_body update_velocity_body_p) (set! update_velocity_body (assoc update_velocity_body :velocity_x (+ (:velocity_x update_velocity_body) (* update_velocity_force_x update_velocity_delta_time)))) (set! update_velocity_body (assoc update_velocity_body :velocity_y (+ (:velocity_y update_velocity_body) (* update_velocity_force_y update_velocity_delta_time)))) (throw (ex-info "return" {:v update_velocity_body}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))

(defn update_position [update_position_body_p update_position_delta_time]
  (binding [update_position_body nil] (try (do (set! update_position_body update_position_body_p) (set! update_position_body (assoc update_position_body :position_x (+ (:position_x update_position_body) (* (:velocity_x update_position_body) update_position_delta_time)))) (set! update_position_body (assoc update_position_body :position_y (+ (:position_y update_position_body) (* (:velocity_y update_position_body) update_position_delta_time)))) (throw (ex-info "return" {:v update_position_body}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))

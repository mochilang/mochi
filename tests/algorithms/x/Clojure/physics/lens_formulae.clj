...
(defn -main []
  (let [rt (Runtime/getRuntime)
    ...
    start (System/nanoTime)]
      (println (str (focal_length_of_lens 10.0 4.0)))
      (println (str (focal_length_of_lens 2.7 5.8)))
      (println (str (object_distance 10.0 40.0)))
      (println (str (object_distance 6.2 1.5)))
      (println (str (image_distance 50.0 40.0)))
      (println (str (image_distance 5.3 7.9)))
      (System/gc)

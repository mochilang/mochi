...
(def ^:dynamic main_REDUCED_PLANCK_CONSTANT 0.0000000000000000000000000000000001054571817)

(def ^:dynamic main_SPEED_OF_LIGHT 300000000.0)
...
(defn main []
  (do (println (str (casimir_force 0.0 4.0 0.03))) (println (str (casimir_force 0.0000000002635 0.0023 0.0))) (println (str (casimir_force 0.000000000000000002737 0.0 0.0023746)))))

...
(def ^:dynamic main_example1 (alternative_list_arrange [(from_int 1) (from_int 2) (from_int 3) (from_int 4) (from_int 5)] [(from_string "A") (from_string "B") (from_string "C")]))

(def ^:dynamic main_example2 (alternative_list_arrange [(from_string "A") (from_string "B") (from_string "C")] [(from_int 1) (from_int 2) (from_int 3) (from_int 4) (from_int 5)]))

(def ^:dynamic main_example3 (alternative_list_arrange [(from_string "X") (from_string "Y") (from_string "Z")] [(from_int 9) (from_int 8) (from_int 7) (from_int 6)]))

(def ^:dynamic main_example4 (alternative_list_arrange [(from_int 1) (from_int 2) (from_int 3) (from_int 4) (from_int 5)] []))

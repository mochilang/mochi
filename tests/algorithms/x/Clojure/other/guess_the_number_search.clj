...
(defn get_avg [get_avg_number_1 get_avg_number_2]
  (try (throw (ex-info "return" {:v (quot (+ get_avg_number_1 get_avg_number_2) 2)})) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e)))))

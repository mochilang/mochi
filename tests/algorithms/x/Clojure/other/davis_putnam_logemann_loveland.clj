...
(defn new_clause [new_clause_lits]
  (binding [new_clause_i nil new_clause_lit nil new_clause_m nil new_clause_names nil] (try (do (set! new_clause_m {}) (set! new_clause_names []) (set! new_clause_i 0) (while (< new_clause_i (count new_clause_lits)) (do (set! new_clause_lit (nth new_clause_lits new_clause_i)) (set! new_clause_m (assoc new_clause_m new_clause_lit (- 0 1))) (set! new_clause_names (conj new_clause_names new_clause_lit)) (set! new_clause_i (+ new_clause_i 1)))) (throw (ex-info "return" {:v {:literals new_clause_m :names new_clause_names}}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))

(defn assign_clause [assign_clause_c_p assign_clause_model]
  (binding [assign_clause_c nil assign_clause_i nil assign_clause_lit nil assign_clause_lits nil assign_clause_symbol nil assign_clause_value nil] (try (do (set! assign_clause_c assign_clause_c_p) (set! assign_clause_lits (:literals assign_clause_c)) (set! assign_clause_i 0) (while (< assign_clause_i (count (:names assign_clause_c))) (do (set! assign_clause_lit (get (:names assign_clause_c) assign_clause_i)) (set! assign_clause_symbol (subs assign_clause_lit 0 (min 2 (count assign_clause_lit)))) (when (in assign_clause_symbol assign_clause_model) (do (set! assign_clause_value (get assign_clause_model assign_clause_symbol)) (when (and (= (subs assign_clause_lit (- (count assign_clause_lit) 1) (min (count assign_clause_lit) (count assign_clause_lit))) "'") (not= assign_clause_value (- 0 1))) (set! assign_clause_value (- 1 assign_clause_value))) (set! assign_clause_lits (assoc assign_clause_lits assign_clause_lit assign_clause_value)))) (set! assign_clause_i (+ assign_clause_i 1)))) (set! assign_clause_c (assoc assign_clause_c :literals assign_clause_lits)) (throw (ex-info "return" {:v assign_clause_c}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))

(defn evaluate_clause [evaluate_clause_c_p evaluate_clause_model]
  (binding [evaluate_clause_any_true nil evaluate_clause_c nil evaluate_clause_i nil evaluate_clause_lit nil evaluate_clause_sym nil evaluate_clause_value nil] (try (do (set! evaluate_clause_c evaluate_clause_c_p) (set! evaluate_clause_i 0) (while (< evaluate_clause_i (count (:names evaluate_clause_c))) (do (set! evaluate_clause_lit (get (:names evaluate_clause_c) evaluate_clause_i)) (set! evaluate_clause_sym (if (= (subs evaluate_clause_lit (- (count evaluate_clause_lit) 1) (min (count evaluate_clause_lit) (count evaluate_clause_lit))) "'") (subs evaluate_clause_lit 0 (min 2 (count evaluate_clause_lit))) (str evaluate_clause_lit "'"))) (when (in evaluate_clause_sym (:literals evaluate_clause_c)) (throw (ex-info "return" {:v {:clause evaluate_clause_c :value 1}}))) (set! evaluate_clause_i (+ evaluate_clause_i 1)))) (set! evaluate_clause_c (assign_clause evaluate_clause_c evaluate_clause_model)) (set! evaluate_clause_i 0) (while (< evaluate_clause_i (count (:names evaluate_clause_c))) (do (set! evaluate_clause_lit (get (:names evaluate_clause_c) evaluate_clause_i)) (set! evaluate_clause_value (get (:literals evaluate_clause_c) evaluate_clause_lit)) (when (= evaluate_clause_value 1) (throw (ex-info "return" {:v {:clause evaluate_clause_c :value 1}}))) (when (= evaluate_clause_value (- 0 1)) (throw (ex-info "return" {:v {:clause evaluate_clause_c :value (- 0 1)}}))) (set! evaluate_clause_i (+ evaluate_clause_i 1)))) (set! evaluate_clause_any_true 0) (set! evaluate_clause_i 0) (while (< evaluate_clause_i (count (:names evaluate_clause_c))) (do (set! evaluate_clause_lit (get (:names evaluate_clause_c) evaluate_clause_i)) (when (= (get (:literals evaluate_clause_c) evaluate_clause_lit) 1) (set! evaluate_clause_any_true 1)) (set! evaluate_clause_i (+ evaluate_clause_i 1)))) (throw (ex-info "return" {:v {:clause evaluate_clause_c :value evaluate_clause_any_true}}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))
...
(defn dpll_algorithm [dpll_algorithm_clauses_p dpll_algorithm_symbols dpll_algorithm_model]
  (binding [dpll_algorithm_all_true nil dpll_algorithm_clauses nil dpll_algorithm_ev nil dpll_algorithm_i nil dpll_algorithm_p nil dpll_algorithm_res1 nil dpll_algorithm_tmp1 nil dpll_algorithm_tmp2 nil rest_v nil] (try (do (set! dpll_algorithm_clauses dpll_algorithm_clauses_p) (set! dpll_algorithm_all_true true) (set! dpll_algorithm_i 0) (while (< dpll_algorithm_i (count dpll_algorithm_clauses)) (do (set! dpll_algorithm_ev (evaluate_clause (nth dpll_algorithm_clauses dpll_algorithm_i) dpll_algorithm_model)) (set! dpll_algorithm_clauses (assoc dpll_algorithm_clauses dpll_algorithm_i (:clause dpll_algorithm_ev))) (if (= (:value dpll_algorithm_ev) 0) (throw (ex-info "return" {:v {:model {} :sat false}})) (when (= (:value dpll_algorithm_ev) (- 0 1)) (set! dpll_algorithm_all_true false))) (set! dpll_algorithm_i (+ dpll_algorithm_i 1)))) (when dpll_algorithm_all_true (throw (ex-info "return" {:v {:model dpll_algorithm_model :sat true}}))) (set! dpll_algorithm_p (nth dpll_algorithm_symbols 0)) (set! rest_v (remove_symbol dpll_algorithm_symbols dpll_algorithm_p)) (set! dpll_algorithm_tmp1 dpll_algorithm_model) (set! dpll_algorithm_tmp2 dpll_algorithm_model) (set! dpll_algorithm_tmp1 (assoc dpll_algorithm_tmp1 dpll_algorithm_p 1)) (set! dpll_algorithm_tmp2 (assoc dpll_algorithm_tmp2 dpll_algorithm_p 0)) (set! dpll_algorithm_res1 (dpll_algorithm dpll_algorithm_clauses rest_v dpll_algorithm_tmp1)) (if (:sat dpll_algorithm_res1) dpll_algorithm_res1 (dpll_algorithm dpll_algorithm_clauses rest_v dpll_algorithm_tmp2))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))
...
(def ^:dynamic main_clause1 (new_clause ["A4" "A3" "A5'" "A1" "A3'"]))

(def ^:dynamic main_clause2 (new_clause ["A4"]))

(def ^:dynamic main_formula (new_formula [main_clause1 main_clause2]))

(def ^:dynamic main_formula_str (str_formula main_formula))

(def ^:dynamic main_clauses [main_clause1 main_clause2])

(def ^:dynamic main_symbols ["A4" "A3" "A5" "A1"])

(def ^:dynamic main_model {})

(def ^:dynamic main_result (dpll_algorithm main_clauses main_symbols main_model))

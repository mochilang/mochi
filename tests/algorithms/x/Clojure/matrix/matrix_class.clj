...
(defn matrix_columns [matrix_columns_m]
  (binding [matrix_columns_col nil matrix_columns_cols nil matrix_columns_i nil matrix_columns_j nil] (try (do (set! matrix_columns_cols []) (set! matrix_columns_j 0) (while (< matrix_columns_j (:cols matrix_columns_m)) (do (set! matrix_columns_col []) (set! matrix_columns_i 0) (while (< matrix_columns_i (:rows matrix_columns_m)) (do (set! matrix_columns_col (conj matrix_columns_col (nth (get (:data matrix_columns_m) matrix_columns_i) matrix_columns_j))) (set! matrix_columns_i (+ matrix_columns_i 1)))) (set! matrix_columns_cols (conj matrix_columns_cols matrix_columns_col)) (set! matrix_columns_j (+ matrix_columns_j 1)))) (throw (ex-info "return" {:v matrix_columns_cols}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))
...
(defn matrix_minor [matrix_minor_m matrix_minor_r matrix_minor_c]
  (binding [matrix_minor_i nil matrix_minor_j nil matrix_minor_row nil matrix_minor_sub nil matrix_minor_vals nil] (try (do (set! matrix_minor_vals []) (set! matrix_minor_i 0) (while (< matrix_minor_i (:rows matrix_minor_m)) (do (when (not= matrix_minor_i matrix_minor_r) (do (set! matrix_minor_row []) (set! matrix_minor_j 0) (while (< matrix_minor_j (:cols matrix_minor_m)) (do (when (not= matrix_minor_j matrix_minor_c) (set! matrix_minor_row (conj matrix_minor_row (nth (get (:data matrix_minor_m) matrix_minor_i) matrix_minor_j)))) (set! matrix_minor_j (+ matrix_minor_j 1)))) (set! matrix_minor_vals (conj matrix_minor_vals matrix_minor_row)))) (set! matrix_minor_i (+ matrix_minor_i 1)))) (set! matrix_minor_sub {:cols (- (:cols matrix_minor_m) 1) :data matrix_minor_vals :rows (- (:rows matrix_minor_m) 1)}) (throw (ex-info "return" {:v (matrix_determinant matrix_minor_sub)}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))
...
(defn matrix_mul_scalar [matrix_mul_scalar_m matrix_mul_scalar_s]
  (binding [matrix_mul_scalar_i nil matrix_mul_scalar_j nil matrix_mul_scalar_row nil matrix_mul_scalar_vals nil] (try (do (set! matrix_mul_scalar_vals []) (set! matrix_mul_scalar_i 0) (while (< matrix_mul_scalar_i (:rows matrix_mul_scalar_m)) (do (set! matrix_mul_scalar_row []) (set! matrix_mul_scalar_j 0) (while (< matrix_mul_scalar_j (:cols matrix_mul_scalar_m)) (do (set! matrix_mul_scalar_row (conj matrix_mul_scalar_row (* (nth (get (:data matrix_mul_scalar_m) matrix_mul_scalar_i) matrix_mul_scalar_j) matrix_mul_scalar_s))) (set! matrix_mul_scalar_j (+ matrix_mul_scalar_j 1)))) (set! matrix_mul_scalar_vals (conj matrix_mul_scalar_vals matrix_mul_scalar_row)) (set! matrix_mul_scalar_i (+ matrix_mul_scalar_i 1)))) (throw (ex-info "return" {:v {:cols (:cols matrix_mul_scalar_m) :data matrix_mul_scalar_vals :rows (:rows matrix_mul_scalar_m)}}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))
...
(defn matrix_add [matrix_add_a matrix_add_b]
  (binding [matrix_add_i nil matrix_add_j nil matrix_add_row nil matrix_add_vals nil] (try (do (when (or (not= (:rows matrix_add_a) (:rows matrix_add_b)) (not= (:cols matrix_add_a) (:cols matrix_add_b))) (throw (ex-info "return" {:v {:cols 0 :data [] :rows 0}}))) (set! matrix_add_vals []) (set! matrix_add_i 0) (while (< matrix_add_i (:rows matrix_add_a)) (do (set! matrix_add_row []) (set! matrix_add_j 0) (while (< matrix_add_j (:cols matrix_add_a)) (do (set! matrix_add_row (conj matrix_add_row (+ (nth (get (:data matrix_add_a) matrix_add_i) matrix_add_j) (nth (get (:data matrix_add_b) matrix_add_i) matrix_add_j)))) (set! matrix_add_j (+ matrix_add_j 1)))) (set! matrix_add_vals (conj matrix_add_vals matrix_add_row)) (set! matrix_add_i (+ matrix_add_i 1)))) (throw (ex-info "return" {:v {:cols (:cols matrix_add_a) :data matrix_add_vals :rows (:rows matrix_add_a)}}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))

(defn matrix_sub [matrix_sub_a matrix_sub_b]
  (binding [matrix_sub_i nil matrix_sub_j nil matrix_sub_row nil matrix_sub_vals nil] (try (do (when (or (not= (:rows matrix_sub_a) (:rows matrix_sub_b)) (not= (:cols matrix_sub_a) (:cols matrix_sub_b))) (throw (ex-info "return" {:v {:cols 0 :data [] :rows 0}}))) (set! matrix_sub_vals []) (set! matrix_sub_i 0) (while (< matrix_sub_i (:rows matrix_sub_a)) (do (set! matrix_sub_row []) (set! matrix_sub_j 0) (while (< matrix_sub_j (:cols matrix_sub_a)) (do (set! matrix_sub_row (conj matrix_sub_row (- (nth (get (:data matrix_sub_a) matrix_sub_i) matrix_sub_j) (nth (get (:data matrix_sub_b) matrix_sub_i) matrix_sub_j)))) (set! matrix_sub_j (+ matrix_sub_j 1)))) (set! matrix_sub_vals (conj matrix_sub_vals matrix_sub_row)) (set! matrix_sub_i (+ matrix_sub_i 1)))) (throw (ex-info "return" {:v {:cols (:cols matrix_sub_a) :data matrix_sub_vals :rows (:rows matrix_sub_a)}}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))

...
(defn -main []
  (let [rt (Runtime/getRuntime)
    ...
    start (System/nanoTime)]
      ...
      (println (str (is_prime 27)))
      (println (str (is_prime 87)))
      (println (str (is_prime 563)))
      (println (str (is_prime 2999)))
      (println (str (is_prime 67483)))
      (System/gc)

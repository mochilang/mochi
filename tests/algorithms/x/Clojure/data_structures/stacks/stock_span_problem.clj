...
(defn calculation_span [calculation_span_price]
  (binding [calculation_span_n nil calculation_span_s nil calculation_span_span nil calculation_span_st nil] (try (do (set! calculation_span_n (count calculation_span_price)) (set! calculation_span_st []) (set! calculation_span_span []) (set! calculation_span_st (conj calculation_span_st 0)) (set! calculation_span_span (conj calculation_span_span 1)) (doseq [i (range 1 calculation_span_n)] (do (while (and (> (count calculation_span_st) 0) (<= (nth calculation_span_price (nth calculation_span_st (- (count calculation_span_st) 1))) (nth calculation_span_price i))) (set! calculation_span_st (slice calculation_span_st 0 (- (count calculation_span_st) 1)))) (set! calculation_span_s (if (<= (count calculation_span_st) 0) (+ i 1) (- i (nth calculation_span_st (- (count calculation_span_st) 1))))) (set! calculation_span_span (conj calculation_span_span calculation_span_s)) (set! calculation_span_st (conj calculation_span_st i)))) (throw (ex-info "return" {:v calculation_span_span}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))

(ns main (:refer-clojure :exclude [empty_list length is_empty to_string insert_nth insert_head insert_tail delete_nth delete_front delete_tail main]))
...
(defn main []
  (binding [main_cll nil main_i nil main_res nil] (do (set! main_cll (empty_list)) (set! main_i 0) (while (< main_i 5) (do (set! main_cll (insert_tail main_cll (+ main_i 1))) (set! main_i (+ main_i 1)))) (println (to_string main_cll)) (set! main_cll (insert_tail main_cll 6)) (println (to_string main_cll)) (set! main_cll (insert_head main_cll 0)) (println (to_string main_cll)) (set! main_res (delete_front main_cll)) (set! main_cll (:list main_res)) (println (:value main_res)) (set! main_res (delete_tail main_cll)) (set! main_cll (:list main_res)) (println (:value main_res)) (set! main_res (delete_nth main_cll 2)) (set! main_cll (:list main_res)) (println (:value main_res)) (println (to_string main_cll)))))

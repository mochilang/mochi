...
(defn pow_mod [pow_mod_base pow_mod_exponent pow_mod_modulus]
  (binding [pow_mod_b nil pow_mod_e nil pow_mod_result nil] (try (do (set! pow_mod_result 1) (set! pow_mod_b (mod pow_mod_base pow_mod_modulus)) (set! pow_mod_e pow_mod_exponent) (while (> pow_mod_e 0) (do (when (= (mod pow_mod_e 2) 1) (set! pow_mod_result (mod (* pow_mod_result pow_mod_b) pow_mod_modulus))) (set! pow_mod_b (mod (* pow_mod_b pow_mod_b) pow_mod_modulus)) (set! pow_mod_e (/ pow_mod_e 2)))) (throw (ex-info "return" {:v pow_mod_result}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))

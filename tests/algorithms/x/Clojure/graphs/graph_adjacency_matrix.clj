...
(defn make_graph [make_graph_vertices make_graph_edges make_graph_directed]
  (binding [make_graph_e nil make_graph_g nil make_graph_i nil make_graph_j nil] (try (do (set! make_graph_g {:adj_matrix [] :directed make_graph_directed :vertex_to_index {}}) (set! make_graph_i 0) (while (< make_graph_i (count make_graph_vertices)) (do (add_vertex make_graph_g (nth make_graph_vertices make_graph_i)) (set! make_graph_i (+ make_graph_i 1)))) (set! make_graph_j 0) (while (< make_graph_j (count make_graph_edges)) (do (set! make_graph_e (nth make_graph_edges make_graph_j)) (add_edge make_graph_g (nth make_graph_e 0) (nth make_graph_e 1)) (set! make_graph_j (+ make_graph_j 1)))) (throw (ex-info "return" {:v make_graph_g}))) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))
...
(defn clear_graph [clear_graph_g_p]
  (binding [clear_graph_g clear_graph_g_p] (do (set! clear_graph_g (assoc clear_graph_g :vertex_to_index {})) (set! clear_graph_g (assoc clear_graph_g :adj_matrix [])) clear_graph_g)))

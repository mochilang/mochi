...
(defn exp_approx [exp_approx_x]
  (binding [exp_approx_absx nil exp_approx_i nil exp_approx_sum nil exp_approx_term nil] (try (do (set! exp_approx_sum 1.0) (set! exp_approx_term 1.0) (set! exp_approx_i 1) (set! exp_approx_absx (if (< exp_approx_x 0.0) (- exp_approx_x) exp_approx_x)) (while (<= exp_approx_i 20) (do (set! exp_approx_term (quot (* exp_approx_term exp_approx_absx) (double exp_approx_i))) (set! exp_approx_sum (+ exp_approx_sum exp_approx_term)) (set! exp_approx_i (+ exp_approx_i 1)))) (if (< exp_approx_x 0.0) (/ 1.0 exp_approx_sum) exp_approx_sum)) (catch clojure.lang.ExceptionInfo e (if (= (ex-message e) "return") (get (ex-data e) :v) (throw e))))))

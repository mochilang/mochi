        ...
        begin (
                     ...
                     (
                      begin (
                        ret1 (
                          alist->hash-table (
                            _list (
                              cons "kind" "conductivity"
                            )
                             (
                              cons "value" (
                                * (
                                  * mobility electron_conc
                                )
                                 ELECTRON_CHARGE
                              )
                            )
                     ...
                     (
                      begin (
                        ret1 (
                          alist->hash-table (
                            _list (
                              cons "kind" "electron_conc"
                            )
                             (
                              cons "value" (
                                _div conductivity (
                                  * mobility ELECTRON_CHARGE
                                )
                              )
                            )
                          )
         ...
         (
          let (
            (
              r1 (
                electric_conductivity 25.0 100.0 0.0
              )
            )
          )
           (
            begin (
              let (
                (
                  r2 (
                    electric_conductivity 0.0 1600.0 200.0
                  )
                )
              )
               (
                begin (
                  let (
                    (
                      r3 (
                        electric_conductivity 1000.0 0.0 1200.0
                      )
                    )
                  )
                   (

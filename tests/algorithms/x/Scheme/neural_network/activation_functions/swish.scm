                  ...
                  begin (
                    if (
                      not (
                        approx_equal_list (
                         ...
                         (
                          _list 0.26894142 0.73105858 0.88079708
                        )
                         eps
                      )
                    )
                   ...
                   (
                    if (
                      not (
                        approx_equal_list (
                          sigmoid_linear_unit v
                        )
                         (
                          _list (
                            - 0.26894142
                          )
                           0.73105858 1.76159416
                        )
                         eps
                      )
                    )

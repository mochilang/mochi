     ...
     (
      _display (
        if (
          string? (
            to-str-space (
              straight_line_depreciation 4 1001.0 0.0
            )
          )
        )
         (
     ...
     (
      _display (
        if (
          string? (
            to-str-space (
              straight_line_depreciation 1 4985.0 100.0
            )
          )
        )
         (

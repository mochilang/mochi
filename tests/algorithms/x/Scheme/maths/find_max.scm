  ...
  let (
   ...
   (
    begin (
     ...
     (
      define (
        find_max_recursive nums left right
      )
       (
        call/cc (
          lambda (
          ...
          lambda (
           ...
           (
            let (
              (
                arr (
                  _list 2.0 4.0 9.0 7.0 19.0 94.0 5.0
                )
              )
            )
             (

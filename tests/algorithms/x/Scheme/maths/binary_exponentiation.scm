  ...
  let (
   ...
   (
    begin (
     ...
     (
      define (
        binary_exp_iterative base exponent
      )
       (
        call/cc (
          lambda (
     ...
     (
      define (
        binary_exp_mod_recursive base exponent modulus
      )
       (
        call/cc (
          lambda (
     ...
     (
      define (
        binary_exp_mod_iterative base exponent modulus
      )
       (
        call/cc (
          lambda (

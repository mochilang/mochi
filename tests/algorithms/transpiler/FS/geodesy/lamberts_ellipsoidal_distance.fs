...
and lamberts_ellipsoidal_distance (lat1: float) (lon1: float) (lat2: float) (lon2: float) =
    ...
    with
        | Return -> __ret
ignore (printfn "%A" (lamberts_ellipsoidal_distance (37.774856) (-122.424227) (37.864742) (-119.537521)))
ignore (printfn "%A" (lamberts_ellipsoidal_distance (37.774856) (-122.424227) (40.713019) (-74.012647)))
ignore (printfn "%A" (lamberts_ellipsoidal_distance (37.774856) (-122.424227) (45.443012) (12.313071)))

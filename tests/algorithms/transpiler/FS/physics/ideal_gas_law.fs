...
let rec pressure_of_gas_system (moles: float) (kelvin: float) (volume: float) =
    ...
    with
        | Return -> __ret
let rec volume_of_gas_system (moles: float) (kelvin: float) (pressure: float) =
    let mutable __ret : float = Unchecked.defaultof<float>
    let mutable moles = moles
    let mutable kelvin = kelvin
    ...
    with
        | Return -> __ret
let rec temperature_of_gas_system (moles: float) (volume: float) (pressure: float) =
    let mutable __ret : float = Unchecked.defaultof<float>
    let mutable moles = moles
    let mutable volume = volume
    let mutable pressure = pressure
    ...
    with
        | Return -> __ret
let rec moles_of_gas_system (kelvin: float) (volume: float) (pressure: float) =
    let mutable __ret : float = Unchecked.defaultof<float>
    let mutable kelvin = kelvin
    let mutable volume = volume
    let mutable pressure = pressure

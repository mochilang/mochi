...
fn get_head_data(ll: LinkedList) i64 {
    if (ll.head_idx == 0 -% 1) {
        return 0 -% 1;
    }
...
fn get_tail_data(ll_1: LinkedList) i64 {
...
fn get_node(ll_2: LinkedList, item: i64) i64 {
...
fn contains(ll_3: LinkedList, value_3: i64) bool {
    return get_node(ll_3, value_3) != 0 -% 1;
}

fn is_empty(ll_4: LinkedList) bool {
    return ll_4.head_idx == 0 -% 1;
}

fn to_string(ll_5: LinkedList) []const u8 {
    var res: []const u8 = "";
    res = res;
    var first: bool = true;
    first = first;
...
fn print_list(ll_6: LinkedList) void {

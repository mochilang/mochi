...
fn push_back(dq: Deque, value: i64) Deque {
...
fn push_front(dq_1: Deque, value_1: i64) Deque {
...
fn extend_back(dq_2: Deque, values: []i64) Deque {
...
fn extend_front(dq_3: Deque, values_1: []i64) Deque {
...
fn pop_back(dq_4: Deque) PopResult {
...
fn pop_front(dq_5: Deque) PopResult {
...
fn is_empty(dq_6: Deque) bool {
    return @as(i64, @intCast(dq_6.data.len)) == 0;
}

fn length(dq_7: Deque) i64 {
    return @as(i64, @intCast(dq_7.data.len));
}

fn to_string(dq_8: Deque) []const u8 {

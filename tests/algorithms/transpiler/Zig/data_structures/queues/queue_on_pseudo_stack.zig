...
fn rotate(q_1: Queue, rotation: i64) Queue {
...
fn front(q_3: Queue) FrontResult {
...
fn size(q_4: Queue) i64 {
    return q_4.length;
}

fn to_string(q_5: Queue) []const u8 {
    var s_3: []const u8 = "<";
    s_3 = s_3;
    if (q_5.length > 0) {

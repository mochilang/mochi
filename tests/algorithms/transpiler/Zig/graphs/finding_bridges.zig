// Generated by Mochi Zig transpiler on 2025-08-15 09:59 +0700
...
fn compute_bridges(graph_1: *const std.AutoHashMap(i64,[]i64)) [][]i64 {
    const n: i64 = @as(i64, @intCast(graph_1.count()));
    ...
    var bridges_1: [][]i64 = std.heap.page_allocator.alloc([]i64, 0) catch unreachable;
    bridges_1 = bridges_1;
    var id_1: i64 = 0;
    id_1 = id_1;
    i = 0;
    while (i < n) {
        if (!(visited[_idx(visited.len, i)])) {
            const result_1: DfsResult = dfs(graph_1, i, 0 - 1, visited, ids, low, id_1, bridges_1);
            id_1 = result_1.id;
            bridges_1 = result_1.bridges;
        }
        i = i + 1;
    }
    return bridges_1;
...
pub fn main() void {
    {
        ...
        std.debug.print("{s}\n", .{_str(compute_bridges(&std.AutoHashMap(i64, []i64).init(std.heap.page_allocator)))});
        const __end = _now();

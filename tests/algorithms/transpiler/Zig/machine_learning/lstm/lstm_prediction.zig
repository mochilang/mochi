...
fn forward(seq: []f64, w_param: LSTMWeights) LSTMState {
    ...
    g_arr = g_arr;
    var c_arr_: []f64 = std.heap.page_allocator.dupe(f64, ([1]f64{0.0})[0..1]) catch unreachable;
    c_arr_ = c_arr_;
    var h_arr: []f64 = std.heap.page_allocator.dupe(f64, ([1]f64{0.0})[0..1]) catch unreachable;
    h_arr = h_arr;
    var t: i64 = 0;
    t = t;

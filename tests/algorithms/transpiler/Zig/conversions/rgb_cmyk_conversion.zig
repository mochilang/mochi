...
fn rgb_to_cmyk(r_input: i64, g_input: i64, b_input: i64) []i64 {
    ...
    const r: f64 = @as(f64, @floatFromInt(r_input)) / 255.0;
    const g: f64 = @as(f64, @floatFromInt(g_input)) / 255.0;
    const b: f64 = @as(f64, @floatFromInt(b_input)) / 255.0;
    var max_val: f64 = r;
    if (g > max_val) {
        max_val = g;
    }
    ...
    const c_float: f64 = 100.0 * (1.0 - r - k_float) / (1.0 - k_float);
    const m_float: f64 = 100.0 * (1.0 - g - k_float) / (1.0 - k_float);
    const y_float: f64 = 100.0 * (1.0 - b - k_float) / (1.0 - k_float);
    const k_percent: f64 = 100.0 * k_float;
    const c: i64 = round_int(c_float);
    const m: i64 = round_int(m_float);
    const y: i64 = round_int(y_float);
    const k: i64 = round_int(k_percent);

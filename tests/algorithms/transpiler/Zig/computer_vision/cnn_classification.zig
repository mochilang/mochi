...
fn conv2d(image_param: [][]f64, kernel_param: [][]f64) [][]f64 {
    const rows: i64 = @as(i64, @intCast(image_param.len));
    const cols: i64 = @as(i64, @intCast(image_param[@as(usize, @intCast(0))].len));
    const k: i64 = @as(i64, @intCast(kernel_param.len));
...
fn max_pool2x2(m: [][]f64) [][]f64 {
    const rows: i64 = @as(i64, @intCast(m.len));
    const cols: i64 = @as(i64, @intCast(m[@as(usize, @intCast(0))].len));
    var out: [][]f64 = &[_][]f64{};
    var i: i64 = 0;
    while (i < rows) {
        var new_row: []f64 = &[_]f64{};

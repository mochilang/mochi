...
fn segment_image(image: [][]i64, thresholds: []i64) [][]i64 {
    ...
    while (i < @as(i64, @intCast(image.len))) {
        ...
        while (j < @as(i64, @intCast(image[@as(usize, @intCast(i))].len))) {
            const pixel: i64 = image[@as(usize, @intCast(i))][@as(usize, @intCast(j))];
            var label: i64 = 0;
            var k: i64 = 0;
...
fn mochi_main() void {
    const image: [][]i64 = blk0: { var _tmp0 = std.heap.page_allocator.alloc([]i64, 3) catch unreachable; _tmp0[0] = blk1: { var _tmp1 = std.heap.page_allocator.alloc(i64, 3) catch unreachable; _tmp1[0] = 80; _tmp1[1] = 120; _tmp1[2] = 180; break :blk1 _tmp1; }; _tmp0[1] = blk2: { var _tmp2 = std.heap.page_allocator.alloc(i64, 3) catch unreachable; _tmp2[0] = 40; _tmp2[1] = 90; _tmp2[2] = 150; break :blk2 _tmp2; }; _tmp0[2] = blk3: { var _tmp3 = std.heap.page_allocator.alloc(i64, 3) catch unreachable; _tmp3[0] = 20; _tmp3[1] = 60; _tmp3[2] = 100; break :blk3 _tmp3; }; break :blk0 _tmp0; };
    const thresholds: []i64 = blk4: { var _tmp4 = std.heap.page_allocator.alloc(i64, 3) catch unreachable; _tmp4[0] = 50; _tmp4[1] = 100; _tmp4[2] = 150; break :blk4 _tmp4; };

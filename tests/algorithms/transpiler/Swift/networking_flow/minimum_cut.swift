// Generated by Mochi transpiler v0.10.73 on 2025-08-25 22:33:56 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func bfs(_ graph: [[Int]], _ s: Int, _ t: Int, _ parent: inout [Int]) -> Bool {
        ...
        var head = 0
        visited = _set(visited, s, { let _tmp4 = true; return _tmp4 }())
    ...
    func mincut(_ graph: [[Int]], _ source: Int, _ sink: Int) -> [[Int]] {
        ...
        while (bfs((g as! [[Int]]), source, sink, &parent)) {
            ...
            while ((v != source)) {
                ...
                _tmp3 = _set(_tmp3, v, { let _tmp7 = _int(((_idx(_idx(g, u), v) as? Int ?? 0) &- path_flow)); return _tmp7 }())
                g = _set(g, u, { let _tmp8 = (_tmp3 as! [Int]); return _tmp8 }())
                var _tmp4 = (_idx(g, v) as! [Int])
                _tmp4 = _set(_tmp4, u, { let _tmp9 = _int(((_idx(_idx(g, v), u) as? Int ?? 0) &+ path_flow)); return _tmp9 }())
                g = _set(g, v, { let _tmp10 = (_tmp4 as! [Int]); return _tmp10 }())
                v = Int(u)
            }
        }
        var res: [[Int]] = ([] as! [[Int]])

// Generated by Mochi transpiler v0.10.61 on 2025-08-08 19:13:19 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func electric_conductivity(_ conductivity: Double, _ electron_conc: Double, _ mobility: Double) -> Result {
        ...
        if (conductivity == 0.0) {
            return Result(kind: "conductivity", value: Double(((mobility * electron_conc) * ELECTRON_CHARGE)))
        }
        if (electron_conc == 0.0) {
            return Result(kind: "electron_conc", value: Double((conductivity / Double((mobility * ELECTRON_CHARGE)))))
        }
        return Result(kind: "mobility", value: Double((conductivity / Double((electron_conc * ELECTRON_CHARGE)))))
    }

// Generated by Mochi transpiler v0.10.61 on 2025-08-08 19:13:21 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func electric_power(_ voltage: Double, _ current: Double, _ power: Double) -> Result {
        ...
        if (zeros != 1) {
            ...
            return Result(name: "voltage", value: Double((power / current)))
        } else if (current == 0.0) {
            return Result(name: "current", value: Double((power / voltage)))
        } else if (power == 0.0) {

// Generated by Mochi transpiler v0.10.66 on 2025-08-16 13:04:55 GMT+7
import Foundation
import Dispatch
    ...
    func newton_forward_interpolation(_ x: [Double], _ y0: [Double], _ value: Double) -> Double {
        ...
        while (i1 < n) {
            ...
            while (j1 < (n &- i1)) {
                ...
                _tmp4 = _set(_tmp4, i1, { let _tmp6 = Double((Double(_idx(_idx(y, (j1 &+ 1)), (i1 &- 1))) - Double(_idx(_idx(y, j1), (i1 &- 1))))); return _tmp6 }())

// Generated by Mochi transpiler v0.10.66 on 2025-08-16 13:04:19 GMT+7
import Foundation
import Dispatch
    ...
    func neville_interpolate(_ x_points: [Double], _ y_points: [Double], _ x0: Double) -> NevilleResult {
        ...
        while (col < n) {
            ...
            while (row_idx < n) {
                ...
                _tmp4 = _set(_tmp4, col, { let _tmp6 = Double((Double(((Double((x0 - Double(_idx(x_points, ((row_idx &- col) &+ 1))))) * Double(_idx(_idx(q, row_idx), (col &- 1)))) - (Double((x0 - Double(_idx(x_points, row_idx)))) * Double(_idx(_idx(q, (row_idx &- 1)), (col &- 1)))))) / Double((Double(_idx(x_points, row_idx)) - Double(_idx(x_points, ((row_idx &- col) &+ 1))))))); return _tmp6 }())
                q = _set(q, row_idx, { let _tmp7 = (_tmp4 as! [Double]); return _tmp7 }())

// Generated by Mochi transpiler v0.10.62 on 2025-08-09 12:11:11 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    print(_p(("Rectangle: " + _p(Double(area_rectangle(10.0, 20.0))))))
    print(_p(("Square: " + _p(Double(area_square(10.0))))))
    print(_p(("Triangle: " + _p(Double(area_triangle(10.0, 10.0))))))
    let TRI_THREE_SIDES = Double(area_triangle_three_sides(5.0, 12.0, 13.0))
    print(_p(("Triangle Three Sides: " + _p(TRI_THREE_SIDES))))
    print(_p(("Parallelogram: " + _p(Double(area_parallelogram(10.0, 20.0))))))
    print(_p(("Rhombus: " + _p(Double(area_rhombus(10.0, 20.0))))))
    print(_p(("Trapezium: " + _p(Double(area_trapezium(10.0, 20.0, 30.0))))))
    print(_p(("Circle: " + _p(Double(area_circle(20.0))))))
    print(_p(("Ellipse: " + _p(Double(area_ellipse(10.0, 20.0))))))
    print(_p(""))
    print(_p("Surface Areas of various geometric shapes:"))
    print(_p(("Cube: " + _p(Double(surface_area_cube(20.0))))))
    print(_p(("Cuboid: " + _p(Double(surface_area_cuboid(10.0, 20.0, 30.0))))))
    print(_p(("Sphere: " + _p(Double(surface_area_sphere(20.0))))))
    print(_p(("Hemisphere: " + _p(Double(surface_area_hemisphere(20.0))))))
    print(_p(("Cone: " + _p(Double(surface_area_cone(10.0, 20.0))))))
    print(_p(("Conical Frustum: " + _p(Double(surface_area_conical_frustum(10.0, 20.0, 30.0))))))
    print(_p(("Cylinder: " + _p(Double(surface_area_cylinder(10.0, 20.0))))))
    print(_p(("Torus: " + _p(Double(surface_area_torus(20.0, 10.0))))))
    print(_p(("Equilateral Triangle: " + _p(Double(area_reg_polygon(3, 10.0))))))
    print(_p(("Square: " + _p(Double(area_reg_polygon(4, 10.0))))))
    print(_p(("Regular Pentagon: " + _p(Double(area_reg_polygon(5, 10.0))))))
    let _benchEnd = _now()

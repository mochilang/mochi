// Generated by Mochi transpiler v0.10.63 on 2025-08-12 08:44:47 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func main() {
        print(_p("Volumes:"))
        print(_p(("Cube: " + _p(Double(vol_cube(2.0))))))
        print(_p(("Cuboid: " + _p(Double(vol_cuboid(2.0, 2.0, 2.0))))))
        print(_p(("Cone: " + _p(Double(vol_cone(2.0, 2.0))))))
        print(_p(("Right Circular Cone: " + _p(Double(vol_right_circ_cone(2.0, 2.0))))))
        print(_p(("Prism: " + _p(Double(vol_prism(2.0, 2.0))))))
        print(_p(("Pyramid: " + _p(Double(vol_pyramid(2.0, 2.0))))))
        print(_p(("Sphere: " + _p(Double(vol_sphere(2.0))))))
        print(_p(("Hemisphere: " + _p(Double(vol_hemisphere(2.0))))))
        print(_p(("Circular Cylinder: " + _p(Double(vol_circular_cylinder(2.0, 2.0))))))
        print(_p(("Torus: " + _p(Double(vol_torus(2.0, 2.0))))))
        print(_p(("Conical Frustum: " + _p(Double(vol_conical_frustum(2.0, 2.0, 4.0))))))
        print(_p(("Spherical cap: " + _p(Double(vol_spherical_cap(1.0, 2.0))))))
        print(_p(("Spheres intersection: " + _p(Double(vol_spheres_intersect(2.0, 2.0, 1.0))))))
        print(_p(("Spheres union: " + _p(Double(vol_spheres_union(2.0, 2.0, 1.0))))))
        print(_p(("Hollow Circular Cylinder: " + _p(Double(vol_hollow_circular_cylinder(1.0, 2.0, 3.0))))))
        print(_p(("Icosahedron: " + _p(Double(vol_icosahedron(2.5))))))
    }
    _ = main()
    let _benchEnd = _now()

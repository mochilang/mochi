// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:01:45 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func predict_y_values(_ x_items: [[Double]], _ means: [Double], _ variance: Double, _ probabilities: [Double]) -> [Int] {
        ...
        while (i < _int(((x_items).count))) {
            ...
            while (j < _int((((_idx(x_items, i) as! [Double])).count))) {
                ...
                var max_idx: Int = 0
                var max_val: Double = Double(_idx(temp, 0))
                var t: Int = 1
    ...
    func main() {
        seed = 1
        let counts: [Int] = ([20, 20, 20] as! [Int])
        let means: [Double] = ([5.0, 10.0, 15.0] as! [Double])
        let std_dev = 1.0

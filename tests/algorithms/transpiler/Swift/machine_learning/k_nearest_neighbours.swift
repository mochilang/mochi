// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:01:44 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func classify(_ knn: KNN, _ pred_point: [Double], _ k: Int) -> String {
        ...
        while (i < _int(((knn.data).count))) {
            ...
            distances = (_append(distances, DistLabel(dist: d, label: _idx(knn.data, i).label)) as! [DistLabel])
            i = _int((i &+ 1))
        }
        ...
        while (count < k) {
            ...
            _idx(distances, min_index).dist = 1000000000000000000.0
            count = _int((count &+ 1))
        }
    ...
    let train_X: [[Double]] = ([([0.0, 0.0] as! [Double]), ([1.0, 0.0] as! [Double]), ([0.0, 1.0] as! [Double]), ([0.5, 0.5] as! [Double]), ([3.0, 3.0] as! [Double]), ([2.0, 3.0] as! [Double]), ([3.0, 2.0] as! [Double])] as! [[Double]])
    let train_y: [Int] = ([0, 0, 0, 0, 1, 1, 1] as! [Int])
    let classes: [String] = (["A", "B"] as! [String])
    let knn = make_knn((train_X as! [[Double]]), (train_y as! [Int]), (classes as! [String]))
    let point: [Double] = ([1.2, 1.2] as! [Double])

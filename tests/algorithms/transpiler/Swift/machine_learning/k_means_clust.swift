...
do {
    ...
    func assign_clusters(_ data: [[Double]], _ centroids: [[Double]]) -> [Int] {
        ...
        for i in 0..<_int(((data).count)) {
            var best_idx: Int = 0
            var best: Double = Double(distance_sq((_idx(data, i) as! [Double]), (_idx(centroids, 0) as! [Double])))
    ...
    func revise_centroids(_ data: [[Double]], _ k: Int, _ assignment: [Int]) -> [[Double]] {
        ...
        for i in 0..<_int(((data).count)) {
            ...
            for j in 0..<dim {
                _idx(_idx(sums, c), j) = Double((Double(_idx(_idx(sums, c), j)) + Double(_idx(_idx(data, i), j))))
            }
        }
    ...
    func kmeans(_ data: [[Double]], _ k: Int, _ initial_centroids: [[Double]], _ max_iter: Int) -> KMeansResult {
        var centroids: [[Double]] = initial_centroids
    ...
    let data: [[Double]] = ([([1.0, 2.0] as! [Double]), ([1.5, 1.8] as! [Double]), ([5.0, 8.0] as! [Double]), ([8.0, 8.0] as! [Double]), ([1.0, 0.6] as! [Double]), ([9.0, 11.0] as! [Double])] as! [[Double]])
    let k = 3
    let initial_centroids: [[Double]] = ([(_idx(data, 0) as! [Double]), (_idx(data, 2) as! [Double]), (_idx(data, 5) as! [Double])] as! [[Double]])

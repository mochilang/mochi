// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:01:38 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    let features: [[Double]] = ([([1.0] as! [Double]), ([2.0] as! [Double]), ([3.0] as! [Double]), ([4.0] as! [Double])] as! [[Double]])
    let target: [Double] = ([-1.0, -1.0, 1.0, 1.0] as! [Double])

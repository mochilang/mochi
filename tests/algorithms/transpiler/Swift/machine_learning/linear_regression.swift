// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:01:46 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    let data_x: [[Double]] = ([([1.0, 1.0] as! [Double]), ([1.0, 2.0] as! [Double]), ([1.0, 3.0] as! [Double])] as! [[Double]])
    let data_y: [Double] = ([1.0, 2.0, 3.0] as! [Double])
    ...
    let predicted_y: [Double] = ([3.0, -0.5, 2.0, 7.0] as! [Double])
    let original_y: [Double] = ([2.5, 0.0, 2.0, 8.0] as! [Double])

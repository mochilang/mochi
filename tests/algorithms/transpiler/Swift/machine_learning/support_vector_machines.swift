// Generated by Mochi transpiler v0.10.62 on 2025-08-09 16:38:54 GMT+7
import Foundation
import Dispatch
            ...
            while (j < _int(((xs).count))) {
                ...
                if ((y * prod) < 1.0) {
                    ...
                    while (k < _int(((w).count))) {
                        w = _set(w, k, Double((Double(_idx(w, k)) + (model.lr * Double(((y * Double(_idx(x, k))) - ((2.0 * model.lambda) * Double(_idx(w, k)))))))))
                        k = _int((k &+ 1))
                    }
                    ...
                    var k = 0
                    while (k < _int(((w).count))) {
                        w = _set(w, k, Double((Double(_idx(w, k)) - (model.lr * Double(((2.0 * model.lambda) * Double(_idx(w, k))))))))
                        k = _int((k &+ 1))
                    }
                }
                j = _int((j &+ 1))

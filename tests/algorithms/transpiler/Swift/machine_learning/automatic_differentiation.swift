// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:01:28 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func div(_ a: Dual, _ b: Dual) -> Dual {
        return Dual(value: (a.value / b.value), deriv: (Double(((a.deriv * b.value) - (b.deriv * a.value))) / Double((b.value * b.value))))
    }
    func power(_ a: Dual, _ p: Int) -> Dual {
        return Dual(value: Double(pow_float(Double(a.value), p)), deriv: ((Double((1.0 * Double(p))) * Double(pow_float(Double(a.value), (p &- 1)))) * a.deriv))
    }
    func main() {
        let a = dual(2.0, 1.0)
        let b = dual(1.0, 0.0)

// Generated by Mochi transpiler v0.10.62 on 2025-08-09 16:38:52 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    while (k < _int(((neighbors).count))) {
        ...
        print(_p((((("[" + "[" + n.vector.map{ _p($0).replacingOccurrences(of: ", ", with: " ") }.joined(separator: " ") + "]") + ", ") + _p(n.distance)) + "]")))
        k = _int((k &+ 1))
    }

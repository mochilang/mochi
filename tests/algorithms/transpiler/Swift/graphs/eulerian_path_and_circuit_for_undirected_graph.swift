// Generated by Mochi transpiler v0.10.60 on 2025-08-08 10:44:03 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func dfs(_ u: Int, _ graph: [Int: [Int]], _ visited_edge: inout [[Bool]], _ path: inout [Int]) -> [Int] {
        ...
        if (graph[u] != nil) {
            ...
            while (i < _int(((neighbors).count))) {
                let v = (neighbors[i] as? Int ?? 0)
                if ((visited_edge[u][v] as! Bool) == false) {
    ...
    func check_euler(_ graph: [Int: [Int]], _ max_node: Int) {
        var visited_edge: [[Bool]] = (make_matrix(max_node) as! [[Bool]])
...
let g1: [Int: [Int]] = ([1: ([2, 3, 4] as! [Int]), 2: ([1, 3] as! [Int]), 3: ([1, 2] as! [Int]), 4: ([1, 5] as! [Int]), 5: ([4] as! [Int])] as! [Int: [Int]])
let g2: [Int: [Int]] = ([1: ([2, 3, 4, 5] as! [Int]), 2: ([1, 3] as! [Int]), 3: ([1, 2] as! [Int]), 4: ([1, 5] as! [Int]), 5: ([1, 4] as! [Int])] as! [Int: [Int]])
let g3: [Int: [Int]] = ([1: ([2, 3, 4] as! [Int]), 2: ([1, 3, 4] as! [Int]), 3: ([1, 2] as! [Int]), 4: ([1, 2, 5] as! [Int]), 5: ([4] as! [Int])] as! [Int: [Int]])
let g4: [Int: [Int]] = ([1: ([2, 3] as! [Int]), 2: ([1, 3] as! [Int]), 3: ([1, 2] as! [Int])] as! [Int: [Int]])

// Generated by Mochi transpiler v0.10.60 on 2025-08-08 10:44:33 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func get_transitions(_ start: String, _ trans: [Transition], _ steps: Int) -> [String: Int] {
        ...
        while (i < steps) {
            ...
            var count: Int = (visited[String(String(describing: node))] as? Int ?? 0)
            count = _int((count &+ 1))
    ...
    func main() -> Void {
        let transitions: [Transition] = ([Transition(src: "a", dst: "a", prob: 0.9), Transition(src: "a", dst: "b", prob: 0.075), Transition(src: "a", dst: "c", prob: 0.025), Transition(src: "b", dst: "a", prob: 0.15), Transition(src: "b", dst: "b", prob: 0.8), Transition(src: "b", dst: "c", prob: 0.05), Transition(src: "c", dst: "a", prob: 0.25), Transition(src: "c", dst: "b", prob: 0.25), Transition(src: "c", dst: "c", prob: 0.5)] as! [Transition])
        let result: [String: Int] = (get_transitions("a", (transitions as! [Transition]), 5000) as! [String: Int])
        print(_p(((((_p((result[String("a")] as? Int ?? 0)) + " ") + _p((result[String("b")] as? Int ?? 0))) + " ") + _p((result[String("c")] as? Int ?? 0)))))
    }
    _ = main()
    let _benchEnd = _now()

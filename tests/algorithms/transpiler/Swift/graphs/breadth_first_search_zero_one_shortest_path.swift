// Generated by Mochi transpiler v0.10.59 on 2025-08-07 09:59:24 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func get_shortest_path(_ al: AdjacencyList, _ start_vertex: Int, _ finish_vertex: Int) -> Int {
        ...
        while (Int(((queue).count)) > 0) {
            let current_vertex = Int(front((queue as! [Int])))
    ...
    _ = add_edge(&g, 9, 7, 0)
    _ = add_edge(&g, 9, 10, 1)
    print(_p(_p(Int(get_shortest_path((g as! AdjacencyList), 0, 3)))))
    print(_p(_p(Int(get_shortest_path((g as! AdjacencyList), 4, 10)))))
    print(_p(_p(Int(get_shortest_path((g as! AdjacencyList), 4, 8)))))
    print(_p(_p(Int(get_shortest_path((g as! AdjacencyList), 0, 1)))))
    let _benchEnd = _now()

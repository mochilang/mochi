// Generated by Mochi transpiler v0.10.65 on 2025-08-14 15:58:09 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func multi_a_star(_ start: Pos, _ goal: Pos, _ n_heuristic: Int) {
        ...
        while (i < n_heuristic) {
            ...
            open_list = _set(open_list, i, (pq_put(&_idx(open_list, i), (start as! Pos), Double(pri)) as! [PQNode]))
            i = _int((i &+ 1))
        }
                ...
                if (valid((nb as! Pos)) && (in_blocks((nb as! Pos)) == false)) {
                    ...
                    if ((!(g_function[nkey] != nil)) || (tentative < Double(g_function[String(String(describing: nkey))] ?? 0.0))) {
                        ...
                        while (i < n_heuristic) {
                            ...
                            open_list = _set(open_list, i, (pq_put(&_idx(open_list, i), (nb as! Pos), Double(pri2)) as! [PQNode]))
                            i = _int((i &+ 1))
                        }
                    }
                }

// Generated by Mochi transpiler v0.10.60 on 2025-08-08 10:44:07 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    let EDGE_ARRAY: [[[String]]] = ([([(["ab", "e1"] as! [String]), (["ac", "e3"] as! [String]), (["ad", "e5"] as! [String]), (["bc", "e4"] as! [String]), (["bd", "e2"] as! [String]), (["be", "e6"] as! [String]), (["bh", "e12"] as! [String]), (["cd", "e2"] as! [String]), (["ce", "e4"] as! [String]), (["de", "e1"] as! [String]), (["df", "e8"] as! [String]), (["dg", "e5"] as! [String]), (["dh", "e10"] as! [String]), (["ef", "e3"] as! [String]), (["eg", "e2"] as! [String]), (["fg", "e6"] as! [String]), (["gh", "e6"] as! [String]), (["hi", "e3"] as! [String])] as! [[String]]), ([(["ab", "e1"] as! [String]), (["ac", "e3"] as! [String]), (["ad", "e5"] as! [String]), (["bc", "e4"] as! [String]), (["bd", "e2"] as! [String]), (["be", "e6"] as! [String]), (["cd", "e2"] as! [String]), (["de", "e1"] as! [String]), (["df", "e8"] as! [String]), (["ef", "e3"] as! [String]), (["eg", "e2"] as! [String]), (["fg", "e6"] as! [String])] as! [[String]]), ([(["ab", "e1"] as! [String]), (["ac", "e3"] as! [String]), (["bc", "e4"] as! [String]), (["bd", "e2"] as! [String]), (["de", "e1"] as! [String]), (["df", "e8"] as! [String]), (["dg", "e5"] as! [String]), (["ef", "e3"] as! [String]), (["eg", "e2"] as! [String]), (["eh", "e12"] as! [String]), (["fg", "e6"] as! [String]), (["fh", "e10"] as! [String]), (["gh", "e6"] as! [String])] as! [[String]]), ([(["ab", "e1"] as! [String]), (["ac", "e3"] as! [String]), (["bc", "e4"] as! [String]), (["bd", "e2"] as! [String]), (["bh", "e12"] as! [String]), (["cd", "e2"] as! [String]), (["df", "e8"] as! [String]), (["dh", "e10"] as! [String])] as! [[String]]), ([(["ab", "e1"] as! [String]), (["ac", "e3"] as! [String]), (["ad", "e5"] as! [String]), (["bc", "e4"] as! [String]), (["bd", "e2"] as! [String]), (["cd", "e2"] as! [String]), (["ce", "e4"] as! [String]), (["de", "e1"] as! [String]), (["df", "e8"] as! [String]), (["dg", "e5"] as! [String]), (["ef", "e3"] as! [String]), (["eg", "e2"] as! [String]), (["fg", "e6"] as! [String])] as! [[String]])] as! [[[String]]])
    ...
    func get_distinct_edge(_ edge_array: [[[String]]]) -> [String] {
        ...
        for row in edge_array {
            for item in row {
                let e = (item[0] as! String)
                if (!((distinct as! [String]).contains((e as! String)))) {
    ...
    func get_bitcode(_ edge_array: [[[String]]], _ de: String) -> String {
        ...
        while (i < _int(((edge_array).count))) {
            ...
            for item in (edge_array[i] as! [[String]]) {
                if ((item[0] as! String) == de) {
                    found = true
                    break
                }
            }
    ...
    func get_frequency_table(_ edge_array: [[[String]]]) -> [[String: String]] {
        ...
        while (i < _int(((table).count))) {
            ...
            while (j < _int(((table).count))) {
                if (String(describing: toi((String(Array(table[j])["count"]) as! String))) > String(describing: toi((String(Array(table[max_i])["count"]) as! String)))
                ) {
                    max_i = Int(j)
                }
                j = _int((j &+ 1))
            }
            let tmp: [String: String] = (table[i] as! [String: String])
            table = _set(table, i, (table[max_i] as! [String: String]))
    ...
    func get_nodes(_ freq_table: [[String: String]]) -> NodesData {
        ...
        for _item in freq_table as! [[String: Any]] {
            ...
            if (nodes[code] != nil) {
                ...
                nodes = _set(nodes, String(describing: code), ([edge] as! [String]))
    ...
    func get_support(_ clusters: ClusterData) -> [Int] {
        ...
        while (i < _int(((clusters.weights).count))) {
            let w = (clusters.weights[i] as? Int ?? 0)
    ...
    func create_edge(_ nodes: NodesData, _ graph: inout [String: [String]], _ gkeys: [String], _ clusters: ClusterData, _ c1: Int, _ maxk: Int) -> [String] {
        ...
        while (idx1 < _int(((codes1).count))) {
            let i_code = (codes1[idx1] as! String)
            var count: Int = 0
            var c2: Int = (c1 &+ 1)
            while (c2 <= maxk) {
                ...
                while (j < _int(((codes2).count))) {
                    ...
                    if contains_bits((i_code as! String), (j_code as! String)) {
                        if (graph[i_code] != nil) {
                            ...
                            graph = _set(graph, String(describing: i_code), ([j_code] as! [String]))
                            if (!((keys as! [String]).contains((i_code as! String)))) {
                                keys = (_append(keys, i_code) as! [String])
                            }
                        }
                        if (!((keys as! [String]).contains((j_code as! String)))) {
    ...
    func my_dfs(_ graph: [String: [String]], _ start: String, _ end: String, _ path: [String]) -> Void {
        var new_path: [String] = (copy_list((path as! [String])) as! [String])
    ...
    func find_freq_subgraph_given_support(_ s: Int, _ clusters: ClusterData, _ graph: GraphData) -> Void {
        ...
        while (i < _int(((codes).count))) {
            _ = my_dfs((graph.edges as! [String: [String]]), (codes[i] as! String), "Header", ([] as! [String]))
            i = _int((i &+ 1))
        }
    }
        ...
        for path in paths {
            ...
            while (j < (_int(((path).count)) &- 1)) {
                ...
                while (e < _int(((edge_list).count))) {
                    ...
                    el = (_append(el, ([a, b] as! [String])) as! [[String]])
                    e = _int((e &+ 1))
                }
                j = _int((j &+ 1))
            }
    ...
    func print_all(_ nodes: NodesData, _ support: [Int], _ clusters: ClusterData, _ graph: GraphData, _ freq_subgraph_edge_list: [[[String]]]) -> Void {
        ...
        while (j < _int(((clusters.weights).count))) {
            let w = (clusters.weights[j] as? Int ?? 0)
        ...
        while (k < _int(((graph.keys).count))) {
            let key = (graph.keys[k] as! String)
            print(_p(key))

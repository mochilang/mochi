// Generated by Mochi transpiler v0.10.60 on 2025-08-08 10:43:46 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func list_to_string(_ lst: [Int]) -> String {
        ...
        while (i < _int(((lst).count))) {
            res = ((res + _p((lst[i] as? Int ?? 0))) as! String)
    ...
    var g: Graph = Graph(vertex: [:], size: 0)

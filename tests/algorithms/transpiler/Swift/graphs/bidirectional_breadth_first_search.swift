// Generated by Mochi transpiler v0.10.59 on 2025-08-07 11:09:40 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func neighbors(_ pos: String) -> [String] {
        ...
        while (i < _int(((delta).count))) {
            ...
            if ((((ny >= 0) && (ny < _int(((grid).count)))) && (nx >= 0)) && (nx < _int((((grid[0] as! [Int])).count)))) {
    ...
    let goal = String(describing: key((_int(((grid).count)) &- 1), (_int((((grid[0] as! [Int])).count)) &- 1)))

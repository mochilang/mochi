// Generated by Mochi transpiler v0.10.65 on 2025-08-14 16:21:26 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func to_little_endian(_ s: String) -> String {
        ...
        return (((String(_slice(Array(s), 24, 32)) + String(_slice(Array(s), 16, 24))) + String(_slice(Array(s), 8, 16))) + String(_slice(Array(s), 0, 8)))
    }
    ...
    func reformat_hex(_ i: Int) -> String {
        ...
        while (j >= 0) {
            le = ((le + String(_slice(Array(hex), j, (j &+ 2)))) as! String)
            j = _int((j &- 2))
        }
        return le
    }
    func preprocess(_ message: String) -> String {
        ...
        bit_string = (((bit_string + String(describing: to_little_endian((String(_slice(Array(start_len), 32, 64)) as! String)))) + String(describing: to_little_endian((String(_slice(Array(start_len), 0, 32)) as! String)))) as! String)
        return bit_string
    }

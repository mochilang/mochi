// Generated by Mochi transpiler v0.10.61 on 2025-08-08 19:13:49 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func simple_interest(_ principal: Double, _ daily_rate: Double, _ days: Double) -> Double {
        if (days <= 0.0) {
            _ = panic("days_between_payments must be > 0")
            return 0.0
        }
        if (daily_rate < 0.0) {
            _ = panic("daily_interest_rate must be >= 0")
            return 0.0
        }
        if (principal <= 0.0) {
            _ = panic("principal must be > 0")
            return 0.0
        }
    ...
    func compound_interest(_ principal: Double, _ nominal_rate: Double, _ periods: Double) -> Double {
        if (periods <= 0.0) {
            _ = panic("number_of_compounding_periods must be > 0")
            return 0.0
        }
        if (nominal_rate < 0.0) {
            _ = panic("nominal_annual_interest_rate_percentage must be >= 0")
            return 0.0
        }
        if (principal <= 0.0) {
            _ = panic("principal must be > 0")
    ...
    func apr_interest(_ principal: Double, _ apr: Double, _ years: Double) -> Double {
        if (years <= 0.0) {
            _ = panic("number_of_years must be > 0")
            return 0.0
        }
        if (apr < 0.0) {
            _ = panic("nominal_annual_percentage_rate must be >= 0")
            return 0.0
        }
        if (principal <= 0.0) {
            _ = panic("principal must be > 0")

// Generated by Mochi transpiler v0.10.66 on 2025-08-14 18:26:15 GMT+7
import Foundation
import Dispatch
    ...
    func solution() -> Int {
        ...
        while (i < _int(((triangle).count))) {
            ...
            while (j < _int((((_idx(triangle, i) as! [Int])).count))) {
                ...
                _tmp2 = _set(_tmp2, j, _int(((_idx(_idx(triangle, i)!, j) as? Int ?? 0) &+ max_val)))
                triangle = _set(triangle, i, (_tmp2 as! [Int]))
                j = _int((j &+ 1))
            }
            i = _int((i &+ 1))
        }

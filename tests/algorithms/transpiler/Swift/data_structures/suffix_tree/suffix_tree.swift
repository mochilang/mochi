// Generated by Mochi transpiler v0.10.60 on 2025-08-07 16:58:12 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func new_node() -> Node {
        return Node(children: ([:] as! [String: Int]), is_end_of_string: false, start: _int(-1), end: _int(-1))
    }
    ...
    func new_suffix_tree(_ text: String) -> SuffixTree {
        var tree: SuffixTree = SuffixTree(text: String(describing: text), nodes: ([] as! [Node]))

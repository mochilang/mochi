// Generated by Mochi transpiler v0.10.59 on 2025-08-07 00:29:30 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    print(_p(String(describing: has_key((root_check.children as! [String: Int]), "a"))))
    print(_p(String(describing: leaf_check.is_end_of_string)))
    print(_p(String(describing: leaf_check.start)))
    print(_p(String(describing: leaf_check.end)))
    print(_p(String(describing: leaf_check.suffix_link)))
    let _benchEnd = _now()

// Generated by Mochi transpiler v0.10.60 on 2025-08-07 16:58:16 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func new_suffix_tree_node(_ children: [String: Int], _ is_end_of_string: Bool, _ start: Int, _ end: Int, _ suffix_link: Int) -> SuffixTreeNode {
        return SuffixTreeNode(children: (children as! [String: Int]), is_end_of_string: Bool(is_end_of_string), start: Int(start), end: Int(end), suffix_link: Int(suffix_link))
    }

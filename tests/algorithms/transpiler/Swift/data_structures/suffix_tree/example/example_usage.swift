// Generated by Mochi transpiler v0.10.59 on 2025-08-07 00:29:26 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func main() {
        ...
        var i: Int = 0
        while (i < Int(((patterns).count))) {
            let pattern = (patterns[i] as! String)
            let found = search((suffix_tree as! SuffixTree), (pattern as! String))
            print(_p(((("Pattern '" + pattern) + "' found: ") + String(describing: found))))
            i = Int((i &+ 1))
        }
    }
    _ = main()

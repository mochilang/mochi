// Generated by Mochi transpiler v0.10.60 on 2025-08-07 16:54:03 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func swap_nodes(_ list: LinkedList, _ v1: Int, _ v2: Int) -> LinkedList {
        ...
        while (i < _int(((list.data).count))) {
            if (((list.data[i] as? Int ?? 0) == v1) && (idx1 == (0 &- 1))) {
                idx1 = Int(i)
            }
            if (((list.data[i] as? Int ?? 0) == v2) && (idx2 == (0 &- 1))) {
                idx2 = Int(i)
            }
            i = _int((i &+ 1))
        }
        ...
        let temp = (res[idx1] as? Int ?? 0)
        res = _set(res, idx1, (res[idx2] as? Int ?? 0))

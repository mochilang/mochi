// Generated by Mochi transpiler v0.10.60 on 2025-08-07 16:51:33 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func add_node(_ list: LinkedList, _ value: Int) -> LinkedList {
        ...
        while ((nexts[last] as? Int ?? 0) != NULL) {
            last = (nexts[last] as? Int ?? 0)
        }
        ...
        while (i < _int(((nexts).count))) {
            if (i == last) {
                ...
                new_nexts = (_append(new_nexts, (nexts[i] as? Int ?? 0)) as! [Int])
            }
            i = _int((i &+ 1))
        }
    ...
    func detect_cycle(_ list: LinkedList) -> Bool {
        ...
        while ((fast != NULL) && ((nexts[fast] as? Int ?? 0) != NULL)) {
            slow = (nexts[slow] as? Int ?? 0)
            fast = (nexts[(nexts[fast] as? Int ?? 0)] as? Int ?? 0)
            if (slow == fast) {
                return true
            }
        }

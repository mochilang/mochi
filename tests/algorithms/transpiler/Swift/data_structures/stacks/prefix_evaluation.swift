// Generated by Mochi transpiler v0.10.60 on 2025-08-07 16:57:45 GMT+7
import Foundation
import Dispatch
...
do {
        ...
        while (i >= 0) {
            ...
            if (token != "") {
                if is_operand((token as! String)) {
                    ...
                    let o1 = Double(stack[(_int(((stack).count)) &- 1)])
                    let o2 = Double(stack[(_int(((stack).count)) &- 2)])
                    stack = (Array(stack[0..<(_int(((stack).count)) &- 2)]) as! [Double])
    ...
    print(_p(_p(Double(evaluate((test_expression as! String))))))
    let test_expression2 = "/ * 10 2 + 4 1 "
    print(_p(_p(Double(evaluate((test_expression2 as! String))))))
    let test_expression3 = "+ * 2 3 / 8 4"
    print(_p(_p(Double(evaluate_recursive((test_expression3 as! String))))))
    let _benchEnd = _now()

// Generated by Mochi transpiler v0.10.60 on 2025-08-07 16:57:21 GMT+7
import Foundation
import Dispatch
    ...
    func infix_to_postfix(_ expression: String) -> String {
        ...
        while (i < _int(((expression).count))) {
            ...
            if is_alnum((ch as! String)) {
                ...
                while ((_int(((stack).count)) > 0) && ((stack[(_int(((stack).count)) &- 1)] as! String) != "(")) {
                    postfix = (_append(postfix, (stack[(_int(((stack).count)) &- 1)] as! String)) as! [String])
                ...
                while true {
                    ...
                    let cp = _int(precedence((ch as! String)))
                    let tp = _int(precedence((stack[(_int(((stack).count)) &- 1)] as! String)))
                    if (cp > tp) {
                        stack = (_append(stack, ch) as! [String])
                        break
                    }

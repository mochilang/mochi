...
do {
    ...
    func apply_table(_ inp: String, _ table: [Int]) -> String {
        ...
        while (i < _int(((table).count))) {
            ...
            res = ((res + String(_slice(Array(inp), idx, (idx &+ 1)))) as! String)
            i = _int((i &+ 1))
        }
        return res
    }
    func left_shift(_ data: String) -> String {
        return (String(_slice(Array(data), 1, _int(((data).count)))) + String(_slice(Array(data), 0, 1)))
    }
    ...
    func apply_sbox(_ s: [[Int]], _ data: String) -> String {
        let row_bits = (String(_slice(Array(data), 0, 1)) + String(_slice(Array(data), (_int(((data).count)) &- 1), _int(((data).count)))))
    ...
    func f(_ expansion: [Int], _ s0: [[Int]], _ s1: [[Int]], _ key: String, _ message: String) -> String {
        ...
        temp = String(describing: apply_table(((left_bin_str + right_bin_str) as! String), (p4_table as! [Int])))
    ...
    let key1 = String(describing: apply_table(((left + right) as! String), (p8_table as! [Int])))
    left = String(describing: left_shift((left as! String)))
    right = String(describing: left_shift((right as! String)))
    left = String(describing: left_shift((left as! String)))
    right = String(describing: left_shift((right as! String)))
    let key2 = String(describing: apply_table(((left + right) as! String), (p8_table as! [Int])))
    ...
    temp = ((String(_slice(Array(temp), 4, 8)) + String(_slice(Array(temp), 0, 4))) as! String)
    ...
    print(_p(("Plain text after decypting is: " + PT)))
    let _benchEnd = _now()

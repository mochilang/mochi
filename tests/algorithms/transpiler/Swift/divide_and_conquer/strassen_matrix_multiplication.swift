// Generated by Mochi transpiler v0.10.60 on 2025-08-07 17:02:06 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func matrix_addition(_ matrix_a: [[Int]], _ matrix_b: [[Int]]) -> [[Int]] {
        ...
        while (i < _int(((matrix_a).count))) {
            var row: [Int] = ([] as! [Int])
            var j: Int = 0
            while (j < _int((((matrix_a[i] as! [Int])).count))) {
    ...
    func matrix_dimensions(_ matrix: [[Int]]) -> [Int] {
        return ([_int(((matrix).count)), _int((((matrix[0] as! [Int])).count))] as! [Int])
    }
    ...
    func pad_matrix(_ mat: [[Int]], _ rows: Int, _ cols: Int) -> [[Int]] {
        ...
        while (i < rows) {
            ...
            while (j < cols) {
                var v: Int = 0
                if ((i < _int(((mat).count))) && (j < _int((((mat[0] as! [Int])).count)))) {
                    v = (mat[i][j] as? Int ?? 0)
                }
    ...
    func strassen(_ matrix1: [[Int]], _ matrix2: [[Int]]) -> [[Int]] {
        ...
        let maximum = _int((([(dims1[0] as? Int ?? 0), (dims1[1] as? Int ?? 0), (dims2[0] as? Int ?? 0), (dims2[1] as? Int ?? 0)] as! [Int]).max()!))

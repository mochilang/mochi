// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:01:16 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func vec_mat_mul(_ v: [Complex], _ m: [[Complex]]) -> [Complex] {
        ...
        while (col < _int((((_idx(m, 0) as! [Complex])).count))) {
            var sum: Complex = Complex(re: 0.0, im: 0.0)
            var row: Int = 0
    ...
    let a: [[Complex]] = ([([Complex(re: 2.0, im: 0.0), Complex(re: 2.0, im: 1.0), Complex(re: 4.0, im: 0.0)] as! [Complex]), ([Complex(re: 2.0, im: -1.0), Complex(re: 3.0, im: 0.0), Complex(re: 0.0, im: 1.0)] as! [Complex]), ([Complex(re: 4.0, im: 0.0), Complex(re: 0.0, im: -1.0), Complex(re: 1.0, im: 0.0)] as! [Complex])] as! [[Complex]])
    let v: [Complex] = ([Complex(re: 1.0, im: 0.0), Complex(re: 2.0, im: 0.0), Complex(re: 3.0, im: 0.0)] as! [Complex])
    if is_hermitian((a as! [[Complex]])) {
        let r1 = Double(rayleigh_quotient((a as! [[Complex]]), (v as! [Complex])))
        print(_p(r1))
        print(_p("\n"))
    }
    let b: [[Complex]] = ([([Complex(re: 1.0, im: 0.0), Complex(re: 2.0, im: 0.0), Complex(re: 4.0, im: 0.0)] as! [Complex]), ([Complex(re: 2.0, im: 0.0), Complex(re: 3.0, im: 0.0), Complex(re: -1.0, im: 0.0)] as! [Complex]), ([Complex(re: 4.0, im: 0.0), Complex(re: -1.0, im: 0.0), Complex(re: 1.0, im: 0.0)] as! [Complex])] as! [[Complex]])

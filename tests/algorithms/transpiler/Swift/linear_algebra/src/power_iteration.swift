// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:01:12 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func norm(_ vec: [Double]) -> Double {
        ...
        var root: Double = Double(sqrtApprox(Double(sum)))
        return root
    }
    ...
    func power_iteration(_ matrix: [[Double]], _ vector: [Double], _ error_tol: Double, _ max_iterations: Int) -> PowerResult {
        var v: [Double] = (normalize((vector as! [Double])) as! [Double])
    ...
    let input_matrix: [[Double]] = ([([41.0, 4.0, 20.0] as! [Double]), ([4.0, 26.0, 30.0] as! [Double]), ([20.0, 30.0, 50.0] as! [Double])] as! [[Double]])
    let vector: [Double] = ([41.0, 4.0, 20.0] as! [Double])

// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:01:11 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func points_to_polynomial(_ coordinates: [[Int]]) -> String {
        ...
        while (count < n) {
            ...
            while (number < n) {
                if (count != number) {
                    ...
                    var cc: Int = 0
                    while (cc < n) {
                        _idx(_idx(matrix, number), cc) = Double((Double(_idx(_idx(matrix, number), cc)) - (Double(_idx(_idx(matrix, count), cc)) * fraction)))
                        cc = _int((cc &+ 1))
                    }
        ...
        count = 0
        while (count < n) {
            var parts: [String] = (_split((_idx(solution, count) as! String), "e") as! [String])
            var coeff: String = (_idx(solution, count) as! String)
    ...
    func main() {
        print(_p(String(describing: points_to_polynomial(([([1, 0] as! [Int]), ([2, 0] as! [Int]), ([3, 0] as! [Int])] as! [[Int]])))))
        print(_p(String(describing: points_to_polynomial(([([1, 1] as! [Int]), ([2, 1] as! [Int]), ([3, 1] as! [Int])] as! [[Int]])))))
        print(_p(String(describing: points_to_polynomial(([([1, 1] as! [Int]), ([2, 4] as! [Int]), ([3, 9] as! [Int])] as! [[Int]])))))
        print(_p(String(describing: points_to_polynomial(([([1, 3] as! [Int]), ([2, 6] as! [Int]), ([3, 11] as! [Int])] as! [[Int]])))))
        print(_p(String(describing: points_to_polynomial(([([1, -3] as! [Int]), ([2, -6] as! [Int]), ([3, -11] as! [Int])] as! [[Int]])))))
        print(_p(String(describing: points_to_polynomial(([([1, 1] as! [Int]), ([1, 2] as! [Int]), ([1, 3] as! [Int])] as! [[Int]])))))
        print(_p(String(describing: points_to_polynomial(([([1, 5] as! [Int]), ([2, 2] as! [Int]), ([3, 9] as! [Int])] as! [[Int]])))))
    }
    _ = main()
    let _benchEnd = _now()

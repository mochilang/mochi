// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:01:17 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func inverse(_ mat: [[Double]]) -> [[Double]] {
        ...
        var col: Int = 0
        while (col < n) {
            var pivot_row: [Double] = (_idx(aug, col) as! [Double])
            ...
            while (r < n) {
                if (r != col) {
                    var row_r: [Double] = (_idx(aug, r) as! [Double])
    ...
    func main() {
        let a: [[Double]] = ([([1.0, 2.0] as! [Double]), ([2.0, 1.0] as! [Double])] as! [[Double]])
        let b: [[Double]] = ([([0.0, 3.0] as! [Double]), ([3.0, 0.0] as! [Double])] as! [[Double]])
        let c: [[Double]] = ([([2.0, 1.0] as! [Double]), ([6.0, 3.0] as! [Double])] as! [[Double]])

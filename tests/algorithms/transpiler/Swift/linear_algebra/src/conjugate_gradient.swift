// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:01:06 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func conjugate_gradient(_ A: [[Double]], _ b: [Double], _ max_iterations: Int, _ tol: Double) -> [Double] {
        let n = _int(((b).count))
        var x: [Double] = (zeros(n) as! [Double])
        var r: [Double] = (vec_sub((b as! [Double]), (mat_vec_mul((A as! [[Double]]), (x as! [Double])) as! [Double])) as! [Double])
        var p: [Double] = r
        var rs_old: Double = Double(dot((r as! [Double]), (r as! [Double])))
        var i: Int = 0
    ...
    let A: [[Double]] = ([([8.73256573, -5.02034289, -2.68709226] as! [Double]), ([-5.02034289, 3.78188322, 0.91980451] as! [Double]), ([-2.68709226, 0.91980451, 1.94746467] as! [Double])] as! [[Double]])
    let b: [Double] = ([-5.80872761, 3.23807431, 1.95381422] as! [Double])

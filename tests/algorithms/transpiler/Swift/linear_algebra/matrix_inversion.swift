// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:01:04 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func invert_matrix(_ matrix: [[Double]]) -> [[Double]] {
        ...
        while (col < n) {
            ...
            var c: Int = 0
            while (c < (2 &* n)) {
                _idx(_idx(aug, col), c) = Double((Double(_idx(_idx(aug, col), c)) / pivot))
                c = _int((c &+ 1))
            }
            var r2: Int = 0
            while (r2 < n) {
                if (r2 != col) {
                    ...
                    var c2: Int = 0
                    while (c2 < (2 &* n)) {
                        _idx(_idx(aug, r2), c2) = Double((Double(_idx(_idx(aug, r2), c2)) - (factor * Double(_idx(_idx(aug, col), c2)))))
                        c2 = _int((c2 &+ 1))
                    }
                }
                r2 = _int((r2 &+ 1))
    ...
    var mat: [[Double]] = ([([4.0, 7.0] as! [Double]), ([2.0, 6.0] as! [Double])] as! [[Double]])

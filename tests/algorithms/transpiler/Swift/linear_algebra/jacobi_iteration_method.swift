// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:01:01 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func jacobi_iteration_method(_ coefficient: [[Double]], _ constant: [Double], _ init_val: [Double], _ iterations: Int) -> [Double] {
        ...
        while (k < iterations) {
            ...
            while (i < n) {
                ...
                var value: Double = (Double((Double(_idx(constant, i)) - sum)) / Double(_idx(_idx(coefficient, i), i)))
    ...
    let coefficient: [[Double]] = ([([4.0, 1.0, 1.0] as! [Double]), ([1.0, 5.0, 2.0] as! [Double]), ([1.0, 2.0, 4.0] as! [Double])] as! [[Double]])
    let constant: [Double] = ([2.0, -6.0, -4.0] as! [Double])
    let init_val: [Double] = ([0.5, -0.5, -0.5] as! [Double])
    let iterations = 3

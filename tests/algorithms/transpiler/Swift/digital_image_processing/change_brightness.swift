// Generated by Mochi transpiler v0.10.60 on 2025-08-07 16:59:51 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func change_brightness(_ img: [[Int]], _ level: Int) -> [[Int]] {
        ...
        while (i < _int(((img).count))) {
            ...
            var j: Int = 0
            while (j < _int((((img[i] as! [Int])).count))) {
                row_res = (_append(row_res, _int(clamp(((img[i][j] as? Int ?? 0) &+ level)))) as! [Int])
                j = _int((j &+ 1))
            }

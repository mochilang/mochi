// Generated by Mochi transpiler v0.10.60 on 2025-08-07 17:00:39 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func median_filter(_ gray_img: [[Int]], _ mask: Int) -> [[Int]] {
        let rows = _int(((gray_img).count))
        let cols = _int((((gray_img[0] as! [Int])).count))
        let bd = (mask / 2)

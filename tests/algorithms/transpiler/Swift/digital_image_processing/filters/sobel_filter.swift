// Generated by Mochi transpiler v0.10.60 on 2025-08-07 17:00:44 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func pad_edge(_ img: [[Double]], _ pad: Int) -> [[Double]] {
        ...
        let w = _int((((img[0] as! [Double])).count))
    ...
    func abs_matrix(_ mat: [[Double]]) -> [[Double]] {
        let h = _int(((mat).count))
        let w = _int((((mat[0] as! [Double])).count))
        var out: [[Double]] = (zeros(h, w) as! [[Double]])
        var y: Int = 0
        while (y < h) {
            var x: Int = 0
    ...
    func max_matrix(_ mat: [[Double]]) -> Double {
        ...
        var y: Int = 0
        while (y < _int(((mat).count))) {
            var x: Int = 0
            while (x < _int((((mat[0] as! [Double])).count))) {
    ...
    func sobel_filter(_ image: [[Int]]) -> [[[Double]]] {
        ...
        let w = _int((((image[0] as! [Int])).count))
    ...
    func print_matrix_int(_ mat: [[Double]]) {
        ...
        while (y < _int(((mat).count))) {
            var line: String = ""
            var x: Int = 0
            while (x < _int((((mat[y] as! [Double])).count))) {
                line = ((line + _p(_int(mat[y][x]))) as! String)
                if (x < (_int((((mat[y] as! [Double])).count)) &- 1)) {
                    line = ((line + " ") as! String)
                }
                x = _int((x &+ 1))
            }
    ...
    func print_matrix_float(_ mat: [[Double]]) {
        ...
        while (y < _int(((mat).count))) {
            ...
            var x: Int = 0
            while (x < _int((((mat[y] as! [Double])).count))) {
                line = ((line + _p(Double(mat[y][x]))) as! String)
                if (x < (_int((((mat[y] as! [Double])).count)) &- 1)) {
                    line = ((line + " ") as! String)
                }
                x = _int((x &+ 1))

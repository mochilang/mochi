// Generated by Mochi transpiler v0.10.60 on 2025-08-07 17:01:11 GMT+7
import Foundation
import Dispatch
    ...
    func get_rotation(_ img: [[Int]], _ pt1: [[Double]], _ pt2: [[Double]], _ rows: Int, _ cols: Int) -> [[Int]] {
        ...
        while (y < rows) {
            ...
            while (x < cols) {
                ...
                let sx = _int(round_to_int(Double(xf)))
                let sy = _int(round_to_int(Double(yf)))

// Generated by Mochi transpiler v0.10.60 on 2025-08-07 17:00:53 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func main() {
        ...
        let redEdge = 40.0
        let nir = 100.0
        print(_p(("NDVI=" + _p(Double(ndvi(Double(red), Double(nir)))))))
        print(_p(("CCCI=" + _p(Double(ccci(Double(red), Double(redEdge), Double(nir)))))))
        print(_p(("CVI=" + _p(Double(cvi(Double(red), Double(green), Double(nir)))))))
    }
    _ = main()
    let _benchEnd = _now()

...
start = Process.clock_gettime(Process::CLOCK_MONOTONIC, :nanosecond)
  ...
  raise 'assertion failed' unless _eq(archimedes_principle(500.0, 4.0, 9.8), 19600.0)
  raise 'assertion failed' unless _eq(archimedes_principle(997.0, 0.5, 9.8), 4885.3)
  $r = archimedes_principle_default(997.0, 0.7)
  $expected = archimedes_principle(997.0, 0.7, $G)
  raise 'assertion failed' unless _eq($r, $expected)
  raise 'assertion failed' unless _eq(archimedes_principle(997.0, 0.7, 0.0), 0.0)

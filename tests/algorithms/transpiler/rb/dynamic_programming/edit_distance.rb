...
start = _now()
  ...
  puts((min_dist_top_down("intention", "execution")).to_s)
  puts((min_dist_top_down("intention", "")).to_s)
  puts((min_dist_top_down("", "")).to_s)
  puts((min_dist_bottom_up("intention", "execution")).to_s)
  puts((min_dist_bottom_up("intention", "")).to_s)
  puts((min_dist_bottom_up("", "")).to_s)
end_time = _now()
end_mem = _mem()

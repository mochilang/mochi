...
start = Process.clock_gettime(Process::CLOCK_MONOTONIC, :nanosecond)
  ...
  def hackernews_top_stories(max_stories)
    ...
    i = 0
    while i < _len(ids)
      stories = _append(stories, get_hackernews_story((__tmp1 = ids; __tmp1.is_a?(Hash) ? __tmp1[i] : _idx(__tmp1, i))))
      i = _add(i, 1)
    end
    return stories
  end
  ...
  Object.const_set(:Story, Struct.new(:title, :url, keyword_init: true))

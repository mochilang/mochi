...
start = _now()
  ...
  puts(_str(index_of_rightmost_set_bit(0)))
  puts(_str(index_of_rightmost_set_bit(5)))
  puts(_str(index_of_rightmost_set_bit(36)))
  puts(_str(index_of_rightmost_set_bit(8)))
end_time = _now()
end_mem = _mem()

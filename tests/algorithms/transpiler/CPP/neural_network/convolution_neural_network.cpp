// Generated by Mochi transpiler v0.10.61 on 2025-08-08 20:01:31 GMT+7
#include <iostream>
#include <string>
#include <cmath>
#include <vector>
        ...
        while ((s < samples.size())) {
            ...
            while ((j < w_out.size())) {
                ...
                while ((k < _index(w_out, j).size())) {
                    w_out[j][k] = (_index(_index(w_out, j), k) + ((cnn.rate_weight * _index(hidden_out, j)) * _index(pd_out, k)));
                    k = (k + int64_t(1));
                }
                j = (j + int64_t(1));
            }
            j = int64_t(0);
            while ((j < b_out.size())) {
                b_out[j] = (_index(b_out, j) - (cnn.rate_bias * _index(pd_out, j)));
                j = (j + int64_t(1));
            }
            ...
            while ((i_h < w_hidden.size())) {
                ...
                while ((j_h < _index(w_hidden, i_h).size())) {
                    w_hidden[i_h][j_h] = (_index(_index(w_hidden, i_h), j_h) + ((cnn.rate_weight * _index(flat, i_h)) * _index(pd_hidden, j_h)));
                    j_h = (j_h + int64_t(1));
                }
                i_h = (i_h + int64_t(1));
            }
            ...
            while ((j < b_hidden.size())) {
                b_hidden[j] = (_index(b_hidden, j) - (cnn.rate_bias * _index(pd_hidden, j)));
                j = (j + int64_t(1));
            }
            s = (s + int64_t(1));
        }

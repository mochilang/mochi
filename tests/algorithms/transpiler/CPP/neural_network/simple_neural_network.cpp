// Generated by Mochi transpiler v0.10.61 on 2025-08-08 20:01:40 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
double sigmoid(double x) {
    return ((double)(1.0) / ((1.0 + expApprox(-x))));
}
...
double forward_propagation(int64_t expected, int64_t number_propagations) {
    ...
    while ((i < number_propagations)) {
        ...
        double layer_1_error = (((double)((double)(expected)) / (100.0)) - layer_1);

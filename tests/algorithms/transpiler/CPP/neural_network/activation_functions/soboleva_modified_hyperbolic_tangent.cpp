// Generated by Mochi transpiler v0.10.64 on 2025-08-12 13:53:39 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <cmath>
...
std::vector<double> soboleva_modified_hyperbolic_tangent(const std::vector<double>& vector, double a_value, double b_value, double c_value, double d_value);
int main();
...
std::vector<double> soboleva_modified_hyperbolic_tangent(const std::vector<double>& vector, double a_value, double b_value, double c_value, double d_value) {
    ...
    while ((i < vector.size())) {
        ...
        double numerator = ((double)(std::exp((a_value * x))) - (double)(std::exp((-b_value * x))));
        double denominator = ((double)(std::exp((c_value * x))) + (double)(std::exp((-d_value * x))));
        result = ([&]{ auto __tmp = result; __tmp.push_back(((double)(numerator) / (denominator))); return __tmp; }());
        i = (i + int64_t(1));
    }
    return result;
}
...
int main() {
    {
        ...
        std::vector<double> vector = std::vector<double>{5.4, -2.4, 6.3, -5.23, 3.27, 0.56};
        std::vector<double> res = soboleva_modified_hyperbolic_tangent(vector, 0.2, 0.4, 0.6, 0.8);
        _json(res);
    }
    return 0;
}

// Generated by Mochi transpiler v0.10.66 on 2025-08-16 13:52:47 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <any>
...
std::vector<double> soboleva_modified_hyperbolic_tangent(const std::vector<double>& vector, double a_value, double b_value, double c_value, double d_value) {
    ...
    while ((i < vector.size())) {
        ...
        double numerator = (_exp((a_value * x)) - _exp((-b_value * x)));
        double denominator = (_exp((c_value * x)) + _exp((-d_value * x)));

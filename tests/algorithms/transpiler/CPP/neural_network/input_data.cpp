// Generated by Mochi transpiler v0.10.61 on 2025-08-08 20:01:36 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <type_traits>
...
int main() {
    {
        ...
        ds = res.dataset;
        std::cout << ([&]{ std::ostringstream ss; { auto __tmp = res.images; ss << "["; for(size_t i=0;i<__tmp.size();++i){ if(i>0) ss << ' '; { std::ostringstream __ss; __ss << __tmp[static_cast<size_t>(i)];
 ss << __ss.str(); }; } ss << "]"; }
 return ss.str(); }());
        std::cout << std::endl;
        std::cout << ([&]{ std::ostringstream ss; { auto __tmp = res.labels; ss << "["; for(size_t i=0;i<__tmp.size();++i){ if(i>0) ss << ' '; { std::ostringstream __ss; __ss << __tmp[static_cast<size_t>(i)];
 ss << __ss.str(); }; } ss << "]"; }
 return ss.str(); }());
        std::cout << std::endl;

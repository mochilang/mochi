// Generated by Mochi transpiler v0.10.66 on 2025-08-15 10:04:29 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <map>
...
std::map<int64_t, std::vector<std::vector<int64_t>>> connect(const std::map<int64_t, std::vector<std::vector<int64_t>>>& graph, int64_t a, int64_t b, int64_t w) {
    ...
    g[static_cast<size_t>(u)] = ([&]{ auto __tmp = ([&](const auto& __m){ auto __it = __m.find(u); if (__it == __m.end()) return std::vector<std::vector<int64_t>>{}; return __it->second; })(g); __tmp.push_back(std::vector<int64_t>{v, w}); return __tmp; }());
    g[static_cast<size_t>(v)] = ([&]{ auto __tmp = ([&](const auto& __m){ auto __it = __m.find(v); if (__it == __m.end()) return std::vector<std::vector<int64_t>>{}; return __it->second; })(g); __tmp.push_back(std::vector<int64_t>{u, w}); return __tmp; }());
    return g;
}
...
std::vector<std::vector<int64_t>> prim(const std::map<int64_t, std::vector<std::vector<int64_t>>>& graph, int64_t s, int64_t n) {
    ...
    dist[static_cast<size_t>(s)] = int64_t(0);
    parent[static_cast<size_t>(s)] = -int64_t(1);
    ...
    while ((known.size() < n)) {
        ...
        for (std::vector<int64_t> e : ([&](const auto& __m){ auto __it = __m.find(u); if (__it == __m.end()) return std::vector<std::vector<int64_t>>{}; return __it->second; })(graph)) {
            int64_t v = _index(e, int64_t(0));
            int64_t w = _index(e, int64_t(1));
            if (!in_list(keys, v)) {
...
void print_edges(const std::vector<std::vector<int64_t>>& edges) {
    int64_t i = int64_t(0);
    while ((i < edges.size())) {
        std::vector<int64_t> e = _index(edges, i);
        std::cout << ((((std::string("(") + ([&]{ std::ostringstream ss; ss << std::boolalpha << _index(e, int64_t(0)); return ss.str(); }())) + std::string(", ")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << _index(e, int64_t(1)); return ss.str(); }())) + std::string(")"));
        std::cout << std::endl;
        i = (i + int64_t(1));
    }
}
...
void test_vector() {
    ...
    int64_t i = int64_t(0);
    while ((i < x)) {
        G[static_cast<size_t>(i)] = std::vector<std::vector<int64_t>>{};
        i = (i + int64_t(1));
    }

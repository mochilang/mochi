// Generated by Mochi transpiler v0.10.65 on 2025-08-14 15:49:50 GMT+7
#include <iostream>
#include <string>
#include <map>
#include <vector>
...
std::map<std::string, bool> visited2 = std::map<std::string, bool>{};
int64_t result2 = 0;
...
std::map<std::string, bool> visited3 = std::map<std::string, bool>{};
int64_t result3 = 0;

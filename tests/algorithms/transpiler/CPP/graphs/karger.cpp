// Generated by Mochi transpiler v0.10.60 on 2025-08-08 11:19:04 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <map>
...
std::vector<Pair> result = partition_graph(TEST_GRAPH);
...
bool contains(const std::vector<std::string>& list, std::string value) {
    int64_t i = int64_t(0);
    while ((i < list.size())) {
        if ((([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(list) == value)) {
            return true;
        }
        i = (i + int64_t(1));
    }
...
std::vector<std::string> remove_all(const std::vector<std::string>& list, std::string value) {
    ...
    while ((i < list.size())) {
        if ((([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(list) != value)) {
            res = ([&]{ auto& __tmp = res; __tmp.push_back(([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(list)); return __tmp; }());
        }
        i = (i + int64_t(1));
    }
    return res;
...
std::vector<Pair> partition_graph(const std::map<std::string, std::vector<std::string>>& graph) {
    ...
    for (std::string node : ([&]{ std::vector<std::decay_t<decltype(graph.begin()->first)>> keys; for(const auto& __p : graph) keys.push_back(__p.first); return keys; }())) {
        ...
        int64_t i = int64_t(0);
        while ((i < neigh.size())) {
            lst = ([&]{ auto& __tmp = lst; __tmp.push_back(([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(neigh)); return __tmp; }());
            i = (i + int64_t(1));
        }
        graph_copy[node] = lst;
    }
    ...
    while ((nodes.size() > int64_t(2))) {
        std::string u = ([&](const auto& __v){ auto __i = rand_int((int64_t)(nodes.size())); if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(nodes);
        ...
        std::string v = ([&](const auto& __v){ auto __i = rand_int((int64_t)(u_neighbors.size())); if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(u_neighbors);
        std::string uv = (u + v);
        ...
        while ((i < ([&](const auto& __m){ auto __it = __m.find(u); if (__it == __m.end()) return std::vector<std::string>{}; return __it->second; })(graph_copy).size())) {
            std::string n = ([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __m){ auto __it = __m.find(u); if (__it == __m.end()) return std::vector<std::string>{}; return __it->second; })(graph_copy));
        ...
        while ((i < ([&](const auto& __m){ auto __it = __m.find(v); if (__it == __m.end()) return std::vector<std::string>{}; return __it->second; })(graph_copy).size())) {
            std::string n = ([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __m){ auto __it = __m.find(v); if (__it == __m.end()) return std::vector<std::string>{}; return __it->second; })(graph_copy));
            if ((((n != u) && (n != v)) && (contains(uv_neighbors, n) == false))) {
                uv_neighbors = ([&]{ auto& __tmp = uv_neighbors; __tmp.push_back(n); return __tmp; }());
            }
            i = (i + int64_t(1));
        ...
        while ((k < uv_neighbors.size())) {
            std::string nb = ([&](const auto& __v){ auto __i = k; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(uv_neighbors);
        ...
        while ((i < ([&](const auto& __m){ auto __it = __m.find(u); if (__it == __m.end()) return std::vector<std::string>{}; return __it->second; })(contracted).size())) {
            group = ([&]{ auto& __tmp = group; __tmp.push_back(([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __m){ auto __it = __m.find(u); if (__it == __m.end()) return std::vector<std::string>{}; return __it->second; })(contracted))); return __tmp; }());
            i = (i + int64_t(1));
        }
        i = int64_t(0);
        while ((i < ([&](const auto& __m){ auto __it = __m.find(v); if (__it == __m.end()) return std::vector<std::string>{}; return __it->second; })(contracted).size())) {
            std::string val = ([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __m){ auto __it = __m.find(v); if (__it == __m.end()) return std::vector<std::string>{}; return __it->second; })(contracted));
    ...
    int64_t j = int64_t(0);
    while ((j < nodes.size())) {
        std::string n = ([&](const auto& __v){ auto __i = j; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(nodes);
    ...
    std::vector<std::string> groupA = ([&](const auto& __v){ auto __i = int64_t(0); if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(groups);
    std::vector<std::string> groupB = ([&](const auto& __v){ auto __i = int64_t(1); if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(groups);
    std::vector<Pair> cut = {};
    j = int64_t(0);
    while ((j < groupA.size())) {
        std::string node = ([&](const auto& __v){ auto __i = j; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(groupA);
        std::vector<std::string> neigh = ([&](const auto& __m){ auto __it = __m.find(node); if (__it == __m.end()) return std::vector<std::string>{}; return __it->second; })(graph);
        int64_t l = int64_t(0);
        while ((l < neigh.size())) {
            std::string nb = ([&](const auto& __v){ auto __i = l; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(neigh);
...
std::string cut_to_string(const std::vector<Pair>& cut) {
    ...
    int64_t i = int64_t(0);
    while ((i < cut.size())) {
        Pair p = ([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(cut);

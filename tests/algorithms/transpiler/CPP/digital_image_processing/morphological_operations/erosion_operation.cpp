// Generated by Mochi transpiler v0.10.60 on 2025-08-07 23:30:27 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
std::vector<std::vector<double>> rgb_to_gray(const std::vector<std::vector<std::vector<int64_t>>>& rgb) {
    ...
    while ((i < rgb.size())) {
        ...
        while ((j < ([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(rgb).size())) {
            double r = (double)(([&](const auto& __v){ auto __i = int64_t(0); if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __v){ auto __i = j; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(rgb))));
            double g = (double)(([&](const auto& __v){ auto __i = int64_t(1); if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __v){ auto __i = j; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(rgb))));
            double b = (double)(([&](const auto& __v){ auto __i = int64_t(2); if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __v){ auto __i = j; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(rgb))));
...
std::vector<std::vector<bool>> gray_to_binary(const std::vector<std::vector<double>>& gray) {
    ...
    while ((i < gray.size())) {
        ...
        while ((j < ([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(gray).size())) {
            row = ([&]{ auto& __tmp = row; __tmp.push_back(((([&](const auto& __v){ auto __i = j; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(gray)) > 127.0) && (([&](const auto& __v){ auto __i = j; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(gray)) <= 255.0))); return __tmp; }());
            j = (j + int64_t(1));
        }
...
std::vector<std::vector<bool>> erosion(const std::vector<std::vector<bool>>& image, const std::vector<std::vector<int64_t>>& kernel) {
    ...
    while ((y < h)) {
        int64_t x = int64_t(0);
        while ((x < w)) {
            padded[static_cast<size_t>((pad_y + y))][static_cast<size_t>((pad_x + x))] = ([&](const auto& __v){ auto __i = x; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __v){ auto __i = y; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(image));
            x = (x + int64_t(1));
        }
        y = (y + int64_t(1));
    }
    ...
    while ((y < h)) {
        ...
        while ((x < w)) {
            ...
            while ((ky < k_h)) {
                ...
                while ((kx < k_w)) {
                    if (((([&](const auto& __v){ auto __i = kx; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __v){ auto __i = ky; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(kernel)) == int64_t(1)) && ([&](const auto& __v){ auto __i = (x + kx); if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __v){ auto __i = (y + ky); if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(padded)))) {
                        sum = (sum + int64_t(1));
                    }
                    kx = (kx + int64_t(1));
                }

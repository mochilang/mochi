// Generated by Mochi transpiler v0.10.59 on 2025-08-07 09:05:52 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
    ...
    while ((y < h)) {
        ...
        while ((x < w)) {
            ...
            while ((i < k)) {
                int64_t j = int64_t(0);
                while ((j < k)) {
                    sum = (sum + (padded[(y + i)][(x + j)] * (double)(kernel[i][j])));
                    j = (j + int64_t(1));
                }
                i = (i + int64_t(1));
            }
...
double max_matrix(const std::vector<std::vector<double>>& mat) {
    double max_val = mat[int64_t(0)][int64_t(0)];
    int64_t y = int64_t(0);
    while ((y < mat.size())) {
        int64_t x = int64_t(0);
        while ((x < mat[int64_t(0)].size())) {
            if ((mat[y][x] > max_val)) {
                max_val = mat[y][x];
            }
            x = (x + int64_t(1));
...
std::vector<std::vector<std::vector<double>>> sobel_filter(const std::vector<std::vector<int64_t>>& image) {
    ...
    while ((y0 < h)) {
        ...
        while ((x0 < w)) {
            row = ([&]{ auto __tmp = row; __tmp.push_back((double)(image[y0][x0])); return __tmp; }());
            x0 = (x0 + int64_t(1));
        }
...
void print_matrix_int(const std::vector<std::vector<double>>& mat) {
    ...
    while ((y < mat.size())) {
        ...
        int64_t x = int64_t(0);
        while ((x < mat[y].size())) {
            line = (line + ([&]{ std::ostringstream ss; ss << std::boolalpha << (int64_t)(mat[y][x]); return ss.str(); }()));
            if ((x < (mat[y].size() - int64_t(1)))) {
...
void print_matrix_float(const std::vector<std::vector<double>>& mat) {
    ...
    while ((y < mat.size())) {
        ...
        int64_t x = int64_t(0);
        while ((x < mat[y].size())) {
            line = (line + ([&]{ std::ostringstream ss; ss << std::boolalpha << mat[y][x]; return ss.str(); }()));
            if ((x < (mat[y].size() - int64_t(1)))) {
                line = (line + std::string(" "));
            }
            x = (x + int64_t(1));
...
int main() {
    {
        ...
        std::vector<std::vector<double>> mag = res[int64_t(0)];
        std::vector<std::vector<double>> theta = res[int64_t(1)];

// Generated by Mochi transpiler v0.10.59 on 2025-08-07 09:03:28 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
std::vector<std::vector<double>> vec_gaussian(std::vector<std::vector<double>>& mat, double variance);
std::vector<std::vector<double>> get_slice(std::vector<std::vector<double>>& img, int64_t x, int64_t y, int64_t kernel_size);
std::vector<std::vector<double>> get_gauss_kernel(int64_t kernel_size, double spatial_variance);
std::vector<std::vector<double>> elementwise_sub(std::vector<std::vector<double>>& mat, double value);
std::vector<std::vector<double>> elementwise_mul(std::vector<std::vector<double>>& a, std::vector<std::vector<double>>& b);
double matrix_sum(std::vector<std::vector<double>>& mat);
double bilateral_filter(std::vector<std::vector<double>>& img, double spatial_variance, double intensity_variance, int64_t kernel_size);
int main();
...
std::vector<std::vector<double>> get_slice(std::vector<std::vector<double>>& img, int64_t x, int64_t y, int64_t kernel_size) {
    ...
    while ((i <= (x + half))) {
        ...
        int64_t j = (y - half);
        while ((j <= (y + half))) {
            row = ([&]{ auto __lhs = row; auto __rhs = std::vector<double>{img[i][j]}; __lhs.insert(__lhs.end(), __rhs.begin(), __rhs.end()); return __lhs; }());
            j = (j + int64_t(1));
        }
...
std::vector<std::vector<double>> elementwise_sub(std::vector<std::vector<double>>& mat, double value) {
    ...
    while ((i < mat.size())) {
        ...
        int64_t j = int64_t(0);
        while ((j < mat[i].size())) {
            row = ([&]{ auto __lhs = row; auto __rhs = std::vector<double>{(mat[i][j] - value)}; __lhs.insert(__lhs.end(), __rhs.begin(), __rhs.end()); return __lhs; }());
            j = (j + int64_t(1));
        }
...
std::vector<std::vector<double>> elementwise_mul(std::vector<std::vector<double>>& a, std::vector<std::vector<double>>& b) {
    ...
    while ((i < a.size())) {
        ...
        int64_t j = int64_t(0);
        while ((j < a[i].size())) {
            row = ([&]{ auto __lhs = row; auto __rhs = std::vector<double>{(a[i][j] * b[i][j])}; __lhs.insert(__lhs.end(), __rhs.begin(), __rhs.end()); return __lhs; }());
            j = (j + int64_t(1));
        }
        res = ([&]{ auto __lhs = res; auto __rhs = std::vector<std::vector<double>>{row}; __lhs.insert(__lhs.end(), __rhs.begin(), __rhs.end()); return __lhs; }());
        i = (i + int64_t(1));
...
double bilateral_filter(std::vector<std::vector<double>>& img, double spatial_variance, double intensity_variance, int64_t kernel_size) {
    ...
    double center = img_s[(kernel_size / int64_t(2))][(kernel_size / int64_t(2))];

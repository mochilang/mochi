// Generated by Mochi transpiler v0.10.69 on 2025-08-22 14:03:00 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int main() {
    {
        ...
        std::cout << _to_string(terminal_velocity(1.0, 25.0, 0.6, 0.77));
        std::cout << std::endl;
        std::cout << _to_string(terminal_velocity(2.0, 100.0, 0.45, 0.23));
        std::cout << std::endl;
        std::cout << _to_string(terminal_velocity(5.0, 50.0, 0.2, 0.5));
        std::cout << std::endl;
    }
    return 0;
}

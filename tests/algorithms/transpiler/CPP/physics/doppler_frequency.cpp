// Generated by Mochi transpiler v0.10.61 on 2025-08-08 20:06:45 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
double doppler_effect(double org_freq, double wave_vel, double obs_vel, double src_vel) {
    ...
    double doppler_freq = ((double)((org_freq * (wave_vel + obs_vel))) / ((wave_vel - src_vel)));
    if ((doppler_freq <= 0.0)) {
...
int main() {
    {
        ...
        test_doppler_effect();
        { std::ostringstream __ss; double __dv = doppler_effect(100.0, 330.0, 10.0, 0.0); if(std::floor(__dv) == __dv) { __ss<<std::fixed<<std::setprecision(1)<<__dv; } else { __ss<<std::defaultfloat<<std::setprecision(17)<<__dv; } std::cout << __ss.str(); }
        std::cout << std::endl;
    }
    return 0;
}

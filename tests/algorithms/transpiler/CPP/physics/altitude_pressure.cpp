// Generated by Mochi transpiler v0.10.69 on 2025-08-22 13:10:48 GMT+7
#include <iostream>
#include <string>
#include <cmath>
#include <sstream>
...
int main() {
    {
        ...
        std::cout << _to_string(get_altitude_at_pressure(100000.0));
        std::cout << std::endl;
        std::cout << _to_string(get_altitude_at_pressure(101325.0));
        std::cout << std::endl;
        std::cout << _to_string(get_altitude_at_pressure(80000.0));
        std::cout << std::endl;
    }
    return 0;
}

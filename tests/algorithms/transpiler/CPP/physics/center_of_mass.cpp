// Generated by Mochi transpiler v0.10.61 on 2025-08-08 20:06:33 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <vector>
...
std::string coord_to_string(const Coord3D& c) {
    return ((((((std::string("Coord3D(x=") + ([&]{ std::ostringstream ss; ss << std::boolalpha << c.x; return ss.str(); }())) + std::string(", y=")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << c.y; return ss.str(); }())) + std::string(", z=")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << c.z; return ss.str(); }())) + std::string(")"));
}

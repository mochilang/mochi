// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:39:35 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
std::string classify(const KNN& knn, const std::vector<double>& pred_point, int64_t k) {
    ...
    while ((count < k)) {
        ...
        { auto& __tmp = distances[min_index]; __tmp.dist = 1000000000000000000.0; }
    ...
    while ((v < votes.size())) {
        ...
        tally[lbl] = (_index(tally, lbl) + int64_t(1));
        v = (v + int64_t(1));
    }

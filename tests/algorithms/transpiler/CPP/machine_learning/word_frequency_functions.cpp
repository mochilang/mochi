// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:43:32 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
double round3(double x) {
    return ((double)(floor(((x * 1000.0) + 0.5))) / (1000.0));
}
...
int main() {
    {
        ...
        std::cout << std::endl;
        std::cout << ([&]{ std::ostringstream ss; { auto __tmp = document_frequency(std::string("first"), corpus); ss << "["; for(size_t i=0;i<__tmp.size();++i){ if(i>0) ss << ' '; ss << __tmp[i]; } ss << "]"; }
 return ss.str(); }());
        std::cout << std::endl;

// Generated by Mochi transpiler v0.10.63 on 2025-08-11 18:37:53 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
    ...
    while ((passes < max_passes)) {
        ...
        while ((i1 < m)) {
            ...
            if (((((_index(labels, i1) * Ei) < (0.0 - tol)) && (_index(alphas, i1) < c)) || (((_index(labels, i1) * Ei) > tol) && (_index(alphas, i1) > 0.0)))) {
                ...
                alphas[i2] = (alpha2_old - ((double)((_index(labels, i2) * (Ei - Ej))) / (eta)));
                ...
                alphas[i1] = (alpha1_old + ((_index(labels, i1) * _index(labels, i2)) * (alpha2_old - _index(alphas, i2))));

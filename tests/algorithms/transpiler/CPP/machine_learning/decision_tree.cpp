// Generated by Mochi transpiler v0.10.63 on 2025-08-11 18:34:04 GMT+7
#include <iostream>
#include <string>
#include <memory>
#include <vector>
...
int main() {
    {
        ...
        std::cout << (std::string("Test values: ") + ([&]{ std::ostringstream ss; { auto __tmp = test_cases; ss << "["; for(size_t i=0;i<__tmp.size();++i){ if(i>0) ss << ' '; ss << __tmp[i]; } ss << "]"; }
 return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Predictions: ") + ([&]{ std::ostringstream ss; { auto __tmp = predictions; ss << "["; for(size_t i=0;i<__tmp.size();++i){ if(i>0) ss << ' '; ss << __tmp[i]; } ss << "]"; }
 return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Average error: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << avg_error; return ss.str(); }()));
        std::cout << std::endl;
    }
    return 0;
}

// Generated by Mochi transpiler v0.10.60 on 2025-08-07 23:31:09 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <type_traits>
...
double closest_pair_of_points_sqr(std::vector<std::vector<double>>& px, std::vector<std::vector<double>>& py, int64_t count);

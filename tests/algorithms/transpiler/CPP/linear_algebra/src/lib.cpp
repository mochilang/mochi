// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:04:38 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <vector>
...
std::string vector_to_string(const Vector& v) {
    ...
    while ((i < v.components.size())) {
        s = (s + ([&]{ std::ostringstream ss; ss << std::boolalpha << _index(v.components, i); return ss.str(); }()));
...
std::string matrix_to_string(const Matrix& m) {
    ...
    while ((i < m.height)) {
        ...
        int64_t j = int64_t(0);
        while ((j < m.width)) {
            ans = (ans + ([&]{ std::ostringstream ss; ss << std::boolalpha << _index(_index(m.data, i), j); return ss.str(); }()));
...
int main() {
    {
        ...
        std::cout << std::endl;
        std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << vector_dot(v1, v2); return ss.str(); }());
        std::cout << std::endl;
        std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << vector_euclidean_length(v1); return ss.str(); }());
        std::cout << std::endl;
        ...
        std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << matrix_determinant(m); return ss.str(); }());
        std::cout << std::endl;
    }
    return 0;
}

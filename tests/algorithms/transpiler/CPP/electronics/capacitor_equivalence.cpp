// Generated by Mochi transpiler v0.10.72 on 2025-08-25 08:41:45 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <vector>
...
double capacitor_series(const std::vector<double>& capacitors) {
    ...
    while ((i < capacitors.size())) {
        ...
        first_sum = (first_sum + ((double)(1.0) / (double)(c)));
        i = (i + int64_t(1));
    }
    return ((double)(1.0) / (double)(first_sum));
}
...
int main() {
    {
        ...
        std::cout << _to_string(parallel);
        std::cout << std::endl;
        std::cout << _to_string(series);
        std::cout << std::endl;
    }
    return 0;
}

// Generated by Mochi transpiler v0.10.72 on 2025-08-25 08:46:18 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
std::vector<double> rect(double mag, double angle);
std::vector<double> multiply(const std::vector<double>& a, const std::vector<double>& b);
std::vector<double> apparent_power(double voltage, double current, double voltage_angle, double current_angle);
bool approx_equal(const std::vector<double>& a, const std::vector<double>& b, double eps);
int main();
...
std::vector<double> rect(double mag, double angle) {
    ...
    return std::vector<double>{(mag * c), (mag * s)};
}

std::vector<double> multiply(const std::vector<double>& a, const std::vector<double>& b) {
    return std::vector<double>{((_index(a, int64_t(0)) * _index(b, int64_t(0))) - (_index(a, int64_t(1)) * _index(b, int64_t(1)))), ((_index(a, int64_t(0)) * _index(b, int64_t(1))) + (_index(a, int64_t(1)) * _index(b, int64_t(0))))};
}

std::vector<double> apparent_power(double voltage, double current, double voltage_angle, double current_angle) {
    double vrad = to_radians(voltage_angle);
    double irad = to_radians(current_angle);
    std::vector<double> vrect = rect(voltage, vrad);
    std::vector<double> irect = rect(current, irad);
    std::vector<double> result = multiply(vrect, irect);
    return result;
}

bool approx_equal(const std::vector<double>& a, const std::vector<double>& b, double eps) {
    return ((abs((_index(a, int64_t(0)) - _index(b, int64_t(0)))) < eps) && (abs((_index(a, int64_t(1)) - _index(b, int64_t(1)))) < eps));
}

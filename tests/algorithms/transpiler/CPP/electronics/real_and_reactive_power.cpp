// Generated by Mochi transpiler v0.10.72 on 2025-08-25 08:43:37 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
double reactive_power(double apparent_power, double power_factor) {
    ...
    return (apparent_power * std::sqrt((1.0 - (power_factor * power_factor))));
}
...
int main() {
    {
        ...
        std::cout << _to_string(real_power(100.0, 0.9));
        std::cout << std::endl;
        std::cout << _to_string(real_power(0.0, 0.8));
        std::cout << std::endl;
        std::cout << _to_string(real_power(100.0, -0.9));
        std::cout << std::endl;
        std::cout << _to_string(reactive_power(100.0, 0.9));
        std::cout << std::endl;
        std::cout << _to_string(reactive_power(0.0, 0.8));
        std::cout << std::endl;
        std::cout << _to_string(reactive_power(100.0, -0.9));
        std::cout << std::endl;
    }

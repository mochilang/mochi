// Generated by Mochi transpiler v0.10.72 on 2025-08-25 08:43:46 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <vector>
...
int main() {
    {
        ...
        std::cout << (std::string("Parallel: ") + _to_string(resistor_parallel(resistors)));
        std::cout << std::endl;
        std::cout << (std::string("Series: ") + _to_string(resistor_series(resistors)));
        std::cout << std::endl;
    }
    return 0;
}

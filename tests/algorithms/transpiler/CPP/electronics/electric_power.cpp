// Generated by Mochi transpiler v0.10.72 on 2025-08-25 08:42:32 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
Result electric_power(double voltage, double current, double power) {
    ...
    } else     if ((std::fabs(voltage - 0.0) < 1e-6)) {
        return Result{std::string("voltage"), ((double)(power) / (double)(current))};
    } else     if ((std::fabs(current - 0.0) < 1e-6)) {
        return Result{std::string("current"), ((double)(power) / (double)(voltage))};
    } else     if ((std::fabs(power - 0.0) < 1e-6)) {
        double p = absf((voltage * current));
        return Result{std::string("power"), round_to(p, int64_t(2))};
    } else {

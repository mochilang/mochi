// Generated by Mochi transpiler v0.10.59 on 2025-08-07 09:10:13 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <map>
...
std::map<std::string, double> ohms_law(double voltage, double current, double resistance) {
    ...
    if ((current == 0.0)) {
        return std::map<std::string, double>{{"current", ((double)(voltage) / (resistance))}};
    }
    return std::map<std::string, double>{{"resistance", ((double)(voltage) / (current))}};
}

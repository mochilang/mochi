// Generated by Mochi transpiler v0.10.67 on 2025-08-17 14:39:48 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
        ...
        while ((p < need_list.size())) {
            if (!_index(finished, p)) {
                ...
                if (exec) {
                    ...
                    r = int64_t(0);
                    while ((r < avail.size())) {
                        avail[static_cast<size_t>(r)] = (_index(avail, r) + _index(_index(alloc, p), r));
                        r = (r + int64_t(1));
                    }
                    std::string avail_str = std::string("");
                    r = int64_t(0);
                    ...
                    std::cout << std::string("");
                    std::cout << std::endl;
                    finished[static_cast<size_t>(p)] = true;

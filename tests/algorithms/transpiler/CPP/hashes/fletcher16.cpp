// Generated by Mochi transpiler v0.10.63 on 2025-08-12 08:44:41 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int64_t fletcher16(std::string text);
int main();
...
int64_t ord(std::string ch) {
    ...
    while ((i < ascii_chars.size())) {
        if ((([&](const auto& __s){ auto __i = i; if (__i < 0) __i += __s.size(); return std::string(1, __s[static_cast<size_t>(__i)]); })(ascii_chars) == ch)) {
            return (int64_t(32) + i);
        }
        i = (i + int64_t(1));
    }
...
int64_t fletcher16(std::string text) {
    int64_t sum1 = int64_t(0);
    int64_t sum2 = int64_t(0);
    int64_t i = int64_t(0);
    while ((i < text.size())) {
        int64_t code = ord(([&](const auto& __s){ auto __i = i; if (__i < 0) __i += __s.size(); return std::string(1, __s[static_cast<size_t>(__i)]); })(text));
        sum1 = ((sum1 + code) % int64_t(255));
        sum2 = ((sum1 + sum2) % int64_t(255));
        i = (i + int64_t(1));
    }
    return ((sum2 * int64_t(256)) + sum1);
}

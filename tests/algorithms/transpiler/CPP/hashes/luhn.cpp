// Generated by Mochi transpiler v0.10.63 on 2025-08-12 08:44:46 GMT+7
#include <iostream>
#include <string>
#include <any>
#include <vector>
...
bool is_luhn(std::string s) {
    ...
    int64_t check_digit = _parse_int_str(s.substr((n - int64_t(1)), n - (n - int64_t(1))), int64_t(10));
    int64_t i = (n - int64_t(2));
    bool even = true;
    while ((i >= int64_t(0))) {
        int64_t digit = _parse_int_str(s.substr(i, (i + int64_t(1)) - i), int64_t(10));
        if (even) {

// Generated by Mochi transpiler v0.10.63 on 2025-08-12 08:44:32 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int64_t djb2(std::string s) {
    int64_t hash_value = int64_t(5381);
    int64_t i = int64_t(0);
    while ((i < s.size())) {
        hash_value = ((hash_value * int64_t(33)) + ord(([&](const auto& __s){ auto __i = i; if (__i < 0) __i += __s.size(); return std::string(1, __s[static_cast<size_t>(__i)]); })(s)));
        hash_value = (hash_value % int64_t(4294967296));
        i = (i + int64_t(1));
    }
    return hash_value;
}
...
int main() {
    {
        ...
        std::cout << djb2(std::string("Algorithms"));
        std::cout << std::endl;
        std::cout << djb2(std::string("scramble bits"));
        std::cout << std::endl;
    }
    return 0;
}

// Generated by Mochi transpiler v0.10.61 on 2025-08-08 16:45:09 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int main() {
    {
        ...
        std::cout << std::endl;
        std::cout << (std::string("Rectangle: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << area_rectangle(10.0, 20.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Square: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << area_square(10.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Triangle: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << area_triangle(10.0, 10.0); return ss.str(); }()));
        std::cout << std::endl;
        TRI_THREE_SIDES = area_triangle_three_sides(5.0, 12.0, 13.0);
        std::cout << (std::string("Triangle Three Sides: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << TRI_THREE_SIDES; return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Parallelogram: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << area_parallelogram(10.0, 20.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Rhombus: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << area_rhombus(10.0, 20.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Trapezium: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << area_trapezium(10.0, 20.0, 30.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Circle: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << area_circle(20.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Ellipse: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << area_ellipse(10.0, 20.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << std::string("");
        std::cout << std::endl;
        std::cout << std::string("Surface Areas of various geometric shapes:");
        std::cout << std::endl;
        std::cout << (std::string("Cube: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << surface_area_cube(20.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Cuboid: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << surface_area_cuboid(10.0, 20.0, 30.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Sphere: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << surface_area_sphere(20.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Hemisphere: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << surface_area_hemisphere(20.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Cone: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << surface_area_cone(10.0, 20.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Conical Frustum: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << surface_area_conical_frustum(10.0, 20.0, 30.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Cylinder: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << surface_area_cylinder(10.0, 20.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Torus: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << surface_area_torus(20.0, 10.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Equilateral Triangle: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << area_reg_polygon(int64_t(3), 10.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Square: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << area_reg_polygon(int64_t(4), 10.0); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Regular Pentagon: ") + ([&]{ std::ostringstream ss; ss << std::boolalpha << area_reg_polygon(int64_t(5), 10.0); return ss.str(); }()));
        std::cout << std::endl;
    }
    return 0;
}

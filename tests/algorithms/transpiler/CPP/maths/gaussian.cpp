// Generated by Mochi transpiler v0.10.63 on 2025-08-12 07:56:46 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
double gaussian(double x, double mu, double sigma) {
    double coeff = ((double)(1.0) / (sqrtApprox((((2.0 * PI) * sigma) * sigma))));
    double exponent = ((double)(-((x - mu) * (x - mu))) / (((2.0 * sigma) * sigma)));

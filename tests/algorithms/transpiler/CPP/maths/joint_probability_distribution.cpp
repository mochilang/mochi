// Generated by Mochi transpiler v0.10.61 on 2025-08-08 17:14:09 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <map>
...
int main() {
    {
        ...
        while ((i < x_values.size())) {
            ...
            while ((j < y_values.size())) {
                ...
                std::cout << ((k + std::string("=")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << prob; return ss.str(); }()));
                std::cout << std::endl;
                j = (j + int64_t(1));
            }
            i = (i + int64_t(1));
        ...
        std::cout << (std::string("Ex=") + ([&]{ std::ostringstream ss; ss << std::boolalpha << ex; return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Ey=") + ([&]{ std::ostringstream ss; ss << std::boolalpha << ey; return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Vx=") + ([&]{ std::ostringstream ss; ss << std::boolalpha << vx; return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Vy=") + ([&]{ std::ostringstream ss; ss << std::boolalpha << vy; return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Cov=") + ([&]{ std::ostringstream ss; ss << std::boolalpha << cov; return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Sx=") + ([&]{ std::ostringstream ss; ss << std::boolalpha << standard_deviation(vx); return ss.str(); }()));
        std::cout << std::endl;
        std::cout << (std::string("Sy=") + ([&]{ std::ostringstream ss; ss << std::boolalpha << standard_deviation(vy); return ss.str(); }()));
        std::cout << std::endl;
    }
    return 0;
}

// Generated by Mochi transpiler v0.10.63 on 2025-08-12 07:55:48 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int main() {
    {
        ...
        while ((i <= int64_t(100))) {
            ...
            std::cout << ((([&]{ std::ostringstream ss; ss << std::boolalpha << i; return ss.str(); }()) + std::string(": ")) + std::to_string(diff));
            std::cout << std::endl;
            i = (i + int64_t(5));
        }
    }

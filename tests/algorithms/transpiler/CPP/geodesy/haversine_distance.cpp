// Generated by Mochi transpiler v0.10.59 on 2025-08-07 10:13:46 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
std::vector<double> SAN_FRANCISCO = std::vector<double>{37.774856, -122.424227};
std::vector<double> YOSEMITE = std::vector<double>{37.864742, -119.537521};
...
int main() {
    {
        ...
        std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << haversine_distance(SAN_FRANCISCO[int64_t(0)], SAN_FRANCISCO[int64_t(1)], YOSEMITE[int64_t(0)], YOSEMITE[int64_t(1)]); return ss.str(); }());
        std::cout << std::endl;
    }
    return 0;
}

// Generated by Mochi transpiler v0.10.72 on 2025-08-24 22:20:36 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
List empty_list();
List push(const List& lst, int64_t value);
int64_t middle_element(const List& lst);
int main();

List empty_list() {
    return List{std::vector<int64_t>{}};
}
...
List push(const List& lst, int64_t value) {
    ...
    while ((i < lst.data.size())) {
        res = ([&]{ auto __tmp = res; __tmp.push_back(_index(lst.data, i)); return __tmp; }());
        i = (i + int64_t(1));
    }
    return List{res};
}
...
int64_t middle_element(const List& lst) {
    int64_t n = lst.data.size();
    if ((n == int64_t(0))) {
        std::cout << std::string("No element found.");
        std::cout << std::endl;
        return int64_t(0);
    }
    int64_t slow = int64_t(0);
    int64_t fast = int64_t(0);
    while (((fast + int64_t(1)) < n)) {
        fast = (fast + int64_t(2));
        slow = (slow + int64_t(1));
    }
...
int main() {
    {
        ...
        List lst = empty_list();
        middle_element(lst);
        lst = push(lst, int64_t(5));
        std::cout << int64_t(5);
        std::cout << std::endl;
        lst = push(lst, int64_t(6));
        std::cout << int64_t(6);
        std::cout << std::endl;
        lst = push(lst, int64_t(8));
        std::cout << int64_t(8);
        std::cout << std::endl;
        lst = push(lst, int64_t(8));
        std::cout << int64_t(8);
        std::cout << std::endl;
        lst = push(lst, int64_t(10));
        std::cout << int64_t(10);
        std::cout << std::endl;
        lst = push(lst, int64_t(12));
        std::cout << int64_t(12);
        std::cout << std::endl;
        lst = push(lst, int64_t(17));
        std::cout << int64_t(17);
        std::cout << std::endl;
        lst = push(lst, int64_t(7));
        std::cout << int64_t(7);
        std::cout << std::endl;
        lst = push(lst, int64_t(3));
        std::cout << int64_t(3);
        std::cout << std::endl;
        lst = push(lst, int64_t(20));
        std::cout << int64_t(20);
        std::cout << std::endl;
        lst = push(lst, -int64_t(20));
        std::cout << -int64_t(20);
        std::cout << std::endl;
        std::cout << middle_element(lst);
        std::cout << std::endl;
    }
    return 0;
}

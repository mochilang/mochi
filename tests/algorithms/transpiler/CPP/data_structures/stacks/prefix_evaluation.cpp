// Generated by Mochi transpiler v0.10.59 on 2025-08-07 09:00:23 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <type_traits>
...
std::vector<std::string> tokenize(std::string s) {
    std::vector<std::string> parts = _split(s, std::string(" "));
    std::vector<std::string> res = {};
    int64_t i = int64_t(0);
    while ((i < parts.size())) {
...
std::vector<double> eval_rec(const std::vector<std::string>& tokens, int64_t pos) {
    ...
    double a = left[int64_t(0)];
    int64_t p1 = (int64_t)(left[int64_t(1)]);
    std::vector<double> right = eval_rec(tokens, p1);
    double b = right[int64_t(0)];
    double p2 = right[int64_t(1)];

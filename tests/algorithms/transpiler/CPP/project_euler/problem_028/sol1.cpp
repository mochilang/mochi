// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:50:38 GMT+7
...
cpp_int solution(const cpp_int& n) {
    cpp_int total = int64_t(1);
    cpp_int i = int64_t(1);
    cpp_int limit = ((n + int64_t(1)) / int64_t(2));
    while ((i < limit)) {
        cpp_int odd = ((int64_t(2) * i) + int64_t(1));
        cpp_int even = (int64_t(2) * i);

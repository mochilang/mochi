// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:50:17 GMT+7
...
bool contains(const std::vector<cpp_int>& lst, const cpp_int& val);
cpp_int solution(const cpp_int& numerator, const cpp_int& limit);
int main();
...
cpp_int solution(const cpp_int& numerator, const cpp_int& limit) {
    cpp_int the_digit = int64_t(1);
    cpp_int longest_len = int64_t(0);
    for (int d = numerator; d < limit; d++ ) {
        std::vector<cpp_int> remainders = {};
        cpp_int rem = numerator;
        cpp_int count = int64_t(1);
        while ((count <= limit)) {
            if (contains(remainders, rem)) {
                if ((longest_len < remainders.size())) {
                    longest_len = remainders.size();
                    the_digit = d;
                }
            } else {
                remainders = ([&]{ auto __tmp = remainders; __tmp.push_back(rem); return __tmp; }());
                rem = ((rem * int64_t(10)) % d);
            }
...
int main() {
    {
        ...
        std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << solution(int64_t(1), int64_t(10)); return ss.str(); }());
        std::cout << std::endl;
        std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << solution(int64_t(10), int64_t(100)); return ss.str(); }());
        std::cout << std::endl;
        std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << solution(int64_t(10), int64_t(1000)); return ss.str(); }());
        std::cout << std::endl;
    }
    return 0;
}

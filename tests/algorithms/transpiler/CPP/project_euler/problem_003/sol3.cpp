// Generated by Mochi transpiler v0.10.62 on 2025-08-09 10:44:35 GMT+7
#include <iostream>
#include <string>
#include <any>
#include <vector>
...
int main() {
    {
        ...
        _json(largest_prime_factor(int64_t(13195)));
        _json(largest_prime_factor(int64_t(10)));
        _json(largest_prime_factor(int64_t(17)));
        _json(largest_prime_factor(int64_t(600851475143)));
    }
    return 0;
}

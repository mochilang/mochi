// Generated by Mochi transpiler v0.10.62 on 2025-08-09 16:50:06 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
int64_t solution(int64_t limit) {
    std::vector<int64_t> pentagonal_nums = {};
    int64_t i = int64_t(1);
    while ((i < limit)) {
        pentagonal_nums = ([&]{ auto __tmp = pentagonal_nums; __tmp.push_back(pentagonal(i)); return __tmp; }());
        i = (i + int64_t(1));
    }
    int64_t a_idx = int64_t(0);
    while ((a_idx < pentagonal_nums.size())) {
        int64_t pentagonal_i = _index(pentagonal_nums, a_idx);
        int64_t b_idx = a_idx;
        while ((b_idx < pentagonal_nums.size())) {
            int64_t pentagonal_j = _index(pentagonal_nums, b_idx);
            int64_t s = (pentagonal_i + pentagonal_j);
            int64_t d = (pentagonal_j - pentagonal_i);

// Generated by Mochi transpiler v0.10.62 on 2025-08-09 10:47:16 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int64_t digit_sum(int64_t n) {
    ...
    int64_t i = int64_t(0);
    while ((i < s.size())) {
        std::string digit_str = s.substr(i, (i + int64_t(1)) - i);
        total = (total + _parse_int_str(digit_str, int64_t(10)));
        i = (i + int64_t(1));
    }
    return total;
}

// Generated by Mochi transpiler v0.10.61 on 2025-08-09 10:24:35 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
int64_t max_product_four(const std::vector<std::vector<int64_t>>& grid);
int main();
...
int64_t max_product_four(const std::vector<std::vector<int64_t>>& grid) {
    int64_t maximum = int64_t(0);
    int64_t i = int64_t(0);
    while ((i < int64_t(20))) {
        int64_t j = int64_t(0);
        while ((j < int64_t(17))) {
            int64_t temp = (((_index(_index(grid, i), j) * _index(_index(grid, i), (j + int64_t(1)))) * _index(_index(grid, i), (j + int64_t(2)))) * _index(_index(grid, i), (j + int64_t(3))));
            if ((temp > maximum)) {
                maximum = temp;
            }
            j = (j + int64_t(1));
    ...
    while ((i < int64_t(17))) {
        int64_t j = int64_t(0);
        while ((j < int64_t(20))) {
            int64_t temp = (((_index(_index(grid, i), j) * _index(_index(grid, (i + int64_t(1))), j)) * _index(_index(grid, (i + int64_t(2))), j)) * _index(_index(grid, (i + int64_t(3))), j));
            if ((temp > maximum)) {
                maximum = temp;
            }
            j = (j + int64_t(1));
    ...
    while ((i < int64_t(17))) {
        int64_t j = int64_t(0);
        while ((j < int64_t(17))) {
            int64_t temp = (((_index(_index(grid, i), j) * _index(_index(grid, (i + int64_t(1))), (j + int64_t(1)))) * _index(_index(grid, (i + int64_t(2))), (j + int64_t(2)))) * _index(_index(grid, (i + int64_t(3))), (j + int64_t(3))));
            if ((temp > maximum)) {
                maximum = temp;
            }
            j = (j + int64_t(1));

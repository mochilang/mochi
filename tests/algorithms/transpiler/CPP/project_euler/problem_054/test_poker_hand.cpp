// Generated by Mochi transpiler v0.10.62 on 2025-08-09 16:51:04 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <type_traits>
...
Hand parse_hand(std::string hand) {
    ...
    for (auto card : _split(hand, std::string(" "))) {
        int64_t v = card_value(std::string(([&](const auto& __v){ if constexpr(std::is_same_v<std::decay_t<decltype(__v)>, std::string>) return __v.substr(int64_t(0), int64_t(1) - int64_t(0)); else return std::vector<typename std::decay_t<decltype(__v)>::value_type>(__v.begin()+int64_t(0), __v.begin()+int64_t(1)); })(card)));
        counts[v] = (_index(counts, v) + int64_t(1));
        suits = ([&]{ auto __tmp = suits; __tmp.push_back((std::string)([&](const auto& __v){ if constexpr(std::is_same_v<std::decay_t<decltype(__v)>, std::string>) return __v.substr(int64_t(1), int64_t(2) - int64_t(1)); else return std::vector<typename std::decay_t<decltype(__v)>::value_type>(__v.begin()+int64_t(1), __v.begin()+int64_t(2)); })(card)); return __tmp; }());
    }
    ...
    if (((((((vals.size() == int64_t(5)) && (_index(vals, int64_t(0)) == int64_t(14))) && (_index(vals, int64_t(1)) == int64_t(5))) && (_index(vals, int64_t(2)) == int64_t(4))) && (_index(vals, int64_t(3)) == int64_t(3))) && (_index(vals, int64_t(4)) == int64_t(2)))) {
        is_straight = true;
        vals[int64_t(0)] = int64_t(5);
        vals[int64_t(1)] = int64_t(4);
        vals[int64_t(2)] = int64_t(3);
        vals[int64_t(3)] = int64_t(2);
        vals[int64_t(4)] = int64_t(14);
    } else {
        is_straight = true;
        int64_t j = int64_t(0);
        while ((j < int64_t(4))) {

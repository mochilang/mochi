// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:50:55 GMT+7
...
cpp_int digits_fifth_powers_sum(const cpp_int& number);
cpp_int solution();
int main();

std::vector<cpp_int> DIGITS_FIFTH_POWER = std::vector<cpp_int>{int64_t(0), int64_t(1), int64_t(32), int64_t(243), int64_t(1024), int64_t(3125), int64_t(7776), int64_t(16807), int64_t(32768), int64_t(59049)};

cpp_int digits_fifth_powers_sum(const cpp_int& number) {
    cpp_int total = int64_t(0);
    cpp_int n = number;
    while ((n > int64_t(0))) {
        cpp_int digit = (n % int64_t(10));
        total = (total + DIGITS_FIFTH_POWER[static_cast<size_t>(digit)]);
        n = (n / int64_t(10));
    }
    return total;
}
...
cpp_int solution() {
    cpp_int total = int64_t(0);
    cpp_int num = int64_t(1000);
    while ((num < int64_t(1000000))) {

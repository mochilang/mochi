// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:50:25 GMT+7
...
cpp_int solution(const cpp_int& a_limit, const cpp_int& b_limit);
int main();
...
cpp_int solution(const cpp_int& a_limit, const cpp_int& b_limit) {
    ...
    cpp_int longest_a = int64_t(0);
    cpp_int longest_b = int64_t(0);
    cpp_int a = ((-int64_t(1) * a_limit) + int64_t(1));
    while ((a < a_limit)) {
        cpp_int b = int64_t(2);
        while ((b < b_limit)) {
            if (is_prime(b)) {
...
int main() {
    {
        ...
        std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << solution(int64_t(1000), int64_t(1000)); return ss.str(); }());
        std::cout << std::endl;
    }
    return 0;
}

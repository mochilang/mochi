// Generated by Mochi transpiler v0.10.70 on 2025-08-22 15:27:54 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <vector>
...
std::vector<std::vector<int64_t>> digit_replacements(int64_t number) {
    ...
    while ((i < num_str.size())) {
        int64_t d = static_cast<int64_t>(_index(num_str, i) - '0');
        counts[static_cast<size_t>(d)] = (_index(counts, d) + int64_t(1));
        i = (i + int64_t(1));
    }

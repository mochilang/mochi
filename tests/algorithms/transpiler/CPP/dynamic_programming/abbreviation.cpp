// Generated by Mochi transpiler v0.10.60 on 2025-08-07 23:32:56 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <type_traits>
...
bool is_lower(std::string c);
bool abbr(std::string a, std::string b);
...
std::string to_upper_char(std::string c) {
    int64_t code = ord(c);
    if (((code >= int64_t(97)) && (code <= int64_t(122)))) {
        return chr((code - int64_t(32)));
    }
    return c;
}
...
bool is_lower(std::string c) {
    int64_t code = ord(c);
    return ((code >= int64_t(97)) && (code <= int64_t(122)));
}
...
bool abbr(std::string a, std::string b) {
    ...
    while ((i < n)) {
        int64_t j = int64_t(0);
        while ((j <= m)) {
            if (([&](const auto& __v){ auto __i = j; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(([&](const auto& __v){ auto __i = i; if (__i < 0) __i += __v.size(); return __v[static_cast<size_t>(__i)]; })(dp))) {
                if (((j < m) && (to_upper_char(([&](const auto& __s){ auto __i = i; if (__i < 0) __i += __s.size(); return std::string(1, __s[static_cast<size_t>(__i)]); })(a)) == ([&](const auto& __s){ auto __i = j; if (__i < 0) __i += __s.size(); return std::string(1, __s[static_cast<size_t>(__i)]); })(b)))) {
                    dp[(i + int64_t(1))][(j + int64_t(1))] = true;
                }
                if (is_lower(([&](const auto& __s){ auto __i = i; if (__i < 0) __i += __s.size(); return std::string(1, __s[static_cast<size_t>(__i)]); })(a))) {
                    dp[(i + int64_t(1))][j] = true;
                }
            }
            j = (j + int64_t(1));
        }
...
int main() {
    {
        ...
        print_bool(abbr(std::string("daBcd"), std::string("ABC")));
        print_bool(abbr(std::string("dBcd"), std::string("ABC")));
    }
    return 0;
}

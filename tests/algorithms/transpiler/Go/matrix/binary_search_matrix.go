...
// Generated by Mochi v0.10.64 on 2025-08-12 16:24:14 GMT+7
package main
...
func mat_bin_search(value int, matrix [][]int) []int {
	var index int = 0
	_ = index
	if int(_index(_index(matrix, index), 0)) == value {
	...
	for (index < len(matrix)) && (int(_index(_index(matrix, index), 0)) < value) {

...
// Generated by Mochi v0.10.61 on 2025-08-08 18:14:55 GMT+7
package main
...
func min_steps_to_one(number int) int {
	...
	_ = i
	for i < number {
		_setIndex(table, (i + 1), min_int(_index(table, (i+1)), (int(_index(table, i))+1)))
		if (i * 2) <= number {
			_setIndex(table, (i * 2), min_int(_index(table, (i*2)), (int(_index(table, i))+1)))
		}
		if (i * 3) <= number {
			_setIndex(table, (i * 3), min_int(_index(table, (i*3)), (int(_index(table, i))+1)))
		}
		i = (i + 1)
	}

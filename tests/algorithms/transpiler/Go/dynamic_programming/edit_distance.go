...
// Generated by Mochi v0.10.61 on 2025-08-08 17:57:46 GMT+7
package main
...
func helper_top_down(word1 string, word2 string, dp [][]int, i int, j int) int {
	...
	if int(_index(_index(dp, i), j)) != (0 - 1) {
	...
	if _substr(word1, i, (i+1)) == _substr(word2, j, (j+1)) {
		...
		insert := helper_top_down(word1, word2, func(v any) [][]int {
			if v == nil {
				return nil
			}
			if vv, ok := v.([][]int); ok {
		...
		_ = insert
		delete := helper_top_down(word1, word2, func(v any) [][]int {
			if v == nil {
				return nil
			}
			if vv, ok := v.([][]int); ok {
		...
		_ = delete
		replace := helper_top_down(word1, word2, func(v any) [][]int {
			if v == nil {
				return nil
			}
			if vv, ok := v.([][]int); ok {

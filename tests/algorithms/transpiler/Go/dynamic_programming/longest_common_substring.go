...
// Generated by Mochi v0.10.61 on 2025-08-08 17:58:01 GMT+7
package main
	...
	for ii <= m {
		...
		for jj <= n {
			if _substr(text1, (ii-1), ii) == _substr(text2, (jj-1), jj) {
				_setIndex(_index(dp, ii), jj, (1 + int(_index(_index(dp, (ii-1)), (jj-1)))))
				if int(_index(_index(dp, ii), jj)) > max_len {

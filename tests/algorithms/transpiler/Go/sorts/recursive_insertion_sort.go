...
// Generated by Mochi v0.10.63 on 2025-08-11 17:37:10 GMT+7
package main
...
func insert_next(collection []int, index int) []int {
	...
	_ = arr
	if (index >= len(arr)) || (int(_index(arr, (index-1))) <= int(_index(arr, index))) {
		return arr
	}
	var j int = (index - 1)
	_ = j
...
func test_rec_insertion_sort() {
	var col1 []int = []int{func(v any) int {
		if vv, ok := v.(int); ok {
			return vv
		}
		return 0
	...
	if ((int(_index(col1, 0)) != 1) || (int(_index(col1, 1)) != 1)) || (int(_index(col1, 2)) != 2) {
		panic("test1 failed")
	}
	var col2 []int = []int{func(v any) int {
		if vv, ok := v.(int); ok {
			return vv
		}
		return 0
	...
	if int(_index(col2, 0)) != (0 - 2) {
		panic("test2 failed")
	}
	if int(_index(col2, 1)) != (0 - 1) {
		panic("test2 failed")
	}
	if int(_index(col2, 2)) != 0 {
		panic("test2 failed")
	}
	if int(_index(col2, 3)) != 1 {
		panic("test2 failed")
	}
	if int(_index(col2, 4)) != 2 {
		panic("test2 failed")
	}
	var col3 []int = []int{func(v any) int {
		if vv, ok := v.(int); ok {
			return vv
		}
		return 0
...
func mochiMain() {
	...
	var numbers []int = []int{func(v any) int {
		if vv, ok := v.(int); ok {
			return vv
		}
		return 0

...
// Generated by Mochi v0.10.67 on 2025-08-17 14:18:48 GMT+7
package main
...
func run_tests() {
	var r float64 = capture_radii(6.957e+08, 1.99e+30, 25000.0)
	_ = r
	if abs((r - 1.720959069143714e+10)) > 1.0 {
		panic("capture_radii failed")
	}
	var a float64 = capture_area(r)
	_ = a
	if abs((a - 9.304455331801812e+20)) > 1.0 {

...
// Generated by Mochi v0.10.73 on 2025-08-25 16:50:31 GMT+7
package main
	...
	func() {
		...
		for len(heap2) > 0 {
			...
			for _, v2 := range func() []string {
				...
				var next_cost2 int = (cost2 + G2[u2][v2])
				_ = next_cost2
		...
		for len(heap3) > 0 {
			...
			for _, v3 := range func() []string {
				...
				var next_cost3 int = (cost3 + G3[u3][v3])
				_ = next_cost3

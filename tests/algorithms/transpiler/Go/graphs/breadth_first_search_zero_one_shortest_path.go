...
// Generated by Mochi v0.10.73 on 2025-08-25 16:50:23 GMT+7
package main
...
func add_edge(al *AdjacencyList, from_vertex int, to_vertex int, weight int) {
	...
	var g [][]Edge = al.Graph
	_ = g
	var edges []Edge = _index(g, from_vertex)
	_ = edges
	_setIndex(g, from_vertex, append(edges, Edge{
...
func get_shortest_path(al AdjacencyList, start_vertex int, finish_vertex int) int {
	...
	for len(queue) > 0 {
		var current_vertex int = front(func(v any) []int {
			if v == nil {
				return nil
			}
			if vv, ok := v.([]int); ok {

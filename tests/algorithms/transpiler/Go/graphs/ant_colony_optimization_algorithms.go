...
// Generated by Mochi v0.10.73 on 2025-08-25 16:50:06 GMT+7
package main
...
func rand_float() float64 {
	return (float64(float64(_modi(_now(), 1000000))) / float64(1000000.0))
}
...
func distance(city1 []int, city2 []int) float64 {
	var dx float64 = float64((_index(city1, 0) - _index(city2, 0)))
	_ = dx
	_ = dx
	var dy float64 = float64((_index(city1, 1) - _index(city2, 1)))
	_ = dy
	_ = dy

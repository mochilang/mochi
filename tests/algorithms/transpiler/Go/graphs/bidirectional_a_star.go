...
// Generated by Mochi v0.10.73 on 2025-08-25 16:50:13 GMT+7
package main
...
func get_successors(p Pos) []Pos {
	...
	_ = i
	for i < len(delta) {
		var nx int = (p.X + _index(_index(delta, i), 1))
		_ = nx
		var ny int = (p.Y + _index(_index(delta, i), 0))
		_ = ny

...
// Generated by Mochi v0.10.61 on 2025-08-08 18:16:10 GMT+7
package main
...
func equated_monthly_installments(principal float64, rate_per_annum float64, years_to_repay int) float64 {
	...
	_ = factor
	_ = factor
	return float64((float64(((principal * rate_per_month) * _toFloat(factor))) / float64(_toFloat((_toFloat(factor) - 1.0)))))
}

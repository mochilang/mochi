...
// Generated by Mochi v0.10.61 on 2025-08-08 17:49:20 GMT+7
package main
...
func main() {
	func() {
		...
		rgb_img = [][][]int{[][]int{[]int{func(v any) int {
			if vv, ok := v.(int); ok {
				return vv
			}
			return 0
		...
		kernel1 = [][]int{[]int{func(v any) int {
			if vv, ok := v.(int); ok {
				return vv
			}
			return 0
		...
		kernel2 = [][]int{[]int{func(v any) int {
			if vv, ok := v.(int); ok {
				return vv
			}
			return 0

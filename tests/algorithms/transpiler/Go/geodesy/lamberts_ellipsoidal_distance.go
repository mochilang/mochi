...
// Generated by Mochi v0.10.62 on 2025-08-09 16:27:27 GMT+7
package main
...
func lamberts_ellipsoidal_distance(lat1 float64, lon1 float64, lat2 float64, lon2 float64) float64 {
	...
	_ = lambda2
	x := (_toFloat((_toFloat(lambda2) - _toFloat(lambda1))) * cos_approx(float64((float64(_toFloat((fmt.Sprint(phi1) + fmt.Sprint(phi2)))) / float64(2.0)))))
	_ = x
	_ = x

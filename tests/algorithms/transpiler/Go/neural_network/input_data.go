...
// Generated by Mochi v0.10.64 on 2025-08-12 09:24:18 GMT+7
package main
...
func mochiMain() {
	var train_images [][]int = [][]int{[]int{func(v any) int {
		if vv, ok := v.(int); ok {
			return vv
		}
		return 0
	...
	_ = train_images
	var train_labels_raw []int = []int{func(v any) int {
		if vv, ok := v.(int); ok {
			return vv
		}
		return 0
	...
	_ = train_labels_raw
	var test_images [][]int = [][]int{[]int{func(v any) int {
		if vv, ok := v.(int); ok {
			return vv
		}
		return 0
	...
	_ = test_images
	var test_labels_raw []int = []int{func(v any) int {
		if vv, ok := v.(int); ok {
			return vv
		}
		return 0

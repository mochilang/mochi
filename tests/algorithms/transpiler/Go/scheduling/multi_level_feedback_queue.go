...
// Generated by Mochi v0.10.63 on 2025-08-11 16:26:35 GMT+7
package main
...
func multi_level_feedback_queue(mlfq MLFQ) []Process {
	...
	for i < (mlfq.NumberOfQueues - 1) {
		rr := round_robin(mlfq, func(v any) []Process {
			if v == nil {
				return nil
			}
		...
		_ = rr
		mlfq.ReadyQueue = RRResult(rr).Ready
		i = (i + 1)
	}
...
func main() {
	func() {
		...
		number_of_queues = 3
		time_slices = []int{func(v any) int {
			if vv, ok := v.(int); ok {
				return vv
			}
			return 0

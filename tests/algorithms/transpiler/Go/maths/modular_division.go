...
// Generated by Mochi v0.10.63 on 2025-08-12 08:26:01 GMT+7
package main
...
func extended_gcd(a int, b int) []int {
	...
	var res []int = extended_gcd(b, _mod(a, b))
	_ = res
...
func extended_euclid(a int, b int) []int {
	...
	var res []int = extended_euclid(b, _mod(a, b))
	_ = res
	var x int = _index(res, 1)
	_ = x
	_ = x
	var y int = (int(_index(res, 0)) - ((a / b) * int(_index(res, 1))))
	_ = y
	_ = y
	return []int{func(v any) int {
		if vv, ok := v.(int); ok {
...
func tests() {
	...
	_ = eg
	if ((int(_index(eg, 0)) != 2) || (int(_index(eg, 1)) != (0 - 1))) || (int(_index(eg, 2)) != 2) {
		panic("eg")
	}
	var eu []int = extended_euclid(10, 6)
	_ = eu
	if (int(_index(eu, 0)) != (0 - 1)) || (int(_index(eu, 1)) != 2) {
		panic("eu")
	}

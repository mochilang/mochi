...
// Generated by Mochi v0.10.63 on 2025-08-12 08:26:04 GMT+7
package main
...
func lcg_rand() int {
	lcg_seed = _mod(((lcg_seed * 1103515245) + 12345), 2147483648)
	return lcg_seed
}
...
func throw_dice(num_throws int, num_dice int) []float64 {
	...
	for t < num_throws {
		...
		_setIndex(count_of_sum, s, (int(_index(count_of_sum, s)) + 1))
		t = (t + 1)
	}

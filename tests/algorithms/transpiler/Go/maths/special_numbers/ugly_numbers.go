...
// Generated by Mochi v0.10.64 on 2025-08-12 16:23:50 GMT+7
package main
...
func ugly_numbers(n int) int {
	...
	for count < n {
		...
		if next_num == next_2 {
			i2 = (i2 + 1)
			next_2 = (int(_index(ugly_nums, i2)) * 2)
		}
		if next_num == next_3 {
			i3 = (i3 + 1)
			next_3 = (int(_index(ugly_nums, i3)) * 3)
		}
		if next_num == next_5 {
			i5 = (i5 + 1)
			next_5 = (int(_index(ugly_nums, i5)) * 5)
		}
		count = (count + 1)
	}

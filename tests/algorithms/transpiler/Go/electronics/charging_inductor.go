...
// Generated by Mochi v0.10.61 on 2025-08-08 18:15:36 GMT+7
package main
...
func expApprox(x float64) float64 {
	...
	if x > 1.0 {
		half := expApprox((float64(x) / float64(2.0)))
		_ = half
		_ = half
		return float64((_toFloat(half) * _toFloat(half)))
	}
	var sum float64 = 1.0
	_ = sum
...
func round(x float64, n int) float64 {
	...
	_ = m
	_ = m
	return float64((float64(floor(float64(((x * _toFloat(m)) + 0.5)))) / float64(_toFloat(m))))
}
...
func charging_inductor(source_voltage float64, resistance float64, inductance float64, time_ float64) float64 {
	...
	exponent := (float64(((0 - time_) * resistance)) / float64(inductance))
	_ = exponent

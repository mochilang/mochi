...
// Generated by Mochi v0.10.61 on 2025-08-08 18:15:49 GMT+7
package main
...
func ind_reactance(inductance float64, frequency float64, reactance float64) map[string]float64 {
	...
	if inductance == 0.0 {
		return func(v any) map[string]float64 {
			...
			return nil
		}(map[string]float64{"inductance": (float64(reactance) / float64(((2.0 * PI) * frequency)))})
	}
	if frequency == 0.0 {
		return func(v any) map[string]float64 {
			if v == nil {
			...
			return nil
		}(map[string]float64{"frequency": (float64(reactance) / float64(((2.0 * PI) * inductance)))})
	}
	return func(v any) map[string]float64 {
		if v == nil {
			return nil
		...
		return nil
	}(map[string]float64{"reactance": (((2.0 * PI) * frequency) * inductance)})
}

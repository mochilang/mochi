...
// Generated by Mochi v0.10.61 on 2025-08-08 18:15:45 GMT+7
package main
...
func electrical_impedance(resistance float64, reactance float64, impedance float64) map[string]float64 {
	...
	if resistance == 0.0 {
		...
		return func(v any) map[string]float64 {
			...
			return nil
		}(map[string]float64{"resistance": value})
	} else {
		if reactance == 0.0 {
			...
			return func(v any) map[string]float64 {
				...
				return nil
			}(map[string]float64{"reactance": value})
		} else {
			if impedance == 0.0 {
				...
				return func(v any) map[string]float64 {
					...
					return nil
				}(map[string]float64{"impedance": value})
			} else {

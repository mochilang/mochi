...
// Generated by Mochi v0.10.61 on 2025-08-08 18:15:51 GMT+7
package main
...
func ohms_law(voltage float64, current float64, resistance float64) map[string]float64 {
	...
	if voltage == 0.0 {
		return func(v any) map[string]float64 {
			...
			return nil
		}(map[string]float64{"voltage": (current * resistance)})
	}
	if current == 0.0 {
		return func(v any) map[string]float64 {
			if v == nil {
			...
			return nil
		}(map[string]float64{"current": (float64(voltage) / float64(resistance))})
	}
	return func(v any) map[string]float64 {
		if v == nil {
			return nil
		...
		return nil
	}(map[string]float64{"resistance": (float64(voltage) / float64(current))})
}

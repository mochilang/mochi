...
// Generated by Mochi v0.10.61 on 2025-08-08 18:15:27 GMT+7
package main
...
func ln_series(x float64) float64 {
	...
	_ = n
	for n <= 19 {
		sum = (sum + (float64(_toFloat(term)) / float64(n)))
		term = ((_toFloat(term) * _toFloat(t)) * _toFloat(t))
		n = (n + 2)
	}
	return (2.0 * sum)
}
...
func builtin_voltage(donor_conc float64, acceptor_conc float64, intrinsic_conc float64) float64 {
	...
	return (float64(((BOLTZMANN * TEMPERATURE) * ln((float64((donor_conc * acceptor_conc)) / float64((intrinsic_conc * intrinsic_conc)))))) / float64(ELECTRON_VOLT))
}

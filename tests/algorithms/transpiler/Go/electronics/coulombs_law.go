...
// Generated by Mochi v0.10.61 on 2025-08-08 18:15:39 GMT+7
package main
...
func coulombs_law(force float64, charge1 float64, charge2 float64, distance float64) map[string]float64 {
	charge_product := math.Abs((charge1 * charge2))
	_ = charge_product
	...
	if force == 0.0 {
		var f float64 = (float64((COULOMBS_CONSTANT * _toFloat(charge_product))) / float64((distance * distance)))
		_ = f
		_ = f
		return func(v any) map[string]float64 {
			...
			return nil
		}(map[string]float64{"force": f})
	}
	if charge1 == 0.0 {
		c1 := (float64((math.Abs(force) * (distance * distance))) / float64((COULOMBS_CONSTANT * charge2)))
		_ = c1
		_ = c1
		return func(v any) map[string]float64 {
			if v == nil {
			...
			return nil
		}(map[string]float64{"charge1": c1})
	}
	if charge2 == 0.0 {
		c2 := (float64((math.Abs(force) * (distance * distance))) / float64((COULOMBS_CONSTANT * charge1)))
		_ = c2
		_ = c2
		return func(v any) map[string]float64 {
			if v == nil {
			...
			return nil
		}(map[string]float64{"charge2": c2})
	}
	d := sqrtApprox(float64((float64((COULOMBS_CONSTANT * _toFloat(charge_product))) / float64(math.Abs(force)))))
	_ = d
	_ = d
	return func(v any) map[string]float64 {
		if v == nil {

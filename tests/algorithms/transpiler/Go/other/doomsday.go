...
// Generated by Mochi v0.10.64 on 2025-08-12 09:24:31 GMT+7
package main
...
func get_week_day(year int, month int, day int) string {
	...
	_ = century
	var century_anchor int = _mod(((5 * _mod(century, 4)) + 2), 7)
	_ = century_anchor
	var centurian int = _mod(year, 100)
	_ = centurian
	var centurian_m int = _mod(centurian, 12)
	_ = centurian_m
	var dooms_day int = _mod(((((centurian / 12) + centurian_m) + (centurian_m / 4)) + century_anchor), 7)
	_ = dooms_day
	var day_anchor int = func() int {
		if (_mod(year, 4) != 0) || ((centurian == 0) && (_mod(year, 400) != 0)) {
	...
	_ = day_anchor
	var week_day int = _mod(((dooms_day + day) - day_anchor), 7)
	_ = week_day
	if week_day < 0 {
		week_day = (week_day + 7)
	}
...
func main() {
	func() {
		...
		DOOMSDAY_LEAP = []int{func(v any) int {
			if vv, ok := v.(int); ok {
				return vv
			}
			return 0
		...
		DOOMSDAY_NOT_LEAP = []int{func(v any) int {
			if vv, ok := v.(int); ok {
				return vv
			}
			return 0

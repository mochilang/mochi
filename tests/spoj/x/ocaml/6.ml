...
and main () =
  ...
  res := (match List.assoc_opt (__str (Obj.repr ("res"))) (!r) with Some v -> (Obj.magic v : string) | None -> "");
  parts := (Obj.magic ((Obj.magic ((match List.assoc_opt (__str (Obj.repr ("parts"))) (!r) with Some v -> (Obj.magic v : Obj.t) | None -> Obj.repr 0)) : Obj.t list)) : Obj.t list);
  );
  );
  ...
  (try List.iter (fun p ->
    try
  let l = (String.length ((Obj.magic ((match List.assoc_opt (__str (Obj.repr ("val"))) (p) with Some v -> (Obj.magic v : Obj.t) | None -> Obj.repr 0)) : string)) + (Obj.magic ((match List.assoc_opt (__str (Obj.repr ("shift"))) (p) with Some v -> (Obj.magic v : Obj.t) | None -> Obj.repr 0)) : int)) in
  if (l > !width) then (
  width := l;
  );
  ...
  let firstPart = (Obj.magic ((match List.assoc_opt (__str (Obj.repr ("val"))) ((let __l = !parts in let __i = 0 in if __i < 0 then ([] : (string * Obj.t) list) else match List.nth_opt __l __i with Some v -> (Obj.magic v : Obj.t) | None -> ([] : (string * Obj.t) list))) with Some v -> (Obj.magic v : Obj.t) | None -> Obj.repr 0)) : string) in
  ...
  (try List.iter (fun p ->
    try
  let val_ = (Obj.magic ((match List.assoc_opt (__str (Obj.repr ("val"))) (p) with Some v -> (Obj.magic v : Obj.t) | None -> Obj.repr 0)) : string) in
  let shift = (Obj.magic ((match List.assoc_opt (__str (Obj.repr ("shift"))) (p) with Some v -> (Obj.magic v : Obj.t) | None -> Obj.repr 0)) : int) in

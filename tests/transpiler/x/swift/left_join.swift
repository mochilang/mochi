// Generated by Mochi transpiler v0.10.33 on 2025-07-21 18:25:23 GMT+7
import Foundation
...
print("--- Left Join ---")
for entry in result {
    print("Order", String(describing: entry["orderId"]!), "customer", String(describing: entry["customer"]!), "total", String(describing: entry["total"]!))
}

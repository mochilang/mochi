// Generated by Mochi v0.10.32 on 2025-07-21 07:58:29 GMT+7
...
const result: Result[] = (() => {
  ...
  { const _joined = []
    const _arr = orders
    for (const _right of _arr) {
      let _m = false;
      for (const _left of _items) {
        const [c] = _left;
        const o = _right;
        if (!((o["customerId"] == c["id"]))) continue;
        _m = true; _joined.push([..._left, _right])
      }
      if (!_m) { const _undef = Array(_items[0]?.length || 0).fill(null); _joined.push([..._undef, _right]) }
    }
    _items = _joined;
  }
  let _rows = _items

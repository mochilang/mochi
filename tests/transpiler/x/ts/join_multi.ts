...
console.log(((v => typeof v === 'string' ? v : JSON.stringify(v))("--- Multi Join ---")));
for (const r of result) {
  console.log(((v => typeof v === 'string' ? v : JSON.stringify(v))(r["name"])), ((v => typeof v === 'string' ? v : JSON.stringify(v))("bought item")), ((v => typeof v === 'string' ? v : JSON.stringify(v))(r["sku"])));
}

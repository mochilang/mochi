...
console.log(((v => typeof v === 'string' ? v : JSON.stringify(v))("--- Even pairs ---")));
for (const p of pairs) {
  console.log(((v => typeof v === 'string' ? v : JSON.stringify(v))(p["n"])), ((v => typeof v === 'string' ? v : JSON.stringify(v))(p["l"])));
}

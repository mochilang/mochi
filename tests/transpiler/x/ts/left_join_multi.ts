...
console.log(((v => typeof v === 'string' ? v : JSON.stringify(v))("--- Left Join Multi ---")));
for (const r of result) {
  console.log(((v => typeof v === 'string' ? v : JSON.stringify(v))(r["orderId"])), ((v => typeof v === 'string' ? v : JSON.stringify(v))(r["name"])), ((v => typeof v === 'string' ? v : JSON.stringify(v))(r["item"])));
}

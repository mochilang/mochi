...
console.log(((v => typeof v === 'string' ? v : JSON.stringify(v))("--- Orders per customer ---")));
for (const s of stats) {
  console.log(((v => typeof v === 'string' ? v : JSON.stringify(v))(s["name"])), ((v => typeof v === 'string' ? v : JSON.stringify(v))("orders:")), ((v => typeof v === 'string' ? v : JSON.stringify(v))(s["count"])));
}

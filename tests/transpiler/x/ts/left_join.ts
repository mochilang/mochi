...
console.log(((v => typeof v === 'string' ? v : JSON.stringify(v))("--- Left Join ---")));
for (const entry of result) {
  console.log(((v => typeof v === 'string' ? v : JSON.stringify(v))("Order")), ((v => typeof v === 'string' ? v : JSON.stringify(v))(entry["orderId"])), ((v => typeof v === 'string' ? v : JSON.stringify(v))("customer")), ((v => typeof v === 'string' ? v : JSON.stringify(v))(entry["customer"])), ((v => typeof v === 'string' ? v : JSON.stringify(v))("total")), ((v => typeof v === 'string' ? v : JSON.stringify(v))(entry["total"])));
}

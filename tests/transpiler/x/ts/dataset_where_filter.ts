...
console.log(((v => typeof v === 'string' ? v : JSON.stringify(v))("--- Adults ---")));
for (const person of adults) {
  console.log(((v => typeof v === 'string' ? v : JSON.stringify(v))(person["name"])), ((v => typeof v === 'string' ? v : JSON.stringify(v))("is")), ((v => typeof v === 'string' ? v : JSON.stringify(v))(person["age"])), ((v => typeof v === 'string' ? v : JSON.stringify(v))((person["is_senior"] ? " (senior)" : ""))));
}

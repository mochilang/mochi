...
const nation: Nation[] = [{"__name": "GenType1", n_nationkey: 1, n_name: "BRAZIL"}];
const customer: Customer[] = [{"__name": "GenType1", c_custkey: 1, c_name: "Alice", c_acctbal: 100.0, c_nationkey: 1, c_address: "123 St", c_phone: "123-456", c_comment: "Loyal"}];
const orders: Order[] = [{"__name": "GenType1", o_orderkey: 1000, o_custkey: 1, o_orderdate: "1993-10-15"}, {"__name": "GenType1", o_orderkey: 2000, o_custkey: 1, o_orderdate: "1994-01-02"}];
const lineitem: Lineitem[] = [{"__name": "GenType1", l_orderkey: 1000, l_returnflag: "R", l_extendedprice: 1000.0, l_discount: 0.1}, {"__name": "GenType1", l_orderkey: 2000, l_returnflag: "N", l_extendedprice: 500.0, l_discount: 0.0}];
...
const result: Record<string, any>[] = (() => {
  ...
  for (const it of rows) {
    ...
    const k = {"__name": "GenType1", c_custkey: c["c_custkey"], c_name: c["c_name"], c_acctbal: c["c_acctbal"], c_address: c["c_address"], c_phone: c["c_phone"], c_comment: c["c_comment"], n_name: n["n_name"]}
  ...
  for (const g of ordered) {
    result.push({"__name": "GenType1", c_custkey: g["key"]["c_custkey"], c_name: g["key"]["c_name"], revenue: (() => {
  const result = []
  for (const x of g["items"]) {
    result.push((x["l"]["l_extendedprice"] * (1 - x["l"]["l_discount"])))
  }

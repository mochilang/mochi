// Generated by Mochi Zig transpiler on 2025-07-22 10:07 +0700
...
pub fn main() void {
    ...
    var out = std.ArrayList(Entry2).init(std.heap.page_allocator);
    for (tmp) |it| { out.append(it.val) catch unreachable; }
    tmp = out.toOwnedSlice() catch unreachable;
    break :blk tmp;
};

// Generated by Mochi Zig transpiler on 2025-07-21 11:36 +0000
...
pub fn main() void {
    ...
    const customer: [_]Customer = [_]Customer{.{ .c_custkey = 1, .c_name = "Alice", .c_acctbal = 100.0, .c_nationkey = 1, .c_address = "123 St", .c_phone = "123-456", .c_comment = "Loyal" }};
    ...
    const lineitem: [_]Lineitem = [_]Lineitem{.{ .l_orderkey = 1000, .l_returnflag = "R", .l_extendedprice = 1000.0, .l_discount = 0.1 }, .{ .l_orderkey = 2000, .l_returnflag = "N", .l_extendedprice = 500.0, .l_discount = 0.0 }};

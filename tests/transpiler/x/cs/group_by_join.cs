// Generated by Mochi 0.10.32 on 2025-07-21 06:09 UTC
using System;
...
class Program {
    ...
    static GResult[] stats = (from o in orders join c in customers on o.customerId equals c.id group o by c.name into gTmp let g = new GGroup{ key = gTmp.Key, items = gTmp.ToArray() } select new GResult{name = g.key, count = g.items.Length}).ToArray();
    static void Main() {

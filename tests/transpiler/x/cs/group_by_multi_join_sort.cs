...
struct Customer {
    ...
    public override string ToString() => $"{{\"c_custkey\": {c_custkey}, \"c_name\": \"{c_name}\", \"c_acctbal\": {c_acctbal}, \"c_nationkey\": {c_nationkey}, \"c_address\": \"{c_address}\", \"c_phone\": \"{c_phone}\", \"c_comment\": \"{c_comment}\"}}";
}
struct Order {
...
struct Lineitem {
    ...
    public override string ToString() => $"{{\"l_orderkey\": {l_orderkey}, \"l_returnflag\": \"{l_returnflag}\", \"l_extendedprice\": {l_extendedprice}, \"l_discount\": {l_discount}}}";
}
struct GKey {
    public int c_custkey;
    public string c_name;
    ...
    public string c_comment;
    public string n_name;
    public override string ToString() => $"{{\"c_custkey\": {c_custkey}, \"c_name\": \"{c_name}\", \"c_acctbal\": {c_acctbal}, \"c_address\": \"{c_address}\", \"c_phone\": \"{c_phone}\", \"c_comment\": \"{c_comment}\", \"n_name\": \"{n_name}\"}}";
}
struct GGroup {
    public GKey key;
...
struct GResult {
    ...
    public string c_phone;
    public string c_comment;
    public override string ToString() => $"{{\"c_custkey\": {c_custkey}, \"c_name\": \"{c_name}\", \"revenue\": {revenue}, \"c_acctbal\": {c_acctbal}, \"n_name\": \"{n_name}\", \"c_address\": \"{c_address}\", \"c_phone\": \"{c_phone}\", \"c_comment\": \"{c_comment}\"}}";
}
class Program {

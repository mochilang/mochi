// Generated by Mochi transpiler v0.10.35 on 2025-07-22 14:50:22 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <map>
...
std::vector<std::pair<double, GGroup>> __tmp;
for(auto &__g : __groups) {
    GGroup g = __g;
...
return __items; }()); return std::accumulate(__tmp.begin(), __tmp.end(), 0.0); }()), __g);
}

// Generated by Mochi transpiler v0.10.32 on 2025-07-21 11:04:39 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <map>
...
int main() {
    { std::ostringstream __ss; __ss << std::boolalpha; if(false) __ss << " "; __ss << std::string("--- People grouped by city ---"); auto __line = __ss.str(); if(!__line.empty() && __line.back() == ' ') __line.pop_back(); std::cout << __line << std::endl; }
    for (auto s : stats) {
        { std::ostringstream __ss; __ss << std::boolalpha; if(false) __ss << " "; __ss << s.city; if(true) __ss << " "; __ss << std::string(": count ="); if(true) __ss << " "; __ss << s.count; if(true) __ss << " "; __ss << std::string(", avg_age ="); if(true) __ss << " "; __ss << s.avg_age; auto __line = __ss.str(); if(!__line.empty() && __line.back() == ' ') __line.pop_back(); std::cout << __line << std::endl; }
    }
    return 0;
}

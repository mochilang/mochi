// Generated by Mochi transpiler v0.10.32 on 2025-07-21 15:10:39 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <map>
...
int main() {
    { std::ostringstream __ss; __ss << std::boolalpha << std::setprecision(17); if(false) __ss << " "; __ss << std::string("--- Group Left Join ---"); auto __line = __ss.str(); if(!__line.empty() && __line.back() == ' ') __line.pop_back(); std::cout << __line << std::endl; }
    for (auto s : stats) {
        { std::ostringstream __ss; __ss << std::boolalpha << std::setprecision(17); if(false) __ss << " "; __ss << s.name; if(true) __ss << " "; __ss << std::string("orders:"); if(true) __ss << " "; __ss << s.count; auto __line = __ss.str(); if(!__line.empty() && __line.back() == ' ') __line.pop_back(); std::cout << __line << std::endl; }
    }
    return 0;
}

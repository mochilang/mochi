// Generated by Mochi transpiler v0.10.32 on 2025-07-20 23:05:27 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <map>
...
for(auto &__kv : __groups) {
    ...
    __items.push_back(ResultItem{.cat = g.key, .share = ((double)(std::accumulate(([]{ std::vector<auto> __items;
for (auto x : g) {

// Generated by Mochi transpiler v0.10.32 on 2025-07-21 11:14:18 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <map>
...
int main() {
    ...
    for (auto person : adults) {
        std::cout << person.name <<  " " << std::string("is") <<  " " << person.age <<  " " << (person.is_senior ? std::string(" (senior)") : std::string("")) << std::endl;
    }
    return 0;
}

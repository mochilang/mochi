// Generated by Mochi transpiler v0.10.32 on 2025-07-21 11:14:16 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <map>
...
int main() {
    std::cout << std::string("--- Top products (excluding most expensive) ---") << std::endl;
    for (auto item : expensive) {
        std::cout << item.name <<  " " << std::string("costs $") <<  " " << item.price << std::endl;
    }
    return 0;
}

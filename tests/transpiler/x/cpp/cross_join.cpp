// Generated by Mochi transpiler v0.10.32 on 2025-07-20 18:03:05 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <map>
...
std::vector<ResultItem> result = ([]{ std::vector<ResultItem> __items; for (auto o : orders) {for (auto c : customers) {__items.push_back(ResultItem{.orderId = o.id, .orderCustomerId = o.customerId, .pairedCustomerName = c.name, .orderTotal = o.total});}} return __items; }());

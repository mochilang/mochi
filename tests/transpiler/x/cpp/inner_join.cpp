// Generated by Mochi transpiler v0.10.32 on 2025-07-21 11:14:35 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <map>
...
int main() {
    ...
    for (auto entry : result) {
        std::cout << std::string("Order") <<  " " << entry.orderId <<  " " << std::string("by") <<  " " << entry.customerName <<  " " << std::string("- $") <<  " " << entry.total << std::endl;
    }
    return 0;
}

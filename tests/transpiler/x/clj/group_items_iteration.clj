;; Generated by Mochi v0.10.32 on 2025-07-21 11:12:36 GMT+7
(ns main)
...
(def groups (for [[k rows] (group-by :key (for [d data :let [k (:tag d)]] {:key k :item d})) :let [g {:key k :items (map :item rows)}]] g))

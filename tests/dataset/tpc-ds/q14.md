...
This query from the TPC-DS specification analyzes cross-channel item sales. The snippet below shows the beginning of the official SQL. The example program in [q14.mochi](./q14.mochi) just outputs the query id.

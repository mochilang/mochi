...
This query is reproduced from the official TPC-DS specification. The companion [q4.mochi](./q4.mochi) program only verifies that the environment runs and returns the query id.

...
This query is reproduced from the official TPC-DS specification. The companion [q8.mochi](./q8.mochi) program only verifies that the environment runs and returns the query id.

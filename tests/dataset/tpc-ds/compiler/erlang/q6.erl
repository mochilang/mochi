#!/usr/bin/env escript
% Generated by Mochi compiler v0.10.25 on 2025-07-15T04:58:14Z
...
main(_) ->
    ...
    Target_month_seq = lists:max([maps:get(d_month_seq, D) || D <- Date_dim, ((maps:get(d_year, D) == 1999) andalso (maps:get(d_moy, D) == 5))]),

#!/usr/bin/env escript
% Generated by Mochi compiler v0.10.26 on 2025-07-15T06:31:01Z
...
main(_) ->
    ...
    Ss98 = lists:sum([maps:get(ss_ext_list_price, Ss) || Ss <- Store_sales, (maps:get(ss_sold_date_sk, Ss) == 1998)]),
    Ss99 = lists:sum([maps:get(ss_ext_list_price, Ss) || Ss <- Store_sales, (maps:get(ss_sold_date_sk, Ss) == 1999)]),
    Ws98 = lists:sum([maps:get(ws_ext_list_price, Ws) || Ws <- Web_sales, (maps:get(ws_sold_date_sk, Ws) == 1998)]),
    Ws99 = lists:sum([maps:get(ws_ext_list_price, Ws) || Ws <- Web_sales, (maps:get(ws_sold_date_sk, Ws) == 1999)]),

...
union_sales = __concat(__concat((function()
    ...
    }, { selectFn = function(ss, d, ca, i) return {["manu"]=i.i_manufact_id, ["price"]=ss.ss_ext_sales_price} end, where = function(ss, d, ca, i) return ((((__eq(i.i_category, "Books") and (d.d_year == year)) and (d.d_moy == month)) and (ca.ca_gmt_offset == (-5)))) end })
end)(), (function()
    ...
    }, { selectFn = function(cs, d, ca, i) return {["manu"]=i.i_manufact_id, ["price"]=cs.cs_ext_sales_price} end, where = function(cs, d, ca, i) return ((((__eq(i.i_category, "Books") and (d.d_year == year)) and (d.d_moy == month)) and (ca.ca_gmt_offset == (-5)))) end })
end)()), (function()
    ...
    }, { selectFn = function(ws, d, ca, i) return {["manu"]=i.i_manufact_id, ["price"]=ws.ws_ext_sales_price} end, where = function(ws, d, ca, i) return ((((__eq(i.i_category, "Books") and (d.d_year == year)) and (d.d_moy == month)) and (ca.ca_gmt_offset == (-5)))) end })
end)())
result = (function()

...
filtered = (function()
    ...
    }, { selectFn = function(cs, c, ca, d) return {cs, c, ca, d} end, where = function(cs, c, ca, d) return ((((((__contains({"85669", "86197", "88274", "83405", "86475", "85392", "85460", "80348", "81792"}, __slice(ca.ca_zip, 0, 5)) or __contains({"CA", "WA", "GA"}, ca.ca_state)) or (cs.cs_sales_price > 500))) and (d.d_qoy == 1)) and (d.d_year == 2000))) end })

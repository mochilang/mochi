...
function test_TPCDS_Q32_simplified()
    if not ((result == 20.0)) then error('expect failed') end
end
...
filtered = (function()
    ...
    }, { selectFn = function(cs, i, d) return cs.cs_ext_discount_amt end, where = function(cs, i, d) return (((i.i_manufact_id == 1) and (d.d_year == 2000))) end })
end)()

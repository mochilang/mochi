...
base = (function()
    ...
    }, { selectFn = function(ws, c, ca, i, d) return {ws, c, ca, i, d} end, where = function(ws, c, ca, i, d) return (((((__contains(zip_list, __slice(ca.ca_zip, 0, 5)) or __contains(item_ids, i.i_item_id))) and (d.d_qoy == qoy)) and (d.d_year == year))) end })

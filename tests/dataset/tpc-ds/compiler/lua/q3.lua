-- Generated by Mochi compiler v0.10.26 on 2025-07-15T07:01:07Z
_Group = {}
...
function test_TPCDS_Q3_result()
    if not (__eq(result, {{["d_year"]=1998, ["brand_id"]=2, ["brand"]="Brand2", ["sum_agg"]=20.0}, {["d_year"]=1998, ["brand_id"]=1, ["brand"]="Brand1", ["sum_agg"]=10.0}})) then error('expect failed') end
end

date_dim = {{["d_date_sk"]=1, ["d_year"]=1998, ["d_moy"]=12}}
store_sales = {{["ss_sold_date_sk"]=1, ["ss_item_sk"]=1, ["ss_ext_sales_price"]=10.0}, {["ss_sold_date_sk"]=1, ["ss_item_sk"]=2, ["ss_ext_sales_price"]=20.0}}
...
result = (function()
    ...
    }, { selectFn = function(dt, ss, i) return {dt, ss, i} end, where = function(dt, ss, i) return ((__eq(i.i_manufact_id, 100) and (dt.d_moy == 12))) end })
    local _groups = __group_by_rows(_rows, function(dt, ss, i) return {["d_year"]=dt.d_year, ["brand_id"]=i.i_brand_id, ["brand"]=i.i_brand} end, function(dt, ss, i) local _row = __merge(dt, ss, i); _row.dt = dt; _row.ss = ss; _row.i = i; return _row end)
    local _res = {}
...
__json(result)
local __tests = {
    {name="TPCDS Q3 result", fn=test_TPCDS_Q3_result},
}

...
function test_TPCDS_Q61_simplified()
    if not ((result == 61)) then error('expect failed') end
end

sales = {{["promo"]=true, ["price"]=20}, {["promo"]=true, ["price"]=41}, {["promo"]=false, ["price"]=39}}
promotions = __sum((function()
    local _res = {}
...
__json(result)
local __tests = {
    {name="TPCDS Q61 simplified", fn=test_TPCDS_Q61_simplified},
}

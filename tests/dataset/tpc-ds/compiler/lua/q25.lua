...
result = (function()
    ...
    }, { selectFn = function(ss, sr, cs, d1, d2, d3, s, i) return {ss, sr, cs, d1, d2, d3, s, i} end, where = function(ss, sr, cs, d1, d2, d3, s, i) return (((((((d1.d_moy == 4) and (d1.d_year == 2000)) and (d2.d_moy >= 4)) and (d2.d_moy <= 10)) and (d3.d_moy >= 4)) and (d3.d_moy <= 10))) end })

...
result = (function()
    ...
    }, { selectFn = function(ss, d, i, s) return {ss, d, i, s} end, where = function(ss, d, i, s) return (((d.d_year == 2000) and ((__eq(s.s_state, "A") or __eq(s.s_state, "B"))))) end })
    ...
    for _, g in ipairs(_groups) do
        _res[#_res+1] = {["i_category"]=g.key.category, ["i_class"]=g.key.class, ["gross_margin"]=(__sum((function()
    local _res = {}

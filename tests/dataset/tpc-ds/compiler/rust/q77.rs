...
fn main() {
    ...
    _json(&result);
    assert!(result == vec![Result16 { channel: "catalog channel", id: 1, sales: 150.0, returns: 7.0, profit: 12.0 }, Result16 { channel: "store channel", id: 1, sales: 100.0, returns: 5.0, profit: 9.0 }, Result17 { channel: "web channel", id: 1, sales: 200.0, returns: 10.0, profit: 18.0 }]);
}

// Generated by Mochi compiler v0.10.25 on 2025-07-15T03:49:45Z
...
function main(): void {
  ...
  sr = (() => {
    ...
    for (const sr of _src) {
      for (const d of date_dim) {
        if (!(_equal(d.d_date_sk, sr.sr_returned_date_sk))) continue;
  ...
  cr = (() => {
    ...
    for (const cr of _src) {
      for (const d of date_dim) {
        if (!(_equal(d.d_date_sk, cr.cr_returned_date_sk))) continue;
  ...
  wr = (() => {
    ...
    for (const wr of _src) {
      for (const d of date_dim) {
        if (!(_equal(d.d_date_sk, wr.wr_returned_date_sk))) continue;
  ...
  per_channel = [].concat(
    (() => {
      ...
      for (const s of _src) {
        ...
        for (const r of _join) {
          if (!(_equal(s.s_store_sk, r.s_store_sk))) continue;
          _m = true;
          _res.push({
            "channel": "store channel",
            "id": s.s_store_sk,
    ...
    (() => {
      ...
      for (const w of _src) {
        let _m = false;
        for (const r of _join) {
          if (!(_equal(w.wp_web_page_sk, r.wp_web_page_sk))) continue;
          _m = true;
          _res.push({
            "channel": "web channel",
            "id": w.wp_web_page_sk,

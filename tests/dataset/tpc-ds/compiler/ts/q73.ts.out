...
function main(): void {
  ...
  groups = (() => {
    ...
    let _items = _query(_src, [
      ...
      },
      {
        ...
        on: (ss, d, s, hd) => (_equal(hd.hd_demo_sk, ss.ss_hdemo_sk)),
      },
    ], {
      ...
      where: (
        ...
        (_equal(hd.hd_buy_potential, "1001-5000") ||
          _equal(hd.hd_buy_potential, "0-500"))) &&
  ...
  result = (() => {
    const _src = groups;
    return _query(_src, [
      { items: customer, on: (g, c) => (_equal(c.c_customer_sk, g.key.cust)) },
    ], {
      select: (g, c) => ({

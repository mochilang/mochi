    ...
    return _query(_src, [
      {
        ...
        on: (
          s,
          w,
        ) => ((_equal(w.ws_sold_year, s.ss_sold_year) &&
          _equal(w.ws_item_sk, s.ss_item_sk)) &&
          _equal(w.ws_customer_sk, s.ss_customer_sk)),
        left: true,
      },
      {
        items: cs,
        on: (
          ...
          w,
          c,
        ) => ((_equal(c.cs_sold_year, s.ss_sold_year) &&
          _equal(c.cs_item_sk, s.ss_item_sk)) &&
          _equal(c.cs_customer_sk, s.ss_customer_sk)),
        left: true,
      },
    ], {
      select: (s, w, c) => ({
      ...
      where: (
        ...
        ((_equal(c, null) ? 0 : c.cs_qty) > 0)) &&
        _equal(s.ss_sold_year, 1998)),
    });
  })();

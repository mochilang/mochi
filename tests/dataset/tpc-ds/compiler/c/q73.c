// Generated by Mochi compiler v0.10.26 on 2025-07-15T06:30:45Z
// Generated by Mochi compiler v0.10.26 on 2025-07-15T06:30:45Z
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
static list_int test_TPCDS_Q73_simplified_result;
static void test_TPCDS_Q73_simplified() {
  ...
  int tmp2 = 1;
  if (test_TPCDS_Q73_simplified_result.len != tmp1.len) {
    tmp2 = 0;
  } else {
    for (int i3 = 0; i3 < test_TPCDS_Q73_simplified_result.len; i3++) {
      if (test_TPCDS_Q73_simplified_result.data[i3] != tmp1.data[i3]) {
        tmp2 = 0;
        break;
      }
    }
...
int main() {
  ...
  date_dim_t date_dim[] = {
      (date_dim_t){.d_date_sk = 1, .d_dom = 1, .d_year = 1998}};
  ...
  result_item_list_t tmp4 =
      result_item_list_t_create(groups.len * customer.len);
  int tmp5 = 0;
  for (int tmp6 = 0; tmp6 < groups.len; tmp6++) {
    groups_item_t g = groups.data[tmp6];
  ...
  printf("]");
  test_TPCDS_Q73_simplified_result = result;

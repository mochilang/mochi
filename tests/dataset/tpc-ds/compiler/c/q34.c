// Generated by Mochi compiler v0.10.26 on 2025-07-15T06:30:40Z
// Generated by Mochi compiler v0.10.26 on 2025-07-15T06:30:39Z
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
static list_int test_TPCDS_Q34_simplified_result;
static void test_TPCDS_Q34_simplified() {
  ...
  int tmp2 = 1;
  if (test_TPCDS_Q34_simplified_result.len != tmp1.len) {
    tmp2 = 0;
  } else {
    for (int i3 = 0; i3 < test_TPCDS_Q34_simplified_result.len; i3++) {
      if (test_TPCDS_Q34_simplified_result.data[i3] != tmp1.data[i3]) {
        tmp2 = 0;
        break;
      }
    }
...
int main() {
  store_sale_t store_sales[] = {(store_sale_t){.ss_ticket_number = 1,
                                               ...
                                               .ss_store_sk = 1,
                                               .ss_hdemo_sk = 1},
                                (store_sale_t){.ss_ticket_number = 1,
                                               .ss_customer_sk = 1,
                                               .ss_sold_date_sk = 1,
                                               .ss_store_sk = 1,
                                               .ss_hdemo_sk = 1},
  ...
  date_dim_t date_dim[] = {
      (date_dim_t){.d_date_sk = 1, .d_dom = 2, .d_year = 2000}};
  int date_dim_len = sizeof(date_dim) / sizeof(date_dim[0]);
  store_t store[] = {(store_t){.s_store_sk = 1, .s_county = "A"}};
  int store_len = sizeof(store) / sizeof(store[0]);
  household_demographic_t household_demographics[] = {
      (household_demographic_t){.hd_demo_sk = 1,
                                .hd_buy_potential = ">10000",
                                .hd_vehicle_count = 2,
                                .hd_dep_count = 3},
      (household_demographic_t){.hd_demo_sk = 2,
                                .hd_buy_potential = ">10000",
                                .hd_vehicle_count = 2,
                                .hd_dep_count = 1}};
  ...
  result_item_list_t tmp4 = result_item_list_t_create(dn.len * customer.len);
  int tmp5 = 0;
  for (int tmp6 = 0; tmp6 < dn.len; tmp6++) {
    dn_item_t dn1 = dn.data[tmp6];
    for (int tmp7 = 0; tmp7 < customer_len; tmp7++) {
      ...
      tmp4.data[tmp5] =
          (result_item_t){.c_last_name = c.c_last_name,
  ...
  for (int i8 = 0; i8 < result.len; i8++) {
    ...
    printf(",");
    _json_string("c_salutation");
    printf(":");
    _json_string(it.c_salutation);
    printf(",");
    _json_string("c_preferred_cust_flag");
    printf(":");
    _json_string(it.c_preferred_cust_flag);
    printf(",");
  ...
  printf("]");
  test_TPCDS_Q34_simplified_result = result;

// Generated by Mochi compiler v0.10.26 on 2025-07-15T06:30:37Z
// Generated by Mochi compiler v0.10.26 on 2025-07-15T06:30:37Z
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
static list_int test_TPCDS_Q20_revenue_ratio_result;
static void test_TPCDS_Q20_revenue_ratio() {
  ...
  int tmp2 = 1;
  if (test_TPCDS_Q20_revenue_ratio_result.len != tmp1.len) {
    tmp2 = 0;
  } else {
    for (int i3 = 0; i3 < test_TPCDS_Q20_revenue_ratio_result.len; i3++) {
      if (test_TPCDS_Q20_revenue_ratio_result.data[i3] != tmp1.data[i3]) {
        tmp2 = 0;
        break;
      }
    }
...
int main() {
  ...
  date_dim_t date_dim[] = {
      (date_dim_t){.d_date_sk = 1, .d_date = "2000-02-10"},
      (date_dim_t){.d_date_sk = 2, .d_date = "2000-02-20"}};
  ...
  printf("]");
  test_TPCDS_Q20_revenue_ratio_result = result;

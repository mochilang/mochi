				...
				for _, ca := range customer_address {
					...
					for _, cc := range call_center {
						...
						if len(func() []Catalog_sale {
							...
							_item["cs_order_number"] = cs1.Cs_order_number
							_item["cs_ship_date_sk"] = cs1.Cs_ship_date_sk
							_item["cs_ship_addr_sk"] = cs1.Cs_ship_addr_sk
							_item["cs_call_center_sk"] = cs1.Cs_call_center_sk
							_item["cs_warehouse_sk"] = cs1.Cs_warehouse_sk
							_item["cs_ext_ship_cost"] = cs1.Cs_ext_ship_cost
							_item["cs_net_profit"] = cs1.Cs_net_profit
							_item["cs1"] = cs1

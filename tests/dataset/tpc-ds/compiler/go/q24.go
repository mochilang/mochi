						...
						for _, c := range customer {
							...
							for _, ca := range customer_address {
								...
								if (!_equal(c.C_birth_country, func() any { v, _ := goffi.Call("strings.ToUpper", ca.Ca_country); return v }()) && (s.S_zip == ca.Ca_zip)) && (s.S_market_id == 5) {
									...
									_item["s_market_id"] = s.S_market_id
									_item["s_state"] = s.S_state
									_item["s_zip"] = s.S_zip
									_item["s"] = s
									_item["i_item_sk"] = i.I_item_sk
									_item["i_color"] = i.I_color
									_item["i_current_price"] = i.I_current_price
									_item["i_manager_id"] = i.I_manager_id
									_item["i_units"] = i.I_units
									_item["i_size"] = i.I_size
									_item["i"] = i
									...
									_item["c_birth_country"] = c.C_birth_country
									_item["c"] = c
									_item["ca_address_sk"] = ca.Ca_address_sk
									_item["ca_state"] = ca.Ca_state
									_item["ca_country"] = ca.Ca_country

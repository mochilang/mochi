...
// Generated by Mochi compiler v0.10.26 on 2025-07-15T12:00:52Z
			...
			for _, ca := range customer_address {
				...
				for _, cd := range customer_demographics {
					...
					if slices.Contains(purchased, c.C_customer_sk) {
						...
						_item["cd_dep_count"] = cd.Cd_dep_count
						_item["cd_dep_employed_count"] = cd.Cd_dep_employed_count
						_item["cd_dep_college_count"] = cd.Cd_dep_college_count
						_item["cd"] = cd

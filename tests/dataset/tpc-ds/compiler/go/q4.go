		...
		for _, c := range customer {
			for _, s := range store_sales {
				...
				for _, d := range date_dim {
					...
					_item["c_login"] = c.C_login
					_item["c"] = c
					_item["ss_customer_sk"] = s.Ss_customer_sk
					_item["ss_sold_date_sk"] = s.Ss_sold_date_sk
					_item["ss_ext_list_price"] = s.Ss_ext_list_price
					_item["ss_ext_wholesale_cost"] = s.Ss_ext_wholesale_cost
					_item["ss_ext_discount_amt"] = s.Ss_ext_discount_amt
					_item["ss_ext_sales_price"] = s.Ss_ext_sales_price
					_item["s"] = s
		...
		for _, c := range customer {
			for _, cs := range catalog_sales {
				...
				for _, d := range date_dim {
					...
					_item["cs_ext_list_price"] = cs.Cs_ext_list_price
					_item["cs_ext_wholesale_cost"] = cs.Cs_ext_wholesale_cost
					_item["cs_ext_discount_amt"] = cs.Cs_ext_discount_amt
					_item["cs_ext_sales_price"] = cs.Cs_ext_sales_price
					_item["cs"] = cs
					_item["d_date_sk"] = d.D_date_sk
					_item["d_year"] = d.D_year
					_item["d"] = d
		...
		for _, c := range customer {
			for _, ws := range web_sales {
				...
				for _, d := range date_dim {
					...
					_item["ws_ext_list_price"] = ws.Ws_ext_list_price
					_item["ws_ext_wholesale_cost"] = ws.Ws_ext_wholesale_cost
					_item["ws_ext_discount_amt"] = ws.Ws_ext_discount_amt
					_item["ws_ext_sales_price"] = ws.Ws_ext_sales_price
					_item["ws"] = ws
					_item["d_date_sk"] = d.D_date_sk
					_item["d_year"] = d.D_year
					_item["d"] = d

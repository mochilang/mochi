	...
	ss = _convSlice[v, S](func() []S {
		...
		for _, ss := range store_sales {
			for _, d := range date_dim {
				...
				_item["s_store_sk"] = ss.S_store_sk
	...
	sr = _convSlice[v, Sr](func() []Sr {
		...
		for _, sr := range store_returns {
			for _, d := range date_dim {
				...
				_item := map[string]any{}
				_item["sr_returned_date_sk"] = sr.Sr_returned_date_sk
				_item["s_store_sk"] = sr.S_store_sk
				_item["sr_return_amt"] = sr.Sr_return_amt
				_item["sr_net_loss"] = sr.Sr_net_loss
				_item["sr"] = sr
				_item["d_date_sk"] = d.D_date_sk
				_item["d_date"] = d.D_date
				_item["d"] = d
	...
	cs = _convSlice[v, C](func() []C {
		...
		for _, cs := range catalog_sales {
			for _, d := range date_dim {
				...
				_item["cs_net_profit"] = cs.Cs_net_profit
				_item["cs"] = cs
				_item["d_date_sk"] = d.D_date_sk
				_item["d_date"] = d.D_date
				_item["d"] = d
	...
	cr = _convSlice[v, Cr](func() []Cr {
		...
		for _, cr := range catalog_returns {
			for _, d := range date_dim {
				...
				_item["cr_return_amount"] = cr.Cr_return_amount
	...
	ws = _convSlice[v, W](func() []W {
		...
		for _, ws := range web_sales {
			for _, d := range date_dim {
				...
				_item["ws_web_page_sk"] = ws.Ws_web_page_sk
				_item["ws_ext_sales_price"] = ws.Ws_ext_sales_price
				_item["ws_net_profit"] = ws.Ws_net_profit
				_item["ws"] = ws
				_item["d_date_sk"] = d.D_date_sk
				_item["d_date"] = d.D_date
				_item["d"] = d
	...
	wr = _convSlice[v, Wr](func() []Wr {
		...
		for _, wr := range web_returns {
			for _, d := range date_dim {
				...
				_item["wr_web_page_sk"] = wr.Wr_web_page_sk
				_item["wr_return_amt"] = wr.Wr_return_amt
				_item["wr_net_loss"] = wr.Wr_net_loss
				_item["wr"] = wr
				_item["d_date_sk"] = d.D_date_sk
				_item["d_date"] = d.D_date
				_item["d"] = d

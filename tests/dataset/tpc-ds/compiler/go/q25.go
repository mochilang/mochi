								...
								for _, s := range store {
									...
									for _, i := range item {
										...
										if (((((d1.D_moy == 4) && (d1.D_year == 2000)) && (d2.D_moy >= 4)) && (d2.D_moy <= 10)) && (d3.D_moy >= 4)) && (d3.D_moy <= 10) {
											...
											_item["sr_item_sk"] = sr.Sr_item_sk
											_item["sr_customer_sk"] = sr.Sr_customer_sk
											_item["sr_ticket_number"] = sr.Sr_ticket_number

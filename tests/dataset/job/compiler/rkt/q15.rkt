...
(define rows (for*/list ([t title] [at aka_title] [mi movie_info] [mk movie_keyword] [mc movie_companies] [k keyword] [it1 info_type] [cn company_name] [ct company_type] #:when (and (equal? (hash-ref at 'movie_id) (hash-ref t 'id)) (equal? (hash-ref mi 'movie_id) (hash-ref t 'id)) (equal? (hash-ref mk 'movie_id) (hash-ref t 'id)) (equal? (hash-ref mc 'movie_id) (hash-ref t 'id)) (equal? (hash-ref k 'id) (hash-ref mk 'keyword_id)) (equal? (hash-ref it1 'id) (hash-ref mi 'info_type_id)) (equal? (hash-ref cn 'id) (hash-ref mc 'company_id)) (equal? (hash-ref ct 'id) (hash-ref mc 'company_type_id)) (and (and (and (and (and (and (and (string=? (hash-ref cn 'country_code) "[us]") (string=? (hash-ref it1 'info) "release dates")) (regexp-match? (regexp "200") (hash-ref mc 'note))) (regexp-match? (regexp "worldwide") (hash-ref mc 'note))) (regexp-match? (regexp "internet") (hash-ref mi 'note))) (regexp-match? (regexp "USA:") (hash-ref mi 'info))) (regexp-match? (regexp "200") (hash-ref mi 'info))) (> (hash-ref t 'production_year) 2000)))) (hash 'release_date (hash-ref mi 'info) 'internet_movie (hash-ref t 'title))))

...
(define matches (for*/list ([an aka_name] [n name] [ci cast_info] [chn char_name] [rt role_type] [t title] [mc movie_companies] [cn company_name] [mi movie_info] [it info_type] #:when (and (equal? (hash-ref n 'id) (hash-ref an 'person_id)) (equal? (hash-ref ci 'person_id) (hash-ref an 'person_id)) (equal? (hash-ref chn 'id) (hash-ref ci 'person_role_id)) (equal? (hash-ref rt 'id) (hash-ref ci 'role_id)) (equal? (hash-ref t 'id) (hash-ref ci 'movie_id)) (equal? (hash-ref mc 'movie_id) (hash-ref t 'id)) (equal? (hash-ref cn 'id) (hash-ref mc 'company_id)) (equal? (hash-ref mi 'movie_id) (hash-ref t 'id)) (equal? (hash-ref it 'id) (hash-ref mi 'info_type_id)) (and (and (and (and (and (and (and (and (and (and (and (cond [(string? '("(voice)" "(voice: Japanese version)" "(voice) (uncredited)" "(voice: English version)")) (regexp-match? (regexp (hash-ref ci 'note)) '("(voice)" "(voice: Japanese version)" "(voice) (uncredited)" "(voice: English version)"))] [(hash? '("(voice)" "(voice: Japanese version)" "(voice) (uncredited)" "(voice: English version)")) (hash-has-key? '("(voice)" "(voice: Japanese version)" "(voice) (uncredited)" "(voice: English version)") (hash-ref ci 'note))] [else (member (hash-ref ci 'note) '("(voice)" "(voice: Japanese version)" "(voice) (uncredited)" "(voice: English version)"))]) (string=? (hash-ref cn 'country_code) "[us]")) (string=? (hash-ref it 'info) "release dates")) (not (equal? (hash-ref mc 'note) '()))) (or (regexp-match? (regexp "(USA)") (hash-ref mc 'note)) (regexp-match? (regexp "(worldwide)") (hash-ref mc 'note)))) (not (equal? (hash-ref mi 'info) '()))) (or (and (regexp-match? (regexp "Japan:") (hash-ref mi 'info)) (regexp-match? (regexp "200") (hash-ref mi 'info))) (and (regexp-match? (regexp "USA:") (hash-ref mi 'info)) (regexp-match? (regexp "200") (hash-ref mi 'info))))) (string=? (hash-ref n 'gender) "f")) (regexp-match? (regexp "Ang") (hash-ref n 'name))) (string=? (hash-ref rt 'role) "actress")) (>= (hash-ref t 'production_year) 2005)) (<= (hash-ref t 'production_year) 2009)))) (hash 'actress (hash-ref n 'name) 'movie (hash-ref t 'title))))

...
var aka_name = [Auto1(name: "Alpha", person_id: 1), Auto1(name: "Beta", person_id: 2)]
var cast_info = [Auto2(movie_id: 101, person_id: 1), Auto2(movie_id: 102, person_id: 2)]
var company_name = [Auto3(country_code: "[us]", id: 1), Auto3(country_code: "[de]", id: 2)]
var keyword = [Auto4(id: 1, keyword: "character-name-in-title"), Auto4(id: 2, keyword: "other")]
var movie_companies = [Auto5(company_id: 1, movie_id: 101), Auto5(company_id: 2, movie_id: 102)]
var movie_keyword = [Auto6(keyword_id: 1, movie_id: 101), Auto6(keyword_id: 2, movie_id: 102)]
var name = [Auto7(id: 1), Auto7(id: 2)]
var title = [Auto8(episode_nr: 60, id: 101, title: "Hero Bob"), Auto8(episode_nr: 40, id: 102, title: "Other Show")]
var rows = ({
	var _res: [[String:Any]] = []
	for an in aka_name {
		for n in name {
...
_json(result)
expect(_equal(result, [Auto9(cool_actor_pseudonym: "Alpha", series_named_after_char: "Hero Bob")]))

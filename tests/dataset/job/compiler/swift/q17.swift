...
var cast_info = [Auto1(movie_id: 1, person_id: 1), Auto1(movie_id: 2, person_id: 2)]
var company_name = [Auto2(country_code: "[us]", id: 1), Auto2(country_code: "[ca]", id: 2)]
var keyword = [Auto3(id: 10, keyword: "character-name-in-title"), Auto3(id: 20, keyword: "other")]
var movie_companies = [Auto4(company_id: 1, movie_id: 1), Auto4(company_id: 2, movie_id: 2)]
var movie_keyword = [Auto5(keyword_id: 10, movie_id: 1), Auto5(keyword_id: 20, movie_id: 2)]
var name = [Auto6(id: 1, name: "Bob Smith"), Auto6(id: 2, name: "Alice Jones")]
var title = [Auto7(id: 1, title: "Bob's Journey"), Auto7(id: 2, title: "Foreign Film")]
var matches = ({
	var _res: [String] = []
	for n in name {
		for ci in cast_info {

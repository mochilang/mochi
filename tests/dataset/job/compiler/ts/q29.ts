// Generated by Mochi compiler v0.10.25 on 2025-07-15T03:13:51Z
                                      ...
                                      if (
                                        !((((((((((((((((((((((((((((((((((((((((((_equal(
                                          ...
                                          _equal(
                                            cct2.kind,
                                            "complete+verified",
                                          )) && _equal(chn.name, "Queen")) &&
                                          ((_equal(ci.note, "(voice)") ||
                                            _equal(
                                              ci.note,
                                              "(voice) (uncredited)",
                                            )) ||
                                          ...
                                          _equal(ci.movie_id, cc.movie_id)) &&
                                          ...
                                          _equal(n.id, pi.person_id)) &&
                                          _equal(ci.person_id, pi.person_id)) &&
                                          _equal(it3.id, pi.info_type_id)) &&
                                          _equal(k.id, mk.keyword_id)) &&
                                          _equal(cct1.id, cc.subject_id)) &&
                                          _equal(cct2.id, cc.status_id))
                                      ) continue;
                                      _res.push({

// Generated by Mochi compiler v0.10.25 on 2025-07-13T11:49:41Z
// Source: tests/dataset/job/q1.mochi
        ...
        for (const t of title) {
          ...
          for (const mi of movie_info_idx) {
            ...
            for (const it of info_type) {
              if (!(_equal(it.id, mi.info_type_id))) continue;
              if (
                !(((_equal(ct.kind, "production companies") &&
                  _equal(it.info, "top 250 rank")) &&

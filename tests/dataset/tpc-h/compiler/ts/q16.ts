// Generated by Mochi compiler v0.10.25 on 2025-07-13T16:34:17Z
...
function main(): void {
  ...
  excluded_suppliers = (() => {
    ...
    for (const ps of _src) {
      for (const p of part) {
        if (!(_equal(p.p_partkey, ps.ps_partkey))) continue;
        if (
          !((_equal(p.p_brand, "Brand#12") && p.p_type.includes("SMALL")) &&
            _equal(p.p_size, 5))
        ) continue;

# Generated by Mochi compiler v0.10.25 on 2025-07-13T14:08:32Z
defmodule Main do
  def main do
    # nation :: list(map())
      ...
      (fn ->
         ...
         rows =
           _query(
             ...
             %{
               select: fn s, l1, o, n -> %{s: s, l1: l1, o: o, n: n} end,
               where: fn [s, l1, o, n] ->
         ...
         Enum.map(items, fn g -> %{s_name: g.key, numwait: _count(g)} end)
       end).()

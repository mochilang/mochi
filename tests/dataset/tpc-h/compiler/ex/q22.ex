# Generated by Mochi compiler v0.10.28 on 2025-07-18T03:25:40Z
defmodule Main do
  ...
  def main do
        ...
        for c <- customer,
            c.c_acctbal > 0 &&
              if(is_map(@valid_codes),
                do: Map.has_key?(@valid_codes, String.slice(c.c_phone, 0, 2 - 0)),
                else: Enum.member?(@valid_codes, String.slice(c.c_phone, 0, 2 - 0))
              ),
            do: c.c_acctbal
      ) /
        Enum.count(
    ...
    eligible_customers =
      for c <- customer,
          ...
          do: %{cntrycode: String.slice(c.c_phone, 0, 2 - 0), c_acctbal: c.c_acctbal}

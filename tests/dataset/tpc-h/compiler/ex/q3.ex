# Generated by Mochi Elixir compiler v0.10.24 on 2006-01-02T15:04:05Z
defmodule Main do
  @cutoff "1995-03-15"
  @segment "BUILDING"
  def main do
      ...
      (fn ->
         ...
         items =
           Enum.sort_by(items, fn g ->
             [
               -_sum(for r <- g.items, do: r.l.l_extendedprice * (1 - r.l.l_discount)),
               g.key.o_orderdate
             ]
           end)
         ...
         Enum.map(items, fn g ->
           %{
             ...
             revenue: _sum(for r <- g.items, do: r.l.l_extendedprice * (1 - r.l.l_discount)),

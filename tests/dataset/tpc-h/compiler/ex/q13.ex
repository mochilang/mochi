# Generated by Mochi compiler v0.10.25 on 2025-07-13T14:08:19Z
defmodule Main do
  def main do
    # customer :: list(map())
      ...
      for c <- customer,
          do: %{
            c_count:
              _count(
                for o <- orders,
                    o.o_custkey == c.c_custkey && !String.contains?(o.o_comment, "special") &&
                      !String.contains?(o.o_comment, "requests"),
                    do: o
              )
          }
    ...
    grouped =
      (fn ->
         ...
         Enum.map(items, fn g -> %{c_count: g.key, custdist: _count(g)} end)
       end).()

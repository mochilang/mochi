# Generated by Mochi compiler v0.10.25 on 2025-07-14T07:13:57Z
...
filtered = _query(
    ...
    [{"items": part, "on": lambda l, p: p["p_partkey"] == l["l_partkey"]}],
    {
        ...
        "where": lambda l, p: l["l_shipdate"] >= start_date
        and l["l_shipdate"] < end_date,
    },
)
promo_sum = _sum([x.revenue for x in filtered if x.is_promo])
total_sum = _sum([x.revenue for x in filtered])

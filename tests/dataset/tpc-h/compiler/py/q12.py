# Generated by Mochi compiler v0.10.25 on 2025-07-14T07:14:20Z
...
def _q0():
    ...
    return [
        Auto1(
            ...
            high_line_count=sum(
                [
                    1 if _get(x[1], "o_orderpriority") in ["1-URGENT", "2-HIGH"] else 0
                    for x in g
                ]
            ),
            low_line_count=sum(
                [
                    (
                        1
                        if not _get(x[1], "o_orderpriority") in ["1-URGENT", "2-HIGH"]
                        else 0
                    )
                    for x in g
                ]

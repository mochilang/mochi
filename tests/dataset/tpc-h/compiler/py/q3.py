# Generated by Mochi compiler v0.10.25 on 2025-07-14T07:14:14Z
...
building_customers: list[dict[str, object]] = [
    c for c in customer if c.c_mktsegment == segment
]
valid_orders: list[dict[str, object]] = _query(
    orders,
    [{"items": building_customers, "on": lambda o, c: o.o_custkey == c["c_custkey"]}],
    {"select": lambda o, c: o, "where": lambda o, c: o.o_orderdate < cutoff},
)
valid_lineitems: list[dict[str, object]] = [
    l for l in lineitem if l.l_shipdate > cutoff
]
...
order_line_join: list[Auto1] = _q0()

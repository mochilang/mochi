# Generated by Mochi compiler v0.10.25 on 2025-07-13T06:12:09Z
        ...
        "c_count": len(
            [
                ...
                if (
                    ...
                    and (not "special" in o["o_comment"])
                )
...
def _q0():
    ...
    return [{"c_count": _get(g, "key"), "custdist": len(g.Items)} for g in _items1]

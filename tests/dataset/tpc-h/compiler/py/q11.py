# Generated by Mochi compiler v0.10.25 on 2025-07-14T07:13:51Z
...
def _q0():
    ...
    _items1 = _groups
    return [Auto3(ps_partkey=g.key, value=_sum([r.value for r in g])) for g in _items1]

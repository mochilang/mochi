# Generated by Mochi compiler v0.10.25 on 2025-07-13T05:04:59Z
...
def _q0():
    ...
    _rows = _query(
        ...
        [
            ...
            {
                "items": orders,
                "on": lambda l, p, s, o: o["o_orderkey"] == l["l_orderkey"],
            },
            {
                "items": customer,
                "on": lambda l, p, s, o, c: c["c_custkey"] == o["o_custkey"],
            },
            {
                "items": nation,
    ...
    _groups = _group_by(
        _rows, lambda l, p, s, o, c, n, r: _slice(o["o_orderdate"], 0, 4)
    )
    _items1 = _groups
    _items1 = sorted(_items1, key=lambda year: _sort_key(_get(year, "key")))
    return [
        {
            "o_year": _get(year, "key"),
            "mkt_share": _sum(
                [
                    (

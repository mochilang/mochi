# Generated by Mochi compiler v0.10.25 on 2025-07-14T07:14:23Z
...
def _q0():
    ...
    _rows = _query(
        ...
        {
            "select": lambda l: l,
            "where": lambda l: l.l_shipdate >= start_date and l.l_shipdate < end_date,
        },
    )
    ...
    return [
        Auto2(
            supplier_no=g.key,
            total_revenue=_sum([x.l_extendedprice * (1 - x.l_discount) for x in g]),
        )
        for g in _items1
    ]


revenue0: list[Auto2] = _q0()
revenues: list[object] = [x.total_revenue for x in revenue0]

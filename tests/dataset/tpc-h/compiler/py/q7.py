# Generated by Mochi compiler v0.10.24 on 2025-07-13T04:20:30Z
...
def _q0():
    ...
    _rows = _query(
        ...
        [
            ...
            {
                "items": supplier,
                "on": lambda l, o, c, s: s["s_suppkey"] == l["l_suppkey"],
            },
            {
                "items": nation,
    ...
    _groups = _group_by(
        _rows,
        lambda l, o, c, s, n1, n2: {
            "supp_nation": n1["n_name"],
            "cust_nation": n2["n_name"],
            "l_year": _slice(l["l_shipdate"], 0, 4),
        },
    )
    _items1 = _groups
    _items1 = sorted(
        ...
        key=lambda g: _sort_key(
            [
                _get(_get(g, "key"), "supp_nation"),
                _get(_get(g, "key"), "cust_nation"),
                _get(_get(g, "key"), "l_year"),
            ]
        ),
    )
    return [
        {
            "supp_nation": _get(_get(g, "key"), "supp_nation"),
            "cust_nation": _get(_get(g, "key"), "cust_nation"),
            "l_year": _get(_get(g, "key"), "l_year"),
            "revenue": _sum(
                [x[0]["l_extendedprice"] * (1 - x[0]["l_discount"]) for x in g]
            ),
        }
        for g in _items1
    ]

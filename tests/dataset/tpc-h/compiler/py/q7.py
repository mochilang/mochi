...
supplier: list[Supplier] = [Supplier(s_suppkey=100, s_nationkey=1)]
customer: list[Customer] = [Customer(c_custkey=200, c_nationkey=2)]
orders: list[Order] = [Order(o_orderkey=1000, o_custkey=200)]

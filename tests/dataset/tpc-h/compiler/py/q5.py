# Generated by Mochi compiler v0.10.24 on 2025-07-13T04:20:28Z
...
lineitem = [
    Lineitem(l_orderkey=1000, l_suppkey=100, l_extendedprice=1000, l_discount=0.05),
    Lineitem(l_orderkey=2000, l_suppkey=200, l_extendedprice=800, l_discount=0.1),
    Lineitem(l_orderkey=3000, l_suppkey=200, l_extendedprice=900, l_discount=0.05),
]
asia_nations = _query(
    region,
...
local_customer_supplier_orders = _query(
    ...
    [
        {
            "items": asia_nations,
            "on": lambda c, n: c["c_nationkey"] == n["n_nationkey"],
        },
        {"items": orders, "on": lambda c, n, o: o["o_custkey"] == c["c_custkey"]},
        {
            "items": lineitem,
            "on": lambda c, n, o, l: l["l_orderkey"] == o["o_orderkey"],
        },
        {
            "items": supplier,
            "on": lambda c, n, o, l, s: s["s_suppkey"] == l["l_suppkey"],
        },
    ],
    {
        "select": lambda c, n, o, l, s: {
            "nation": n["n_name"],
...
def _q0():
    ...
    _items1 = _groups
    _items1 = sorted(_items1, key=lambda g: _sort_key(-_sum([x["revenue"] for x in g])))
    return [
        {"n_name": _get(g, "key"), "revenue": _sum([x["revenue"] for x in g])}
        for g in _items1
    ]

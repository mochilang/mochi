# Generated by Mochi compiler v0.10.25 on 2025-07-14T07:14:15Z
...
region: list[Region] = [
    Region(r_regionkey=0, r_name="ASIA"),
...
def _q0():
    ...
    return [Auto1(n_name=g.key, revenue=_sum([x.revenue for x in g])) for g in _items1]

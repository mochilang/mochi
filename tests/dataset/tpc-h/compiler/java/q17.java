// Generated by Mochi compiler v0.10.25 on 2025-07-13T17:38:13Z
// q17.mochi
import java.util.*;

class PPartkeyPBrandPContainer {
    int p_partkey;
    String p_brand;
    String p_container;
    PPartkeyPBrandPContainer(int p_partkey, String p_brand, String p_container) {
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof PPartkeyPBrandPContainer other)) return false;
...
class LPartkeyLQuantityLExtendedprice {
    int l_partkey;
    int l_quantity;
    double l_extendedprice;
    LPartkeyLQuantityLExtendedprice(int l_partkey, int l_quantity, double l_extendedprice) {
    ...
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof LPartkeyLQuantityLExtendedprice other)) return false;
...
public class Q17 {
    ...
    List<PPartkeyPBrandPContainer> part = new ArrayList<>(Arrays.asList(new PPartkeyPBrandPContainer(1, "Brand#23", "MED BOX"), new PPartkeyPBrandPContainer(2, "Brand#77", "LG JAR")));
    List<LPartkeyLQuantityLExtendedprice> lineitem = new ArrayList<>(Arrays.asList(new LPartkeyLQuantityLExtendedprice(1, 1, 100.000000), new LPartkeyLQuantityLExtendedprice(1, 10, 1000.000000), new LPartkeyLQuantityLExtendedprice(1, 20, 2000.000000), new LPartkeyLQuantityLExtendedprice(2, 5, 500.000000)));

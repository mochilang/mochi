// Generated by Mochi compiler v0.10.25 on 2025-07-13T17:39:07Z
// q19.mochi
import java.util.*;

class PPartkeyPBrandPContainerPSize {
    int p_partkey;
    String p_brand;
    String p_container;
    int p_size;
    PPartkeyPBrandPContainerPSize(int p_partkey, String p_brand, String p_container, int p_size) {
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof PPartkeyPBrandPContainerPSize other)) return false;
...
class LPartkeyLQuantityLExtendedpriceLDiscountLShipmodeLShipinstruct {
    int l_partkey;
    int l_quantity;
    ...
    LPartkeyLQuantityLExtendedpriceLDiscountLShipmodeLShipinstruct(int l_partkey, int l_quantity, double l_extendedprice, double l_discount, String l_shipmode, String l_shipinstruct) {
    ...
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof LPartkeyLQuantityLExtendedpriceLDiscountLShipmodeLShipinstruct other)) return false;
...
public class Q19 {
    ...
    List<PPartkeyPBrandPContainerPSize> part = new ArrayList<>(Arrays.asList(new PPartkeyPBrandPContainerPSize(1, "Brand#12", "SM BOX", 3), new PPartkeyPBrandPContainerPSize(2, "Brand#23", "MED BOX", 5), new PPartkeyPBrandPContainerPSize(3, "Brand#34", "LG BOX", 15)));
    List<LPartkeyLQuantityLExtendedpriceLDiscountLShipmodeLShipinstruct> lineitem = new ArrayList<>(Arrays.asList(new LPartkeyLQuantityLExtendedpriceLDiscountLShipmodeLShipinstruct(1, 5, 1000.000000, 0.100000, "AIR", "DELIVER IN PERSON"), new LPartkeyLQuantityLExtendedpriceLDiscountLShipmodeLShipinstruct(2, 15, 2000.000000, 0.050000, "AIR REG", "DELIVER IN PERSON"), new LPartkeyLQuantityLExtendedpriceLDiscountLShipmodeLShipinstruct(3, 35, 1500.000000, 0.000000, "AIR", "DELIVER IN PERSON")));

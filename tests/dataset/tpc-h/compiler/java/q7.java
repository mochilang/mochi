...
class LOrderkeyLSuppkeyLExtendedpriceLDiscountLShipdate {
    int l_orderkey;
    int l_suppkey;
    double l_extendedprice;
    double l_discount;
    String l_shipdate;
    LOrderkeyLSuppkeyLExtendedpriceLDiscountLShipdate(int l_orderkey, int l_suppkey, double l_extendedprice, double l_discount, String l_shipdate) {
    ...
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof LOrderkeyLSuppkeyLExtendedpriceLDiscountLShipdate other)) return false;
...
class LOCSN1N2 {
    LOrderkeyLSuppkeyLExtendedpriceLDiscountLShipdate l;
    OOrderkeyOCustkey o;
    CCustkeyCNationkey c;
    SSuppkeySNationkey s;
    NNationkeyNName n1;
    NNationkeyNName n2;
    LOCSN1N2(LOrderkeyLSuppkeyLExtendedpriceLDiscountLShipdate l, OOrderkeyOCustkey o, CCustkeyCNationkey c, SSuppkeySNationkey s, NNationkeyNName n1, NNationkeyNName n2) {
        this.l = l;
        this.o = o;
        this.c = c;
        this.s = s;
    ...
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof LOCSN1N2 other)) return false;
...
public class Q7 {
    ...
    List<NNationkeyNName> nation = new ArrayList<>(Arrays.asList(new NNationkeyNName(1, "FRANCE"), new NNationkeyNName(2, "GERMANY")));
    List<SSuppkeySNationkey> supplier = new ArrayList<>(Arrays.asList(new SSuppkeySNationkey(100, 1)));
    List<CCustkeyCNationkey> customer = new ArrayList<>(Arrays.asList(new CCustkeyCNationkey(200, 2)));
    List<OOrderkeyOCustkey> orders = new ArrayList<>(Arrays.asList(new OOrderkeyOCustkey(1000, 200)));
    List<LOrderkeyLSuppkeyLExtendedpriceLDiscountLShipdate> lineitem = new ArrayList<>(Arrays.asList(new LOrderkeyLSuppkeyLExtendedpriceLDiscountLShipdate(1000, 100, 1000.000000, 0.100000, "1995-06-15"), new LOrderkeyLSuppkeyLExtendedpriceLDiscountLShipdate(1000, 100, 800.000000, 0.050000, "1997-01-01")));
    ...
    Map<SuppNationCustNationLYear,List<LOCSN1N2>> groups1 = new LinkedHashMap<>();
    for (var l : lineitem) {
        for (var o : orders) {
    ...
    for (Map.Entry<SuppNationCustNationLYear,List<LOCSN1N2>> __e : groups1.entrySet()) {
        SuppNationCustNationLYear g_key = __e.getKey();
        Group<SuppNationCustNationLYear,LOCSN1N2> g = new Group<>(g_key, __e.getValue());

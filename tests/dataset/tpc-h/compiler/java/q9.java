// Generated by Mochi compiler v0.10.26 on 2025-07-15T08:19:36Z
// q9.mochi
import java.util.*;
...
class OOrderkeyOOrderdate {
    int o_orderkey;
    String o_orderdate;
    OOrderkeyOOrderdate(int o_orderkey, String o_orderdate) {
        this.o_orderkey = o_orderkey;
        this.o_orderdate = o_orderdate;
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof OOrderkeyOOrderdate other)) return false;
...
class LOrderkeyLPartkeyLSuppkeyLQuantityLExtendedpriceLDiscount {
    int l_orderkey;
    int l_partkey;
    int l_suppkey;
    int l_quantity;
    ...
    double l_discount;
    LOrderkeyLPartkeyLSuppkeyLQuantityLExtendedpriceLDiscount(int l_orderkey, int l_partkey, int l_suppkey, int l_quantity, double l_extendedprice, double l_discount) {
    ...
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof LOrderkeyLPartkeyLSuppkeyLQuantityLExtendedpriceLDiscount other)) return false;
...
class LPSPsON {
    LOrderkeyLPartkeyLSuppkeyLQuantityLExtendedpriceLDiscount l;
    PPartkeyPName p;
    SSuppkeySNationkey s;
    PsPartkeyPsSuppkeyPsSupplycost ps;
    OOrderkeyOOrderdate o;
    NNationkeyNName n;
    LPSPsON(LOrderkeyLPartkeyLSuppkeyLQuantityLExtendedpriceLDiscount l, PPartkeyPName p, SSuppkeySNationkey s, PsPartkeyPsSuppkeyPsSupplycost ps, OOrderkeyOOrderdate o, NNationkeyNName n) {
        this.l = l;
        this.p = p;
        this.s = s;
        this.ps = ps;
    ...
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof LPSPsON other)) return false;
...
public class Q9 {
    ...
    List<NNationkeyNName> nation = new ArrayList<>(Arrays.asList(new NNationkeyNName(1, "BRAZIL"), new NNationkeyNName(2, "CANADA")));
    List<SSuppkeySNationkey> supplier = new ArrayList<>(Arrays.asList(new SSuppkeySNationkey(100, 1), new SSuppkeySNationkey(200, 2)));
    List<PPartkeyPName> part = new ArrayList<>(Arrays.asList(new PPartkeyPName(1000, "green metal box"), new PPartkeyPName(2000, "red plastic crate")));
    List<PsPartkeyPsSuppkeyPsSupplycost> partsupp = new ArrayList<>(Arrays.asList(new PsPartkeyPsSuppkeyPsSupplycost(1000, 100, 10.000000), new PsPartkeyPsSuppkeyPsSupplycost(1000, 200, 8.000000)));
    List<OOrderkeyOOrderdate> orders = new ArrayList<>(Arrays.asList(new OOrderkeyOOrderdate(1, "1995-02-10"), new OOrderkeyOOrderdate(2, "1997-01-01")));
    List<LOrderkeyLPartkeyLSuppkeyLQuantityLExtendedpriceLDiscount> lineitem = new ArrayList<>(Arrays.asList(new LOrderkeyLPartkeyLSuppkeyLQuantityLExtendedpriceLDiscount(1, 1000, 100, 5, 1000.000000, 0.100000), new LOrderkeyLPartkeyLSuppkeyLQuantityLExtendedpriceLDiscount(2, 1000, 200, 10, 800.000000, 0.050000)));
    String prefix = "green";
    ...
    Map<NationOYear,List<LPSPsON>> groups1 = new LinkedHashMap<>();
    for (var l : lineitem) {
        for (var p : part) {
    ...
    for (Map.Entry<NationOYear,List<LPSPsON>> __e : groups1.entrySet()) {
        NationOYear g_key = __e.getKey();
        Group<NationOYear,LPSPsON> g = new Group<>(g_key, __e.getValue());

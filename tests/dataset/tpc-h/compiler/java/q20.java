// Generated by Mochi compiler v0.10.25 on 2025-07-13T17:39:17Z
// q20.mochi
import java.util.*;
...
class SSuppkeySNameSAddressSNationkey {
    int s_suppkey;
    String s_name;
    String s_address;
    int s_nationkey;
    SSuppkeySNameSAddressSNationkey(int s_suppkey, String s_name, String s_address, int s_nationkey) {
    ...
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof SSuppkeySNameSAddressSNationkey other)) return false;
...
class PPartkeyPName {
    int p_partkey;
    String p_name;
    PPartkeyPName(int p_partkey, String p_name) {
        this.p_partkey = p_partkey;
        this.p_name = p_name;
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof PPartkeyPName other)) return false;
...
class PsPartkeyPsSuppkeyPsAvailqty {
    int ps_partkey;
    int ps_suppkey;
    int ps_availqty;
    PsPartkeyPsSuppkeyPsAvailqty(int ps_partkey, int ps_suppkey, int ps_availqty) {
    ...
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof PsPartkeyPsSuppkeyPsAvailqty other)) return false;
...
class LPartkeyLSuppkeyLQuantityLShipdate {
    int l_partkey;
    int l_suppkey;
    int l_quantity;
    String l_shipdate;
    LPartkeyLSuppkeyLQuantityLShipdate(int l_partkey, int l_suppkey, int l_quantity, String l_shipdate) {
    ...
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof LPartkeyLSuppkeyLQuantityLShipdate other)) return false;
...
class PartkeySuppkey {
    int partkey;
    int suppkey;
    PartkeySuppkey(int partkey, int suppkey) {
        this.partkey = partkey;
        this.suppkey = suppkey;
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof PartkeySuppkey other)) return false;
...
class SNameSAddress {
    String s_name;
    String s_address;
    SNameSAddress(String s_name, String s_address) {
        this.s_name = s_name;
        this.s_address = s_address;
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof SNameSAddress other)) return false;
...
public class Q20 {
    ...
    List<NNationkeyNName> nation = new ArrayList<>(Arrays.asList(new NNationkeyNName(1, "CANADA"), new NNationkeyNName(2, "GERMANY")));
    List<SSuppkeySNameSAddressSNationkey> supplier = new ArrayList<>(Arrays.asList(new SSuppkeySNameSAddressSNationkey(100, "Maple Supply", "123 Forest Lane", 1), new SSuppkeySNameSAddressSNationkey(200, "Berlin Metals", "456 Iron Str", 2)));
    List<PPartkeyPName> part = new ArrayList<>(Arrays.asList(new PPartkeyPName(10, "forest glade bricks"), new PPartkeyPName(20, "desert sand paper")));
    List<PsPartkeyPsSuppkeyPsAvailqty> partsupp = new ArrayList<>(Arrays.asList(new PsPartkeyPsSuppkeyPsAvailqty(10, 100, 100), new PsPartkeyPsSuppkeyPsAvailqty(20, 200, 30)));
    List<LPartkeyLSuppkeyLQuantityLShipdate> lineitem = new ArrayList<>(Arrays.asList(new LPartkeyLSuppkeyLQuantityLShipdate(10, 100, 100, "1994-05-15"), new LPartkeyLSuppkeyLQuantityLShipdate(10, 100, 50, "1995-01-01")));
    ...
    Map<PartkeySuppkey,List<LPartkeyLSuppkeyLQuantityLShipdate>> groups1 = new LinkedHashMap<>();
    for (var l : lineitem) {
        ...
        var row2 = l;
        PartkeySuppkey key3 = new PartkeySuppkey(l.l_partkey, l.l_suppkey);
        List<LPartkeyLSuppkeyLQuantityLShipdate> bucket4 = groups1.get(key3);
        if (bucket4 == null) { bucket4 = new ArrayList<>(); groups1.put(key3, bucket4); }
        bucket4.add(row2);
    }
    for (Map.Entry<PartkeySuppkey,List<LPartkeyLSuppkeyLQuantityLShipdate>> __e : groups1.entrySet()) {
        PartkeySuppkey g_key = __e.getKey();
        Group<PartkeySuppkey,LPartkeyLSuppkeyLQuantityLShipdate> g = new Group<>(g_key, __e.getValue());
    ...
    List<SNameSAddress> result = (new java.util.function.Supplier<List<SNameSAddress>>(){public List<SNameSAddress> get(){
    List<SNameSAddress> res7 = new ArrayList<>();
    for (var s : supplier) {
        for (var n : nation) {
            if (!(n.n_nationkey == s.s_nationkey)) continue;
            if (!(target_partkeys.contains(s.s_suppkey) && Objects.equals(n.n_name, "CANADA"))) continue;
            res7.add(new SNameSAddress(s.s_name, s.s_address));
        }
    }
    return res7;
}}).get();
    json(result);
    if (!(Objects.equals(result, Arrays.asList(new SNameSAddress("Maple Supply", "123 Forest Lane"))))) throw new AssertionError("expect failed");
    }
}

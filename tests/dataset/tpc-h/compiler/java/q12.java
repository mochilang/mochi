// Generated by Mochi compiler v0.10.25 on 2025-07-13T16:56:28Z
// q12.mochi
import java.util.*;

class OOrderkeyOOrderpriority {
    int o_orderkey;
    String o_orderpriority;
    OOrderkeyOOrderpriority(int o_orderkey, String o_orderpriority) {
        this.o_orderkey = o_orderkey;
        this.o_orderpriority = o_orderpriority;
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof OOrderkeyOOrderpriority other)) return false;
...
class LOrderkeyLShipmodeLCommitdateLReceiptdateLShipdate {
    int l_orderkey;
    String l_shipmode;
    String l_commitdate;
    String l_receiptdate;
    String l_shipdate;
    LOrderkeyLShipmodeLCommitdateLReceiptdateLShipdate(int l_orderkey, String l_shipmode, String l_commitdate, String l_receiptdate, String l_shipdate) {
    ...
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof LOrderkeyLShipmodeLCommitdateLReceiptdateLShipdate other)) return false;
...
class LO {
    LOrderkeyLShipmodeLCommitdateLReceiptdateLShipdate l;
    OOrderkeyOOrderpriority o;
    LO(LOrderkeyLShipmodeLCommitdateLReceiptdateLShipdate l, OOrderkeyOOrderpriority o) {
        this.l = l;
        this.o = o;
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof LO other)) return false;
...
public class Q12 {
    ...
    List<OOrderkeyOOrderpriority> orders = new ArrayList<>(Arrays.asList(new OOrderkeyOOrderpriority(1, "1-URGENT"), new OOrderkeyOOrderpriority(2, "3-MEDIUM")));
    List<LOrderkeyLShipmodeLCommitdateLReceiptdateLShipdate> lineitem = new ArrayList<>(Arrays.asList(new LOrderkeyLShipmodeLCommitdateLReceiptdateLShipdate(1, "MAIL", "1994-02-10", "1994-02-15", "1994-02-05"), new LOrderkeyLShipmodeLCommitdateLReceiptdateLShipdate(2, "SHIP", "1994-03-01", "1994-02-28", "1994-02-27")));
    ...
    Map<String,List<LO>> groups1 = new LinkedHashMap<>();
    for (var l : lineitem) {
        for (var o : orders) {
            ...
            List<LO> bucket4 = groups1.get(key3);
            if (bucket4 == null) { bucket4 = new ArrayList<>(); groups1.put(key3, bucket4); }
            bucket4.add(row2);
        }
    }
    for (Map.Entry<String,List<LO>> __e : groups1.entrySet()) {
        String g_key = __e.getKey();
        Group<String,LO> g = new Group<>(g_key, __e.getValue());
    ...
    for (var x : g) {
        res6.add((!(Arrays.asList("1-URGENT", "2-HIGH").contains(x.o.o_orderpriority)) ? 1 : 0));
    }
    return res6;

-- Generated by Mochi compiler v0.10.25 on 2025-07-13T10:00:35Z
_Group = {}
...
function test_Q15_returns_top_revenue_supplier_s__for_Q1_1996()
    ...
    if not (__eq(result, {{["s_suppkey"]=100, ["s_name"]="Best Supplier", ["s_address"]="123 Market St", ["s_phone"]="123-456", ["total_revenue"]=rev}})) then error('expect failed') end
end
...
result = (function()
    local _src = supplier
    return __query(_src, {
        { items = revenue0, on = function(s, r) return __eq(s.s_suppkey, r.supplier_no) end }
    }, { selectFn = function(s, r) return {["s_suppkey"]=s.s_suppkey, ["s_name"]=s.s_name, ["s_address"]=s.s_address, ["s_phone"]=s.s_phone, ["total_revenue"]=r.total_revenue} end, where = function(s, r) return (__eq(r.total_revenue, max_revenue)) end, sortKey = function(s, r) return (s.s_suppkey) end })
end)()
__json(result)
local __tests = {

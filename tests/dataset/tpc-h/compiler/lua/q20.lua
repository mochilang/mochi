...
result = (function()
    ...
    }, { selectFn = function(s, n) return {["s_name"]=s.s_name, ["s_address"]=s.s_address} end, where = function(s, n) return ((__contains(target_partkeys, s.s_suppkey) and __eq(n.n_name, "CANADA"))) end, sortKey = function(s, n) return (s.s_name) end })
end)()
__json(result)
local __tests = {

...
function test_Q7_computes_revenue_between_FRANCE_and_GERMANY_by_year()
    if not (__eq(result, {{["supp_nation"]="FRANCE", ["cust_nation"]="GERMANY", ["l_year"]="1995", ["revenue"]=900.0}})) then error('expect failed') end
end
...
result = (function()
    ...
    local _rows = __query(_src, {
        { items = orders, on = function(l, o) return __eq(o.o_orderkey, l.l_orderkey) end },
        { items = customer, on = function(l, o, c) return __eq(c.c_custkey, o.o_custkey) end },
        { items = supplier, on = function(l, o, c, s) return __eq(s.s_suppkey, l.l_suppkey) end },
        { items = nation, on = function(l, o, c, s, n1) return __eq(n1.n_nationkey, s.s_nationkey) end },
        { items = nation, on = function(l, o, c, s, n1, n2) return __eq(n2.n_nationkey, c.c_nationkey) end }
    }, { selectFn = function(l, o, c, s, n1, n2) return {l, o, c, s, n1, n2} end, where = function(l, o, c, s, n1, n2) return ((((((l.l_shipdate >= start_date) and (l.l_shipdate <= end_date)) and ((__eq(n1.n_name, nation1) and __eq(n2.n_name, nation2)))) or ((__eq(n1.n_name, nation2) and __eq(n2.n_name, nation1)))))) end })

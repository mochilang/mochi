...
function test_Q10_returns_customer_revenue_from_returned_items()
    if not (__eq(result, {{["c_custkey"]=1, ["c_name"]="Alice", ["revenue"]=(1000.0 * 0.9), ["c_acctbal"]=100.0, ["n_name"]="BRAZIL", ["c_address"]="123 St", ["c_phone"]="123-456", ["c_comment"]="Loyal"}})) then error('expect failed') end
end

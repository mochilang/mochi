...
result = (function()
    ...
    }, { selectFn = function(s, l1, o, n) return {s, l1, o, n} end, where = function(s, l1, o, n) return ((((__eq(o.o_orderstatus, "F") and (l1.l_receiptdate > l1.l_commitdate)) and __eq(n.n_name, "SAUDI ARABIA")) and (not #(function()
    local _res = {}

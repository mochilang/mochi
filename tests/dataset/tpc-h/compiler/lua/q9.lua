-- Generated by Mochi compiler v0.10.25 on 2025-07-13T07:25:06Z
_Group = {}
...
function test_Q9_computes_profit_for_green_parts_by_nation_and_year()
    ...
    local cost = (5 * 10.0)
    if not (__eq(result, {{["nation"]="BRAZIL", ["o_year"]="1995", ["profit"]=(revenue - cost)}})) then error('expect failed') end
end
...
result = (function()
    ...
    local _rows = __query(_src, {
        ...
        { items = supplier, on = function(l, p, s) return __eq(s.s_suppkey, l.l_suppkey) end },
        { items = partsupp, on = function(l, p, s, ps) return (__eq(ps.ps_partkey, l.l_partkey) and __eq(ps.ps_suppkey, l.l_suppkey)) end },
        { items = orders, on = function(l, p, s, ps, o) return __eq(o.o_orderkey, l.l_orderkey) end },
        { items = nation, on = function(l, p, s, ps, o, n) return __eq(n.n_nationkey, s.s_nationkey) end }
    ...
    local _groups = __group_by_rows(_rows, function(l, p, s, ps, o, n) return {["nation"]=n.n_name, ["o_year"]=__slice(o.o_orderdate, 0, 4)} end, function(l, p, s, ps, o, n) local _row = __merge(l, p, s, ps, o, n); _row.l = l; _row.p = p; _row.s = s; _row.ps = ps; _row.o = o; _row.n = n; return _row end)
    local _res = {}
    for _, g in ipairs(_groups) do
        _res[#_res+1] = {["nation"]=g.key.nation, ["o_year"]=tostring(g.key.o_year), ["profit"]=__sum((function()
    local _res = {}

...
result = (function()
    ...
    }, { selectFn = function(l, p, s, ps, o, n) return {l, p, s, ps, o, n} end, where = function(l, p, s, ps, o, n) return (((((__slice(p.p_name, 0, #prefix) == prefix) and 1 or 0) and (o.o_orderdate >= start_date)) and (o.o_orderdate <= end_date))) end })

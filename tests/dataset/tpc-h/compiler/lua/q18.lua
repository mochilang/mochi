...
function test_Q18_returns_large_volume_customers_with_total_quantity___200()
    if not (__eq(result, {{["c_name"]="Alice", ["c_custkey"]=1, ["revenue"]=1700.0, ["c_acctbal"]=1000.0, ["n_name"]="GERMANY", ["c_address"]="123 Market St", ["c_phone"]="123-456", ["c_comment"]="Premium client"}})) then error('expect failed') end
end

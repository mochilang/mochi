...
revenues = (function()
    ...
    }, { selectFn = function(l, p) return (l.l_extendedprice * ((1 - l.l_discount))) end, where = function(l, p) return (((((((((((__eq(p.p_brand, "Brand#12")) and ((function(_l,_v) for _,x in ipairs(_l) do if x == _v then return true end end return false end)({"SM CASE", "SM BOX", "SM PACK", "SM PKG"},p.p_container))) and (((l.l_quantity >= 1) and (l.l_quantity <= 11)))) and (((p.p_size >= 1) and (p.p_size <= 5))))) or (((((__eq(p.p_brand, "Brand#23")) and ((function(_l,_v) for _,x in ipairs(_l) do if x == _v then return true end end return false end)({"MED BAG", "MED BOX", "MED PKG", "MED PACK"},p.p_container))) and (((l.l_quantity >= 10) and (l.l_quantity <= 20)))) and (((p.p_size >= 1) and (p.p_size <= 10)))))) or (((((__eq(p.p_brand, "Brand#34")) and ((function(_l,_v) for _,x in ipairs(_l) do if x == _v then return true end end return false end)({"LG CASE", "LG BOX", "LG PACK", "LG PKG"},p.p_container))) and (((l.l_quantity >= 20) and (l.l_quantity <= 30)))) and (((p.p_size >= 1) and (p.p_size <= 15))))))) and (function(_l,_v) for _,x in ipairs(_l) do if x == _v then return true end end return false end)({"AIR", "AIR REG"},l.l_shipmode)) and __eq(l.l_shipinstruct, "DELIVER IN PERSON"))) end })
end)()

// Generated by Mochi compiler v0.10.25 on 2025-07-13T06:19:22Z
import 'dart:convert';
            ...
            for (var n in nation) {
              ...
              for (var r in region) {
                ...
                if (!((p['p_type'] == target_type &&
                    ...
                    r['r_name'] == 'AMERICA')))
                  continue;
                var _k6 = o['o_orderdate'].toString().substring(0, 4);
                var _k6_s = jsonEncode(_k6);
                _g1.putIfAbsent(_k6_s, () => <dynamic>[]).add({
                  'l': l,
                  'p': p,
                  's': s,
                  'o': o,
                ...
                for (var x in year) {
                  _q7.add(
                    (() {
                      ...
                      if (_t == true) {
                        return (x['l']['l_extendedprice'] as num) *

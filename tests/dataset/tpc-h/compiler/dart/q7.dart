// Generated by Mochi compiler v0.10.24 on 2025-07-13T01:51:07Z
import 'dart:convert';
...
var result = (() {
  ...
  for (var entry in _g1.entries) {
    ...
    _q0.add([
      [_k4['supp_nation'], _k4['cust_nation'], _k4['l_year']],
      {
        'supp_nation': _k4['supp_nation'],
        'cust_nation': _k4['cust_nation'],
        'l_year': _k4['l_year'],
        'revenue': (() {
          var _t6 = (() {
            var _q5 = <dynamic>[];

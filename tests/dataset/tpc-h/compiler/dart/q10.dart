...
var result = (() {
  ...
  for (var entry in _g1.entries) {
    ...
    _q0.add([-_sum(g.map((x) => (x['l']['l_extendedprice'] as num) * ((1 - (x['l']['l_discount'] as num)) as num))), {'c_custkey': _k3['c_custkey'], 'c_name': _k3['c_name'], 'revenue': _sum(g.map((x) => (x['l']['l_extendedprice'] as num) * ((1 - (x['l']['l_discount'] as num)) as num))), 'c_acctbal': _k3['c_acctbal'], 'n_name': _k3['n_name'], 'c_address': _k3['c_address'], 'c_phone': _k3['c_phone'], 'c_comment': _k3['c_comment']}]);
  }

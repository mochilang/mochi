...
// Generated by Mochi compiler v0.10.28 on 2025-07-18T03:22:54Z
...
func test_Q4_returns_count_of_orders_with_late_lineitems_in_range() {
	expect(_equal(result, []map[string]any{map[string]any{"o_orderpriority": any("1-URGENT"), "order_count": any(1)}, map[string]any{"o_orderpriority": any("2-HIGH"), "order_count": any(1)}}))
}

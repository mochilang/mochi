...
// Generated by Mochi compiler v0.10.25 on 2025-07-14T12:18:46Z
		...
		for _, g := range items {
			results = append(results, Result{
				...
				Sum_disc_price: _sum(func() []any {
					results := []any{}
					for _, x := range g.Items {
						results = append(results, ((_getField(x, "l_extendedprice")).(float64) * float64((float64(1) - (_getField(x, "l_discount")).(float64)))))
					}
					return results
				}()),
				Sum_charge: _sum(func() []any {
					results := []any{}
					for _, x := range g.Items {
						results = append(results, (((_getField(x, "l_extendedprice")).(float64) * float64((float64(1) - (_getField(x, "l_discount")).(float64)))) * float64((float64(1) + (_getField(x, "l_tax")).(float64)))))
					}
					return results
				}()),

...
// Generated by Mochi compiler v0.10.25 on 2025-07-15T02:43:20Z
	...
	result = func() []Result {
		...
		for _, g := range items {
			results = append(results, Result{
				...
				Sum_base_price: _sum(func() []float64 {
					results := []float64{}
					for _, xRaw := range g.Items {
						x := xRaw.(Lineitem)
				...
				Sum_disc_price: _sum(func() []float64 {
					results := []float64{}
					for _, xRaw := range g.Items {
						x := xRaw.(Lineitem)

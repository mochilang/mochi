// Generated by Mochi compiler v0.10.26 on 2025-07-15T08:19:02Z
using System;
...
class Program
{
    ...
    static void Main()
    {
        var lineitem = new List<dynamic> { new Dictionary<dynamic, dynamic> { { "l_extendedprice", 1000.000000 }, { "l_discount", 0.060000 }, { "l_shipdate", "1994-02-15" }, { "l_quantity", 10 } }, new Dictionary<dynamic, dynamic> { { "l_extendedprice", 500.000000 }, { "l_discount", 0.070000 }, { "l_shipdate", "1994-03-10" }, { "l_quantity", 23 } }, new Dictionary<dynamic, dynamic> { { "l_extendedprice", 400.000000 }, { "l_discount", 0.040000 }, { "l_shipdate", "1994-04-10" }, { "l_quantity", 15 } }, new Dictionary<dynamic, dynamic> { { "l_extendedprice", 200.000000 }, { "l_discount", 0.060000 }, { "l_shipdate", "1995-01-01" }, { "l_quantity", 5 } } };

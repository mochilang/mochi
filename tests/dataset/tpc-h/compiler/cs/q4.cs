// Generated by Mochi compiler v0.10.26 on 2025-07-15T08:18:44Z
using System;
...
class Program
{
    ...
    {
        expect(_equal(result, new List<dynamic> { new Dictionary<dynamic, dynamic> { { "o_orderpriority", "1-URGENT" }, { "order_count", 1 } }, new Dictionary<dynamic, dynamic> { { "o_orderpriority", "2-HIGH" }, { "order_count", 1 } } }));
    }

    static void Main()
    {
        var orders = new List<dynamic> { new Dictionary<dynamic, dynamic> { { "o_orderkey", 1 }, { "o_orderdate", "1993-07-01" }, { "o_orderpriority", "1-URGENT" } }, new Dictionary<dynamic, dynamic> { { "o_orderkey", 2 }, { "o_orderdate", "1993-07-15" }, { "o_orderpriority", "2-HIGH" } }, new Dictionary<dynamic, dynamic> { { "o_orderkey", 3 }, { "o_orderdate", "1993-08-01" }, { "o_orderpriority", "3-NORMAL" } } };
        var lineitem = new List<dynamic> { new Dictionary<dynamic, dynamic> { { "l_orderkey", 1 }, { "l_commitdate", "1993-07-10" }, { "l_receiptdate", "1993-07-12" } }, new Dictionary<dynamic, dynamic> { { "l_orderkey", 1 }, { "l_commitdate", "1993-07-12" }, { "l_receiptdate", "1993-07-10" } }, new Dictionary<dynamic, dynamic> { { "l_orderkey", 2 }, { "l_commitdate", "1993-07-20" }, { "l_receiptdate", "1993-07-25" } }, new Dictionary<dynamic, dynamic> { { "l_orderkey", 3 }, { "l_commitdate", "1993-08-02" }, { "l_receiptdate", "1993-08-01" } }, new Dictionary<dynamic, dynamic> { { "l_orderkey", 3 }, { "l_commitdate", "1993-08-05" }, { "l_receiptdate", "1993-08-10" } } };
        ...
        var result = _group_by<dynamic, dynamic>(late_orders, o => o["o_orderpriority"]).OrderBy(g => g.key).Select(g => new Dictionary<dynamic, dynamic> { { "o_orderpriority", g.key }, { "order_count", Enumerable.Count(g) } }).ToList();

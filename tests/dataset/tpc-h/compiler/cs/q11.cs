// Generated by Mochi compiler v0.10.26 on 2025-07-15T08:19:47Z
using System;
...
class Program
{
    ...
    {
        expect(_equal(result, new List<dynamic> { new Dictionary<dynamic, dynamic> { { "ps_partkey", 1000 }, { "value", 2000.000000 } }, new Dictionary<dynamic, dynamic> { { "ps_partkey", 2000 }, { "value", 50.000000 } } }));
    }

    static void Main()
    {
        var nation = new List<dynamic> { new Dictionary<dynamic, dynamic> { { "n_nationkey", 1 }, { "n_name", "GERMANY" } }, new Dictionary<dynamic, dynamic> { { "n_nationkey", 2 }, { "n_name", "FRANCE" } } };
        var supplier = new List<dynamic> { new Dictionary<dynamic, dynamic> { { "s_suppkey", 100 }, { "s_nationkey", 1 } }, new Dictionary<dynamic, dynamic> { { "s_suppkey", 200 }, { "s_nationkey", 1 } }, new Dictionary<dynamic, dynamic> { { "s_suppkey", 300 }, { "s_nationkey", 2 } } };
        var partsupp = new List<dynamic> { new Dictionary<dynamic, dynamic> { { "ps_partkey", 1000 }, { "ps_suppkey", 100 }, { "ps_supplycost", 10.000000 }, { "ps_availqty", 100 } }, new Dictionary<dynamic, dynamic> { { "ps_partkey", 1000 }, { "ps_suppkey", 200 }, { "ps_supplycost", 20.000000 }, { "ps_availqty", 50 } }, new Dictionary<dynamic, dynamic> { { "ps_partkey", 2000 }, { "ps_suppkey", 100 }, { "ps_supplycost", 5.000000 }, { "ps_availqty", 10 } }, new Dictionary<dynamic, dynamic> { { "ps_partkey", 3000 }, { "ps_suppkey", 300 }, { "ps_supplycost", 8.000000 }, { "ps_availqty", 500 } } };
    ...
    select new Dictionary<dynamic, dynamic> { { "ps_partkey", ps["ps_partkey"] }, { "value", (ps["ps_supplycost"] * ps["ps_availqty"]) } }
).ToList();
        var grouped = _group_by<dynamic, dynamic>(filtered, x => x["ps_partkey"]).Select(g => new Dictionary<dynamic, dynamic> { { "ps_partkey", g.key }, { "value", _sum(g.Items.Select(r => r["value"]).ToList()) } }).ToList();

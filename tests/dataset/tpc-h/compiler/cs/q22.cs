// Generated by Mochi compiler v0.10.28 on 2025-07-18T03:38:24Z
using System;
...
class Program
{
    ...
    {
        expect(_equal(result, new List<dynamic> { new Dictionary<string, dynamic> { { "cntrycode", "13" }, { "numcust", 1 }, { "totacctbal", 600.000000 } }, new Dictionary<string, dynamic> { { "cntrycode", "30" }, { "numcust", 1 }, { "totacctbal", 700.000000 } } }));
    }

    static void Main()
    {
        var customer = new List<dynamic> { new Dictionary<string, dynamic> { { "c_custkey", 1 }, { "c_phone", "13-123-4567" }, { "c_acctbal", 600.000000 } }, new Dictionary<string, dynamic> { { "c_custkey", 2 }, { "c_phone", "31-456-7890" }, { "c_acctbal", 100.000000 } }, new Dictionary<string, dynamic> { { "c_custkey", 3 }, { "c_phone", "30-000-0000" }, { "c_acctbal", 700.000000 } } };
        var orders = new List<dynamic> { new Dictionary<string, int> { { "o_orderkey", 10 }, { "o_custkey", 2 } } };
        ...
        var eligible_customers = customer.Where(c => (c["c_acctbal"] > avg_balance) && ((!Enumerable.Any(orders.Where(o => (o["o_custkey"] == c["c_custkey"])).Select(o => o).ToList())))).Select(c => new Dictionary<string, string> { { "cntrycode", _sliceString(c["c_phone"], 0, 2) }, { "c_acctbal", c["c_acctbal"] } }).ToList();
            ...
            public record struct Row
    {
        ...
        public int numcust;
        public double totacctbal;
    }

    var row = new Dictionary<string, dynamic> { { "cntrycode", g.key }, { "numcust", Enumerable.Count(g) }, { "totacctbal", total } };

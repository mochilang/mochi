// Generated by Mochi compiler v0.10.28 on 2025-07-18T03:38:01Z
using System;
...
class Program
{
    ...
    {
        expect(_equal(result, new List<dynamic> { new Dictionary<string, string> { { "s_name", "Maple Supply" }, { "s_address", "123 Forest Lane" } } }));
    }

    static void Main()
    {
        var nation = new List<dynamic> { new Dictionary<string, dynamic> { { "n_nationkey", 1 }, { "n_name", "CANADA" } }, new Dictionary<string, dynamic> { { "n_nationkey", 2 }, { "n_name", "GERMANY" } } };
        var supplier = new List<dynamic> { new Dictionary<string, dynamic> { { "s_suppkey", 100 }, { "s_name", "Maple Supply" }, { "s_address", "123 Forest Lane" }, { "s_nationkey", 1 } }, new Dictionary<string, dynamic> { { "s_suppkey", 200 }, { "s_name", "Berlin Metals" }, { "s_address", "456 Iron Str" }, { "s_nationkey", 2 } } };
        var part = new List<dynamic> { new Dictionary<string, dynamic> { { "p_partkey", 10 }, { "p_name", "forest glade bricks" } }, new Dictionary<string, dynamic> { { "p_partkey", 20 }, { "p_name", "desert sand paper" } } };
        var partsupp = new List<dynamic> { new Dictionary<string, int> { { "ps_partkey", 10 }, { "ps_suppkey", 100 }, { "ps_availqty", 100 } }, new Dictionary<string, int> { { "ps_partkey", 20 }, { "ps_suppkey", 200 }, { "ps_availqty", 30 } } };
        var lineitem = new List<dynamic> { new Dictionary<string, dynamic> { { "l_partkey", 10 }, { "l_suppkey", 100 }, { "l_quantity", 100 }, { "l_shipdate", "1994-05-15" } }, new Dictionary<string, dynamic> { { "l_partkey", 10 }, { "l_suppkey", 100 }, { "l_quantity", 50 }, { "l_shipdate", "1995-01-01" } } };
        var prefix = "forest";
        var shipped_94 = _group_by<dynamic, dynamic>(lineitem.Where(l => string.Compare(Convert.ToString(l["l_shipdate"]), Convert.ToString("1994-01-01")) >= 0 && string.Compare(Convert.ToString(l["l_shipdate"]), Convert.ToString("1995-01-01")) < 0), l => new Dictionary<string, dynamic> { { "partkey", l["l_partkey"] }, { "suppkey", l["l_suppkey"] } }).Select(g => new Dictionary<string, dynamic> { { "partkey", g.key.partkey }, { "suppkey", g.key.suppkey }, { "qty", _sum(g.Items.Select(x => x["l_quantity"]).ToList()) } }).ToList();
        ...
        var result = supplier.Join(nation, s => n["n_nationkey"], n => s["s_nationkey"], (s, n) => new Dictionary<string, dynamic> { { "s_name", s["s_name"] }, { "s_address", s["s_address"] } }).Where(s => target_partkeys.Contains(s["s_suppkey"])).OrderBy(s => s["s_name"]).ToList();

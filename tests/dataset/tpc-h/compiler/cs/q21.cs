// Generated by Mochi compiler v0.10.28 on 2025-07-18T03:38:13Z
using System;
...
class Program
{
    ...
    {
        expect(_equal(result, new List<dynamic> { new Dictionary<string, dynamic> { { "s_name", "Desert Trade" }, { "numwait", 1 } } }));
    }

    static void Main()
    {
        var nation = new List<dynamic> { new Dictionary<string, dynamic> { { "n_nationkey", 1 }, { "n_name", "SAUDI ARABIA" } }, new Dictionary<string, dynamic> { { "n_nationkey", 2 }, { "n_name", "FRANCE" } } };
        var supplier = new List<dynamic> { new Dictionary<string, dynamic> { { "s_suppkey", 100 }, { "s_name", "Desert Trade" }, { "s_nationkey", 1 } }, new Dictionary<string, dynamic> { { "s_suppkey", 200 }, { "s_name", "Euro Goods" }, { "s_nationkey", 2 } } };
        var orders = new List<dynamic> { new Dictionary<string, dynamic> { { "o_orderkey", 500 }, { "o_orderstatus", "F" } }, new Dictionary<string, dynamic> { { "o_orderkey", 600 }, { "o_orderstatus", "O" } } };
        var lineitem = new List<dynamic> { new Dictionary<string, dynamic> { { "l_orderkey", 500 }, { "l_suppkey", 100 }, { "l_receiptdate", "1995-04-15" }, { "l_commitdate", "1995-04-10" } }, new Dictionary<string, dynamic> { { "l_orderkey", 500 }, { "l_suppkey", 200 }, { "l_receiptdate", "1995-04-12" }, { "l_commitdate", "1995-04-12" } }, new Dictionary<string, dynamic> { { "l_orderkey", 600 }, { "l_suppkey", 100 }, { "l_receiptdate", "1995-05-01" }, { "l_commitdate", "1995-04-25" } } };
        var result = new Func<List<Dictionary<string, dynamic>>>(() =>
        {
            ...
            {
                _res.Add(new Dictionary<string, dynamic> { { "s_name", g["key"] }, { "numwait", g.Count() } });
            }
            return _res;
        })();

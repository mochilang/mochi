// Generated by Mochi compiler v0.10.26 on 2025-07-15T08:20:56Z
using System;
...
class Program
{
    ...
    static void Main()
    {
        var part = new List<dynamic> { new Dictionary<dynamic, dynamic> { { "p_partkey", 1 }, { "p_brand", "Brand#12" }, { "p_container", "SM BOX" }, { "p_size", 3 } }, new Dictionary<dynamic, dynamic> { { "p_partkey", 2 }, { "p_brand", "Brand#23" }, { "p_container", "MED BOX" }, { "p_size", 5 } }, new Dictionary<dynamic, dynamic> { { "p_partkey", 3 }, { "p_brand", "Brand#34" }, { "p_container", "LG BOX" }, { "p_size", 15 } } };
        var lineitem = new List<dynamic> { new Dictionary<dynamic, dynamic> { { "l_partkey", 1 }, { "l_quantity", 5 }, { "l_extendedprice", 1000.000000 }, { "l_discount", 0.100000 }, { "l_shipmode", "AIR" }, { "l_shipinstruct", "DELIVER IN PERSON" } }, new Dictionary<dynamic, dynamic> { { "l_partkey", 2 }, { "l_quantity", 15 }, { "l_extendedprice", 2000.000000 }, { "l_discount", 0.050000 }, { "l_shipmode", "AIR REG" }, { "l_shipinstruct", "DELIVER IN PERSON" } }, new Dictionary<dynamic, dynamic> { { "l_partkey", 3 }, { "l_quantity", 35 }, { "l_extendedprice", 1500.000000 }, { "l_discount", 0.000000 }, { "l_shipmode", "AIR" }, { "l_shipinstruct", "DELIVER IN PERSON" } } };

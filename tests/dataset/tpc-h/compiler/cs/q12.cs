// Generated by Mochi compiler v0.10.26 on 2025-07-15T08:19:56Z
using System;
...
class Program
{
    ...
    {
        expect(_equal(result, new List<dynamic> { new Dictionary<dynamic, dynamic> { { "l_shipmode", "MAIL" }, { "high_line_count", 1 }, { "low_line_count", 0 } } }));
    }

    static void Main()
    {
        var orders = new List<dynamic> { new Dictionary<dynamic, dynamic> { { "o_orderkey", 1 }, { "o_orderpriority", "1-URGENT" } }, new Dictionary<dynamic, dynamic> { { "o_orderkey", 2 }, { "o_orderpriority", "3-MEDIUM" } } };
        var lineitem = new List<dynamic> { new Dictionary<dynamic, dynamic> { { "l_orderkey", 1 }, { "l_shipmode", "MAIL" }, { "l_commitdate", "1994-02-10" }, { "l_receiptdate", "1994-02-15" }, { "l_shipdate", "1994-02-05" } }, new Dictionary<dynamic, dynamic> { { "l_orderkey", 2 }, { "l_shipmode", "SHIP" }, { "l_commitdate", "1994-03-01" }, { "l_receiptdate", "1994-02-28" }, { "l_shipdate", "1994-02-27" } } };
        var result = new Func<List<dynamic>>(() =>
        {
            ...
            {
                _res.Add(new Dictionary<dynamic, dynamic> { { "l_shipmode", g["key"] }, { "high_line_count", Enumerable.Sum(g.Select(x => (new List<string> { "1-URGENT", "2-HIGH" }.Contains(x["o"]["o_orderpriority"]) ? 1 : 0)).ToList()) }, { "low_line_count", Enumerable.Sum(g.Select(x => ((!(new List<string> { "1-URGENT", "2-HIGH" }.Contains(x["o"]["o_orderpriority"]))) ? 1 : 0)).ToList()) } });
            }
            return _res;
        })();

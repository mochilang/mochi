// Generated by Mochi compiler v0.10.26 on 2025-07-15T08:18:35Z
using System;
...
class Program
{
    ...
    {
        expect(_equal(order_line_join, new List<dynamic> { new Dictionary<dynamic, dynamic> { { "l_orderkey", 100 }, { "revenue", ((1000.000000 * 0.950000) + 500.000000) }, { "o_orderdate", "1995-03-14" }, { "o_shippriority", 1 } } }));
    }

    static void Main()
    {
        var customer = new List<dynamic> { new Dictionary<dynamic, dynamic> { { "c_custkey", 1 }, { "c_mktsegment", "BUILDING" } }, new Dictionary<dynamic, dynamic> { { "c_custkey", 2 }, { "c_mktsegment", "AUTOMOBILE" } } };
        var orders = new List<dynamic> { new Dictionary<dynamic, dynamic> { { "o_orderkey", 100 }, { "o_custkey", 1 }, { "o_orderdate", "1995-03-14" }, { "o_shippriority", 1 } }, new Dictionary<dynamic, dynamic> { { "o_orderkey", 200 }, { "o_custkey", 2 }, { "o_orderdate", "1995-03-10" }, { "o_shippriority", 2 } } };
        var lineitem = new List<dynamic> { new Dictionary<dynamic, dynamic> { { "l_orderkey", 100 }, { "l_extendedprice", 1000.000000 }, { "l_discount", 0.050000 }, { "l_shipdate", "1995-03-16" } }, new Dictionary<dynamic, dynamic> { { "l_orderkey", 100 }, { "l_extendedprice", 500.000000 }, { "l_discount", 0.000000 }, { "l_shipdate", "1995-03-20" } }, new Dictionary<dynamic, dynamic> { { "l_orderkey", 200 }, { "l_extendedprice", 1000.000000 }, { "l_discount", 0.100000 }, { "l_shipdate", "1995-03-14" } } };
        ...
        var order_line_join = new Func<List<dynamic>>(() =>
        {
            ...
            foreach (var o in valid_orders)
            {
                foreach (var l in valid_lineitems)
                {
                    ...
                    var key = new Dictionary<dynamic, dynamic> { { "o_orderkey", o["o_orderkey"] }, { "o_orderdate", o["o_orderdate"] }, { "o_shippriority", o["o_shippriority"] } };
            ...
            {
                _res.Add(new Dictionary<dynamic, dynamic> { { "l_orderkey", g["key"].o_orderkey }, { "revenue", _sum(g.Select(r => (r["l"]["l_extendedprice"] * ((1 - r["l"]["l_discount"])))).ToList()) }, { "o_orderdate", g["key"].o_orderdate }, { "o_shippriority", g["key"].o_shippriority } });
            }
            return _res;
        })();

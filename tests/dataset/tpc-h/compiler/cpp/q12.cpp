...
struct Lineitem {
  ...
  decltype(std::string("MAIL")) l_shipmode;
  decltype(std::string("1994-02-10")) l_commitdate;
  decltype(std::string("1994-02-15")) l_receiptdate;
  decltype(std::string("1994-02-05")) l_shipdate;
};
struct Result {
  decltype(l) l;
  decltype(o) o;
...
struct __struct4 {
  decltype(std::declval<Result>().l_shipmode) key;
  std::vector<Result> items;
};
struct __struct5 {
  decltype(std::declval<__struct4>().key) l_shipmode;

...
struct Nation {
  ...
  decltype(std::string("SAUDI ARABIA")) n_name;
};
struct Supplier {
  decltype(100) s_suppkey;
  decltype(std::string("Desert Trade")) s_name;
  decltype(1) s_nationkey;
};
struct Order {
  decltype(500) o_orderkey;
  decltype(std::string("F")) o_orderstatus;
};
struct Lineitem {
  decltype(500) l_orderkey;
  decltype(100) l_suppkey;
  decltype(std::string("1995-04-15")) l_receiptdate;
  decltype(std::string("1995-04-10")) l_commitdate;
};
struct Result {
  decltype(s) s;
  decltype(l1) l1;
...
struct __struct6 {
  decltype(std::declval<Result>().s_name) key;
  std::vector<Result> items;
};
struct __struct7 {
  decltype(std::declval<__struct6>().key) s_name;
  int numwait;
};
struct __struct8 {
  decltype((-((int)std::declval<__struct6>().items.size()))) f0;
  decltype(std::declval<__struct6>().key) f1;
};

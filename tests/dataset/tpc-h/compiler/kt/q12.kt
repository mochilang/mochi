...
val result = run {
        ...
        for (o in orders) {
            if (o.o_orderkey == l.l_orderkey) {
                if ((l.l_shipmode in mutableListOf("MAIL", "SHIP")) && (l.l_commitdate < l.l_receiptdate) && (l.l_shipdate < l.l_commitdate) && (l.l_receiptdate >= "1994-01-01") && (l.l_receiptdate < "1995-01-01")) {
                    ...
                    __g.add(mutableMapOf("l" to l, "o" to o) as MutableMap<String, Any?>)
                }
            }
        }
    }
    ...
    for (x in g) {
        __res.add(if (((x as MutableMap<String, Any?>)["o"] as MutableMap<*, *>)["o_orderpriority"] in mutableListOf("1-URGENT", "2-HIGH")) 1 else 0)
    }
    __res

// Generated by Mochi compiler v0.10.28 on 2025-07-18T03:51:06Z
...
val result =     val __sorted = grouped.sortedByDescending { (it as MutableMap<String, Any?>)["value"] as Comparable<Any> }
run {
    val __res = mutableListOf<MutableMap<String, Any?>>()
    for (x in __sorted) {

...
let region: obj list = [{ r_regionkey = 0; r_name = "AMERICA" }]
let nation: obj list = [{ n_nationkey = 10; n_regionkey = 0; n_name = "BRAZIL" }; { n_nationkey = 20; n_regionkey = 0; n_name = "CANADA" }]
let customer: obj list = [{ c_custkey = 1; c_nationkey = 10 }; { c_custkey = 2; c_nationkey = 20 }]
let orders: obj list = [{ o_orderkey = 100; o_custkey = 1; o_orderdate = "1995-04-10" }; { o_orderkey = 200; o_custkey = 2; o_orderdate = "1995-07-15" }]
let lineitem: obj list = [{ l_orderkey = 100; l_suppkey = 1000; l_partkey = 5000; l_extendedprice = 1000; l_discount = 0.1 }; { l_orderkey = 200; l_suppkey = 2000; l_partkey = 5000; l_extendedprice = 500; l_discount = 0.05 }]
let supplier: obj list = [{ s_suppkey = 1000 }; { s_suppkey = 2000 }]
let part: obj list = [{ p_partkey = 5000; p_type = "ECONOMY ANODIZED STEEL" }; { p_partkey = 6000; p_type = "SMALL BRASS" }]
...
let result: obj list = [ for year in _group_by [ for l in lineitem do 
  for p in part do 
...
let numerator: float = 1000 * 0.9
let denominator: float = numerator + (500 * 0.95)

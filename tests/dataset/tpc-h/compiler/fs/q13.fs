...
let per_customer: Anon3 list = [ for c in customer do yield { c_count = List.length [ for o in orders do if (o.o_custkey = c.c_custkey && (not (List.contains "special" o.o_comment)) && (not (List.contains "requests" o.o_comment))) then yield o ] } ]

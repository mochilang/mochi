Let’s proceed to **TPC-H Query 6**, which is the simplest query in the suite — no joins, just filtering and aggregation. We’ll write the **Mochi version with inline data and a test**.

...
// TestPhase12FFI is the gate test for MEP-47 Phase 12: Java FFI via extern java fun.
// It runs every .mochi fixture under tests/transpiler3/jvm/phase12-ffi/ and
// compares stdout to the paired .out file.
func TestPhase12FFI(t *testing.T) {
	fixtureDir := filepath.Join(repoRootForTest(t), "tests", "transpiler3", "jvm", "phase12-ffi")

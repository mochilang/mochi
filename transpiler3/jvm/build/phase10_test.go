...
// TestPhase10Streams is the gate test for MEP-47 Phase 10: channels and streams.
// It runs every .mochi fixture under tests/transpiler3/jvm/phase10-streams/ and
// compares stdout to the paired .out file.
func TestPhase10Streams(t *testing.T) {
	fixtureDir := filepath.Join(repoRootForTest(t), "tests", "transpiler3", "jvm", "phase10-streams")

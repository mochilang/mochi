...
replace github.com/tree-sitter/tree-sitter-fsharp => ./third_party/tree-sitter-fsharp
...
require (
	...
	github.com/tree-sitter/tree-sitter-fsharp v0.0.0
	github.com/tree-sitter/tree-sitter-racket v0.0.0
	github.com/tree-sitter/tree-sitter-swift v0.0.0-20220113184755-db675450dcc1
)

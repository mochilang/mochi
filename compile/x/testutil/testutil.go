...
// provided compile function. The query should be specified without the file
// extension, e.g. "q1". The compile function may return generated code which is
// ignored. If compilation fails, the test is skipped.
func CompileTPCDS(
	t *testing.T,
	query string,
	compileFn func(env *types.Env, prog *parser.Program) ([]byte, error),

...
// TestCobolCompiler_TPCDS_Golden compiles the first two TPCDS queries using the COBOL backend.
// Generated code is compared against the golden files under tests/dataset/tpc-ds/compiler/cobol.
